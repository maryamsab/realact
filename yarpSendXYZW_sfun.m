function yarpSendXYZW_sfun(block)
...
arrMsg  = block.InputPort(1).Data + ' ' + block.InputPort(2).Data + ' ' + block.InputPort(3).Data + ' ' + block.InputPort(4).Data;
strMsg = '';
...
%write BMLs to a file
fileID = fopen('maryamSent.txt','a');
fprintf(fileID,'send %s\r\n',strMsg);
fclose(fileID);
