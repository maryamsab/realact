  ...
  const mxArray * prhs[] )
{
  ...
  if (sf_ARP_02_RPSsmile_KinectGloveAtomicBradImitateSmile_process_check_sum_call
      (nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int
    sf_ARP_02_RPSsmile_KinectGloveAtomicBradImitateSmile_autoinheritance_info
    ( int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  ...
  if (strcmp(machineName, "ARP_02_RPSsmile_KinectGloveAtomicBradImitateSmile") ==
      0) {
...
extern void ARP_02_RPSsmile_KinectGloveAtomicBradImitateSmile_terminator(void);
void sf_machine_global_terminator(void)
{
  sfGlobalMdlStartCallCounts--;
  if (sfGlobalMdlStartCallCounts == 0) {
    ARP_02_RPSsmile_KinectGloveAtomicBradImitateSmile_terminator();
...
extern void ARP_02_RPSsmile_KinectGloveAtomicBradImitateSmile_initializer(void);
extern void
  ARP_02_RPSsmile_KinectGloveAtomicBradImitateSmile_register_exported_symbols
  (SimStruct* S);
extern void ARP_02_RPSsmile_KinectGloveAtomicBradImitateSmile_debug_initialize(
    struct SfDebugInstanceStruct*);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  ARP_02_RPSsmile_KinectGloveAtomicBradImitateSmile_register_exported_symbols(S);
}
