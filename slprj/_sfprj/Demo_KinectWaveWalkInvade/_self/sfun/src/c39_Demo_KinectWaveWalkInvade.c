...
static void initialize_c39_Demo_KinectWaveWalkInvade
  (SFc39_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance);
static void initialize_params_c39_Demo_KinectWaveWalkInvade
  (SFc39_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance);
static void enable_c39_Demo_KinectWaveWalkInvade
  (SFc39_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance);
static void disable_c39_Demo_KinectWaveWalkInvade
  (SFc39_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance);
static void c39_update_debugger_state_c39_Demo_KinectWaveWalkInvade
  (SFc39_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c39_Demo_KinectWaveWalkInvade
  (SFc39_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance);
static void set_sim_state_c39_Demo_KinectWaveWalkInvade
  (SFc39_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance, const mxArray
   *c39_st);
static void finalize_c39_Demo_KinectWaveWalkInvade
  (SFc39_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance);
static void sf_gateway_c39_Demo_KinectWaveWalkInvade
  (SFc39_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance);
static void c39_chartstep_c39_Demo_KinectWaveWalkInvade
  (SFc39_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance);
static void initSimStructsc39_Demo_KinectWaveWalkInvade
  (SFc39_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance);
...
static uint8_T c39_e_emlrt_marshallIn
  (SFc39_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance, const mxArray
   *c39_b_is_active_c39_Demo_KinectWaveWalkInvade, const char_T *c39_identifier);
static uint8_T c39_f_emlrt_marshallIn
  (SFc39_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance, const mxArray
   *c39_u, const emlrtMsgIdentifier *c39_parentId);
static void init_dsm_address_info(SFc39_Demo_KinectWaveWalkInvadeInstanceStruct *
  chartInstance);
  ...
  (SFc39_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance)
{
  ...
  chartInstance->c39_is_active_c39_Demo_KinectWaveWalkInvade = 0U;
}
   ...
   *c39_st)
{
  ...
  *c39_e = c39_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c39_u,
  ...
  chartInstance->c39_is_active_c39_Demo_KinectWaveWalkInvade =
    ...
    "is_active_c39_Demo_KinectWaveWalkInvade");
  sf_mex_destroy(&c39_u);
  c39_update_debugger_state_c39_Demo_KinectWaveWalkInvade(chartInstance);
  ...
  (SFc39_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance)
{
  ...
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 21U, chartInstance->c39_sfEvent);
  _SFD_DATA_RANGE_CHECK(*c39_V, 0U);
  chartInstance->c39_sfEvent = CALL_EVENT;
  c39_chartstep_c39_Demo_KinectWaveWalkInvade(chartInstance);
  ...
  (SFc39_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance)
{
  ...
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 21U, chartInstance->c39_sfEvent);
  ...
  _SFD_SYMBOL_SCOPE_POP();
  *c39_b_e = c39_e;
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 21U, chartInstance->c39_sfEvent);
}
  ...
  *c39_inData)
{
  ...
  const mxArray *c39_y = NULL;
  SFc39_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance;
  chartInstance = (SFc39_Demo_KinectWaveWalkInvadeInstanceStruct *)
    chartInstanceVoid;
   ...
   *c39_b_is_active_c39_Demo_KinectWaveWalkInvade, const char_T *c39_identifier)
{
  ...
  c39_y = c39_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c39_b_is_active_c39_Demo_KinectWaveWalkInvade), &c39_thisId);
  sf_mex_destroy(&c39_b_is_active_c39_Demo_KinectWaveWalkInvade);
  return c39_y;
}
...
void sf_c39_Demo_KinectWaveWalkInvade_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c39_Demo_KinectWaveWalkInvade_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c39_Demo_KinectWaveWalkInvade(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"e\",},{M[8],M[0],T\"is_active_c39_Demo_KinectWaveWalkInvade\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c39_Demo_KinectWaveWalkInvade_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c39_Demo_KinectWaveWalkInvade(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc39_Demo_KinectWaveWalkInvadeInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c39_Demo_KinectWaveWalkInvade
    ((SFc39_Demo_KinectWaveWalkInvadeInstanceStruct*) chartInstanceVar);
  initialize_c39_Demo_KinectWaveWalkInvade
    ((SFc39_Demo_KinectWaveWalkInvadeInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c39_Demo_KinectWaveWalkInvade(void
  *chartInstanceVar)
{
  enable_c39_Demo_KinectWaveWalkInvade
    ((SFc39_Demo_KinectWaveWalkInvadeInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c39_Demo_KinectWaveWalkInvade(void
  *chartInstanceVar)
{
  disable_c39_Demo_KinectWaveWalkInvade
    ((SFc39_Demo_KinectWaveWalkInvadeInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c39_Demo_KinectWaveWalkInvade(void
  *chartInstanceVar)
{
  sf_gateway_c39_Demo_KinectWaveWalkInvade
    ((SFc39_Demo_KinectWaveWalkInvadeInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c39_Demo_KinectWaveWalkInvade
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c39_Demo_KinectWaveWalkInvade
    ((SFc39_Demo_KinectWaveWalkInvadeInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c39_Demo_KinectWaveWalkInvade();/* state var info */
...
extern void sf_internal_set_sim_state_c39_Demo_KinectWaveWalkInvade(SimStruct* S,
  const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c39_Demo_KinectWaveWalkInvade();/* state var info */
  ...
  set_sim_state_c39_Demo_KinectWaveWalkInvade
    ((SFc39_Demo_KinectWaveWalkInvadeInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c39_Demo_KinectWaveWalkInvade
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c39_Demo_KinectWaveWalkInvade(S);
}

static void sf_opaque_set_sim_state_c39_Demo_KinectWaveWalkInvade(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c39_Demo_KinectWaveWalkInvade(S, st);
}

static void sf_opaque_terminate_c39_Demo_KinectWaveWalkInvade(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc39_Demo_KinectWaveWalkInvadeInstanceStruct*)
                    chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c39_Demo_KinectWaveWalkInvade
      ((SFc39_Demo_KinectWaveWalkInvadeInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc39_Demo_KinectWaveWalkInvade
    ((SFc39_Demo_KinectWaveWalkInvadeInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c39_Demo_KinectWaveWalkInvade(SimStruct *S)
{
  int i;
...
static void mdlRTW_c39_Demo_KinectWaveWalkInvade(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c39_Demo_KinectWaveWalkInvade(SimStruct *S)
{
  SFc39_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc39_Demo_KinectWaveWalkInvadeInstanceStruct *)utMalloc
    (sizeof(SFc39_Demo_KinectWaveWalkInvadeInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc39_Demo_KinectWaveWalkInvadeInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c39_Demo_KinectWaveWalkInvade;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c39_Demo_KinectWaveWalkInvade;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c39_Demo_KinectWaveWalkInvade;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c39_Demo_KinectWaveWalkInvade;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c39_Demo_KinectWaveWalkInvade;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c39_Demo_KinectWaveWalkInvade;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c39_Demo_KinectWaveWalkInvade;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c39_Demo_KinectWaveWalkInvade;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c39_Demo_KinectWaveWalkInvade;
  chartInstance->chartInfo.mdlStart = mdlStart_c39_Demo_KinectWaveWalkInvade;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c39_Demo_KinectWaveWalkInvade;
...
void c39_Demo_KinectWaveWalkInvade_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c39_Demo_KinectWaveWalkInvade(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c39_Demo_KinectWaveWalkInvade(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c39_Demo_KinectWaveWalkInvade(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c39_Demo_KinectWaveWalkInvade_method_dispatcher.\n"
