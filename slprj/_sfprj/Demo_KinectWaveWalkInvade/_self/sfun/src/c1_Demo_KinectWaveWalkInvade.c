...
#include "c1_Demo_KinectWaveWalkInvade.h"
...
static void initialize_c1_Demo_KinectWaveWalkInvade
  (SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance);
static void initialize_params_c1_Demo_KinectWaveWalkInvade
  (SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance);
static void enable_c1_Demo_KinectWaveWalkInvade
  (SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance);
static void disable_c1_Demo_KinectWaveWalkInvade
  (SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance);
static void c1_update_debugger_state_c1_Demo_KinectWaveWalkInvade
  (SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c1_Demo_KinectWaveWalkInvade
  (SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance);
static void set_sim_state_c1_Demo_KinectWaveWalkInvade
  (SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance, const mxArray
   *c1_st);
static void c1_set_sim_state_side_effects_c1_Demo_KinectWaveWalkInvade
  (SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance);
static void finalize_c1_Demo_KinectWaveWalkInvade
  (SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance);
static void sf_gateway_c1_Demo_KinectWaveWalkInvade
  (SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance);
static void c1_c1_Demo_KinectWaveWalkInvade
  (SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance);
static void initSimStructsc1_Demo_KinectWaveWalkInvade
  (SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance);
static void c1_sendBMLbyPriority(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance);
static void c1_enter_atomic_sendH(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance);
static void c1_enter_atomic_sendM(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance);
static void c1_low(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance);
static void c1_encStr2Arr(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, real_T c1_myarr256[1000]);
static boolean_T c1_isequal(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, real_T c1_varargin_1[1000], real_T c1_varargin_2[1000]);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber, uint32_T c1_instanceNumber);
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData);
static real_T c1_emlrt_marshallIn(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, const mxArray *c1_nargout, const char_T *c1_identifier);
static real_T c1_b_emlrt_marshallIn(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_b_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_c_emlrt_marshallIn(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId,
  real_T c1_y[1000]);
...
static const mxArray *c1_d_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_d_emlrt_marshallIn(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, const mxArray *c1_newBmls, const char_T *c1_identifier, real_T
  c1_y[5000]);
static void c1_e_emlrt_marshallIn(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId,
  real_T c1_y[5000]);
...
static void c1_removeQueue(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, real_T c1_bmls[5000], real_T c1_newBmls[5000]);
static real_T c1_isEmptyQueue(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, real_T c1_bmls[5000]);
static const mxArray *c1_f_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static int8_T c1_g_emlrt_marshallIn(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
...
static uint8_T c1_i_emlrt_marshallIn
  (SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance, const mxArray
   *c1_b_tp_RPS_Scenario, const char_T *c1_identifier);
...
static const mxArray *c1_k_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_k_emlrt_marshallIn(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, const mxArray *c1_BML, const char_T *c1_identifier, real_T
  c1_y[1000]);
static void c1_l_emlrt_marshallIn(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId,
  real_T c1_y[1000]);
static void c1_h_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static void c1_m_emlrt_marshallIn(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, const mxArray *c1_emotion_amount_factor, const char_T
  *c1_identifier, real_T c1_y[6]);
static void c1_n_emlrt_marshallIn(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId,
  real_T c1_y[6]);
...
static void c1_updateDataWrittenToVector
  (SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance, uint32_T
   c1_vectorIndex);
static void c1_errorIfDataNotWrittenToFcn
  (SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance, uint32_T
   c1_vectorIndex, uint32_T c1_dataNumber);
static real_T c1_get_BML(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_BML(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_BML(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_BML1(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_BML1(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_BML1(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_BML2(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_BML2(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_BML2(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_BORED(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_BORED(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_BORED(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_BOREDOM_THRESHOLD
  (SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance, uint32_T c1_b);
static void c1_set_BOREDOM_THRESHOLD
  (SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance, uint32_T c1_b,
   real_T c1_c);
static real_T *c1_access_BOREDOM_THRESHOLD
  (SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance, uint32_T c1_b);
static real_T c1_get_CONTEMPT(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_CONTEMPT(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_CONTEMPT(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_EXCITE(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_EXCITE(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_EXCITE(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_FEAR(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_FEAR(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_FEAR(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_FRUST(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_FRUST(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_FRUST(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_GAZE_GUI(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_GAZE_GUI(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_GAZE_GUI(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_GAZE_SOFTEYE(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_GAZE_SOFTEYE(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_GAZE_SOFTEYE
  (SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance, uint32_T c1_b);
static real_T c1_get_GAZE_USER_HAND(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_GAZE_USER_HAND(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_GAZE_USER_HAND
  (SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance, uint32_T c1_b);
static real_T c1_get_GAZE_WIN(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_GAZE_WIN(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_GAZE_WIN(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_HAPPY(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_HAPPY(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_HAPPY(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_IDLE(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_IDLE(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_IDLE(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_P(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_P(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance,
                     uint32_T c1_b, real_T c1_c);
static real_T *c1_access_P(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_SAD(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_SAD(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_SAD(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_STATE_BEFORE(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_STATE_BEFORE(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_STATE_BEFORE
  (SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance, uint32_T c1_b);
static real_T c1_get_STATE_GO(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_STATE_GO(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_STATE_GO(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_STATE_HAND(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_STATE_HAND(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_STATE_HAND(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_STATE_OVER(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_STATE_OVER(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_STATE_OVER(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_STATE_READY(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_STATE_READY(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_STATE_READY
  (SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance, uint32_T c1_b);
static real_T c1_get_STATE_RESULT(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_STATE_RESULT(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_STATE_RESULT
  (SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance, uint32_T c1_b);
static real_T c1_get_STATE_WAIT(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_STATE_WAIT(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_STATE_WAIT(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_avert(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_avert(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_avert(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_avertH(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_avertH(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_avertH(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
...
static real_T *c1_access_avert_head_frequency_factor
  (SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance, uint32_T c1_b);
static real_T c1_get_avert_head_speed
  (SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance, uint32_T c1_b);
static void c1_set_avert_head_speed(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_avert_head_speed
  (SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance, uint32_T c1_b);
static real_T c1_get_bHand(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_bHand(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_bHand(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_bmlsH(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_bmlsH(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_bmlsH(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_bmlsL(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_bmlsL(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_bmlsL(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_bmlsM(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_bmlsM(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_bmlsM(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_bodyBusyFlag(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_bodyBusyFlag(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_bodyBusyFlag
  (SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance, uint32_T c1_b);
static real_T c1_get_boredom(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_boredom(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_boredom(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_diff(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_diff(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_diff(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_emotion_amount_factor
  (SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance, uint32_T c1_b);
static void c1_set_emotion_amount_factor
  (SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance, uint32_T c1_b,
   real_T c1_c);
static real_T *c1_access_emotion_amount_factor
  (SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance, uint32_T c1_b);
static real_T c1_get_faceBusyFlag(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_faceBusyFlag(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_faceBusyFlag
  (SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance, uint32_T c1_b);
static real_T c1_get_fileID(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_fileID(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_fileID(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_gazing(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_gazing(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_gazing(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_interest(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_interest(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_interest(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
...
static real_T *c1_access_mutual_gaze_duration_factor
  (SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance, uint32_T c1_b);
static real_T c1_get_n(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_n(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance,
                     uint32_T c1_b, real_T c1_c);
static real_T *c1_access_n(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_pa(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_pa(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
                      *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_pa(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_pose_chance_factor
  (SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance, uint32_T c1_b);
static void c1_set_pose_chance_factor
  (SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance, uint32_T c1_b,
   real_T c1_c);
static real_T *c1_access_pose_chance_factor
  (SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance, uint32_T c1_b);
static real_T c1_get_pose_change_flag
  (SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance, uint32_T c1_b);
static void c1_set_pose_change_flag(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_pose_change_flag
  (SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance, uint32_T c1_b);
static real_T c1_get_pose_frequency_factor
  (SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance, uint32_T c1_b);
static void c1_set_pose_frequency_factor
  (SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance, uint32_T c1_b,
   real_T c1_c);
static real_T *c1_access_pose_frequency_factor
  (SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance, uint32_T c1_b);
static real_T c1_get_pose_lean(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_pose_lean(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_pose_lean(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *
  chartInstance, uint32_T c1_b);
static real_T c1_get_pose_lean_flag(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_pose_lean_flag(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_pose_lean_flag
  (SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance, uint32_T c1_b);
static real_T c1_get_pose_selfAdaptor_chance_factor
  (SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance, uint32_T c1_b);
static void c1_set_pose_selfAdaptor_chance_factor
  (SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance, uint32_T c1_b,
   real_T c1_c);
static real_T *c1_access_pose_selfAdaptor_chance_factor
  (SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance, uint32_T c1_b);
static real_T c1_get_pose_speed(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_pose_speed(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_pose_speed(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_pr(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_pr(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
                      *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_pr(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_r(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_r(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance,
                     uint32_T c1_b, real_T c1_c);
static real_T *c1_access_r(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
...
static real_T *c1_access_randAvertGazeChance
  (SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance, uint32_T c1_b);
static real_T c1_get_randGazeDur(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_randGazeDur(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_randGazeDur
  (SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance, uint32_T c1_b);
static real_T c1_get_randPoseChance(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_randPoseChance(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_randPoseChance
  (SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance, uint32_T c1_b);
static real_T c1_get_randSlowPose(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_randSlowPose(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_randSlowPose
  (SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance, uint32_T c1_b);
static real_T c1_get_randSmile(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_randSmile(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_randSmile(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *
  chartInstance, uint32_T c1_b);
static real_T c1_get_s(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_s(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance,
                     uint32_T c1_b, real_T c1_c);
static real_T *c1_access_s(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_t(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_t(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance,
                     uint32_T c1_b, real_T c1_c);
static real_T *c1_access_t(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_temp(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_temp(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_temp(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_uHand(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_uHand(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_uHand(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void init_dsm_address_info(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct
  *chartInstance);
  ...
  (SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance)
{
  ...
  sf_exported_auto_initc5_Demo_KinectWaveWalkInvade
    (chartInstance->c1_subchartSimstruct);
  sf_exported_auto_initc8_Demo_KinectWaveWalkInvade
    (chartInstance->c1_b_subchartSimstruct);
  sf_exported_auto_initc20_Demo_KinectWaveWalkInvade
    (chartInstance->c1_c_subchartSimstruct);
  sf_exported_auto_initc4_Demo_KinectWaveWalkInvade
    (chartInstance->c1_d_subchartSimstruct);
  sf_exported_auto_initc9_Demo_KinectWaveWalkInvade
    (chartInstance->c1_e_subchartSimstruct);
  sf_exported_auto_initc11_Demo_KinectWaveWalkInvade
    (chartInstance->c1_f_subchartSimstruct);
  sf_exported_auto_initc42_Demo_KinectWaveWalkInvade
    (chartInstance->c1_g_subchartSimstruct);
  sf_exported_auto_initc43_Demo_KinectWaveWalkInvade
    (chartInstance->c1_h_subchartSimstruct);
  sf_exported_auto_initc44_Demo_KinectWaveWalkInvade
    (chartInstance->c1_i_subchartSimstruct);
  sf_exported_auto_initc10_Demo_KinectWaveWalkInvade
  ...
  chartInstance->c1_is_active_c1_Demo_KinectWaveWalkInvade = 0U;
  ...
  (SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance)
{
  ...
  if (chartInstance->c1_is_active_RPS_Scenario == 1U) {
    sf_exported_auto_enablec5_Demo_KinectWaveWalkInvade
      (chartInstance->c1_subchartSimstruct);
  }

  if (chartInstance->c1_is_active_personalSpace_Controller == 1U) {
    sf_exported_auto_enablec8_Demo_KinectWaveWalkInvade
      (chartInstance->c1_b_subchartSimstruct);
  }

  if (chartInstance->c1_is_active_wave_Controller == 1U) {
    sf_exported_auto_enablec20_Demo_KinectWaveWalkInvade
      (chartInstance->c1_c_subchartSimstruct);
  }

  if (chartInstance->c1_is_active_idlePose_Controller == 1U) {
    sf_exported_auto_enablec4_Demo_KinectWaveWalkInvade
      (chartInstance->c1_d_subchartSimstruct);
  }

  if (chartInstance->c1_is_active_Gaze_Controller == 1U) {
    sf_exported_auto_enablec9_Demo_KinectWaveWalkInvade
      (chartInstance->c1_e_subchartSimstruct);
  }

  if (chartInstance->c1_is_active_facialExpression_Controller == 1U) {
    sf_exported_auto_enablec11_Demo_KinectWaveWalkInvade
      (chartInstance->c1_f_subchartSimstruct);
  }

  if (chartInstance->c1_is_active_personality_Behavior_Factors == 1U) {
    sf_exported_auto_enablec42_Demo_KinectWaveWalkInvade
      (chartInstance->c1_g_subchartSimstruct);
  }

  if (chartInstance->c1_is_active_emotion_Behavior_Factors == 1U) {
    sf_exported_auto_enablec43_Demo_KinectWaveWalkInvade
      (chartInstance->c1_h_subchartSimstruct);
  }

  if (chartInstance->c1_is_active_custom_Behavior_Factors == 1U) {
    sf_exported_auto_enablec44_Demo_KinectWaveWalkInvade
      (chartInstance->c1_i_subchartSimstruct);
  }

  if (chartInstance->c1_is_active_attention_Controller == 1U) {
    sf_exported_auto_enablec10_Demo_KinectWaveWalkInvade
      (chartInstance->c1_j_subchartSimstruct);
  }
}
  ...
  (SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance)
{
  ...
  if (chartInstance->c1_is_active_RPS_Scenario == 1U) {
    sf_exported_auto_disablec5_Demo_KinectWaveWalkInvade
      (chartInstance->c1_subchartSimstruct);
  }

  if (chartInstance->c1_is_active_personalSpace_Controller == 1U) {
    sf_exported_auto_disablec8_Demo_KinectWaveWalkInvade
      (chartInstance->c1_b_subchartSimstruct);
  }

  if (chartInstance->c1_is_active_wave_Controller == 1U) {
    sf_exported_auto_disablec20_Demo_KinectWaveWalkInvade
      (chartInstance->c1_c_subchartSimstruct);
  }

  if (chartInstance->c1_is_active_idlePose_Controller == 1U) {
    sf_exported_auto_disablec4_Demo_KinectWaveWalkInvade
      (chartInstance->c1_d_subchartSimstruct);
  }

  if (chartInstance->c1_is_active_Gaze_Controller == 1U) {
    sf_exported_auto_disablec9_Demo_KinectWaveWalkInvade
      (chartInstance->c1_e_subchartSimstruct);
  }

  if (chartInstance->c1_is_active_facialExpression_Controller == 1U) {
    sf_exported_auto_disablec11_Demo_KinectWaveWalkInvade
      (chartInstance->c1_f_subchartSimstruct);
  }

  if (chartInstance->c1_is_active_personality_Behavior_Factors == 1U) {
    sf_exported_auto_disablec42_Demo_KinectWaveWalkInvade
      (chartInstance->c1_g_subchartSimstruct);
  }

  if (chartInstance->c1_is_active_emotion_Behavior_Factors == 1U) {
    sf_exported_auto_disablec43_Demo_KinectWaveWalkInvade
      (chartInstance->c1_h_subchartSimstruct);
  }

  if (chartInstance->c1_is_active_custom_Behavior_Factors == 1U) {
    sf_exported_auto_disablec44_Demo_KinectWaveWalkInvade
      (chartInstance->c1_i_subchartSimstruct);
  }

  if (chartInstance->c1_is_active_attention_Controller == 1U) {
    sf_exported_auto_disablec10_Demo_KinectWaveWalkInvade
      (chartInstance->c1_j_subchartSimstruct);
  }
}
  ...
  (SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance)
{
  ...
  if (chartInstance->c1_is_active_c1_Demo_KinectWaveWalkInvade == 1U) {
  ...
  (SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance)
{
  ...
  c1_tc_hoistedGlobal = chartInstance->c1_is_active_c1_Demo_KinectWaveWalkInvade;
   ...
   *c1_st)
{
  ...
  *c1_win = c1_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 6)),
  ...
  chartInstance->c1_is_active_c1_Demo_KinectWaveWalkInvade =
    c1_i_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 80)),
    "is_active_c1_Demo_KinectWaveWalkInvade");
  ...
  (SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance)
{
  ...
  c1_set_sim_state_side_effects_c1_Demo_KinectWaveWalkInvade(chartInstance);
  _SFD_SYMBOL_SCOPE_PUSH(0U, 0U);
  _sfTime_ = sf_get_time(chartInstance->S);
  sf_exported_auto_gatewayc5_Demo_KinectWaveWalkInvade
    (chartInstance->c1_subchartSimstruct);
  sf_exported_auto_gatewayc8_Demo_KinectWaveWalkInvade
    (chartInstance->c1_b_subchartSimstruct);
  sf_exported_auto_gatewayc20_Demo_KinectWaveWalkInvade
    (chartInstance->c1_c_subchartSimstruct);
  sf_exported_auto_gatewayc4_Demo_KinectWaveWalkInvade
    (chartInstance->c1_d_subchartSimstruct);
  sf_exported_auto_gatewayc9_Demo_KinectWaveWalkInvade
    (chartInstance->c1_e_subchartSimstruct);
  sf_exported_auto_gatewayc11_Demo_KinectWaveWalkInvade
    (chartInstance->c1_f_subchartSimstruct);
  sf_exported_auto_gatewayc42_Demo_KinectWaveWalkInvade
    (chartInstance->c1_g_subchartSimstruct);
  sf_exported_auto_gatewayc43_Demo_KinectWaveWalkInvade
    (chartInstance->c1_h_subchartSimstruct);
  sf_exported_auto_gatewayc44_Demo_KinectWaveWalkInvade
    (chartInstance->c1_i_subchartSimstruct);
  sf_exported_auto_gatewayc10_Demo_KinectWaveWalkInvade
    (chartInstance->c1_j_subchartSimstruct);
  ...
  sf_exported_auto_activate_c5_Demo_KinectWaveWalkInvade_secs
    (chartInstance->c1_subchartSimstruct);
  sf_exported_auto_activate_c8_Demo_KinectWaveWalkInvade_secs
    (chartInstance->c1_b_subchartSimstruct);
  sf_exported_auto_activate_c20_Demo_KinectWaveWalkInvade_secs
    (chartInstance->c1_c_subchartSimstruct);
  sf_exported_auto_activate_c4_Demo_KinectWaveWalkInvade_secs
    (chartInstance->c1_d_subchartSimstruct);
  sf_exported_auto_activate_c9_Demo_KinectWaveWalkInvade_secs
    (chartInstance->c1_e_subchartSimstruct);
  sf_exported_auto_activate_c11_Demo_KinectWaveWalkInvade_secs
    (chartInstance->c1_f_subchartSimstruct);
  sf_exported_auto_activate_callc42_Demo_KinectWaveWalkInvade
    (chartInstance->c1_g_subchartSimstruct);
  sf_exported_auto_activate_callc43_Demo_KinectWaveWalkInvade
    (chartInstance->c1_h_subchartSimstruct);
  sf_exported_auto_activate_callc44_Demo_KinectWaveWalkInvade
    (chartInstance->c1_i_subchartSimstruct);
  sf_exported_auto_activate_c10_Demo_KinectWaveWalkInvade_secs
    (chartInstance->c1_j_subchartSimstruct);
  sf_exported_auto_incrementTemporalCounter_c5_Demo_KinectWaveWalkInvade_secs
    (chartInstance->c1_subchartSimstruct);
  sf_exported_auto_incrementTemporalCounter_c8_Demo_KinectWaveWalkInvade_secs
    (chartInstance->c1_b_subchartSimstruct);
  sf_exported_auto_incrementTemporalCounter_c20_Demo_KinectWaveWalkInvade_secs
    (chartInstance->c1_c_subchartSimstruct);
  sf_exported_auto_incrementTemporalCounter_c4_Demo_KinectWaveWalkInvade_secs
    (chartInstance->c1_d_subchartSimstruct);
  sf_exported_auto_incrementTemporalCounter_c9_Demo_KinectWaveWalkInvade_secs
    (chartInstance->c1_e_subchartSimstruct);
  sf_exported_auto_incrementTemporalCounter_c11_Demo_KinectWaveWalkInvade_secs
    (chartInstance->c1_f_subchartSimstruct);
  sf_exported_auto_incrementTemporalCounter_c10_Demo_KinectWaveWalkInvade_secs
    (chartInstance->c1_j_subchartSimstruct);
  chartInstance->c1_sfEvent = c1_event_secs;
  _SFD_CE_CALL(EVENT_BEFORE_BROADCAST_TAG, c1_event_secs,
               chartInstance->c1_sfEvent);
  sf_exported_auto_stepBuffersc5_Demo_KinectWaveWalkInvade
    (chartInstance->c1_subchartSimstruct);
  sf_exported_auto_stepBuffersc8_Demo_KinectWaveWalkInvade
    (chartInstance->c1_b_subchartSimstruct);
  sf_exported_auto_stepBuffersc20_Demo_KinectWaveWalkInvade
    (chartInstance->c1_c_subchartSimstruct);
  sf_exported_auto_stepBuffersc4_Demo_KinectWaveWalkInvade
    (chartInstance->c1_d_subchartSimstruct);
  sf_exported_auto_stepBuffersc9_Demo_KinectWaveWalkInvade
    (chartInstance->c1_e_subchartSimstruct);
  sf_exported_auto_stepBuffersc11_Demo_KinectWaveWalkInvade
    (chartInstance->c1_f_subchartSimstruct);
  sf_exported_auto_stepBuffersc42_Demo_KinectWaveWalkInvade
    (chartInstance->c1_g_subchartSimstruct);
  sf_exported_auto_stepBuffersc43_Demo_KinectWaveWalkInvade
    (chartInstance->c1_h_subchartSimstruct);
  sf_exported_auto_stepBuffersc44_Demo_KinectWaveWalkInvade
    (chartInstance->c1_i_subchartSimstruct);
  sf_exported_auto_stepBuffersc10_Demo_KinectWaveWalkInvade
    (chartInstance->c1_j_subchartSimstruct);
  c1_c1_Demo_KinectWaveWalkInvade(chartInstance);
  _SFD_CE_CALL(EVENT_AFTER_BROADCAST_TAG, c1_event_secs,
               chartInstance->c1_sfEvent);
  sf_exported_auto_resetTemporalCounter_c5_Demo_KinectWaveWalkInvade_secs
    (chartInstance->c1_subchartSimstruct);
  sf_exported_auto_resetTemporalCounter_c8_Demo_KinectWaveWalkInvade_secs
    (chartInstance->c1_b_subchartSimstruct);
  sf_exported_auto_resetTemporalCounter_c20_Demo_KinectWaveWalkInvade_secs
    (chartInstance->c1_c_subchartSimstruct);
  sf_exported_auto_resetTemporalCounter_c4_Demo_KinectWaveWalkInvade_secs
    (chartInstance->c1_d_subchartSimstruct);
  sf_exported_auto_resetTemporalCounter_c9_Demo_KinectWaveWalkInvade_secs
    (chartInstance->c1_e_subchartSimstruct);
  sf_exported_auto_resetTemporalCounter_c11_Demo_KinectWaveWalkInvade_secs
    (chartInstance->c1_f_subchartSimstruct);
  sf_exported_auto_resetTemporalCounter_c10_Demo_KinectWaveWalkInvade_secs
    (chartInstance->c1_j_subchartSimstruct);
  sf_exported_auto_deactivate_c5_Demo_KinectWaveWalkInvade_secs
    (chartInstance->c1_subchartSimstruct);
  sf_exported_auto_deactivate_c8_Demo_KinectWaveWalkInvade_secs
    (chartInstance->c1_b_subchartSimstruct);
  sf_exported_auto_deactivate_c20_Demo_KinectWaveWalkInvade_secs
    (chartInstance->c1_c_subchartSimstruct);
  sf_exported_auto_deactivate_c4_Demo_KinectWaveWalkInvade_secs
    (chartInstance->c1_d_subchartSimstruct);
  sf_exported_auto_deactivate_c9_Demo_KinectWaveWalkInvade_secs
    (chartInstance->c1_e_subchartSimstruct);
  sf_exported_auto_deactivate_c11_Demo_KinectWaveWalkInvade_secs
    (chartInstance->c1_f_subchartSimstruct);
  sf_exported_auto_deactivate_callc42_Demo_KinectWaveWalkInvade
    (chartInstance->c1_g_subchartSimstruct);
  sf_exported_auto_deactivate_callc43_Demo_KinectWaveWalkInvade
    (chartInstance->c1_h_subchartSimstruct);
  sf_exported_auto_deactivate_callc44_Demo_KinectWaveWalkInvade
    (chartInstance->c1_i_subchartSimstruct);
  sf_exported_auto_deactivate_c10_Demo_KinectWaveWalkInvade_secs
    (chartInstance->c1_j_subchartSimstruct);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_Demo_KinectWaveWalkInvadeMachineNumber_,
    chartInstance->chartNumber, chartInstance->instanceNumber);
  if (chartInstance->c1_is_active_RPS_Scenario == 1U) {
    sf_exported_auto_check_state_inconsistency_c5_Demo_KinectWaveWalkInvade
      (chartInstance->c1_subchartSimstruct);
  }

  if (chartInstance->c1_is_active_personalSpace_Controller == 1U) {
    sf_exported_auto_check_state_inconsistency_c8_Demo_KinectWaveWalkInvade
      (chartInstance->c1_b_subchartSimstruct);
  }

  if (chartInstance->c1_is_active_wave_Controller == 1U) {
    sf_exported_auto_check_state_inconsistency_c20_Demo_KinectWaveWalkInvade
      (chartInstance->c1_c_subchartSimstruct);
  }
  ...
  if (chartInstance->c1_is_active_Gaze_Controller == 1U) {
    sf_exported_auto_check_state_inconsistency_c9_Demo_KinectWaveWalkInvade
      (chartInstance->c1_e_subchartSimstruct);
  }

  if (chartInstance->c1_is_active_facialExpression_Controller == 1U) {
    sf_exported_auto_check_state_inconsistency_c11_Demo_KinectWaveWalkInvade
      (chartInstance->c1_f_subchartSimstruct);
  }

  if (chartInstance->c1_is_active_personality_Behavior_Factors == 1U) {
    sf_exported_auto_check_state_inconsistency_c42_Demo_KinectWaveWalkInvade
      (chartInstance->c1_g_subchartSimstruct);
  }
  ...
  if (chartInstance->c1_is_active_attention_Controller == 1U) {
    sf_exported_auto_check_state_inconsistency_c10_Demo_KinectWaveWalkInvade
      (chartInstance->c1_j_subchartSimstruct);
  }
}
  ...
  (SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance)
{
  ...
  if (chartInstance->c1_is_active_c1_Demo_KinectWaveWalkInvade == 0U) {
    sf_exported_auto_initBuffersc5_Demo_KinectWaveWalkInvade
      (chartInstance->c1_subchartSimstruct);
    sf_exported_auto_initBuffersc8_Demo_KinectWaveWalkInvade
      (chartInstance->c1_b_subchartSimstruct);
    sf_exported_auto_initBuffersc20_Demo_KinectWaveWalkInvade
      (chartInstance->c1_c_subchartSimstruct);
    sf_exported_auto_initBuffersc4_Demo_KinectWaveWalkInvade
      (chartInstance->c1_d_subchartSimstruct);
    sf_exported_auto_initBuffersc9_Demo_KinectWaveWalkInvade
      (chartInstance->c1_e_subchartSimstruct);
    sf_exported_auto_initBuffersc11_Demo_KinectWaveWalkInvade
      (chartInstance->c1_f_subchartSimstruct);
    sf_exported_auto_initBuffersc42_Demo_KinectWaveWalkInvade
      (chartInstance->c1_g_subchartSimstruct);
    sf_exported_auto_initBuffersc43_Demo_KinectWaveWalkInvade
      (chartInstance->c1_h_subchartSimstruct);
    sf_exported_auto_initBuffersc44_Demo_KinectWaveWalkInvade
      (chartInstance->c1_i_subchartSimstruct);
    sf_exported_auto_initBuffersc10_Demo_KinectWaveWalkInvade
      (chartInstance->c1_j_subchartSimstruct);
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 0U, chartInstance->c1_sfEvent);
    chartInstance->c1_is_active_c1_Demo_KinectWaveWalkInvade = 1U;
    _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 0U, chartInstance->c1_sfEvent);
    chartInstance->c1_is_active_RPS_Scenario = 1U;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, chartInstance->c1_sfEvent);
    chartInstance->c1_tp_RPS_Scenario = 1U;
    sf_exported_auto_enterc5_Demo_KinectWaveWalkInvade
      (chartInstance->c1_subchartSimstruct);
    chartInstance->c1_is_active_Gaze_Controller = 1U;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, chartInstance->c1_sfEvent);
    chartInstance->c1_tp_Gaze_Controller = 1U;
    sf_exported_auto_enterc9_Demo_KinectWaveWalkInvade
      (chartInstance->c1_e_subchartSimstruct);
    chartInstance->c1_is_active_idlePose_Controller = 1U;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 6U, chartInstance->c1_sfEvent);
    chartInstance->c1_tp_idlePose_Controller = 1U;
    sf_exported_auto_enterc4_Demo_KinectWaveWalkInvade
      (chartInstance->c1_d_subchartSimstruct);
    chartInstance->c1_is_active_facialExpression_Controller = 1U;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 5U, chartInstance->c1_sfEvent);
    chartInstance->c1_tp_facialExpression_Controller = 1U;
    sf_exported_auto_enterc11_Demo_KinectWaveWalkInvade
      (chartInstance->c1_f_subchartSimstruct);
    chartInstance->c1_is_active_personalSpace_Controller = 1U;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 7U, chartInstance->c1_sfEvent);
    chartInstance->c1_tp_personalSpace_Controller = 1U;
    sf_exported_auto_enterc8_Demo_KinectWaveWalkInvade
      (chartInstance->c1_b_subchartSimstruct);
    ...
    sf_exported_auto_duringc11_Demo_KinectWaveWalkInvade
      (chartInstance->c1_f_subchartSimstruct);
    ...
    sf_exported_auto_duringc8_Demo_KinectWaveWalkInvade
      (chartInstance->c1_b_subchartSimstruct);
    ...
    sf_exported_auto_duringc20_Demo_KinectWaveWalkInvade
      (chartInstance->c1_c_subchartSimstruct);
    ...
    sf_exported_auto_duringc10_Demo_KinectWaveWalkInvade
      (chartInstance->c1_j_subchartSimstruct);
    _SFD_CS_CALL(EXIT_OUT_OF_FUNCTION_TAG, 2U, chartInstance->c1_sfEvent);
    _SFD_CS_CALL(STATE_ENTER_DURING_FUNCTION_TAG, 8U, chartInstance->c1_sfEvent);
    sf_exported_auto_duringc42_Demo_KinectWaveWalkInvade
      (chartInstance->c1_g_subchartSimstruct);
    ...
    sf_exported_auto_duringc43_Demo_KinectWaveWalkInvade
      (chartInstance->c1_h_subchartSimstruct);
    ...
    sf_exported_auto_duringc44_Demo_KinectWaveWalkInvade
      (chartInstance->c1_i_subchartSimstruct);
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  const mxArray *c1_y = NULL;
  SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance;
  chartInstance = (SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *)
    chartInstanceVoid;
...
const mxArray *sf_c1_Demo_KinectWaveWalkInvade_get_eml_resolved_functions_info
  (void)
{
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_BML_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'BML\' (#3210) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_BML1_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'BML1\' (#3226) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_BML2_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'BML2\' (#3225) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_BORED_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'BORED\' (#3205) in the initialization routine of the chart.\n");
  }
  ...
  (SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_BOREDOM_THRESHOLD_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'BOREDOM_THRESHOLD\' (#3175) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_CONTEMPT_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'CONTEMPT\' (#3204) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_EXCITE_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'EXCITE\' (#3209) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_FEAR_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'FEAR\' (#3207) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_FRUST_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'FRUST\' (#3206) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_GAZE_GUI_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'GAZE_GUI\' (#3189) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_GAZE_SOFTEYE_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'GAZE_SOFTEYE\' (#3190) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_GAZE_USER_HAND_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'GAZE_USER_HAND\' (#3191) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_GAZE_WIN_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'GAZE_WIN\' (#3197) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_HAPPY_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'HAPPY\' (#3202) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_IDLE_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'IDLE\' (#3208) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_P_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'P\' (#3183) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_SAD_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'SAD\' (#3203) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_STATE_BEFORE_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'STATE_BEFORE\' (#3199) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_STATE_GO_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'STATE_GO\' (#3193) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_STATE_HAND_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'STATE_HAND\' (#3194) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_STATE_OVER_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'STATE_OVER\' (#3195) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_STATE_READY_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'STATE_READY\' (#3192) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_STATE_RESULT_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'STATE_RESULT\' (#3200) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_STATE_WAIT_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'STATE_WAIT\' (#3201) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_avert_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'avert\' (#3188) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_avertH_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'avertH\' (#3239) in the initialization routine of the chart.\n");
  }
  ...
  (SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_avert_gaze_dirs_chance_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'avert_gaze_dirs_chance\' (#3248) in the initialization routine of the chart.\n");
  }
  ...
  (SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_avert_gaze_duration_factor_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'avert_gaze_duration_factor\' (#3246) in the initialization routine of the chart.\n");
  }
  ...
  (SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_avert_head_frequency_factor_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'avert_head_frequency_factor\' (#3247) in the initialization routine of the chart.\n");
  }
  ...
  (SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_avert_head_speed_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'avert_head_speed\' (#3249) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_bHand_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'bHand\' (#3170) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_bmlsH_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'bmlsH\' (#3232) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_bmlsL_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'bmlsL\' (#3230) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_bmlsM_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'bmlsM\' (#3237) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_bodyBusyFlag_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'bodyBusyFlag\' (#3228) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_boredom_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'boredom\' (#3174) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_diff_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'diff\' (#3168) in the initialization routine of the chart.\n");
  }
  ...
  (SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_emotion_amount_factor_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'emotion_amount_factor\' (#3257) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_faceBusyFlag_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'faceBusyFlag\' (#3242) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_fileID_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'fileID\' (#3216) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_gazing_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'gazing\' (#3196) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_interest_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'interest\' (#3178) in the initialization routine of the chart.\n");
  }
  ...
  (SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_mutual_gaze_duration_factor_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'mutual_gaze_duration_factor\' (#3245) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_n_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'n\' (#3229) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_pa_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'pa\' (#3180) in the initialization routine of the chart.\n");
  }
  ...
  (SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_pose_chance_factor_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'pose_chance_factor\' (#3250) in the initialization routine of the chart.\n");
  }
  ...
  (SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_pose_change_flag_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'pose_change_flag\' (#3256) in the initialization routine of the chart.\n");
  }
  ...
  (SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_pose_frequency_factor_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'pose_frequency_factor\' (#3252) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_pose_lean_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'pose_lean\' (#3254) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_pose_lean_flag_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'pose_lean_flag\' (#3255) in the initialization routine of the chart.\n");
  }
  ...
  (SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_pose_selfAdaptor_chance_factor_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'pose_selfAdaptor_chance_factor\' (#3251) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_pose_speed_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'pose_speed\' (#3253) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_pr_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'pr\' (#3211) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_r_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'r\' (#3179) in the initialization routine of the chart.\n");
  }
  ...
  (SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_randAvertGazeChance_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'randAvertGazeChance\' (#3176) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_randGazeDur_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'randGazeDur\' (#3182) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_randPoseChance_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'randPoseChance\' (#3177) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_randSlowPose_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'randSlowPose\' (#3198) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_randSmile_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'randSmile\' (#3173) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_s_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'s\' (#3181) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_t_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'t\' (#3227) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_temp_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'temp\' (#3167) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_uHand_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'uHand\' (#3169) in the initialization routine of the chart.\n");
  }
...
void sf_c1_Demo_KinectWaveWalkInvade_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c1_Demo_KinectWaveWalkInvade_get_autoinheritance_info(void)
{
...
mxArray *sf_c1_Demo_KinectWaveWalkInvade_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c1_Demo_KinectWaveWalkInvade_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c1_Demo_KinectWaveWalkInvade(void)
{
  ...
  sf_c1_Demo_KinectWaveWalkInvade_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c1_Demo_KinectWaveWalkInvade(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_Demo_KinectWaveWalkInvadeInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c1_Demo_KinectWaveWalkInvade
    ((SFc1_Demo_KinectWaveWalkInvadeInstanceStruct*) chartInstanceVar);
  initialize_c1_Demo_KinectWaveWalkInvade
    ((SFc1_Demo_KinectWaveWalkInvadeInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c1_Demo_KinectWaveWalkInvade(void *chartInstanceVar)
{
  enable_c1_Demo_KinectWaveWalkInvade
    ((SFc1_Demo_KinectWaveWalkInvadeInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c1_Demo_KinectWaveWalkInvade(void
  *chartInstanceVar)
{
  disable_c1_Demo_KinectWaveWalkInvade
    ((SFc1_Demo_KinectWaveWalkInvadeInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c1_Demo_KinectWaveWalkInvade(void
  *chartInstanceVar)
{
  sf_gateway_c1_Demo_KinectWaveWalkInvade
    ((SFc1_Demo_KinectWaveWalkInvadeInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c1_Demo_KinectWaveWalkInvade
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_Demo_KinectWaveWalkInvade
    ((SFc1_Demo_KinectWaveWalkInvadeInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_Demo_KinectWaveWalkInvade();/* state var info */
...
extern void sf_internal_set_sim_state_c1_Demo_KinectWaveWalkInvade(SimStruct* S,
  const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c1_Demo_KinectWaveWalkInvade();/* state var info */
  ...
  set_sim_state_c1_Demo_KinectWaveWalkInvade
    ((SFc1_Demo_KinectWaveWalkInvadeInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c1_Demo_KinectWaveWalkInvade
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c1_Demo_KinectWaveWalkInvade(S);
}

static void sf_opaque_set_sim_state_c1_Demo_KinectWaveWalkInvade(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c1_Demo_KinectWaveWalkInvade(S, st);
}

static void sf_opaque_terminate_c1_Demo_KinectWaveWalkInvade(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_Demo_KinectWaveWalkInvadeInstanceStruct*)
                    chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c1_Demo_KinectWaveWalkInvade
      ((SFc1_Demo_KinectWaveWalkInvadeInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc1_Demo_KinectWaveWalkInvade
    ((SFc1_Demo_KinectWaveWalkInvadeInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_Demo_KinectWaveWalkInvade(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c1_Demo_KinectWaveWalkInvade(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c1_Demo_KinectWaveWalkInvade(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_Demo_KinectWaveWalkInvade(SimStruct *S)
{
  SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc1_Demo_KinectWaveWalkInvadeInstanceStruct *)utMalloc
    (sizeof(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc1_Demo_KinectWaveWalkInvadeInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c1_Demo_KinectWaveWalkInvade;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c1_Demo_KinectWaveWalkInvade;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c1_Demo_KinectWaveWalkInvade;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c1_Demo_KinectWaveWalkInvade;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c1_Demo_KinectWaveWalkInvade;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c1_Demo_KinectWaveWalkInvade;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c1_Demo_KinectWaveWalkInvade;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_Demo_KinectWaveWalkInvade;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_Demo_KinectWaveWalkInvade;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_Demo_KinectWaveWalkInvade;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c1_Demo_KinectWaveWalkInvade;
...
void c1_Demo_KinectWaveWalkInvade_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_Demo_KinectWaveWalkInvade(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_Demo_KinectWaveWalkInvade(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_Demo_KinectWaveWalkInvade(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_Demo_KinectWaveWalkInvade_method_dispatcher.\n"
