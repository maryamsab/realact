#ifndef __c44_Expriment_Gaze_h__
#define __c44_Expriment_Gaze_h__
...
/* Type Definitions */
#ifndef typedef_SFc44_Expriment_GazeInstanceStruct
#define typedef_SFc44_Expriment_GazeInstanceStruct
...
typedef struct {
  ...
  uint8_T c44_is_active_c44_Expriment_Gaze;
  uint8_T c44_is_c44_Expriment_Gaze;
...
#endif                                 /*typedef_SFc44_Expriment_GazeInstanceStruct*/
...
extern const mxArray *sf_c44_Expriment_Gaze_get_eml_resolved_functions_info(void);
extern boolean_T sf_exported_auto_isStablec44_Expriment_Gaze(SimStruct *c44_S);
extern void sf_exported_auto_duringc44_Expriment_Gaze(SimStruct *c44_S);
extern void sf_exported_auto_enterc44_Expriment_Gaze(SimStruct *c44_S);
extern void sf_exported_auto_enablec50_lib_affectiveChar_behavior(SimStruct
  *c44_S);
extern void sf_exported_auto_exitc44_Expriment_Gaze(SimStruct *c44_S);
extern void sf_exported_auto_disablec50_lib_affectiveChar_behavior(SimStruct
  *c44_S);
extern void sf_exported_auto_gatewayc44_Expriment_Gaze(SimStruct *c44_S);
extern void sf_exported_auto_gatewayc50_lib_affectiveChar_behavior(SimStruct
  *c44_S);
extern void sf_exported_auto_enablec44_Expriment_Gaze(SimStruct *c44_S);
extern void sf_exported_auto_enablec50_lib_affectiveChar_behavior(SimStruct
  *c44_S);
extern void sf_exported_auto_disablec44_Expriment_Gaze(SimStruct *c44_S);
extern void sf_exported_auto_disablec50_lib_affectiveChar_behavior(SimStruct
  *c44_S);
extern void sf_exported_auto_stepBuffersc44_Expriment_Gaze(SimStruct *c44_S);
extern void sf_exported_auto_stepBuffersc50_lib_affectiveChar_behavior(SimStruct
  *c44_S);
extern void sf_exported_auto_initBuffersc44_Expriment_Gaze(SimStruct *c44_S);
extern void sf_exported_auto_initBuffersc50_lib_affectiveChar_behavior(SimStruct
  *c44_S);
extern void sf_exported_auto_activate_callc44_Expriment_Gaze(SimStruct *c44_S);
extern void sf_exported_auto_activate_callc50_lib_affectiveChar_behavior
  (SimStruct *c44_S);
extern void sf_exported_auto_increment_call_counterc44_Expriment_Gaze(SimStruct *
  c44_S);
extern void
  sf_exported_auto_increment_call_counterc50_lib_affectiveChar_behavior
  (SimStruct *c44_S);
extern void sf_exported_auto_reset_call_counterc44_Expriment_Gaze(SimStruct
  *c44_S);
extern void sf_exported_auto_reset_call_counterc50_lib_affectiveChar_behavior
  (SimStruct *c44_S);
extern void sf_exported_auto_deactivate_callc44_Expriment_Gaze(SimStruct *c44_S);
extern void sf_exported_auto_deactivate_callc50_lib_affectiveChar_behavior
  (SimStruct *c44_S);
extern void sf_exported_auto_initc44_Expriment_Gaze(SimStruct *c44_S);
extern const mxArray *sf_exported_auto_getSimstatec44_Expriment_Gaze(SimStruct
  *c44_S);
extern const mxArray *sf_internal_get_sim_state_c44_Expriment_Gaze(SimStruct
  *c44_S);
extern void sf_exported_auto_setSimstatec44_Expriment_Gaze(SimStruct *c44_S,
  const mxArray *c44_in);
extern void sf_internal_set_sim_state_c44_Expriment_Gaze(SimStruct *c44_S, const
  mxArray *c44_in);
...
extern void c44_Expriment_Gaze_method_dispatcher(SimStruct *S, int_T method,
  void *data);
