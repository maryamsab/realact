...
static void initialize_c55_Expriment_Gaze(SFc55_Expriment_GazeInstanceStruct
  *chartInstance);
static void initialize_params_c55_Expriment_Gaze
  (SFc55_Expriment_GazeInstanceStruct *chartInstance);
static void enable_c55_Expriment_Gaze(SFc55_Expriment_GazeInstanceStruct
  *chartInstance);
static void disable_c55_Expriment_Gaze(SFc55_Expriment_GazeInstanceStruct
  *chartInstance);
static void c55_update_debugger_state_c55_Expriment_Gaze
  (SFc55_Expriment_GazeInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c55_Expriment_Gaze
  (SFc55_Expriment_GazeInstanceStruct *chartInstance);
static void set_sim_state_c55_Expriment_Gaze(SFc55_Expriment_GazeInstanceStruct *
  chartInstance, const mxArray *c55_st);
static void finalize_c55_Expriment_Gaze(SFc55_Expriment_GazeInstanceStruct
  *chartInstance);
static void sf_gateway_c55_Expriment_Gaze(SFc55_Expriment_GazeInstanceStruct
  *chartInstance);
static void initSimStructsc55_Expriment_Gaze(SFc55_Expriment_GazeInstanceStruct *
  chartInstance);
...
static const mxArray *c55_sf_marshallOut(void *chartInstanceVoid, void
  *c55_inData);
static real_T c55_emlrt_marshallIn(SFc55_Expriment_GazeInstanceStruct
  *chartInstance, const mxArray *c55_v2, const char_T *c55_identifier);
static real_T c55_b_emlrt_marshallIn(SFc55_Expriment_GazeInstanceStruct
...
static const mxArray *c55_b_sf_marshallOut(void *chartInstanceVoid, void
  *c55_inData);
static boolean_T c55_c_emlrt_marshallIn(SFc55_Expriment_GazeInstanceStruct
  *chartInstance, const mxArray *c55_u, const emlrtMsgIdentifier *c55_parentId);
...
static const mxArray *c55_c_sf_marshallOut(void *chartInstanceVoid, void
  *c55_inData);
static int32_T c55_d_emlrt_marshallIn(SFc55_Expriment_GazeInstanceStruct
  *chartInstance, const mxArray *c55_u, const emlrtMsgIdentifier *c55_parentId);
static void c55_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c55_mxArrayInData, const char_T *c55_varName, void *c55_outData);
static uint8_T c55_e_emlrt_marshallIn(SFc55_Expriment_GazeInstanceStruct
  *chartInstance, const mxArray *c55_b_is_active_c55_Expriment_Gaze, const
  char_T *c55_identifier);
static uint8_T c55_f_emlrt_marshallIn(SFc55_Expriment_GazeInstanceStruct
  *chartInstance, const mxArray *c55_u, const emlrtMsgIdentifier *c55_parentId);
static void init_dsm_address_info(SFc55_Expriment_GazeInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c55_is_active_c55_Expriment_Gaze = 0U;
}
  ...
  (SFc55_Expriment_GazeInstanceStruct *chartInstance)
{
  ...
  c55_b_hoistedGlobal = chartInstance->c55_is_active_c55_Expriment_Gaze;
  ...
  chartInstance, const mxArray *c55_st)
{
  ...
  *c55_v2 = c55_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c55_u,
    0)), "v2");
  chartInstance->c55_is_active_c55_Expriment_Gaze = c55_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c55_u, 1)),
     "is_active_c55_Expriment_Gaze");
  sf_mex_destroy(&c55_u);
  c55_update_debugger_state_c55_Expriment_Gaze(chartInstance);
  ...
  *c55_inData)
{
  ...
  const mxArray *c55_y = NULL;
  SFc55_Expriment_GazeInstanceStruct *chartInstance;
  chartInstance = (SFc55_Expriment_GazeInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c55_Expriment_Gaze_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c55_identifier)
{
  ...
  c55_y = c55_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c55_b_is_active_c55_Expriment_Gaze), &c55_thisId);
  sf_mex_destroy(&c55_b_is_active_c55_Expriment_Gaze);
  return c55_y;
}
...
void sf_c55_Expriment_Gaze_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c55_Expriment_Gaze_get_autoinheritance_info(void)
{
...
mxArray *sf_c55_Expriment_Gaze_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c55_Expriment_Gaze_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c55_Expriment_Gaze(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[4],T\"v2\",},{M[8],M[0],T\"is_active_c55_Expriment_Gaze\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c55_Expriment_Gaze_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc55_Expriment_GazeInstanceStruct *)
...
static void sf_opaque_initialize_c55_Expriment_Gaze(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc55_Expriment_GazeInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c55_Expriment_Gaze((SFc55_Expriment_GazeInstanceStruct*)
    chartInstanceVar);
  initialize_c55_Expriment_Gaze((SFc55_Expriment_GazeInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c55_Expriment_Gaze(void *chartInstanceVar)
{
  enable_c55_Expriment_Gaze((SFc55_Expriment_GazeInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c55_Expriment_Gaze(void *chartInstanceVar)
{
  disable_c55_Expriment_Gaze((SFc55_Expriment_GazeInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c55_Expriment_Gaze(void *chartInstanceVar)
{
  sf_gateway_c55_Expriment_Gaze((SFc55_Expriment_GazeInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c55_Expriment_Gaze(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c55_Expriment_Gaze
    ((SFc55_Expriment_GazeInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c55_Expriment_Gaze();/* state var info */
...
extern void sf_internal_set_sim_state_c55_Expriment_Gaze(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c55_Expriment_Gaze();/* state var info */
  ...
  set_sim_state_c55_Expriment_Gaze((SFc55_Expriment_GazeInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c55_Expriment_Gaze(SimStruct* S)
{
  return sf_internal_get_sim_state_c55_Expriment_Gaze(S);
}

static void sf_opaque_set_sim_state_c55_Expriment_Gaze(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c55_Expriment_Gaze(S, st);
}

static void sf_opaque_terminate_c55_Expriment_Gaze(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc55_Expriment_GazeInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c55_Expriment_Gaze((SFc55_Expriment_GazeInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc55_Expriment_Gaze((SFc55_Expriment_GazeInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c55_Expriment_Gaze(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c55_Expriment_Gaze(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c55_Expriment_Gaze(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c55_Expriment_Gaze(SimStruct *S)
{
  SFc55_Expriment_GazeInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc55_Expriment_GazeInstanceStruct *)utMalloc(sizeof
    (SFc55_Expriment_GazeInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc55_Expriment_GazeInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c55_Expriment_Gaze;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c55_Expriment_Gaze;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c55_Expriment_Gaze;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c55_Expriment_Gaze;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c55_Expriment_Gaze;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c55_Expriment_Gaze;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c55_Expriment_Gaze;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c55_Expriment_Gaze;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c55_Expriment_Gaze;
  chartInstance->chartInfo.mdlStart = mdlStart_c55_Expriment_Gaze;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c55_Expriment_Gaze;
...
void c55_Expriment_Gaze_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c55_Expriment_Gaze(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c55_Expriment_Gaze(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c55_Expriment_Gaze(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c55_Expriment_Gaze_method_dispatcher.\n"
