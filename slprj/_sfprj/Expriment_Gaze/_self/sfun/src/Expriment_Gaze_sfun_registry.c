...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_Expriment_Gaze_process_check_sum_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_lib_affectiveChar_behavior_process_check_sum_call( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_Expriment_Gaze_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
...
{
  extern unsigned int sf_Expriment_Gaze_autoinheritance_info( int nlhs, mxArray *
  ...
  if (strcmp(machineName, "Expriment_Gaze") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_Expriment_Gaze_autoinheritance_info(nlhs,plhs,3,newRhs);
  }
...
unsigned int sf_process_get_third_party_uses_info_call( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_Expriment_Gaze_third_party_uses_info( int nlhs, mxArray
    * plhs[], int nrhs, const mxArray * prhs[] );
  ...
  if (strcmp(machineName, "Expriment_Gaze") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_Expriment_Gaze_third_party_uses_info(nlhs,plhs,3,newRhs);
  }
...
unsigned int sf_process_get_updateBuildInfo_args_info_call( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_Expriment_Gaze_updateBuildInfo_args_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  ...
  if (strcmp(machineName, "Expriment_Gaze") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_Expriment_Gaze_updateBuildInfo_args_info(nlhs,plhs,3,newRhs);
  }
...
unsigned int sf_process_get_eml_resolved_functions_info_call( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_Expriment_Gaze_get_eml_resolved_functions_info( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  extern unsigned int
  ...
  if (strcmp(machineName, "Expriment_Gaze") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_Expriment_Gaze_get_eml_resolved_functions_info(nlhs,plhs,2,newRhs);
  }
...
extern unsigned int sf_Expriment_Gaze_method_dispatcher(SimStruct *S, unsigned
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"Expriment_Gaze")) {
    return(sf_Expriment_Gaze_method_dispatcher(simstructPtr,chartFileNumber,
...
extern void Expriment_Gaze_terminator(void);
...
extern void Expriment_Gaze_initializer(void);
extern void lib_affectiveChar_behavior_initializer(void);
extern void Expriment_Gaze_register_exported_symbols(SimStruct* S);
extern void lib_affectiveChar_behavior_register_exported_symbols(SimStruct* S);
extern void Expriment_Gaze_debug_initialize(struct SfDebugInstanceStruct*);
...
{
  Expriment_Gaze_register_exported_symbols(S);
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfGlobalMdlStartCallCounts == 1) {
    ...
    if (!simModeIsRTWGen) {
      Expriment_Gaze_debug_initialize(sfGlobalDebugInstanceStruct);
    }

    Expriment_Gaze_initializer();
    if (!simModeIsRTWGen) {
