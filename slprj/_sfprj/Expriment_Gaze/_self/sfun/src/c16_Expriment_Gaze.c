...
static void initialize_c16_Expriment_Gaze(SFc16_Expriment_GazeInstanceStruct
  *chartInstance);
static void initialize_params_c16_Expriment_Gaze
  (SFc16_Expriment_GazeInstanceStruct *chartInstance);
static void enable_c16_Expriment_Gaze(SFc16_Expriment_GazeInstanceStruct
  *chartInstance);
static void disable_c16_Expriment_Gaze(SFc16_Expriment_GazeInstanceStruct
  *chartInstance);
static void c16_update_debugger_state_c16_Expriment_Gaze
  (SFc16_Expriment_GazeInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c16_Expriment_Gaze
  (SFc16_Expriment_GazeInstanceStruct *chartInstance);
static void set_sim_state_c16_Expriment_Gaze(SFc16_Expriment_GazeInstanceStruct *
  chartInstance, const mxArray *c16_st);
static void finalize_c16_Expriment_Gaze(SFc16_Expriment_GazeInstanceStruct
  *chartInstance);
static void sf_gateway_c16_Expriment_Gaze(SFc16_Expriment_GazeInstanceStruct
  *chartInstance);
static void initSimStructsc16_Expriment_Gaze(SFc16_Expriment_GazeInstanceStruct *
  chartInstance);
static void c16_encStr2Arr(SFc16_Expriment_GazeInstanceStruct *chartInstance,
...
static void c16_emlrt_marshallIn(SFc16_Expriment_GazeInstanceStruct
  *chartInstance, const mxArray *c16_sprintf, const char_T *c16_identifier,
  char_T c16_y_data[], int32_T c16_y_sizes[2]);
static void c16_b_emlrt_marshallIn(SFc16_Expriment_GazeInstanceStruct
...
static const mxArray *c16_sf_marshallOut(void *chartInstanceVoid, void
  *c16_inData);
static void c16_c_emlrt_marshallIn(SFc16_Expriment_GazeInstanceStruct
  *chartInstance, const mxArray *c16_arrBML, const char_T *c16_identifier,
  real_T c16_y[1000]);
static void c16_d_emlrt_marshallIn(SFc16_Expriment_GazeInstanceStruct
  *chartInstance, const mxArray *c16_u, const emlrtMsgIdentifier *c16_parentId,
  real_T c16_y[1000]);
...
static const mxArray *c16_b_sf_marshallOut(void *chartInstanceVoid, void
  *c16_inData);
static real_T c16_e_emlrt_marshallIn(SFc16_Expriment_GazeInstanceStruct
  *chartInstance, const mxArray *c16_u, const emlrtMsgIdentifier *c16_parentId);
...
static void c16_f_emlrt_marshallIn(SFc16_Expriment_GazeInstanceStruct
  *chartInstance, const mxArray *c16_u, const emlrtMsgIdentifier *c16_parentId,
  char_T c16_y_data[], int32_T c16_y_sizes[2]);
...
static void c16_g_emlrt_marshallIn(SFc16_Expriment_GazeInstanceStruct
  *chartInstance, const mxArray *c16_u, const emlrtMsgIdentifier *c16_parentId,
...
static const mxArray *c16_e_sf_marshallOut(void *chartInstanceVoid, void
  *c16_inData);
static int32_T c16_h_emlrt_marshallIn(SFc16_Expriment_GazeInstanceStruct
  *chartInstance, const mxArray *c16_u, const emlrtMsgIdentifier *c16_parentId);
static void c16_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c16_mxArrayInData, const char_T *c16_varName, void *c16_outData);
static uint8_T c16_i_emlrt_marshallIn(SFc16_Expriment_GazeInstanceStruct
  *chartInstance, const mxArray *c16_b_is_active_c16_Expriment_Gaze, const
  char_T *c16_identifier);
static uint8_T c16_j_emlrt_marshallIn(SFc16_Expriment_GazeInstanceStruct
  *chartInstance, const mxArray *c16_u, const emlrtMsgIdentifier *c16_parentId);
static void init_dsm_address_info(SFc16_Expriment_GazeInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c16_is_active_c16_Expriment_Gaze = 0U;
}
  ...
  (SFc16_Expriment_GazeInstanceStruct *chartInstance)
{
  ...
  c16_hoistedGlobal = chartInstance->c16_is_active_c16_Expriment_Gaze;
  ...
  chartInstance, const mxArray *c16_st)
{
  ...
  chartInstance->c16_is_active_c16_Expriment_Gaze = c16_i_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c16_u, 1)),
     "is_active_c16_Expriment_Gaze");
  sf_mex_destroy(&c16_u);
  c16_update_debugger_state_c16_Expriment_Gaze(chartInstance);
  ...
  c16_chartNumber, uint32_T c16_instanceNumber)
{
  ...
  _SFD_SCRIPT_TRANSLATION(c16_chartNumber, c16_instanceNumber, 0U,
    ...
    "C:\\Users\\root180\\Documents\\affective-project\\24-12-2015-Matlab\\countDigits.m"));
  ...
  *c16_inData)
{
  ...
  const mxArray *c16_y = NULL;
  SFc16_Expriment_GazeInstanceStruct *chartInstance;
  chartInstance = (SFc16_Expriment_GazeInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c16_Expriment_Gaze_get_eml_resolved_functions_info(void)
{
...
static void c16_info_helper(const mxArray **c16_info)
{
  ...
  sf_mex_addfield(*c16_info, c16_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 7);
  sf_mex_addfield(*c16_info, c16_emlrt_marshallOut(
    "[E]C:/Users/root180/Documents/affective-project/24-12-2015-Matlab/countDigits.m"),
                  "resolved", "resolved", 7);
  ...
  char_T *c16_identifier)
{
  ...
  c16_y = c16_j_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c16_b_is_active_c16_Expriment_Gaze), &c16_thisId);
  sf_mex_destroy(&c16_b_is_active_c16_Expriment_Gaze);
  return c16_y;
}
...
void sf_c16_Expriment_Gaze_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c16_Expriment_Gaze_get_autoinheritance_info(void)
{
...
mxArray *sf_c16_Expriment_Gaze_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c16_Expriment_Gaze_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c16_Expriment_Gaze(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[14],T\"arrBML\",},{M[8],M[0],T\"is_active_c16_Expriment_Gaze\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c16_Expriment_Gaze_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc16_Expriment_GazeInstanceStruct *)
...
static void sf_opaque_initialize_c16_Expriment_Gaze(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc16_Expriment_GazeInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c16_Expriment_Gaze((SFc16_Expriment_GazeInstanceStruct*)
    chartInstanceVar);
  initialize_c16_Expriment_Gaze((SFc16_Expriment_GazeInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c16_Expriment_Gaze(void *chartInstanceVar)
{
  enable_c16_Expriment_Gaze((SFc16_Expriment_GazeInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c16_Expriment_Gaze(void *chartInstanceVar)
{
  disable_c16_Expriment_Gaze((SFc16_Expriment_GazeInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c16_Expriment_Gaze(void *chartInstanceVar)
{
  sf_gateway_c16_Expriment_Gaze((SFc16_Expriment_GazeInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c16_Expriment_Gaze(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c16_Expriment_Gaze
    ((SFc16_Expriment_GazeInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c16_Expriment_Gaze();/* state var info */
...
extern void sf_internal_set_sim_state_c16_Expriment_Gaze(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c16_Expriment_Gaze();/* state var info */
  ...
  set_sim_state_c16_Expriment_Gaze((SFc16_Expriment_GazeInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c16_Expriment_Gaze(SimStruct* S)
{
  return sf_internal_get_sim_state_c16_Expriment_Gaze(S);
}

static void sf_opaque_set_sim_state_c16_Expriment_Gaze(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c16_Expriment_Gaze(S, st);
}

static void sf_opaque_terminate_c16_Expriment_Gaze(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc16_Expriment_GazeInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c16_Expriment_Gaze((SFc16_Expriment_GazeInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc16_Expriment_Gaze((SFc16_Expriment_GazeInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c16_Expriment_Gaze(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c16_Expriment_Gaze(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(1757901206U));
  ssSetChecksum1(S,(1862884236U));
  ssSetChecksum2(S,(3570843789U));
  ssSetChecksum3(S,(3484449151U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c16_Expriment_Gaze(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c16_Expriment_Gaze(SimStruct *S)
{
  SFc16_Expriment_GazeInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc16_Expriment_GazeInstanceStruct *)utMalloc(sizeof
    (SFc16_Expriment_GazeInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc16_Expriment_GazeInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c16_Expriment_Gaze;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c16_Expriment_Gaze;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c16_Expriment_Gaze;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c16_Expriment_Gaze;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c16_Expriment_Gaze;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c16_Expriment_Gaze;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c16_Expriment_Gaze;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c16_Expriment_Gaze;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c16_Expriment_Gaze;
  chartInstance->chartInfo.mdlStart = mdlStart_c16_Expriment_Gaze;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c16_Expriment_Gaze;
...
void c16_Expriment_Gaze_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c16_Expriment_Gaze(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c16_Expriment_Gaze(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c16_Expriment_Gaze(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c16_Expriment_Gaze_method_dispatcher.\n"
