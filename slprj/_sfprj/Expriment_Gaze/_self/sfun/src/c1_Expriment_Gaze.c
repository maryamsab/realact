...
static void initialize_c1_Expriment_Gaze(SFc1_Expriment_GazeInstanceStruct
  *chartInstance);
static void initialize_params_c1_Expriment_Gaze
  (SFc1_Expriment_GazeInstanceStruct *chartInstance);
static void enable_c1_Expriment_Gaze(SFc1_Expriment_GazeInstanceStruct
  *chartInstance);
static void disable_c1_Expriment_Gaze(SFc1_Expriment_GazeInstanceStruct
  *chartInstance);
static void c1_update_debugger_state_c1_Expriment_Gaze
  (SFc1_Expriment_GazeInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c1_Expriment_Gaze
  (SFc1_Expriment_GazeInstanceStruct *chartInstance);
static void set_sim_state_c1_Expriment_Gaze(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, const mxArray *c1_st);
static void c1_set_sim_state_side_effects_c1_Expriment_Gaze
  (SFc1_Expriment_GazeInstanceStruct *chartInstance);
static void finalize_c1_Expriment_Gaze(SFc1_Expriment_GazeInstanceStruct
  *chartInstance);
static void sf_gateway_c1_Expriment_Gaze(SFc1_Expriment_GazeInstanceStruct
  *chartInstance);
static void c1_c1_Expriment_Gaze(SFc1_Expriment_GazeInstanceStruct
  *chartInstance);
static void initSimStructsc1_Expriment_Gaze(SFc1_Expriment_GazeInstanceStruct
  *chartInstance);
static void c1_sendBMLbyPriority(SFc1_Expriment_GazeInstanceStruct
  *chartInstance);
static void c1_enter_atomic_sendH(SFc1_Expriment_GazeInstanceStruct
  *chartInstance);
static void c1_enter_atomic_sendM(SFc1_Expriment_GazeInstanceStruct
  *chartInstance);
static void c1_low(SFc1_Expriment_GazeInstanceStruct *chartInstance);
static void c1_encStr2Arr(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  real_T c1_myarr256[1000]);
static boolean_T c1_isequal(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  real_T c1_varargin_1[1000], real_T c1_varargin_2[1000]);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber, uint32_T c1_instanceNumber);
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData);
static real_T c1_emlrt_marshallIn(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, const mxArray *c1_nargout, const char_T *c1_identifier);
static real_T c1_b_emlrt_marshallIn(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_b_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_c_emlrt_marshallIn(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId,
  real_T c1_y[1000]);
...
static const mxArray *c1_d_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_d_emlrt_marshallIn(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, const mxArray *c1_newBmls, const char_T *c1_identifier, real_T
  c1_y[5000]);
static void c1_e_emlrt_marshallIn(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId,
  real_T c1_y[5000]);
...
static const mxArray *c1_e_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static boolean_T c1_f_emlrt_marshallIn(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
...
static void c1_removeQueue(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  real_T c1_bmls[5000], real_T c1_newBmls[5000]);
static real_T c1_isEmptyQueue(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  real_T c1_bmls[5000]);
static const mxArray *c1_f_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static int8_T c1_g_emlrt_marshallIn(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_g_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static int32_T c1_h_emlrt_marshallIn(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_f_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_h_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static uint8_T c1_i_emlrt_marshallIn(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, const mxArray *c1_b_tp_RPS_Scenario, const char_T
  *c1_identifier);
static uint8_T c1_j_emlrt_marshallIn(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
...
static const mxArray *c1_k_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_k_emlrt_marshallIn(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, const mxArray *c1_BML, const char_T *c1_identifier, real_T
  c1_y[1000]);
static void c1_l_emlrt_marshallIn(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId,
  real_T c1_y[1000]);
...
static const mxArray *c1_l_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_m_emlrt_marshallIn(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, const mxArray *c1_emotion_amount_factor, const char_T
  *c1_identifier, real_T c1_y[11]);
static void c1_n_emlrt_marshallIn(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId,
  real_T c1_y[11]);
static void c1_i_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_o_emlrt_marshallIn(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, const mxArray *c1_k_subchartSimStateInfo, const char_T
  *c1_identifier);
static const mxArray *c1_p_emlrt_marshallIn(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_updateDataWrittenToVector(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_vectorIndex);
static void c1_errorIfDataNotWrittenToFcn(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_vectorIndex, uint32_T c1_dataNumber);
static real_T c1_get_BML(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b);
static void c1_set_BML(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b, real_T c1_c);
static real_T *c1_access_BML(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b);
static real_T c1_get_BML1(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b);
static void c1_set_BML1(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b, real_T c1_c);
static real_T *c1_access_BML1(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b);
static real_T c1_get_BML2(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b);
static void c1_set_BML2(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b, real_T c1_c);
static real_T *c1_access_BML2(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b);
static real_T c1_get_BORED(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b);
static void c1_set_BORED(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b, real_T c1_c);
static real_T *c1_access_BORED(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b);
static real_T c1_get_BOREDOM_THRESHOLD(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_BOREDOM_THRESHOLD(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_BOREDOM_THRESHOLD(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_CONTEMPT(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b);
static void c1_set_CONTEMPT(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b, real_T c1_c);
static real_T *c1_access_CONTEMPT(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_EXCITE(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b);
static void c1_set_EXCITE(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b, real_T c1_c);
static real_T *c1_access_EXCITE(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b);
static real_T c1_get_FEAR(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b);
static void c1_set_FEAR(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b, real_T c1_c);
static real_T *c1_access_FEAR(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b);
static real_T c1_get_FRUST(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b);
static void c1_set_FRUST(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b, real_T c1_c);
static real_T *c1_access_FRUST(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b);
static real_T c1_get_GAZE_GUI(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b);
static void c1_set_GAZE_GUI(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b, real_T c1_c);
static real_T *c1_access_GAZE_GUI(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_GAZE_SOFTEYE(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_GAZE_SOFTEYE(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b, real_T c1_c);
static real_T *c1_access_GAZE_SOFTEYE(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_GAZE_USER_HAND(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_GAZE_USER_HAND(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_GAZE_USER_HAND(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_GAZE_WIN(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b);
static void c1_set_GAZE_WIN(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b, real_T c1_c);
static real_T *c1_access_GAZE_WIN(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_HAPPY(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b);
static void c1_set_HAPPY(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b, real_T c1_c);
static real_T *c1_access_HAPPY(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b);
static real_T c1_get_IDLE(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b);
static void c1_set_IDLE(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b, real_T c1_c);
static real_T *c1_access_IDLE(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b);
static real_T c1_get_P(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b);
static void c1_set_P(SFc1_Expriment_GazeInstanceStruct *chartInstance, uint32_T
                     c1_b, real_T c1_c);
static real_T *c1_access_P(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b);
static real_T c1_get_SAD(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b);
static void c1_set_SAD(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b, real_T c1_c);
static real_T *c1_access_SAD(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b);
static real_T c1_get_STATE_BEFORE(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_STATE_BEFORE(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b, real_T c1_c);
static real_T *c1_access_STATE_BEFORE(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_STATE_GO(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b);
static void c1_set_STATE_GO(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b, real_T c1_c);
static real_T *c1_access_STATE_GO(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_STATE_HAND(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b);
static void c1_set_STATE_HAND(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b, real_T c1_c);
static real_T *c1_access_STATE_HAND(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_STATE_OVER(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b);
static void c1_set_STATE_OVER(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b, real_T c1_c);
static real_T *c1_access_STATE_OVER(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_STATE_READY(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_STATE_READY(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b, real_T c1_c);
static real_T *c1_access_STATE_READY(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_STATE_RESULT(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_STATE_RESULT(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b, real_T c1_c);
static real_T *c1_access_STATE_RESULT(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_STATE_WAIT(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b);
static void c1_set_STATE_WAIT(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b, real_T c1_c);
static real_T *c1_access_STATE_WAIT(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_avert(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b);
static void c1_set_avert(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b, real_T c1_c);
static real_T *c1_access_avert(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b);
static real_T c1_get_avertH(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b);
static void c1_set_avertH(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b, real_T c1_c);
static real_T *c1_access_avertH(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b);
static real_T c1_get_avert_freq_factor(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_avert_freq_factor(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_avert_freq_factor(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_avert_gaze_dirs_chance(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_avert_gaze_dirs_chance(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_avert_gaze_dirs_chance
  (SFc1_Expriment_GazeInstanceStruct *chartInstance, uint32_T c1_b);
static real_T c1_get_avert_gaze_duration_factor
  (SFc1_Expriment_GazeInstanceStruct *chartInstance, uint32_T c1_b);
static void c1_set_avert_gaze_duration_factor(SFc1_Expriment_GazeInstanceStruct *
  chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_avert_gaze_duration_factor
  (SFc1_Expriment_GazeInstanceStruct *chartInstance, uint32_T c1_b);
static real_T c1_get_avert_head_frequency_factor
  (SFc1_Expriment_GazeInstanceStruct *chartInstance, uint32_T c1_b);
static void c1_set_avert_head_frequency_factor(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_avert_head_frequency_factor
  (SFc1_Expriment_GazeInstanceStruct *chartInstance, uint32_T c1_b);
static real_T c1_get_avert_head_speed(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_avert_head_speed(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_avert_head_speed(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_bHand(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b);
static void c1_set_bHand(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b, real_T c1_c);
static real_T *c1_access_bHand(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b);
static real_T c1_get_blink_flag(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b);
static void c1_set_blink_flag(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b, real_T c1_c);
static real_T *c1_access_blink_flag(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_blinkperiod_max(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_blinkperiod_max(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_blinkperiod_max(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_blinkperiod_min(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_blinkperiod_min(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_blinkperiod_min(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_bmlsH(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b);
static void c1_set_bmlsH(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b, real_T c1_c);
static real_T *c1_access_bmlsH(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b);
static real_T c1_get_bmlsL(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b);
static void c1_set_bmlsL(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b, real_T c1_c);
static real_T *c1_access_bmlsL(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b);
static real_T c1_get_bmlsM(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b);
static void c1_set_bmlsM(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b, real_T c1_c);
static real_T *c1_access_bmlsM(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b);
static real_T c1_get_bodyBusyFlag(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_bodyBusyFlag(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b, real_T c1_c);
static real_T *c1_access_bodyBusyFlag(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_boredom(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b);
static void c1_set_boredom(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b, real_T c1_c);
static real_T *c1_access_boredom(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_diff(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b);
static void c1_set_diff(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b, real_T c1_c);
static real_T *c1_access_diff(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b);
static real_T c1_get_emotion_amount_factor(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_emotion_amount_factor(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_emotion_amount_factor(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_faceBusyFlag(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_faceBusyFlag(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b, real_T c1_c);
static real_T *c1_access_faceBusyFlag(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_fileID(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b);
static void c1_set_fileID(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b, real_T c1_c);
static real_T *c1_access_fileID(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b);
static real_T c1_get_gazing(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b);
static void c1_set_gazing(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b, real_T c1_c);
static real_T *c1_access_gazing(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b);
static real_T c1_get_interest(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b);
static void c1_set_interest(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b, real_T c1_c);
static real_T *c1_access_interest(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_mut_freq_factor(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_mut_freq_factor(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_mut_freq_factor(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_mutual_gaze_duration_factor
  (SFc1_Expriment_GazeInstanceStruct *chartInstance, uint32_T c1_b);
static void c1_set_mutual_gaze_duration_factor(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_mutual_gaze_duration_factor
  (SFc1_Expriment_GazeInstanceStruct *chartInstance, uint32_T c1_b);
static real_T c1_get_n(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b);
static void c1_set_n(SFc1_Expriment_GazeInstanceStruct *chartInstance, uint32_T
                     c1_b, real_T c1_c);
static real_T *c1_access_n(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b);
static real_T c1_get_pa(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b);
static void c1_set_pa(SFc1_Expriment_GazeInstanceStruct *chartInstance, uint32_T
                      c1_b, real_T c1_c);
static real_T *c1_access_pa(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b);
static real_T c1_get_pose_cat_chance(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_pose_cat_chance(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_pose_cat_chance(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_pose_chance_factor(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_pose_chance_factor(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_pose_chance_factor(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_pose_change_flag(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_pose_change_flag(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_pose_change_flag(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_pose_frequency_factor(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_pose_frequency_factor(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_pose_frequency_factor(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_pose_lean(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b);
static void c1_set_pose_lean(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b, real_T c1_c);
static real_T *c1_access_pose_lean(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_pose_lean_flag(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_pose_lean_flag(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_pose_lean_flag(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_pose_speed(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b);
static void c1_set_pose_speed(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b, real_T c1_c);
static real_T *c1_access_pose_speed(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_pose_twitch(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_pose_twitch(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b, real_T c1_c);
static real_T *c1_access_pose_twitch(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_pr(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b);
static void c1_set_pr(SFc1_Expriment_GazeInstanceStruct *chartInstance, uint32_T
                      c1_b, real_T c1_c);
static real_T *c1_access_pr(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b);
static real_T c1_get_r(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b);
static void c1_set_r(SFc1_Expriment_GazeInstanceStruct *chartInstance, uint32_T
                     c1_b, real_T c1_c);
static real_T *c1_access_r(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b);
static real_T c1_get_randAvertGazeChance(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_randAvertGazeChance(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_randAvertGazeChance(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_randGazeDur(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_randGazeDur(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b, real_T c1_c);
static real_T *c1_access_randGazeDur(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_randPoseChance(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_randPoseChance(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_randPoseChance(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_randSlowPose(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_randSlowPose(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b, real_T c1_c);
static real_T *c1_access_randSlowPose(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_randSmile(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b);
static void c1_set_randSmile(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b, real_T c1_c);
static real_T *c1_access_randSmile(SFc1_Expriment_GazeInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_s(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b);
static void c1_set_s(SFc1_Expriment_GazeInstanceStruct *chartInstance, uint32_T
                     c1_b, real_T c1_c);
static real_T *c1_access_s(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b);
static real_T c1_get_t(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b);
static void c1_set_t(SFc1_Expriment_GazeInstanceStruct *chartInstance, uint32_T
                     c1_b, real_T c1_c);
static real_T *c1_access_t(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b);
static real_T c1_get_temp(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b);
static void c1_set_temp(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b, real_T c1_c);
static real_T *c1_access_temp(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b);
static real_T c1_get_uHand(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b);
static void c1_set_uHand(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b, real_T c1_c);
static real_T *c1_access_uHand(SFc1_Expriment_GazeInstanceStruct *chartInstance,
  uint32_T c1_b);
static void init_dsm_address_info(SFc1_Expriment_GazeInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  sf_exported_auto_initc5_Expriment_Gaze(chartInstance->c1_subchartSimstruct);
  sf_exported_auto_initc8_Expriment_Gaze(chartInstance->c1_b_subchartSimstruct);
  sf_exported_auto_initc20_Expriment_Gaze(chartInstance->c1_c_subchartSimstruct);
  sf_exported_auto_initc57_Expriment_Gaze(chartInstance->c1_d_subchartSimstruct);
  sf_exported_auto_initc9_Expriment_Gaze(chartInstance->c1_e_subchartSimstruct);
  sf_exported_auto_initc4_Expriment_Gaze(chartInstance->c1_f_subchartSimstruct);
  sf_exported_auto_initc42_Expriment_Gaze(chartInstance->c1_g_subchartSimstruct);
  sf_exported_auto_initc44_Expriment_Gaze(chartInstance->c1_h_subchartSimstruct);
  sf_exported_auto_initc11_Expriment_Gaze(chartInstance->c1_i_subchartSimstruct);
  sf_exported_auto_initc10_Expriment_Gaze(chartInstance->c1_j_subchartSimstruct);
  ...
  chartInstance->c1_is_active_c1_Expriment_Gaze = 0U;
  ...
  *chartInstance)
{
  ...
  if (chartInstance->c1_is_active_RPS_Scenario == 1U) {
    sf_exported_auto_disablec5_Expriment_Gaze
      (chartInstance->c1_subchartSimstruct);
  }

  if (chartInstance->c1_is_active_personalSpace_Controller == 1U) {
    sf_exported_auto_disablec8_Expriment_Gaze
      (chartInstance->c1_b_subchartSimstruct);
  }

  if (chartInstance->c1_is_active_wave_Controller == 1U) {
    sf_exported_auto_disablec20_Expriment_Gaze
      (chartInstance->c1_c_subchartSimstruct);
  }

  if (chartInstance->c1_is_active_Gaze_Controller == 1U) {
    sf_exported_auto_disablec57_Expriment_Gaze
      (chartInstance->c1_d_subchartSimstruct);
  }

  if (chartInstance->c1_is_active_facialExpression_Controller == 1U) {
    sf_exported_auto_disablec9_Expriment_Gaze
      (chartInstance->c1_e_subchartSimstruct);
  }

  if (chartInstance->c1_is_active_idlePose_Controller == 1U) {
    sf_exported_auto_disablec4_Expriment_Gaze
      (chartInstance->c1_f_subchartSimstruct);
  }

  if (chartInstance->c1_is_active_personality_Behavior_Factors == 1U) {
    sf_exported_auto_disablec42_Expriment_Gaze
      (chartInstance->c1_g_subchartSimstruct);
  }

  if (chartInstance->c1_is_active_custom_Behavior_Factors == 1U) {
    sf_exported_auto_disablec44_Expriment_Gaze
      (chartInstance->c1_h_subchartSimstruct);
  }

  if (chartInstance->c1_is_active_emotion_Behavior_Factors == 1U) {
    sf_exported_auto_disablec11_Expriment_Gaze
      (chartInstance->c1_i_subchartSimstruct);
  }

  if (chartInstance->c1_is_active_attention_Controller == 1U) {
    sf_exported_auto_disablec10_Expriment_Gaze
      (chartInstance->c1_j_subchartSimstruct);
  }
}
  ...
  (SFc1_Expriment_GazeInstanceStruct *chartInstance)
{
  ...
  if (chartInstance->c1_is_active_c1_Expriment_Gaze == 1U) {
  ...
  (SFc1_Expriment_GazeInstanceStruct *chartInstance)
{
  ...
  c1_ad_hoistedGlobal = chartInstance->c1_is_active_c1_Expriment_Gaze;
  ...
  *chartInstance, const mxArray *c1_st)
{
  ...
  *c1_win = c1_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 6)),
  ...
  chartInstance->c1_is_active_c1_Expriment_Gaze = c1_i_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 86)),
     "is_active_c1_Expriment_Gaze");
  ...
  *chartInstance)
{
  ...
  c1_set_sim_state_side_effects_c1_Expriment_Gaze(chartInstance);
  _SFD_SYMBOL_SCOPE_PUSH(0U, 0U);
  _sfTime_ = sf_get_time(chartInstance->S);
  sf_exported_auto_gatewayc5_Expriment_Gaze(chartInstance->c1_subchartSimstruct);
  sf_exported_auto_gatewayc8_Expriment_Gaze
    (chartInstance->c1_b_subchartSimstruct);
  sf_exported_auto_gatewayc20_Expriment_Gaze
    (chartInstance->c1_c_subchartSimstruct);
  sf_exported_auto_gatewayc57_Expriment_Gaze
    (chartInstance->c1_d_subchartSimstruct);
  sf_exported_auto_gatewayc9_Expriment_Gaze
    (chartInstance->c1_e_subchartSimstruct);
  sf_exported_auto_gatewayc4_Expriment_Gaze
    (chartInstance->c1_f_subchartSimstruct);
  sf_exported_auto_gatewayc42_Expriment_Gaze
    (chartInstance->c1_g_subchartSimstruct);
  sf_exported_auto_gatewayc44_Expriment_Gaze
    (chartInstance->c1_h_subchartSimstruct);
  sf_exported_auto_gatewayc11_Expriment_Gaze
    (chartInstance->c1_i_subchartSimstruct);
  sf_exported_auto_gatewayc10_Expriment_Gaze
    (chartInstance->c1_j_subchartSimstruct);
  ...
  sf_exported_auto_activate_c5_Expriment_Gaze_secs
    (chartInstance->c1_subchartSimstruct);
  sf_exported_auto_activate_c8_Expriment_Gaze_secs
    (chartInstance->c1_b_subchartSimstruct);
  sf_exported_auto_activate_c20_Expriment_Gaze_secs
    (chartInstance->c1_c_subchartSimstruct);
  sf_exported_auto_activate_c57_Expriment_Gaze_secs
    (chartInstance->c1_d_subchartSimstruct);
  sf_exported_auto_activate_c9_Expriment_Gaze_secs
    (chartInstance->c1_e_subchartSimstruct);
  sf_exported_auto_activate_c4_Expriment_Gaze_secs
    (chartInstance->c1_f_subchartSimstruct);
  sf_exported_auto_activate_callc42_Expriment_Gaze
    (chartInstance->c1_g_subchartSimstruct);
  sf_exported_auto_activate_callc44_Expriment_Gaze
    (chartInstance->c1_h_subchartSimstruct);
  sf_exported_auto_activate_callc11_Expriment_Gaze
    (chartInstance->c1_i_subchartSimstruct);
  sf_exported_auto_activate_c10_Expriment_Gaze_secs
    (chartInstance->c1_j_subchartSimstruct);
  sf_exported_auto_incrementTemporalCounter_c5_Expriment_Gaze_secs
    (chartInstance->c1_subchartSimstruct);
  sf_exported_auto_incrementTemporalCounter_c8_Expriment_Gaze_secs
    (chartInstance->c1_b_subchartSimstruct);
  sf_exported_auto_incrementTemporalCounter_c20_Expriment_Gaze_secs
    (chartInstance->c1_c_subchartSimstruct);
  sf_exported_auto_incrementTemporalCounter_c57_Expriment_Gaze_secs
    (chartInstance->c1_d_subchartSimstruct);
  sf_exported_auto_incrementTemporalCounter_c9_Expriment_Gaze_secs
    (chartInstance->c1_e_subchartSimstruct);
  sf_exported_auto_incrementTemporalCounter_c4_Expriment_Gaze_secs
    (chartInstance->c1_f_subchartSimstruct);
  sf_exported_auto_incrementTemporalCounter_c10_Expriment_Gaze_secs
    (chartInstance->c1_j_subchartSimstruct);
  chartInstance->c1_sfEvent = c1_event_secs;
  _SFD_CE_CALL(EVENT_BEFORE_BROADCAST_TAG, c1_event_secs,
               chartInstance->c1_sfEvent);
  sf_exported_auto_stepBuffersc5_Expriment_Gaze
    (chartInstance->c1_subchartSimstruct);
  sf_exported_auto_stepBuffersc8_Expriment_Gaze
    (chartInstance->c1_b_subchartSimstruct);
  sf_exported_auto_stepBuffersc20_Expriment_Gaze
    (chartInstance->c1_c_subchartSimstruct);
  sf_exported_auto_stepBuffersc57_Expriment_Gaze
    (chartInstance->c1_d_subchartSimstruct);
  sf_exported_auto_stepBuffersc9_Expriment_Gaze
    (chartInstance->c1_e_subchartSimstruct);
  sf_exported_auto_stepBuffersc4_Expriment_Gaze
    (chartInstance->c1_f_subchartSimstruct);
  sf_exported_auto_stepBuffersc42_Expriment_Gaze
    (chartInstance->c1_g_subchartSimstruct);
  sf_exported_auto_stepBuffersc44_Expriment_Gaze
    (chartInstance->c1_h_subchartSimstruct);
  sf_exported_auto_stepBuffersc11_Expriment_Gaze
    (chartInstance->c1_i_subchartSimstruct);
  sf_exported_auto_stepBuffersc10_Expriment_Gaze
    (chartInstance->c1_j_subchartSimstruct);
  c1_c1_Expriment_Gaze(chartInstance);
  _SFD_CE_CALL(EVENT_AFTER_BROADCAST_TAG, c1_event_secs,
               chartInstance->c1_sfEvent);
  sf_exported_auto_resetTemporalCounter_c5_Expriment_Gaze_secs
    (chartInstance->c1_subchartSimstruct);
  sf_exported_auto_resetTemporalCounter_c8_Expriment_Gaze_secs
    (chartInstance->c1_b_subchartSimstruct);
  sf_exported_auto_resetTemporalCounter_c20_Expriment_Gaze_secs
    (chartInstance->c1_c_subchartSimstruct);
  sf_exported_auto_resetTemporalCounter_c57_Expriment_Gaze_secs
    (chartInstance->c1_d_subchartSimstruct);
  sf_exported_auto_resetTemporalCounter_c9_Expriment_Gaze_secs
    (chartInstance->c1_e_subchartSimstruct);
  sf_exported_auto_resetTemporalCounter_c4_Expriment_Gaze_secs
    (chartInstance->c1_f_subchartSimstruct);
  sf_exported_auto_resetTemporalCounter_c10_Expriment_Gaze_secs
    (chartInstance->c1_j_subchartSimstruct);
  sf_exported_auto_deactivate_c5_Expriment_Gaze_secs
    (chartInstance->c1_subchartSimstruct);
  sf_exported_auto_deactivate_c8_Expriment_Gaze_secs
    (chartInstance->c1_b_subchartSimstruct);
  sf_exported_auto_deactivate_c20_Expriment_Gaze_secs
    (chartInstance->c1_c_subchartSimstruct);
  sf_exported_auto_deactivate_c57_Expriment_Gaze_secs
    (chartInstance->c1_d_subchartSimstruct);
  sf_exported_auto_deactivate_c9_Expriment_Gaze_secs
    (chartInstance->c1_e_subchartSimstruct);
  sf_exported_auto_deactivate_c4_Expriment_Gaze_secs
    (chartInstance->c1_f_subchartSimstruct);
  sf_exported_auto_deactivate_callc42_Expriment_Gaze
    (chartInstance->c1_g_subchartSimstruct);
  sf_exported_auto_deactivate_callc44_Expriment_Gaze
    (chartInstance->c1_h_subchartSimstruct);
  sf_exported_auto_deactivate_callc11_Expriment_Gaze
    (chartInstance->c1_i_subchartSimstruct);
  sf_exported_auto_deactivate_c10_Expriment_Gaze_secs
    (chartInstance->c1_j_subchartSimstruct);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_Expriment_GazeMachineNumber_,
    chartInstance->chartNumber, chartInstance->instanceNumber);
  if (chartInstance->c1_is_active_RPS_Scenario == 1U) {
    sf_exported_auto_check_state_inconsistency_c5_Expriment_Gaze
      (chartInstance->c1_subchartSimstruct);
  }

  if (chartInstance->c1_is_active_personalSpace_Controller == 1U) {
    sf_exported_auto_check_state_inconsistency_c8_Expriment_Gaze
      (chartInstance->c1_b_subchartSimstruct);
  }

  if (chartInstance->c1_is_active_wave_Controller == 1U) {
    sf_exported_auto_check_state_inconsistency_c20_Expriment_Gaze
      (chartInstance->c1_c_subchartSimstruct);
  }

  if (chartInstance->c1_is_active_Gaze_Controller == 1U) {
    sf_exported_auto_check_state_inconsistency_c57_Expriment_Gaze
      (chartInstance->c1_d_subchartSimstruct);
  }

  if (chartInstance->c1_is_active_facialExpression_Controller == 1U) {
    sf_exported_auto_check_state_inconsistency_c9_Expriment_Gaze
      (chartInstance->c1_e_subchartSimstruct);
  }

  if (chartInstance->c1_is_active_idlePose_Controller == 1U) {
    sf_exported_auto_check_state_inconsistency_c4_Expriment_Gaze
      (chartInstance->c1_f_subchartSimstruct);
  }

  if (chartInstance->c1_is_active_personality_Behavior_Factors == 1U) {
    sf_exported_auto_check_state_inconsistency_c42_Expriment_Gaze
      (chartInstance->c1_g_subchartSimstruct);
  }

  if (chartInstance->c1_is_active_custom_Behavior_Factors == 1U) {
    sf_exported_auto_check_state_inconsistency_c44_Expriment_Gaze
      (chartInstance->c1_h_subchartSimstruct);
  }

  if (chartInstance->c1_is_active_emotion_Behavior_Factors == 1U) {
    sf_exported_auto_check_state_inconsistency_c11_Expriment_Gaze
      (chartInstance->c1_i_subchartSimstruct);
  }

  if (chartInstance->c1_is_active_attention_Controller == 1U) {
    sf_exported_auto_check_state_inconsistency_c10_Expriment_Gaze
      (chartInstance->c1_j_subchartSimstruct);
  }
}
  ...
  *chartInstance)
{
  ...
  if (chartInstance->c1_is_active_c1_Expriment_Gaze == 0U) {
    sf_exported_auto_initBuffersc5_Expriment_Gaze
      (chartInstance->c1_subchartSimstruct);
    sf_exported_auto_initBuffersc8_Expriment_Gaze
      (chartInstance->c1_b_subchartSimstruct);
    sf_exported_auto_initBuffersc20_Expriment_Gaze
      (chartInstance->c1_c_subchartSimstruct);
    sf_exported_auto_initBuffersc57_Expriment_Gaze
      (chartInstance->c1_d_subchartSimstruct);
    sf_exported_auto_initBuffersc9_Expriment_Gaze
      (chartInstance->c1_e_subchartSimstruct);
    sf_exported_auto_initBuffersc4_Expriment_Gaze
      (chartInstance->c1_f_subchartSimstruct);
    sf_exported_auto_initBuffersc42_Expriment_Gaze
      (chartInstance->c1_g_subchartSimstruct);
    sf_exported_auto_initBuffersc44_Expriment_Gaze
      (chartInstance->c1_h_subchartSimstruct);
    sf_exported_auto_initBuffersc11_Expriment_Gaze
      (chartInstance->c1_i_subchartSimstruct);
    sf_exported_auto_initBuffersc10_Expriment_Gaze
      (chartInstance->c1_j_subchartSimstruct);
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 0U, chartInstance->c1_sfEvent);
    chartInstance->c1_is_active_c1_Expriment_Gaze = 1U;
    _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 0U, chartInstance->c1_sfEvent);
    chartInstance->c1_is_active_RPS_Scenario = 1U;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, chartInstance->c1_sfEvent);
    chartInstance->c1_tp_RPS_Scenario = 1U;
    sf_exported_auto_enterc5_Expriment_Gaze(chartInstance->c1_subchartSimstruct);
    chartInstance->c1_is_active_personalSpace_Controller = 1U;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 7U, chartInstance->c1_sfEvent);
    chartInstance->c1_tp_personalSpace_Controller = 1U;
    sf_exported_auto_enterc8_Expriment_Gaze
      (chartInstance->c1_b_subchartSimstruct);
    ...
    sf_exported_auto_duringc20_Expriment_Gaze
      (chartInstance->c1_c_subchartSimstruct);
    ...
    sf_exported_auto_duringc44_Expriment_Gaze
      (chartInstance->c1_h_subchartSimstruct);
    ...
    sf_exported_auto_duringc4_Expriment_Gaze
      (chartInstance->c1_f_subchartSimstruct);
    ...
    sf_exported_auto_duringc11_Expriment_Gaze
      (chartInstance->c1_i_subchartSimstruct);
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  const mxArray *c1_y = NULL;
  SFc1_Expriment_GazeInstanceStruct *chartInstance;
  chartInstance = (SFc1_Expriment_GazeInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c1_Expriment_Gaze_get_eml_resolved_functions_info(void)
{
  ...
  uint32_T c1_b)
{
  ...
  if (chartInstance->c1_BML_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'BML\' (#335) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c1_b)
{
  ...
  if (chartInstance->c1_BML1_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'BML1\' (#351) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c1_b)
{
  ...
  if (chartInstance->c1_BML2_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'BML2\' (#350) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c1_b)
{
  ...
  if (chartInstance->c1_BORED_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'BORED\' (#330) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_BOREDOM_THRESHOLD_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'BOREDOM_THRESHOLD\' (#300) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c1_b)
{
  ...
  if (chartInstance->c1_CONTEMPT_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'CONTEMPT\' (#329) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c1_b)
{
  ...
  if (chartInstance->c1_EXCITE_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'EXCITE\' (#334) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c1_b)
{
  ...
  if (chartInstance->c1_FEAR_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'FEAR\' (#332) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c1_b)
{
  ...
  if (chartInstance->c1_FRUST_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'FRUST\' (#331) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c1_b)
{
  ...
  if (chartInstance->c1_GAZE_GUI_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'GAZE_GUI\' (#314) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_GAZE_SOFTEYE_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'GAZE_SOFTEYE\' (#315) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_GAZE_USER_HAND_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'GAZE_USER_HAND\' (#316) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c1_b)
{
  ...
  if (chartInstance->c1_GAZE_WIN_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'GAZE_WIN\' (#322) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c1_b)
{
  ...
  if (chartInstance->c1_HAPPY_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'HAPPY\' (#327) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c1_b)
{
  ...
  if (chartInstance->c1_IDLE_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'IDLE\' (#333) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c1_b)
{
  ...
  if (chartInstance->c1_P_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'P\' (#308) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c1_b)
{
  ...
  if (chartInstance->c1_SAD_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'SAD\' (#328) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_STATE_BEFORE_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'STATE_BEFORE\' (#324) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c1_b)
{
  ...
  if (chartInstance->c1_STATE_GO_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'STATE_GO\' (#318) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c1_b)
{
  ...
  if (chartInstance->c1_STATE_HAND_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'STATE_HAND\' (#319) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c1_b)
{
  ...
  if (chartInstance->c1_STATE_OVER_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'STATE_OVER\' (#320) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_STATE_READY_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'STATE_READY\' (#317) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_STATE_RESULT_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'STATE_RESULT\' (#325) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c1_b)
{
  ...
  if (chartInstance->c1_STATE_WAIT_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'STATE_WAIT\' (#326) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c1_b)
{
  ...
  if (chartInstance->c1_avert_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'avert\' (#313) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c1_b)
{
  ...
  if (chartInstance->c1_avertH_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'avertH\' (#364) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_avert_freq_factor_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'avert_freq_factor\' (#384) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_avert_gaze_dirs_chance_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'avert_gaze_dirs_chance\' (#374) in the initialization routine of the chart.\n");
  }
  ...
  (SFc1_Expriment_GazeInstanceStruct *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_avert_gaze_duration_factor_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'avert_gaze_duration_factor\' (#372) in the initialization routine of the chart.\n");
  }
  ...
  (SFc1_Expriment_GazeInstanceStruct *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_avert_head_frequency_factor_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'avert_head_frequency_factor\' (#373) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_avert_head_speed_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'avert_head_speed\' (#375) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c1_b)
{
  ...
  if (chartInstance->c1_bHand_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'bHand\' (#295) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c1_b)
{
  ...
  if (chartInstance->c1_blink_flag_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'blink_flag\' (#387) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_blinkperiod_max_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'blinkperiod_max\' (#389) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_blinkperiod_min_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'blinkperiod_min\' (#388) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c1_b)
{
  ...
  if (chartInstance->c1_bmlsH_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'bmlsH\' (#357) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c1_b)
{
  ...
  if (chartInstance->c1_bmlsL_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'bmlsL\' (#355) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c1_b)
{
  ...
  if (chartInstance->c1_bmlsM_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'bmlsM\' (#362) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_bodyBusyFlag_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'bodyBusyFlag\' (#353) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c1_b)
{
  ...
  if (chartInstance->c1_boredom_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'boredom\' (#299) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c1_b)
{
  ...
  if (chartInstance->c1_diff_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'diff\' (#293) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_emotion_amount_factor_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'emotion_amount_factor\' (#383) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_faceBusyFlag_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'faceBusyFlag\' (#368) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c1_b)
{
  ...
  if (chartInstance->c1_fileID_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'fileID\' (#341) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c1_b)
{
  ...
  if (chartInstance->c1_gazing_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'gazing\' (#321) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c1_b)
{
  ...
  if (chartInstance->c1_interest_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'interest\' (#303) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_mut_freq_factor_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'mut_freq_factor\' (#385) in the initialization routine of the chart.\n");
  }
  ...
  (SFc1_Expriment_GazeInstanceStruct *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_mutual_gaze_duration_factor_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'mutual_gaze_duration_factor\' (#371) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c1_b)
{
  ...
  if (chartInstance->c1_n_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'n\' (#354) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c1_b)
{
  ...
  if (chartInstance->c1_pa_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'pa\' (#305) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_pose_cat_chance_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'pose_cat_chance\' (#377) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_pose_chance_factor_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'pose_chance_factor\' (#376) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_pose_change_flag_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'pose_change_flag\' (#382) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_pose_frequency_factor_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'pose_frequency_factor\' (#378) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c1_b)
{
  ...
  if (chartInstance->c1_pose_lean_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'pose_lean\' (#380) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_pose_lean_flag_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'pose_lean_flag\' (#381) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c1_b)
{
  ...
  if (chartInstance->c1_pose_speed_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'pose_speed\' (#379) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_pose_twitch_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'pose_twitch\' (#386) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c1_b)
{
  ...
  if (chartInstance->c1_pr_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'pr\' (#336) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c1_b)
{
  ...
  if (chartInstance->c1_r_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'r\' (#304) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_randAvertGazeChance_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'randAvertGazeChance\' (#301) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_randGazeDur_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'randGazeDur\' (#307) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_randPoseChance_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'randPoseChance\' (#302) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_randSlowPose_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'randSlowPose\' (#323) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c1_b)
{
  ...
  if (chartInstance->c1_randSmile_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'randSmile\' (#298) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c1_b)
{
  ...
  if (chartInstance->c1_s_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'s\' (#306) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c1_b)
{
  ...
  if (chartInstance->c1_t_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'t\' (#352) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c1_b)
{
  ...
  if (chartInstance->c1_temp_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'temp\' (#292) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c1_b)
{
  ...
  if (chartInstance->c1_uHand_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'uHand\' (#294) in the initialization routine of the chart.\n");
  }
...
void sf_c1_Expriment_Gaze_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c1_Expriment_Gaze_get_autoinheritance_info(void)
{
...
mxArray *sf_c1_Expriment_Gaze_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c1_Expriment_Gaze_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c1_Expriment_Gaze(void)
{
  ...
  const char *infoEncStr[] = {
    ...
    "100 S1x10'type','srcId','name','auxInfo'{{M[3],M[754],T\"smileN\",},{M[3],M[1262],T\"t\",},{M[3],M[1109],T\"t1\",},{M[3],M[1110],T\"t2\",},{M[3],M[460],T\"temp\",},{M[3],M[467],T\"uHand\",},{M[8],M[0],T\"is_active_c1_Expriment_Gaze\",},{M[8],M[879],T\"is_active_personalSpace_Controller\",},{M[8],M[1122],T\"is_active_sendBMLbyPriority\",},{M[8],M[1246],T\"is_active_RPS_Scenario\",}}",
  ...
  sf_c1_Expriment_Gaze_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc1_Expriment_GazeInstanceStruct *)
...
static void sf_opaque_initialize_c1_Expriment_Gaze(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_Expriment_GazeInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c1_Expriment_Gaze((SFc1_Expriment_GazeInstanceStruct*)
    chartInstanceVar);
  initialize_c1_Expriment_Gaze((SFc1_Expriment_GazeInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c1_Expriment_Gaze(void *chartInstanceVar)
{
  enable_c1_Expriment_Gaze((SFc1_Expriment_GazeInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c1_Expriment_Gaze(void *chartInstanceVar)
{
  disable_c1_Expriment_Gaze((SFc1_Expriment_GazeInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c1_Expriment_Gaze(void *chartInstanceVar)
{
  sf_gateway_c1_Expriment_Gaze((SFc1_Expriment_GazeInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c1_Expriment_Gaze(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_Expriment_Gaze
    ((SFc1_Expriment_GazeInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_Expriment_Gaze();/* state var info */
...
extern void sf_internal_set_sim_state_c1_Expriment_Gaze(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c1_Expriment_Gaze();/* state var info */
  ...
  set_sim_state_c1_Expriment_Gaze((SFc1_Expriment_GazeInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c1_Expriment_Gaze(SimStruct* S)
{
  return sf_internal_get_sim_state_c1_Expriment_Gaze(S);
}

static void sf_opaque_set_sim_state_c1_Expriment_Gaze(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c1_Expriment_Gaze(S, st);
}

static void sf_opaque_terminate_c1_Expriment_Gaze(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_Expriment_GazeInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c1_Expriment_Gaze((SFc1_Expriment_GazeInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc1_Expriment_Gaze((SFc1_Expriment_GazeInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_Expriment_Gaze(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c1_Expriment_Gaze(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(976407923U));
  ssSetChecksum1(S,(2843091990U));
  ssSetChecksum2(S,(493883978U));
  ssSetChecksum3(S,(440328216U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c1_Expriment_Gaze(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_Expriment_Gaze(SimStruct *S)
{
  SFc1_Expriment_GazeInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc1_Expriment_GazeInstanceStruct *)utMalloc(sizeof
    (SFc1_Expriment_GazeInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc1_Expriment_GazeInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c1_Expriment_Gaze;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c1_Expriment_Gaze;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c1_Expriment_Gaze;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c1_Expriment_Gaze;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c1_Expriment_Gaze;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c1_Expriment_Gaze;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c1_Expriment_Gaze;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_Expriment_Gaze;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_Expriment_Gaze;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_Expriment_Gaze;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c1_Expriment_Gaze;
...
void c1_Expriment_Gaze_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_Expriment_Gaze(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_Expriment_Gaze(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_Expriment_Gaze(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_Expriment_Gaze_method_dispatcher.\n"
