  ...
  if (nrhs>2 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"library")) {
      ...
      if (!strcmp(machineName,"lib_affectiveChar_behavior")) {
        if (nrhs==3) {
          ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1074369298U);
          ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(601169466U);
          ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2156160986U);
          ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2133995778U);
        } else if (nrhs==4) {
  ...
  mxArray * plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 50:
      {
        if (strcmp(aiChksum, "DoUreYcadwtPJxr6Bzz9eH") == 0) {
          extern mxArray
  ...
  mxArray * plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 50:
      {
        if (strcmp(tpChksum, "SCLUnwVTIQZcFAGMSPT6XH") == 0) {
          extern mxArray
...
mxArray* load_lib_affectiveChar_behavior_optimization_info(void)
{
  if (sRtwOptimizationInfoStruct==NULL) {
    sRtwOptimizationInfoStruct = sf_load_rtw_optimization_info(
      "lib_affectiveChar_behavior", "Expriment_Gaze");
