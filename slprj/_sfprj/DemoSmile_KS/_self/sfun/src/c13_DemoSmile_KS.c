...
static void initialize_c13_DemoSmile_KS(SFc13_DemoSmile_KSInstanceStruct
  *chartInstance);
static void initialize_params_c13_DemoSmile_KS(SFc13_DemoSmile_KSInstanceStruct *
  chartInstance);
static void enable_c13_DemoSmile_KS(SFc13_DemoSmile_KSInstanceStruct
  *chartInstance);
static void disable_c13_DemoSmile_KS(SFc13_DemoSmile_KSInstanceStruct
  *chartInstance);
static void c13_update_debugger_state_c13_DemoSmile_KS
  (SFc13_DemoSmile_KSInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c13_DemoSmile_KS
  (SFc13_DemoSmile_KSInstanceStruct *chartInstance);
static void set_sim_state_c13_DemoSmile_KS(SFc13_DemoSmile_KSInstanceStruct
  *chartInstance, const mxArray *c13_st);
static void finalize_c13_DemoSmile_KS(SFc13_DemoSmile_KSInstanceStruct
  *chartInstance);
static void sf_gateway_c13_DemoSmile_KS(SFc13_DemoSmile_KSInstanceStruct
  *chartInstance);
static void initSimStructsc13_DemoSmile_KS(SFc13_DemoSmile_KSInstanceStruct
  *chartInstance);
...
static const mxArray *c13_sf_marshallOut(void *chartInstanceVoid, void
  *c13_inData);
static real_T c13_emlrt_marshallIn(SFc13_DemoSmile_KSInstanceStruct
  *chartInstance, const mxArray *c13_sat, const char_T *c13_identifier);
static real_T c13_b_emlrt_marshallIn(SFc13_DemoSmile_KSInstanceStruct
...
static const mxArray *c13_b_sf_marshallOut(void *chartInstanceVoid, void
  *c13_inData);
static int32_T c13_c_emlrt_marshallIn(SFc13_DemoSmile_KSInstanceStruct
  *chartInstance, const mxArray *c13_u, const emlrtMsgIdentifier *c13_parentId);
...
static uint8_T c13_d_emlrt_marshallIn(SFc13_DemoSmile_KSInstanceStruct
  *chartInstance, const mxArray *c13_b_is_active_c13_DemoSmile_KS, const char_T *
  c13_identifier);
static uint8_T c13_e_emlrt_marshallIn(SFc13_DemoSmile_KSInstanceStruct
  *chartInstance, const mxArray *c13_u, const emlrtMsgIdentifier *c13_parentId);
static void init_dsm_address_info(SFc13_DemoSmile_KSInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c13_is_active_c13_DemoSmile_KS = 0U;
}
  ...
  (SFc13_DemoSmile_KSInstanceStruct *chartInstance)
{
  ...
  c13_b_hoistedGlobal = chartInstance->c13_is_active_c13_DemoSmile_KS;
  ...
  *c13_inData)
{
  ...
  const mxArray *c13_y = NULL;
  SFc13_DemoSmile_KSInstanceStruct *chartInstance;
  chartInstance = (SFc13_DemoSmile_KSInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c13_DemoSmile_KS_get_eml_resolved_functions_info(void)
{
...
void sf_c13_DemoSmile_KS_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c13_DemoSmile_KS_get_autoinheritance_info(void)
{
...
mxArray *sf_c13_DemoSmile_KS_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c13_DemoSmile_KS_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c13_DemoSmile_KS(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"sat\",},{M[8],M[0],T\"is_active_c13_DemoSmile_KS\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c13_DemoSmile_KS_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c13_DemoSmile_KS(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc13_DemoSmile_KSInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c13_DemoSmile_KS((SFc13_DemoSmile_KSInstanceStruct*)
    chartInstanceVar);
  initialize_c13_DemoSmile_KS((SFc13_DemoSmile_KSInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c13_DemoSmile_KS(void *chartInstanceVar)
{
  enable_c13_DemoSmile_KS((SFc13_DemoSmile_KSInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c13_DemoSmile_KS(void *chartInstanceVar)
{
  disable_c13_DemoSmile_KS((SFc13_DemoSmile_KSInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c13_DemoSmile_KS(void *chartInstanceVar)
{
  sf_gateway_c13_DemoSmile_KS((SFc13_DemoSmile_KSInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c13_DemoSmile_KS(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c13_DemoSmile_KS
    ((SFc13_DemoSmile_KSInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c13_DemoSmile_KS();/* state var info */
...
extern void sf_internal_set_sim_state_c13_DemoSmile_KS(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c13_DemoSmile_KS();/* state var info */
  ...
  set_sim_state_c13_DemoSmile_KS((SFc13_DemoSmile_KSInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c13_DemoSmile_KS(SimStruct* S)
{
  return sf_internal_get_sim_state_c13_DemoSmile_KS(S);
}

static void sf_opaque_set_sim_state_c13_DemoSmile_KS(SimStruct* S, const mxArray
  *st)
{
  sf_internal_set_sim_state_c13_DemoSmile_KS(S, st);
}

static void sf_opaque_terminate_c13_DemoSmile_KS(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc13_DemoSmile_KSInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c13_DemoSmile_KS((SFc13_DemoSmile_KSInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc13_DemoSmile_KS((SFc13_DemoSmile_KSInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c13_DemoSmile_KS(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c13_DemoSmile_KS(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlStart_c13_DemoSmile_KS(SimStruct *S)
{
  SFc13_DemoSmile_KSInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc13_DemoSmile_KSInstanceStruct *)utMalloc(sizeof
    (SFc13_DemoSmile_KSInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc13_DemoSmile_KSInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c13_DemoSmile_KS;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c13_DemoSmile_KS;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c13_DemoSmile_KS;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c13_DemoSmile_KS;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c13_DemoSmile_KS;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c13_DemoSmile_KS;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c13_DemoSmile_KS;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c13_DemoSmile_KS;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c13_DemoSmile_KS;
  chartInstance->chartInfo.mdlStart = mdlStart_c13_DemoSmile_KS;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c13_DemoSmile_KS;
...
void c13_DemoSmile_KS_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c13_DemoSmile_KS(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c13_DemoSmile_KS(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c13_DemoSmile_KS(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c13_DemoSmile_KS_method_dispatcher.\n"
