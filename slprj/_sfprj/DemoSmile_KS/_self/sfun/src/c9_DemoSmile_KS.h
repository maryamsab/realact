#ifndef __c9_DemoSmile_KS_h__
#define __c9_DemoSmile_KS_h__
...
/* Type Definitions */
#ifndef typedef_SFc9_DemoSmile_KSInstanceStruct
#define typedef_SFc9_DemoSmile_KSInstanceStruct
...
typedef struct {
  ...
  uint8_T c9_is_active_c9_DemoSmile_KS;
...
#endif                                 /*typedef_SFc9_DemoSmile_KSInstanceStruct*/
...
extern const mxArray *sf_c9_DemoSmile_KS_get_eml_resolved_functions_info(void);
extern void sf_exported_auto_activate_c9_DemoSmile_KS_secs(SimStruct *c9_S);
...
extern void sf_exported_auto_resetTemporalCounter_c9_DemoSmile_KS_secs(SimStruct
  *c9_S);
extern void sf_exported_auto_deactivate_c9_DemoSmile_KS_secs(SimStruct *c9_S);
extern boolean_T sf_exported_auto_isStablec9_DemoSmile_KS(SimStruct *c9_S);
extern void sf_exported_auto_duringc9_DemoSmile_KS(SimStruct *c9_S);
extern void sf_exported_auto_enterc9_DemoSmile_KS(SimStruct *c9_S);
extern void sf_exported_auto_exitc9_DemoSmile_KS(SimStruct *c9_S);
extern void sf_exported_auto_gatewayc9_DemoSmile_KS(SimStruct *c9_S);
extern void sf_exported_auto_enablec9_DemoSmile_KS(SimStruct *c9_S);
extern void sf_exported_auto_disablec9_DemoSmile_KS(SimStruct *c9_S);
extern void sf_exported_auto_stepBuffersc9_DemoSmile_KS(SimStruct *c9_S);
extern void sf_exported_auto_initBuffersc9_DemoSmile_KS(SimStruct *c9_S);
extern void sf_exported_auto_activate_callc9_DemoSmile_KS(SimStruct *c9_S);
extern void sf_exported_auto_increment_call_counterc9_DemoSmile_KS(SimStruct
  *c9_S);
extern void sf_exported_auto_reset_call_counterc9_DemoSmile_KS(SimStruct *c9_S);
extern void sf_exported_auto_deactivate_callc9_DemoSmile_KS(SimStruct *c9_S);
extern void sf_exported_auto_initc9_DemoSmile_KS(SimStruct *c9_S);
extern const mxArray *sf_exported_auto_getSimstatec9_DemoSmile_KS(SimStruct
  *c9_S);
extern const mxArray *sf_internal_get_sim_state_c9_DemoSmile_KS(SimStruct *c9_S);
extern void sf_exported_auto_setSimstatec9_DemoSmile_KS(SimStruct *c9_S, const
  mxArray *c9_in);
extern void sf_internal_set_sim_state_c9_DemoSmile_KS(SimStruct *c9_S, const
  mxArray *c9_in);
extern void sf_exported_auto_check_state_inconsistency_c9_DemoSmile_KS(SimStruct
  *c9_S);
extern void sf_exported_user_c9_DemoSmile_KS_gazeFollowUserMove(SimStruct *c9_S,
  real_T c9_bmlID, real_T *c9_p, real_T c9_gazeBML[256]);
extern void sf_exported_user_c9_DemoSmile_KS_idleGazeFunction(SimStruct *c9_S,
  real_T c9_dir, real_T c9_mag, real_T c9_arrBML[256]);
extern void sf_exported_user_c9_DemoSmile_KS_idleGazeInterestedTable(SimStruct
  *c9_S, real_T c9_bmlID, real_T *c9_p, real_T c9_gazeBML[256]);
extern void sf_exported_user_c9_DemoSmile_KS_idleGazeTable(SimStruct *c9_S,
  real_T c9_bmlID, real_T *c9_p, real_T c9_gazeBML[256]);
extern void sf_exported_user_c9_DemoSmile_KS_insertQueueLow(SimStruct *c9_S,
  real_T c9_bmls[1280], real_T c9_myBML[256], real_T c9_newBmls[1280]);
extern void sf_exported_user_c9_DemoSmile_KS_successTable(SimStruct *c9_S,
  real_T c9_bmlID, real_T *c9_p, real_T c9_poseBML[256]);

/* Function Definitions */
extern void sf_c9_DemoSmile_KS_get_check_sum(mxArray *plhs[]);
extern void c9_DemoSmile_KS_method_dispatcher(SimStruct *S, int_T method, void
  *data);
