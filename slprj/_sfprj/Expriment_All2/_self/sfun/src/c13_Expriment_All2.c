...
static const char * c13_debug_family_names[6] = { "aVarTruthTableCondition_1",
  "aVarTruthTableCondition_2", "nargin", "nargout", "a1", "a2" };

/* Function Declarations */
static void initialize_c13_Expriment_All2(SFc13_Expriment_All2InstanceStruct
  *chartInstance);
static void initialize_params_c13_Expriment_All2
  (SFc13_Expriment_All2InstanceStruct *chartInstance);
static void enable_c13_Expriment_All2(SFc13_Expriment_All2InstanceStruct
  *chartInstance);
static void disable_c13_Expriment_All2(SFc13_Expriment_All2InstanceStruct
  *chartInstance);
static void c13_update_debugger_state_c13_Expriment_All2
  (SFc13_Expriment_All2InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c13_Expriment_All2
  (SFc13_Expriment_All2InstanceStruct *chartInstance);
static void set_sim_state_c13_Expriment_All2(SFc13_Expriment_All2InstanceStruct *
  chartInstance, const mxArray *c13_st);
static void finalize_c13_Expriment_All2(SFc13_Expriment_All2InstanceStruct
  *chartInstance);
static void sf_gateway_c13_Expriment_All2(SFc13_Expriment_All2InstanceStruct
  *chartInstance);
static void initSimStructsc13_Expriment_All2(SFc13_Expriment_All2InstanceStruct *
  chartInstance);
...
static const mxArray *c13_sf_marshallOut(void *chartInstanceVoid, void
  *c13_inData);
static real_T c13_emlrt_marshallIn(SFc13_Expriment_All2InstanceStruct
  *chartInstance, const mxArray *c13_a2, const char_T *c13_identifier);
static real_T c13_b_emlrt_marshallIn(SFc13_Expriment_All2InstanceStruct
...
static const mxArray *c13_b_sf_marshallOut(void *chartInstanceVoid, void
  *c13_inData);
static boolean_T c13_c_emlrt_marshallIn(SFc13_Expriment_All2InstanceStruct
  *chartInstance, const mxArray *c13_u, const emlrtMsgIdentifier *c13_parentId);
...
static const mxArray *c13_c_sf_marshallOut(void *chartInstanceVoid, void
  *c13_inData);
static int32_T c13_d_emlrt_marshallIn(SFc13_Expriment_All2InstanceStruct
  *chartInstance, const mxArray *c13_u, const emlrtMsgIdentifier *c13_parentId);
static void c13_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c13_mxArrayInData, const char_T *c13_varName, void *c13_outData);
static uint8_T c13_e_emlrt_marshallIn(SFc13_Expriment_All2InstanceStruct
  *chartInstance, const mxArray *c13_b_is_active_c13_Expriment_All2, const
  char_T *c13_identifier);
static uint8_T c13_f_emlrt_marshallIn(SFc13_Expriment_All2InstanceStruct
  *chartInstance, const mxArray *c13_u, const emlrtMsgIdentifier *c13_parentId);
static void init_dsm_address_info(SFc13_Expriment_All2InstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c13_is_active_c13_Expriment_All2 = 0U;
}
  ...
  chartInstance, const mxArray *c13_st)
{
  ...
  *c13_a2 = c13_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c13_u,
    0)), "a2");
  chartInstance->c13_is_active_c13_Expriment_All2 = c13_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c13_u, 1)),
     "is_active_c13_Expriment_All2");
  sf_mex_destroy(&c13_u);
  c13_update_debugger_state_c13_Expriment_All2(chartInstance);
  ...
  *c13_inData)
{
  ...
  const mxArray *c13_y = NULL;
  SFc13_Expriment_All2InstanceStruct *chartInstance;
  chartInstance = (SFc13_Expriment_All2InstanceStruct *)chartInstanceVoid;
  ...
  *chartInstance, const mxArray *c13_a2, const char_T *c13_identifier)
{
  ...
  c13_y = c13_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c13_a2), &c13_thisId);
  sf_mex_destroy(&c13_a2);
  return c13_y;
}
...
static void c13_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c13_mxArrayInData, const char_T *c13_varName, void *c13_outData)
{
  const mxArray *c13_a2;
  const char_T *c13_identifier;
  emlrtMsgIdentifier c13_thisId;
  real_T c13_y;
  SFc13_Expriment_All2InstanceStruct *chartInstance;
  chartInstance = (SFc13_Expriment_All2InstanceStruct *)chartInstanceVoid;
  c13_a2 = sf_mex_dup(c13_mxArrayInData);
...
static void c13_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c13_mxArrayInData, const char_T *c13_varName, void *c13_outData)
{
  const mxArray *c13_aVarTruthTableCondition_2;
  const char_T *c13_identifier;
  emlrtMsgIdentifier c13_thisId;
  boolean_T c13_y;
  SFc13_Expriment_All2InstanceStruct *chartInstance;
  chartInstance = (SFc13_Expriment_All2InstanceStruct *)chartInstanceVoid;
  c13_aVarTruthTableCondition_2 = sf_mex_dup(c13_mxArrayInData);
  c13_identifier = c13_varName;
  c13_thisId.fIdentifier = c13_identifier;
  c13_thisId.fParent = NULL;
  c13_y = c13_c_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c13_aVarTruthTableCondition_2), &c13_thisId);
  sf_mex_destroy(&c13_aVarTruthTableCondition_2);
  *(boolean_T *)c13_outData = c13_y;
  sf_mex_destroy(&c13_mxArrayInData);
}

const mxArray *sf_c13_Expriment_All2_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c13_identifier)
{
  ...
  c13_y = c13_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c13_b_is_active_c13_Expriment_All2), &c13_thisId);
  sf_mex_destroy(&c13_b_is_active_c13_Expriment_All2);
  return c13_y;
}
...
void sf_c13_Expriment_All2_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c13_Expriment_All2_get_autoinheritance_info(void)
{
...
mxArray *sf_c13_Expriment_All2_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c13_Expriment_All2_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c13_Expriment_All2(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[4],T\"a2\",},{M[8],M[0],T\"is_active_c13_Expriment_All2\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c13_Expriment_All2_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc13_Expriment_All2InstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          real_T *c13_a2;
          real_T *c13_a1;
          c13_a1 = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
          c13_a2 = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
          _SFD_SET_DATA_VALUE_PTR(0U, c13_a2);
          _SFD_SET_DATA_VALUE_PTR(1U, c13_a1);
        }
      }
    } else {
...
static void sf_opaque_initialize_c13_Expriment_All2(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc13_Expriment_All2InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c13_Expriment_All2((SFc13_Expriment_All2InstanceStruct*)
    chartInstanceVar);
  initialize_c13_Expriment_All2((SFc13_Expriment_All2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c13_Expriment_All2(void *chartInstanceVar)
{
  enable_c13_Expriment_All2((SFc13_Expriment_All2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c13_Expriment_All2(void *chartInstanceVar)
{
  disable_c13_Expriment_All2((SFc13_Expriment_All2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c13_Expriment_All2(void *chartInstanceVar)
{
  sf_gateway_c13_Expriment_All2((SFc13_Expriment_All2InstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c13_Expriment_All2(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c13_Expriment_All2
    ((SFc13_Expriment_All2InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c13_Expriment_All2();/* state var info */
...
extern void sf_internal_set_sim_state_c13_Expriment_All2(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c13_Expriment_All2();/* state var info */
  ...
  set_sim_state_c13_Expriment_All2((SFc13_Expriment_All2InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c13_Expriment_All2(SimStruct* S)
{
  return sf_internal_get_sim_state_c13_Expriment_All2(S);
}

static void sf_opaque_set_sim_state_c13_Expriment_All2(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c13_Expriment_All2(S, st);
}

static void sf_opaque_terminate_c13_Expriment_All2(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc13_Expriment_All2InstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c13_Expriment_All2((SFc13_Expriment_All2InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc13_Expriment_All2((SFc13_Expriment_All2InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c13_Expriment_All2(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c13_Expriment_All2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c13_Expriment_All2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c13_Expriment_All2(SimStruct *S)
{
  SFc13_Expriment_All2InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc13_Expriment_All2InstanceStruct *)utMalloc(sizeof
    (SFc13_Expriment_All2InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc13_Expriment_All2InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c13_Expriment_All2;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c13_Expriment_All2;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c13_Expriment_All2;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c13_Expriment_All2;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c13_Expriment_All2;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c13_Expriment_All2;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c13_Expriment_All2;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c13_Expriment_All2;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c13_Expriment_All2;
  chartInstance->chartInfo.mdlStart = mdlStart_c13_Expriment_All2;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c13_Expriment_All2;
...
void c13_Expriment_All2_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c13_Expriment_All2(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c13_Expriment_All2(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c13_Expriment_All2(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c13_Expriment_All2_method_dispatcher.\n"
