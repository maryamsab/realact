...
static void initialize_c55_Expriment_All2(SFc55_Expriment_All2InstanceStruct
  *chartInstance);
static void initialize_params_c55_Expriment_All2
  (SFc55_Expriment_All2InstanceStruct *chartInstance);
static void enable_c55_Expriment_All2(SFc55_Expriment_All2InstanceStruct
  *chartInstance);
static void disable_c55_Expriment_All2(SFc55_Expriment_All2InstanceStruct
  *chartInstance);
static void c55_update_debugger_state_c55_Expriment_All2
  (SFc55_Expriment_All2InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c55_Expriment_All2
  (SFc55_Expriment_All2InstanceStruct *chartInstance);
static void set_sim_state_c55_Expriment_All2(SFc55_Expriment_All2InstanceStruct *
  chartInstance, const mxArray *c55_st);
static void finalize_c55_Expriment_All2(SFc55_Expriment_All2InstanceStruct
  *chartInstance);
static void sf_gateway_c55_Expriment_All2(SFc55_Expriment_All2InstanceStruct
  *chartInstance);
static void initSimStructsc55_Expriment_All2(SFc55_Expriment_All2InstanceStruct *
  chartInstance);
...
static const mxArray *c55_sf_marshallOut(void *chartInstanceVoid, void
  *c55_inData);
static real_T c55_emlrt_marshallIn(SFc55_Expriment_All2InstanceStruct
  *chartInstance, const mxArray *c55_v2, const char_T *c55_identifier);
static real_T c55_b_emlrt_marshallIn(SFc55_Expriment_All2InstanceStruct
...
static const mxArray *c55_b_sf_marshallOut(void *chartInstanceVoid, void
  *c55_inData);
static boolean_T c55_c_emlrt_marshallIn(SFc55_Expriment_All2InstanceStruct
  *chartInstance, const mxArray *c55_u, const emlrtMsgIdentifier *c55_parentId);
...
static const mxArray *c55_c_sf_marshallOut(void *chartInstanceVoid, void
  *c55_inData);
static int32_T c55_d_emlrt_marshallIn(SFc55_Expriment_All2InstanceStruct
  *chartInstance, const mxArray *c55_u, const emlrtMsgIdentifier *c55_parentId);
static void c55_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c55_mxArrayInData, const char_T *c55_varName, void *c55_outData);
static uint8_T c55_e_emlrt_marshallIn(SFc55_Expriment_All2InstanceStruct
  *chartInstance, const mxArray *c55_b_is_active_c55_Expriment_All2, const
  char_T *c55_identifier);
static uint8_T c55_f_emlrt_marshallIn(SFc55_Expriment_All2InstanceStruct
  *chartInstance, const mxArray *c55_u, const emlrtMsgIdentifier *c55_parentId);
static void init_dsm_address_info(SFc55_Expriment_All2InstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c55_is_active_c55_Expriment_All2 = 0U;
}
  ...
  (SFc55_Expriment_All2InstanceStruct *chartInstance)
{
  ...
  c55_b_hoistedGlobal = chartInstance->c55_is_active_c55_Expriment_All2;
  ...
  chartInstance, const mxArray *c55_st)
{
  ...
  *c55_v2 = c55_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c55_u,
    0)), "v2");
  chartInstance->c55_is_active_c55_Expriment_All2 = c55_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c55_u, 1)),
     "is_active_c55_Expriment_All2");
  sf_mex_destroy(&c55_u);
  c55_update_debugger_state_c55_Expriment_All2(chartInstance);
  ...
  *c55_inData)
{
  ...
  const mxArray *c55_y = NULL;
  SFc55_Expriment_All2InstanceStruct *chartInstance;
  chartInstance = (SFc55_Expriment_All2InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c55_Expriment_All2_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c55_identifier)
{
  ...
  c55_y = c55_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c55_b_is_active_c55_Expriment_All2), &c55_thisId);
  sf_mex_destroy(&c55_b_is_active_c55_Expriment_All2);
  return c55_y;
}
...
void sf_c55_Expriment_All2_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c55_Expriment_All2_get_autoinheritance_info(void)
{
...
mxArray *sf_c55_Expriment_All2_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c55_Expriment_All2_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c55_Expriment_All2(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[4],T\"v2\",},{M[8],M[0],T\"is_active_c55_Expriment_All2\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c55_Expriment_All2_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc55_Expriment_All2InstanceStruct *)
...
static void sf_opaque_initialize_c55_Expriment_All2(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc55_Expriment_All2InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c55_Expriment_All2((SFc55_Expriment_All2InstanceStruct*)
    chartInstanceVar);
  initialize_c55_Expriment_All2((SFc55_Expriment_All2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c55_Expriment_All2(void *chartInstanceVar)
{
  enable_c55_Expriment_All2((SFc55_Expriment_All2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c55_Expriment_All2(void *chartInstanceVar)
{
  disable_c55_Expriment_All2((SFc55_Expriment_All2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c55_Expriment_All2(void *chartInstanceVar)
{
  sf_gateway_c55_Expriment_All2((SFc55_Expriment_All2InstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c55_Expriment_All2(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c55_Expriment_All2
    ((SFc55_Expriment_All2InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c55_Expriment_All2();/* state var info */
...
extern void sf_internal_set_sim_state_c55_Expriment_All2(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c55_Expriment_All2();/* state var info */
  ...
  set_sim_state_c55_Expriment_All2((SFc55_Expriment_All2InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c55_Expriment_All2(SimStruct* S)
{
  return sf_internal_get_sim_state_c55_Expriment_All2(S);
}

static void sf_opaque_set_sim_state_c55_Expriment_All2(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c55_Expriment_All2(S, st);
}

static void sf_opaque_terminate_c55_Expriment_All2(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc55_Expriment_All2InstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c55_Expriment_All2((SFc55_Expriment_All2InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc55_Expriment_All2((SFc55_Expriment_All2InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c55_Expriment_All2(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c55_Expriment_All2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c55_Expriment_All2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c55_Expriment_All2(SimStruct *S)
{
  SFc55_Expriment_All2InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc55_Expriment_All2InstanceStruct *)utMalloc(sizeof
    (SFc55_Expriment_All2InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc55_Expriment_All2InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c55_Expriment_All2;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c55_Expriment_All2;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c55_Expriment_All2;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c55_Expriment_All2;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c55_Expriment_All2;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c55_Expriment_All2;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c55_Expriment_All2;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c55_Expriment_All2;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c55_Expriment_All2;
  chartInstance->chartInfo.mdlStart = mdlStart_c55_Expriment_All2;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c55_Expriment_All2;
...
void c55_Expriment_All2_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c55_Expriment_All2(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c55_Expriment_All2(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c55_Expriment_All2(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c55_Expriment_All2_method_dispatcher.\n"
