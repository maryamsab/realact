...
static void initialize_c12_Expriment_All2(SFc12_Expriment_All2InstanceStruct
  *chartInstance);
static void initialize_params_c12_Expriment_All2
  (SFc12_Expriment_All2InstanceStruct *chartInstance);
static void enable_c12_Expriment_All2(SFc12_Expriment_All2InstanceStruct
  *chartInstance);
static void disable_c12_Expriment_All2(SFc12_Expriment_All2InstanceStruct
  *chartInstance);
static void c12_update_debugger_state_c12_Expriment_All2
  (SFc12_Expriment_All2InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c12_Expriment_All2
  (SFc12_Expriment_All2InstanceStruct *chartInstance);
static void set_sim_state_c12_Expriment_All2(SFc12_Expriment_All2InstanceStruct *
  chartInstance, const mxArray *c12_st);
static void finalize_c12_Expriment_All2(SFc12_Expriment_All2InstanceStruct
  *chartInstance);
static void sf_gateway_c12_Expriment_All2(SFc12_Expriment_All2InstanceStruct
  *chartInstance);
static void initSimStructsc12_Expriment_All2(SFc12_Expriment_All2InstanceStruct *
  chartInstance);
static void init_script_number_translation(uint32_T c12_machineNumber, uint32_T
  c12_chartNumber, uint32_T c12_instanceNumber);
static const mxArray *c12_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static real_T c12_emlrt_marshallIn(SFc12_Expriment_All2InstanceStruct
  *chartInstance, const mxArray *c12_a2, const char_T *c12_identifier);
static real_T c12_b_emlrt_marshallIn(SFc12_Expriment_All2InstanceStruct
  *chartInstance, const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId);
static void c12_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c12_mxArrayInData, const char_T *c12_varName, void *c12_outData);
static const mxArray *c12_b_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static boolean_T c12_c_emlrt_marshallIn(SFc12_Expriment_All2InstanceStruct
  *chartInstance, const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId);
static void c12_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c12_mxArrayInData, const char_T *c12_varName, void *c12_outData);
static const mxArray *c12_c_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static int32_T c12_d_emlrt_marshallIn(SFc12_Expriment_All2InstanceStruct
  *chartInstance, const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId);
static void c12_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c12_mxArrayInData, const char_T *c12_varName, void *c12_outData);
static uint8_T c12_e_emlrt_marshallIn(SFc12_Expriment_All2InstanceStruct
  *chartInstance, const mxArray *c12_b_is_active_c12_Expriment_All2, const
  char_T *c12_identifier);
static uint8_T c12_f_emlrt_marshallIn(SFc12_Expriment_All2InstanceStruct
  *chartInstance, const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId);
static void init_dsm_address_info(SFc12_Expriment_All2InstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c12_is_active_c12_Expriment_All2 = 0U;
}
  ...
  (SFc12_Expriment_All2InstanceStruct *chartInstance)
{
  ...
  c12_b_hoistedGlobal = chartInstance->c12_is_active_c12_Expriment_All2;
  ...
  chartInstance, const mxArray *c12_st)
{
  ...
  *c12_a2 = c12_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c12_u,
    0)), "a2");
  chartInstance->c12_is_active_c12_Expriment_All2 = c12_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c12_u, 1)),
     "is_active_c12_Expriment_All2");
  sf_mex_destroy(&c12_u);
  c12_update_debugger_state_c12_Expriment_All2(chartInstance);
  ...
  *c12_inData)
{
  ...
  const mxArray *c12_y = NULL;
  SFc12_Expriment_All2InstanceStruct *chartInstance;
  chartInstance = (SFc12_Expriment_All2InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c12_Expriment_All2_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c12_identifier)
{
  ...
  c12_y = c12_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c12_b_is_active_c12_Expriment_All2), &c12_thisId);
  sf_mex_destroy(&c12_b_is_active_c12_Expriment_All2);
  return c12_y;
}
...
void sf_c12_Expriment_All2_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c12_Expriment_All2_get_autoinheritance_info(void)
{
...
mxArray *sf_c12_Expriment_All2_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c12_Expriment_All2_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c12_Expriment_All2(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[4],T\"a2\",},{M[8],M[0],T\"is_active_c12_Expriment_All2\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c12_Expriment_All2_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc12_Expriment_All2InstanceStruct *)
...
static void sf_opaque_initialize_c12_Expriment_All2(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc12_Expriment_All2InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c12_Expriment_All2((SFc12_Expriment_All2InstanceStruct*)
    chartInstanceVar);
  initialize_c12_Expriment_All2((SFc12_Expriment_All2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c12_Expriment_All2(void *chartInstanceVar)
{
  enable_c12_Expriment_All2((SFc12_Expriment_All2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c12_Expriment_All2(void *chartInstanceVar)
{
  disable_c12_Expriment_All2((SFc12_Expriment_All2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c12_Expriment_All2(void *chartInstanceVar)
{
  sf_gateway_c12_Expriment_All2((SFc12_Expriment_All2InstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c12_Expriment_All2(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c12_Expriment_All2
    ((SFc12_Expriment_All2InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c12_Expriment_All2();/* state var info */
...
extern void sf_internal_set_sim_state_c12_Expriment_All2(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c12_Expriment_All2();/* state var info */
  ...
  set_sim_state_c12_Expriment_All2((SFc12_Expriment_All2InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c12_Expriment_All2(SimStruct* S)
{
  return sf_internal_get_sim_state_c12_Expriment_All2(S);
}

static void sf_opaque_set_sim_state_c12_Expriment_All2(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c12_Expriment_All2(S, st);
}

static void sf_opaque_terminate_c12_Expriment_All2(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc12_Expriment_All2InstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c12_Expriment_All2((SFc12_Expriment_All2InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc12_Expriment_All2((SFc12_Expriment_All2InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c12_Expriment_All2(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c12_Expriment_All2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c12_Expriment_All2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c12_Expriment_All2(SimStruct *S)
{
  SFc12_Expriment_All2InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc12_Expriment_All2InstanceStruct *)utMalloc(sizeof
    (SFc12_Expriment_All2InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc12_Expriment_All2InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c12_Expriment_All2;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c12_Expriment_All2;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c12_Expriment_All2;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c12_Expriment_All2;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c12_Expriment_All2;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c12_Expriment_All2;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c12_Expriment_All2;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c12_Expriment_All2;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c12_Expriment_All2;
  chartInstance->chartInfo.mdlStart = mdlStart_c12_Expriment_All2;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c12_Expriment_All2;
...
void c12_Expriment_All2_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c12_Expriment_All2(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c12_Expriment_All2(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c12_Expriment_All2(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c12_Expriment_All2_method_dispatcher.\n"
