...
static void initialize_c44_Demo_Glove(SFc44_Demo_GloveInstanceStruct
  *chartInstance);
static void initialize_params_c44_Demo_Glove(SFc44_Demo_GloveInstanceStruct
  *chartInstance);
static void enable_c44_Demo_Glove(SFc44_Demo_GloveInstanceStruct *chartInstance);
static void disable_c44_Demo_Glove(SFc44_Demo_GloveInstanceStruct *chartInstance);
static void c44_update_debugger_state_c44_Demo_Glove
  (SFc44_Demo_GloveInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c44_Demo_Glove
  (SFc44_Demo_GloveInstanceStruct *chartInstance);
static void set_sim_state_c44_Demo_Glove(SFc44_Demo_GloveInstanceStruct
  *chartInstance, const mxArray *c44_st);
static void c44_set_sim_state_side_effects_c44_Demo_Glove
  (SFc44_Demo_GloveInstanceStruct *chartInstance);
static void finalize_c44_Demo_Glove(SFc44_Demo_GloveInstanceStruct
  *chartInstance);
static void sf_gateway_c44_Demo_Glove(SFc44_Demo_GloveInstanceStruct
  *chartInstance);
static void c44_enter_atomic_c44_Demo_Glove(SFc44_Demo_GloveInstanceStruct
  *chartInstance);
static void c44_enter_internal_c44_Demo_Glove(SFc44_Demo_GloveInstanceStruct
  *chartInstance);
static void c44_c44_Demo_Glove(SFc44_Demo_GloveInstanceStruct *chartInstance);
static void c44_exit_internal_c44_Demo_Glove(SFc44_Demo_GloveInstanceStruct
  *chartInstance);
static void c44_initc44_Demo_Glove(SFc44_Demo_GloveInstanceStruct *chartInstance);
static void initSimStructsc44_Demo_Glove(SFc44_Demo_GloveInstanceStruct
  *chartInstance);
...
static const mxArray *c44_sf_marshallOut(void *chartInstanceVoid, void
  *c44_inData);
static real_T c44_emlrt_marshallIn(SFc44_Demo_GloveInstanceStruct *chartInstance,
...
static const mxArray *c44_b_sf_marshallOut(void *chartInstanceVoid, void
  *c44_inData);
static boolean_T c44_b_emlrt_marshallIn(SFc44_Demo_GloveInstanceStruct
...
static const mxArray *c44_c_sf_marshallOut(void *chartInstanceVoid, void
  *c44_inData);
static int32_T c44_c_emlrt_marshallIn(SFc44_Demo_GloveInstanceStruct
  *chartInstance, const mxArray *c44_u, const emlrtMsgIdentifier *c44_parentId);
...
static const mxArray *c44_d_sf_marshallOut(void *chartInstanceVoid, void
  *c44_inData);
static uint8_T c44_d_emlrt_marshallIn(SFc44_Demo_GloveInstanceStruct
  *chartInstance, const mxArray *c44_b_tp_setP, const char_T *c44_identifier);
static uint8_T c44_e_emlrt_marshallIn(SFc44_Demo_GloveInstanceStruct
  *chartInstance, const mxArray *c44_u, const emlrtMsgIdentifier *c44_parentId);
...
static const mxArray *c44_e_sf_marshallOut(void *chartInstanceVoid, void
  *c44_inData);
static void c44_f_emlrt_marshallIn(SFc44_Demo_GloveInstanceStruct *chartInstance,
...
static const mxArray *c44_f_sf_marshallOut(void *chartInstanceVoid, void
  *c44_inData);
static const mxArray *c44_g_emlrt_marshallIn(SFc44_Demo_GloveInstanceStruct
  *chartInstance, const mxArray *c44_b_subchartSimStateInfo, const char_T
  *c44_identifier);
static const mxArray *c44_h_emlrt_marshallIn(SFc44_Demo_GloveInstanceStruct
  *chartInstance, const mxArray *c44_u, const emlrtMsgIdentifier *c44_parentId);
static real_T c44_get_avert_gaze_dirs_chance(SFc44_Demo_GloveInstanceStruct
  *chartInstance, uint32_T c44_b);
static void c44_set_avert_gaze_dirs_chance(SFc44_Demo_GloveInstanceStruct
  *chartInstance, uint32_T c44_b, real_T c44_c);
static real_T *c44_access_avert_gaze_dirs_chance(SFc44_Demo_GloveInstanceStruct *
  chartInstance, uint32_T c44_b);
static real_T c44_get_avert_gaze_duration_factor(SFc44_Demo_GloveInstanceStruct *
  chartInstance, uint32_T c44_b);
static void c44_set_avert_gaze_duration_factor(SFc44_Demo_GloveInstanceStruct
  *chartInstance, uint32_T c44_b, real_T c44_c);
static real_T *c44_access_avert_gaze_duration_factor
  (SFc44_Demo_GloveInstanceStruct *chartInstance, uint32_T c44_b);
static real_T c44_get_avert_head_frequency_factor(SFc44_Demo_GloveInstanceStruct
  *chartInstance, uint32_T c44_b);
static void c44_set_avert_head_frequency_factor(SFc44_Demo_GloveInstanceStruct
  *chartInstance, uint32_T c44_b, real_T c44_c);
static real_T *c44_access_avert_head_frequency_factor
  (SFc44_Demo_GloveInstanceStruct *chartInstance, uint32_T c44_b);
static real_T c44_get_avert_head_speed(SFc44_Demo_GloveInstanceStruct
  *chartInstance, uint32_T c44_b);
static void c44_set_avert_head_speed(SFc44_Demo_GloveInstanceStruct
  *chartInstance, uint32_T c44_b, real_T c44_c);
static real_T *c44_access_avert_head_speed(SFc44_Demo_GloveInstanceStruct
  *chartInstance, uint32_T c44_b);
static real_T c44_get_emotion_amount_factor(SFc44_Demo_GloveInstanceStruct
  *chartInstance, uint32_T c44_b);
static void c44_set_emotion_amount_factor(SFc44_Demo_GloveInstanceStruct
  *chartInstance, uint32_T c44_b, real_T c44_c);
static real_T *c44_access_emotion_amount_factor(SFc44_Demo_GloveInstanceStruct
  *chartInstance, uint32_T c44_b);
static real_T c44_get_mutual_gaze_duration_factor(SFc44_Demo_GloveInstanceStruct
  *chartInstance, uint32_T c44_b);
static void c44_set_mutual_gaze_duration_factor(SFc44_Demo_GloveInstanceStruct
  *chartInstance, uint32_T c44_b, real_T c44_c);
static real_T *c44_access_mutual_gaze_duration_factor
  (SFc44_Demo_GloveInstanceStruct *chartInstance, uint32_T c44_b);
static real_T c44_get_pose_chanc_factor(SFc44_Demo_GloveInstanceStruct
  *chartInstance, uint32_T c44_b);
static void c44_set_pose_chanc_factor(SFc44_Demo_GloveInstanceStruct
  *chartInstance, uint32_T c44_b, real_T c44_c);
static real_T *c44_access_pose_chanc_factor(SFc44_Demo_GloveInstanceStruct
  *chartInstance, uint32_T c44_b);
static real_T c44_get_pose_frequency_factor(SFc44_Demo_GloveInstanceStruct
  *chartInstance, uint32_T c44_b);
static void c44_set_pose_frequency_factor(SFc44_Demo_GloveInstanceStruct
  *chartInstance, uint32_T c44_b, real_T c44_c);
static real_T *c44_access_pose_frequency_factor(SFc44_Demo_GloveInstanceStruct
  *chartInstance, uint32_T c44_b);
static real_T c44_get_pose_lean(SFc44_Demo_GloveInstanceStruct *chartInstance,
  uint32_T c44_b);
static void c44_set_pose_lean(SFc44_Demo_GloveInstanceStruct *chartInstance,
  uint32_T c44_b, real_T c44_c);
static real_T *c44_access_pose_lean(SFc44_Demo_GloveInstanceStruct
  *chartInstance, uint32_T c44_b);
static real_T c44_get_pose_lean_flag(SFc44_Demo_GloveInstanceStruct
  *chartInstance, uint32_T c44_b);
static void c44_set_pose_lean_flag(SFc44_Demo_GloveInstanceStruct *chartInstance,
  uint32_T c44_b, real_T c44_c);
static real_T *c44_access_pose_lean_flag(SFc44_Demo_GloveInstanceStruct
  *chartInstance, uint32_T c44_b);
static real_T c44_get_pose_selfAdaptor_chance_factor
  (SFc44_Demo_GloveInstanceStruct *chartInstance, uint32_T c44_b);
static void c44_set_pose_selfAdaptor_chance_factor
  (SFc44_Demo_GloveInstanceStruct *chartInstance, uint32_T c44_b, real_T c44_c);
static real_T *c44_access_pose_selfAdaptor_chance_factor
  (SFc44_Demo_GloveInstanceStruct *chartInstance, uint32_T c44_b);
static real_T c44_get_pose_speed(SFc44_Demo_GloveInstanceStruct *chartInstance,
  uint32_T c44_b);
static void c44_set_pose_speed(SFc44_Demo_GloveInstanceStruct *chartInstance,
  uint32_T c44_b, real_T c44_c);
static real_T *c44_access_pose_speed(SFc44_Demo_GloveInstanceStruct
  *chartInstance, uint32_T c44_b);
static void init_dsm_address_info(SFc44_Demo_GloveInstanceStruct *chartInstance);
  ...
  (SFc44_Demo_GloveInstanceStruct *chartInstance)
{
  ...
  c44_hoistedGlobal = chartInstance->c44_is_active_c44_Demo_Glove;
  c44_u = c44_hoistedGlobal;
  c44_b_y = NULL;
  sf_mex_assign(&c44_b_y, sf_mex_create("y", &c44_u, 3, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c44_y, 0, c44_b_y);
  c44_b_hoistedGlobal = chartInstance->c44_is_c44_Demo_Glove;
  ...
  *chartInstance, const mxArray *c44_st)
{
  ...
  chartInstance->c44_is_active_c44_Demo_Glove = c44_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c44_u, 0)),
     "is_active_c44_Demo_Glove");
  chartInstance->c44_is_c44_Demo_Glove = c44_d_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c44_u, 1)), "is_c44_Demo_Glove");
  ...
  c44_update_debugger_state_c44_Demo_Glove(chartInstance);
...
static void sf_gateway_c44_Demo_Glove(SFc44_Demo_GloveInstanceStruct
  *chartInstance)
{
  c44_set_sim_state_side_effects_c44_Demo_Glove(chartInstance);
}
  ...
  *chartInstance)
{
  ...
  chartInstance->c44_is_active_c44_Demo_Glove = 1U;
  ...
  *chartInstance)
{
  ...
  chartInstance->c44_is_c44_Demo_Glove = c44_IN_init;
  _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, chartInstance->c44_sfEvent);
  chartInstance->c44_tp_init = 1U;
...
static void c44_c44_Demo_Glove(SFc44_Demo_GloveInstanceStruct *chartInstance)
{
  ...
  switch (chartInstance->c44_is_c44_Demo_Glove) {
   case c44_IN_init:
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, chartInstance->c44_sfEvent);
    chartInstance->c44_isStable = false;
    chartInstance->c44_is_c44_Demo_Glove = c44_IN_wait;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 4U, chartInstance->c44_sfEvent);
    chartInstance->c44_tp_wait = 1U;
   ...
   case c44_IN_wait:
    ...
    if (c44_out) {
      ...
      _SFD_CS_CALL(STATE_INACTIVE_TAG, 4U, chartInstance->c44_sfEvent);
      chartInstance->c44_isStable = false;
      chartInstance->c44_is_c44_Demo_Glove = c44_IN_setP;
      _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, chartInstance->c44_sfEvent);
      chartInstance->c44_tp_setP = 1U;
      ...
      if (c44_b_out) {
        ...
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 4U, chartInstance->c44_sfEvent);
        chartInstance->c44_isStable = false;
        chartInstance->c44_is_c44_Demo_Glove = c44_IN_setP1;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 2U, chartInstance->c44_sfEvent);
        chartInstance->c44_tp_setP1 = 1U;
   ...
   default:
    ...
    chartInstance->c44_is_c44_Demo_Glove = c44_IN_NO_ACTIVE_CHILD;
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, chartInstance->c44_sfEvent);
    break;
  }
...
static void c44_initc44_Demo_Glove(SFc44_Demo_GloveInstanceStruct *chartInstance)
{
  ...
  chartInstance->c44_tp_setP1 = 0U;
  chartInstance->c44_tp_wait = 0U;
  chartInstance->c44_is_active_c44_Demo_Glove = 0U;
  chartInstance->c44_is_c44_Demo_Glove = c44_IN_NO_ACTIVE_CHILD;
}
  ...
  *c44_inData)
{
  ...
  const mxArray *c44_y = NULL;
  SFc44_Demo_GloveInstanceStruct *chartInstance;
  chartInstance = (SFc44_Demo_GloveInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c44_Demo_Glove_get_eml_resolved_functions_info(void)
{
...
boolean_T sf_exported_auto_isStablec44_Demo_Glove(SimStruct *c44_S)
{
  SFc44_Demo_GloveInstanceStruct *chartInstance;
  chartInstance = (SFc44_Demo_GloveInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c44_S))->instanceInfo)->chartInstance;
  return chartInstance->c44_isStable;
}

void sf_exported_auto_duringc44_Demo_Glove(SimStruct *c44_S)
{
  SFc44_Demo_GloveInstanceStruct *chartInstance;
  chartInstance = (SFc44_Demo_GloveInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c44_S))->instanceInfo)->chartInstance;
  c44_c44_Demo_Glove(chartInstance);
}

void sf_exported_auto_enterc44_Demo_Glove(SimStruct *c44_S)
{
  SFc44_Demo_GloveInstanceStruct *chartInstance;
  chartInstance = (SFc44_Demo_GloveInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c44_S))->instanceInfo)->chartInstance;
  ...
  sf_exported_auto_enablec46_lib_affectiveChar_behavior
    (chartInstance->c44_subchartSimstruct);
  c44_enter_atomic_c44_Demo_Glove(chartInstance);
  c44_enter_internal_c44_Demo_Glove(chartInstance);
}

void sf_exported_auto_exitc44_Demo_Glove(SimStruct *c44_S)
{
  SFc44_Demo_GloveInstanceStruct *chartInstance;
  chartInstance = (SFc44_Demo_GloveInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c44_S))->instanceInfo)->chartInstance;
  _sfTime_ = sf_get_time(chartInstance->S);
  c44_exit_internal_c44_Demo_Glove(chartInstance);
  sf_exported_auto_disablec46_lib_affectiveChar_behavior
    (chartInstance->c44_subchartSimstruct);
}

void sf_exported_auto_gatewayc44_Demo_Glove(SimStruct *c44_S)
{
  SFc44_Demo_GloveInstanceStruct *chartInstance;
  chartInstance = (SFc44_Demo_GloveInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c44_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_enablec44_Demo_Glove(SimStruct *c44_S)
{
  SFc44_Demo_GloveInstanceStruct *chartInstance;
  chartInstance = (SFc44_Demo_GloveInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c44_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_disablec44_Demo_Glove(SimStruct *c44_S)
{
  SFc44_Demo_GloveInstanceStruct *chartInstance;
  chartInstance = (SFc44_Demo_GloveInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c44_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_stepBuffersc44_Demo_Glove(SimStruct *c44_S)
{
  SFc44_Demo_GloveInstanceStruct *chartInstance;
  chartInstance = (SFc44_Demo_GloveInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c44_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_initBuffersc44_Demo_Glove(SimStruct *c44_S)
{
  SFc44_Demo_GloveInstanceStruct *chartInstance;
  chartInstance = (SFc44_Demo_GloveInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c44_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_activate_callc44_Demo_Glove(SimStruct *c44_S)
{
  SFc44_Demo_GloveInstanceStruct *chartInstance;
  chartInstance = (SFc44_Demo_GloveInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c44_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_increment_call_counterc44_Demo_Glove(SimStruct *c44_S)
{
  SFc44_Demo_GloveInstanceStruct *chartInstance;
  chartInstance = (SFc44_Demo_GloveInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c44_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_reset_call_counterc44_Demo_Glove(SimStruct *c44_S)
{
  SFc44_Demo_GloveInstanceStruct *chartInstance;
  chartInstance = (SFc44_Demo_GloveInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c44_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_deactivate_callc44_Demo_Glove(SimStruct *c44_S)
{
  SFc44_Demo_GloveInstanceStruct *chartInstance;
  chartInstance = (SFc44_Demo_GloveInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c44_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_initc44_Demo_Glove(SimStruct *c44_S)
{
  SFc44_Demo_GloveInstanceStruct *chartInstance;
  chartInstance = (SFc44_Demo_GloveInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c44_S))->instanceInfo)->chartInstance;
  c44_initc44_Demo_Glove(chartInstance);
}

const mxArray *sf_exported_auto_getSimstatec44_Demo_Glove(SimStruct *c44_S)
{
  ...
  chartInstance = (SFc44_Demo_GloveInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c44_S))->instanceInfo)->chartInstance;
  c44_out = NULL;
  sf_mex_assign(&c44_out, sf_internal_get_sim_state_c44_Demo_Glove(c44_S), false);
  return c44_out;
}

void sf_exported_auto_setSimstatec44_Demo_Glove(SimStruct *c44_S, const mxArray *
  c44_in)
{
  SFc44_Demo_GloveInstanceStruct *chartInstance;
  chartInstance = (SFc44_Demo_GloveInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c44_S))->instanceInfo)->chartInstance;
  sf_internal_set_sim_state_c44_Demo_Glove(c44_S, sf_mex_dup(c44_in));
  sf_mex_destroy(&c44_in);
}

void sf_exported_auto_check_state_inconsistency_c44_Demo_Glove(SimStruct *c44_S)
{
  SFc44_Demo_GloveInstanceStruct *chartInstance;
  chartInstance = (SFc44_Demo_GloveInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c44_S))->instanceInfo)->chartInstance;
  ...
  *chartInstance, uint32_T c44_b)
{
  ...
  if (chartInstance->c44_avert_gaze_dirs_chance_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'avert_gaze_dirs_chance\' (#987) in the initialization routine of the chart.\n");
  }
  ...
  chartInstance, uint32_T c44_b)
{
  ...
  if (chartInstance->c44_avert_gaze_duration_factor_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'avert_gaze_duration_factor\' (#985) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c44_b)
{
  ...
  if (chartInstance->c44_avert_head_frequency_factor_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'avert_head_frequency_factor\' (#984) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c44_b)
{
  ...
  if (chartInstance->c44_avert_head_speed_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'avert_head_speed\' (#986) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c44_b)
{
  ...
  if (chartInstance->c44_emotion_amount_factor_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'emotion_amount_factor\' (#996) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c44_b)
{
  ...
  if (chartInstance->c44_mutual_gaze_duration_factor_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'mutual_gaze_duration_factor\' (#983) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c44_b)
{
  ...
  if (chartInstance->c44_pose_chanc_factor_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'pose_chanc_factor\' (#991) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c44_b)
{
  ...
  if (chartInstance->c44_pose_frequency_factor_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'pose_frequency_factor\' (#992) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c44_b)
{
  ...
  if (chartInstance->c44_pose_lean_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'pose_lean\' (#989) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c44_b)
{
  ...
  if (chartInstance->c44_pose_lean_flag_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'pose_lean_flag\' (#994) in the initialization routine of the chart.\n");
  }
  ...
  (SFc44_Demo_GloveInstanceStruct *chartInstance, uint32_T c44_b)
{
  ...
  if (chartInstance->c44_pose_selfAdaptor_chance_factor_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'pose_selfAdaptor_chance_factor\' (#993) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c44_b)
{
  ...
  if (chartInstance->c44_pose_speed_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'pose_speed\' (#990) in the initialization routine of the chart.\n");
  }
...
void sf_c44_Demo_Glove_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c44_Demo_Glove_get_autoinheritance_info(void)
{
...
mxArray *sf_c44_Demo_Glove_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c44_Demo_Glove_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c44_Demo_Glove(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[8],M[0],T\"is_active_c44_Demo_Glove\",},{M[9],M[0],T\"is_c44_Demo_Glove\",},{M[14],M[123],T\"subchartSimStateInfo\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c44_Demo_Glove_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc44_Demo_GloveInstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c44_Demo_Glove(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc44_Demo_GloveInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c44_Demo_Glove((SFc44_Demo_GloveInstanceStruct*)
    chartInstanceVar);
  initialize_c44_Demo_Glove((SFc44_Demo_GloveInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c44_Demo_Glove(void *chartInstanceVar)
{
  enable_c44_Demo_Glove((SFc44_Demo_GloveInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c44_Demo_Glove(void *chartInstanceVar)
{
  disable_c44_Demo_Glove((SFc44_Demo_GloveInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c44_Demo_Glove(void *chartInstanceVar)
{
  sf_gateway_c44_Demo_Glove((SFc44_Demo_GloveInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c44_Demo_Glove(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c44_Demo_Glove
    ((SFc44_Demo_GloveInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c44_Demo_Glove();/* state var info */
...
extern void sf_internal_set_sim_state_c44_Demo_Glove(SimStruct* S, const mxArray
  *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c44_Demo_Glove();/* state var info */
  ...
  set_sim_state_c44_Demo_Glove((SFc44_Demo_GloveInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c44_Demo_Glove(SimStruct* S)
{
  return NULL;
}

static void sf_opaque_set_sim_state_c44_Demo_Glove(SimStruct* S, const mxArray
  *st)
{
}

static void sf_opaque_terminate_c44_Demo_Glove(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc44_Demo_GloveInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c44_Demo_Glove((SFc44_Demo_GloveInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc44_Demo_Glove((SFc44_Demo_GloveInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c44_Demo_Glove(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c44_Demo_Glove(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c44_Demo_Glove(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c44_Demo_Glove(SimStruct *S)
{
  SFc44_Demo_GloveInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc44_Demo_GloveInstanceStruct *)utMalloc(sizeof
    (SFc44_Demo_GloveInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc44_Demo_GloveInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c44_Demo_Glove;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c44_Demo_Glove;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c44_Demo_Glove;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c44_Demo_Glove;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c44_Demo_Glove;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c44_Demo_Glove;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c44_Demo_Glove;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c44_Demo_Glove;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c44_Demo_Glove;
  chartInstance->chartInfo.mdlStart = mdlStart_c44_Demo_Glove;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c44_Demo_Glove;
...
void c44_Demo_Glove_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c44_Demo_Glove(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c44_Demo_Glove(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c44_Demo_Glove(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c44_Demo_Glove_method_dispatcher.\n"
