...
static void initialize_c37_Demo_Glove(SFc37_Demo_GloveInstanceStruct
  *chartInstance);
static void initialize_params_c37_Demo_Glove(SFc37_Demo_GloveInstanceStruct
  *chartInstance);
static void enable_c37_Demo_Glove(SFc37_Demo_GloveInstanceStruct *chartInstance);
static void disable_c37_Demo_Glove(SFc37_Demo_GloveInstanceStruct *chartInstance);
static void c37_update_debugger_state_c37_Demo_Glove
  (SFc37_Demo_GloveInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c37_Demo_Glove
  (SFc37_Demo_GloveInstanceStruct *chartInstance);
static void set_sim_state_c37_Demo_Glove(SFc37_Demo_GloveInstanceStruct
  *chartInstance, const mxArray *c37_st);
static void finalize_c37_Demo_Glove(SFc37_Demo_GloveInstanceStruct
  *chartInstance);
static void sf_gateway_c37_Demo_Glove(SFc37_Demo_GloveInstanceStruct
  *chartInstance);
static void initSimStructsc37_Demo_Glove(SFc37_Demo_GloveInstanceStruct
  *chartInstance);
...
static const mxArray *c37_sf_marshallOut(void *chartInstanceVoid, void
  *c37_inData);
static real_T c37_emlrt_marshallIn(SFc37_Demo_GloveInstanceStruct *chartInstance,
  const mxArray *c37_personality, const char_T *c37_identifier);
static real_T c37_b_emlrt_marshallIn(SFc37_Demo_GloveInstanceStruct
...
static const mxArray *c37_c_sf_marshallOut(void *chartInstanceVoid, void
  *c37_inData);
static int32_T c37_c_emlrt_marshallIn(SFc37_Demo_GloveInstanceStruct
  *chartInstance, const mxArray *c37_u, const emlrtMsgIdentifier *c37_parentId);
static void c37_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c37_mxArrayInData, const char_T *c37_varName, void *c37_outData);
static uint8_T c37_d_emlrt_marshallIn(SFc37_Demo_GloveInstanceStruct
  *chartInstance, const mxArray *c37_b_is_active_c37_Demo_Glove, const char_T
  *c37_identifier);
static uint8_T c37_e_emlrt_marshallIn(SFc37_Demo_GloveInstanceStruct
  *chartInstance, const mxArray *c37_u, const emlrtMsgIdentifier *c37_parentId);
static void init_dsm_address_info(SFc37_Demo_GloveInstanceStruct *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c37_is_active_c37_Demo_Glove = 0U;
}
  ...
  (SFc37_Demo_GloveInstanceStruct *chartInstance)
{
  ...
  c37_b_hoistedGlobal = chartInstance->c37_is_active_c37_Demo_Glove;
  ...
  *chartInstance, const mxArray *c37_st)
{
  ...
  *c37_personality = c37_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  chartInstance->c37_is_active_c37_Demo_Glove = c37_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c37_u, 1)),
     "is_active_c37_Demo_Glove");
  sf_mex_destroy(&c37_u);
  c37_update_debugger_state_c37_Demo_Glove(chartInstance);
  ...
  *c37_inData)
{
  ...
  const mxArray *c37_y = NULL;
  SFc37_Demo_GloveInstanceStruct *chartInstance;
  chartInstance = (SFc37_Demo_GloveInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c37_Demo_Glove_get_eml_resolved_functions_info(void)
{
  ...
  *c37_identifier)
{
  ...
  c37_y = c37_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c37_b_is_active_c37_Demo_Glove), &c37_thisId);
  sf_mex_destroy(&c37_b_is_active_c37_Demo_Glove);
  return c37_y;
}
...
void sf_c37_Demo_Glove_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c37_Demo_Glove_get_autoinheritance_info(void)
{
...
mxArray *sf_c37_Demo_Glove_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c37_Demo_Glove_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c37_Demo_Glove(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"personality\",},{M[8],M[0],T\"is_active_c37_Demo_Glove\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c37_Demo_Glove_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc37_Demo_GloveInstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c37_Demo_Glove(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc37_Demo_GloveInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c37_Demo_Glove((SFc37_Demo_GloveInstanceStruct*)
    chartInstanceVar);
  initialize_c37_Demo_Glove((SFc37_Demo_GloveInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c37_Demo_Glove(void *chartInstanceVar)
{
  enable_c37_Demo_Glove((SFc37_Demo_GloveInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c37_Demo_Glove(void *chartInstanceVar)
{
  disable_c37_Demo_Glove((SFc37_Demo_GloveInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c37_Demo_Glove(void *chartInstanceVar)
{
  sf_gateway_c37_Demo_Glove((SFc37_Demo_GloveInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c37_Demo_Glove(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c37_Demo_Glove
    ((SFc37_Demo_GloveInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c37_Demo_Glove();/* state var info */
...
extern void sf_internal_set_sim_state_c37_Demo_Glove(SimStruct* S, const mxArray
  *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c37_Demo_Glove();/* state var info */
  ...
  set_sim_state_c37_Demo_Glove((SFc37_Demo_GloveInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c37_Demo_Glove(SimStruct* S)
{
  return sf_internal_get_sim_state_c37_Demo_Glove(S);
}

static void sf_opaque_set_sim_state_c37_Demo_Glove(SimStruct* S, const mxArray
  *st)
{
  sf_internal_set_sim_state_c37_Demo_Glove(S, st);
}

static void sf_opaque_terminate_c37_Demo_Glove(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc37_Demo_GloveInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c37_Demo_Glove((SFc37_Demo_GloveInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc37_Demo_Glove((SFc37_Demo_GloveInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c37_Demo_Glove(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c37_Demo_Glove(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c37_Demo_Glove(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c37_Demo_Glove(SimStruct *S)
{
  SFc37_Demo_GloveInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc37_Demo_GloveInstanceStruct *)utMalloc(sizeof
    (SFc37_Demo_GloveInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc37_Demo_GloveInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c37_Demo_Glove;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c37_Demo_Glove;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c37_Demo_Glove;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c37_Demo_Glove;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c37_Demo_Glove;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c37_Demo_Glove;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c37_Demo_Glove;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c37_Demo_Glove;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c37_Demo_Glove;
  chartInstance->chartInfo.mdlStart = mdlStart_c37_Demo_Glove;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c37_Demo_Glove;
...
void c37_Demo_Glove_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c37_Demo_Glove(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c37_Demo_Glove(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c37_Demo_Glove(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c37_Demo_Glove_method_dispatcher.\n"
