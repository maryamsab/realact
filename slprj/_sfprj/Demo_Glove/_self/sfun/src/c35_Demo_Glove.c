...
static void initialize_c35_Demo_Glove(SFc35_Demo_GloveInstanceStruct
  *chartInstance);
static void initialize_params_c35_Demo_Glove(SFc35_Demo_GloveInstanceStruct
  *chartInstance);
static void enable_c35_Demo_Glove(SFc35_Demo_GloveInstanceStruct *chartInstance);
static void disable_c35_Demo_Glove(SFc35_Demo_GloveInstanceStruct *chartInstance);
static void c35_update_debugger_state_c35_Demo_Glove
  (SFc35_Demo_GloveInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c35_Demo_Glove
  (SFc35_Demo_GloveInstanceStruct *chartInstance);
static void set_sim_state_c35_Demo_Glove(SFc35_Demo_GloveInstanceStruct
  *chartInstance, const mxArray *c35_st);
static void c35_set_sim_state_side_effects_c35_Demo_Glove
  (SFc35_Demo_GloveInstanceStruct *chartInstance);
static void finalize_c35_Demo_Glove(SFc35_Demo_GloveInstanceStruct
  *chartInstance);
static void sf_gateway_c35_Demo_Glove(SFc35_Demo_GloveInstanceStruct
  *chartInstance);
static void initSimStructsc35_Demo_Glove(SFc35_Demo_GloveInstanceStruct
  *chartInstance);
static void c35_enter_atomic_stateCreatePawn(SFc35_Demo_GloveInstanceStruct
  *chartInstance);
...
static const mxArray *c35_sf_marshallOut(void *chartInstanceVoid, void
  *c35_inData);
static real_T c35_emlrt_marshallIn(SFc35_Demo_GloveInstanceStruct *chartInstance,
...
static const mxArray *c35_b_sf_marshallOut(void *chartInstanceVoid, void
  *c35_inData);
static void c35_b_emlrt_marshallIn(SFc35_Demo_GloveInstanceStruct *chartInstance,
...
static void c35_sendSBM(SFc35_Demo_GloveInstanceStruct *chartInstance, real_T
  c35_In2[1000]);
static const mxArray *c35_e_sf_marshallOut(void *chartInstanceVoid, void
  *c35_inData);
static int32_T c35_c_emlrt_marshallIn(SFc35_Demo_GloveInstanceStruct
...
static const mxArray *c35_f_sf_marshallOut(void *chartInstanceVoid, void
  *c35_inData);
static uint8_T c35_d_emlrt_marshallIn(SFc35_Demo_GloveInstanceStruct
  *chartInstance, const mxArray *c35_b_tp_stateCreatePawn, const char_T
  *c35_identifier);
static uint8_T c35_e_emlrt_marshallIn(SFc35_Demo_GloveInstanceStruct
  *chartInstance, const mxArray *c35_u, const emlrtMsgIdentifier *c35_parentId);
...
static const mxArray *c35_g_sf_marshallOut(void *chartInstanceVoid, void
  *c35_inData);
static void c35_f_emlrt_marshallIn(SFc35_Demo_GloveInstanceStruct *chartInstance,
  const mxArray *c35_u, const emlrtMsgIdentifier *c35_parentId, real_T c35_y
  [1000]);
static void c35_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c35_mxArrayInData, const char_T *c35_varName, void *c35_outData);
static const mxArray *c35_g_emlrt_marshallIn(SFc35_Demo_GloveInstanceStruct
  *chartInstance, const mxArray *c35_b_setSimStateSideEffectsInfo, const char_T *
  c35_identifier);
static const mxArray *c35_h_emlrt_marshallIn(SFc35_Demo_GloveInstanceStruct
  *chartInstance, const mxArray *c35_u, const emlrtMsgIdentifier *c35_parentId);
static void init_dsm_address_info(SFc35_Demo_GloveInstanceStruct *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c35_is_active_c35_Demo_Glove = 0U;
  chartInstance->c35_is_c35_Demo_Glove = c35_IN_NO_ACTIVE_CHILD;
}
  ...
  (SFc35_Demo_GloveInstanceStruct *chartInstance)
{
  ...
  if (chartInstance->c35_is_active_c35_Demo_Glove == 1U) {
    _SFD_CC_CALL(CHART_ACTIVE_TAG, 16U, chartInstance->c35_sfEvent);
  }

  if (chartInstance->c35_is_c35_Demo_Glove == c35_IN_stateCreatePawn) {
  ...
  (SFc35_Demo_GloveInstanceStruct *chartInstance)
{
  ...
  c35_hoistedGlobal = chartInstance->c35_is_active_c35_Demo_Glove;
  c35_u = c35_hoistedGlobal;
  c35_b_y = NULL;
  sf_mex_assign(&c35_b_y, sf_mex_create("y", &c35_u, 3, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c35_y, 0, c35_b_y);
  c35_b_hoistedGlobal = chartInstance->c35_is_c35_Demo_Glove;
  ...
  *chartInstance, const mxArray *c35_st)
{
  ...
  chartInstance->c35_is_active_c35_Demo_Glove = c35_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c35_u, 0)),
     "is_active_c35_Demo_Glove");
  chartInstance->c35_is_c35_Demo_Glove = c35_d_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c35_u, 1)), "is_c35_Demo_Glove");
  ...
  c35_update_debugger_state_c35_Demo_Glove(chartInstance);
...
static void sf_gateway_c35_Demo_Glove(SFc35_Demo_GloveInstanceStruct
  *chartInstance)
{
  c35_set_sim_state_side_effects_c35_Demo_Glove(chartInstance);
  ...
  if (chartInstance->c35_is_active_c35_Demo_Glove == 0U) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 16U, chartInstance->c35_sfEvent);
    chartInstance->c35_is_active_c35_Demo_Glove = 1U;
    ...
    chartInstance->c35_is_c35_Demo_Glove = c35_IN_stateCreatePawn;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, chartInstance->c35_sfEvent);
    chartInstance->c35_tp_stateCreatePawn = 1U;
  ...
  *c35_inData)
{
  ...
  const mxArray *c35_y = NULL;
  SFc35_Demo_GloveInstanceStruct *chartInstance;
  chartInstance = (SFc35_Demo_GloveInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c35_Demo_Glove_get_eml_resolved_functions_info(void)
{
...
void sf_c35_Demo_Glove_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c35_Demo_Glove_get_autoinheritance_info(void)
{
...
mxArray *sf_c35_Demo_Glove_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c35_Demo_Glove_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c35_Demo_Glove(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[8],M[0],T\"is_active_c35_Demo_Glove\",},{M[9],M[0],T\"is_c35_Demo_Glove\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c35_Demo_Glove_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc35_Demo_GloveInstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c35_Demo_Glove(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc35_Demo_GloveInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c35_Demo_Glove((SFc35_Demo_GloveInstanceStruct*)
    chartInstanceVar);
  initialize_c35_Demo_Glove((SFc35_Demo_GloveInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c35_Demo_Glove(void *chartInstanceVar)
{
  enable_c35_Demo_Glove((SFc35_Demo_GloveInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c35_Demo_Glove(void *chartInstanceVar)
{
  disable_c35_Demo_Glove((SFc35_Demo_GloveInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c35_Demo_Glove(void *chartInstanceVar)
{
  sf_gateway_c35_Demo_Glove((SFc35_Demo_GloveInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c35_Demo_Glove(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c35_Demo_Glove
    ((SFc35_Demo_GloveInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c35_Demo_Glove();/* state var info */
...
extern void sf_internal_set_sim_state_c35_Demo_Glove(SimStruct* S, const mxArray
  *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c35_Demo_Glove();/* state var info */
  ...
  set_sim_state_c35_Demo_Glove((SFc35_Demo_GloveInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c35_Demo_Glove(SimStruct* S)
{
  return sf_internal_get_sim_state_c35_Demo_Glove(S);
}

static void sf_opaque_set_sim_state_c35_Demo_Glove(SimStruct* S, const mxArray
  *st)
{
  sf_internal_set_sim_state_c35_Demo_Glove(S, st);
}

static void sf_opaque_terminate_c35_Demo_Glove(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc35_Demo_GloveInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c35_Demo_Glove((SFc35_Demo_GloveInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc35_Demo_Glove((SFc35_Demo_GloveInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c35_Demo_Glove(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c35_Demo_Glove(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(2479050234U));
  ssSetChecksum1(S,(3796060823U));
  ssSetChecksum2(S,(2409919918U));
  ssSetChecksum3(S,(3500823440U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c35_Demo_Glove(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c35_Demo_Glove(SimStruct *S)
{
  SFc35_Demo_GloveInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc35_Demo_GloveInstanceStruct *)utMalloc(sizeof
    (SFc35_Demo_GloveInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc35_Demo_GloveInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c35_Demo_Glove;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c35_Demo_Glove;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c35_Demo_Glove;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c35_Demo_Glove;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c35_Demo_Glove;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c35_Demo_Glove;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c35_Demo_Glove;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c35_Demo_Glove;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c35_Demo_Glove;
  chartInstance->chartInfo.mdlStart = mdlStart_c35_Demo_Glove;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c35_Demo_Glove;
...
void c35_Demo_Glove_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c35_Demo_Glove(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c35_Demo_Glove(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c35_Demo_Glove(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c35_Demo_Glove_method_dispatcher.\n"
