...
static void initialize_c40_Demo_Glove(SFc40_Demo_GloveInstanceStruct
  *chartInstance);
static void initialize_params_c40_Demo_Glove(SFc40_Demo_GloveInstanceStruct
  *chartInstance);
static void enable_c40_Demo_Glove(SFc40_Demo_GloveInstanceStruct *chartInstance);
static void disable_c40_Demo_Glove(SFc40_Demo_GloveInstanceStruct *chartInstance);
static void c40_update_debugger_state_c40_Demo_Glove
  (SFc40_Demo_GloveInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c40_Demo_Glove
  (SFc40_Demo_GloveInstanceStruct *chartInstance);
static void set_sim_state_c40_Demo_Glove(SFc40_Demo_GloveInstanceStruct
  *chartInstance, const mxArray *c40_st);
static void finalize_c40_Demo_Glove(SFc40_Demo_GloveInstanceStruct
  *chartInstance);
static void sf_gateway_c40_Demo_Glove(SFc40_Demo_GloveInstanceStruct
  *chartInstance);
static void initSimStructsc40_Demo_Glove(SFc40_Demo_GloveInstanceStruct
  *chartInstance);
...
static const mxArray *c40_sf_marshallOut(void *chartInstanceVoid, void
  *c40_inData);
static void c40_emlrt_marshallIn(SFc40_Demo_GloveInstanceStruct *chartInstance,
  const mxArray *c40_y, const char_T *c40_identifier, real_T c40_b_y[6]);
static void c40_b_emlrt_marshallIn(SFc40_Demo_GloveInstanceStruct *chartInstance,
...
static const mxArray *c40_b_sf_marshallOut(void *chartInstanceVoid, void
  *c40_inData);
static real_T c40_c_emlrt_marshallIn(SFc40_Demo_GloveInstanceStruct
...
static const mxArray *c40_c_sf_marshallOut(void *chartInstanceVoid, void
  *c40_inData);
static int32_T c40_d_emlrt_marshallIn(SFc40_Demo_GloveInstanceStruct
  *chartInstance, const mxArray *c40_u, const emlrtMsgIdentifier *c40_parentId);
static void c40_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c40_mxArrayInData, const char_T *c40_varName, void *c40_outData);
static uint8_T c40_e_emlrt_marshallIn(SFc40_Demo_GloveInstanceStruct
  *chartInstance, const mxArray *c40_b_is_active_c40_Demo_Glove, const char_T
  *c40_identifier);
static uint8_T c40_f_emlrt_marshallIn(SFc40_Demo_GloveInstanceStruct
  *chartInstance, const mxArray *c40_u, const emlrtMsgIdentifier *c40_parentId);
static void init_dsm_address_info(SFc40_Demo_GloveInstanceStruct *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c40_is_active_c40_Demo_Glove = 0U;
}
  ...
  (SFc40_Demo_GloveInstanceStruct *chartInstance)
{
  ...
  c40_hoistedGlobal = chartInstance->c40_is_active_c40_Demo_Glove;
  ...
  *chartInstance, const mxArray *c40_st)
{
  ...
  chartInstance->c40_is_active_c40_Demo_Glove = c40_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c40_u, 1)),
     "is_active_c40_Demo_Glove");
  sf_mex_destroy(&c40_u);
  c40_update_debugger_state_c40_Demo_Glove(chartInstance);
  ...
  *c40_inData)
{
  ...
  const mxArray *c40_y = NULL;
  SFc40_Demo_GloveInstanceStruct *chartInstance;
  chartInstance = (SFc40_Demo_GloveInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c40_Demo_Glove_get_eml_resolved_functions_info(void)
{
  ...
  *c40_identifier)
{
  ...
  c40_y = c40_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c40_b_is_active_c40_Demo_Glove), &c40_thisId);
  sf_mex_destroy(&c40_b_is_active_c40_Demo_Glove);
  return c40_y;
}
...
void sf_c40_Demo_Glove_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c40_Demo_Glove_get_autoinheritance_info(void)
{
...
mxArray *sf_c40_Demo_Glove_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c40_Demo_Glove_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c40_Demo_Glove(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c40_Demo_Glove\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c40_Demo_Glove_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc40_Demo_GloveInstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c40_Demo_Glove(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc40_Demo_GloveInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c40_Demo_Glove((SFc40_Demo_GloveInstanceStruct*)
    chartInstanceVar);
  initialize_c40_Demo_Glove((SFc40_Demo_GloveInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c40_Demo_Glove(void *chartInstanceVar)
{
  enable_c40_Demo_Glove((SFc40_Demo_GloveInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c40_Demo_Glove(void *chartInstanceVar)
{
  disable_c40_Demo_Glove((SFc40_Demo_GloveInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c40_Demo_Glove(void *chartInstanceVar)
{
  sf_gateway_c40_Demo_Glove((SFc40_Demo_GloveInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c40_Demo_Glove(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c40_Demo_Glove
    ((SFc40_Demo_GloveInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c40_Demo_Glove();/* state var info */
...
extern void sf_internal_set_sim_state_c40_Demo_Glove(SimStruct* S, const mxArray
  *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c40_Demo_Glove();/* state var info */
  ...
  set_sim_state_c40_Demo_Glove((SFc40_Demo_GloveInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c40_Demo_Glove(SimStruct* S)
{
  return sf_internal_get_sim_state_c40_Demo_Glove(S);
}

static void sf_opaque_set_sim_state_c40_Demo_Glove(SimStruct* S, const mxArray
  *st)
{
  sf_internal_set_sim_state_c40_Demo_Glove(S, st);
}

static void sf_opaque_terminate_c40_Demo_Glove(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc40_Demo_GloveInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c40_Demo_Glove((SFc40_Demo_GloveInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc40_Demo_Glove((SFc40_Demo_GloveInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c40_Demo_Glove(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c40_Demo_Glove(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c40_Demo_Glove(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c40_Demo_Glove(SimStruct *S)
{
  SFc40_Demo_GloveInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc40_Demo_GloveInstanceStruct *)utMalloc(sizeof
    (SFc40_Demo_GloveInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc40_Demo_GloveInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c40_Demo_Glove;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c40_Demo_Glove;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c40_Demo_Glove;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c40_Demo_Glove;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c40_Demo_Glove;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c40_Demo_Glove;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c40_Demo_Glove;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c40_Demo_Glove;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c40_Demo_Glove;
  chartInstance->chartInfo.mdlStart = mdlStart_c40_Demo_Glove;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c40_Demo_Glove;
...
void c40_Demo_Glove_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c40_Demo_Glove(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c40_Demo_Glove(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c40_Demo_Glove(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c40_Demo_Glove_method_dispatcher.\n"
