#ifndef __c4_Demo_Glove_h__
#define __c4_Demo_Glove_h__
...
/* Type Definitions */
#ifndef typedef_SFc4_Demo_GloveInstanceStruct
#define typedef_SFc4_Demo_GloveInstanceStruct
...
typedef struct {
  ...
  uint8_T c4_is_active_c4_Demo_Glove;
...
#endif                                 /*typedef_SFc4_Demo_GloveInstanceStruct*/
...
extern const mxArray *sf_c4_Demo_Glove_get_eml_resolved_functions_info(void);
extern void sf_exported_auto_activate_c4_Demo_Glove_secs(SimStruct *c4_S);
...
extern void sf_exported_auto_resetTemporalCounter_c4_Demo_Glove_secs(SimStruct
  *c4_S);
extern void sf_exported_auto_deactivate_c4_Demo_Glove_secs(SimStruct *c4_S);
extern boolean_T sf_exported_auto_isStablec4_Demo_Glove(SimStruct *c4_S);
extern void sf_exported_auto_duringc4_Demo_Glove(SimStruct *c4_S);
extern void sf_exported_auto_enterc4_Demo_Glove(SimStruct *c4_S);
extern void sf_exported_auto_exitc4_Demo_Glove(SimStruct *c4_S);
extern void sf_exported_auto_gatewayc4_Demo_Glove(SimStruct *c4_S);
extern void sf_exported_auto_enablec4_Demo_Glove(SimStruct *c4_S);
extern void sf_exported_auto_disablec4_Demo_Glove(SimStruct *c4_S);
extern void sf_exported_auto_stepBuffersc4_Demo_Glove(SimStruct *c4_S);
extern void sf_exported_auto_initBuffersc4_Demo_Glove(SimStruct *c4_S);
extern void sf_exported_auto_activate_callc4_Demo_Glove(SimStruct *c4_S);
extern void sf_exported_auto_increment_call_counterc4_Demo_Glove(SimStruct *c4_S);
extern void sf_exported_auto_reset_call_counterc4_Demo_Glove(SimStruct *c4_S);
extern void sf_exported_auto_deactivate_callc4_Demo_Glove(SimStruct *c4_S);
extern void sf_exported_auto_initc4_Demo_Glove(SimStruct *c4_S);
extern const mxArray *sf_exported_auto_getSimstatec4_Demo_Glove(SimStruct *c4_S);
extern const mxArray *sf_internal_get_sim_state_c4_Demo_Glove(SimStruct *c4_S);
extern void sf_exported_auto_setSimstatec4_Demo_Glove(SimStruct *c4_S, const
  mxArray *c4_in);
extern void sf_internal_set_sim_state_c4_Demo_Glove(SimStruct *c4_S, const
  mxArray *c4_in);
extern void sf_exported_auto_check_state_inconsistency_c4_Demo_Glove(SimStruct
  *c4_S);
extern void sf_exported_user_c4_Demo_Glove_idlePoseBradOrigTable(SimStruct *c4_S,
  real_T c4_bmlID, real_T *c4_pr, real_T c4_poseBML[1000]);
extern void sf_exported_user_c4_Demo_Glove_insertQueue(SimStruct *c4_S, real_T
  c4_bmls[5000], real_T c4_myBML[1000], real_T c4_newBmls[5000]);
extern void sf_exported_user_c4_Demo_Glove_insertQueueLow(SimStruct *c4_S,
  real_T c4_bmls[5000], real_T c4_myBML[1000], real_T c4_newBmls[5000]);
extern void sf_exported_user_c4_Demo_Glove_selfAdaptorTable(SimStruct *c4_S,
  real_T c4_bmlID, real_T *c4_pr, real_T c4_poseBML[1000]);
extern void sf_exported_user_c4_Demo_Glove_setAffectParams(SimStruct *c4_S,
  real_T c4_v, real_T c4_ar, real_T c4_p, real_T *c4_pfreq, real_T *c4_pChance,
  real_T *c4_pCat, real_T *c4_pLean);
extern void sf_exported_user_c4_Demo_Glove_setPersonalityParams(SimStruct *c4_S,
  real_T c4_p, real_T *c4_pf, real_T *c4_pL, real_T *c4_pC, real_T *c4_pCat);
extern void sf_exported_user_c4_Demo_Glove_setVAParams(SimStruct *c4_S, real_T
  c4_v, real_T c4_ar, real_T c4_pfreqP, real_T c4_pChanceP, real_T c4_pCatP,
  real_T *c4_pfreq, real_T *c4_pChance, real_T *c4_pCat);
extern void sf_exported_user_c4_Demo_Glove_walkInvadingTable(SimStruct *c4_S,
  real_T c4_bmlID, creal_T *c4_p, real_T c4_poseBML[1000]);
extern void sf_exported_user_c4_Demo_Glove_weightshiftTable(SimStruct *c4_S,
  real_T c4_bmlID, real_T *c4_pr, real_T c4_poseBML[1000]);

/* Function Definitions */
extern void sf_c4_Demo_Glove_get_check_sum(mxArray *plhs[]);
extern void c4_Demo_Glove_method_dispatcher(SimStruct *S, int_T method, void
  *data);
