...
static void initialize_c15_Demo_Glove(SFc15_Demo_GloveInstanceStruct
  *chartInstance);
static void initialize_params_c15_Demo_Glove(SFc15_Demo_GloveInstanceStruct
  *chartInstance);
static void enable_c15_Demo_Glove(SFc15_Demo_GloveInstanceStruct *chartInstance);
static void disable_c15_Demo_Glove(SFc15_Demo_GloveInstanceStruct *chartInstance);
static void c15_update_debugger_state_c15_Demo_Glove
  (SFc15_Demo_GloveInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c15_Demo_Glove
  (SFc15_Demo_GloveInstanceStruct *chartInstance);
static void set_sim_state_c15_Demo_Glove(SFc15_Demo_GloveInstanceStruct
  *chartInstance, const mxArray *c15_st);
static void c15_set_sim_state_side_effects_c15_Demo_Glove
  (SFc15_Demo_GloveInstanceStruct *chartInstance);
static void finalize_c15_Demo_Glove(SFc15_Demo_GloveInstanceStruct
  *chartInstance);
static void sf_gateway_c15_Demo_Glove(SFc15_Demo_GloveInstanceStruct
  *chartInstance);
static void initSimStructsc15_Demo_Glove(SFc15_Demo_GloveInstanceStruct
  *chartInstance);
static void c15_enter_atomic_stateCreatePawn(SFc15_Demo_GloveInstanceStruct
  *chartInstance);
static void c15_encStr2Arr(SFc15_Demo_GloveInstanceStruct *chartInstance, real_T
  c15_myarr256[1000]);
...
static const mxArray *c15_sf_marshallOut(void *chartInstanceVoid, void
  *c15_inData);
static real_T c15_emlrt_marshallIn(SFc15_Demo_GloveInstanceStruct *chartInstance,
...
static const mxArray *c15_b_sf_marshallOut(void *chartInstanceVoid, void
  *c15_inData);
static void c15_b_emlrt_marshallIn(SFc15_Demo_GloveInstanceStruct *chartInstance,
...
static void c15_sendBML(SFc15_Demo_GloveInstanceStruct *chartInstance, real_T
  c15_In1[1000]);
static void c15_sendSBM(SFc15_Demo_GloveInstanceStruct *chartInstance, real_T
  c15_In2[1000]);
static const mxArray *c15_g_sf_marshallOut(void *chartInstanceVoid, void
  *c15_inData);
static int32_T c15_c_emlrt_marshallIn(SFc15_Demo_GloveInstanceStruct
...
static const mxArray *c15_h_sf_marshallOut(void *chartInstanceVoid, void
  *c15_inData);
static uint8_T c15_d_emlrt_marshallIn(SFc15_Demo_GloveInstanceStruct
  *chartInstance, const mxArray *c15_b_tp_stateCreatePawn, const char_T
  *c15_identifier);
static uint8_T c15_e_emlrt_marshallIn(SFc15_Demo_GloveInstanceStruct
  *chartInstance, const mxArray *c15_u, const emlrtMsgIdentifier *c15_parentId);
...
static const mxArray *c15_i_sf_marshallOut(void *chartInstanceVoid, void
  *c15_inData);
static void c15_f_emlrt_marshallIn(SFc15_Demo_GloveInstanceStruct *chartInstance,
  const mxArray *c15_u, const emlrtMsgIdentifier *c15_parentId, real_T c15_y
  [1000]);
static void c15_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c15_mxArrayInData, const char_T *c15_varName, void *c15_outData);
static const mxArray *c15_g_emlrt_marshallIn(SFc15_Demo_GloveInstanceStruct
  *chartInstance, const mxArray *c15_b_setSimStateSideEffectsInfo, const char_T *
  c15_identifier);
static const mxArray *c15_h_emlrt_marshallIn(SFc15_Demo_GloveInstanceStruct
  *chartInstance, const mxArray *c15_u, const emlrtMsgIdentifier *c15_parentId);
static void init_dsm_address_info(SFc15_Demo_GloveInstanceStruct *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c15_is_active_c15_Demo_Glove = 0U;
  chartInstance->c15_is_c15_Demo_Glove = c15_IN_NO_ACTIVE_CHILD;
}
  ...
  (SFc15_Demo_GloveInstanceStruct *chartInstance)
{
  ...
  if (chartInstance->c15_is_active_c15_Demo_Glove == 1U) {
    _SFD_CC_CALL(CHART_ACTIVE_TAG, 11U, chartInstance->c15_sfEvent);
  }

  if (chartInstance->c15_is_c15_Demo_Glove == c15_IN_stateCreatePawn) {
  ...
  (SFc15_Demo_GloveInstanceStruct *chartInstance)
{
  ...
  c15_hoistedGlobal = chartInstance->c15_is_active_c15_Demo_Glove;
  c15_u = c15_hoistedGlobal;
  c15_b_y = NULL;
  sf_mex_assign(&c15_b_y, sf_mex_create("y", &c15_u, 3, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c15_y, 0, c15_b_y);
  c15_b_hoistedGlobal = chartInstance->c15_is_c15_Demo_Glove;
  ...
  *chartInstance, const mxArray *c15_st)
{
  ...
  chartInstance->c15_is_active_c15_Demo_Glove = c15_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c15_u, 0)),
     "is_active_c15_Demo_Glove");
  chartInstance->c15_is_c15_Demo_Glove = c15_d_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c15_u, 1)), "is_c15_Demo_Glove");
  ...
  c15_update_debugger_state_c15_Demo_Glove(chartInstance);
...
static void sf_gateway_c15_Demo_Glove(SFc15_Demo_GloveInstanceStruct
  *chartInstance)
{
  c15_set_sim_state_side_effects_c15_Demo_Glove(chartInstance);
  ...
  if (chartInstance->c15_is_active_c15_Demo_Glove == 0U) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 11U, chartInstance->c15_sfEvent);
    chartInstance->c15_is_active_c15_Demo_Glove = 1U;
    ...
    chartInstance->c15_is_c15_Demo_Glove = c15_IN_stateCreatePawn;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 2U, chartInstance->c15_sfEvent);
    chartInstance->c15_tp_stateCreatePawn = 1U;
  ...
  *c15_inData)
{
  ...
  const mxArray *c15_y = NULL;
  SFc15_Demo_GloveInstanceStruct *chartInstance;
  chartInstance = (SFc15_Demo_GloveInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c15_Demo_Glove_get_eml_resolved_functions_info(void)
{
...
void sf_c15_Demo_Glove_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c15_Demo_Glove_get_autoinheritance_info(void)
{
...
mxArray *sf_c15_Demo_Glove_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c15_Demo_Glove_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c15_Demo_Glove(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[8],M[0],T\"is_active_c15_Demo_Glove\",},{M[9],M[0],T\"is_c15_Demo_Glove\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c15_Demo_Glove_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc15_Demo_GloveInstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c15_Demo_Glove(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc15_Demo_GloveInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c15_Demo_Glove((SFc15_Demo_GloveInstanceStruct*)
    chartInstanceVar);
  initialize_c15_Demo_Glove((SFc15_Demo_GloveInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c15_Demo_Glove(void *chartInstanceVar)
{
  enable_c15_Demo_Glove((SFc15_Demo_GloveInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c15_Demo_Glove(void *chartInstanceVar)
{
  disable_c15_Demo_Glove((SFc15_Demo_GloveInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c15_Demo_Glove(void *chartInstanceVar)
{
  sf_gateway_c15_Demo_Glove((SFc15_Demo_GloveInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c15_Demo_Glove(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c15_Demo_Glove
    ((SFc15_Demo_GloveInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c15_Demo_Glove();/* state var info */
...
extern void sf_internal_set_sim_state_c15_Demo_Glove(SimStruct* S, const mxArray
  *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c15_Demo_Glove();/* state var info */
  ...
  set_sim_state_c15_Demo_Glove((SFc15_Demo_GloveInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c15_Demo_Glove(SimStruct* S)
{
  return sf_internal_get_sim_state_c15_Demo_Glove(S);
}

static void sf_opaque_set_sim_state_c15_Demo_Glove(SimStruct* S, const mxArray
  *st)
{
  sf_internal_set_sim_state_c15_Demo_Glove(S, st);
}

static void sf_opaque_terminate_c15_Demo_Glove(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc15_Demo_GloveInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c15_Demo_Glove((SFc15_Demo_GloveInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc15_Demo_Glove((SFc15_Demo_GloveInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c15_Demo_Glove(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c15_Demo_Glove(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(2426128924U));
  ssSetChecksum1(S,(1393916798U));
  ssSetChecksum2(S,(3440813822U));
  ssSetChecksum3(S,(2869372841U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c15_Demo_Glove(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c15_Demo_Glove(SimStruct *S)
{
  SFc15_Demo_GloveInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc15_Demo_GloveInstanceStruct *)utMalloc(sizeof
    (SFc15_Demo_GloveInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc15_Demo_GloveInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c15_Demo_Glove;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c15_Demo_Glove;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c15_Demo_Glove;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c15_Demo_Glove;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c15_Demo_Glove;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c15_Demo_Glove;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c15_Demo_Glove;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c15_Demo_Glove;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c15_Demo_Glove;
  chartInstance->chartInfo.mdlStart = mdlStart_c15_Demo_Glove;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c15_Demo_Glove;
...
void c15_Demo_Glove_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c15_Demo_Glove(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c15_Demo_Glove(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c15_Demo_Glove(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c15_Demo_Glove_method_dispatcher.\n"
