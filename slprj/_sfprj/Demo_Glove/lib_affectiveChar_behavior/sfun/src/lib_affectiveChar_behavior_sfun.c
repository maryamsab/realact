  ...
  method, void *data)
{
  ...
  if (chartFileNumber==46) {
    c46_lib_affectiveChar_behavior_method_dispatcher(simstructPtr, method, data);
    return 1;
  }
  ...
  if (nrhs>2 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"library")) {
      ...
      if (!strcmp(machineName,"lib_affectiveChar_behavior")) {
        if (nrhs==3) {
          ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(940263434U);
          ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1231370363U);
          ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1454669884U);
          ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2766726098U);
        } else if (nrhs==4) {
          ...
          switch (chartFileNumber) {
           ...
           case 46:
            {
              extern void sf_c46_lib_affectiveChar_behavior_get_check_sum
                (mxArray *plhs[]);
              sf_c46_lib_affectiveChar_behavior_get_check_sum(plhs);
              break;
            }
  ...
  mxArray * plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     ...
     case 46:
      {
        if (strcmp(aiChksum, "bAqBzZseVKKGhyRLdfvtNE") == 0) {
          extern mxArray
            *sf_c46_lib_affectiveChar_behavior_get_autoinheritance_info(void);
          plhs[0] = sf_c46_lib_affectiveChar_behavior_get_autoinheritance_info();
          break;
        }
...

  {
    ...
    switch (chartFileNumber) {
     ...
     case 46:
      {
        extern const mxArray
          *sf_c46_lib_affectiveChar_behavior_get_eml_resolved_functions_info
          (void);
        mxArray *persistentMxArray = (mxArray *)
          sf_c46_lib_affectiveChar_behavior_get_eml_resolved_functions_info();
        plhs[0] = mxDuplicateArray(persistentMxArray);
  ...
  mxArray * plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     ...
     case 46:
      {
        if (strcmp(tpChksum, "GiVpF02MWU7HTb4hOOstBF") == 0) {
          extern mxArray
            *sf_c46_lib_affectiveChar_behavior_third_party_uses_info(void);
          plhs[0] = sf_c46_lib_affectiveChar_behavior_third_party_uses_info();
          break;
        }
      }
     ...
     case 46:
      {
        if (strcmp(tpChksum, "GiVpF02MWU7HTb4hOOstBF") == 0) {
          extern mxArray
            *sf_c46_lib_affectiveChar_behavior_updateBuildInfo_args_info(void);
          plhs[0] = sf_c46_lib_affectiveChar_behavior_updateBuildInfo_args_info();
          break;
        }
      }
  ...
  debugInstance)
{
  _lib_affectiveChar_behaviorMachineNumber_ = sf_debug_initialize_machine
    (debugInstance,"lib_affectiveChar_behavior","sfun",1,2,0,0,0);
...
mxArray* load_lib_affectiveChar_behavior_optimization_info(void)
{
  if (sRtwOptimizationInfoStruct==NULL) {
    sRtwOptimizationInfoStruct = sf_load_rtw_optimization_info(
      "lib_affectiveChar_behavior", "Demo_Glove");
