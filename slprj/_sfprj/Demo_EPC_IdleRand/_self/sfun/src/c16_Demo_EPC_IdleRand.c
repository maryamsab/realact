...
#include "c16_Demo_EPC_IdleRand.h"
...
static void initialize_c16_Demo_EPC_IdleRand
  (SFc16_Demo_EPC_IdleRandInstanceStruct *chartInstance);
static void initialize_params_c16_Demo_EPC_IdleRand
  (SFc16_Demo_EPC_IdleRandInstanceStruct *chartInstance);
static void enable_c16_Demo_EPC_IdleRand(SFc16_Demo_EPC_IdleRandInstanceStruct
  *chartInstance);
static void disable_c16_Demo_EPC_IdleRand(SFc16_Demo_EPC_IdleRandInstanceStruct *
  chartInstance);
static void c16_update_debugger_state_c16_Demo_EPC_IdleRand
  (SFc16_Demo_EPC_IdleRandInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c16_Demo_EPC_IdleRand
  (SFc16_Demo_EPC_IdleRandInstanceStruct *chartInstance);
static void set_sim_state_c16_Demo_EPC_IdleRand
  (SFc16_Demo_EPC_IdleRandInstanceStruct *chartInstance, const mxArray *c16_st);
static void finalize_c16_Demo_EPC_IdleRand(SFc16_Demo_EPC_IdleRandInstanceStruct
  *chartInstance);
static void sf_gateway_c16_Demo_EPC_IdleRand
  (SFc16_Demo_EPC_IdleRandInstanceStruct *chartInstance);
static void c16_chartstep_c16_Demo_EPC_IdleRand
  (SFc16_Demo_EPC_IdleRandInstanceStruct *chartInstance);
static void initSimStructsc16_Demo_EPC_IdleRand
  (SFc16_Demo_EPC_IdleRandInstanceStruct *chartInstance);
...
static void c16_emlrt_marshallIn(SFc16_Demo_EPC_IdleRandInstanceStruct
  *chartInstance, const mxArray *c16_sprintf, const char_T *c16_identifier,
  char_T c16_y_data[], int32_T c16_y_sizes[2]);
static void c16_b_emlrt_marshallIn(SFc16_Demo_EPC_IdleRandInstanceStruct
...
static const mxArray *c16_sf_marshallOut(void *chartInstanceVoid, void
  *c16_inData);
static void c16_c_emlrt_marshallIn(SFc16_Demo_EPC_IdleRandInstanceStruct
  *chartInstance, const mxArray *c16_arrBML, const char_T *c16_identifier,
  real_T c16_y[256]);
static void c16_d_emlrt_marshallIn(SFc16_Demo_EPC_IdleRandInstanceStruct
  *chartInstance, const mxArray *c16_u, const emlrtMsgIdentifier *c16_parentId,
  real_T c16_y[256]);
...
static const mxArray *c16_b_sf_marshallOut(void *chartInstanceVoid, void
  *c16_inData);
static real_T c16_e_emlrt_marshallIn(SFc16_Demo_EPC_IdleRandInstanceStruct
  *chartInstance, const mxArray *c16_u, const emlrtMsgIdentifier *c16_parentId);
...
static void c16_f_emlrt_marshallIn(SFc16_Demo_EPC_IdleRandInstanceStruct
  *chartInstance, const mxArray *c16_u, const emlrtMsgIdentifier *c16_parentId,
  char_T c16_y_data[], int32_T c16_y_sizes[2]);
...
static void c16_g_emlrt_marshallIn(SFc16_Demo_EPC_IdleRandInstanceStruct
  *chartInstance, const mxArray *c16_u, const emlrtMsgIdentifier *c16_parentId,
...
static const mxArray *c16_e_sf_marshallOut(void *chartInstanceVoid, void
  *c16_inData);
static int32_T c16_h_emlrt_marshallIn(SFc16_Demo_EPC_IdleRandInstanceStruct
  *chartInstance, const mxArray *c16_u, const emlrtMsgIdentifier *c16_parentId);
static void c16_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c16_mxArrayInData, const char_T *c16_varName, void *c16_outData);
static uint8_T c16_i_emlrt_marshallIn(SFc16_Demo_EPC_IdleRandInstanceStruct
  *chartInstance, const mxArray *c16_b_is_active_c16_Demo_EPC_IdleRand, const
  char_T *c16_identifier);
static uint8_T c16_j_emlrt_marshallIn(SFc16_Demo_EPC_IdleRandInstanceStruct
  *chartInstance, const mxArray *c16_u, const emlrtMsgIdentifier *c16_parentId);
static void init_dsm_address_info(SFc16_Demo_EPC_IdleRandInstanceStruct
  *chartInstance);
  ...
  (SFc16_Demo_EPC_IdleRandInstanceStruct *chartInstance)
{
  ...
  chartInstance->c16_is_active_c16_Demo_EPC_IdleRand = 0U;
}
  ...
  (SFc16_Demo_EPC_IdleRandInstanceStruct *chartInstance)
{
  ...
  c16_hoistedGlobal = chartInstance->c16_is_active_c16_Demo_EPC_IdleRand;
  ...
  (SFc16_Demo_EPC_IdleRandInstanceStruct *chartInstance, const mxArray *c16_st)
{
  ...
  chartInstance->c16_is_active_c16_Demo_EPC_IdleRand = c16_i_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c16_u, 1)),
     "is_active_c16_Demo_EPC_IdleRand");
  sf_mex_destroy(&c16_u);
  c16_update_debugger_state_c16_Demo_EPC_IdleRand(chartInstance);
  ...
  (SFc16_Demo_EPC_IdleRandInstanceStruct *chartInstance)
{
  ...
  chartInstance->c16_sfEvent = CALL_EVENT;
  c16_chartstep_c16_Demo_EPC_IdleRand(chartInstance);
  ...
  c16_chartNumber, uint32_T c16_instanceNumber)
{
  ...
  _SFD_SCRIPT_TRANSLATION(c16_chartNumber, c16_instanceNumber, 0U,
    ...
    "C:\\Users\\root180\\Documents\\affective-project\\6-10-2015-Matlab-Demo\\countDigits.m"));
  _SFD_SCRIPT_TRANSLATION(c16_chartNumber, c16_instanceNumber, 1U,
    sf_debug_get_script_id(
    "C:\\Users\\root180\\Documents\\affective-project\\6-10-2015-Matlab-Demo\\encStr2Arr.m"));
}
  ...
  *c16_inData)
{
  ...
  const mxArray *c16_y = NULL;
  SFc16_Demo_EPC_IdleRandInstanceStruct *chartInstance;
  chartInstance = (SFc16_Demo_EPC_IdleRandInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c16_Demo_EPC_IdleRand_get_eml_resolved_functions_info(void)
{
...
static void c16_info_helper(const mxArray **c16_info)
{
  ...
  sf_mex_addfield(*c16_info, c16_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 7);
  sf_mex_addfield(*c16_info, c16_emlrt_marshallOut(
    "[E]C:/Users/root180/Documents/affective-project/6-10-2015-Matlab-Demo/countDigits.m"),
                  "resolved", "resolved", 7);
  ...
  sf_mex_addfield(*c16_info, c16_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 13);
  sf_mex_addfield(*c16_info, c16_emlrt_marshallOut(
    "[E]C:/Users/root180/Documents/affective-project/6-10-2015-Matlab-Demo/encStr2Arr.m"),
  ...
  char_T *c16_identifier)
{
  ...
  c16_y = c16_j_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c16_b_is_active_c16_Demo_EPC_IdleRand), &c16_thisId);
  sf_mex_destroy(&c16_b_is_active_c16_Demo_EPC_IdleRand);
  return c16_y;
}
...
void sf_c16_Demo_EPC_IdleRand_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1488508098U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3513609491U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3549793982U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2806875943U);
}

mxArray *sf_c16_Demo_EPC_IdleRand_get_autoinheritance_info(void)
{
...
mxArray *sf_c16_Demo_EPC_IdleRand_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c16_Demo_EPC_IdleRand_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c16_Demo_EPC_IdleRand(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[14],T\"arrBML\",},{M[8],M[0],T\"is_active_c16_Demo_EPC_IdleRand\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c16_Demo_EPC_IdleRand_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc16_Demo_EPC_IdleRandInstanceStruct *)
...
{
  return "OPOgCUcYOgC76AebRWn6OC";
}

static void sf_opaque_initialize_c16_Demo_EPC_IdleRand(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc16_Demo_EPC_IdleRandInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c16_Demo_EPC_IdleRand((SFc16_Demo_EPC_IdleRandInstanceStruct*)
    chartInstanceVar);
  initialize_c16_Demo_EPC_IdleRand((SFc16_Demo_EPC_IdleRandInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c16_Demo_EPC_IdleRand(void *chartInstanceVar)
{
  enable_c16_Demo_EPC_IdleRand((SFc16_Demo_EPC_IdleRandInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c16_Demo_EPC_IdleRand(void *chartInstanceVar)
{
  disable_c16_Demo_EPC_IdleRand((SFc16_Demo_EPC_IdleRandInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c16_Demo_EPC_IdleRand(void *chartInstanceVar)
{
  sf_gateway_c16_Demo_EPC_IdleRand((SFc16_Demo_EPC_IdleRandInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c16_Demo_EPC_IdleRand(SimStruct*
  S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c16_Demo_EPC_IdleRand
    ((SFc16_Demo_EPC_IdleRandInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c16_Demo_EPC_IdleRand();/* state var info */
...
extern void sf_internal_set_sim_state_c16_Demo_EPC_IdleRand(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c16_Demo_EPC_IdleRand();/* state var info */
  ...
  set_sim_state_c16_Demo_EPC_IdleRand((SFc16_Demo_EPC_IdleRandInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c16_Demo_EPC_IdleRand(SimStruct* S)
{
  return sf_internal_get_sim_state_c16_Demo_EPC_IdleRand(S);
}

static void sf_opaque_set_sim_state_c16_Demo_EPC_IdleRand(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c16_Demo_EPC_IdleRand(S, st);
}

static void sf_opaque_terminate_c16_Demo_EPC_IdleRand(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc16_Demo_EPC_IdleRandInstanceStruct*) chartInstanceVar)
      ->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c16_Demo_EPC_IdleRand((SFc16_Demo_EPC_IdleRandInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc16_Demo_EPC_IdleRand((SFc16_Demo_EPC_IdleRandInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c16_Demo_EPC_IdleRand(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c16_Demo_EPC_IdleRand
      ((SFc16_Demo_EPC_IdleRandInstanceStruct*)(chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c16_Demo_EPC_IdleRand(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(901425058U));
  ssSetChecksum1(S,(2055164713U));
  ssSetChecksum2(S,(191928757U));
  ssSetChecksum3(S,(3149596209U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c16_Demo_EPC_IdleRand(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c16_Demo_EPC_IdleRand(SimStruct *S)
{
  SFc16_Demo_EPC_IdleRandInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc16_Demo_EPC_IdleRandInstanceStruct *)utMalloc(sizeof
    (SFc16_Demo_EPC_IdleRandInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc16_Demo_EPC_IdleRandInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c16_Demo_EPC_IdleRand;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c16_Demo_EPC_IdleRand;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c16_Demo_EPC_IdleRand;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c16_Demo_EPC_IdleRand;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c16_Demo_EPC_IdleRand;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c16_Demo_EPC_IdleRand;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c16_Demo_EPC_IdleRand;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c16_Demo_EPC_IdleRand;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c16_Demo_EPC_IdleRand;
  chartInstance->chartInfo.mdlStart = mdlStart_c16_Demo_EPC_IdleRand;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c16_Demo_EPC_IdleRand;
...
void c16_Demo_EPC_IdleRand_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c16_Demo_EPC_IdleRand(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c16_Demo_EPC_IdleRand(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c16_Demo_EPC_IdleRand(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c16_Demo_EPC_IdleRand_method_dispatcher.\n"
