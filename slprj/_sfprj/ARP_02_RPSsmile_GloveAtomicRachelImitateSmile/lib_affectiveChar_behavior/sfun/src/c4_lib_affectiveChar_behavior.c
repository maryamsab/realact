  ...
  switch (chartInstance->c4_is_c4_lib_affectiveChar_behavior) {
   case c4_IN_stateCheck:
    ...
    if (c4_out) {
      ...
      c4_sendBMLc4_lib_affectiveChar_behavior(chartInstance, c4_dv1);
      _SFD_SYMBOL_SCOPE_POP();
    } else {
   ...
   case c4_IN_stateSmile:
    ...
    if (c4_b_out) {
      ...
      c4_sendBMLc4_lib_affectiveChar_behavior(chartInstance, c4_dv2);
      _SFD_SYMBOL_SCOPE_POP();
    }
  ...
  *chartInstance, real_T c4_myarr256[256])
{
  ...
  int32_T c4_i3;
  static real_T c4_dv3[223] = { 60.0, 63.0, 120.0, 109.0, 108.0, 32.0, 118.0,
...
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData)
{
  ...
  for (c4_i7 = 0; c4_i7 < 256; c4_i7++) {
    c4_b_inData[c4_i7] = (*(real_T (*)[256])c4_inData)[c4_i7];
  }
  ...
  real_T c4_y[256])
{
  ...
  int32_T c4_i9;
  (void)chartInstance;
  sf_mex_import(c4_parentId, sf_mex_dup(c4_u), c4_dv4, 1, 0, 0U, 1, 0U, 2, 256,
                1);
  for (c4_i9 = 0; c4_i9 < 256; c4_i9++) {
    c4_y[c4_i9] = c4_dv4[c4_i9];
  }
  ...
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData)
{
  ...
  for (c4_i10 = 0; c4_i10 < 256; c4_i10++) {
    (*(real_T (*)[256])c4_outData)[c4_i10] = c4_y[c4_i10];
  }
  ...
  *c4_inData)
{
  ...
  for (c4_i11 = 0; c4_i11 < 256; c4_i11++) {
    c4_b_inData[c4_i11] = (*(real_T (*)[256])c4_inData)[c4_i11];
  }
  ...
  real_T c4_y[256])
{
  ...
  int32_T c4_i13;
  (void)chartInstance;
  sf_mex_import(c4_parentId, sf_mex_dup(c4_u), c4_dv5, 1, 0, 0U, 1, 0U, 1, 256);
  for (c4_i13 = 0; c4_i13 < 256; c4_i13++) {
    c4_y[c4_i13] = c4_dv5[c4_i13];
  }
  ...
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData)
{
  ...
  for (c4_i14 = 0; c4_i14 < 256; c4_i14++) {
    (*(real_T (*)[256])c4_outData)[c4_i14] = c4_y[c4_i14];
  }
  ...
  *c4_inData)
{
  ...
  for (c4_i15 = 0; c4_i15 < 223; c4_i15++) {
    c4_b_inData[c4_i15] = (*(char_T (*)[223])c4_inData)[c4_i15];
  }
  ...
  *c4_inData)
{
  ...
  for (c4_i17 = 0; c4_i17 < 223; c4_i17++) {
    c4_b_inData[c4_i17] = (*(real_T (*)[223])c4_inData)[c4_i17];
  }
  ...
  *c4_inData)
{
  ...
  chartInstance = (SFc4_lib_affectiveChar_behaviorInstanceStruct *)
    chartInstanceVoid;
  c4_mxArrayOutData = NULL;
  for (c4_i19 = 0; c4_i19 < 87; c4_i19++) {
    c4_b_inData[c4_i19] = (*(char_T (*)[87])c4_inData)[c4_i19];
  }

  for (c4_i20 = 0; c4_i20 < 87; c4_i20++) {
  ...
  *c4_inData)
{
  ...
  for (c4_i21 = 0; c4_i21 < 87; c4_i21++) {
    c4_b_inData[c4_i21] = (*(real_T (*)[87])c4_inData)[c4_i21];
  }
   ...
   [256])
{
  ...
  for (c4_i23 = 0; c4_i23 < 256; c4_i23++) {
    _SFD_DATA_RANGE_CHECK(c4_arg[c4_i23], 3U);
  }
  ...
  for (c4_i24 = 0; c4_i24 < 256; c4_i24++) {
    (*c4_b_arg)[c4_i24] = c4_arg[c4_i24];
  }

  for (c4_i25 = 0; c4_i25 < 256; c4_i25++) {
    _SFD_DATA_RANGE_CHECK((*c4_b_arg)[c4_i25], 3U);
  }
   ...
   real_T c4_poseBML[256])
{
  ...
  int32_T c4_i28;
  static real_T c4_dv7[87] = { 60.0, 63.0, 120.0, 109.0, 108.0, 32.0, 118.0,
    101.0, 114.0, 115.0, 105.0, 111.0, 110.0, 61.0, 34.0, 49.0, 46.0, 48.0, 34.0,
    32.0, 63.0, 62.0, 60.0, 97.0, 99.0, 116.0, 62.0, 60.0, 98.0, 109.0, 108.0,
  ...
  if (CV_EML_IF(1, 1, 0, c4_aVarTruthTableCondition_1)) {
    ...
    c4_encStr2Arr(chartInstance, c4_dv6);
    for (c4_i26 = 0; c4_i26 < 256; c4_i26++) {
      c4_poseBML[c4_i26] = c4_dv6[c4_i26];
    }
    ...
    if (CV_EML_IF(1, 1, 1, c4_aVarTruthTableCondition_2)) {
      ...
      _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c4_myarr256, 8U, c4_d_sf_marshallOut,
        c4_d_sf_marshallIn);
      for (c4_i27 = 0; c4_i27 < 87; c4_i27++) {
        c4_mystr[c4_i27] = c4_cv1[c4_i27];
      }
      ...
      c4_maxarrsize = 256.0;
      _SFD_SCRIPT_CALL(0U, chartInstance->c4_sfEvent, 6);
      for (c4_i28 = 0; c4_i28 < 87; c4_i28++) {
        c4_arr[c4_i28] = c4_dv7[c4_i28];
      }
      ...
      for (c4_i32 = 0; c4_i32 < 256; c4_i32++) {
        c4_poseBML[c4_i32] = c4_myarr256[c4_i32];
      }
      ...
      for (c4_i33 = 0; c4_i33 < 256; c4_i33++) {
        c4_poseBML[c4_i33] = c4_dv6[c4_i33];
      }
   ...
   *c4_u, const emlrtMsgIdentifier *c4_parentId)
{
  ...
  int32_T c4_i35;
  (void)chartInstance;
  sf_mex_import(c4_parentId, sf_mex_dup(c4_u), &c4_i35, 1, 6, 0U, 0, 0U, 0);
  c4_y = c4_i35;
  sf_mex_destroy(&c4_u);
  return c4_y;
}
  ...
  *chartInstance, uint32_T c4_b)
{
  ...
  if (chartInstance->c4_isPosing_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'isPosing\' (#1992) in the initialization routine of the chart.\n");
  }
