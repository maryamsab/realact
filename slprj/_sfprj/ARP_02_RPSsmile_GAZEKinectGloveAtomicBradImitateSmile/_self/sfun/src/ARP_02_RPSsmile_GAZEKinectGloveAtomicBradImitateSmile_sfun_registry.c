  ...
  const mxArray * prhs[] )
{
  ...
  if (sf_ARP_02_RPSsmile_GAZEKinectGloveAtomicBradImitateSmile_process_check_sum_call
      (nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
  ...
  nrhs, const mxArray * prhs[] )
{
  ...
  if (strcmp(machineName,
             "ARP_02_RPSsmile_GAZEKinectGloveAtomicBradImitateSmile") == 0) {
...
extern void ARP_02_RPSsmile_GAZEKinectGloveAtomicBradImitateSmile_terminator
  (void);
void sf_machine_global_terminator(void)
{
  sfGlobalMdlStartCallCounts--;
  if (sfGlobalMdlStartCallCounts == 0) {
    ARP_02_RPSsmile_GAZEKinectGloveAtomicBradImitateSmile_terminator();
...
extern void ARP_02_RPSsmile_GAZEKinectGloveAtomicBradImitateSmile_initializer
  (void);
extern void
  ARP_02_RPSsmile_GAZEKinectGloveAtomicBradImitateSmile_register_exported_symbols
  (SimStruct* S);
extern void
  ARP_02_RPSsmile_GAZEKinectGloveAtomicBradImitateSmile_debug_initialize(struct
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfGlobalMdlStartCallCounts == 1) {
    ...
    if (!simModeIsRTWGen) {
      ARP_02_RPSsmile_GAZEKinectGloveAtomicBradImitateSmile_debug_initialize
        (sfGlobalDebugInstanceStruct);
    }

    ARP_02_RPSsmile_GAZEKinectGloveAtomicBradImitateSmile_initializer();
  }
