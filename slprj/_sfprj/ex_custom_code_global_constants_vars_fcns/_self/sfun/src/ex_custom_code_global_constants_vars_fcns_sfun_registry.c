...
{
  extern unsigned int
    sf_ex_custom_code_global_constants_vars_fcns_process_check_sum_call( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_ex_custom_code_global_constants_vars_fcns_process_check_sum_call(nlhs,
       plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int
    sf_ex_custom_code_global_constants_vars_fcns_autoinheritance_info( int nlhs,
  ...
  if (strcmp(machineName, "ex_custom_code_global_constants_vars_fcns") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_ex_custom_code_global_constants_vars_fcns_autoinheritance_info
      (nlhs,plhs,3,newRhs);
  }
...
{
  extern unsigned int
    sf_ex_custom_code_global_constants_vars_fcns_third_party_uses_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 4) {
  ...
  if (strcmp(machineName, "ex_custom_code_global_constants_vars_fcns") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_ex_custom_code_global_constants_vars_fcns_third_party_uses_info
      (nlhs,plhs,3,newRhs);
  }
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
  ...
  if (strcmp(machineName, "ex_custom_code_global_constants_vars_fcns") == 0) {
    ...
    newRhs[2] = prhs[3];
    return
      sf_ex_custom_code_global_constants_vars_fcns_updateBuildInfo_args_info
      (nlhs,plhs,3,newRhs);
  }
...
extern unsigned int
  sf_ex_custom_code_global_constants_vars_fcns_method_dispatcher(SimStruct *S,
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"ex_custom_code_global_constants_vars_fcns")) {
    return(sf_ex_custom_code_global_constants_vars_fcns_method_dispatcher
...
void sf_machine_global_terminator(void)
{
  ...
  if (sfGlobalMdlStartCallCounts == 0) {
    ex_custom_code_global_constants_vars_fcns_terminator();
...
extern void ex_custom_code_global_constants_vars_fcns_register_exported_symbols
  (SimStruct* S);
extern void ex_custom_code_global_constants_vars_fcns_debug_initialize(struct
  SfDebugInstanceStruct*);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  ex_custom_code_global_constants_vars_fcns_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfGlobalMdlStartCallCounts == 1) {
    ...
    if (!simModeIsRTWGen) {
      ex_custom_code_global_constants_vars_fcns_debug_initialize
        (sfGlobalDebugInstanceStruct);
    }

    ex_custom_code_global_constants_vars_fcns_initializer();
  }
