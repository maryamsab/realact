  ...
  *chartInstance, uint32_T c11_b)
{
  ...
  if (chartInstance->c11_avert_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'avert\' (#35) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c11_b)
{
  ...
  if (chartInstance->c11_isPosing_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'isPosing\' (#33) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c11_b)
{
  ...
  if (chartInstance->c11_isSmiling_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'isSmiling\' (#34) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c11_b)
{
  ...
  if (chartInstance->c11_smileN_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'smileN\' (#32) in the initialization routine of the chart.\n");
  }
