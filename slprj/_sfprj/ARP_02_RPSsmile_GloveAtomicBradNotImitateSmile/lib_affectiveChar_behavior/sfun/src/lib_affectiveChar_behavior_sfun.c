  ...
  method, void *data)
{
  if (chartFileNumber==1) {
    c1_lib_affectiveChar_behavior_method_dispatcher(simstructPtr, method, data);
    return 1;
  }
  ...
  if (nrhs>2 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"library")) {
      ...
      if (!strcmp(machineName,"lib_affectiveChar_behavior")) {
        if (nrhs==3) {
          ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(683759847U);
          ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(573141308U);
          ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2494337696U);
          ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1936612211U);
        } else if (nrhs==4) {
          ...
          switch (chartFileNumber) {
           case 1:
            {
              extern void sf_c1_lib_affectiveChar_behavior_get_check_sum(mxArray
                *plhs[]);
              sf_c1_lib_affectiveChar_behavior_get_check_sum(plhs);
              break;
            }
     ...
     case 1:
      {
        if (strcmp(aiChksum, "nKxzfEbf6KUXmGTryxfCtH") == 0) {
          extern mxArray
            *sf_c1_lib_affectiveChar_behavior_get_autoinheritance_info(void);
          plhs[0] = sf_c1_lib_affectiveChar_behavior_get_autoinheritance_info();
          break;
        }
     ...
     case 1:
      {
        ...
        mxArray *persistentMxArray = (mxArray *)
          sf_c1_lib_affectiveChar_behavior_get_eml_resolved_functions_info();
     ...
     case 1:
      {
        if (strcmp(tpChksum, "jqpwu4bekXPa7KrTf6jsdE") == 0) {
          extern mxArray *sf_c1_lib_affectiveChar_behavior_third_party_uses_info
            (void);
          plhs[0] = sf_c1_lib_affectiveChar_behavior_third_party_uses_info();
          break;
        }
      }
     ...
     case 1:
      {
        if (strcmp(tpChksum, "jqpwu4bekXPa7KrTf6jsdE") == 0) {
          extern mxArray
            *sf_c1_lib_affectiveChar_behavior_updateBuildInfo_args_info(void);
          plhs[0] = sf_c1_lib_affectiveChar_behavior_updateBuildInfo_args_info();
          break;
        }
      }
