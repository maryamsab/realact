...
{
  extern unsigned int
    sf_ARP_02_RPSsmile_GloveAtomicBradNotImitateSmile_process_check_sum_call
    ( int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_ARP_02_RPSsmile_GloveAtomicBradNotImitateSmile_process_check_sum_call
      (nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
  ...
  nrhs, const mxArray * prhs[] )
{
  ...
  if (strcmp(machineName, "ARP_02_RPSsmile_GloveAtomicBradNotImitateSmile") == 0)
  {
    ...
    newRhs[2] = prhs[3];
    return
      sf_ARP_02_RPSsmile_GloveAtomicBradNotImitateSmile_autoinheritance_info
      (nlhs,plhs,3,newRhs);
  }
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
  ...
  if (strcmp(machineName, "ARP_02_RPSsmile_GloveAtomicBradNotImitateSmile") == 0)
  {
    ...
    newRhs[2] = prhs[3];
    return
      sf_ARP_02_RPSsmile_GloveAtomicBradNotImitateSmile_third_party_uses_info
      (nlhs,plhs,3,newRhs);
  }
...
extern unsigned int
  sf_ARP_02_RPSsmile_GloveAtomicBradNotImitateSmile_method_dispatcher(SimStruct *
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"ARP_02_RPSsmile_GloveAtomicBradNotImitateSmile")) {
    return(sf_ARP_02_RPSsmile_GloveAtomicBradNotImitateSmile_method_dispatcher
...
extern void ARP_02_RPSsmile_GloveAtomicBradNotImitateSmile_terminator(void);
void sf_machine_global_terminator(void)
{
  sfGlobalMdlStartCallCounts--;
  if (sfGlobalMdlStartCallCounts == 0) {
    ARP_02_RPSsmile_GloveAtomicBradNotImitateSmile_terminator();
...
extern void ARP_02_RPSsmile_GloveAtomicBradNotImitateSmile_initializer(void);
extern void
  ARP_02_RPSsmile_GloveAtomicBradNotImitateSmile_register_exported_symbols
  (SimStruct* S);
extern void ARP_02_RPSsmile_GloveAtomicBradNotImitateSmile_debug_initialize(
    struct SfDebugInstanceStruct*);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  ARP_02_RPSsmile_GloveAtomicBradNotImitateSmile_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfGlobalMdlStartCallCounts == 1) {
    ...
    if (!simModeIsRTWGen) {
      ARP_02_RPSsmile_GloveAtomicBradNotImitateSmile_debug_initialize
        (sfGlobalDebugInstanceStruct);
    }

    ARP_02_RPSsmile_GloveAtomicBradNotImitateSmile_initializer();
  }
