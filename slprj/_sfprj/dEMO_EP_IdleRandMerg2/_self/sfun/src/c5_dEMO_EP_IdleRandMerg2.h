#ifndef __c5_dEMO_EP_IdleRandMerg2_h__
#define __c5_dEMO_EP_IdleRandMerg2_h__
...
/* Type Definitions */
#ifndef typedef_SFc5_dEMO_EP_IdleRandMerg2InstanceStruct
#define typedef_SFc5_dEMO_EP_IdleRandMerg2InstanceStruct
...
typedef struct {
  ...
  uint8_T c5_is_active_c5_dEMO_EP_IdleRandMerg2;
...
#endif                                 /*typedef_SFc5_dEMO_EP_IdleRandMerg2InstanceStruct*/
...
extern void sf_exported_auto_deactivate_c5_dEMO_EP_IdleRandMerg2_secs(SimStruct *
  c5_S);
extern boolean_T sf_exported_auto_isStablec5_dEMO_EP_IdleRandMerg2(SimStruct
  *c5_S);
extern void sf_exported_auto_duringc5_dEMO_EP_IdleRandMerg2(SimStruct *c5_S);
extern void sf_exported_auto_enterc5_dEMO_EP_IdleRandMerg2(SimStruct *c5_S);
extern void sf_exported_auto_exitc5_dEMO_EP_IdleRandMerg2(SimStruct *c5_S);
extern void sf_exported_auto_gatewayc5_dEMO_EP_IdleRandMerg2(SimStruct *c5_S);
extern void sf_exported_auto_enablec5_dEMO_EP_IdleRandMerg2(SimStruct *c5_S);
extern void sf_exported_auto_disablec5_dEMO_EP_IdleRandMerg2(SimStruct *c5_S);
extern void sf_exported_auto_stepBuffersc5_dEMO_EP_IdleRandMerg2(SimStruct *c5_S);
extern void sf_exported_auto_initBuffersc5_dEMO_EP_IdleRandMerg2(SimStruct *c5_S);
extern void sf_exported_auto_activate_callc5_dEMO_EP_IdleRandMerg2(SimStruct
  *c5_S);
extern void sf_exported_auto_increment_call_counterc5_dEMO_EP_IdleRandMerg2
  (SimStruct *c5_S);
extern void sf_exported_auto_reset_call_counterc5_dEMO_EP_IdleRandMerg2
  (SimStruct *c5_S);
extern void sf_exported_auto_deactivate_callc5_dEMO_EP_IdleRandMerg2(SimStruct
  *c5_S);
extern void sf_exported_auto_initc5_dEMO_EP_IdleRandMerg2(SimStruct *c5_S);
...
extern const mxArray *sf_internal_get_sim_state_c5_dEMO_EP_IdleRandMerg2
  (SimStruct *c5_S);
extern void sf_exported_auto_setSimstatec5_dEMO_EP_IdleRandMerg2(SimStruct *c5_S,
  const mxArray *c5_in);
extern void sf_internal_set_sim_state_c5_dEMO_EP_IdleRandMerg2(SimStruct *c5_S,
  const mxArray *c5_in);
extern void sf_exported_auto_check_state_inconsistency_c5_dEMO_EP_IdleRandMerg2
  (SimStruct *c5_S);
extern void sf_exported_user_c5_dEMO_EP_IdleRandMerg2_handPoseSBTable(SimStruct *
  c5_S, real_T c5_sbmID, real_T c5_poseSBM[1000]);
extern void sf_exported_user_c5_dEMO_EP_IdleRandMerg2_idlePoseBradTable
  (SimStruct *c5_S, real_T c5_bmlID, real_T *c5_p, real_T c5_poseBML[1000]);
extern void sf_exported_user_c5_dEMO_EP_IdleRandMerg2_initialPoseTable(SimStruct
  *c5_S, real_T c5_bmlID, real_T *c5_p, real_T c5_poseBML[1000]);
extern void sf_exported_user_c5_dEMO_EP_IdleRandMerg2_insertQueue(SimStruct
  *c5_S, real_T c5_bmls[5000], real_T c5_mBML[1000], real_T c5_newBmls[5000]);
extern void sf_exported_user_c5_dEMO_EP_IdleRandMerg2_insertQueueLow(SimStruct
  *c5_S, real_T c5_bmls[5000], real_T c5_myBML[1000], real_T c5_newBmls[5000]);
extern void sf_exported_user_c5_dEMO_EP_IdleRandMerg2_paperPoseBradTable
  (SimStruct *c5_S, real_T c5_bmlID, real_T *c5_p, real_T c5_poseBML[1000]);
extern void sf_exported_user_c5_dEMO_EP_IdleRandMerg2_rockPoseTable(SimStruct
  *c5_S, real_T c5_bmlID, real_T *c5_p, real_T c5_poseBML[1000]);
extern void sf_exported_user_c5_dEMO_EP_IdleRandMerg2_scissorsPoseBradTable
  (SimStruct *c5_S, real_T c5_bmlID, real_T *c5_p, real_T c5_poseBML[1000]);
extern void sf_exported_user_c5_dEMO_EP_IdleRandMerg2_sendSBM(SimStruct *c5_S,
  real_T c5_arg[256]);

/* Function Definitions */
extern void sf_c5_dEMO_EP_IdleRandMerg2_get_check_sum(mxArray *plhs[]);
extern void c5_dEMO_EP_IdleRandMerg2_method_dispatcher(SimStruct *S, int_T
  method, void *data);
