#ifndef __c9_EP_IdleRand_K_h__
#define __c9_EP_IdleRand_K_h__
...
/* Type Definitions */
#ifndef typedef_SFc9_EP_IdleRand_KInstanceStruct
#define typedef_SFc9_EP_IdleRand_KInstanceStruct
...
typedef struct {
  ...
  uint8_T c9_is_active_c9_EP_IdleRand_K;
...
#endif                                 /*typedef_SFc9_EP_IdleRand_KInstanceStruct*/
...
extern const mxArray *sf_c9_EP_IdleRand_K_get_eml_resolved_functions_info(void);
extern void sf_exported_auto_activate_c9_EP_IdleRand_K_secs(SimStruct *c9_S);
...
extern void sf_exported_auto_resetTemporalCounter_c9_EP_IdleRand_K_secs
  (SimStruct *c9_S);
extern void sf_exported_auto_deactivate_c9_EP_IdleRand_K_secs(SimStruct *c9_S);
extern boolean_T sf_exported_auto_isStablec9_EP_IdleRand_K(SimStruct *c9_S);
extern void sf_exported_auto_duringc9_EP_IdleRand_K(SimStruct *c9_S);
extern void sf_exported_auto_enterc9_EP_IdleRand_K(SimStruct *c9_S);
extern void sf_exported_auto_exitc9_EP_IdleRand_K(SimStruct *c9_S);
extern void sf_exported_auto_gatewayc9_EP_IdleRand_K(SimStruct *c9_S);
extern void sf_exported_auto_enablec9_EP_IdleRand_K(SimStruct *c9_S);
extern void sf_exported_auto_disablec9_EP_IdleRand_K(SimStruct *c9_S);
extern void sf_exported_auto_stepBuffersc9_EP_IdleRand_K(SimStruct *c9_S);
extern void sf_exported_auto_initBuffersc9_EP_IdleRand_K(SimStruct *c9_S);
extern void sf_exported_auto_activate_callc9_EP_IdleRand_K(SimStruct *c9_S);
extern void sf_exported_auto_increment_call_counterc9_EP_IdleRand_K(SimStruct
  *c9_S);
extern void sf_exported_auto_reset_call_counterc9_EP_IdleRand_K(SimStruct *c9_S);
extern void sf_exported_auto_deactivate_callc9_EP_IdleRand_K(SimStruct *c9_S);
extern void sf_exported_auto_initc9_EP_IdleRand_K(SimStruct *c9_S);
extern const mxArray *sf_exported_auto_getSimstatec9_EP_IdleRand_K(SimStruct
  *c9_S);
extern const mxArray *sf_internal_get_sim_state_c9_EP_IdleRand_K(SimStruct *c9_S);
extern void sf_exported_auto_setSimstatec9_EP_IdleRand_K(SimStruct *c9_S, const
  mxArray *c9_in);
extern void sf_internal_set_sim_state_c9_EP_IdleRand_K(SimStruct *c9_S, const
  mxArray *c9_in);
extern void sf_exported_auto_check_state_inconsistency_c9_EP_IdleRand_K
  (SimStruct *c9_S);
extern void sf_exported_user_c9_EP_IdleRand_K_gazeFollowUserMove(SimStruct *c9_S,
  real_T c9_bmlID, real_T *c9_p, real_T c9_gazeBML[256]);
extern void sf_exported_user_c9_EP_IdleRand_K_idleGazeFunction(SimStruct *c9_S,
  real_T c9_dir, real_T c9_mag, real_T c9_p, real_T c9_arrBML[256]);
extern void sf_exported_user_c9_EP_IdleRand_K_idleGazeInterestedTable(SimStruct *
  c9_S, real_T c9_bmlID, real_T *c9_p, real_T c9_gazeBML[256]);
extern void sf_exported_user_c9_EP_IdleRand_K_idleGazeOrigFunction(SimStruct
  *c9_S, real_T c9_dir, real_T c9_mag, real_T c9_arrBML[256]);
extern void sf_exported_user_c9_EP_IdleRand_K_idleGazeTable(SimStruct *c9_S,
  real_T c9_bmlID, real_T *c9_p, real_T c9_gazeBML[256]);
extern void sf_exported_user_c9_EP_IdleRand_K_idleGazeTableExtrovert(SimStruct
  *c9_S, real_T c9_bmlID, real_T *c9_p, real_T c9_gazeBML[256]);
extern void sf_exported_user_c9_EP_IdleRand_K_idleGazeTableIntrovert(SimStruct
  *c9_S, real_T c9_bmlID, real_T *c9_p, real_T c9_gazeBML[256]);
extern void sf_exported_user_c9_EP_IdleRand_K_insertQueueLow(SimStruct *c9_S,
  real_T c9_bmls[1280], real_T c9_myBML[256], real_T c9_newBmls[1280]);
extern void sf_exported_user_c9_EP_IdleRand_K_setPersonalityFactor(SimStruct
  *c9_S, real_T c9_p, real_T *c9_m, real_T *c9_a, real_T *c9_h);
extern void sf_exported_user_c9_EP_IdleRand_K_successTable(SimStruct *c9_S,
  real_T c9_bmlID, real_T *c9_p, real_T c9_poseBML[256]);

/* Function Definitions */
extern void sf_c9_EP_IdleRand_K_get_check_sum(mxArray *plhs[]);
extern void c9_EP_IdleRand_K_method_dispatcher(SimStruct *S, int_T method, void *
  data);
