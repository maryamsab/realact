...
static void initialize_c10_EP_IdleRand_K(SFc10_EP_IdleRand_KInstanceStruct
  *chartInstance);
static void initialize_params_c10_EP_IdleRand_K
  (SFc10_EP_IdleRand_KInstanceStruct *chartInstance);
static void enable_c10_EP_IdleRand_K(SFc10_EP_IdleRand_KInstanceStruct
  *chartInstance);
static void disable_c10_EP_IdleRand_K(SFc10_EP_IdleRand_KInstanceStruct
  *chartInstance);
static void c10_update_debugger_state_c10_EP_IdleRand_K
  (SFc10_EP_IdleRand_KInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c10_EP_IdleRand_K
  (SFc10_EP_IdleRand_KInstanceStruct *chartInstance);
static void set_sim_state_c10_EP_IdleRand_K(SFc10_EP_IdleRand_KInstanceStruct
  *chartInstance, const mxArray *c10_st);
static void c10_set_sim_state_side_effects_c10_EP_IdleRand_K
  (SFc10_EP_IdleRand_KInstanceStruct *chartInstance);
static void finalize_c10_EP_IdleRand_K(SFc10_EP_IdleRand_KInstanceStruct
  *chartInstance);
static void sf_gateway_c10_EP_IdleRand_K(SFc10_EP_IdleRand_KInstanceStruct
  *chartInstance);
static void c10_enter_atomic_c10_EP_IdleRand_K(SFc10_EP_IdleRand_KInstanceStruct
  *chartInstance);
static void c10_enter_internal_c10_EP_IdleRand_K
  (SFc10_EP_IdleRand_KInstanceStruct *chartInstance);
static void c10_c10_EP_IdleRand_K(SFc10_EP_IdleRand_KInstanceStruct
  *chartInstance);
static void c10_exit_internal_c10_EP_IdleRand_K
  (SFc10_EP_IdleRand_KInstanceStruct *chartInstance);
static void c10_initc10_EP_IdleRand_K(SFc10_EP_IdleRand_KInstanceStruct
  *chartInstance);
static void initSimStructsc10_EP_IdleRand_K(SFc10_EP_IdleRand_KInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c10_machineNumber, uint32_T
  c10_chartNumber, uint32_T c10_instanceNumber);
static const mxArray *c10_sf_marshallOut(void *chartInstanceVoid, void
  *c10_inData);
static real_T c10_emlrt_marshallIn(SFc10_EP_IdleRand_KInstanceStruct
  *chartInstance, const mxArray *c10_nargout, const char_T *c10_identifier);
static real_T c10_b_emlrt_marshallIn(SFc10_EP_IdleRand_KInstanceStruct
  *chartInstance, const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId);
static void c10_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c10_mxArrayInData, const char_T *c10_varName, void *c10_outData);
static const mxArray *c10_b_sf_marshallOut(void *chartInstanceVoid, void
  *c10_inData);
static boolean_T c10_c_emlrt_marshallIn(SFc10_EP_IdleRand_KInstanceStruct
  *chartInstance, const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId);
static void c10_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c10_mxArrayInData, const char_T *c10_varName, void *c10_outData);
static void c10_activate_secsc10_EP_IdleRand_K(SFc10_EP_IdleRand_KInstanceStruct
  *chartInstance);
static void c10_deactivate_secsc10_EP_IdleRand_K
  (SFc10_EP_IdleRand_KInstanceStruct *chartInstance);
static void c10_increment_counters_secsc10_EP_IdleRand_K
  (SFc10_EP_IdleRand_KInstanceStruct *chartInstance);
static void c10_reset_counters_secsc10_EP_IdleRand_K
  (SFc10_EP_IdleRand_KInstanceStruct *chartInstance);
static const mxArray *c10_c_sf_marshallOut(void *chartInstanceVoid, void
  *c10_inData);
static int8_T c10_d_emlrt_marshallIn(SFc10_EP_IdleRand_KInstanceStruct
  *chartInstance, const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId);
...
static const mxArray *c10_d_sf_marshallOut(void *chartInstanceVoid, void
  *c10_inData);
static int32_T c10_e_emlrt_marshallIn(SFc10_EP_IdleRand_KInstanceStruct
  *chartInstance, const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId);
...
static const mxArray *c10_e_sf_marshallOut(void *chartInstanceVoid, void
  *c10_inData);
static uint8_T c10_f_emlrt_marshallIn(SFc10_EP_IdleRand_KInstanceStruct
  *chartInstance, const mxArray *c10_b_tp_wait, const char_T *c10_identifier);
static uint8_T c10_g_emlrt_marshallIn(SFc10_EP_IdleRand_KInstanceStruct
  *chartInstance, const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId);
static void c10_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c10_mxArrayInData, const char_T *c10_varName, void *c10_outData);
static uint32_T c10_h_emlrt_marshallIn(SFc10_EP_IdleRand_KInstanceStruct
  *chartInstance, const mxArray *c10_b_temporalCounter_i1, const char_T
  *c10_identifier);
static uint32_T c10_i_emlrt_marshallIn(SFc10_EP_IdleRand_KInstanceStruct
  *chartInstance, const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId);
static const mxArray *c10_j_emlrt_marshallIn(SFc10_EP_IdleRand_KInstanceStruct
  *chartInstance, const mxArray *c10_b_setSimStateSideEffectsInfo, const char_T *
  c10_identifier);
static const mxArray *c10_k_emlrt_marshallIn(SFc10_EP_IdleRand_KInstanceStruct
  *chartInstance, const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId);
static void c10_updateDataWrittenToVector(SFc10_EP_IdleRand_KInstanceStruct
  *chartInstance, uint32_T c10_vectorIndex);
static void c10_errorIfDataNotWrittenToFcn(SFc10_EP_IdleRand_KInstanceStruct
  *chartInstance, uint32_T c10_vectorIndex, uint32_T c10_dataNumber);
static real_T c10_get_changeFlag(SFc10_EP_IdleRand_KInstanceStruct
  *chartInstance, uint32_T c10_b);
static void c10_set_changeFlag(SFc10_EP_IdleRand_KInstanceStruct *chartInstance,
  uint32_T c10_b, real_T c10_c);
static real_T *c10_access_changeFlag(SFc10_EP_IdleRand_KInstanceStruct
  *chartInstance, uint32_T c10_b);
static void init_dsm_address_info(SFc10_EP_IdleRand_KInstanceStruct
  *chartInstance);
  ...
  (SFc10_EP_IdleRand_KInstanceStruct *chartInstance)
{
  ...
  c10_b_hoistedGlobal = chartInstance->c10_is_active_c10_EP_IdleRand_K;
  c10_b_u = c10_b_hoistedGlobal;
  c10_c_y = NULL;
  sf_mex_assign(&c10_c_y, sf_mex_create("y", &c10_b_u, 3, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c10_y, 1, c10_c_y);
  c10_c_hoistedGlobal = chartInstance->c10_is_c10_EP_IdleRand_K;
  ...
  *chartInstance, const mxArray *c10_st)
{
  ...
  chartInstance->c10_is_active_c10_EP_IdleRand_K = c10_f_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c10_u, 1)),
     "is_active_c10_EP_IdleRand_K");
  chartInstance->c10_is_c10_EP_IdleRand_K = c10_f_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c10_u, 2)), "is_c10_EP_IdleRand_K");
  ...
  c10_update_debugger_state_c10_EP_IdleRand_K(chartInstance);
...
static void sf_gateway_c10_EP_IdleRand_K(SFc10_EP_IdleRand_KInstanceStruct
  *chartInstance)
{
  c10_set_sim_state_side_effects_c10_EP_IdleRand_K(chartInstance);
}
  ...
  *chartInstance)
{
  ...
  chartInstance->c10_is_active_c10_EP_IdleRand_K = 1U;
  ...
  (SFc10_EP_IdleRand_KInstanceStruct *chartInstance)
{
  ...
  chartInstance->c10_is_c10_EP_IdleRand_K = c10_IN_init;
  _SFD_CS_CALL(STATE_ACTIVE_TAG, 3U, chartInstance->c10_sfEvent);
  chartInstance->c10_tp_init = 1U;
  ...
  *chartInstance)
{
  ...
  switch (chartInstance->c10_is_c10_EP_IdleRand_K) {
   case c10_IN_check:
    CV_CHART_EVAL(6, 0, 1);
    ...
    if (c10_out) {
      ...
      _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, chartInstance->c10_sfEvent);
      chartInstance->c10_isStable = false;
      chartInstance->c10_is_c10_EP_IdleRand_K = c10_IN_flagOne;
      _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, chartInstance->c10_sfEvent);
      chartInstance->c10_temporalCounter_i1 = 0U;
      chartInstance->c10_tp_flagOne = 1U;
   ...
   case c10_IN_flagOne:
    ...
    if (c10_b_out) {
      ...
      _SFD_CS_CALL(STATE_INACTIVE_TAG, 1U, chartInstance->c10_sfEvent);
      chartInstance->c10_isStable = false;
      chartInstance->c10_is_c10_EP_IdleRand_K = c10_IN_wait;
      _SFD_CS_CALL(STATE_ACTIVE_TAG, 4U, chartInstance->c10_sfEvent);
      chartInstance->c10_tp_wait = 1U;
      ...
      if (c10_c_out) {
        ...
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 1U, chartInstance->c10_sfEvent);
        chartInstance->c10_isStable = false;
        chartInstance->c10_is_c10_EP_IdleRand_K = c10_IN_flagZero;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 2U, chartInstance->c10_sfEvent);
        chartInstance->c10_tp_flagZero = 1U;
   ...
   case c10_IN_flagZero:
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 2U, chartInstance->c10_sfEvent);
    chartInstance->c10_isStable = false;
    chartInstance->c10_is_c10_EP_IdleRand_K = c10_IN_check;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, chartInstance->c10_sfEvent);
    chartInstance->c10_tp_check = 1U;
   ...
   default:
    CV_CHART_EVAL(6, 0, 0);
    chartInstance->c10_is_c10_EP_IdleRand_K = c10_IN_NO_ACTIVE_CHILD;
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, chartInstance->c10_sfEvent);
    break;
  }
  ...
  *chartInstance)
{
  ...
  chartInstance->c10_tp_init = 0U;
  chartInstance->c10_tp_wait = 0U;
  chartInstance->c10_is_active_c10_EP_IdleRand_K = 0U;
  chartInstance->c10_is_c10_EP_IdleRand_K = c10_IN_NO_ACTIVE_CHILD;
}
  ...
  *c10_inData)
{
  ...
  const mxArray *c10_y = NULL;
  SFc10_EP_IdleRand_KInstanceStruct *chartInstance;
  chartInstance = (SFc10_EP_IdleRand_KInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c10_EP_IdleRand_K_get_eml_resolved_functions_info(void)
{
...
void sf_exported_auto_activate_c10_EP_IdleRand_K_secs(SimStruct *c10_S)
{
  SFc10_EP_IdleRand_KInstanceStruct *chartInstance;
  chartInstance = (SFc10_EP_IdleRand_KInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c10_S))->instanceInfo)->chartInstance;
  c10_activate_secsc10_EP_IdleRand_K(chartInstance);
}

void sf_exported_auto_incrementTemporalCounter_c10_EP_IdleRand_K_secs(SimStruct *
  c10_S)
{
  SFc10_EP_IdleRand_KInstanceStruct *chartInstance;
  chartInstance = (SFc10_EP_IdleRand_KInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c10_S))->instanceInfo)->chartInstance;
  c10_increment_counters_secsc10_EP_IdleRand_K(chartInstance);
}

void sf_exported_auto_resetTemporalCounter_c10_EP_IdleRand_K_secs(SimStruct
  *c10_S)
{
  SFc10_EP_IdleRand_KInstanceStruct *chartInstance;
  chartInstance = (SFc10_EP_IdleRand_KInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c10_S))->instanceInfo)->chartInstance;
  c10_reset_counters_secsc10_EP_IdleRand_K(chartInstance);
}

void sf_exported_auto_deactivate_c10_EP_IdleRand_K_secs(SimStruct *c10_S)
{
  SFc10_EP_IdleRand_KInstanceStruct *chartInstance;
  chartInstance = (SFc10_EP_IdleRand_KInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c10_S))->instanceInfo)->chartInstance;
  c10_deactivate_secsc10_EP_IdleRand_K(chartInstance);
}

boolean_T sf_exported_auto_isStablec10_EP_IdleRand_K(SimStruct *c10_S)
{
  SFc10_EP_IdleRand_KInstanceStruct *chartInstance;
  chartInstance = (SFc10_EP_IdleRand_KInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c10_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_duringc10_EP_IdleRand_K(SimStruct *c10_S)
{
  SFc10_EP_IdleRand_KInstanceStruct *chartInstance;
  chartInstance = (SFc10_EP_IdleRand_KInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c10_S))->instanceInfo)->chartInstance;
  c10_c10_EP_IdleRand_K(chartInstance);
}

void sf_exported_auto_enterc10_EP_IdleRand_K(SimStruct *c10_S)
{
  SFc10_EP_IdleRand_KInstanceStruct *chartInstance;
  chartInstance = (SFc10_EP_IdleRand_KInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c10_S))->instanceInfo)->chartInstance;
  _sfTime_ = sf_get_time(chartInstance->S);
  c10_enter_atomic_c10_EP_IdleRand_K(chartInstance);
  c10_enter_internal_c10_EP_IdleRand_K(chartInstance);
}

void sf_exported_auto_exitc10_EP_IdleRand_K(SimStruct *c10_S)
{
  SFc10_EP_IdleRand_KInstanceStruct *chartInstance;
  chartInstance = (SFc10_EP_IdleRand_KInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c10_S))->instanceInfo)->chartInstance;
  _sfTime_ = sf_get_time(chartInstance->S);
  c10_exit_internal_c10_EP_IdleRand_K(chartInstance);
}

void sf_exported_auto_gatewayc10_EP_IdleRand_K(SimStruct *c10_S)
{
  SFc10_EP_IdleRand_KInstanceStruct *chartInstance;
  chartInstance = (SFc10_EP_IdleRand_KInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c10_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_enablec10_EP_IdleRand_K(SimStruct *c10_S)
{
  SFc10_EP_IdleRand_KInstanceStruct *chartInstance;
  chartInstance = (SFc10_EP_IdleRand_KInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c10_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_disablec10_EP_IdleRand_K(SimStruct *c10_S)
{
  SFc10_EP_IdleRand_KInstanceStruct *chartInstance;
  chartInstance = (SFc10_EP_IdleRand_KInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c10_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_stepBuffersc10_EP_IdleRand_K(SimStruct *c10_S)
{
  SFc10_EP_IdleRand_KInstanceStruct *chartInstance;
  chartInstance = (SFc10_EP_IdleRand_KInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c10_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_initBuffersc10_EP_IdleRand_K(SimStruct *c10_S)
{
  SFc10_EP_IdleRand_KInstanceStruct *chartInstance;
  chartInstance = (SFc10_EP_IdleRand_KInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c10_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_activate_callc10_EP_IdleRand_K(SimStruct *c10_S)
{
  SFc10_EP_IdleRand_KInstanceStruct *chartInstance;
  chartInstance = (SFc10_EP_IdleRand_KInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c10_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_increment_call_counterc10_EP_IdleRand_K(SimStruct *c10_S)
{
  SFc10_EP_IdleRand_KInstanceStruct *chartInstance;
  chartInstance = (SFc10_EP_IdleRand_KInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c10_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_reset_call_counterc10_EP_IdleRand_K(SimStruct *c10_S)
{
  SFc10_EP_IdleRand_KInstanceStruct *chartInstance;
  chartInstance = (SFc10_EP_IdleRand_KInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c10_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_deactivate_callc10_EP_IdleRand_K(SimStruct *c10_S)
{
  SFc10_EP_IdleRand_KInstanceStruct *chartInstance;
  chartInstance = (SFc10_EP_IdleRand_KInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c10_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_initc10_EP_IdleRand_K(SimStruct *c10_S)
{
  SFc10_EP_IdleRand_KInstanceStruct *chartInstance;
  chartInstance = (SFc10_EP_IdleRand_KInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c10_S))->instanceInfo)->chartInstance;
  c10_initc10_EP_IdleRand_K(chartInstance);
}

const mxArray *sf_exported_auto_getSimstatec10_EP_IdleRand_K(SimStruct *c10_S)
{
  ...
  chartInstance = (SFc10_EP_IdleRand_KInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c10_S))->instanceInfo)->chartInstance;
  c10_out = NULL;
  sf_mex_assign(&c10_out, sf_internal_get_sim_state_c10_EP_IdleRand_K(c10_S),
                false);
  return c10_out;
}

void sf_exported_auto_setSimstatec10_EP_IdleRand_K(SimStruct *c10_S, const
  mxArray *c10_in)
{
  SFc10_EP_IdleRand_KInstanceStruct *chartInstance;
  chartInstance = (SFc10_EP_IdleRand_KInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c10_S))->instanceInfo)->chartInstance;
  sf_internal_set_sim_state_c10_EP_IdleRand_K(c10_S, sf_mex_dup(c10_in));
  sf_mex_destroy(&c10_in);
}

void sf_exported_auto_check_state_inconsistency_c10_EP_IdleRand_K(SimStruct
  *c10_S)
{
  SFc10_EP_IdleRand_KInstanceStruct *chartInstance;
  chartInstance = (SFc10_EP_IdleRand_KInstanceStruct *)((ChartInfoStruct *)
  ...
  *chartInstance, uint32_T c10_b)
{
  ...
  if (chartInstance->c10_changeFlag_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'changeFlag\' (#720) in the initialization routine of the chart.\n");
  }
...
void sf_c10_EP_IdleRand_K_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c10_EP_IdleRand_K_get_autoinheritance_info(void)
{
...
mxArray *sf_c10_EP_IdleRand_K_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c10_EP_IdleRand_K_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c10_EP_IdleRand_K(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[3],M[19],T\"timer\",},{M[8],M[0],T\"is_active_c10_EP_IdleRand_K\",},{M[9],M[0],T\"is_c10_EP_IdleRand_K\",},{M[11],M[11],T\"temporalCounter_i1\",S'et','os','ct'{{T\"ev\",M[7],M[1]}}}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c10_EP_IdleRand_K_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc10_EP_IdleRand_KInstanceStruct *)
...
static void sf_opaque_initialize_c10_EP_IdleRand_K(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc10_EP_IdleRand_KInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c10_EP_IdleRand_K((SFc10_EP_IdleRand_KInstanceStruct*)
    chartInstanceVar);
  initialize_c10_EP_IdleRand_K((SFc10_EP_IdleRand_KInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c10_EP_IdleRand_K(void *chartInstanceVar)
{
  enable_c10_EP_IdleRand_K((SFc10_EP_IdleRand_KInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c10_EP_IdleRand_K(void *chartInstanceVar)
{
  disable_c10_EP_IdleRand_K((SFc10_EP_IdleRand_KInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c10_EP_IdleRand_K(void *chartInstanceVar)
{
  sf_gateway_c10_EP_IdleRand_K((SFc10_EP_IdleRand_KInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c10_EP_IdleRand_K(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c10_EP_IdleRand_K
    ((SFc10_EP_IdleRand_KInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c10_EP_IdleRand_K();/* state var info */
...
extern void sf_internal_set_sim_state_c10_EP_IdleRand_K(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c10_EP_IdleRand_K();/* state var info */
  ...
  set_sim_state_c10_EP_IdleRand_K((SFc10_EP_IdleRand_KInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c10_EP_IdleRand_K(SimStruct* S)
{
  return NULL;
}

static void sf_opaque_set_sim_state_c10_EP_IdleRand_K(SimStruct* S, const
  mxArray *st)
{
}

static void sf_opaque_terminate_c10_EP_IdleRand_K(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc10_EP_IdleRand_KInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c10_EP_IdleRand_K((SFc10_EP_IdleRand_KInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc10_EP_IdleRand_K((SFc10_EP_IdleRand_KInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c10_EP_IdleRand_K(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c10_EP_IdleRand_K(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c10_EP_IdleRand_K(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c10_EP_IdleRand_K(SimStruct *S)
{
  SFc10_EP_IdleRand_KInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc10_EP_IdleRand_KInstanceStruct *)utMalloc(sizeof
    (SFc10_EP_IdleRand_KInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc10_EP_IdleRand_KInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c10_EP_IdleRand_K;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c10_EP_IdleRand_K;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c10_EP_IdleRand_K;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c10_EP_IdleRand_K;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c10_EP_IdleRand_K;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c10_EP_IdleRand_K;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c10_EP_IdleRand_K;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c10_EP_IdleRand_K;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c10_EP_IdleRand_K;
  chartInstance->chartInfo.mdlStart = mdlStart_c10_EP_IdleRand_K;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c10_EP_IdleRand_K;
...
void c10_EP_IdleRand_K_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c10_EP_IdleRand_K(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c10_EP_IdleRand_K(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c10_EP_IdleRand_K(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c10_EP_IdleRand_K_method_dispatcher.\n"
