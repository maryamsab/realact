...
static void initialize_c20_DemoWalk_K(SFc20_DemoWalk_KInstanceStruct
  *chartInstance);
static void initialize_params_c20_DemoWalk_K(SFc20_DemoWalk_KInstanceStruct
  *chartInstance);
static void enable_c20_DemoWalk_K(SFc20_DemoWalk_KInstanceStruct *chartInstance);
static void disable_c20_DemoWalk_K(SFc20_DemoWalk_KInstanceStruct *chartInstance);
static void c20_update_debugger_state_c20_DemoWalk_K
  (SFc20_DemoWalk_KInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c20_DemoWalk_K
  (SFc20_DemoWalk_KInstanceStruct *chartInstance);
static void set_sim_state_c20_DemoWalk_K(SFc20_DemoWalk_KInstanceStruct
  *chartInstance, const mxArray *c20_st);
static void c20_set_sim_state_side_effects_c20_DemoWalk_K
  (SFc20_DemoWalk_KInstanceStruct *chartInstance);
static void finalize_c20_DemoWalk_K(SFc20_DemoWalk_KInstanceStruct
  *chartInstance);
static void sf_gateway_c20_DemoWalk_K(SFc20_DemoWalk_KInstanceStruct
  *chartInstance);
static void c20_enter_atomic_c20_DemoWalk_K(SFc20_DemoWalk_KInstanceStruct
  *chartInstance);
static void c20_enter_internal_c20_DemoWalk_K(SFc20_DemoWalk_KInstanceStruct
  *chartInstance);
static void c20_c20_DemoWalk_K(SFc20_DemoWalk_KInstanceStruct *chartInstance);
static void c20_exit_internal_c20_DemoWalk_K(SFc20_DemoWalk_KInstanceStruct
  *chartInstance);
static void c20_initc20_DemoWalk_K(SFc20_DemoWalk_KInstanceStruct *chartInstance);
static void initSimStructsc20_DemoWalk_K(SFc20_DemoWalk_KInstanceStruct
  *chartInstance);
static void c20_enter_atomic_gazeCamera(SFc20_DemoWalk_KInstanceStruct
  *chartInstance);
static void c20_gazeCamera(SFc20_DemoWalk_KInstanceStruct *chartInstance);
static void c20_wave(SFc20_DemoWalk_KInstanceStruct *chartInstance);
static void c20_enter_atomic_gazeCamera1(SFc20_DemoWalk_KInstanceStruct
  *chartInstance);
static void c20_gazeCamera1(SFc20_DemoWalk_KInstanceStruct *chartInstance);
static void c20_enter_atomic_waveLeftHand(SFc20_DemoWalk_KInstanceStruct
  *chartInstance);
static void c20_enter_atomic_waveBothHands(SFc20_DemoWalk_KInstanceStruct
  *chartInstance);
static void c20_enter_atomic_gazeCamera2(SFc20_DemoWalk_KInstanceStruct
  *chartInstance);
static void c20_encStr2Arr(SFc20_DemoWalk_KInstanceStruct *chartInstance, real_T
  c20_myarr256[256]);
static void c20_b_encStr2Arr(SFc20_DemoWalk_KInstanceStruct *chartInstance,
  real_T c20_myarr256[256]);
static void c20_c_encStr2Arr(SFc20_DemoWalk_KInstanceStruct *chartInstance,
  real_T c20_myarr256[256]);
static void c20_d_encStr2Arr(SFc20_DemoWalk_KInstanceStruct *chartInstance,
  real_T c20_myarr256[256]);
...
static const mxArray *c20_sf_marshallOut(void *chartInstanceVoid, void
  *c20_inData);
static void c20_emlrt_marshallIn(SFc20_DemoWalk_KInstanceStruct *chartInstance,
  const mxArray *c20_poseBML, const char_T *c20_identifier, real_T c20_y[256]);
static void c20_b_emlrt_marshallIn(SFc20_DemoWalk_KInstanceStruct *chartInstance,
...
static const mxArray *c20_b_sf_marshallOut(void *chartInstanceVoid, void
  *c20_inData);
static real_T c20_c_emlrt_marshallIn(SFc20_DemoWalk_KInstanceStruct
  *chartInstance, const mxArray *c20_pr, const char_T *c20_identifier);
static real_T c20_d_emlrt_marshallIn(SFc20_DemoWalk_KInstanceStruct
...
static const mxArray *c20_c_sf_marshallOut(void *chartInstanceVoid, void
  *c20_inData);
static boolean_T c20_e_emlrt_marshallIn(SFc20_DemoWalk_KInstanceStruct
  *chartInstance, const mxArray *c20_u, const emlrtMsgIdentifier *c20_parentId);
...
static const mxArray *c20_d_sf_marshallOut(void *chartInstanceVoid, void
  *c20_inData);
static void c20_f_emlrt_marshallIn(SFc20_DemoWalk_KInstanceStruct *chartInstance,
  const mxArray *c20_myarr256, const char_T *c20_identifier, real_T c20_y[256]);
static void c20_g_emlrt_marshallIn(SFc20_DemoWalk_KInstanceStruct *chartInstance,
  const mxArray *c20_u, const emlrtMsgIdentifier *c20_parentId, real_T c20_y[256]);
...
static const mxArray *c20_o_sf_marshallOut(void *chartInstanceVoid, void
  *c20_inData);
static void c20_h_emlrt_marshallIn(SFc20_DemoWalk_KInstanceStruct *chartInstance,
  const mxArray *c20_newBmls, const char_T *c20_identifier, real_T c20_y[1280]);
static void c20_i_emlrt_marshallIn(SFc20_DemoWalk_KInstanceStruct *chartInstance,
...
static void c20_activate_secsc20_DemoWalk_K(SFc20_DemoWalk_KInstanceStruct
  *chartInstance);
static void c20_deactivate_secsc20_DemoWalk_K(SFc20_DemoWalk_KInstanceStruct
  *chartInstance);
static void c20_increment_counters_secsc20_DemoWalk_K
  (SFc20_DemoWalk_KInstanceStruct *chartInstance);
static void c20_reset_counters_secsc20_DemoWalk_K(SFc20_DemoWalk_KInstanceStruct
  *chartInstance);
static void c20_wavePoseBradTablec20_DemoWalk_K(SFc20_DemoWalk_KInstanceStruct
  *chartInstance, real_T c20_bmlID, real_T *c20_pr, real_T c20_poseBML[256]);
static void c20_insertQueuec20_DemoWalk_K(SFc20_DemoWalk_KInstanceStruct
...
static const mxArray *c20_q_sf_marshallOut(void *chartInstanceVoid, void
  *c20_inData);
static int8_T c20_j_emlrt_marshallIn(SFc20_DemoWalk_KInstanceStruct
  *chartInstance, const mxArray *c20_u, const emlrtMsgIdentifier *c20_parentId);
...
static const mxArray *c20_r_sf_marshallOut(void *chartInstanceVoid, void
  *c20_inData);
static int32_T c20_k_emlrt_marshallIn(SFc20_DemoWalk_KInstanceStruct
  *chartInstance, const mxArray *c20_u, const emlrtMsgIdentifier *c20_parentId);
...
static const mxArray *c20_s_sf_marshallOut(void *chartInstanceVoid, void
  *c20_inData);
static uint8_T c20_l_emlrt_marshallIn(SFc20_DemoWalk_KInstanceStruct
  *chartInstance, const mxArray *c20_b_tp_init, const char_T *c20_identifier);
static uint8_T c20_m_emlrt_marshallIn(SFc20_DemoWalk_KInstanceStruct
  *chartInstance, const mxArray *c20_u, const emlrtMsgIdentifier *c20_parentId);
static void c20_h_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c20_mxArrayInData, const char_T *c20_varName, void *c20_outData);
static const mxArray *c20_n_emlrt_marshallIn(SFc20_DemoWalk_KInstanceStruct
  *chartInstance, const mxArray *c20_b_setSimStateSideEffectsInfo, const char_T *
  c20_identifier);
static const mxArray *c20_o_emlrt_marshallIn(SFc20_DemoWalk_KInstanceStruct
  *chartInstance, const mxArray *c20_u, const emlrtMsgIdentifier *c20_parentId);
static void c20_updateDataWrittenToVector(SFc20_DemoWalk_KInstanceStruct
  *chartInstance, uint32_T c20_vectorIndex);
static void c20_errorIfDataNotWrittenToFcn(SFc20_DemoWalk_KInstanceStruct
  *chartInstance, uint32_T c20_vectorIndex, uint32_T c20_dataNumber);
static real_T c20_get_BML(SFc20_DemoWalk_KInstanceStruct *chartInstance,
  uint32_T c20_b);
static void c20_set_BML(SFc20_DemoWalk_KInstanceStruct *chartInstance, uint32_T
  c20_b, real_T c20_c);
static real_T *c20_access_BML(SFc20_DemoWalk_KInstanceStruct *chartInstance,
  uint32_T c20_b);
static real_T c20_get_BML2(SFc20_DemoWalk_KInstanceStruct *chartInstance,
  uint32_T c20_b);
static void c20_set_BML2(SFc20_DemoWalk_KInstanceStruct *chartInstance, uint32_T
  c20_b, real_T c20_c);
static real_T *c20_access_BML2(SFc20_DemoWalk_KInstanceStruct *chartInstance,
  uint32_T c20_b);
static real_T c20_get_P(SFc20_DemoWalk_KInstanceStruct *chartInstance, uint32_T
  c20_b);
static void c20_set_P(SFc20_DemoWalk_KInstanceStruct *chartInstance, uint32_T
                      c20_b, real_T c20_c);
static real_T *c20_access_P(SFc20_DemoWalk_KInstanceStruct *chartInstance,
  uint32_T c20_b);
static real_T c20_get_STATE_BEFORE(SFc20_DemoWalk_KInstanceStruct *chartInstance,
  uint32_T c20_b);
static void c20_set_STATE_BEFORE(SFc20_DemoWalk_KInstanceStruct *chartInstance,
  uint32_T c20_b, real_T c20_c);
static real_T *c20_access_STATE_BEFORE(SFc20_DemoWalk_KInstanceStruct
  *chartInstance, uint32_T c20_b);
static real_T c20_get_STATE_OVER(SFc20_DemoWalk_KInstanceStruct *chartInstance,
  uint32_T c20_b);
static void c20_set_STATE_OVER(SFc20_DemoWalk_KInstanceStruct *chartInstance,
  uint32_T c20_b, real_T c20_c);
static real_T *c20_access_STATE_OVER(SFc20_DemoWalk_KInstanceStruct
  *chartInstance, uint32_T c20_b);
static real_T c20_get_avert(SFc20_DemoWalk_KInstanceStruct *chartInstance,
  uint32_T c20_b);
static void c20_set_avert(SFc20_DemoWalk_KInstanceStruct *chartInstance,
  uint32_T c20_b, real_T c20_c);
static real_T *c20_access_avert(SFc20_DemoWalk_KInstanceStruct *chartInstance,
  uint32_T c20_b);
static real_T c20_get_bmlsM(SFc20_DemoWalk_KInstanceStruct *chartInstance,
  uint32_T c20_b);
static void c20_set_bmlsM(SFc20_DemoWalk_KInstanceStruct *chartInstance,
  uint32_T c20_b, real_T c20_c);
static real_T *c20_access_bmlsM(SFc20_DemoWalk_KInstanceStruct *chartInstance,
  uint32_T c20_b);
static real_T c20_get_fileID(SFc20_DemoWalk_KInstanceStruct *chartInstance,
  uint32_T c20_b);
static void c20_set_fileID(SFc20_DemoWalk_KInstanceStruct *chartInstance,
  uint32_T c20_b, real_T c20_c);
static real_T *c20_access_fileID(SFc20_DemoWalk_KInstanceStruct *chartInstance,
  uint32_T c20_b);
static void init_dsm_address_info(SFc20_DemoWalk_KInstanceStruct *chartInstance);
  ...
  (SFc20_DemoWalk_KInstanceStruct *chartInstance)
{
  ...
  c20_e_hoistedGlobal = chartInstance->c20_is_active_c20_DemoWalk_K;
  ...
  c20_f_hoistedGlobal = chartInstance->c20_is_c20_DemoWalk_K;
  ...
  *chartInstance, const mxArray *c20_st)
{
  ...
  *c20_gameState = c20_c_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  chartInstance->c20_is_active_c20_DemoWalk_K = c20_l_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c20_u, 7)),
     "is_active_c20_DemoWalk_K");
  chartInstance->c20_is_c20_DemoWalk_K = c20_l_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c20_u, 8)), "is_c20_DemoWalk_K");
  ...
  c20_update_debugger_state_c20_DemoWalk_K(chartInstance);
...
static void sf_gateway_c20_DemoWalk_K(SFc20_DemoWalk_KInstanceStruct
  *chartInstance)
{
  c20_set_sim_state_side_effects_c20_DemoWalk_K(chartInstance);
}
  ...
  *chartInstance)
{
  ...
  chartInstance->c20_is_active_c20_DemoWalk_K = 1U;
  ...
  *chartInstance)
{
  ...
  chartInstance->c20_is_c20_DemoWalk_K = c20_IN_init;
  _SFD_CS_CALL(STATE_ACTIVE_TAG, 3U, chartInstance->c20_sfEvent);
  chartInstance->c20_tp_init = 1U;
...
static void c20_c20_DemoWalk_K(SFc20_DemoWalk_KInstanceStruct *chartInstance)
{
  ...
  switch (chartInstance->c20_is_c20_DemoWalk_K) {
   ...
   case c20_IN_gazeCamera2:
    ...
    if (c20_out) {
      ...
      _SFD_CS_CALL(STATE_INACTIVE_TAG, 2U, chartInstance->c20_sfEvent);
      chartInstance->c20_isStable = false;
      chartInstance->c20_is_c20_DemoWalk_K = c20_IN_waveBothHands;
      _SFD_CS_CALL(STATE_ACTIVE_TAG, 6U, chartInstance->c20_sfEvent);
      chartInstance->c20_temporalCounter_i1 = 0U;
      chartInstance->c20_tp_waveBothHands = 1U;
      ...
      _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c20_b_nargout, 1U,
        c20_b_sf_marshallOut, c20_b_sf_marshallIn);
      c20_wavePoseBradTablec20_DemoWalk_K(chartInstance, 3.0, &c20_P, c20_b_BMLM);
      ...
      c20_insertQueuec20_DemoWalk_K(chartInstance, c20_dv3, c20_dv4, c20_dv5);
   ...
   case c20_IN_init:
    ...
    if (c20_b_out) {
      ...
      _SFD_CS_CALL(STATE_INACTIVE_TAG, 3U, chartInstance->c20_sfEvent);
      chartInstance->c20_isStable = false;
      chartInstance->c20_is_c20_DemoWalk_K = c20_IN_wave;
      _SFD_CS_CALL(STATE_ACTIVE_TAG, 5U, chartInstance->c20_sfEvent);
      chartInstance->c20_temporalCounter_i1 = 0U;
      chartInstance->c20_tp_wave = 1U;
    } else {
   ...
   default:
    ...
    chartInstance->c20_is_c20_DemoWalk_K = c20_IN_NO_ACTIVE_CHILD;
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, chartInstance->c20_sfEvent);
    break;
  }
...
static void c20_initc20_DemoWalk_K(SFc20_DemoWalk_KInstanceStruct *chartInstance)
{
  ...
  chartInstance->c20_tp_waveRightHand = 0U;
  chartInstance->c20_temporalCounter_i1 = 0U;
  chartInstance->c20_is_active_c20_DemoWalk_K = 0U;
  chartInstance->c20_is_c20_DemoWalk_K = c20_IN_NO_ACTIVE_CHILD;
}
  ...
  *chartInstance)
{
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c20_nargout, 1U, c20_b_sf_marshallOut,
    c20_b_sf_marshallIn);
  c20_wavePoseBradTablec20_DemoWalk_K(chartInstance, 6.0, &c20_P, c20_b_BMLM);
  c20_set_P(chartInstance, 0, c20_P);
  ssUpdateDataStoreLog(chartInstance->S, 2);
  ...
  c20_insertQueuec20_DemoWalk_K(chartInstance, c20_dv6, c20_dv7, c20_dv8);
...
static void c20_gazeCamera(SFc20_DemoWalk_KInstanceStruct *chartInstance)
{
  ...
  if (c20_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, chartInstance->c20_sfEvent);
    chartInstance->c20_isStable = false;
    chartInstance->c20_is_c20_DemoWalk_K = c20_IN_waveRightHand;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 9U, chartInstance->c20_sfEvent);
    chartInstance->c20_temporalCounter_i1 = 0U;
    chartInstance->c20_tp_waveRightHand = 1U;
    ...
    _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c20_b_nargout, 1U,
      c20_b_sf_marshallOut, c20_b_sf_marshallIn);
    c20_wavePoseBradTablec20_DemoWalk_K(chartInstance, 1.0, &c20_P, c20_b_BMLM);
    c20_set_P(chartInstance, 0, c20_P);
    ssUpdateDataStoreLog(chartInstance->S, 2);
    ...
    c20_insertQueuec20_DemoWalk_K(chartInstance, c20_dv9, c20_dv10, c20_dv11);
...
static void c20_wave(SFc20_DemoWalk_KInstanceStruct *chartInstance)
{
  ...
  if (c20_out) {
    ...
    if (c20_b_out) {
      ...
      _SFD_CS_CALL(STATE_INACTIVE_TAG, 5U, chartInstance->c20_sfEvent);
      chartInstance->c20_isStable = false;
      chartInstance->c20_is_c20_DemoWalk_K = c20_IN_gazeCamera1;
      _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, chartInstance->c20_sfEvent);
      chartInstance->c20_temporalCounter_i1 = 0U;
      chartInstance->c20_tp_gazeCamera1 = 1U;
      ...
      _SFD_CS_CALL(STATE_INACTIVE_TAG, 5U, chartInstance->c20_sfEvent);
      chartInstance->c20_isStable = false;
      chartInstance->c20_is_c20_DemoWalk_K = c20_IN_waveLeftHand;
      _SFD_CS_CALL(STATE_ACTIVE_TAG, 7U, chartInstance->c20_sfEvent);
      chartInstance->c20_temporalCounter_i1 = 0U;
      chartInstance->c20_tp_waveLeftHand = 1U;
    ...
    if (c20_c_out) {
      ...
      if (c20_d_out) {
        ...
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 5U, chartInstance->c20_sfEvent);
        chartInstance->c20_isStable = false;
        chartInstance->c20_is_c20_DemoWalk_K = c20_IN_gazeCamera2;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 2U, chartInstance->c20_sfEvent);
        chartInstance->c20_temporalCounter_i1 = 0U;
        chartInstance->c20_tp_gazeCamera2 = 1U;
      ...
      if (c20_e_out) {
        ...
        if (c20_f_out) {
          ...
          _SFD_CS_CALL(STATE_INACTIVE_TAG, 5U, chartInstance->c20_sfEvent);
          chartInstance->c20_isStable = false;
          chartInstance->c20_is_c20_DemoWalk_K = c20_IN_gazeCamera;
          _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, chartInstance->c20_sfEvent);
          chartInstance->c20_temporalCounter_i1 = 0U;
          chartInstance->c20_tp_gazeCamera = 1U;
          ...
          _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c20_j_nargout, 1U,
            c20_b_sf_marshallOut, c20_b_sf_marshallIn);
          c20_wavePoseBradTablec20_DemoWalk_K(chartInstance, 1.0, &c20_P,
            c20_b_BMLM);
          c20_set_P(chartInstance, 0, c20_P);
          ssUpdateDataStoreLog(chartInstance->S, 2);
          ...
          c20_insertQueuec20_DemoWalk_K(chartInstance, c20_dv12, c20_dv13,
            c20_dv14);
  ...
  *chartInstance)
{
  ...
  c20_insertQueuec20_DemoWalk_K(chartInstance, c20_dv15, c20_dv16, c20_dv17);
...
static void c20_gazeCamera1(SFc20_DemoWalk_KInstanceStruct *chartInstance)
{
  ...
  if (c20_out) {
    ...
    _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c20_b_nargout, 1U,
      c20_b_sf_marshallOut, c20_b_sf_marshallIn);
    c20_wavePoseBradTablec20_DemoWalk_K(chartInstance, 2.0, &c20_P, c20_b_BMLM);
    c20_set_P(chartInstance, 0, c20_P);
    ssUpdateDataStoreLog(chartInstance->S, 2);
    ...
    c20_insertQueuec20_DemoWalk_K(chartInstance, c20_dv18, c20_dv19, c20_dv20);
  ...
  *chartInstance)
{
  ...
  c20_insertQueuec20_DemoWalk_K(chartInstance, c20_dv21, c20_dv22, c20_dv23);
  ...
  *chartInstance)
{
  ...
  c20_insertQueuec20_DemoWalk_K(chartInstance, c20_dv24, c20_dv25, c20_dv26);
  ...
  *chartInstance)
{
  ...
  c20_insertQueuec20_DemoWalk_K(chartInstance, c20_dv27, c20_dv28, c20_dv29);
  ...
  *c20_inData)
{
  ...
  const mxArray *c20_y = NULL;
  SFc20_DemoWalk_KInstanceStruct *chartInstance;
  chartInstance = (SFc20_DemoWalk_KInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c20_DemoWalk_K_get_eml_resolved_functions_info(void)
{
...
void sf_exported_auto_activate_c20_DemoWalk_K_secs(SimStruct *c20_S)
{
  SFc20_DemoWalk_KInstanceStruct *chartInstance;
  chartInstance = (SFc20_DemoWalk_KInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c20_S))->instanceInfo)->chartInstance;
  c20_activate_secsc20_DemoWalk_K(chartInstance);
}

void sf_exported_auto_incrementTemporalCounter_c20_DemoWalk_K_secs(SimStruct
  *c20_S)
{
  SFc20_DemoWalk_KInstanceStruct *chartInstance;
  chartInstance = (SFc20_DemoWalk_KInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c20_S))->instanceInfo)->chartInstance;
  c20_increment_counters_secsc20_DemoWalk_K(chartInstance);
}

void sf_exported_auto_resetTemporalCounter_c20_DemoWalk_K_secs(SimStruct *c20_S)
{
  SFc20_DemoWalk_KInstanceStruct *chartInstance;
  chartInstance = (SFc20_DemoWalk_KInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c20_S))->instanceInfo)->chartInstance;
  c20_reset_counters_secsc20_DemoWalk_K(chartInstance);
}

void sf_exported_auto_deactivate_c20_DemoWalk_K_secs(SimStruct *c20_S)
{
  SFc20_DemoWalk_KInstanceStruct *chartInstance;
  chartInstance = (SFc20_DemoWalk_KInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c20_S))->instanceInfo)->chartInstance;
  c20_deactivate_secsc20_DemoWalk_K(chartInstance);
}

boolean_T sf_exported_auto_isStablec20_DemoWalk_K(SimStruct *c20_S)
{
  SFc20_DemoWalk_KInstanceStruct *chartInstance;
  chartInstance = (SFc20_DemoWalk_KInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c20_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_duringc20_DemoWalk_K(SimStruct *c20_S)
{
  SFc20_DemoWalk_KInstanceStruct *chartInstance;
  chartInstance = (SFc20_DemoWalk_KInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c20_S))->instanceInfo)->chartInstance;
  c20_c20_DemoWalk_K(chartInstance);
}

void sf_exported_auto_enterc20_DemoWalk_K(SimStruct *c20_S)
{
  SFc20_DemoWalk_KInstanceStruct *chartInstance;
  chartInstance = (SFc20_DemoWalk_KInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c20_S))->instanceInfo)->chartInstance;
  _sfTime_ = sf_get_time(chartInstance->S);
  c20_enter_atomic_c20_DemoWalk_K(chartInstance);
  c20_enter_internal_c20_DemoWalk_K(chartInstance);
}

void sf_exported_auto_exitc20_DemoWalk_K(SimStruct *c20_S)
{
  SFc20_DemoWalk_KInstanceStruct *chartInstance;
  chartInstance = (SFc20_DemoWalk_KInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c20_S))->instanceInfo)->chartInstance;
  _sfTime_ = sf_get_time(chartInstance->S);
  c20_exit_internal_c20_DemoWalk_K(chartInstance);
}

void sf_exported_auto_gatewayc20_DemoWalk_K(SimStruct *c20_S)
{
  SFc20_DemoWalk_KInstanceStruct *chartInstance;
  chartInstance = (SFc20_DemoWalk_KInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c20_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_enablec20_DemoWalk_K(SimStruct *c20_S)
{
  SFc20_DemoWalk_KInstanceStruct *chartInstance;
  chartInstance = (SFc20_DemoWalk_KInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c20_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_disablec20_DemoWalk_K(SimStruct *c20_S)
{
  SFc20_DemoWalk_KInstanceStruct *chartInstance;
  chartInstance = (SFc20_DemoWalk_KInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c20_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_stepBuffersc20_DemoWalk_K(SimStruct *c20_S)
{
  SFc20_DemoWalk_KInstanceStruct *chartInstance;
  chartInstance = (SFc20_DemoWalk_KInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c20_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_initBuffersc20_DemoWalk_K(SimStruct *c20_S)
{
  SFc20_DemoWalk_KInstanceStruct *chartInstance;
  chartInstance = (SFc20_DemoWalk_KInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c20_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_activate_callc20_DemoWalk_K(SimStruct *c20_S)
{
  SFc20_DemoWalk_KInstanceStruct *chartInstance;
  chartInstance = (SFc20_DemoWalk_KInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c20_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_increment_call_counterc20_DemoWalk_K(SimStruct *c20_S)
{
  SFc20_DemoWalk_KInstanceStruct *chartInstance;
  chartInstance = (SFc20_DemoWalk_KInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c20_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_reset_call_counterc20_DemoWalk_K(SimStruct *c20_S)
{
  SFc20_DemoWalk_KInstanceStruct *chartInstance;
  chartInstance = (SFc20_DemoWalk_KInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c20_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_deactivate_callc20_DemoWalk_K(SimStruct *c20_S)
{
  SFc20_DemoWalk_KInstanceStruct *chartInstance;
  chartInstance = (SFc20_DemoWalk_KInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c20_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_initc20_DemoWalk_K(SimStruct *c20_S)
{
  SFc20_DemoWalk_KInstanceStruct *chartInstance;
  chartInstance = (SFc20_DemoWalk_KInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c20_S))->instanceInfo)->chartInstance;
  c20_initc20_DemoWalk_K(chartInstance);
}

const mxArray *sf_exported_auto_getSimstatec20_DemoWalk_K(SimStruct *c20_S)
{
  ...
  chartInstance = (SFc20_DemoWalk_KInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c20_S))->instanceInfo)->chartInstance;
  c20_out = NULL;
  sf_mex_assign(&c20_out, sf_internal_get_sim_state_c20_DemoWalk_K(c20_S), false);
  return c20_out;
}

void sf_exported_auto_setSimstatec20_DemoWalk_K(SimStruct *c20_S, const mxArray *
  c20_in)
{
  SFc20_DemoWalk_KInstanceStruct *chartInstance;
  chartInstance = (SFc20_DemoWalk_KInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c20_S))->instanceInfo)->chartInstance;
  sf_internal_set_sim_state_c20_DemoWalk_K(c20_S, sf_mex_dup(c20_in));
  sf_mex_destroy(&c20_in);
}

void sf_exported_auto_check_state_inconsistency_c20_DemoWalk_K(SimStruct *c20_S)
{
  SFc20_DemoWalk_KInstanceStruct *chartInstance;
  chartInstance = (SFc20_DemoWalk_KInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c20_S))->instanceInfo)->chartInstance;
...
void sf_exported_user_c20_DemoWalk_K_insertQueue(SimStruct *c20_S, real_T
  c20_bmls[1280], real_T c20_mBML[256], real_T c20_newBmls[1280])
{
  ...
  c20_insertQueuec20_DemoWalk_K(chartInstance, c20_b_bmls, c20_b_mBML,
    c20_newBmls);
}

void sf_exported_user_c20_DemoWalk_K_wavePoseBradTable(SimStruct *c20_S, real_T
  c20_bmlID, real_T *c20_pr, real_T c20_poseBML[256])
{
  ...
  chartInstance = (SFc20_DemoWalk_KInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c20_S))->instanceInfo)->chartInstance;
  c20_wavePoseBradTablec20_DemoWalk_K(chartInstance, c20_bmlID, &c20_b_pr,
    c20_poseBML);
  *c20_pr = c20_b_pr;
}
  ...
  uint32_T c20_b)
{
  ...
  if (chartInstance->c20_BML_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'BML\' (#1561) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c20_b)
{
  ...
  if (chartInstance->c20_BML2_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'BML2\' (#1568) in the initialization routine of the chart.\n");
  }
  ...
  c20_b)
{
  ...
  if (chartInstance->c20_P_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'P\' (#1562) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c20_b)
{
  ...
  if (chartInstance->c20_STATE_BEFORE_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'STATE_BEFORE\' (#1564) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c20_b)
{
  ...
  if (chartInstance->c20_STATE_OVER_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'STATE_OVER\' (#1563) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c20_b)
{
  ...
  if (chartInstance->c20_avert_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'avert\' (#1569) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c20_b)
{
  ...
  if (chartInstance->c20_bmlsM_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'bmlsM\' (#1572) in the initialization routine of the chart.\n");
  }
...
void sf_c20_DemoWalk_K_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c20_DemoWalk_K_get_autoinheritance_info(void)
{
...
mxArray *sf_c20_DemoWalk_K_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c20_DemoWalk_K_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c20_DemoWalk_K(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x10'type','srcId','name','auxInfo'{{M[1],M[25],T\"gameState\",},{M[3],M[69],T\"BMLM\",},{M[3],M[33],T\"bFlag\",},{M[3],M[32],T\"lFlag\",},{M[3],M[72],T\"n\",},{M[3],M[70],T\"newBmlsM\",},{M[3],M[31],T\"rFlag\",},{M[8],M[0],T\"is_active_c20_DemoWalk_K\",},{M[9],M[0],T\"is_c20_DemoWalk_K\",},{M[11],M[29],T\"temporalCounter_i1\",S'et','os','ct'{{T\"ev\",M1x7[8 10 11 46 49 42 51],M[1]}}}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 10, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c20_DemoWalk_K_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc20_DemoWalk_KInstanceStruct *) chartInfo->chartInstance;
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_FCN(8,0,"wavePoseBradTablec20_DemoWalk_K",0,-1,990);
        ...
        _SFD_CV_INIT_EML_FCN(4,0,"insertQueuec20_DemoWalk_K",0,-1,640);
...
static void sf_opaque_initialize_c20_DemoWalk_K(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc20_DemoWalk_KInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c20_DemoWalk_K((SFc20_DemoWalk_KInstanceStruct*)
    chartInstanceVar);
  initialize_c20_DemoWalk_K((SFc20_DemoWalk_KInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c20_DemoWalk_K(void *chartInstanceVar)
{
  enable_c20_DemoWalk_K((SFc20_DemoWalk_KInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c20_DemoWalk_K(void *chartInstanceVar)
{
  disable_c20_DemoWalk_K((SFc20_DemoWalk_KInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c20_DemoWalk_K(void *chartInstanceVar)
{
  sf_gateway_c20_DemoWalk_K((SFc20_DemoWalk_KInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c20_DemoWalk_K(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c20_DemoWalk_K
    ((SFc20_DemoWalk_KInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c20_DemoWalk_K();/* state var info */
...
extern void sf_internal_set_sim_state_c20_DemoWalk_K(SimStruct* S, const mxArray
  *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c20_DemoWalk_K();/* state var info */
  ...
  set_sim_state_c20_DemoWalk_K((SFc20_DemoWalk_KInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c20_DemoWalk_K(SimStruct* S)
{
  return NULL;
}

static void sf_opaque_set_sim_state_c20_DemoWalk_K(SimStruct* S, const mxArray
  *st)
{
}

static void sf_opaque_terminate_c20_DemoWalk_K(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc20_DemoWalk_KInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c20_DemoWalk_K((SFc20_DemoWalk_KInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc20_DemoWalk_K((SFc20_DemoWalk_KInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c20_DemoWalk_K(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c20_DemoWalk_K(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(3421859871U));
  ssSetChecksum1(S,(1512711975U));
  ssSetChecksum2(S,(1301213011U));
  ssSetChecksum3(S,(4043299405U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c20_DemoWalk_K(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c20_DemoWalk_K(SimStruct *S)
{
  SFc20_DemoWalk_KInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc20_DemoWalk_KInstanceStruct *)utMalloc(sizeof
    (SFc20_DemoWalk_KInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc20_DemoWalk_KInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c20_DemoWalk_K;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c20_DemoWalk_K;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c20_DemoWalk_K;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c20_DemoWalk_K;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c20_DemoWalk_K;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c20_DemoWalk_K;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c20_DemoWalk_K;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c20_DemoWalk_K;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c20_DemoWalk_K;
  chartInstance->chartInfo.mdlStart = mdlStart_c20_DemoWalk_K;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c20_DemoWalk_K;
...
void c20_DemoWalk_K_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c20_DemoWalk_K(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c20_DemoWalk_K(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c20_DemoWalk_K(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c20_DemoWalk_K_method_dispatcher.\n"
