#ifndef __c5_DemoWalk_K_h__
#define __c5_DemoWalk_K_h__
...
/* Type Definitions */
#ifndef typedef_SFc5_DemoWalk_KInstanceStruct
#define typedef_SFc5_DemoWalk_KInstanceStruct
...
typedef struct {
  ...
  uint8_T c5_is_active_c5_DemoWalk_K;
...
#endif                                 /*typedef_SFc5_DemoWalk_KInstanceStruct*/
...
extern const mxArray *sf_c5_DemoWalk_K_get_eml_resolved_functions_info(void);
extern void sf_exported_auto_activate_c5_DemoWalk_K_secs(SimStruct *c5_S);
...
extern void sf_exported_auto_resetTemporalCounter_c5_DemoWalk_K_secs(SimStruct
  *c5_S);
extern void sf_exported_auto_deactivate_c5_DemoWalk_K_secs(SimStruct *c5_S);
extern boolean_T sf_exported_auto_isStablec5_DemoWalk_K(SimStruct *c5_S);
extern void sf_exported_auto_duringc5_DemoWalk_K(SimStruct *c5_S);
extern void sf_exported_auto_enterc5_DemoWalk_K(SimStruct *c5_S);
extern void sf_exported_auto_exitc5_DemoWalk_K(SimStruct *c5_S);
extern void sf_exported_auto_gatewayc5_DemoWalk_K(SimStruct *c5_S);
extern void sf_exported_auto_enablec5_DemoWalk_K(SimStruct *c5_S);
extern void sf_exported_auto_disablec5_DemoWalk_K(SimStruct *c5_S);
extern void sf_exported_auto_stepBuffersc5_DemoWalk_K(SimStruct *c5_S);
extern void sf_exported_auto_initBuffersc5_DemoWalk_K(SimStruct *c5_S);
extern void sf_exported_auto_activate_callc5_DemoWalk_K(SimStruct *c5_S);
extern void sf_exported_auto_increment_call_counterc5_DemoWalk_K(SimStruct *c5_S);
extern void sf_exported_auto_reset_call_counterc5_DemoWalk_K(SimStruct *c5_S);
extern void sf_exported_auto_deactivate_callc5_DemoWalk_K(SimStruct *c5_S);
extern void sf_exported_auto_initc5_DemoWalk_K(SimStruct *c5_S);
extern const mxArray *sf_exported_auto_getSimstatec5_DemoWalk_K(SimStruct *c5_S);
extern const mxArray *sf_internal_get_sim_state_c5_DemoWalk_K(SimStruct *c5_S);
extern void sf_exported_auto_setSimstatec5_DemoWalk_K(SimStruct *c5_S, const
  mxArray *c5_in);
extern void sf_internal_set_sim_state_c5_DemoWalk_K(SimStruct *c5_S, const
  mxArray *c5_in);
extern void sf_exported_auto_check_state_inconsistency_c5_DemoWalk_K(SimStruct
  *c5_S);
extern void sf_exported_user_c5_DemoWalk_K_handPoseSBTable(SimStruct *c5_S,
  real_T c5_sbmID, real_T c5_poseSBM[256]);
extern void sf_exported_user_c5_DemoWalk_K_idlePoseBradTable(SimStruct *c5_S,
  real_T c5_bmlID, real_T *c5_p, real_T c5_poseBML[256]);
extern void sf_exported_user_c5_DemoWalk_K_initialPoseTable(SimStruct *c5_S,
  real_T c5_bmlID, real_T *c5_p, real_T c5_poseBML[256]);
extern void sf_exported_user_c5_DemoWalk_K_insertQueue(SimStruct *c5_S, real_T
  c5_bmls[1280], real_T c5_mBML[256], real_T c5_newBmls[1280]);
extern void sf_exported_user_c5_DemoWalk_K_insertQueueLow(SimStruct *c5_S,
  real_T c5_bmls[1280], real_T c5_myBML[256], real_T c5_newBmls[1280]);
extern void sf_exported_user_c5_DemoWalk_K_paperPoseBradTable(SimStruct *c5_S,
  real_T c5_bmlID, real_T *c5_p, real_T c5_poseBML[256]);
extern void sf_exported_user_c5_DemoWalk_K_rockPoseTable(SimStruct *c5_S, real_T
  c5_bmlID, real_T *c5_p, real_T c5_poseBML[256]);
extern void sf_exported_user_c5_DemoWalk_K_scissorsPoseBradTable(SimStruct *c5_S,
  real_T c5_bmlID, real_T *c5_p, real_T c5_poseBML[256]);
extern void sf_exported_user_c5_DemoWalk_K_sendSBM(SimStruct *c5_S, real_T
  c5_arg[256]);

/* Function Definitions */
extern void sf_c5_DemoWalk_K_get_check_sum(mxArray *plhs[]);
extern void c5_DemoWalk_K_method_dispatcher(SimStruct *S, int_T method, void
  *data);
