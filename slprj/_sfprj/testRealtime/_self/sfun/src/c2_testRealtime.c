...
static void initialize_c2_testRealtime(SFc2_testRealtimeInstanceStruct
  *chartInstance);
static void initialize_params_c2_testRealtime(SFc2_testRealtimeInstanceStruct
  *chartInstance);
static void enable_c2_testRealtime(SFc2_testRealtimeInstanceStruct
  *chartInstance);
static void disable_c2_testRealtime(SFc2_testRealtimeInstanceStruct
  *chartInstance);
static void c2_update_debugger_state_c2_testRealtime
  (SFc2_testRealtimeInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_testRealtime
  (SFc2_testRealtimeInstanceStruct *chartInstance);
static void set_sim_state_c2_testRealtime(SFc2_testRealtimeInstanceStruct
  *chartInstance, const mxArray *c2_st);
static void finalize_c2_testRealtime(SFc2_testRealtimeInstanceStruct
  *chartInstance);
static void sf_gateway_c2_testRealtime(SFc2_testRealtimeInstanceStruct
  *chartInstance);
static void initSimStructsc2_testRealtime(SFc2_testRealtimeInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber, uint32_T c2_instanceNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static real_T c2_emlrt_marshallIn(SFc2_testRealtimeInstanceStruct *chartInstance,
...
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_b_emlrt_marshallIn(SFc2_testRealtimeInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_c_emlrt_marshallIn(SFc2_testRealtimeInstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_testRealtime, const char_T
  *c2_identifier);
static uint8_T c2_d_emlrt_marshallIn(SFc2_testRealtimeInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void init_dsm_address_info(SFc2_testRealtimeInstanceStruct *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_testRealtime = 0U;
}
  ...
  (SFc2_testRealtimeInstanceStruct *chartInstance)
{
  ...
  c2_hoistedGlobal = chartInstance->c2_is_active_c2_testRealtime;
  ...
  *chartInstance, const mxArray *c2_st)
{
  ...
  chartInstance->c2_is_active_c2_testRealtime = c2_c_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 0)),
     "is_active_c2_testRealtime");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_testRealtime(chartInstance);
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_testRealtimeInstanceStruct *chartInstance;
  chartInstance = (SFc2_testRealtimeInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c2_testRealtime_get_eml_resolved_functions_info(void)
{
  ...
  *c2_identifier)
{
  ...
  c2_y = c2_d_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_testRealtime), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_testRealtime);
  return c2_y;
}
...
void sf_c2_testRealtime_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c2_testRealtime_get_autoinheritance_info(void)
{
...
mxArray *sf_c2_testRealtime_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_testRealtime_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c2_testRealtime(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S'type','srcId','name','auxInfo'{{M[8],M[0],T\"is_active_c2_testRealtime\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 1, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_testRealtime_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc2_testRealtimeInstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c2_testRealtime(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_testRealtimeInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_testRealtime((SFc2_testRealtimeInstanceStruct*)
    chartInstanceVar);
  initialize_c2_testRealtime((SFc2_testRealtimeInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_testRealtime(void *chartInstanceVar)
{
  enable_c2_testRealtime((SFc2_testRealtimeInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_testRealtime(void *chartInstanceVar)
{
  disable_c2_testRealtime((SFc2_testRealtimeInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_testRealtime(void *chartInstanceVar)
{
  sf_gateway_c2_testRealtime((SFc2_testRealtimeInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_testRealtime(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_testRealtime
    ((SFc2_testRealtimeInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_testRealtime();/* state var info */
...
extern void sf_internal_set_sim_state_c2_testRealtime(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c2_testRealtime();/* state var info */
  ...
  set_sim_state_c2_testRealtime((SFc2_testRealtimeInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c2_testRealtime(SimStruct* S)
{
  return sf_internal_get_sim_state_c2_testRealtime(S);
}

static void sf_opaque_set_sim_state_c2_testRealtime(SimStruct* S, const mxArray *
  st)
{
  sf_internal_set_sim_state_c2_testRealtime(S, st);
}

static void sf_opaque_terminate_c2_testRealtime(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_testRealtimeInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c2_testRealtime((SFc2_testRealtimeInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc2_testRealtime((SFc2_testRealtimeInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_testRealtime(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_testRealtime(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c2_testRealtime(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_testRealtime(SimStruct *S)
{
  SFc2_testRealtimeInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc2_testRealtimeInstanceStruct *)utMalloc(sizeof
    (SFc2_testRealtimeInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_testRealtimeInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c2_testRealtime;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_testRealtime;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c2_testRealtime;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_testRealtime;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c2_testRealtime;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c2_testRealtime;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c2_testRealtime;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_testRealtime;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_testRealtime;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_testRealtime;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c2_testRealtime;
...
void c2_testRealtime_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_testRealtime(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_testRealtime(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_testRealtime(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_testRealtime_method_dispatcher.\n"
