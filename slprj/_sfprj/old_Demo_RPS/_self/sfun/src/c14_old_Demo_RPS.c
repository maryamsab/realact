...
static const char * c14_debug_family_names[8] = { "randTrigger", "nargin",
  "nargout", "userInvade", "interactionState", "randa", "a_trig", "a_trigW" };

/* Function Declarations */
static void initialize_c14_old_Demo_RPS(SFc14_old_Demo_RPSInstanceStruct
  *chartInstance);
static void initialize_params_c14_old_Demo_RPS(SFc14_old_Demo_RPSInstanceStruct *
  chartInstance);
static void enable_c14_old_Demo_RPS(SFc14_old_Demo_RPSInstanceStruct
  *chartInstance);
static void disable_c14_old_Demo_RPS(SFc14_old_Demo_RPSInstanceStruct
  *chartInstance);
static void c14_update_debugger_state_c14_old_Demo_RPS
  (SFc14_old_Demo_RPSInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c14_old_Demo_RPS
  (SFc14_old_Demo_RPSInstanceStruct *chartInstance);
static void set_sim_state_c14_old_Demo_RPS(SFc14_old_Demo_RPSInstanceStruct
  *chartInstance, const mxArray *c14_st);
static void finalize_c14_old_Demo_RPS(SFc14_old_Demo_RPSInstanceStruct
  *chartInstance);
static void sf_gateway_c14_old_Demo_RPS(SFc14_old_Demo_RPSInstanceStruct
  *chartInstance);
static void initSimStructsc14_old_Demo_RPS(SFc14_old_Demo_RPSInstanceStruct
  *chartInstance);
...
static const mxArray *c14_sf_marshallOut(void *chartInstanceVoid, void
  *c14_inData);
static real_T c14_emlrt_marshallIn(SFc14_old_Demo_RPSInstanceStruct
  *chartInstance, const mxArray *c14_a_trigW, const char_T *c14_identifier);
static real_T c14_b_emlrt_marshallIn(SFc14_old_Demo_RPSInstanceStruct
...
static const mxArray *c14_b_sf_marshallOut(void *chartInstanceVoid, void
  *c14_inData);
static int32_T c14_c_emlrt_marshallIn(SFc14_old_Demo_RPSInstanceStruct
  *chartInstance, const mxArray *c14_u, const emlrtMsgIdentifier *c14_parentId);
static void c14_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c14_mxArrayInData, const char_T *c14_varName, void *c14_outData);
static uint8_T c14_d_emlrt_marshallIn(SFc14_old_Demo_RPSInstanceStruct
  *chartInstance, const mxArray *c14_b_is_active_c14_old_Demo_RPS, const char_T *
  c14_identifier);
static uint8_T c14_e_emlrt_marshallIn(SFc14_old_Demo_RPSInstanceStruct
  *chartInstance, const mxArray *c14_u, const emlrtMsgIdentifier *c14_parentId);
static void init_dsm_address_info(SFc14_old_Demo_RPSInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c14_is_active_c14_old_Demo_RPS = 0U;
}
  ...
  (SFc14_old_Demo_RPSInstanceStruct *chartInstance)
{
  ...
  c14_c_hoistedGlobal = chartInstance->c14_is_active_c14_old_Demo_RPS;
  ...
  *chartInstance, const mxArray *c14_st)
{
  ...
  *c14_a_trigW = c14_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c14_u, 1)), "a_trigW");
  chartInstance->c14_is_active_c14_old_Demo_RPS = c14_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c14_u, 2)),
     "is_active_c14_old_Demo_RPS");
  sf_mex_destroy(&c14_u);
  c14_update_debugger_state_c14_old_Demo_RPS(chartInstance);
  ...
  *chartInstance)
{
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c14_a_trig, 6U, c14_sf_marshallOut,
    c14_sf_marshallIn);
  ...
  *c14_inData)
{
  ...
  const mxArray *c14_y = NULL;
  SFc14_old_Demo_RPSInstanceStruct *chartInstance;
  chartInstance = (SFc14_old_Demo_RPSInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c14_old_Demo_RPS_get_eml_resolved_functions_info(void)
{
  ...
  c14_identifier)
{
  ...
  c14_y = c14_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c14_b_is_active_c14_old_Demo_RPS), &c14_thisId);
  sf_mex_destroy(&c14_b_is_active_c14_old_Demo_RPS);
  return c14_y;
}
...
void sf_c14_old_Demo_RPS_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2053655461U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(428999231U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3324283594U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3647224462U);
}

mxArray *sf_c14_old_Demo_RPS_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("wAUFLFK3LLXih92bljPpoH");
...
mxArray *sf_c14_old_Demo_RPS_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c14_old_Demo_RPS_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c14_old_Demo_RPS(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"a_trig\",},{M[1],M[8],T\"a_trigW\",},{M[8],M[0],T\"is_active_c14_old_Demo_RPS\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c14_old_Demo_RPS_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc14_old_Demo_RPSInstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,1467);
        _SFD_CV_INIT_EML_IF(0,1,0,635,670,-1,725);
        _SFD_CV_INIT_EML_IF(0,1,1,730,766,-1,829);
        _SFD_CV_INIT_EML_IF(0,1,2,839,862,-1,944);
        _SFD_CV_INIT_EML_IF(0,1,3,949,972,-1,1055);
        _SFD_CV_INIT_EML_IF(0,1,4,1060,1083,-1,1173);
        _SFD_CV_INIT_EML_IF(0,1,5,1178,1201,-1,1287);
        _SFD_CV_INIT_EML_IF(0,1,6,1397,1414,-1,1467);

        {
          static int condStart[] = { 638, 655 };

          static int condEnd[] = { 651, 669 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,0,637,670,2,0,&(condStart[0]),&(condEnd[0]),
                                3,&(pfixExpr[0]));
        }

        {
          static int condStart[] = { 733, 751 };

          static int condEnd[] = { 747, 765 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,1,732,766,2,2,&(condStart[0]),&(condEnd[0]),
                                3,&(pfixExpr[0]));
        }
...
{
  return "fXo4rSvho3A2pqwItbDCrB";
}

static void sf_opaque_initialize_c14_old_Demo_RPS(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc14_old_Demo_RPSInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c14_old_Demo_RPS((SFc14_old_Demo_RPSInstanceStruct*)
    chartInstanceVar);
  initialize_c14_old_Demo_RPS((SFc14_old_Demo_RPSInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c14_old_Demo_RPS(void *chartInstanceVar)
{
  enable_c14_old_Demo_RPS((SFc14_old_Demo_RPSInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c14_old_Demo_RPS(void *chartInstanceVar)
{
  disable_c14_old_Demo_RPS((SFc14_old_Demo_RPSInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c14_old_Demo_RPS(void *chartInstanceVar)
{
  sf_gateway_c14_old_Demo_RPS((SFc14_old_Demo_RPSInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c14_old_Demo_RPS(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c14_old_Demo_RPS
    ((SFc14_old_Demo_RPSInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c14_old_Demo_RPS();/* state var info */
...
extern void sf_internal_set_sim_state_c14_old_Demo_RPS(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c14_old_Demo_RPS();/* state var info */
  ...
  set_sim_state_c14_old_Demo_RPS((SFc14_old_Demo_RPSInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c14_old_Demo_RPS(SimStruct* S)
{
  return sf_internal_get_sim_state_c14_old_Demo_RPS(S);
}

static void sf_opaque_set_sim_state_c14_old_Demo_RPS(SimStruct* S, const mxArray
  *st)
{
  sf_internal_set_sim_state_c14_old_Demo_RPS(S, st);
}

static void sf_opaque_terminate_c14_old_Demo_RPS(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc14_old_Demo_RPSInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c14_old_Demo_RPS((SFc14_old_Demo_RPSInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc14_old_Demo_RPS((SFc14_old_Demo_RPSInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c14_old_Demo_RPS(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c14_old_Demo_RPS(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(1584703493U));
  ssSetChecksum1(S,(446785059U));
  ssSetChecksum2(S,(1633413548U));
  ssSetChecksum3(S,(1735070665U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c14_old_Demo_RPS(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c14_old_Demo_RPS(SimStruct *S)
{
  SFc14_old_Demo_RPSInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc14_old_Demo_RPSInstanceStruct *)utMalloc(sizeof
    (SFc14_old_Demo_RPSInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc14_old_Demo_RPSInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c14_old_Demo_RPS;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c14_old_Demo_RPS;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c14_old_Demo_RPS;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c14_old_Demo_RPS;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c14_old_Demo_RPS;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c14_old_Demo_RPS;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c14_old_Demo_RPS;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c14_old_Demo_RPS;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c14_old_Demo_RPS;
  chartInstance->chartInfo.mdlStart = mdlStart_c14_old_Demo_RPS;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c14_old_Demo_RPS;
...
void c14_old_Demo_RPS_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c14_old_Demo_RPS(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c14_old_Demo_RPS(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c14_old_Demo_RPS(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c14_old_Demo_RPS_method_dispatcher.\n"
