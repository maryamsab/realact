...
static const char * c13_debug_family_names[10] = { "randTrigger", "nargin",
  "nargout", "randv", "smile", "wave", "win", "invade", "v_trig", "v_trigW" };

/* Function Declarations */
static void initialize_c13_old_Demo_RPS(SFc13_old_Demo_RPSInstanceStruct
  *chartInstance);
static void initialize_params_c13_old_Demo_RPS(SFc13_old_Demo_RPSInstanceStruct *
  chartInstance);
static void enable_c13_old_Demo_RPS(SFc13_old_Demo_RPSInstanceStruct
  *chartInstance);
static void disable_c13_old_Demo_RPS(SFc13_old_Demo_RPSInstanceStruct
  *chartInstance);
static void c13_update_debugger_state_c13_old_Demo_RPS
  (SFc13_old_Demo_RPSInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c13_old_Demo_RPS
  (SFc13_old_Demo_RPSInstanceStruct *chartInstance);
static void set_sim_state_c13_old_Demo_RPS(SFc13_old_Demo_RPSInstanceStruct
  *chartInstance, const mxArray *c13_st);
static void finalize_c13_old_Demo_RPS(SFc13_old_Demo_RPSInstanceStruct
  *chartInstance);
static void sf_gateway_c13_old_Demo_RPS(SFc13_old_Demo_RPSInstanceStruct
  *chartInstance);
static void initSimStructsc13_old_Demo_RPS(SFc13_old_Demo_RPSInstanceStruct
  *chartInstance);
...
static const mxArray *c13_sf_marshallOut(void *chartInstanceVoid, void
  *c13_inData);
static real_T c13_emlrt_marshallIn(SFc13_old_Demo_RPSInstanceStruct
  *chartInstance, const mxArray *c13_v_trigW, const char_T *c13_identifier);
static real_T c13_b_emlrt_marshallIn(SFc13_old_Demo_RPSInstanceStruct
...
static const mxArray *c13_b_sf_marshallOut(void *chartInstanceVoid, void
  *c13_inData);
static int32_T c13_c_emlrt_marshallIn(SFc13_old_Demo_RPSInstanceStruct
  *chartInstance, const mxArray *c13_u, const emlrtMsgIdentifier *c13_parentId);
static void c13_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c13_mxArrayInData, const char_T *c13_varName, void *c13_outData);
static uint8_T c13_d_emlrt_marshallIn(SFc13_old_Demo_RPSInstanceStruct
  *chartInstance, const mxArray *c13_b_is_active_c13_old_Demo_RPS, const char_T *
  c13_identifier);
static uint8_T c13_e_emlrt_marshallIn(SFc13_old_Demo_RPSInstanceStruct
  *chartInstance, const mxArray *c13_u, const emlrtMsgIdentifier *c13_parentId);
static void init_dsm_address_info(SFc13_old_Demo_RPSInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c13_is_active_c13_old_Demo_RPS = 0U;
}
  ...
  (SFc13_old_Demo_RPSInstanceStruct *chartInstance)
{
  ...
  c13_c_hoistedGlobal = chartInstance->c13_is_active_c13_old_Demo_RPS;
  ...
  *chartInstance, const mxArray *c13_st)
{
  ...
  *c13_v_trigW = c13_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c13_u, 1)), "v_trigW");
  chartInstance->c13_is_active_c13_old_Demo_RPS = c13_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c13_u, 2)),
     "is_active_c13_old_Demo_RPS");
  sf_mex_destroy(&c13_u);
  c13_update_debugger_state_c13_old_Demo_RPS(chartInstance);
  ...
  *chartInstance)
{
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c13_v_trig, 8U, c13_sf_marshallOut,
    c13_sf_marshallIn);
  ...
  *c13_inData)
{
  ...
  const mxArray *c13_y = NULL;
  SFc13_old_Demo_RPSInstanceStruct *chartInstance;
  chartInstance = (SFc13_old_Demo_RPSInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c13_old_Demo_RPS_get_eml_resolved_functions_info(void)
{
  ...
  c13_identifier)
{
  ...
  c13_y = c13_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c13_b_is_active_c13_old_Demo_RPS), &c13_thisId);
  sf_mex_destroy(&c13_b_is_active_c13_old_Demo_RPS);
  return c13_y;
}
...
void sf_c13_old_Demo_RPS_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(797899436U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1118985446U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1750274106U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2206931722U);
}

mxArray *sf_c13_old_Demo_RPS_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("8181FjyUUo3zSQKb5PdMuD");
...
mxArray *sf_c13_old_Demo_RPS_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c13_old_Demo_RPS_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c13_old_Demo_RPS(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"v_trig\",},{M[1],M[11],T\"v_trigW\",},{M[8],M[0],T\"is_active_c13_old_Demo_RPS\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c13_old_Demo_RPS_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc13_old_Demo_RPSInstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,1079);
        _SFD_CV_INIT_EML_IF(0,1,0,444,479,-1,534);
        _SFD_CV_INIT_EML_IF(0,1,1,539,575,-1,636);
        _SFD_CV_INIT_EML_IF(0,1,2,646,656,740,754);
        _SFD_CV_INIT_EML_IF(0,1,3,740,754,-1,754);
        _SFD_CV_INIT_EML_IF(0,1,4,858,870,-1,925);
        _SFD_CV_INIT_EML_IF(0,1,5,931,942,-1,997);
        _SFD_CV_INIT_EML_IF(0,1,6,1003,1016,-1,1077);

        {
          static int condStart[] = { 447, 464 };

          static int condEnd[] = { 460, 478 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,0,446,479,2,0,&(condStart[0]),&(condEnd[0]),
                                3,&(pfixExpr[0]));
        }
...
{
  return "sGp0viLRcTFEyI7qazf3zD";
}

static void sf_opaque_initialize_c13_old_Demo_RPS(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc13_old_Demo_RPSInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c13_old_Demo_RPS((SFc13_old_Demo_RPSInstanceStruct*)
    chartInstanceVar);
  initialize_c13_old_Demo_RPS((SFc13_old_Demo_RPSInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c13_old_Demo_RPS(void *chartInstanceVar)
{
  enable_c13_old_Demo_RPS((SFc13_old_Demo_RPSInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c13_old_Demo_RPS(void *chartInstanceVar)
{
  disable_c13_old_Demo_RPS((SFc13_old_Demo_RPSInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c13_old_Demo_RPS(void *chartInstanceVar)
{
  sf_gateway_c13_old_Demo_RPS((SFc13_old_Demo_RPSInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c13_old_Demo_RPS(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c13_old_Demo_RPS
    ((SFc13_old_Demo_RPSInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c13_old_Demo_RPS();/* state var info */
...
extern void sf_internal_set_sim_state_c13_old_Demo_RPS(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c13_old_Demo_RPS();/* state var info */
  ...
  set_sim_state_c13_old_Demo_RPS((SFc13_old_Demo_RPSInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c13_old_Demo_RPS(SimStruct* S)
{
  return sf_internal_get_sim_state_c13_old_Demo_RPS(S);
}

static void sf_opaque_set_sim_state_c13_old_Demo_RPS(SimStruct* S, const mxArray
  *st)
{
  sf_internal_set_sim_state_c13_old_Demo_RPS(S, st);
}

static void sf_opaque_terminate_c13_old_Demo_RPS(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc13_old_Demo_RPSInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c13_old_Demo_RPS((SFc13_old_Demo_RPSInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc13_old_Demo_RPS((SFc13_old_Demo_RPSInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c13_old_Demo_RPS(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c13_old_Demo_RPS(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(473584684U));
  ssSetChecksum1(S,(600005654U));
  ssSetChecksum2(S,(131456899U));
  ssSetChecksum3(S,(2034084013U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c13_old_Demo_RPS(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c13_old_Demo_RPS(SimStruct *S)
{
  SFc13_old_Demo_RPSInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc13_old_Demo_RPSInstanceStruct *)utMalloc(sizeof
    (SFc13_old_Demo_RPSInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc13_old_Demo_RPSInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c13_old_Demo_RPS;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c13_old_Demo_RPS;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c13_old_Demo_RPS;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c13_old_Demo_RPS;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c13_old_Demo_RPS;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c13_old_Demo_RPS;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c13_old_Demo_RPS;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c13_old_Demo_RPS;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c13_old_Demo_RPS;
  chartInstance->chartInfo.mdlStart = mdlStart_c13_old_Demo_RPS;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c13_old_Demo_RPS;
...
void c13_old_Demo_RPS_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c13_old_Demo_RPS(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c13_old_Demo_RPS(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c13_old_Demo_RPS(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c13_old_Demo_RPS_method_dispatcher.\n"
