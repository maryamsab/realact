#ifndef __c44_Demo_Kinect_h__
#define __c44_Demo_Kinect_h__
...
/* Type Definitions */
#ifndef typedef_SFc44_Demo_KinectInstanceStruct
#define typedef_SFc44_Demo_KinectInstanceStruct
...
typedef struct {
  ...
  uint8_T c44_is_active_c44_Demo_Kinect;
  uint8_T c44_is_c44_Demo_Kinect;
...
#endif                                 /*typedef_SFc44_Demo_KinectInstanceStruct*/
...
extern const mxArray *sf_c44_Demo_Kinect_get_eml_resolved_functions_info(void);
extern boolean_T sf_exported_auto_isStablec44_Demo_Kinect(SimStruct *c44_S);
extern void sf_exported_auto_duringc44_Demo_Kinect(SimStruct *c44_S);
extern void sf_exported_auto_enterc44_Demo_Kinect(SimStruct *c44_S);
extern void sf_exported_auto_enablec46_lib_affectiveChar_behavior(SimStruct
  *c44_S);
extern void sf_exported_auto_exitc44_Demo_Kinect(SimStruct *c44_S);
extern void sf_exported_auto_disablec46_lib_affectiveChar_behavior(SimStruct
  *c44_S);
extern void sf_exported_auto_gatewayc44_Demo_Kinect(SimStruct *c44_S);
extern void sf_exported_auto_gatewayc46_lib_affectiveChar_behavior(SimStruct
  *c44_S);
extern void sf_exported_auto_enablec44_Demo_Kinect(SimStruct *c44_S);
extern void sf_exported_auto_enablec46_lib_affectiveChar_behavior(SimStruct
  *c44_S);
extern void sf_exported_auto_disablec44_Demo_Kinect(SimStruct *c44_S);
extern void sf_exported_auto_disablec46_lib_affectiveChar_behavior(SimStruct
  *c44_S);
extern void sf_exported_auto_stepBuffersc44_Demo_Kinect(SimStruct *c44_S);
extern void sf_exported_auto_stepBuffersc46_lib_affectiveChar_behavior(SimStruct
  *c44_S);
extern void sf_exported_auto_initBuffersc44_Demo_Kinect(SimStruct *c44_S);
extern void sf_exported_auto_initBuffersc46_lib_affectiveChar_behavior(SimStruct
  *c44_S);
extern void sf_exported_auto_activate_callc44_Demo_Kinect(SimStruct *c44_S);
extern void sf_exported_auto_activate_callc46_lib_affectiveChar_behavior
  (SimStruct *c44_S);
extern void sf_exported_auto_increment_call_counterc44_Demo_Kinect(SimStruct
  *c44_S);
extern void
  sf_exported_auto_increment_call_counterc46_lib_affectiveChar_behavior
  (SimStruct *c44_S);
extern void sf_exported_auto_reset_call_counterc44_Demo_Kinect(SimStruct *c44_S);
extern void sf_exported_auto_reset_call_counterc46_lib_affectiveChar_behavior
  (SimStruct *c44_S);
extern void sf_exported_auto_deactivate_callc44_Demo_Kinect(SimStruct *c44_S);
extern void sf_exported_auto_deactivate_callc46_lib_affectiveChar_behavior
  (SimStruct *c44_S);
extern void sf_exported_auto_initc44_Demo_Kinect(SimStruct *c44_S);
extern const mxArray *sf_exported_auto_getSimstatec44_Demo_Kinect(SimStruct
  *c44_S);
extern const mxArray *sf_internal_get_sim_state_c44_Demo_Kinect(SimStruct *c44_S);
extern void sf_exported_auto_setSimstatec44_Demo_Kinect(SimStruct *c44_S, const
  mxArray *c44_in);
extern void sf_internal_set_sim_state_c44_Demo_Kinect(SimStruct *c44_S, const
  mxArray *c44_in);
...
extern void c44_Demo_Kinect_method_dispatcher(SimStruct *S, int_T method, void
  *data);
