...
static void initialize_c53_Expriment_All(SFc53_Expriment_AllInstanceStruct
  *chartInstance);
static void initialize_params_c53_Expriment_All
  (SFc53_Expriment_AllInstanceStruct *chartInstance);
static void enable_c53_Expriment_All(SFc53_Expriment_AllInstanceStruct
  *chartInstance);
static void disable_c53_Expriment_All(SFc53_Expriment_AllInstanceStruct
  *chartInstance);
static void c53_update_debugger_state_c53_Expriment_All
  (SFc53_Expriment_AllInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c53_Expriment_All
  (SFc53_Expriment_AllInstanceStruct *chartInstance);
static void set_sim_state_c53_Expriment_All(SFc53_Expriment_AllInstanceStruct
  *chartInstance, const mxArray *c53_st);
static void finalize_c53_Expriment_All(SFc53_Expriment_AllInstanceStruct
  *chartInstance);
static void sf_gateway_c53_Expriment_All(SFc53_Expriment_AllInstanceStruct
  *chartInstance);
static void initSimStructsc53_Expriment_All(SFc53_Expriment_AllInstanceStruct
  *chartInstance);
...
static const mxArray *c53_sf_marshallOut(void *chartInstanceVoid, void
  *c53_inData);
static real_T c53_emlrt_marshallIn(SFc53_Expriment_AllInstanceStruct
  *chartInstance, const mxArray *c53_v2, const char_T *c53_identifier);
static real_T c53_b_emlrt_marshallIn(SFc53_Expriment_AllInstanceStruct
...
static const mxArray *c53_b_sf_marshallOut(void *chartInstanceVoid, void
  *c53_inData);
static boolean_T c53_c_emlrt_marshallIn(SFc53_Expriment_AllInstanceStruct
  *chartInstance, const mxArray *c53_u, const emlrtMsgIdentifier *c53_parentId);
...
static const mxArray *c53_c_sf_marshallOut(void *chartInstanceVoid, void
  *c53_inData);
static int32_T c53_d_emlrt_marshallIn(SFc53_Expriment_AllInstanceStruct
  *chartInstance, const mxArray *c53_u, const emlrtMsgIdentifier *c53_parentId);
static void c53_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c53_mxArrayInData, const char_T *c53_varName, void *c53_outData);
static uint8_T c53_e_emlrt_marshallIn(SFc53_Expriment_AllInstanceStruct
  *chartInstance, const mxArray *c53_b_is_active_c53_Expriment_All, const char_T
  *c53_identifier);
static uint8_T c53_f_emlrt_marshallIn(SFc53_Expriment_AllInstanceStruct
  *chartInstance, const mxArray *c53_u, const emlrtMsgIdentifier *c53_parentId);
static void init_dsm_address_info(SFc53_Expriment_AllInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c53_is_active_c53_Expriment_All = 0U;
}
  ...
  (SFc53_Expriment_AllInstanceStruct *chartInstance)
{
  ...
  c53_b_hoistedGlobal = chartInstance->c53_is_active_c53_Expriment_All;
  ...
  *chartInstance, const mxArray *c53_st)
{
  ...
  *c53_v2 = c53_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c53_u,
    0)), "v2");
  chartInstance->c53_is_active_c53_Expriment_All = c53_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c53_u, 1)),
     "is_active_c53_Expriment_All");
  sf_mex_destroy(&c53_u);
  c53_update_debugger_state_c53_Expriment_All(chartInstance);
  ...
  *c53_inData)
{
  ...
  const mxArray *c53_y = NULL;
  SFc53_Expriment_AllInstanceStruct *chartInstance;
  chartInstance = (SFc53_Expriment_AllInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c53_Expriment_All_get_eml_resolved_functions_info(void)
{
  ...
  *c53_identifier)
{
  ...
  c53_y = c53_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c53_b_is_active_c53_Expriment_All), &c53_thisId);
  sf_mex_destroy(&c53_b_is_active_c53_Expriment_All);
  return c53_y;
}
...
void sf_c53_Expriment_All_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c53_Expriment_All_get_autoinheritance_info(void)
{
...
mxArray *sf_c53_Expriment_All_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c53_Expriment_All_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c53_Expriment_All(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[4],T\"v2\",},{M[8],M[0],T\"is_active_c53_Expriment_All\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c53_Expriment_All_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc53_Expriment_AllInstanceStruct *)
...
static void sf_opaque_initialize_c53_Expriment_All(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc53_Expriment_AllInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c53_Expriment_All((SFc53_Expriment_AllInstanceStruct*)
    chartInstanceVar);
  initialize_c53_Expriment_All((SFc53_Expriment_AllInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c53_Expriment_All(void *chartInstanceVar)
{
  enable_c53_Expriment_All((SFc53_Expriment_AllInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c53_Expriment_All(void *chartInstanceVar)
{
  disable_c53_Expriment_All((SFc53_Expriment_AllInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c53_Expriment_All(void *chartInstanceVar)
{
  sf_gateway_c53_Expriment_All((SFc53_Expriment_AllInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c53_Expriment_All(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c53_Expriment_All
    ((SFc53_Expriment_AllInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c53_Expriment_All();/* state var info */
...
extern void sf_internal_set_sim_state_c53_Expriment_All(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c53_Expriment_All();/* state var info */
  ...
  set_sim_state_c53_Expriment_All((SFc53_Expriment_AllInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c53_Expriment_All(SimStruct* S)
{
  return sf_internal_get_sim_state_c53_Expriment_All(S);
}

static void sf_opaque_set_sim_state_c53_Expriment_All(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c53_Expriment_All(S, st);
}

static void sf_opaque_terminate_c53_Expriment_All(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc53_Expriment_AllInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c53_Expriment_All((SFc53_Expriment_AllInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc53_Expriment_All((SFc53_Expriment_AllInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c53_Expriment_All(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c53_Expriment_All(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c53_Expriment_All(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c53_Expriment_All(SimStruct *S)
{
  SFc53_Expriment_AllInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc53_Expriment_AllInstanceStruct *)utMalloc(sizeof
    (SFc53_Expriment_AllInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc53_Expriment_AllInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c53_Expriment_All;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c53_Expriment_All;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c53_Expriment_All;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c53_Expriment_All;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c53_Expriment_All;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c53_Expriment_All;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c53_Expriment_All;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c53_Expriment_All;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c53_Expriment_All;
  chartInstance->chartInfo.mdlStart = mdlStart_c53_Expriment_All;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c53_Expriment_All;
...
void c53_Expriment_All_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c53_Expriment_All(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c53_Expriment_All(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c53_Expriment_All(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c53_Expriment_All_method_dispatcher.\n"
