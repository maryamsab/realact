...
static void initialize_c58_Expriment_All(SFc58_Expriment_AllInstanceStruct
  *chartInstance);
static void initialize_params_c58_Expriment_All
  (SFc58_Expriment_AllInstanceStruct *chartInstance);
static void enable_c58_Expriment_All(SFc58_Expriment_AllInstanceStruct
  *chartInstance);
static void disable_c58_Expriment_All(SFc58_Expriment_AllInstanceStruct
  *chartInstance);
static void c58_update_debugger_state_c58_Expriment_All
  (SFc58_Expriment_AllInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c58_Expriment_All
  (SFc58_Expriment_AllInstanceStruct *chartInstance);
static void set_sim_state_c58_Expriment_All(SFc58_Expriment_AllInstanceStruct
  *chartInstance, const mxArray *c58_st);
static void finalize_c58_Expriment_All(SFc58_Expriment_AllInstanceStruct
  *chartInstance);
static void sf_gateway_c58_Expriment_All(SFc58_Expriment_AllInstanceStruct
  *chartInstance);
static void initSimStructsc58_Expriment_All(SFc58_Expriment_AllInstanceStruct
  *chartInstance);
...
static const mxArray *c58_sf_marshallOut(void *chartInstanceVoid, void
  *c58_inData);
static real_T c58_emlrt_marshallIn(SFc58_Expriment_AllInstanceStruct
  *chartInstance, const mxArray *c58_v_trig, const char_T *c58_identifier);
static real_T c58_b_emlrt_marshallIn(SFc58_Expriment_AllInstanceStruct
...
static const mxArray *c58_c_sf_marshallOut(void *chartInstanceVoid, void
  *c58_inData);
static int32_T c58_c_emlrt_marshallIn(SFc58_Expriment_AllInstanceStruct
  *chartInstance, const mxArray *c58_u, const emlrtMsgIdentifier *c58_parentId);
static void c58_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c58_mxArrayInData, const char_T *c58_varName, void *c58_outData);
static uint8_T c58_d_emlrt_marshallIn(SFc58_Expriment_AllInstanceStruct
  *chartInstance, const mxArray *c58_b_is_active_c58_Expriment_All, const char_T
  *c58_identifier);
static uint8_T c58_e_emlrt_marshallIn(SFc58_Expriment_AllInstanceStruct
  *chartInstance, const mxArray *c58_u, const emlrtMsgIdentifier *c58_parentId);
static void init_dsm_address_info(SFc58_Expriment_AllInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c58_is_active_c58_Expriment_All = 0U;
}
  ...
  (SFc58_Expriment_AllInstanceStruct *chartInstance)
{
  ...
  c58_c_hoistedGlobal = chartInstance->c58_is_active_c58_Expriment_All;
  ...
  *chartInstance, const mxArray *c58_st)
{
  ...
  *c58_v_trigW = c58_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c58_u, 1)), "v_trigW");
  chartInstance->c58_is_active_c58_Expriment_All = c58_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c58_u, 2)),
     "is_active_c58_Expriment_All");
  sf_mex_destroy(&c58_u);
  c58_update_debugger_state_c58_Expriment_All(chartInstance);
  ...
  *c58_inData)
{
  ...
  const mxArray *c58_y = NULL;
  SFc58_Expriment_AllInstanceStruct *chartInstance;
  chartInstance = (SFc58_Expriment_AllInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c58_Expriment_All_get_eml_resolved_functions_info(void)
{
  ...
  *c58_identifier)
{
  ...
  c58_y = c58_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c58_b_is_active_c58_Expriment_All), &c58_thisId);
  sf_mex_destroy(&c58_b_is_active_c58_Expriment_All);
  return c58_y;
}
...
void sf_c58_Expriment_All_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c58_Expriment_All_get_autoinheritance_info(void)
{
...
mxArray *sf_c58_Expriment_All_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c58_Expriment_All_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c58_Expriment_All(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[14],T\"v_trig\",},{M[1],M[11],T\"v_trigW\",},{M[8],M[0],T\"is_active_c58_Expriment_All\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c58_Expriment_All_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc58_Expriment_AllInstanceStruct *)
...
static void sf_opaque_initialize_c58_Expriment_All(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc58_Expriment_AllInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c58_Expriment_All((SFc58_Expriment_AllInstanceStruct*)
    chartInstanceVar);
  initialize_c58_Expriment_All((SFc58_Expriment_AllInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c58_Expriment_All(void *chartInstanceVar)
{
  enable_c58_Expriment_All((SFc58_Expriment_AllInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c58_Expriment_All(void *chartInstanceVar)
{
  disable_c58_Expriment_All((SFc58_Expriment_AllInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c58_Expriment_All(void *chartInstanceVar)
{
  sf_gateway_c58_Expriment_All((SFc58_Expriment_AllInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c58_Expriment_All(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c58_Expriment_All
    ((SFc58_Expriment_AllInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c58_Expriment_All();/* state var info */
...
extern void sf_internal_set_sim_state_c58_Expriment_All(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c58_Expriment_All();/* state var info */
  ...
  set_sim_state_c58_Expriment_All((SFc58_Expriment_AllInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c58_Expriment_All(SimStruct* S)
{
  return sf_internal_get_sim_state_c58_Expriment_All(S);
}

static void sf_opaque_set_sim_state_c58_Expriment_All(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c58_Expriment_All(S, st);
}

static void sf_opaque_terminate_c58_Expriment_All(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc58_Expriment_AllInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c58_Expriment_All((SFc58_Expriment_AllInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc58_Expriment_All((SFc58_Expriment_AllInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c58_Expriment_All(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c58_Expriment_All(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c58_Expriment_All(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c58_Expriment_All(SimStruct *S)
{
  SFc58_Expriment_AllInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc58_Expriment_AllInstanceStruct *)utMalloc(sizeof
    (SFc58_Expriment_AllInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc58_Expriment_AllInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c58_Expriment_All;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c58_Expriment_All;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c58_Expriment_All;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c58_Expriment_All;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c58_Expriment_All;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c58_Expriment_All;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c58_Expriment_All;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c58_Expriment_All;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c58_Expriment_All;
  chartInstance->chartInfo.mdlStart = mdlStart_c58_Expriment_All;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c58_Expriment_All;
...
void c58_Expriment_All_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c58_Expriment_All(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c58_Expriment_All(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c58_Expriment_All(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c58_Expriment_All_method_dispatcher.\n"
