...
static void initialize_c16_Expriment_All(SFc16_Expriment_AllInstanceStruct
  *chartInstance);
static void initialize_params_c16_Expriment_All
  (SFc16_Expriment_AllInstanceStruct *chartInstance);
static void enable_c16_Expriment_All(SFc16_Expriment_AllInstanceStruct
  *chartInstance);
static void disable_c16_Expriment_All(SFc16_Expriment_AllInstanceStruct
  *chartInstance);
static void c16_update_debugger_state_c16_Expriment_All
  (SFc16_Expriment_AllInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c16_Expriment_All
  (SFc16_Expriment_AllInstanceStruct *chartInstance);
static void set_sim_state_c16_Expriment_All(SFc16_Expriment_AllInstanceStruct
  *chartInstance, const mxArray *c16_st);
static void finalize_c16_Expriment_All(SFc16_Expriment_AllInstanceStruct
  *chartInstance);
static void sf_gateway_c16_Expriment_All(SFc16_Expriment_AllInstanceStruct
  *chartInstance);
static void initSimStructsc16_Expriment_All(SFc16_Expriment_AllInstanceStruct
  *chartInstance);
static void c16_encStr2Arr(SFc16_Expriment_AllInstanceStruct *chartInstance,
  char_T c16_mystr_data[], int32_T c16_mystr_sizes[2], real_T c16_myarr256[2000]);
...
static void c16_emlrt_marshallIn(SFc16_Expriment_AllInstanceStruct
  *chartInstance, const mxArray *c16_sprintf, const char_T *c16_identifier,
  char_T c16_y_data[], int32_T c16_y_sizes[2]);
static void c16_b_emlrt_marshallIn(SFc16_Expriment_AllInstanceStruct
...
static const mxArray *c16_sf_marshallOut(void *chartInstanceVoid, void
  *c16_inData);
static void c16_c_emlrt_marshallIn(SFc16_Expriment_AllInstanceStruct
  *chartInstance, const mxArray *c16_arrBML, const char_T *c16_identifier,
  real_T c16_y[2000]);
static void c16_d_emlrt_marshallIn(SFc16_Expriment_AllInstanceStruct
  *chartInstance, const mxArray *c16_u, const emlrtMsgIdentifier *c16_parentId,
  real_T c16_y[2000]);
...
static const mxArray *c16_b_sf_marshallOut(void *chartInstanceVoid, void
  *c16_inData);
static real_T c16_e_emlrt_marshallIn(SFc16_Expriment_AllInstanceStruct
  *chartInstance, const mxArray *c16_u, const emlrtMsgIdentifier *c16_parentId);
...
static void c16_f_emlrt_marshallIn(SFc16_Expriment_AllInstanceStruct
  *chartInstance, const mxArray *c16_u, const emlrtMsgIdentifier *c16_parentId,
  char_T c16_y_data[], int32_T c16_y_sizes[2]);
...
static void c16_g_emlrt_marshallIn(SFc16_Expriment_AllInstanceStruct
  *chartInstance, const mxArray *c16_u, const emlrtMsgIdentifier *c16_parentId,
...
static const mxArray *c16_e_sf_marshallOut(void *chartInstanceVoid, void
  *c16_inData);
static int32_T c16_h_emlrt_marshallIn(SFc16_Expriment_AllInstanceStruct
  *chartInstance, const mxArray *c16_u, const emlrtMsgIdentifier *c16_parentId);
static void c16_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c16_mxArrayInData, const char_T *c16_varName, void *c16_outData);
static uint8_T c16_i_emlrt_marshallIn(SFc16_Expriment_AllInstanceStruct
  *chartInstance, const mxArray *c16_b_is_active_c16_Expriment_All, const char_T
  *c16_identifier);
static uint8_T c16_j_emlrt_marshallIn(SFc16_Expriment_AllInstanceStruct
  *chartInstance, const mxArray *c16_u, const emlrtMsgIdentifier *c16_parentId);
static void init_dsm_address_info(SFc16_Expriment_AllInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c16_is_active_c16_Expriment_All = 0U;
}
  ...
  (SFc16_Expriment_AllInstanceStruct *chartInstance)
{
  ...
  real_T (*c16_arrBML)[2000];
  c16_arrBML = (real_T (*)[2000])ssGetOutputPortSignal(chartInstance->S, 1);
  c16_st = NULL;
  c16_st = NULL;
  c16_y = NULL;
  sf_mex_assign(&c16_y, sf_mex_createcellmatrix(2, 1), false);
  for (c16_i0 = 0; c16_i0 < 2000; c16_i0++) {
    c16_u[c16_i0] = (*c16_arrBML)[c16_i0];
  }

  c16_b_y = NULL;
  sf_mex_assign(&c16_b_y, sf_mex_create("y", c16_u, 0, 0U, 1U, 0U, 1, 2000),
                false);
  sf_mex_setcell(c16_y, 0, c16_b_y);
  c16_hoistedGlobal = chartInstance->c16_is_active_c16_Expriment_All;
  ...
  *chartInstance, const mxArray *c16_st)
{
  ...
  c16_c_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c16_u, 0)),
    "arrBML", c16_dv0);
  for (c16_i1 = 0; c16_i1 < 2000; c16_i1++) {
    (*c16_arrBML)[c16_i1] = c16_dv0[c16_i1];
  }

  chartInstance->c16_is_active_c16_Expriment_All = c16_i_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c16_u, 1)),
     "is_active_c16_Expriment_All");
  sf_mex_destroy(&c16_u);
  c16_update_debugger_state_c16_Expriment_All(chartInstance);
  ...
  *chartInstance)
{
  ...
  real_T *c16_h_x;
  real_T *c16_f_y;
  real_T (*c16_b_arrBML)[2000];
  boolean_T guard1 = false;
  boolean_T guard2 = false;
  boolean_T guard3 = false;
  c16_b_arrBML = (real_T (*)[2000])ssGetOutputPortSignal(chartInstance->S, 1);
  ...
  for (c16_i6 = 0; c16_i6 < 2000; c16_i6++) {
    c16_arrBML[c16_i6] = c16_dv2[c16_i6];
  }

  _SFD_EML_CALL(0U, chartInstance->c16_sfEvent, -17);
  _SFD_SYMBOL_SCOPE_POP();
  for (c16_i7 = 0; c16_i7 < 2000; c16_i7++) {
  ...
  for (c16_i8 = 0; c16_i8 < 2000; c16_i8++) {
  ...
  char_T c16_mystr_data[], int32_T c16_mystr_sizes[2], real_T c16_myarr256[2000])
{
  ...
  c16_padsize = 2000.0 - c16_ss;
  _SFD_SCRIPT_CALL(1U, chartInstance->c16_sfEvent, 9);
  for (c16_i10 = 0; c16_i10 < 2000; c16_i10++) {
    c16_tt[c16_i10] = 0.0;
  }
  ...
  if (c16_b2) {
    ...
    c16_i11 = _SFD_EML_ARRAY_BOUNDS_CHECK("tt", (int32_T)c16_ss, 1, 2000, 0, 0);
  }
  ...
  for (c16_i14 = 0; c16_i14 < 2000; c16_i14++) {
  ...
  c16_chartNumber, uint32_T c16_instanceNumber)
{
  ...
  _SFD_SCRIPT_TRANSLATION(c16_chartNumber, c16_instanceNumber, 0U,
    ...
    "C:\\Users\\root180\\Documents\\affective-project\\15-1-2016-Matlab\\countDigits.m"));
  ...
  *c16_inData)
{
  ...
  int32_T c16_i18;
  real_T c16_b_inData[2000];
  int32_T c16_i19;
  real_T c16_u[2000];
  const mxArray *c16_y = NULL;
  SFc16_Expriment_AllInstanceStruct *chartInstance;
  chartInstance = (SFc16_Expriment_AllInstanceStruct *)chartInstanceVoid;
  c16_mxArrayOutData = NULL;
  for (c16_i18 = 0; c16_i18 < 2000; c16_i18++) {
    c16_b_inData[c16_i18] = (*(real_T (*)[2000])c16_inData)[c16_i18];
  }

  for (c16_i19 = 0; c16_i19 < 2000; c16_i19++) {
    c16_u[c16_i19] = c16_b_inData[c16_i19];
  }

  c16_y = NULL;
  sf_mex_assign(&c16_y, sf_mex_create("y", c16_u, 0, 0U, 1U, 0U, 1, 2000), false);
  ...
  real_T c16_y[2000])
{
  ...
  sf_mex_import(c16_parentId, sf_mex_dup(c16_u), c16_dv3, 1, 0, 0U, 1, 0U, 1,
                2000);
  for (c16_i20 = 0; c16_i20 < 2000; c16_i20++) {
  ...
  *c16_mxArrayInData, const char_T *c16_varName, void *c16_outData)
{
  ...
  c16_d_emlrt_marshallIn(chartInstance, sf_mex_dup(c16_arrBML), &c16_thisId,
    c16_y);
  sf_mex_destroy(&c16_arrBML);
  for (c16_i21 = 0; c16_i21 < 2000; c16_i21++) {
    (*(real_T (*)[2000])c16_outData)[c16_i21] = c16_y[c16_i21];
  }
...
const mxArray *sf_c16_Expriment_All_get_eml_resolved_functions_info(void)
{
...
static void c16_info_helper(const mxArray **c16_info)
{
  ...
  sf_mex_addfield(*c16_info, c16_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 7);
  sf_mex_addfield(*c16_info, c16_emlrt_marshallOut(
    "[E]C:/Users/root180/Documents/affective-project/15-1-2016-Matlab/countDigits.m"),
                  "resolved", "resolved", 7);
  ...
  sf_mex_addfield(*c16_info, c16_b_emlrt_marshallOut(1452377975U), "fileTimeLo",
                  "fileTimeLo", 13);
  sf_mex_addfield(*c16_info, c16_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 13);
  sf_mex_addfield(*c16_info, c16_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  *c16_identifier)
{
  ...
  c16_y = c16_j_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c16_b_is_active_c16_Expriment_All), &c16_thisId);
  sf_mex_destroy(&c16_b_is_active_c16_Expriment_All);
  return c16_y;
}
...
void sf_c16_Expriment_All_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2043725013U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1989555150U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(390524187U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1747811439U);
}

mxArray *sf_c16_Expriment_All_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("1ZHcZ9HuksFRgnQ5yLbgsG");
...
mxArray *sf_c16_Expriment_All_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c16_Expriment_All_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c16_Expriment_All(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[14],T\"arrBML\",},{M[8],M[0],T\"is_active_c16_Expriment_All\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c16_Expriment_All_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc16_Expriment_AllInstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,702);
...

        {
          ...
          real_T *c16_y;
          real_T (*c16_arrBML)[2000];
          c16_arrBML = (real_T (*)[2000])ssGetOutputPortSignal(chartInstance->S,
            1);
...
{
  return "950MNstBZl2XTINyLiyxl";
}

static void sf_opaque_initialize_c16_Expriment_All(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc16_Expriment_AllInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c16_Expriment_All((SFc16_Expriment_AllInstanceStruct*)
    chartInstanceVar);
  initialize_c16_Expriment_All((SFc16_Expriment_AllInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c16_Expriment_All(void *chartInstanceVar)
{
  enable_c16_Expriment_All((SFc16_Expriment_AllInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c16_Expriment_All(void *chartInstanceVar)
{
  disable_c16_Expriment_All((SFc16_Expriment_AllInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c16_Expriment_All(void *chartInstanceVar)
{
  sf_gateway_c16_Expriment_All((SFc16_Expriment_AllInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c16_Expriment_All(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c16_Expriment_All
    ((SFc16_Expriment_AllInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c16_Expriment_All();/* state var info */
...
extern void sf_internal_set_sim_state_c16_Expriment_All(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c16_Expriment_All();/* state var info */
  ...
  set_sim_state_c16_Expriment_All((SFc16_Expriment_AllInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c16_Expriment_All(SimStruct* S)
{
  return sf_internal_get_sim_state_c16_Expriment_All(S);
}

static void sf_opaque_set_sim_state_c16_Expriment_All(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c16_Expriment_All(S, st);
}

static void sf_opaque_terminate_c16_Expriment_All(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc16_Expriment_AllInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c16_Expriment_All((SFc16_Expriment_AllInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc16_Expriment_All((SFc16_Expriment_AllInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c16_Expriment_All(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c16_Expriment_All(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(581902205U));
  ssSetChecksum1(S,(2977488564U));
  ssSetChecksum2(S,(240456633U));
  ssSetChecksum3(S,(1957891448U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c16_Expriment_All(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c16_Expriment_All(SimStruct *S)
{
  SFc16_Expriment_AllInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc16_Expriment_AllInstanceStruct *)utMalloc(sizeof
    (SFc16_Expriment_AllInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc16_Expriment_AllInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c16_Expriment_All;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c16_Expriment_All;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c16_Expriment_All;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c16_Expriment_All;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c16_Expriment_All;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c16_Expriment_All;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c16_Expriment_All;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c16_Expriment_All;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c16_Expriment_All;
  chartInstance->chartInfo.mdlStart = mdlStart_c16_Expriment_All;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c16_Expriment_All;
...
void c16_Expriment_All_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c16_Expriment_All(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c16_Expriment_All(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c16_Expriment_All(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c16_Expriment_All_method_dispatcher.\n"
