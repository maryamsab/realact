...
static void initialize_c2_Expriment_All(SFc2_Expriment_AllInstanceStruct
  *chartInstance);
static void initialize_params_c2_Expriment_All(SFc2_Expriment_AllInstanceStruct *
  chartInstance);
static void enable_c2_Expriment_All(SFc2_Expriment_AllInstanceStruct
  *chartInstance);
static void disable_c2_Expriment_All(SFc2_Expriment_AllInstanceStruct
  *chartInstance);
static void c2_update_debugger_state_c2_Expriment_All
  (SFc2_Expriment_AllInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_Expriment_All
  (SFc2_Expriment_AllInstanceStruct *chartInstance);
static void set_sim_state_c2_Expriment_All(SFc2_Expriment_AllInstanceStruct
  *chartInstance, const mxArray *c2_st);
static void finalize_c2_Expriment_All(SFc2_Expriment_AllInstanceStruct
  *chartInstance);
static void sf_gateway_c2_Expriment_All(SFc2_Expriment_AllInstanceStruct
  *chartInstance);
static void initSimStructsc2_Expriment_All(SFc2_Expriment_AllInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber, uint32_T c2_instanceNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static real_T c2_emlrt_marshallIn(SFc2_Expriment_AllInstanceStruct
...
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_b_emlrt_marshallIn(SFc2_Expriment_AllInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_c_emlrt_marshallIn(SFc2_Expriment_AllInstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_Expriment_All, const char_T
  *c2_identifier);
static uint8_T c2_d_emlrt_marshallIn(SFc2_Expriment_AllInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void init_dsm_address_info(SFc2_Expriment_AllInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_Expriment_All = 0U;
}
  ...
  (SFc2_Expriment_AllInstanceStruct *chartInstance)
{
  ...
  c2_hoistedGlobal = chartInstance->c2_is_active_c2_Expriment_All;
  ...
  *chartInstance, const mxArray *c2_st)
{
  ...
  chartInstance->c2_is_active_c2_Expriment_All = c2_c_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 0)),
     "is_active_c2_Expriment_All");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_Expriment_All(chartInstance);
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_Expriment_AllInstanceStruct *chartInstance;
  chartInstance = (SFc2_Expriment_AllInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c2_Expriment_All_get_eml_resolved_functions_info(void)
{
  ...
  *c2_identifier)
{
  ...
  c2_y = c2_d_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_Expriment_All), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_Expriment_All);
  return c2_y;
}
...
void sf_c2_Expriment_All_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c2_Expriment_All_get_autoinheritance_info(void)
{
...
mxArray *sf_c2_Expriment_All_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_Expriment_All_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c2_Expriment_All(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S'type','srcId','name','auxInfo'{{M[8],M[0],T\"is_active_c2_Expriment_All\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 1, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_Expriment_All_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc2_Expriment_AllInstanceStruct *)
...
static void sf_opaque_initialize_c2_Expriment_All(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_Expriment_AllInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_Expriment_All((SFc2_Expriment_AllInstanceStruct*)
    chartInstanceVar);
  initialize_c2_Expriment_All((SFc2_Expriment_AllInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c2_Expriment_All(void *chartInstanceVar)
{
  enable_c2_Expriment_All((SFc2_Expriment_AllInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_Expriment_All(void *chartInstanceVar)
{
  disable_c2_Expriment_All((SFc2_Expriment_AllInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_Expriment_All(void *chartInstanceVar)
{
  sf_gateway_c2_Expriment_All((SFc2_Expriment_AllInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_Expriment_All(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_Expriment_All
    ((SFc2_Expriment_AllInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_Expriment_All();/* state var info */
...
extern void sf_internal_set_sim_state_c2_Expriment_All(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c2_Expriment_All();/* state var info */
  ...
  set_sim_state_c2_Expriment_All((SFc2_Expriment_AllInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c2_Expriment_All(SimStruct* S)
{
  return sf_internal_get_sim_state_c2_Expriment_All(S);
}

static void sf_opaque_set_sim_state_c2_Expriment_All(SimStruct* S, const mxArray
  *st)
{
  sf_internal_set_sim_state_c2_Expriment_All(S, st);
}

static void sf_opaque_terminate_c2_Expriment_All(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_Expriment_AllInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c2_Expriment_All((SFc2_Expriment_AllInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc2_Expriment_All((SFc2_Expriment_AllInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_Expriment_All(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_Expriment_All(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c2_Expriment_All(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_Expriment_All(SimStruct *S)
{
  SFc2_Expriment_AllInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc2_Expriment_AllInstanceStruct *)utMalloc(sizeof
    (SFc2_Expriment_AllInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_Expriment_AllInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c2_Expriment_All;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_Expriment_All;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c2_Expriment_All;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_Expriment_All;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c2_Expriment_All;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_Expriment_All;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_Expriment_All;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_Expriment_All;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_Expriment_All;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_Expriment_All;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c2_Expriment_All;
...
void c2_Expriment_All_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_Expriment_All(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_Expriment_All(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_Expriment_All(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_Expriment_All_method_dispatcher.\n"
