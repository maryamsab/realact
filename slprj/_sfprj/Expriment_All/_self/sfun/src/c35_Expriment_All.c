...
static void initialize_c35_Expriment_All(SFc35_Expriment_AllInstanceStruct
  *chartInstance);
static void initialize_params_c35_Expriment_All
  (SFc35_Expriment_AllInstanceStruct *chartInstance);
static void enable_c35_Expriment_All(SFc35_Expriment_AllInstanceStruct
  *chartInstance);
static void disable_c35_Expriment_All(SFc35_Expriment_AllInstanceStruct
  *chartInstance);
static void c35_update_debugger_state_c35_Expriment_All
  (SFc35_Expriment_AllInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c35_Expriment_All
  (SFc35_Expriment_AllInstanceStruct *chartInstance);
static void set_sim_state_c35_Expriment_All(SFc35_Expriment_AllInstanceStruct
  *chartInstance, const mxArray *c35_st);
static void c35_set_sim_state_side_effects_c35_Expriment_All
  (SFc35_Expriment_AllInstanceStruct *chartInstance);
static void finalize_c35_Expriment_All(SFc35_Expriment_AllInstanceStruct
  *chartInstance);
static void sf_gateway_c35_Expriment_All(SFc35_Expriment_AllInstanceStruct
  *chartInstance);
static void initSimStructsc35_Expriment_All(SFc35_Expriment_AllInstanceStruct
  *chartInstance);
...
static const mxArray *c35_sf_marshallOut(void *chartInstanceVoid, void
  *c35_inData);
static real_T c35_emlrt_marshallIn(SFc35_Expriment_AllInstanceStruct
...
static void c35_sendSBM(SFc35_Expriment_AllInstanceStruct *chartInstance, real_T
  c35_In2[2000]);
static const mxArray *c35_e_sf_marshallOut(void *chartInstanceVoid, void
  *c35_inData);
static int32_T c35_c_emlrt_marshallIn(SFc35_Expriment_AllInstanceStruct
  *chartInstance, const mxArray *c35_u, const emlrtMsgIdentifier *c35_parentId);
...
static const mxArray *c35_f_sf_marshallOut(void *chartInstanceVoid, void
  *c35_inData);
static uint8_T c35_d_emlrt_marshallIn(SFc35_Expriment_AllInstanceStruct
  *chartInstance, const mxArray *c35_b_tp_stateCreatePawn, const char_T
  *c35_identifier);
static uint8_T c35_e_emlrt_marshallIn(SFc35_Expriment_AllInstanceStruct
  *chartInstance, const mxArray *c35_u, const emlrtMsgIdentifier *c35_parentId);
...
static const mxArray *c35_g_sf_marshallOut(void *chartInstanceVoid, void
  *c35_inData);
static void c35_f_emlrt_marshallIn(SFc35_Expriment_AllInstanceStruct
  *chartInstance, const mxArray *c35_u, const emlrtMsgIdentifier *c35_parentId,
  real_T c35_y[2000]);
static void c35_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c35_mxArrayInData, const char_T *c35_varName, void *c35_outData);
static const mxArray *c35_g_emlrt_marshallIn(SFc35_Expriment_AllInstanceStruct
  *chartInstance, const mxArray *c35_b_setSimStateSideEffectsInfo, const char_T *
  c35_identifier);
static const mxArray *c35_h_emlrt_marshallIn(SFc35_Expriment_AllInstanceStruct
  *chartInstance, const mxArray *c35_u, const emlrtMsgIdentifier *c35_parentId);
static void init_dsm_address_info(SFc35_Expriment_AllInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c35_is_active_c35_Expriment_All = 0U;
  chartInstance->c35_is_c35_Expriment_All = c35_IN_NO_ACTIVE_CHILD;
}
  ...
  (SFc35_Expriment_AllInstanceStruct *chartInstance)
{
  ...
  if (chartInstance->c35_is_active_c35_Expriment_All == 1U) {
    _SFD_CC_CALL(CHART_ACTIVE_TAG, 16U, chartInstance->c35_sfEvent);
  }

  if (chartInstance->c35_is_c35_Expriment_All == c35_IN_stateCreatePawn) {
  ...
  (SFc35_Expriment_AllInstanceStruct *chartInstance)
{
  ...
  c35_hoistedGlobal = chartInstance->c35_is_active_c35_Expriment_All;
  c35_u = c35_hoistedGlobal;
  c35_b_y = NULL;
  sf_mex_assign(&c35_b_y, sf_mex_create("y", &c35_u, 3, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c35_y, 0, c35_b_y);
  c35_b_hoistedGlobal = chartInstance->c35_is_c35_Expriment_All;
  ...
  *chartInstance, const mxArray *c35_st)
{
  ...
  chartInstance->c35_is_active_c35_Expriment_All = c35_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c35_u, 0)),
     "is_active_c35_Expriment_All");
  chartInstance->c35_is_c35_Expriment_All = c35_d_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c35_u, 1)), "is_c35_Expriment_All");
  ...
  c35_update_debugger_state_c35_Expriment_All(chartInstance);
...
static void sf_gateway_c35_Expriment_All(SFc35_Expriment_AllInstanceStruct
  *chartInstance)
{
  c35_set_sim_state_side_effects_c35_Expriment_All(chartInstance);
  ...
  if (chartInstance->c35_is_active_c35_Expriment_All == 0U) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 16U, chartInstance->c35_sfEvent);
    chartInstance->c35_is_active_c35_Expriment_All = 1U;
    ...
    chartInstance->c35_is_c35_Expriment_All = c35_IN_stateCreatePawn;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, chartInstance->c35_sfEvent);
    chartInstance->c35_tp_stateCreatePawn = 1U;
  ...
  *c35_inData)
{
  ...
  const mxArray *c35_y = NULL;
  SFc35_Expriment_AllInstanceStruct *chartInstance;
  chartInstance = (SFc35_Expriment_AllInstanceStruct *)chartInstanceVoid;
  ...
  *c35_inData)
{
  ...
  chartInstance = (SFc35_Expriment_AllInstanceStruct *)chartInstanceVoid;
  c35_mxArrayOutData = NULL;
  for (c35_i6 = 0; c35_i6 < 2000; c35_i6++) {
    c35_b_inData[c35_i6] = (*(real_T (*)[2000])c35_inData)[c35_i6];
  }

  for (c35_i7 = 0; c35_i7 < 2000; c35_i7++) {
    c35_u[c35_i7] = c35_b_inData[c35_i7];
  }

  c35_y = NULL;
  sf_mex_assign(&c35_y, sf_mex_create("y", c35_u, 0, 0U, 1U, 0U, 1, 2000), false);
  sf_mex_assign(&c35_mxArrayOutData, c35_y, false);
  return c35_mxArrayOutData;
}
  ...
  *c35_mxArrayInData, const char_T *c35_varName, void *c35_outData)
{
  ...
  for (c35_i9 = 0; c35_i9 < 2000; c35_i9++) {
    (*(real_T (*)[2000])c35_outData)[c35_i9] = c35_y[c35_i9];
  }
...
const mxArray *sf_c35_Expriment_All_get_eml_resolved_functions_info(void)
{
...
static void c35_info_helper(const mxArray **c35_info)
{
  ...
  sf_mex_addfield(*c35_info, c35_emlrt_marshallOut(
    "[E]C:/Users/root180/Documents/affective-project/15-1-2016-Matlab/encStr2Arr.m"),
                  "resolved", "resolved", 0);
  sf_mex_addfield(*c35_info, c35_b_emlrt_marshallOut(1452377975U), "fileTimeLo",
                  "fileTimeLo", 0);
  ...
  c35_In2[2000])
{
  ...
  int32_T c35_i15;
  int32_T c35_i16;
  real_T (*c35_b_In2)[2000];
  c35_b_In2 = (real_T (*)[2000])ssGetOutputPortSignal(chartInstance->S, 1);
  for (c35_i14 = 0; c35_i14 < 2000; c35_i14++) {
  ...
  for (c35_i15 = 0; c35_i15 < 2000; c35_i15++) {
    (*c35_b_In2)[c35_i15] = c35_In2[c35_i15];
  }

  for (c35_i16 = 0; c35_i16 < 2000; c35_i16++) {
  ...
  *c35_inData)
{
  ...
  chartInstance = (SFc35_Expriment_AllInstanceStruct *)chartInstanceVoid;
  c35_mxArrayOutData = NULL;
  for (c35_i18 = 0; c35_i18 < 2000; c35_i18++) {
    c35_b_inData[c35_i18] = (*(real_T (*)[2000])c35_inData)[c35_i18];
  }

  for (c35_i19 = 0; c35_i19 < 2000; c35_i19++) {
    c35_u[c35_i19] = c35_b_inData[c35_i19];
  }

  c35_y = NULL;
  sf_mex_assign(&c35_y, sf_mex_create("y", c35_u, 0, 0U, 1U, 0U, 2, 2000, 1),
                false);
  sf_mex_assign(&c35_mxArrayOutData, c35_y, false);
  return c35_mxArrayOutData;
}
  ...
  real_T c35_y[2000])
{
  ...
  sf_mex_import(c35_parentId, sf_mex_dup(c35_u), c35_dv2, 1, 0, 0U, 1, 0U, 2,
                2000, 1);
  for (c35_i20 = 0; c35_i20 < 2000; c35_i20++) {
  ...
  *c35_mxArrayInData, const char_T *c35_varName, void *c35_outData)
{
  ...
  for (c35_i21 = 0; c35_i21 < 2000; c35_i21++) {
    (*(real_T (*)[2000])c35_outData)[c35_i21] = c35_y[c35_i21];
  }
...
void sf_c35_Expriment_All_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2040173985U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3980197712U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2355502964U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3069338167U);
}

mxArray *sf_c35_Expriment_All_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("FjmZuzFOgeYluwz4gGfy8G");
...
mxArray *sf_c35_Expriment_All_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c35_Expriment_All_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c35_Expriment_All(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[8],M[0],T\"is_active_c35_Expriment_All\",},{M[9],M[0],T\"is_c35_Expriment_All\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c35_Expriment_All_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc35_Expriment_AllInstanceStruct *)
...
{
  return "TTo0JNmBYGlR5M4gHnNlzF";
}

static void sf_opaque_initialize_c35_Expriment_All(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc35_Expriment_AllInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c35_Expriment_All((SFc35_Expriment_AllInstanceStruct*)
    chartInstanceVar);
  initialize_c35_Expriment_All((SFc35_Expriment_AllInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c35_Expriment_All(void *chartInstanceVar)
{
  enable_c35_Expriment_All((SFc35_Expriment_AllInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c35_Expriment_All(void *chartInstanceVar)
{
  disable_c35_Expriment_All((SFc35_Expriment_AllInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c35_Expriment_All(void *chartInstanceVar)
{
  sf_gateway_c35_Expriment_All((SFc35_Expriment_AllInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c35_Expriment_All(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c35_Expriment_All
    ((SFc35_Expriment_AllInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c35_Expriment_All();/* state var info */
...
extern void sf_internal_set_sim_state_c35_Expriment_All(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c35_Expriment_All();/* state var info */
  ...
  set_sim_state_c35_Expriment_All((SFc35_Expriment_AllInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c35_Expriment_All(SimStruct* S)
{
  return sf_internal_get_sim_state_c35_Expriment_All(S);
}

static void sf_opaque_set_sim_state_c35_Expriment_All(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c35_Expriment_All(S, st);
}

static void sf_opaque_terminate_c35_Expriment_All(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc35_Expriment_AllInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c35_Expriment_All((SFc35_Expriment_AllInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc35_Expriment_All((SFc35_Expriment_AllInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c35_Expriment_All(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c35_Expriment_All(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(3736412204U));
  ssSetChecksum1(S,(387102553U));
  ssSetChecksum2(S,(1792473610U));
  ssSetChecksum3(S,(1148977319U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c35_Expriment_All(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c35_Expriment_All(SimStruct *S)
{
  SFc35_Expriment_AllInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc35_Expriment_AllInstanceStruct *)utMalloc(sizeof
    (SFc35_Expriment_AllInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc35_Expriment_AllInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c35_Expriment_All;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c35_Expriment_All;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c35_Expriment_All;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c35_Expriment_All;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c35_Expriment_All;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c35_Expriment_All;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c35_Expriment_All;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c35_Expriment_All;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c35_Expriment_All;
  chartInstance->chartInfo.mdlStart = mdlStart_c35_Expriment_All;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c35_Expriment_All;
...
void c35_Expriment_All_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c35_Expriment_All(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c35_Expriment_All(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c35_Expriment_All(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c35_Expriment_All_method_dispatcher.\n"
