  ...
  if (nrhs>2 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"library")) {
      ...
      if (!strcmp(machineName,"lib_affectiveChar_behavior")) {
        if (nrhs==3) {
          ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3355613497U);
          ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3296598210U);
          ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3366502074U);
          ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3699155700U);
        } else if (nrhs==4) {
  ...
  mxArray * plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 59:
      {
        if (strcmp(aiChksum, "eeB0b7ksol9HMLxji5MC6D") == 0) {
          extern mxArray
  ...
  mxArray * plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 59:
      {
        if (strcmp(tpChksum, "IrnhsWoBZ1WfVu2Hjscw9E") == 0) {
          extern mxArray
...
mxArray* load_lib_affectiveChar_behavior_optimization_info(void)
{
  if (sRtwOptimizationInfoStruct==NULL) {
    sRtwOptimizationInfoStruct = sf_load_rtw_optimization_info(
      "lib_affectiveChar_behavior", "Expriment_All");
