...
#include "c1_testKinectBeatSmile.h"
...
static void initialize_c1_testKinectBeatSmile
  (SFc1_testKinectBeatSmileInstanceStruct *chartInstance);
static void initialize_params_c1_testKinectBeatSmile
  (SFc1_testKinectBeatSmileInstanceStruct *chartInstance);
static void enable_c1_testKinectBeatSmile(SFc1_testKinectBeatSmileInstanceStruct
  *chartInstance);
static void disable_c1_testKinectBeatSmile
  (SFc1_testKinectBeatSmileInstanceStruct *chartInstance);
static void c1_update_debugger_state_c1_testKinectBeatSmile
  (SFc1_testKinectBeatSmileInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c1_testKinectBeatSmile
  (SFc1_testKinectBeatSmileInstanceStruct *chartInstance);
static void set_sim_state_c1_testKinectBeatSmile
  (SFc1_testKinectBeatSmileInstanceStruct *chartInstance, const mxArray *c1_st);
static void c1_set_sim_state_side_effects_c1_testKinectBeatSmile
  (SFc1_testKinectBeatSmileInstanceStruct *chartInstance);
static void finalize_c1_testKinectBeatSmile
  (SFc1_testKinectBeatSmileInstanceStruct *chartInstance);
static void sf_gateway_c1_testKinectBeatSmile
  (SFc1_testKinectBeatSmileInstanceStruct *chartInstance);
static void c1_chartstep_c1_testKinectBeatSmile
  (SFc1_testKinectBeatSmileInstanceStruct *chartInstance);
static void initSimStructsc1_testKinectBeatSmile
  (SFc1_testKinectBeatSmileInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber, uint32_T c1_instanceNumber);
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData);
static real_T c1_emlrt_marshallIn(SFc1_testKinectBeatSmileInstanceStruct
  *chartInstance, const mxArray *c1_nargout, const char_T *c1_identifier);
static real_T c1_b_emlrt_marshallIn(SFc1_testKinectBeatSmileInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_b_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_c_emlrt_marshallIn(SFc1_testKinectBeatSmileInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId,
  real_T c1_y[256]);
...
static const mxArray *c1_e_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static boolean_T c1_d_emlrt_marshallIn(SFc1_testKinectBeatSmileInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
...
static const mxArray *c1_f_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static int32_T c1_e_emlrt_marshallIn(SFc1_testKinectBeatSmileInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_g_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static uint8_T c1_f_emlrt_marshallIn(SFc1_testKinectBeatSmileInstanceStruct
  *chartInstance, const mxArray *c1_b_tp_idle, const char_T *c1_identifier);
static uint8_T c1_g_emlrt_marshallIn(SFc1_testKinectBeatSmileInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_h_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_h_emlrt_marshallIn(SFc1_testKinectBeatSmileInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId,
  real_T c1_y[256]);
static void c1_f_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_i_emlrt_marshallIn
  (SFc1_testKinectBeatSmileInstanceStruct *chartInstance, const mxArray
   *c1_b_setSimStateSideEffectsInfo, const char_T *c1_identifier);
static const mxArray *c1_j_emlrt_marshallIn
  (SFc1_testKinectBeatSmileInstanceStruct *chartInstance, const mxArray *c1_u,
   const emlrtMsgIdentifier *c1_parentId);
static void c1_updateDataWrittenToVector(SFc1_testKinectBeatSmileInstanceStruct *
  chartInstance, uint32_T c1_vectorIndex);
static void c1_errorIfDataNotWrittenToFcn(SFc1_testKinectBeatSmileInstanceStruct
  *chartInstance, uint32_T c1_vectorIndex, uint32_T c1_dataNumber);
static void init_dsm_address_info(SFc1_testKinectBeatSmileInstanceStruct
  *chartInstance);
  ...
  (SFc1_testKinectBeatSmileInstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_testKinectBeatSmile = 0U;
  chartInstance->c1_is_c1_testKinectBeatSmile = c1_IN_NO_ACTIVE_CHILD;
}
  ...
  (SFc1_testKinectBeatSmileInstanceStruct *chartInstance)
{
  ...
  if (chartInstance->c1_is_active_c1_testKinectBeatSmile == 1U) {
    _SFD_CC_CALL(CHART_ACTIVE_TAG, 0U, chartInstance->c1_sfEvent);
  }

  if (chartInstance->c1_is_c1_testKinectBeatSmile == c1_IN_idle) {
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, chartInstance->c1_sfEvent);
  } else {
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, chartInstance->c1_sfEvent);
  }

  if (chartInstance->c1_is_c1_testKinectBeatSmile == c1_IN_stateBeat) {
  ...
  (SFc1_testKinectBeatSmileInstanceStruct *chartInstance)
{
  ...
  c1_b_hoistedGlobal = chartInstance->c1_is_active_c1_testKinectBeatSmile;
  c1_b_u = c1_b_hoistedGlobal;
  c1_c_y = NULL;
  sf_mex_assign(&c1_c_y, sf_mex_create("y", &c1_b_u, 3, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c1_y, 1, c1_c_y);
  c1_c_hoistedGlobal = chartInstance->c1_is_c1_testKinectBeatSmile;
  ...
  (SFc1_testKinectBeatSmileInstanceStruct *chartInstance, const mxArray *c1_st)
{
  ...
  chartInstance->c1_is_active_c1_testKinectBeatSmile = c1_f_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 1)),
     "is_active_c1_testKinectBeatSmile");
  chartInstance->c1_is_c1_testKinectBeatSmile = c1_f_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 2)),
     "is_c1_testKinectBeatSmile");
  ...
  c1_update_debugger_state_c1_testKinectBeatSmile(chartInstance);
  ...
  (SFc1_testKinectBeatSmileInstanceStruct *chartInstance)
{
  ...
  c1_set_sim_state_side_effects_c1_testKinectBeatSmile(chartInstance);
  ...
  chartInstance->c1_sfEvent = CALL_EVENT;
  c1_chartstep_c1_testKinectBeatSmile(chartInstance);
  ...
  (SFc1_testKinectBeatSmileInstanceStruct *chartInstance)
{
  ...
  if (chartInstance->c1_is_active_c1_testKinectBeatSmile == 0U) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 0U, chartInstance->c1_sfEvent);
    chartInstance->c1_is_active_c1_testKinectBeatSmile = 1U;
    _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 0U, chartInstance->c1_sfEvent);
    _SFD_CT_CALL(TRANSITION_ACTIVE_TAG, 0U, chartInstance->c1_sfEvent);
    chartInstance->c1_is_c1_testKinectBeatSmile = c1_IN_idle;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, chartInstance->c1_sfEvent);
    chartInstance->c1_tp_idle = 1U;
  } else {
    switch (chartInstance->c1_is_c1_testKinectBeatSmile) {
     case c1_IN_idle:
      CV_CHART_EVAL(0, 0, 1);
      ...
      if (c1_out) {
        ...
        if (c1_b_out) {
          ...
          chartInstance->c1_tp_idle = 0U;
          _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, chartInstance->c1_sfEvent);
          chartInstance->c1_is_c1_testKinectBeatSmile = c1_IN_stateBeat;
          _SFD_CS_CALL(STATE_ACTIVE_TAG, 2U, chartInstance->c1_sfEvent);
          chartInstance->c1_temporalCounter_i1 = 0U;
          chartInstance->c1_tp_stateBeat = 1U;
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  const mxArray *c1_y = NULL;
  SFc1_testKinectBeatSmileInstanceStruct *chartInstance;
  chartInstance = (SFc1_testKinectBeatSmileInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c1_testKinectBeatSmile_get_eml_resolved_functions_info(void)
{
...
void sf_c1_testKinectBeatSmile_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c1_testKinectBeatSmile_get_autoinheritance_info(void)
{
...
mxArray *sf_c1_testKinectBeatSmile_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c1_testKinectBeatSmile_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c1_testKinectBeatSmile(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[3],M[372],T\"beat\",},{M[8],M[0],T\"is_active_c1_testKinectBeatSmile\",},{M[9],M[0],T\"is_c1_testKinectBeatSmile\",},{M[11],M[0],T\"temporalCounter_i1\",S'et','os','ct'{{T\"at\",M[21],M[1]}}}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_testKinectBeatSmile_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc1_testKinectBeatSmileInstanceStruct *)
...
static void sf_opaque_initialize_c1_testKinectBeatSmile(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_testKinectBeatSmileInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c1_testKinectBeatSmile
    ((SFc1_testKinectBeatSmileInstanceStruct*) chartInstanceVar);
  initialize_c1_testKinectBeatSmile((SFc1_testKinectBeatSmileInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c1_testKinectBeatSmile(void *chartInstanceVar)
{
  enable_c1_testKinectBeatSmile((SFc1_testKinectBeatSmileInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c1_testKinectBeatSmile(void *chartInstanceVar)
{
  disable_c1_testKinectBeatSmile((SFc1_testKinectBeatSmileInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c1_testKinectBeatSmile(void *chartInstanceVar)
{
  sf_gateway_c1_testKinectBeatSmile((SFc1_testKinectBeatSmileInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c1_testKinectBeatSmile(SimStruct*
  S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_testKinectBeatSmile
    ((SFc1_testKinectBeatSmileInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_testKinectBeatSmile();/* state var info */
...
extern void sf_internal_set_sim_state_c1_testKinectBeatSmile(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c1_testKinectBeatSmile();/* state var info */
  ...
  set_sim_state_c1_testKinectBeatSmile((SFc1_testKinectBeatSmileInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c1_testKinectBeatSmile(SimStruct*
  S)
{
  return sf_internal_get_sim_state_c1_testKinectBeatSmile(S);
}

static void sf_opaque_set_sim_state_c1_testKinectBeatSmile(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c1_testKinectBeatSmile(S, st);
}

static void sf_opaque_terminate_c1_testKinectBeatSmile(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_testKinectBeatSmileInstanceStruct*) chartInstanceVar
      )->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c1_testKinectBeatSmile((SFc1_testKinectBeatSmileInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc1_testKinectBeatSmile((SFc1_testKinectBeatSmileInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_testKinectBeatSmile(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ...
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c1_testKinectBeatSmile
      ((SFc1_testKinectBeatSmileInstanceStruct*)(chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c1_testKinectBeatSmile(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(647910419U));
  ssSetChecksum1(S,(424526273U));
  ssSetChecksum2(S,(75751098U));
  ssSetChecksum3(S,(949052171U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c1_testKinectBeatSmile(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_testKinectBeatSmile(SimStruct *S)
{
  SFc1_testKinectBeatSmileInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc1_testKinectBeatSmileInstanceStruct *)utMalloc(sizeof
    (SFc1_testKinectBeatSmileInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc1_testKinectBeatSmileInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c1_testKinectBeatSmile;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c1_testKinectBeatSmile;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c1_testKinectBeatSmile;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c1_testKinectBeatSmile;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c1_testKinectBeatSmile;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c1_testKinectBeatSmile;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c1_testKinectBeatSmile;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_testKinectBeatSmile;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_testKinectBeatSmile;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_testKinectBeatSmile;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c1_testKinectBeatSmile;
...
void c1_testKinectBeatSmile_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_testKinectBeatSmile(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_testKinectBeatSmile(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_testKinectBeatSmile(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_testKinectBeatSmile_method_dispatcher.\n"
