  ...
  const mxArray * prhs[] )
{
  ...
  if (sf_ARP_02_RPSsmile_GloveAtomicRachelNotImitateSmile_process_check_sum_call
      (nlhs,plhs,nrhs,prhs))
    return 1;
...
{
  extern unsigned int
    sf_ARP_02_RPSsmile_GloveAtomicRachelNotImitateSmile_autoinheritance_info
    ( int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  ...
  if (strcmp(machineName, "ARP_02_RPSsmile_GloveAtomicRachelNotImitateSmile") ==
      0) {
...
{
  extern unsigned int
    sf_ARP_02_RPSsmile_GloveAtomicRachelNotImitateSmile_third_party_uses_info
    ( int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
...
{
  if (!strcmp(machineName,"ARP_02_RPSsmile_GloveAtomicRachelNotImitateSmile")) {
    return(sf_ARP_02_RPSsmile_GloveAtomicRachelNotImitateSmile_method_dispatcher
...
extern void ARP_02_RPSsmile_GloveAtomicRachelNotImitateSmile_terminator(void);
...
void sf_machine_global_terminator(void)
{
  ...
  if (sfGlobalMdlStartCallCounts == 0) {
    ARP_02_RPSsmile_GloveAtomicRachelNotImitateSmile_terminator();
...
extern void ARP_02_RPSsmile_GloveAtomicRachelNotImitateSmile_initializer(void);
extern void lib_affectiveChar_behavior_initializer(void);
extern void
  ARP_02_RPSsmile_GloveAtomicRachelNotImitateSmile_register_exported_symbols
  (SimStruct* S);
extern void lib_affectiveChar_behavior_register_exported_symbols(SimStruct* S);
extern void ARP_02_RPSsmile_GloveAtomicRachelNotImitateSmile_debug_initialize(
    struct SfDebugInstanceStruct*);
...
{
  ARP_02_RPSsmile_GloveAtomicRachelNotImitateSmile_register_exported_symbols(S);
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfGlobalMdlStartCallCounts == 1) {
    ...
    if (!simModeIsRTWGen) {
      ARP_02_RPSsmile_GloveAtomicRachelNotImitateSmile_debug_initialize
        (sfGlobalDebugInstanceStruct);
    }

    ARP_02_RPSsmile_GloveAtomicRachelNotImitateSmile_initializer();
    if (!simModeIsRTWGen) {
