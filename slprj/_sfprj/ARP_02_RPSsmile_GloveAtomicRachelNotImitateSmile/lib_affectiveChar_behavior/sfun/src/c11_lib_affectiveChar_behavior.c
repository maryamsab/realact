...
static real_T c11_get_isSmiling(SFc11_lib_affectiveChar_behaviorInstanceStruct
  *chartInstance, uint32_T c11_b);
static void c11_set_isSmiling(SFc11_lib_affectiveChar_behaviorInstanceStruct
  *chartInstance, uint32_T c11_b, real_T c11_c);
static real_T *c11_access_isSmiling
  (SFc11_lib_affectiveChar_behaviorInstanceStruct *chartInstance, uint32_T c11_b);
static real_T c11_get_smileN(SFc11_lib_affectiveChar_behaviorInstanceStruct
  *chartInstance, uint32_T c11_b);
static void c11_set_smileN(SFc11_lib_affectiveChar_behaviorInstanceStruct
  *chartInstance, uint32_T c11_b, real_T c11_c);
static real_T *c11_access_smileN(SFc11_lib_affectiveChar_behaviorInstanceStruct *
  chartInstance, uint32_T c11_b);
  ...
  (SFc11_lib_affectiveChar_behaviorInstanceStruct *chartInstance)
{
  ...
  if (chartInstance->c11_is_active_c11_lib_affectiveChar_behavior == 1U) {
    _SFD_CC_CALL(CHART_ACTIVE_TAG, 2U, chartInstance->c11_sfEvent);
  }
  ...
  (SFc11_lib_affectiveChar_behaviorInstanceStruct *chartInstance)
{
  ...
  c11_b_hoistedGlobal = chartInstance->c11_is_c11_lib_affectiveChar_behavior;
   ...
   c11_st)
{
  ...
  chartInstance->c11_is_c11_lib_affectiveChar_behavior = c11_f_emlrt_marshallIn
...
static void c11_enter_atomic_c11_lib_affectiveChar_behavior
  (SFc11_lib_affectiveChar_behaviorInstanceStruct *chartInstance)
{
  _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 2U, chartInstance->c11_sfEvent);
   ...
   case c11_IN_stateCheckSmile:
    ...
    if (c11_out) {
      ...
      for (c11_i0 = 0; c11_i0 < 256; c11_i0++) {
        c11_arg[c11_i0] = c11_dv0[c11_i0];
      }

      for (c11_i1 = 0; c11_i1 < 256; c11_i1++) {
        _SFD_DATA_RANGE_CHECK(c11_arg[c11_i1], 4U);
      }
      ...
      for (c11_i2 = 0; c11_i2 < 256; c11_i2++) {
        (*c11_b_arg)[c11_i2] = c11_arg[c11_i2];
      }

      for (c11_i3 = 0; c11_i3 < 256; c11_i3++) {
        _SFD_DATA_RANGE_CHECK((*c11_b_arg)[c11_i3], 4U);
      }
  ...
  (SFc11_lib_affectiveChar_behaviorInstanceStruct *chartInstance)
{
  ...
  c11_hoistedGlobal = c11_get_smileN(chartInstance, 0);
  c11_smileTablec11_lib_affectiveChar_behavior(chartInstance, c11_hoistedGlobal,
    c11_dv1);
  for (c11_i4 = 0; c11_i4 < 256; c11_i4++) {
    c11_arg[c11_i4] = c11_dv1[c11_i4];
  }

  for (c11_i5 = 0; c11_i5 < 256; c11_i5++) {
    _SFD_DATA_RANGE_CHECK(c11_arg[c11_i5], 4U);
  }
  ...
  for (c11_i7 = 0; c11_i7 < 256; c11_i7++) {
    _SFD_DATA_RANGE_CHECK((*c11_b_arg)[c11_i7], 4U);
  }
  ...
  *chartInstance, real_T c11_myarr256[256])
{
  ...
  int32_T c11_i9;
  static real_T c11_dv2[223] = { 60.0, 63.0, 120.0, 109.0, 108.0, 32.0, 118.0,
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c11_myarr256, 8U, c11_d_sf_marshallOut,
    c11_d_sf_marshallIn);
  for (c11_i8 = 0; c11_i8 < 223; c11_i8++) {
    c11_mystr[c11_i8] = c11_cv0[c11_i8];
  }
  ...
  for (c11_i9 = 0; c11_i9 < 223; c11_i9++) {
    c11_arr[c11_i9] = c11_dv2[c11_i9];
  }
  ...
  for (c11_i11 = 0; c11_i11 < 223; c11_i11++) {
    c11_tt[c11_i11] = c11_arr[c11_i11];
  }

  _SFD_SCRIPT_CALL(0U, chartInstance->c11_sfEvent, 11);
  for (c11_i12 = 0; c11_i12 < 256; c11_i12++) {
    c11_myarr256[c11_i12] = c11_tt[c11_i12];
  }
  ...
  *c11_inData)
{
  ...
  for (c11_i13 = 0; c11_i13 < 256; c11_i13++) {
    c11_b_inData[c11_i13] = (*(real_T (*)[256])c11_inData)[c11_i13];
  }
  ...
  *c11_mxArrayInData, const char_T *c11_varName, void *c11_outData)
{
  ...
  for (c11_i16 = 0; c11_i16 < 256; c11_i16++) {
    (*(real_T (*)[256])c11_outData)[c11_i16] = c11_y[c11_i16];
  }
  ...
  *c11_inData)
{
  ...
  chartInstance = (SFc11_lib_affectiveChar_behaviorInstanceStruct *)
    chartInstanceVoid;
  c11_mxArrayOutData = NULL;
  for (c11_i21 = 0; c11_i21 < 223; c11_i21++) {
    c11_b_inData[c11_i21] = (*(char_T (*)[223])c11_inData)[c11_i21];
  }

  for (c11_i22 = 0; c11_i22 < 223; c11_i22++) {
  ...
  *c11_inData)
{
  ...
  chartInstance = (SFc11_lib_affectiveChar_behaviorInstanceStruct *)
    chartInstanceVoid;
  c11_mxArrayOutData = NULL;
  for (c11_i23 = 0; c11_i23 < 223; c11_i23++) {
    c11_b_inData[c11_i23] = (*(real_T (*)[223])c11_inData)[c11_i23];
  }

  for (c11_i24 = 0; c11_i24 < 223; c11_i24++) {
    c11_u[c11_i24] = c11_b_inData[c11_i24];
  }
  ...
  *c11_inData)
{
  ...
  chartInstance = (SFc11_lib_affectiveChar_behaviorInstanceStruct *)
    chartInstanceVoid;
  c11_mxArrayOutData = NULL;
  for (c11_i25 = 0; c11_i25 < 87; c11_i25++) {
    c11_b_inData[c11_i25] = (*(char_T (*)[87])c11_inData)[c11_i25];
  }

  for (c11_i26 = 0; c11_i26 < 87; c11_i26++) {
  ...
  *c11_inData)
{
  ...
  for (c11_i27 = 0; c11_i27 < 87; c11_i27++) {
    c11_b_inData[c11_i27] = (*(real_T (*)[87])c11_inData)[c11_i27];
  }
   ...
   c11_arg[256])
{
  ...
  for (c11_i29 = 0; c11_i29 < 256; c11_i29++) {
    _SFD_DATA_RANGE_CHECK(c11_arg[c11_i29], 4U);
  }
  ...
  for (c11_i30 = 0; c11_i30 < 256; c11_i30++) {
    (*c11_b_arg)[c11_i30] = c11_arg[c11_i30];
  }

  for (c11_i31 = 0; c11_i31 < 256; c11_i31++) {
    _SFD_DATA_RANGE_CHECK((*c11_b_arg)[c11_i31], 4U);
  }
   ...
   c11_bmlID, real_T c11_poseBML[256])
{
  ...
  int32_T c11_i34;
  static real_T c11_dv6[87] = { 60.0, 63.0, 120.0, 109.0, 108.0, 32.0, 118.0,
    101.0, 114.0, 115.0, 105.0, 111.0, 110.0, 61.0, 34.0, 49.0, 46.0, 48.0, 34.0,
    32.0, 63.0, 62.0, 60.0, 97.0, 99.0, 116.0, 62.0, 60.0, 98.0, 109.0, 108.0,
  ...
  if (CV_EML_IF(1, 1, 0, c11_aVarTruthTableCondition_1)) {
    ...
    for (c11_i32 = 0; c11_i32 < 256; c11_i32++) {
      c11_poseBML[c11_i32] = c11_dv5[c11_i32];
    }
    ...
    if (CV_EML_IF(1, 1, 1, c11_aVarTruthTableCondition_2)) {
      ...
      for (c11_i33 = 0; c11_i33 < 87; c11_i33++) {
        c11_mystr[c11_i33] = c11_cv1[c11_i33];
      }
      ...
      c11_maxarrsize = 256.0;
      _SFD_SCRIPT_CALL(0U, chartInstance->c11_sfEvent, 6);
      for (c11_i34 = 0; c11_i34 < 87; c11_i34++) {
        c11_arr[c11_i34] = c11_dv6[c11_i34];
      }
      ...
      _SFD_SCRIPT_CALL(0U, chartInstance->c11_sfEvent, 10);
      for (c11_i36 = 0; c11_i36 < 87; c11_i36++) {
        c11_tt[c11_i36] = c11_arr[c11_i36];
      }

      _SFD_SCRIPT_CALL(0U, chartInstance->c11_sfEvent, 11);
      for (c11_i37 = 0; c11_i37 < 256; c11_i37++) {
        c11_myarr256[c11_i37] = c11_tt[c11_i37];
      }

      _SFD_SCRIPT_CALL(0U, chartInstance->c11_sfEvent, -11);
      _SFD_SYMBOL_SCOPE_POP();
      for (c11_i38 = 0; c11_i38 < 256; c11_i38++) {
        c11_poseBML[c11_i38] = c11_myarr256[c11_i38];
      }
      ...
      for (c11_i39 = 0; c11_i39 < 256; c11_i39++) {
        c11_poseBML[c11_i39] = c11_dv5[c11_i39];
      }
  ...
  real_T c11_arg[256])
{
  ...
  chartInstance = (SFc11_lib_affectiveChar_behaviorInstanceStruct *)
    ((ChartInfoStruct *)((ChartRunTimeInfo *)ssGetUserData(c11_S))->instanceInfo)
    ->chartInstance;
  for (c11_i40 = 0; c11_i40 < 256; c11_i40++) {
    c11_b_arg[c11_i40] = c11_arg[c11_i40];
  }
   ...
   c11_u, const emlrtMsgIdentifier *c11_parentId)
{
  ...
  int32_T c11_i41;
  (void)chartInstance;
  sf_mex_import(c11_parentId, sf_mex_dup(c11_u), &c11_i41, 1, 6, 0U, 0, 0U, 0);
  c11_y = c11_i41;
  sf_mex_destroy(&c11_u);
  return c11_y;
}
  ...
  *chartInstance, uint32_T c11_b)
{
  ...
  if (chartInstance->c11_avert_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'avert\' (#767) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c11_b)
{
  ...
  if (chartInstance->c11_isSmiling_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'isSmiling\' (#766) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c11_b)
{
  ...
  if (chartInstance->c11_smileN_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'smileN\' (#764) in the initialization routine of the chart.\n");
  }
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(371788686U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(4008586237U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1539560765U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(572726394U);
}
...
mxArray *sf_c11_lib_affectiveChar_behavior_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("FQ7T7bQXxyHHaPJI5Zo4p");
...
static const mxArray *sf_get_sim_state_info_c11_lib_affectiveChar_behavior(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[8],M[0],T\"is_active_c11_lib_affectiveChar_behavior\",},{M[9],M[0],T\"is_c11_lib_affectiveChar_behavior\",}}"
  };
...
static void mdlSetWorkWidths_c11_lib_affectiveChar_behavior(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(2380050266U));
  ssSetChecksum1(S,(4239498960U));
  ssSetChecksum2(S,(1964351588U));
  ssSetChecksum3(S,(1878243936U));
