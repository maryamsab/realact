  ...
  if (nrhs>2 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"library")) {
      ...
      if (!strcmp(machineName,"lib_affectiveChar_behavior")) {
        if (nrhs==3) {
          ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2907097284U);
          ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2824202327U);
          ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2872371697U);
          ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2676754086U);
        } else if (nrhs==4) {
