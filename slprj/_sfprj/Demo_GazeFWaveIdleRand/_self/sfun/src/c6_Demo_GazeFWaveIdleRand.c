...
static void initialize_c6_Demo_GazeFWaveIdleRand
  (SFc6_Demo_GazeFWaveIdleRandInstanceStruct *chartInstance);
static void initialize_params_c6_Demo_GazeFWaveIdleRand
  (SFc6_Demo_GazeFWaveIdleRandInstanceStruct *chartInstance);
static void enable_c6_Demo_GazeFWaveIdleRand
  (SFc6_Demo_GazeFWaveIdleRandInstanceStruct *chartInstance);
static void disable_c6_Demo_GazeFWaveIdleRand
  (SFc6_Demo_GazeFWaveIdleRandInstanceStruct *chartInstance);
static void c6_update_debugger_state_c6_Demo_GazeFWaveIdleRand
  (SFc6_Demo_GazeFWaveIdleRandInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c6_Demo_GazeFWaveIdleRand
  (SFc6_Demo_GazeFWaveIdleRandInstanceStruct *chartInstance);
static void set_sim_state_c6_Demo_GazeFWaveIdleRand
  (SFc6_Demo_GazeFWaveIdleRandInstanceStruct *chartInstance, const mxArray
   *c6_st);
static void finalize_c6_Demo_GazeFWaveIdleRand
  (SFc6_Demo_GazeFWaveIdleRandInstanceStruct *chartInstance);
static void sf_gateway_c6_Demo_GazeFWaveIdleRand
  (SFc6_Demo_GazeFWaveIdleRandInstanceStruct *chartInstance);
static void initSimStructsc6_Demo_GazeFWaveIdleRand
  (SFc6_Demo_GazeFWaveIdleRandInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c6_machineNumber, uint32_T
  c6_chartNumber, uint32_T c6_instanceNumber);
static const mxArray *c6_sf_marshallOut(void *chartInstanceVoid, void *c6_inData);
static real_T c6_emlrt_marshallIn(SFc6_Demo_GazeFWaveIdleRandInstanceStruct
  *chartInstance, const mxArray *c6_y, const char_T *c6_identifier);
static real_T c6_b_emlrt_marshallIn(SFc6_Demo_GazeFWaveIdleRandInstanceStruct
  *chartInstance, const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void c6_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData);
static const mxArray *c6_b_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static boolean_T c6_c_emlrt_marshallIn(SFc6_Demo_GazeFWaveIdleRandInstanceStruct
  *chartInstance, const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void c6_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData);
static const mxArray *c6_c_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static int32_T c6_d_emlrt_marshallIn(SFc6_Demo_GazeFWaveIdleRandInstanceStruct
  *chartInstance, const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void c6_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData);
static uint8_T c6_e_emlrt_marshallIn(SFc6_Demo_GazeFWaveIdleRandInstanceStruct
  *chartInstance, const mxArray *c6_b_is_active_c6_Demo_GazeFWaveIdleRand, const
  char_T *c6_identifier);
static uint8_T c6_f_emlrt_marshallIn(SFc6_Demo_GazeFWaveIdleRandInstanceStruct
  *chartInstance, const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void init_dsm_address_info(SFc6_Demo_GazeFWaveIdleRandInstanceStruct
  *chartInstance);
  ...
  (SFc6_Demo_GazeFWaveIdleRandInstanceStruct *chartInstance)
{
  ...
  chartInstance->c6_is_active_c6_Demo_GazeFWaveIdleRand = 0U;
}
  ...
  (SFc6_Demo_GazeFWaveIdleRandInstanceStruct *chartInstance)
{
  ...
  c6_b_hoistedGlobal = chartInstance->c6_is_active_c6_Demo_GazeFWaveIdleRand;
   ...
   *c6_st)
{
  ...
  *c6_y = c6_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c6_u, 0)),
    "y");
  chartInstance->c6_is_active_c6_Demo_GazeFWaveIdleRand = c6_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c6_u, 1)),
     "is_active_c6_Demo_GazeFWaveIdleRand");
  sf_mex_destroy(&c6_u);
  c6_update_debugger_state_c6_Demo_GazeFWaveIdleRand(chartInstance);
...
static const mxArray *c6_sf_marshallOut(void *chartInstanceVoid, void *c6_inData)
{
  ...
  const mxArray *c6_y = NULL;
  SFc6_Demo_GazeFWaveIdleRandInstanceStruct *chartInstance;
  chartInstance = (SFc6_Demo_GazeFWaveIdleRandInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c6_Demo_GazeFWaveIdleRand_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c6_identifier)
{
  ...
  c6_y = c6_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c6_b_is_active_c6_Demo_GazeFWaveIdleRand), &c6_thisId);
  sf_mex_destroy(&c6_b_is_active_c6_Demo_GazeFWaveIdleRand);
  return c6_y;
}
...
void sf_c6_Demo_GazeFWaveIdleRand_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c6_Demo_GazeFWaveIdleRand_get_autoinheritance_info(void)
{
...
mxArray *sf_c6_Demo_GazeFWaveIdleRand_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c6_Demo_GazeFWaveIdleRand_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c6_Demo_GazeFWaveIdleRand(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c6_Demo_GazeFWaveIdleRand\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c6_Demo_GazeFWaveIdleRand_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc6_Demo_GazeFWaveIdleRandInstanceStruct *)
...
static void sf_opaque_initialize_c6_Demo_GazeFWaveIdleRand(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc6_Demo_GazeFWaveIdleRandInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c6_Demo_GazeFWaveIdleRand
    ((SFc6_Demo_GazeFWaveIdleRandInstanceStruct*) chartInstanceVar);
  initialize_c6_Demo_GazeFWaveIdleRand
    ((SFc6_Demo_GazeFWaveIdleRandInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c6_Demo_GazeFWaveIdleRand(void *chartInstanceVar)
{
  enable_c6_Demo_GazeFWaveIdleRand((SFc6_Demo_GazeFWaveIdleRandInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c6_Demo_GazeFWaveIdleRand(void *chartInstanceVar)
{
  disable_c6_Demo_GazeFWaveIdleRand((SFc6_Demo_GazeFWaveIdleRandInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c6_Demo_GazeFWaveIdleRand(void *chartInstanceVar)
{
  sf_gateway_c6_Demo_GazeFWaveIdleRand
    ((SFc6_Demo_GazeFWaveIdleRandInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c6_Demo_GazeFWaveIdleRand
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c6_Demo_GazeFWaveIdleRand
    ((SFc6_Demo_GazeFWaveIdleRandInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c6_Demo_GazeFWaveIdleRand();/* state var info */
...
extern void sf_internal_set_sim_state_c6_Demo_GazeFWaveIdleRand(SimStruct* S,
  const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c6_Demo_GazeFWaveIdleRand();/* state var info */
  ...
  set_sim_state_c6_Demo_GazeFWaveIdleRand
    ((SFc6_Demo_GazeFWaveIdleRandInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c6_Demo_GazeFWaveIdleRand
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c6_Demo_GazeFWaveIdleRand(S);
}

static void sf_opaque_set_sim_state_c6_Demo_GazeFWaveIdleRand(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c6_Demo_GazeFWaveIdleRand(S, st);
}

static void sf_opaque_terminate_c6_Demo_GazeFWaveIdleRand(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc6_Demo_GazeFWaveIdleRandInstanceStruct*)
                    chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c6_Demo_GazeFWaveIdleRand
      ((SFc6_Demo_GazeFWaveIdleRandInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc6_Demo_GazeFWaveIdleRand
    ((SFc6_Demo_GazeFWaveIdleRandInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c6_Demo_GazeFWaveIdleRand(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c6_Demo_GazeFWaveIdleRand(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c6_Demo_GazeFWaveIdleRand(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c6_Demo_GazeFWaveIdleRand(SimStruct *S)
{
  SFc6_Demo_GazeFWaveIdleRandInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc6_Demo_GazeFWaveIdleRandInstanceStruct *)utMalloc(sizeof
    (SFc6_Demo_GazeFWaveIdleRandInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc6_Demo_GazeFWaveIdleRandInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c6_Demo_GazeFWaveIdleRand;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c6_Demo_GazeFWaveIdleRand;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c6_Demo_GazeFWaveIdleRand;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c6_Demo_GazeFWaveIdleRand;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c6_Demo_GazeFWaveIdleRand;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c6_Demo_GazeFWaveIdleRand;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c6_Demo_GazeFWaveIdleRand;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c6_Demo_GazeFWaveIdleRand;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c6_Demo_GazeFWaveIdleRand;
  chartInstance->chartInfo.mdlStart = mdlStart_c6_Demo_GazeFWaveIdleRand;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c6_Demo_GazeFWaveIdleRand;
...
void c6_Demo_GazeFWaveIdleRand_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c6_Demo_GazeFWaveIdleRand(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c6_Demo_GazeFWaveIdleRand(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c6_Demo_GazeFWaveIdleRand(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c6_Demo_GazeFWaveIdleRand_method_dispatcher.\n"
