...
#define c1_IN_stateGazeatUser          ((uint8_T)3U)
...
static void initialize_c1_testAtomicGaze(SFc1_testAtomicGazeInstanceStruct
  *chartInstance);
static void initialize_params_c1_testAtomicGaze
  (SFc1_testAtomicGazeInstanceStruct *chartInstance);
static void enable_c1_testAtomicGaze(SFc1_testAtomicGazeInstanceStruct
  *chartInstance);
static void disable_c1_testAtomicGaze(SFc1_testAtomicGazeInstanceStruct
  *chartInstance);
static void c1_update_debugger_state_c1_testAtomicGaze
  (SFc1_testAtomicGazeInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c1_testAtomicGaze
  (SFc1_testAtomicGazeInstanceStruct *chartInstance);
static void set_sim_state_c1_testAtomicGaze(SFc1_testAtomicGazeInstanceStruct
  *chartInstance, const mxArray *c1_st);
static void c1_set_sim_state_side_effects_c1_testAtomicGaze
  (SFc1_testAtomicGazeInstanceStruct *chartInstance);
static void finalize_c1_testAtomicGaze(SFc1_testAtomicGazeInstanceStruct
  *chartInstance);
static void sf_gateway_c1_testAtomicGaze(SFc1_testAtomicGazeInstanceStruct
  *chartInstance);
static void initSimStructsc1_testAtomicGaze(SFc1_testAtomicGazeInstanceStruct
  *chartInstance);
static void c1_idle(SFc1_testAtomicGazeInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber, uint32_T c1_instanceNumber);
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData);
static real_T c1_emlrt_marshallIn(SFc1_testAtomicGazeInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_b_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_b_emlrt_marshallIn(SFc1_testAtomicGazeInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId,
  real_T c1_y[256]);
...
static const mxArray *c1_g_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static boolean_T c1_c_emlrt_marshallIn(SFc1_testAtomicGazeInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
...
static const mxArray *c1_h_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static int32_T c1_d_emlrt_marshallIn(SFc1_testAtomicGazeInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_i_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static uint8_T c1_e_emlrt_marshallIn(SFc1_testAtomicGazeInstanceStruct
  *chartInstance, const mxArray *c1_b_tp_idle, const char_T *c1_identifier);
static uint8_T c1_f_emlrt_marshallIn(SFc1_testAtomicGazeInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_j_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_g_emlrt_marshallIn(SFc1_testAtomicGazeInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId,
  real_T c1_y[256]);
static void c1_f_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_h_emlrt_marshallIn(SFc1_testAtomicGazeInstanceStruct
  *chartInstance, const mxArray *c1_b_setSimStateSideEffectsInfo, const char_T
  *c1_identifier);
static const mxArray *c1_i_emlrt_marshallIn(SFc1_testAtomicGazeInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void init_dsm_address_info(SFc1_testAtomicGazeInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c1_temporalCounter_i1 = 0U;
  chartInstance->c1_tp_stateGazeatUser = 0U;
  chartInstance->c1_is_active_c1_testAtomicGaze = 0U;
  chartInstance->c1_is_c1_testAtomicGaze = c1_IN_NO_ACTIVE_CHILD;
}
  ...
  (SFc1_testAtomicGazeInstanceStruct *chartInstance)
{
  ...
  if (chartInstance->c1_is_active_c1_testAtomicGaze == 1U) {
    _SFD_CC_CALL(CHART_ACTIVE_TAG, 0U, chartInstance->c1_sfEvent);
  }

  if (chartInstance->c1_is_c1_testAtomicGaze == c1_IN_idle) {
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, chartInstance->c1_sfEvent);
  } else {
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, chartInstance->c1_sfEvent);
  }

  if (chartInstance->c1_is_c1_testAtomicGaze == c1_IN_stateCreatePawn) {
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 3U, chartInstance->c1_sfEvent);
  } else {
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 3U, chartInstance->c1_sfEvent);
  }

  if (chartInstance->c1_is_c1_testAtomicGaze == c1_IN_stateGazeatUser) {
  ...
  (SFc1_testAtomicGazeInstanceStruct *chartInstance)
{
  ...
  c1_hoistedGlobal = chartInstance->c1_is_active_c1_testAtomicGaze;
  c1_u = c1_hoistedGlobal;
  c1_b_y = NULL;
  sf_mex_assign(&c1_b_y, sf_mex_create("y", &c1_u, 3, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c1_y, 0, c1_b_y);
  c1_b_hoistedGlobal = chartInstance->c1_is_c1_testAtomicGaze;
  ...
  *chartInstance, const mxArray *c1_st)
{
  ...
  chartInstance->c1_is_active_c1_testAtomicGaze = c1_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 0)),
     "is_active_c1_testAtomicGaze");
  chartInstance->c1_is_c1_testAtomicGaze = c1_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c1_u, 1)), "is_c1_testAtomicGaze");
  ...
  c1_update_debugger_state_c1_testAtomicGaze(chartInstance);
  ...
  (SFc1_testAtomicGazeInstanceStruct *chartInstance)
{
  if (chartInstance->c1_doSetSimStateSideEffects != 0) {
    ...
    if (chartInstance->c1_is_c1_testAtomicGaze == c1_IN_stateGazeatUser) {
      chartInstance->c1_tp_stateGazeatUser = 1U;
    } else {
      chartInstance->c1_tp_stateGazeatUser = 0U;
    }
  ...
  *chartInstance)
{
  ...
  c1_set_sim_state_side_effects_c1_testAtomicGaze(chartInstance);
  ...
  if (chartInstance->c1_is_active_c1_testAtomicGaze == 0U) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 0U, chartInstance->c1_sfEvent);
    chartInstance->c1_is_active_c1_testAtomicGaze = 1U;
    _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 0U, chartInstance->c1_sfEvent);
    _SFD_CT_CALL(TRANSITION_ACTIVE_TAG, 1U, chartInstance->c1_sfEvent);
    chartInstance->c1_is_c1_testAtomicGaze = c1_IN_idle;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, chartInstance->c1_sfEvent);
    chartInstance->c1_temporalCounter_i1 = 0U;
    chartInstance->c1_tp_idle = 1U;
  } else {
    switch (chartInstance->c1_is_c1_testAtomicGaze) {
     case c1_IN_idle:
      CV_CHART_EVAL(0, 0, 1);
     ...
     case c1_IN_stateCreatePawn:
      ...
      _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_out, 2U, c1_g_sf_marshallOut,
        c1_c_sf_marshallIn);
      c1_out = CV_EML_IF(2, 0, 0, chartInstance->c1_temporalCounter_i1 >= 1);
      _SFD_SYMBOL_SCOPE_POP();
      if (c1_out) {
        _SFD_CT_CALL(TRANSITION_ACTIVE_TAG, 2U, chartInstance->c1_sfEvent);
        chartInstance->c1_tp_stateCreatePawn = 0U;
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 3U, chartInstance->c1_sfEvent);
        chartInstance->c1_is_c1_testAtomicGaze = c1_IN_stateGazeatUser;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 4U, chartInstance->c1_sfEvent);
        chartInstance->c1_tp_stateGazeatUser = 1U;
...
static void c1_idle(SFc1_testAtomicGazeInstanceStruct *chartInstance)
{
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_out, 2U, c1_g_sf_marshallOut,
    c1_c_sf_marshallIn);
  c1_out = CV_EML_IF(0, 0, 0, chartInstance->c1_temporalCounter_i1 >= 1);
  _SFD_SYMBOL_SCOPE_POP();
  if (c1_out) {
    _SFD_CT_CALL(TRANSITION_ACTIVE_TAG, 0U, chartInstance->c1_sfEvent);
    chartInstance->c1_tp_idle = 0U;
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, chartInstance->c1_sfEvent);
    chartInstance->c1_is_c1_testAtomicGaze = c1_IN_stateCreatePawn;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 3U, chartInstance->c1_sfEvent);
    chartInstance->c1_temporalCounter_i1 = 0U;
    chartInstance->c1_tp_stateCreatePawn = 1U;
    ...
    _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_c_nargin, 6U, c1_sf_marshallOut,
      c1_sf_marshallIn);
    _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_c_nargout, 7U, c1_sf_marshallOut,
      c1_sf_marshallIn);
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  const mxArray *c1_y = NULL;
  SFc1_testAtomicGazeInstanceStruct *chartInstance;
  chartInstance = (SFc1_testAtomicGazeInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c1_testAtomicGaze_get_eml_resolved_functions_info(void)
{
...
void sf_c1_testAtomicGaze_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2724350618U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2727477204U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1176184579U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2933854037U);
}

mxArray *sf_c1_testAtomicGaze_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("68yF8pSdvqXv3srqjxFAjB");
...
mxArray *sf_c1_testAtomicGaze_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c1_testAtomicGaze_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c1_testAtomicGaze(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[8],M[0],T\"is_active_c1_testAtomicGaze\",},{M[9],M[0],T\"is_c1_testAtomicGaze\",},{M[11],M[0],T\"temporalCounter_i1\",S'et','os','ct'{{T\"at\",M1x2[368 369],M[1]}}}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_testAtomicGaze_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc1_testAtomicGazeInstanceStruct *)
...
{
  return "q4ywoenNaZzWicIAfs7EOF";
}

static void sf_opaque_initialize_c1_testAtomicGaze(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_testAtomicGazeInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c1_testAtomicGaze((SFc1_testAtomicGazeInstanceStruct*)
    chartInstanceVar);
  initialize_c1_testAtomicGaze((SFc1_testAtomicGazeInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c1_testAtomicGaze(void *chartInstanceVar)
{
  enable_c1_testAtomicGaze((SFc1_testAtomicGazeInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c1_testAtomicGaze(void *chartInstanceVar)
{
  disable_c1_testAtomicGaze((SFc1_testAtomicGazeInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c1_testAtomicGaze(void *chartInstanceVar)
{
  sf_gateway_c1_testAtomicGaze((SFc1_testAtomicGazeInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c1_testAtomicGaze(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_testAtomicGaze
    ((SFc1_testAtomicGazeInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_testAtomicGaze();/* state var info */
...
extern void sf_internal_set_sim_state_c1_testAtomicGaze(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c1_testAtomicGaze();/* state var info */
  ...
  set_sim_state_c1_testAtomicGaze((SFc1_testAtomicGazeInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c1_testAtomicGaze(SimStruct* S)
{
  return sf_internal_get_sim_state_c1_testAtomicGaze(S);
}

static void sf_opaque_set_sim_state_c1_testAtomicGaze(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c1_testAtomicGaze(S, st);
}

static void sf_opaque_terminate_c1_testAtomicGaze(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_testAtomicGazeInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c1_testAtomicGaze((SFc1_testAtomicGazeInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc1_testAtomicGaze((SFc1_testAtomicGazeInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_testAtomicGaze(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c1_testAtomicGaze(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(1797216079U));
  ssSetChecksum1(S,(3484647472U));
  ssSetChecksum2(S,(3080414128U));
  ssSetChecksum3(S,(3238695958U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c1_testAtomicGaze(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_testAtomicGaze(SimStruct *S)
{
  SFc1_testAtomicGazeInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc1_testAtomicGazeInstanceStruct *)utMalloc(sizeof
    (SFc1_testAtomicGazeInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc1_testAtomicGazeInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c1_testAtomicGaze;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c1_testAtomicGaze;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c1_testAtomicGaze;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c1_testAtomicGaze;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c1_testAtomicGaze;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c1_testAtomicGaze;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c1_testAtomicGaze;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_testAtomicGaze;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_testAtomicGaze;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_testAtomicGaze;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c1_testAtomicGaze;
...
void c1_testAtomicGaze_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_testAtomicGaze(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_testAtomicGaze(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_testAtomicGaze(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_testAtomicGaze_method_dispatcher.\n"
