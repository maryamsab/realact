...
static void initialize_c21_DemoWave_K(SFc21_DemoWave_KInstanceStruct
  *chartInstance);
static void initialize_params_c21_DemoWave_K(SFc21_DemoWave_KInstanceStruct
  *chartInstance);
static void enable_c21_DemoWave_K(SFc21_DemoWave_KInstanceStruct *chartInstance);
static void disable_c21_DemoWave_K(SFc21_DemoWave_KInstanceStruct *chartInstance);
static void c21_update_debugger_state_c21_DemoWave_K
  (SFc21_DemoWave_KInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c21_DemoWave_K
  (SFc21_DemoWave_KInstanceStruct *chartInstance);
static void set_sim_state_c21_DemoWave_K(SFc21_DemoWave_KInstanceStruct
  *chartInstance, const mxArray *c21_st);
static void finalize_c21_DemoWave_K(SFc21_DemoWave_KInstanceStruct
  *chartInstance);
static void sf_gateway_c21_DemoWave_K(SFc21_DemoWave_KInstanceStruct
  *chartInstance);
static void initSimStructsc21_DemoWave_K(SFc21_DemoWave_KInstanceStruct
  *chartInstance);
...
static const mxArray *c21_sf_marshallOut(void *chartInstanceVoid, void
  *c21_inData);
static real_T c21_emlrt_marshallIn(SFc21_DemoWave_KInstanceStruct *chartInstance,
  const mxArray *c21_y, const char_T *c21_identifier);
static real_T c21_b_emlrt_marshallIn(SFc21_DemoWave_KInstanceStruct
...
static const mxArray *c21_b_sf_marshallOut(void *chartInstanceVoid, void
  *c21_inData);
static boolean_T c21_c_emlrt_marshallIn(SFc21_DemoWave_KInstanceStruct
  *chartInstance, const mxArray *c21_u, const emlrtMsgIdentifier *c21_parentId);
...
static const mxArray *c21_c_sf_marshallOut(void *chartInstanceVoid, void
  *c21_inData);
static int32_T c21_d_emlrt_marshallIn(SFc21_DemoWave_KInstanceStruct
  *chartInstance, const mxArray *c21_u, const emlrtMsgIdentifier *c21_parentId);
static void c21_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c21_mxArrayInData, const char_T *c21_varName, void *c21_outData);
static uint8_T c21_e_emlrt_marshallIn(SFc21_DemoWave_KInstanceStruct
  *chartInstance, const mxArray *c21_b_is_active_c21_DemoWave_K, const char_T
  *c21_identifier);
static uint8_T c21_f_emlrt_marshallIn(SFc21_DemoWave_KInstanceStruct
  *chartInstance, const mxArray *c21_u, const emlrtMsgIdentifier *c21_parentId);
static void init_dsm_address_info(SFc21_DemoWave_KInstanceStruct *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c21_is_active_c21_DemoWave_K = 0U;
}
  ...
  (SFc21_DemoWave_KInstanceStruct *chartInstance)
{
  ...
  c21_b_hoistedGlobal = chartInstance->c21_is_active_c21_DemoWave_K;
  ...
  *chartInstance, const mxArray *c21_st)
{
  ...
  *c21_y = c21_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c21_u,
    0)), "y");
  chartInstance->c21_is_active_c21_DemoWave_K = c21_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c21_u, 1)),
     "is_active_c21_DemoWave_K");
  sf_mex_destroy(&c21_u);
  c21_update_debugger_state_c21_DemoWave_K(chartInstance);
  ...
  *chartInstance)
{
  ...
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 16U, chartInstance->c21_sfEvent);
  _SFD_DATA_RANGE_CHECK(*c21_b_R, 0U);
  _SFD_DATA_RANGE_CHECK(*c21_b_L, 1U);
  chartInstance->c21_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 16U, chartInstance->c21_sfEvent);
  ...
  *c21_b_y = c21_y;
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 16U, chartInstance->c21_sfEvent);
  _SFD_SYMBOL_SCOPE_POP();
  ...
  *c21_inData)
{
  ...
  const mxArray *c21_y = NULL;
  SFc21_DemoWave_KInstanceStruct *chartInstance;
  chartInstance = (SFc21_DemoWave_KInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c21_DemoWave_K_get_eml_resolved_functions_info(void)
{
  ...
  *c21_identifier)
{
  ...
  c21_y = c21_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c21_b_is_active_c21_DemoWave_K), &c21_thisId);
  sf_mex_destroy(&c21_b_is_active_c21_DemoWave_K);
  return c21_y;
}
...
void sf_c21_DemoWave_K_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(778393128U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2424823327U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3624914490U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(4277161524U);
}

mxArray *sf_c21_DemoWave_K_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("Gc7VntGn8cYPPsAqjM8CnG");
...
mxArray *sf_c21_DemoWave_K_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c21_DemoWave_K_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c21_DemoWave_K(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c21_DemoWave_K\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c21_DemoWave_K_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc21_DemoWave_KInstanceStruct *) chartInfo->chartInstance;
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"tt_blk_kernel",0,-1,739);
        _SFD_CV_INIT_EML_FCN(0,1,"aFcnTruthTableAction_1",739,-1,796);
        _SFD_CV_INIT_EML_FCN(0,2,"aFcnTruthTableAction_2",796,-1,856);
        _SFD_CV_INIT_EML_FCN(0,3,"aFcnTruthTableAction_3",856,-1,915);
        _SFD_CV_INIT_EML_FCN(0,4,"aFcnTruthTableAction_4",915,-1,974);
        _SFD_CV_INIT_EML_IF(0,1,0,433,463,494,737);
        _SFD_CV_INIT_EML_IF(0,1,1,494,528,559,737);
        _SFD_CV_INIT_EML_IF(0,1,2,559,593,624,737);
        _SFD_CV_INIT_EML_IF(0,1,3,624,658,689,737);
...
{
  return "IrJx1HAbJxOP0GUtSY6MKC";
}

static void sf_opaque_initialize_c21_DemoWave_K(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc21_DemoWave_KInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c21_DemoWave_K((SFc21_DemoWave_KInstanceStruct*)
    chartInstanceVar);
  initialize_c21_DemoWave_K((SFc21_DemoWave_KInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c21_DemoWave_K(void *chartInstanceVar)
{
  enable_c21_DemoWave_K((SFc21_DemoWave_KInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c21_DemoWave_K(void *chartInstanceVar)
{
  disable_c21_DemoWave_K((SFc21_DemoWave_KInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c21_DemoWave_K(void *chartInstanceVar)
{
  sf_gateway_c21_DemoWave_K((SFc21_DemoWave_KInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c21_DemoWave_K(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c21_DemoWave_K
    ((SFc21_DemoWave_KInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c21_DemoWave_K();/* state var info */
...
extern void sf_internal_set_sim_state_c21_DemoWave_K(SimStruct* S, const mxArray
  *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c21_DemoWave_K();/* state var info */
  ...
  set_sim_state_c21_DemoWave_K((SFc21_DemoWave_KInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c21_DemoWave_K(SimStruct* S)
{
  return sf_internal_get_sim_state_c21_DemoWave_K(S);
}

static void sf_opaque_set_sim_state_c21_DemoWave_K(SimStruct* S, const mxArray
  *st)
{
  sf_internal_set_sim_state_c21_DemoWave_K(S, st);
}

static void sf_opaque_terminate_c21_DemoWave_K(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc21_DemoWave_KInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c21_DemoWave_K((SFc21_DemoWave_KInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc21_DemoWave_K((SFc21_DemoWave_KInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c21_DemoWave_K(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c21_DemoWave_K(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(3325375299U));
  ssSetChecksum1(S,(3369023557U));
  ssSetChecksum2(S,(2135495446U));
  ssSetChecksum3(S,(2961770678U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c21_DemoWave_K(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c21_DemoWave_K(SimStruct *S)
{
  SFc21_DemoWave_KInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc21_DemoWave_KInstanceStruct *)utMalloc(sizeof
    (SFc21_DemoWave_KInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc21_DemoWave_KInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c21_DemoWave_K;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c21_DemoWave_K;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c21_DemoWave_K;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c21_DemoWave_K;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c21_DemoWave_K;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c21_DemoWave_K;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c21_DemoWave_K;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c21_DemoWave_K;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c21_DemoWave_K;
  chartInstance->chartInfo.mdlStart = mdlStart_c21_DemoWave_K;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c21_DemoWave_K;
...
void c21_DemoWave_K_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c21_DemoWave_K(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c21_DemoWave_K(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c21_DemoWave_K(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c21_DemoWave_K_method_dispatcher.\n"
