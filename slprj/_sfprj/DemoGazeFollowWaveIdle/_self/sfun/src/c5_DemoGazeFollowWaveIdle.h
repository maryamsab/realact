#ifndef __c5_DemoGazeFollowWaveIdle_h__
#define __c5_DemoGazeFollowWaveIdle_h__
...
/* Type Definitions */
#ifndef typedef_SFc5_DemoGazeFollowWaveIdleInstanceStruct
#define typedef_SFc5_DemoGazeFollowWaveIdleInstanceStruct
...
typedef struct {
  ...
  uint8_T c5_is_active_c5_DemoGazeFollowWaveIdle;
...
#endif                                 /*typedef_SFc5_DemoGazeFollowWaveIdleInstanceStruct*/
...
extern void sf_exported_auto_deactivate_c5_DemoGazeFollowWaveIdle_secs(SimStruct
  *c5_S);
extern boolean_T sf_exported_auto_isStablec5_DemoGazeFollowWaveIdle(SimStruct
  *c5_S);
extern void sf_exported_auto_duringc5_DemoGazeFollowWaveIdle(SimStruct *c5_S);
extern void sf_exported_auto_enterc5_DemoGazeFollowWaveIdle(SimStruct *c5_S);
extern void sf_exported_auto_exitc5_DemoGazeFollowWaveIdle(SimStruct *c5_S);
extern void sf_exported_auto_gatewayc5_DemoGazeFollowWaveIdle(SimStruct *c5_S);
extern void sf_exported_auto_enablec5_DemoGazeFollowWaveIdle(SimStruct *c5_S);
extern void sf_exported_auto_disablec5_DemoGazeFollowWaveIdle(SimStruct *c5_S);
...
extern void sf_exported_auto_initBuffersc5_DemoGazeFollowWaveIdle(SimStruct
  *c5_S);
extern void sf_exported_auto_activate_callc5_DemoGazeFollowWaveIdle(SimStruct
  *c5_S);
extern void sf_exported_auto_increment_call_counterc5_DemoGazeFollowWaveIdle
  (SimStruct *c5_S);
extern void sf_exported_auto_reset_call_counterc5_DemoGazeFollowWaveIdle
  (SimStruct *c5_S);
extern void sf_exported_auto_deactivate_callc5_DemoGazeFollowWaveIdle(SimStruct *
  c5_S);
extern void sf_exported_auto_initc5_DemoGazeFollowWaveIdle(SimStruct *c5_S);
...
extern void sf_internal_set_sim_state_c5_DemoGazeFollowWaveIdle(SimStruct *c5_S,
  const mxArray *c5_in);
extern void sf_exported_auto_check_state_inconsistency_c5_DemoGazeFollowWaveIdle
  (SimStruct *c5_S);
extern void sf_exported_user_c5_DemoGazeFollowWaveIdle_handPoseSBTable(SimStruct
  *c5_S, real_T c5_sbmID, real_T c5_poseSBM[256]);
extern void sf_exported_user_c5_DemoGazeFollowWaveIdle_idlePoseBradTable
  (SimStruct *c5_S, real_T c5_bmlID, real_T *c5_p, real_T c5_poseBML[256]);
extern void sf_exported_user_c5_DemoGazeFollowWaveIdle_initialPoseTable
  (SimStruct *c5_S, real_T c5_bmlID, real_T *c5_p, real_T c5_poseBML[256]);
extern void sf_exported_user_c5_DemoGazeFollowWaveIdle_insertQueue(SimStruct
  *c5_S, real_T c5_bmls[1280], real_T c5_mBML[256], real_T c5_newBmls[1280]);
extern void sf_exported_user_c5_DemoGazeFollowWaveIdle_insertQueueLow(SimStruct *
  c5_S, real_T c5_bmls[1280], real_T c5_myBML[256], real_T c5_newBmls[1280]);
extern void sf_exported_user_c5_DemoGazeFollowWaveIdle_paperPoseBradTable
  (SimStruct *c5_S, real_T c5_bmlID, real_T *c5_p, real_T c5_poseBML[256]);
extern void sf_exported_user_c5_DemoGazeFollowWaveIdle_rockPoseTable(SimStruct
  *c5_S, real_T c5_bmlID, real_T *c5_p, real_T c5_poseBML[256]);
extern void sf_exported_user_c5_DemoGazeFollowWaveIdle_scissorsPoseBradTable
  (SimStruct *c5_S, real_T c5_bmlID, real_T *c5_p, real_T c5_poseBML[256]);
extern void sf_exported_user_c5_DemoGazeFollowWaveIdle_sendSBM(SimStruct *c5_S,
  real_T c5_arg[256]);

/* Function Definitions */
extern void sf_c5_DemoGazeFollowWaveIdle_get_check_sum(mxArray *plhs[]);
extern void c5_DemoGazeFollowWaveIdle_method_dispatcher(SimStruct *S, int_T
  method, void *data);
