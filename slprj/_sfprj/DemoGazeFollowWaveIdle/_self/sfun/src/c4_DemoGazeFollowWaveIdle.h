#ifndef __c4_DemoGazeFollowWaveIdle_h__
#define __c4_DemoGazeFollowWaveIdle_h__
...
/* Type Definitions */
#ifndef typedef_SFc4_DemoGazeFollowWaveIdleInstanceStruct
#define typedef_SFc4_DemoGazeFollowWaveIdleInstanceStruct
...
typedef struct {
  ...
  uint8_T c4_is_active_c4_DemoGazeFollowWaveIdle;
  uint8_T c4_is_c4_DemoGazeFollowWaveIdle;
  real_T c4_BMLl[256];
...
#endif                                 /*typedef_SFc4_DemoGazeFollowWaveIdleInstanceStruct*/
...
extern void sf_exported_auto_deactivate_c4_DemoGazeFollowWaveIdle_secs(SimStruct
  *c4_S);
extern boolean_T sf_exported_auto_isStablec4_DemoGazeFollowWaveIdle(SimStruct
  *c4_S);
extern void sf_exported_auto_duringc4_DemoGazeFollowWaveIdle(SimStruct *c4_S);
extern void sf_exported_auto_enterc4_DemoGazeFollowWaveIdle(SimStruct *c4_S);
extern void sf_exported_auto_exitc4_DemoGazeFollowWaveIdle(SimStruct *c4_S);
extern void sf_exported_auto_gatewayc4_DemoGazeFollowWaveIdle(SimStruct *c4_S);
extern void sf_exported_auto_enablec4_DemoGazeFollowWaveIdle(SimStruct *c4_S);
extern void sf_exported_auto_disablec4_DemoGazeFollowWaveIdle(SimStruct *c4_S);
...
extern void sf_exported_auto_initBuffersc4_DemoGazeFollowWaveIdle(SimStruct
  *c4_S);
extern void sf_exported_auto_activate_callc4_DemoGazeFollowWaveIdle(SimStruct
  *c4_S);
extern void sf_exported_auto_increment_call_counterc4_DemoGazeFollowWaveIdle
  (SimStruct *c4_S);
extern void sf_exported_auto_reset_call_counterc4_DemoGazeFollowWaveIdle
  (SimStruct *c4_S);
extern void sf_exported_auto_deactivate_callc4_DemoGazeFollowWaveIdle(SimStruct *
  c4_S);
extern void sf_exported_auto_initc4_DemoGazeFollowWaveIdle(SimStruct *c4_S);
...
extern void sf_internal_set_sim_state_c4_DemoGazeFollowWaveIdle(SimStruct *c4_S,
  const mxArray *c4_in);
extern void sf_exported_auto_check_state_inconsistency_c4_DemoGazeFollowWaveIdle
  (SimStruct *c4_S);
extern void sf_exported_user_c4_DemoGazeFollowWaveIdle_idlePoseBradTable
  (SimStruct *c4_S, real_T c4_bmlID, real_T *c4_pr, real_T c4_poseBML[256]);
extern void sf_exported_user_c4_DemoGazeFollowWaveIdle_insertQueueLow(SimStruct *
  c4_S, real_T c4_bmls[1280], real_T c4_myBML[256], real_T c4_newBmls[1280]);
extern void sf_exported_user_c4_DemoGazeFollowWaveIdle_walkInvadingTable
...
extern void c4_DemoGazeFollowWaveIdle_method_dispatcher(SimStruct *S, int_T
  method, void *data);
