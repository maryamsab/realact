...
static void initialize_c8_DemoGazeFollowWaveIdle
  (SFc8_DemoGazeFollowWaveIdleInstanceStruct *chartInstance);
static void initialize_params_c8_DemoGazeFollowWaveIdle
  (SFc8_DemoGazeFollowWaveIdleInstanceStruct *chartInstance);
static void enable_c8_DemoGazeFollowWaveIdle
  (SFc8_DemoGazeFollowWaveIdleInstanceStruct *chartInstance);
static void disable_c8_DemoGazeFollowWaveIdle
  (SFc8_DemoGazeFollowWaveIdleInstanceStruct *chartInstance);
static void c8_update_debugger_state_c8_DemoGazeFollowWaveIdle
  (SFc8_DemoGazeFollowWaveIdleInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c8_DemoGazeFollowWaveIdle
  (SFc8_DemoGazeFollowWaveIdleInstanceStruct *chartInstance);
static void set_sim_state_c8_DemoGazeFollowWaveIdle
  (SFc8_DemoGazeFollowWaveIdleInstanceStruct *chartInstance, const mxArray
   *c8_st);
static void c8_set_sim_state_side_effects_c8_DemoGazeFollowWaveIdle
  (SFc8_DemoGazeFollowWaveIdleInstanceStruct *chartInstance);
static void finalize_c8_DemoGazeFollowWaveIdle
  (SFc8_DemoGazeFollowWaveIdleInstanceStruct *chartInstance);
static void sf_gateway_c8_DemoGazeFollowWaveIdle
  (SFc8_DemoGazeFollowWaveIdleInstanceStruct *chartInstance);
static void c8_enter_atomic_c8_DemoGazeFollowWaveIdle
  (SFc8_DemoGazeFollowWaveIdleInstanceStruct *chartInstance);
static void c8_enter_internal_c8_DemoGazeFollowWaveIdle
  (SFc8_DemoGazeFollowWaveIdleInstanceStruct *chartInstance);
static void c8_c8_DemoGazeFollowWaveIdle
  (SFc8_DemoGazeFollowWaveIdleInstanceStruct *chartInstance);
static void c8_exit_internal_c8_DemoGazeFollowWaveIdle
  (SFc8_DemoGazeFollowWaveIdleInstanceStruct *chartInstance);
static void c8_initc8_DemoGazeFollowWaveIdle
  (SFc8_DemoGazeFollowWaveIdleInstanceStruct *chartInstance);
static void initSimStructsc8_DemoGazeFollowWaveIdle
  (SFc8_DemoGazeFollowWaveIdleInstanceStruct *chartInstance);
static void c8_stateInit(SFc8_DemoGazeFollowWaveIdleInstanceStruct
  *chartInstance);
static void c8_enter_atomic_stateWalkBack
  (SFc8_DemoGazeFollowWaveIdleInstanceStruct *chartInstance);
static void c8_enter_atomic_browUp(SFc8_DemoGazeFollowWaveIdleInstanceStruct
  *chartInstance);
static void c8_checkUserCoord(SFc8_DemoGazeFollowWaveIdleInstanceStruct
  *chartInstance);
static void c8_enter_atomic_idle(SFc8_DemoGazeFollowWaveIdleInstanceStruct
  *chartInstance);
static void c8_enter_atomic_leanFW(SFc8_DemoGazeFollowWaveIdleInstanceStruct
  *chartInstance);
static void c8_enter_atomic_leanNeutral
  (SFc8_DemoGazeFollowWaveIdleInstanceStruct *chartInstance);
static void c8_leanNeutral(SFc8_DemoGazeFollowWaveIdleInstanceStruct
  *chartInstance);
static void c8_encStr2Arr(SFc8_DemoGazeFollowWaveIdleInstanceStruct
  *chartInstance, real_T c8_myarr256[256]);
static void c8_b_encStr2Arr(SFc8_DemoGazeFollowWaveIdleInstanceStruct
  *chartInstance, real_T c8_myarr256[256]);
static void c8_c_encStr2Arr(SFc8_DemoGazeFollowWaveIdleInstanceStruct
  *chartInstance, real_T c8_myarr256[256]);
static void c8_d_encStr2Arr(SFc8_DemoGazeFollowWaveIdleInstanceStruct
  *chartInstance, real_T c8_myarr256[256]);
static void c8_e_encStr2Arr(SFc8_DemoGazeFollowWaveIdleInstanceStruct
  *chartInstance, real_T c8_myarr256[256]);
static void c8_f_encStr2Arr(SFc8_DemoGazeFollowWaveIdleInstanceStruct
  *chartInstance, real_T c8_myarr256[256]);
static void c8_g_encStr2Arr(SFc8_DemoGazeFollowWaveIdleInstanceStruct
  *chartInstance, real_T c8_myarr256[256]);
static void init_script_number_translation(uint32_T c8_machineNumber, uint32_T
  c8_chartNumber, uint32_T c8_instanceNumber);
static const mxArray *c8_sf_marshallOut(void *chartInstanceVoid, void *c8_inData);
static void c8_emlrt_marshallIn(SFc8_DemoGazeFollowWaveIdleInstanceStruct
  *chartInstance, const mxArray *c8_newBmls, const char_T *c8_identifier, real_T
  c8_y[1280]);
static void c8_b_emlrt_marshallIn(SFc8_DemoGazeFollowWaveIdleInstanceStruct
...
static const mxArray *c8_b_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static void c8_c_emlrt_marshallIn(SFc8_DemoGazeFollowWaveIdleInstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId,
  real_T c8_y[256]);
...
static const mxArray *c8_c_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static real_T c8_d_emlrt_marshallIn(SFc8_DemoGazeFollowWaveIdleInstanceStruct
  *chartInstance, const mxArray *c8_nargout, const char_T *c8_identifier);
static real_T c8_e_emlrt_marshallIn(SFc8_DemoGazeFollowWaveIdleInstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void c8_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData);
static const mxArray *c8_d_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static void c8_f_emlrt_marshallIn(SFc8_DemoGazeFollowWaveIdleInstanceStruct
  *chartInstance, const mxArray *c8_myarr256, const char_T *c8_identifier,
  real_T c8_y[256]);
static void c8_g_emlrt_marshallIn(SFc8_DemoGazeFollowWaveIdleInstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId,
  real_T c8_y[256]);
...
static const mxArray *c8_f_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static boolean_T c8_h_emlrt_marshallIn(SFc8_DemoGazeFollowWaveIdleInstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
...
static void c8_activate_secsc8_DemoGazeFollowWaveIdle
  (SFc8_DemoGazeFollowWaveIdleInstanceStruct *chartInstance);
static void c8_deactivate_secsc8_DemoGazeFollowWaveIdle
  (SFc8_DemoGazeFollowWaveIdleInstanceStruct *chartInstance);
static void c8_increment_counters_secsc8_DemoGazeFollowWaveIdle
  (SFc8_DemoGazeFollowWaveIdleInstanceStruct *chartInstance);
static void c8_reset_counters_secsc8_DemoGazeFollowWaveIdle
  (SFc8_DemoGazeFollowWaveIdleInstanceStruct *chartInstance);
static void c8_insertQueueLowc8_DemoGazeFollowWaveIdle
  (SFc8_DemoGazeFollowWaveIdleInstanceStruct *chartInstance, real_T c8_bmls[1280],
   real_T c8_myBML[256], real_T c8_newBmls[1280]);
static void c8_walkInvadingTablec8_DemoGazeFollowWaveIdle
  (SFc8_DemoGazeFollowWaveIdleInstanceStruct *chartInstance, real_T c8_bmlID,
   real_T *c8_p, real_T c8_poseBML[256]);
static void c8_insertQueuec8_DemoGazeFollowWaveIdle
  (SFc8_DemoGazeFollowWaveIdleInstanceStruct *chartInstance, real_T c8_bmls[1280],
   real_T c8_myBML[256], real_T c8_newBmls[1280]);
static boolean_T c8_isequal(SFc8_DemoGazeFollowWaveIdleInstanceStruct
...
static const mxArray *c8_u_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static int8_T c8_i_emlrt_marshallIn(SFc8_DemoGazeFollowWaveIdleInstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
...
static const mxArray *c8_v_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static int32_T c8_j_emlrt_marshallIn(SFc8_DemoGazeFollowWaveIdleInstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
...
static const mxArray *c8_w_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static uint8_T c8_k_emlrt_marshallIn(SFc8_DemoGazeFollowWaveIdleInstanceStruct
  *chartInstance, const mxArray *c8_b_tp_stateInit, const char_T *c8_identifier);
static uint8_T c8_l_emlrt_marshallIn(SFc8_DemoGazeFollowWaveIdleInstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
...
static const mxArray *c8_x_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static void c8_m_emlrt_marshallIn(SFc8_DemoGazeFollowWaveIdleInstanceStruct
  *chartInstance, const mxArray *c8_b_BMLM, const char_T *c8_identifier, creal_T
  c8_y[256]);
static void c8_n_emlrt_marshallIn(SFc8_DemoGazeFollowWaveIdleInstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId,
  creal_T c8_y[256]);
...
static const mxArray *c8_p_emlrt_marshallIn
  (SFc8_DemoGazeFollowWaveIdleInstanceStruct *chartInstance, const mxArray *c8_u,
   const emlrtMsgIdentifier *c8_parentId);
static void c8_updateDataWrittenToVector
  (SFc8_DemoGazeFollowWaveIdleInstanceStruct *chartInstance, uint32_T
   c8_vectorIndex);
static void c8_errorIfDataNotWrittenToFcn
  (SFc8_DemoGazeFollowWaveIdleInstanceStruct *chartInstance, uint32_T
   c8_vectorIndex, uint32_T c8_dataNumber);
static real_T c8_get_BML1(SFc8_DemoGazeFollowWaveIdleInstanceStruct
  *chartInstance, uint32_T c8_b);
static void c8_set_BML1(SFc8_DemoGazeFollowWaveIdleInstanceStruct *chartInstance,
  uint32_T c8_b, real_T c8_c);
static real_T *c8_access_BML1(SFc8_DemoGazeFollowWaveIdleInstanceStruct
  *chartInstance, uint32_T c8_b);
static real_T c8_get_P(SFc8_DemoGazeFollowWaveIdleInstanceStruct *chartInstance,
  uint32_T c8_b);
static void c8_set_P(SFc8_DemoGazeFollowWaveIdleInstanceStruct *chartInstance,
                     uint32_T c8_b, real_T c8_c);
static real_T *c8_access_P(SFc8_DemoGazeFollowWaveIdleInstanceStruct
  *chartInstance, uint32_T c8_b);
static real_T c8_get_STATE_BEFORE(SFc8_DemoGazeFollowWaveIdleInstanceStruct
  *chartInstance, uint32_T c8_b);
static void c8_set_STATE_BEFORE(SFc8_DemoGazeFollowWaveIdleInstanceStruct
  *chartInstance, uint32_T c8_b, real_T c8_c);
static real_T *c8_access_STATE_BEFORE(SFc8_DemoGazeFollowWaveIdleInstanceStruct *
  chartInstance, uint32_T c8_b);
static real_T c8_get_STATE_OVER(SFc8_DemoGazeFollowWaveIdleInstanceStruct
  *chartInstance, uint32_T c8_b);
static void c8_set_STATE_OVER(SFc8_DemoGazeFollowWaveIdleInstanceStruct
  *chartInstance, uint32_T c8_b, real_T c8_c);
static real_T *c8_access_STATE_OVER(SFc8_DemoGazeFollowWaveIdleInstanceStruct
  *chartInstance, uint32_T c8_b);
static real_T c8_get_STATE_READY(SFc8_DemoGazeFollowWaveIdleInstanceStruct
  *chartInstance, uint32_T c8_b);
static void c8_set_STATE_READY(SFc8_DemoGazeFollowWaveIdleInstanceStruct
  *chartInstance, uint32_T c8_b, real_T c8_c);
static real_T *c8_access_STATE_READY(SFc8_DemoGazeFollowWaveIdleInstanceStruct
  *chartInstance, uint32_T c8_b);
static real_T c8_get_avert(SFc8_DemoGazeFollowWaveIdleInstanceStruct
  *chartInstance, uint32_T c8_b);
static void c8_set_avert(SFc8_DemoGazeFollowWaveIdleInstanceStruct
  *chartInstance, uint32_T c8_b, real_T c8_c);
static real_T *c8_access_avert(SFc8_DemoGazeFollowWaveIdleInstanceStruct
  *chartInstance, uint32_T c8_b);
static real_T c8_get_bmlsL(SFc8_DemoGazeFollowWaveIdleInstanceStruct
  *chartInstance, uint32_T c8_b);
static void c8_set_bmlsL(SFc8_DemoGazeFollowWaveIdleInstanceStruct
  *chartInstance, uint32_T c8_b, real_T c8_c);
static real_T *c8_access_bmlsL(SFc8_DemoGazeFollowWaveIdleInstanceStruct
  *chartInstance, uint32_T c8_b);
static real_T c8_get_bmlsM(SFc8_DemoGazeFollowWaveIdleInstanceStruct
  *chartInstance, uint32_T c8_b);
static void c8_set_bmlsM(SFc8_DemoGazeFollowWaveIdleInstanceStruct
  *chartInstance, uint32_T c8_b, real_T c8_c);
static real_T *c8_access_bmlsM(SFc8_DemoGazeFollowWaveIdleInstanceStruct
  *chartInstance, uint32_T c8_b);
static real_T c8_get_fileID(SFc8_DemoGazeFollowWaveIdleInstanceStruct
  *chartInstance, uint32_T c8_b);
static void c8_set_fileID(SFc8_DemoGazeFollowWaveIdleInstanceStruct
  *chartInstance, uint32_T c8_b, real_T c8_c);
static real_T *c8_access_fileID(SFc8_DemoGazeFollowWaveIdleInstanceStruct
  *chartInstance, uint32_T c8_b);
static real_T c8_get_pr(SFc8_DemoGazeFollowWaveIdleInstanceStruct *chartInstance,
  uint32_T c8_b);
static void c8_set_pr(SFc8_DemoGazeFollowWaveIdleInstanceStruct *chartInstance,
                      uint32_T c8_b, real_T c8_c);
static real_T *c8_access_pr(SFc8_DemoGazeFollowWaveIdleInstanceStruct
  *chartInstance, uint32_T c8_b);
static void init_dsm_address_info(SFc8_DemoGazeFollowWaveIdleInstanceStruct
  *chartInstance);
  ...
  (SFc8_DemoGazeFollowWaveIdleInstanceStruct *chartInstance)
{
  ...
  c8_i_hoistedGlobal = chartInstance->c8_is_active_c8_DemoGazeFollowWaveIdle;
  c8_n_u = c8_i_hoistedGlobal;
  c8_o_y = NULL;
  sf_mex_assign(&c8_o_y, sf_mex_create("y", &c8_n_u, 3, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c8_y, 13, c8_o_y);
  c8_j_hoistedGlobal = chartInstance->c8_is_c8_DemoGazeFollowWaveIdle;
   ...
   *c8_st)
{
  ...
  *c8_gameState = c8_d_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
  ...
  chartInstance->c8_is_active_c8_DemoGazeFollowWaveIdle = c8_k_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c8_u, 13)),
     "is_active_c8_DemoGazeFollowWaveIdle");
  chartInstance->c8_is_c8_DemoGazeFollowWaveIdle = c8_k_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c8_u, 14)),
     "is_c8_DemoGazeFollowWaveIdle");
  ...
  c8_update_debugger_state_c8_DemoGazeFollowWaveIdle(chartInstance);
...
static void sf_gateway_c8_DemoGazeFollowWaveIdle
  (SFc8_DemoGazeFollowWaveIdleInstanceStruct *chartInstance)
{
  c8_set_sim_state_side_effects_c8_DemoGazeFollowWaveIdle(chartInstance);
}
  ...
  (SFc8_DemoGazeFollowWaveIdleInstanceStruct *chartInstance)
{
  ...
  chartInstance->c8_is_active_c8_DemoGazeFollowWaveIdle = 1U;
  ...
  (SFc8_DemoGazeFollowWaveIdleInstanceStruct *chartInstance)
{
  ...
  chartInstance->c8_is_c8_DemoGazeFollowWaveIdle = c8_IN_stateInit;
  _SFD_CS_CALL(STATE_ACTIVE_TAG, 9U, chartInstance->c8_sfEvent);
  chartInstance->c8_tp_stateInit = 1U;
  ...
  (SFc8_DemoGazeFollowWaveIdleInstanceStruct *chartInstance)
{
  ...
  switch (chartInstance->c8_is_c8_DemoGazeFollowWaveIdle) {
   case c8_IN_browUp:
    CV_CHART_EVAL(4, 0, 1);
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, chartInstance->c8_sfEvent);
    chartInstance->c8_isStable = false;
    chartInstance->c8_is_c8_DemoGazeFollowWaveIdle = c8_IN_checkUserCoord;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, chartInstance->c8_sfEvent);
    chartInstance->c8_temporalCounter_i1 = 0U;
    chartInstance->c8_tp_checkUserCoord = 1U;
   ...
   case c8_IN_idle:
    ...
    if (c8_out) {
      ...
      _SFD_CS_CALL(STATE_INACTIVE_TAG, 4U, chartInstance->c8_sfEvent);
      chartInstance->c8_isStable = false;
      chartInstance->c8_is_c8_DemoGazeFollowWaveIdle = c8_IN_wait;
      _SFD_CS_CALL(STATE_ACTIVE_TAG, 11U, chartInstance->c8_sfEvent);
      chartInstance->c8_tp_wait = 1U;
    } else {
   ...
   case c8_IN_wait:
    ...
    if (c8_c_out) {
      ...
      _SFD_CS_CALL(STATE_INACTIVE_TAG, 11U, chartInstance->c8_sfEvent);
      chartInstance->c8_isStable = false;
      chartInstance->c8_is_c8_DemoGazeFollowWaveIdle =
        c8_IN_headNeuralGazeCamera;
      _SFD_CS_CALL(STATE_ACTIVE_TAG, 3U, chartInstance->c8_sfEvent);
      chartInstance->c8_tp_headNeuralGazeCamera = 1U;
      ...
      c8_walkInvadingTablec8_DemoGazeFollowWaveIdle(chartInstance, 4.0, &c8_P,
        c8_b_BMLM);
      ...
      c8_insertQueuec8_DemoGazeFollowWaveIdle(chartInstance, c8_dv3, c8_dv4,
        c8_dv5);
   ...
   default:
    CV_CHART_EVAL(4, 0, 0);
    chartInstance->c8_is_c8_DemoGazeFollowWaveIdle = c8_IN_NO_ACTIVE_CHILD;
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, chartInstance->c8_sfEvent);
    break;
  }
  ...
  (SFc8_DemoGazeFollowWaveIdleInstanceStruct *chartInstance)
{
  ...
  chartInstance->c8_tp_walkFW = 0U;
  chartInstance->c8_temporalCounter_i1 = 0U;
  chartInstance->c8_is_active_c8_DemoGazeFollowWaveIdle = 0U;
  chartInstance->c8_is_c8_DemoGazeFollowWaveIdle = c8_IN_NO_ACTIVE_CHILD;
}
  ...
  *chartInstance)
{
  ...
  if (c8_out) {
    ...
    if (c8_b_out) {
      ...
      c8_insertQueuec8_DemoGazeFollowWaveIdle(chartInstance, c8_dv6, c8_dv7,
        c8_dv8);
  ...
  (SFc8_DemoGazeFollowWaveIdleInstanceStruct *chartInstance)
{
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c8_nargout, 1U, c8_c_sf_marshallOut,
    c8_c_sf_marshallIn);
  c8_walkInvadingTablec8_DemoGazeFollowWaveIdle(chartInstance, 2.0, &c8_P,
    c8_b_BMLM);
  c8_set_P(chartInstance, 0, c8_P);
  ssUpdateDataStoreLog(chartInstance->S, 1);
  ...
  c8_insertQueuec8_DemoGazeFollowWaveIdle(chartInstance, c8_dv9, c8_dv10,
    c8_dv11);
  ...
  *chartInstance)
{
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c8_nargout, 1U, c8_c_sf_marshallOut,
    c8_c_sf_marshallIn);
  c8_walkInvadingTablec8_DemoGazeFollowWaveIdle(chartInstance, 8.0, &c8_P,
    c8_b_BMLM);
  c8_set_P(chartInstance, 0, c8_P);
  ssUpdateDataStoreLog(chartInstance->S, 1);
  ...
  c8_insertQueuec8_DemoGazeFollowWaveIdle(chartInstance, c8_dv12, c8_dv13,
    c8_dv14);
  ...
  *chartInstance)
{
  ...
  if (c8_out) {
    ...
    if (c8_b_out) {
      ...
      _SFD_CS_CALL(STATE_INACTIVE_TAG, 1U, chartInstance->c8_sfEvent);
      chartInstance->c8_isStable = false;
      chartInstance->c8_is_c8_DemoGazeFollowWaveIdle = c8_IN_leanNeutral;
      _SFD_CS_CALL(STATE_ACTIVE_TAG, 8U, chartInstance->c8_sfEvent);
      chartInstance->c8_temporalCounter_i1 = 0U;
      chartInstance->c8_tp_leanNeutral = 1U;
      ...
      if (c8_c_out) {
        ...
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 1U, chartInstance->c8_sfEvent);
        chartInstance->c8_isStable = false;
        chartInstance->c8_is_c8_DemoGazeFollowWaveIdle = c8_IN_leanFW;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 7U, chartInstance->c8_sfEvent);
        chartInstance->c8_tp_leanFW = 1U;
  ...
  if (guard3 == true) {
    ...
    if (c8_d_out) {
      ...
      if (c8_e_out) {
        ...
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 1U, chartInstance->c8_sfEvent);
        chartInstance->c8_isStable = false;
        chartInstance->c8_is_c8_DemoGazeFollowWaveIdle = c8_IN_browUp;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, chartInstance->c8_sfEvent);
        chartInstance->c8_tp_browUp = 1U;
        ...
        if (c8_f_out) {
          ...
          _SFD_CS_CALL(STATE_INACTIVE_TAG, 1U, chartInstance->c8_sfEvent);
          chartInstance->c8_isStable = false;
          chartInstance->c8_is_c8_DemoGazeFollowWaveIdle = c8_IN_idle;
          _SFD_CS_CALL(STATE_ACTIVE_TAG, 4U, chartInstance->c8_sfEvent);
          chartInstance->c8_temporalCounter_i1 = 0U;
          chartInstance->c8_tp_idle = 1U;
  ...
  if (guard2 == true) {
    ...
    if (c8_g_out) {
      ...
      if (c8_h_out) {
        ...
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 1U, chartInstance->c8_sfEvent);
        chartInstance->c8_isStable = false;
        chartInstance->c8_is_c8_DemoGazeFollowWaveIdle = c8_IN_stateWalkBack;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 10U, chartInstance->c8_sfEvent);
        chartInstance->c8_temporalCounter_i1 = 0U;
        chartInstance->c8_tp_stateWalkBack = 1U;
        ...
        if (c8_i_out) {
          ...
          _SFD_CS_CALL(STATE_INACTIVE_TAG, 1U, chartInstance->c8_sfEvent);
          chartInstance->c8_isStable = false;
          chartInstance->c8_is_c8_DemoGazeFollowWaveIdle = c8_IN_gazeSurprized;
          _SFD_CS_CALL(STATE_ACTIVE_TAG, 2U, chartInstance->c8_sfEvent);
          chartInstance->c8_tp_gazeSurprized = 1U;
          ...
          _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c8_j_nargout, 1U,
            c8_c_sf_marshallOut, c8_c_sf_marshallIn);
          c8_walkInvadingTablec8_DemoGazeFollowWaveIdle(chartInstance, 5.0,
            &c8_P, c8_b_BMLM);
          c8_set_P(chartInstance, 0, c8_P);
          ssUpdateDataStoreLog(chartInstance->S, 1);
          ...
          c8_insertQueuec8_DemoGazeFollowWaveIdle(chartInstance, c8_dv15,
            c8_dv16, c8_dv17);
  ...
  if (guard1 == true) {
    ...
    if (c8_j_out) {
      ...
      _SFD_CS_CALL(STATE_INACTIVE_TAG, 1U, chartInstance->c8_sfEvent);
      chartInstance->c8_isStable = false;
      chartInstance->c8_is_c8_DemoGazeFollowWaveIdle = c8_IN_wait2;
      _SFD_CS_CALL(STATE_ACTIVE_TAG, 12U, chartInstance->c8_sfEvent);
      chartInstance->c8_tp_wait2 = 1U;
    } else {
  ...
  *chartInstance)
{
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c8_nargout, 1U, c8_c_sf_marshallOut,
    c8_c_sf_marshallIn);
  c8_walkInvadingTablec8_DemoGazeFollowWaveIdle(chartInstance, 1.0, &c8_P,
    c8_b_BMLM);
  c8_set_P(chartInstance, 0, c8_P);
  ssUpdateDataStoreLog(chartInstance->S, 1);
  ...
  c8_insertQueuec8_DemoGazeFollowWaveIdle(chartInstance, c8_dv18, c8_dv19,
    c8_dv20);
  ...
  *chartInstance)
{
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c8_nargout, 1U, c8_c_sf_marshallOut,
    c8_c_sf_marshallIn);
  c8_walkInvadingTablec8_DemoGazeFollowWaveIdle(chartInstance, 6.0, &c8_P,
    c8_b_BMLM);
  c8_set_P(chartInstance, 0, c8_P);
  ssUpdateDataStoreLog(chartInstance->S, 1);
  ...
  c8_insertQueuec8_DemoGazeFollowWaveIdle(chartInstance, c8_dv21, c8_dv22,
    c8_dv23);
  ...
  (SFc8_DemoGazeFollowWaveIdleInstanceStruct *chartInstance)
{
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c8_nargout, 1U, c8_c_sf_marshallOut,
    c8_c_sf_marshallIn);
  c8_walkInvadingTablec8_DemoGazeFollowWaveIdle(chartInstance, 7.0, &c8_P,
    c8_b_BMLM);
  c8_set_P(chartInstance, 0, c8_P);
  ssUpdateDataStoreLog(chartInstance->S, 1);
  ...
  c8_insertQueuec8_DemoGazeFollowWaveIdle(chartInstance, c8_dv24, c8_dv25,
    c8_dv26);
  ...
  *chartInstance)
{
  ...
  if (c8_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 8U, chartInstance->c8_sfEvent);
    chartInstance->c8_isStable = false;
    chartInstance->c8_is_c8_DemoGazeFollowWaveIdle = c8_IN_walkFW;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 13U, chartInstance->c8_sfEvent);
    chartInstance->c8_temporalCounter_i1 = 0U;
    chartInstance->c8_tp_walkFW = 1U;
    ...
    _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c8_b_nargout, 1U, c8_c_sf_marshallOut,
      c8_c_sf_marshallIn);
    c8_walkInvadingTablec8_DemoGazeFollowWaveIdle(chartInstance, 3.0, &c8_P,
      c8_b_BMLM);
    c8_set_P(chartInstance, 0, c8_P);
    ssUpdateDataStoreLog(chartInstance->S, 1);
    ...
    c8_insertQueuec8_DemoGazeFollowWaveIdle(chartInstance, c8_dv27, c8_dv28,
      c8_dv29);
...
static const mxArray *c8_sf_marshallOut(void *chartInstanceVoid, void *c8_inData)
{
  ...
  const mxArray *c8_y = NULL;
  SFc8_DemoGazeFollowWaveIdleInstanceStruct *chartInstance;
  chartInstance = (SFc8_DemoGazeFollowWaveIdleInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c8_DemoGazeFollowWaveIdle_get_eml_resolved_functions_info(void)
{
...
void sf_exported_auto_activate_c8_DemoGazeFollowWaveIdle_secs(SimStruct *c8_S)
{
  SFc8_DemoGazeFollowWaveIdleInstanceStruct *chartInstance;
  chartInstance = (SFc8_DemoGazeFollowWaveIdleInstanceStruct *)((ChartInfoStruct
    *)((ChartRunTimeInfo *)ssGetUserData(c8_S))->instanceInfo)->chartInstance;
  c8_activate_secsc8_DemoGazeFollowWaveIdle(chartInstance);
}

void sf_exported_auto_incrementTemporalCounter_c8_DemoGazeFollowWaveIdle_secs
  (SimStruct *c8_S)
{
  SFc8_DemoGazeFollowWaveIdleInstanceStruct *chartInstance;
  chartInstance = (SFc8_DemoGazeFollowWaveIdleInstanceStruct *)((ChartInfoStruct
    *)((ChartRunTimeInfo *)ssGetUserData(c8_S))->instanceInfo)->chartInstance;
  c8_increment_counters_secsc8_DemoGazeFollowWaveIdle(chartInstance);
}

void sf_exported_auto_resetTemporalCounter_c8_DemoGazeFollowWaveIdle_secs
  (SimStruct *c8_S)
{
  SFc8_DemoGazeFollowWaveIdleInstanceStruct *chartInstance;
  chartInstance = (SFc8_DemoGazeFollowWaveIdleInstanceStruct *)((ChartInfoStruct
    *)((ChartRunTimeInfo *)ssGetUserData(c8_S))->instanceInfo)->chartInstance;
  c8_reset_counters_secsc8_DemoGazeFollowWaveIdle(chartInstance);
}

void sf_exported_auto_deactivate_c8_DemoGazeFollowWaveIdle_secs(SimStruct *c8_S)
{
  SFc8_DemoGazeFollowWaveIdleInstanceStruct *chartInstance;
  chartInstance = (SFc8_DemoGazeFollowWaveIdleInstanceStruct *)((ChartInfoStruct
    *)((ChartRunTimeInfo *)ssGetUserData(c8_S))->instanceInfo)->chartInstance;
  c8_deactivate_secsc8_DemoGazeFollowWaveIdle(chartInstance);
}

boolean_T sf_exported_auto_isStablec8_DemoGazeFollowWaveIdle(SimStruct *c8_S)
{
  SFc8_DemoGazeFollowWaveIdleInstanceStruct *chartInstance;
  chartInstance = (SFc8_DemoGazeFollowWaveIdleInstanceStruct *)((ChartInfoStruct
    *)((ChartRunTimeInfo *)ssGetUserData(c8_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_duringc8_DemoGazeFollowWaveIdle(SimStruct *c8_S)
{
  SFc8_DemoGazeFollowWaveIdleInstanceStruct *chartInstance;
  chartInstance = (SFc8_DemoGazeFollowWaveIdleInstanceStruct *)((ChartInfoStruct
    *)((ChartRunTimeInfo *)ssGetUserData(c8_S))->instanceInfo)->chartInstance;
  c8_c8_DemoGazeFollowWaveIdle(chartInstance);
}

void sf_exported_auto_enterc8_DemoGazeFollowWaveIdle(SimStruct *c8_S)
{
  SFc8_DemoGazeFollowWaveIdleInstanceStruct *chartInstance;
  chartInstance = (SFc8_DemoGazeFollowWaveIdleInstanceStruct *)((ChartInfoStruct
    *)((ChartRunTimeInfo *)ssGetUserData(c8_S))->instanceInfo)->chartInstance;
  _sfTime_ = sf_get_time(chartInstance->S);
  c8_enter_atomic_c8_DemoGazeFollowWaveIdle(chartInstance);
  c8_enter_internal_c8_DemoGazeFollowWaveIdle(chartInstance);
}

void sf_exported_auto_exitc8_DemoGazeFollowWaveIdle(SimStruct *c8_S)
{
  SFc8_DemoGazeFollowWaveIdleInstanceStruct *chartInstance;
  chartInstance = (SFc8_DemoGazeFollowWaveIdleInstanceStruct *)((ChartInfoStruct
    *)((ChartRunTimeInfo *)ssGetUserData(c8_S))->instanceInfo)->chartInstance;
  _sfTime_ = sf_get_time(chartInstance->S);
  c8_exit_internal_c8_DemoGazeFollowWaveIdle(chartInstance);
}

void sf_exported_auto_gatewayc8_DemoGazeFollowWaveIdle(SimStruct *c8_S)
{
  SFc8_DemoGazeFollowWaveIdleInstanceStruct *chartInstance;
  chartInstance = (SFc8_DemoGazeFollowWaveIdleInstanceStruct *)((ChartInfoStruct
    *)((ChartRunTimeInfo *)ssGetUserData(c8_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_enablec8_DemoGazeFollowWaveIdle(SimStruct *c8_S)
{
  SFc8_DemoGazeFollowWaveIdleInstanceStruct *chartInstance;
  chartInstance = (SFc8_DemoGazeFollowWaveIdleInstanceStruct *)((ChartInfoStruct
    *)((ChartRunTimeInfo *)ssGetUserData(c8_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_disablec8_DemoGazeFollowWaveIdle(SimStruct *c8_S)
{
  SFc8_DemoGazeFollowWaveIdleInstanceStruct *chartInstance;
  chartInstance = (SFc8_DemoGazeFollowWaveIdleInstanceStruct *)((ChartInfoStruct
    *)((ChartRunTimeInfo *)ssGetUserData(c8_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_stepBuffersc8_DemoGazeFollowWaveIdle(SimStruct *c8_S)
{
  SFc8_DemoGazeFollowWaveIdleInstanceStruct *chartInstance;
  chartInstance = (SFc8_DemoGazeFollowWaveIdleInstanceStruct *)((ChartInfoStruct
    *)((ChartRunTimeInfo *)ssGetUserData(c8_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_initBuffersc8_DemoGazeFollowWaveIdle(SimStruct *c8_S)
{
  SFc8_DemoGazeFollowWaveIdleInstanceStruct *chartInstance;
  chartInstance = (SFc8_DemoGazeFollowWaveIdleInstanceStruct *)((ChartInfoStruct
    *)((ChartRunTimeInfo *)ssGetUserData(c8_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_activate_callc8_DemoGazeFollowWaveIdle(SimStruct *c8_S)
{
  SFc8_DemoGazeFollowWaveIdleInstanceStruct *chartInstance;
  chartInstance = (SFc8_DemoGazeFollowWaveIdleInstanceStruct *)((ChartInfoStruct
    *)((ChartRunTimeInfo *)ssGetUserData(c8_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_increment_call_counterc8_DemoGazeFollowWaveIdle(SimStruct *
  c8_S)
{
  SFc8_DemoGazeFollowWaveIdleInstanceStruct *chartInstance;
  chartInstance = (SFc8_DemoGazeFollowWaveIdleInstanceStruct *)((ChartInfoStruct
...
void sf_exported_auto_reset_call_counterc8_DemoGazeFollowWaveIdle(SimStruct
  *c8_S)
{
  SFc8_DemoGazeFollowWaveIdleInstanceStruct *chartInstance;
  chartInstance = (SFc8_DemoGazeFollowWaveIdleInstanceStruct *)((ChartInfoStruct
...
void sf_exported_auto_deactivate_callc8_DemoGazeFollowWaveIdle(SimStruct *c8_S)
{
  SFc8_DemoGazeFollowWaveIdleInstanceStruct *chartInstance;
  chartInstance = (SFc8_DemoGazeFollowWaveIdleInstanceStruct *)((ChartInfoStruct
    *)((ChartRunTimeInfo *)ssGetUserData(c8_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_initc8_DemoGazeFollowWaveIdle(SimStruct *c8_S)
{
  SFc8_DemoGazeFollowWaveIdleInstanceStruct *chartInstance;
  chartInstance = (SFc8_DemoGazeFollowWaveIdleInstanceStruct *)((ChartInfoStruct
    *)((ChartRunTimeInfo *)ssGetUserData(c8_S))->instanceInfo)->chartInstance;
  c8_initc8_DemoGazeFollowWaveIdle(chartInstance);
}

const mxArray *sf_exported_auto_getSimstatec8_DemoGazeFollowWaveIdle(SimStruct
  *c8_S)
{
  ...
  chartInstance = (SFc8_DemoGazeFollowWaveIdleInstanceStruct *)((ChartInfoStruct
    *)((ChartRunTimeInfo *)ssGetUserData(c8_S))->instanceInfo)->chartInstance;
  c8_out = NULL;
  sf_mex_assign(&c8_out, sf_internal_get_sim_state_c8_DemoGazeFollowWaveIdle
                (c8_S), false);
  return c8_out;
}

void sf_exported_auto_setSimstatec8_DemoGazeFollowWaveIdle(SimStruct *c8_S,
  const mxArray *c8_in)
{
  SFc8_DemoGazeFollowWaveIdleInstanceStruct *chartInstance;
  chartInstance = (SFc8_DemoGazeFollowWaveIdleInstanceStruct *)((ChartInfoStruct
    *)((ChartRunTimeInfo *)ssGetUserData(c8_S))->instanceInfo)->chartInstance;
  sf_internal_set_sim_state_c8_DemoGazeFollowWaveIdle(c8_S, sf_mex_dup(c8_in));
  sf_mex_destroy(&c8_in);
}

void sf_exported_auto_check_state_inconsistency_c8_DemoGazeFollowWaveIdle
  (SimStruct *c8_S)
{
  SFc8_DemoGazeFollowWaveIdleInstanceStruct *chartInstance;
  chartInstance = (SFc8_DemoGazeFollowWaveIdleInstanceStruct *)((ChartInfoStruct
...
void sf_exported_user_c8_DemoGazeFollowWaveIdle_insertQueue(SimStruct *c8_S,
  real_T c8_bmls[1280], real_T c8_myBML[256], real_T c8_newBmls[1280])
{
  ...
  c8_insertQueuec8_DemoGazeFollowWaveIdle(chartInstance, c8_b_bmls, c8_b_myBML,
    c8_newBmls);
}

void sf_exported_user_c8_DemoGazeFollowWaveIdle_insertQueueLow(SimStruct *c8_S,
  real_T c8_bmls[1280], real_T c8_myBML[256], real_T c8_newBmls[1280])
{
  int32_T c8_i221;
  real_T c8_b_bmls[1280];
  ...
  c8_insertQueueLowc8_DemoGazeFollowWaveIdle(chartInstance, c8_b_bmls,
    c8_b_myBML, c8_newBmls);
}

void sf_exported_user_c8_DemoGazeFollowWaveIdle_walkInvadingTable(SimStruct
  *c8_S, real_T c8_bmlID, real_T *c8_p, real_T c8_poseBML[256])
{
  ...
  chartInstance = (SFc8_DemoGazeFollowWaveIdleInstanceStruct *)((ChartInfoStruct
    *)((ChartRunTimeInfo *)ssGetUserData(c8_S))->instanceInfo)->chartInstance;
  c8_walkInvadingTablec8_DemoGazeFollowWaveIdle(chartInstance, c8_bmlID, &c8_b_p,
    c8_poseBML);
  *c8_p = c8_b_p;
}
  ...
  *chartInstance, uint32_T c8_b)
{
  ...
  if (chartInstance->c8_BML1_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'BML1\' (#904) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c8_b)
{
  ...
  if (chartInstance->c8_P_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'P\' (#905) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c8_b)
{
  ...
  if (chartInstance->c8_STATE_BEFORE_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'STATE_BEFORE\' (#903) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c8_b)
{
  ...
  if (chartInstance->c8_STATE_OVER_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'STATE_OVER\' (#901) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c8_b)
{
  ...
  if (chartInstance->c8_STATE_READY_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'STATE_READY\' (#900) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c8_b)
{
  ...
  if (chartInstance->c8_avert_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'avert\' (#916) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c8_b)
{
  ...
  if (chartInstance->c8_bmlsM_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'bmlsM\' (#918) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c8_b)
{
  ...
  if (chartInstance->c8_pr_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'pr\' (#906) in the initialization routine of the chart.\n");
  }
...
void sf_c8_DemoGazeFollowWaveIdle_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c8_DemoGazeFollowWaveIdle_get_autoinheritance_info(void)
{
...
mxArray *sf_c8_DemoGazeFollowWaveIdle_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c8_DemoGazeFollowWaveIdle_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c8_DemoGazeFollowWaveIdle(void)
{
  ...
  const char *infoEncStr[] = {
    ...
    "100 S1x6'type','srcId','name','auxInfo'{{M[3],M[111],T\"newBmlsL\",},{M[3],M[100],T\"newBmlsM\",},{M[3],M[75],T\"position\",},{M[8],M[0],T\"is_active_c8_DemoGazeFollowWaveIdle\",},{M[9],M[0],T\"is_c8_DemoGazeFollowWaveIdle\",},{M[11],M[33],T\"temporalCounter_i1\",S'et','os','ct'{{T\"ev\",M1x5[26 23 24 50 84],M[1]}}}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 16, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c8_DemoGazeFollowWaveIdle_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc8_DemoGazeFollowWaveIdleInstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_FCN(6,0,"insertQueueLowc8_DemoGazeFollowWaveIdle",0,-1,
                             568);
        ...
        _SFD_CV_INIT_EML_FCN(14,0,"walkInvadingTablec8_DemoGazeFollowWaveIdle",0,
                             -1,1351);
        ...
        _SFD_CV_INIT_EML_FCN(5,0,"insertQueuec8_DemoGazeFollowWaveIdle",0,-1,565);
...
static void sf_opaque_initialize_c8_DemoGazeFollowWaveIdle(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc8_DemoGazeFollowWaveIdleInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c8_DemoGazeFollowWaveIdle
    ((SFc8_DemoGazeFollowWaveIdleInstanceStruct*) chartInstanceVar);
  initialize_c8_DemoGazeFollowWaveIdle
    ((SFc8_DemoGazeFollowWaveIdleInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c8_DemoGazeFollowWaveIdle(void *chartInstanceVar)
{
  enable_c8_DemoGazeFollowWaveIdle((SFc8_DemoGazeFollowWaveIdleInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c8_DemoGazeFollowWaveIdle(void *chartInstanceVar)
{
  disable_c8_DemoGazeFollowWaveIdle((SFc8_DemoGazeFollowWaveIdleInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c8_DemoGazeFollowWaveIdle(void *chartInstanceVar)
{
  sf_gateway_c8_DemoGazeFollowWaveIdle
    ((SFc8_DemoGazeFollowWaveIdleInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c8_DemoGazeFollowWaveIdle
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c8_DemoGazeFollowWaveIdle
    ((SFc8_DemoGazeFollowWaveIdleInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c8_DemoGazeFollowWaveIdle();/* state var info */
...
extern void sf_internal_set_sim_state_c8_DemoGazeFollowWaveIdle(SimStruct* S,
  const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c8_DemoGazeFollowWaveIdle();/* state var info */
  ...
  set_sim_state_c8_DemoGazeFollowWaveIdle
    ((SFc8_DemoGazeFollowWaveIdleInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c8_DemoGazeFollowWaveIdle
  (SimStruct* S)
{
  return NULL;
}

static void sf_opaque_set_sim_state_c8_DemoGazeFollowWaveIdle(SimStruct* S,
  const mxArray *st)
{
}

static void sf_opaque_terminate_c8_DemoGazeFollowWaveIdle(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc8_DemoGazeFollowWaveIdleInstanceStruct*)
                    chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c8_DemoGazeFollowWaveIdle
      ((SFc8_DemoGazeFollowWaveIdleInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc8_DemoGazeFollowWaveIdle
    ((SFc8_DemoGazeFollowWaveIdleInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c8_DemoGazeFollowWaveIdle(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c8_DemoGazeFollowWaveIdle(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(3205660171U));
  ssSetChecksum1(S,(909789840U));
  ssSetChecksum2(S,(2346498683U));
  ssSetChecksum3(S,(2350844033U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c8_DemoGazeFollowWaveIdle(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c8_DemoGazeFollowWaveIdle(SimStruct *S)
{
  SFc8_DemoGazeFollowWaveIdleInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc8_DemoGazeFollowWaveIdleInstanceStruct *)utMalloc(sizeof
    (SFc8_DemoGazeFollowWaveIdleInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc8_DemoGazeFollowWaveIdleInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c8_DemoGazeFollowWaveIdle;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c8_DemoGazeFollowWaveIdle;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c8_DemoGazeFollowWaveIdle;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c8_DemoGazeFollowWaveIdle;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c8_DemoGazeFollowWaveIdle;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c8_DemoGazeFollowWaveIdle;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c8_DemoGazeFollowWaveIdle;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c8_DemoGazeFollowWaveIdle;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c8_DemoGazeFollowWaveIdle;
  chartInstance->chartInfo.mdlStart = mdlStart_c8_DemoGazeFollowWaveIdle;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c8_DemoGazeFollowWaveIdle;
...
void c8_DemoGazeFollowWaveIdle_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c8_DemoGazeFollowWaveIdle(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c8_DemoGazeFollowWaveIdle(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c8_DemoGazeFollowWaveIdle(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c8_DemoGazeFollowWaveIdle_method_dispatcher.\n"
