#ifndef __c9_DemoGazeFollowWaveIdle_h__
#define __c9_DemoGazeFollowWaveIdle_h__
...
/* Type Definitions */
#ifndef typedef_SFc9_DemoGazeFollowWaveIdleInstanceStruct
#define typedef_SFc9_DemoGazeFollowWaveIdleInstanceStruct
...
typedef struct {
  ...
  uint8_T c9_is_active_c9_DemoGazeFollowWaveIdle;
...
#endif                                 /*typedef_SFc9_DemoGazeFollowWaveIdleInstanceStruct*/
...
extern void sf_exported_auto_deactivate_c9_DemoGazeFollowWaveIdle_secs(SimStruct
  *c9_S);
extern boolean_T sf_exported_auto_isStablec9_DemoGazeFollowWaveIdle(SimStruct
  *c9_S);
extern void sf_exported_auto_duringc9_DemoGazeFollowWaveIdle(SimStruct *c9_S);
extern void sf_exported_auto_enterc9_DemoGazeFollowWaveIdle(SimStruct *c9_S);
extern void sf_exported_auto_exitc9_DemoGazeFollowWaveIdle(SimStruct *c9_S);
extern void sf_exported_auto_gatewayc9_DemoGazeFollowWaveIdle(SimStruct *c9_S);
extern void sf_exported_auto_enablec9_DemoGazeFollowWaveIdle(SimStruct *c9_S);
extern void sf_exported_auto_disablec9_DemoGazeFollowWaveIdle(SimStruct *c9_S);
...
extern void sf_exported_auto_initBuffersc9_DemoGazeFollowWaveIdle(SimStruct
  *c9_S);
extern void sf_exported_auto_activate_callc9_DemoGazeFollowWaveIdle(SimStruct
  *c9_S);
extern void sf_exported_auto_increment_call_counterc9_DemoGazeFollowWaveIdle
  (SimStruct *c9_S);
extern void sf_exported_auto_reset_call_counterc9_DemoGazeFollowWaveIdle
  (SimStruct *c9_S);
extern void sf_exported_auto_deactivate_callc9_DemoGazeFollowWaveIdle(SimStruct *
  c9_S);
extern void sf_exported_auto_initc9_DemoGazeFollowWaveIdle(SimStruct *c9_S);
...
extern void sf_internal_set_sim_state_c9_DemoGazeFollowWaveIdle(SimStruct *c9_S,
  const mxArray *c9_in);
extern void sf_exported_auto_check_state_inconsistency_c9_DemoGazeFollowWaveIdle
  (SimStruct *c9_S);
extern void sf_exported_user_c9_DemoGazeFollowWaveIdle_gazeFollowUserMove
  (SimStruct *c9_S, real_T c9_bmlID, real_T *c9_p, real_T c9_gazeBML[256]);
extern void sf_exported_user_c9_DemoGazeFollowWaveIdle_idleGazeFunction
  (SimStruct *c9_S, real_T c9_dir, real_T c9_mag, real_T c9_arrBML[256]);
extern void sf_exported_user_c9_DemoGazeFollowWaveIdle_idleGazeInterestedTable
  (SimStruct *c9_S, real_T c9_bmlID, real_T *c9_p, real_T c9_gazeBML[256]);
extern void sf_exported_user_c9_DemoGazeFollowWaveIdle_idleGazeTable(SimStruct
  *c9_S, real_T c9_bmlID, real_T *c9_p, real_T c9_gazeBML[256]);
extern void sf_exported_user_c9_DemoGazeFollowWaveIdle_insertQueueLow(SimStruct *
  c9_S, real_T c9_bmls[1280], real_T c9_myBML[256], real_T c9_newBmls[1280]);
extern void sf_exported_user_c9_DemoGazeFollowWaveIdle_successTable(SimStruct
...
extern void c9_DemoGazeFollowWaveIdle_method_dispatcher(SimStruct *S, int_T
  method, void *data);
