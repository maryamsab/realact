...
static void initialize_c5_EP_IdleRandMerg(SFc5_EP_IdleRandMergInstanceStruct
  *chartInstance);
static void initialize_params_c5_EP_IdleRandMerg
  (SFc5_EP_IdleRandMergInstanceStruct *chartInstance);
static void enable_c5_EP_IdleRandMerg(SFc5_EP_IdleRandMergInstanceStruct
  *chartInstance);
static void disable_c5_EP_IdleRandMerg(SFc5_EP_IdleRandMergInstanceStruct
  *chartInstance);
static void c5_update_debugger_state_c5_EP_IdleRandMerg
  (SFc5_EP_IdleRandMergInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c5_EP_IdleRandMerg
  (SFc5_EP_IdleRandMergInstanceStruct *chartInstance);
static void set_sim_state_c5_EP_IdleRandMerg(SFc5_EP_IdleRandMergInstanceStruct *
  chartInstance, const mxArray *c5_st);
static void c5_set_sim_state_side_effects_c5_EP_IdleRandMerg
  (SFc5_EP_IdleRandMergInstanceStruct *chartInstance);
static void finalize_c5_EP_IdleRandMerg(SFc5_EP_IdleRandMergInstanceStruct
  *chartInstance);
static void sf_gateway_c5_EP_IdleRandMerg(SFc5_EP_IdleRandMergInstanceStruct
  *chartInstance);
static void c5_enter_atomic_c5_EP_IdleRandMerg
  (SFc5_EP_IdleRandMergInstanceStruct *chartInstance);
static void c5_enter_internal_c5_EP_IdleRandMerg
  (SFc5_EP_IdleRandMergInstanceStruct *chartInstance);
static void c5_c5_EP_IdleRandMerg(SFc5_EP_IdleRandMergInstanceStruct
  *chartInstance);
static void c5_exit_internal_c5_EP_IdleRandMerg
  (SFc5_EP_IdleRandMergInstanceStruct *chartInstance);
static void c5_initc5_EP_IdleRandMerg(SFc5_EP_IdleRandMergInstanceStruct
  *chartInstance);
static void initSimStructsc5_EP_IdleRandMerg(SFc5_EP_IdleRandMergInstanceStruct *
  chartInstance);
static void c5_stateGame(SFc5_EP_IdleRandMergInstanceStruct *chartInstance);
static void c5_stateSt1(SFc5_EP_IdleRandMergInstanceStruct *chartInstance);
static void c5_enter_atomic_stateStart(SFc5_EP_IdleRandMergInstanceStruct
  *chartInstance);
static void c5_stateStart(SFc5_EP_IdleRandMergInstanceStruct *chartInstance);
static void c5_enter_atomic_saccadeFinish(SFc5_EP_IdleRandMergInstanceStruct
  *chartInstance);
static void c5_stateInit(SFc5_EP_IdleRandMergInstanceStruct *chartInstance);
static void c5_enter_atomic_gazeCamera(SFc5_EP_IdleRandMergInstanceStruct
  *chartInstance);
static void c5_enter_atomic_stateReady(SFc5_EP_IdleRandMergInstanceStruct
  *chartInstance);
static void c5_stateReady(SFc5_EP_IdleRandMergInstanceStruct *chartInstance);
static void c5_statePoseReady(SFc5_EP_IdleRandMergInstanceStruct *chartInstance);
static void c5_stateGo(SFc5_EP_IdleRandMergInstanceStruct *chartInstance);
static void c5_stateReadUserHand(SFc5_EP_IdleRandMergInstanceStruct
  *chartInstance);
static void c5_stateShowHands(SFc5_EP_IdleRandMergInstanceStruct *chartInstance);
static void c5_stateUserWin(SFc5_EP_IdleRandMergInstanceStruct *chartInstance);
static void c5_stateNoWin(SFc5_EP_IdleRandMergInstanceStruct *chartInstance);
static void c5_stateShowResult(SFc5_EP_IdleRandMergInstanceStruct *chartInstance);
static void c5_statePlayHand(SFc5_EP_IdleRandMergInstanceStruct *chartInstance);
static void c5_enter_atomic_statePoseRock(SFc5_EP_IdleRandMergInstanceStruct
  *chartInstance);
static void c5_enter_atomic_statePosePaper(SFc5_EP_IdleRandMergInstanceStruct
  *chartInstance);
static void c5_enter_atomic_statePoseScissors(SFc5_EP_IdleRandMergInstanceStruct
  *chartInstance);
static void c5_enter_atomic_stateAgentNotWin(SFc5_EP_IdleRandMergInstanceStruct *
  chartInstance);
static void c5_encStr2Arr(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  real_T c5_myarr256[1000]);
static void c5_b_encStr2Arr(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  real_T c5_myarr256[1000]);
static void c5_c_encStr2Arr(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  real_T c5_myarr256[1000]);
static void c5_d_encStr2Arr(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  real_T c5_myarr256[1000]);
static void c5_e_encStr2Arr(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  real_T c5_myarr256[1000]);
static void c5_f_encStr2Arr(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  real_T c5_myarr256[1000]);
static void c5_g_encStr2Arr(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  real_T c5_myarr256[1000]);
static void c5_h_encStr2Arr(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  real_T c5_myarr256[1000]);
static void c5_i_encStr2Arr(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  real_T c5_myarr256[1000]);
static void c5_j_encStr2Arr(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  real_T c5_myarr256[1000]);
static void c5_k_encStr2Arr(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  real_T c5_myarr256[1000]);
static void c5_l_encStr2Arr(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  real_T c5_myarr256[1000]);
static void c5_m_encStr2Arr(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  real_T c5_myarr256[1000]);
static void c5_n_encStr2Arr(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  real_T c5_myarr256[1000]);
static void c5_o_encStr2Arr(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  real_T c5_myarr256[1000]);
static void c5_p_encStr2Arr(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  real_T c5_myarr256[1000]);
static void c5_q_encStr2Arr(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  real_T c5_myarr256[1000]);
static void c5_r_encStr2Arr(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  real_T c5_myarr256[1000]);
static void c5_s_encStr2Arr(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  real_T c5_myarr256[1000]);
static void c5_t_encStr2Arr(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  real_T c5_myarr256[1000]);
static void c5_u_encStr2Arr(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  real_T c5_myarr256[1000]);
static void c5_v_encStr2Arr(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  real_T c5_myarr256[1000]);
static void c5_w_encStr2Arr(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  real_T c5_myarr256[1000]);
static void c5_x_encStr2Arr(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  real_T c5_myarr256[1000]);
static void c5_y_encStr2Arr(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  real_T c5_myarr256[1000]);
static void c5_ab_encStr2Arr(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  real_T c5_myarr256[1000]);
static void c5_bb_encStr2Arr(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  real_T c5_myarr256[1000]);
static void c5_cb_encStr2Arr(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  real_T c5_myarr256[1000]);
static void init_script_number_translation(uint32_T c5_machineNumber, uint32_T
  c5_chartNumber, uint32_T c5_instanceNumber);
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData);
static void c5_emlrt_marshallIn(SFc5_EP_IdleRandMergInstanceStruct
  *chartInstance, const mxArray *c5_newBmls, const char_T *c5_identifier, real_T
  c5_y[5000]);
static void c5_b_emlrt_marshallIn(SFc5_EP_IdleRandMergInstanceStruct
...
static const mxArray *c5_b_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static void c5_c_emlrt_marshallIn(SFc5_EP_IdleRandMergInstanceStruct
  *chartInstance, const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId,
  real_T c5_y[1000]);
...
static const mxArray *c5_c_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static real_T c5_d_emlrt_marshallIn(SFc5_EP_IdleRandMergInstanceStruct
  *chartInstance, const mxArray *c5_nargout, const char_T *c5_identifier);
static real_T c5_e_emlrt_marshallIn(SFc5_EP_IdleRandMergInstanceStruct
  *chartInstance, const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void c5_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static const mxArray *c5_d_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static void c5_f_emlrt_marshallIn(SFc5_EP_IdleRandMergInstanceStruct
  *chartInstance, const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId,
  real_T c5_y[1000]);
...
static const mxArray *c5_f_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static boolean_T c5_g_emlrt_marshallIn(SFc5_EP_IdleRandMergInstanceStruct
  *chartInstance, const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
...
static void c5_activate_secsc5_EP_IdleRandMerg
  (SFc5_EP_IdleRandMergInstanceStruct *chartInstance);
static void c5_deactivate_secsc5_EP_IdleRandMerg
  (SFc5_EP_IdleRandMergInstanceStruct *chartInstance);
static void c5_increment_counters_secsc5_EP_IdleRandMerg
  (SFc5_EP_IdleRandMergInstanceStruct *chartInstance);
static void c5_reset_counters_secsc5_EP_IdleRandMerg
  (SFc5_EP_IdleRandMergInstanceStruct *chartInstance);
static void c5_insertQueuec5_EP_IdleRandMerg(SFc5_EP_IdleRandMergInstanceStruct *
  chartInstance, real_T c5_bmls[5000], real_T c5_mBML[1000], real_T c5_newBmls
  [5000]);
static void c5_insertQueueLowc5_EP_IdleRandMerg
  (SFc5_EP_IdleRandMergInstanceStruct *chartInstance, real_T c5_bmls[5000],
   real_T c5_myBML[1000], real_T c5_newBmls[5000]);
static void c5_sendSBMc5_EP_IdleRandMerg(SFc5_EP_IdleRandMergInstanceStruct
  *chartInstance, real_T c5_arg[256]);
static void c5_rockPoseTablec5_EP_IdleRandMerg
  (SFc5_EP_IdleRandMergInstanceStruct *chartInstance, real_T c5_bmlID, real_T
   *c5_p, real_T c5_poseBML[1000]);
static void c5_paperPoseBradTablec5_EP_IdleRandMerg
  (SFc5_EP_IdleRandMergInstanceStruct *chartInstance, real_T c5_bmlID, real_T
   *c5_p, real_T c5_poseBML[1000]);
static void c5_scissorsPoseBradTablec5_EP_IdleRandMerg
  (SFc5_EP_IdleRandMergInstanceStruct *chartInstance, real_T c5_bmlID, real_T
   *c5_p, real_T c5_poseBML[1000]);
static void c5_handPoseSBTablec5_EP_IdleRandMerg
  (SFc5_EP_IdleRandMergInstanceStruct *chartInstance, real_T c5_sbmID, real_T
   c5_poseSBM[1000]);
static void c5_idlePoseBradTablec5_EP_IdleRandMerg
  (SFc5_EP_IdleRandMergInstanceStruct *chartInstance, real_T c5_bmlID, real_T
   *c5_p, real_T c5_poseBML[1000]);
static void c5_initialPoseTablec5_EP_IdleRandMerg
  (SFc5_EP_IdleRandMergInstanceStruct *chartInstance, real_T c5_bmlID, real_T
   *c5_p, real_T c5_poseBML[1000]);
static void c5_sendSBM(SFc5_EP_IdleRandMergInstanceStruct *chartInstance);
static void c5_b_sendSBM(SFc5_EP_IdleRandMergInstanceStruct *chartInstance);
static boolean_T c5_isequal(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  real_T c5_varargin_1[1000], real_T c5_varargin_2[1000]);
static const mxArray *c5_rb_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static int8_T c5_h_emlrt_marshallIn(SFc5_EP_IdleRandMergInstanceStruct
  *chartInstance, const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
...
static const mxArray *c5_sb_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static int32_T c5_i_emlrt_marshallIn(SFc5_EP_IdleRandMergInstanceStruct
  *chartInstance, const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
...
static const mxArray *c5_tb_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static uint8_T c5_j_emlrt_marshallIn(SFc5_EP_IdleRandMergInstanceStruct
  *chartInstance, const mxArray *c5_b_tp_stateGame, const char_T *c5_identifier);
static uint8_T c5_k_emlrt_marshallIn(SFc5_EP_IdleRandMergInstanceStruct
  *chartInstance, const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
...
static const mxArray *c5_vb_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static void c5_l_emlrt_marshallIn(SFc5_EP_IdleRandMergInstanceStruct
  *chartInstance, const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId,
  real_T c5_y[256]);
static void c5_i_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static uint32_T c5_m_emlrt_marshallIn(SFc5_EP_IdleRandMergInstanceStruct
  *chartInstance, const mxArray *c5_b_temporalCounter_i3, const char_T
  *c5_identifier);
static uint32_T c5_n_emlrt_marshallIn(SFc5_EP_IdleRandMergInstanceStruct
  *chartInstance, const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static const mxArray *c5_o_emlrt_marshallIn(SFc5_EP_IdleRandMergInstanceStruct
  *chartInstance, const mxArray *c5_b_setSimStateSideEffectsInfo, const char_T
  *c5_identifier);
static const mxArray *c5_p_emlrt_marshallIn(SFc5_EP_IdleRandMergInstanceStruct
  *chartInstance, const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void c5_updateDataWrittenToVector(SFc5_EP_IdleRandMergInstanceStruct
  *chartInstance, uint32_T c5_vectorIndex);
static void c5_errorIfDataNotWrittenToFcn(SFc5_EP_IdleRandMergInstanceStruct
  *chartInstance, uint32_T c5_vectorIndex, uint32_T c5_dataNumber);
static real_T c5_get_BML(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b);
static void c5_set_BML(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b, real_T c5_c);
static real_T *c5_access_BML(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b);
static real_T c5_get_BML2(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b);
static void c5_set_BML2(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b, real_T c5_c);
static real_T *c5_access_BML2(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b);
static real_T c5_get_BORED(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b);
static void c5_set_BORED(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b, real_T c5_c);
static real_T *c5_access_BORED(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b);
static real_T c5_get_BOREDOM_THRESHOLD(SFc5_EP_IdleRandMergInstanceStruct
  *chartInstance, uint32_T c5_b);
static void c5_set_BOREDOM_THRESHOLD(SFc5_EP_IdleRandMergInstanceStruct
  *chartInstance, uint32_T c5_b, real_T c5_c);
static real_T *c5_access_BOREDOM_THRESHOLD(SFc5_EP_IdleRandMergInstanceStruct
  *chartInstance, uint32_T c5_b);
static real_T c5_get_CONTEMPT(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b);
static void c5_set_CONTEMPT(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b, real_T c5_c);
static real_T *c5_access_CONTEMPT(SFc5_EP_IdleRandMergInstanceStruct
  *chartInstance, uint32_T c5_b);
static real_T c5_get_EXCITE(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b);
static void c5_set_EXCITE(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b, real_T c5_c);
static real_T *c5_access_EXCITE(SFc5_EP_IdleRandMergInstanceStruct
  *chartInstance, uint32_T c5_b);
static real_T c5_get_FEAR(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b);
static void c5_set_FEAR(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b, real_T c5_c);
static real_T *c5_access_FEAR(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b);
static real_T c5_get_FRUST(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b);
static void c5_set_FRUST(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b, real_T c5_c);
static real_T *c5_access_FRUST(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b);
static real_T c5_get_GAZE_GUI(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b);
static void c5_set_GAZE_GUI(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b, real_T c5_c);
static real_T *c5_access_GAZE_GUI(SFc5_EP_IdleRandMergInstanceStruct
  *chartInstance, uint32_T c5_b);
static real_T c5_get_GAZE_SOFTEYE(SFc5_EP_IdleRandMergInstanceStruct
  *chartInstance, uint32_T c5_b);
static void c5_set_GAZE_SOFTEYE(SFc5_EP_IdleRandMergInstanceStruct
  *chartInstance, uint32_T c5_b, real_T c5_c);
static real_T *c5_access_GAZE_SOFTEYE(SFc5_EP_IdleRandMergInstanceStruct
  *chartInstance, uint32_T c5_b);
static real_T c5_get_GAZE_USER_HAND(SFc5_EP_IdleRandMergInstanceStruct
  *chartInstance, uint32_T c5_b);
static void c5_set_GAZE_USER_HAND(SFc5_EP_IdleRandMergInstanceStruct
  *chartInstance, uint32_T c5_b, real_T c5_c);
static real_T *c5_access_GAZE_USER_HAND(SFc5_EP_IdleRandMergInstanceStruct
  *chartInstance, uint32_T c5_b);
static real_T c5_get_GAZE_WIN(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b);
static void c5_set_GAZE_WIN(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b, real_T c5_c);
static real_T *c5_access_GAZE_WIN(SFc5_EP_IdleRandMergInstanceStruct
  *chartInstance, uint32_T c5_b);
static real_T c5_get_HAPPY(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b);
static void c5_set_HAPPY(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b, real_T c5_c);
static real_T *c5_access_HAPPY(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b);
static real_T c5_get_IDLE(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b);
static void c5_set_IDLE(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b, real_T c5_c);
static real_T *c5_access_IDLE(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b);
static real_T c5_get_P(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b);
static void c5_set_P(SFc5_EP_IdleRandMergInstanceStruct *chartInstance, uint32_T
                     c5_b, real_T c5_c);
static real_T *c5_access_P(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b);
static real_T c5_get_SAD(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b);
static void c5_set_SAD(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b, real_T c5_c);
static real_T *c5_access_SAD(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b);
static real_T c5_get_STATE_BEFORE(SFc5_EP_IdleRandMergInstanceStruct
  *chartInstance, uint32_T c5_b);
static void c5_set_STATE_BEFORE(SFc5_EP_IdleRandMergInstanceStruct
  *chartInstance, uint32_T c5_b, real_T c5_c);
static real_T *c5_access_STATE_BEFORE(SFc5_EP_IdleRandMergInstanceStruct
  *chartInstance, uint32_T c5_b);
static real_T c5_get_STATE_GO(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b);
static void c5_set_STATE_GO(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b, real_T c5_c);
static real_T *c5_access_STATE_GO(SFc5_EP_IdleRandMergInstanceStruct
  *chartInstance, uint32_T c5_b);
static real_T c5_get_STATE_HAND(SFc5_EP_IdleRandMergInstanceStruct
  *chartInstance, uint32_T c5_b);
static void c5_set_STATE_HAND(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b, real_T c5_c);
static real_T *c5_access_STATE_HAND(SFc5_EP_IdleRandMergInstanceStruct
  *chartInstance, uint32_T c5_b);
static real_T c5_get_STATE_OVER(SFc5_EP_IdleRandMergInstanceStruct
  *chartInstance, uint32_T c5_b);
static void c5_set_STATE_OVER(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b, real_T c5_c);
static real_T *c5_access_STATE_OVER(SFc5_EP_IdleRandMergInstanceStruct
  *chartInstance, uint32_T c5_b);
static real_T c5_get_STATE_READY(SFc5_EP_IdleRandMergInstanceStruct
  *chartInstance, uint32_T c5_b);
static void c5_set_STATE_READY(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b, real_T c5_c);
static real_T *c5_access_STATE_READY(SFc5_EP_IdleRandMergInstanceStruct
  *chartInstance, uint32_T c5_b);
static real_T c5_get_STATE_RESULT(SFc5_EP_IdleRandMergInstanceStruct
  *chartInstance, uint32_T c5_b);
static void c5_set_STATE_RESULT(SFc5_EP_IdleRandMergInstanceStruct
  *chartInstance, uint32_T c5_b, real_T c5_c);
static real_T *c5_access_STATE_RESULT(SFc5_EP_IdleRandMergInstanceStruct
  *chartInstance, uint32_T c5_b);
static real_T c5_get_STATE_WAIT(SFc5_EP_IdleRandMergInstanceStruct
  *chartInstance, uint32_T c5_b);
static void c5_set_STATE_WAIT(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b, real_T c5_c);
static real_T *c5_access_STATE_WAIT(SFc5_EP_IdleRandMergInstanceStruct
  *chartInstance, uint32_T c5_b);
static real_T c5_get_avert(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b);
static void c5_set_avert(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b, real_T c5_c);
static real_T *c5_access_avert(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b);
static real_T c5_get_avertH(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b);
static void c5_set_avertH(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b, real_T c5_c);
static real_T *c5_access_avertH(SFc5_EP_IdleRandMergInstanceStruct
  *chartInstance, uint32_T c5_b);
static real_T c5_get_bHand(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b);
static void c5_set_bHand(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b, real_T c5_c);
static real_T *c5_access_bHand(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b);
static real_T c5_get_bmlsH(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b);
static void c5_set_bmlsH(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b, real_T c5_c);
static real_T *c5_access_bmlsH(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b);
static real_T c5_get_bmlsL(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b);
static void c5_set_bmlsL(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b, real_T c5_c);
static real_T *c5_access_bmlsL(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b);
static real_T c5_get_boredom(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b);
static void c5_set_boredom(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b, real_T c5_c);
static real_T *c5_access_boredom(SFc5_EP_IdleRandMergInstanceStruct
  *chartInstance, uint32_T c5_b);
static real_T c5_get_diff(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b);
static void c5_set_diff(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b, real_T c5_c);
static real_T *c5_access_diff(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b);
static real_T c5_get_fileID(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b);
static void c5_set_fileID(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b, real_T c5_c);
static real_T *c5_access_fileID(SFc5_EP_IdleRandMergInstanceStruct
  *chartInstance, uint32_T c5_b);
static real_T c5_get_gazing(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b);
static void c5_set_gazing(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b, real_T c5_c);
static real_T *c5_access_gazing(SFc5_EP_IdleRandMergInstanceStruct
  *chartInstance, uint32_T c5_b);
static real_T c5_get_n(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b);
static void c5_set_n(SFc5_EP_IdleRandMergInstanceStruct *chartInstance, uint32_T
                     c5_b, real_T c5_c);
static real_T *c5_access_n(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b);
static real_T c5_get_pa(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b);
static void c5_set_pa(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
                      uint32_T c5_b, real_T c5_c);
static real_T *c5_access_pa(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b);
static real_T c5_get_pr(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b);
static void c5_set_pr(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
                      uint32_T c5_b, real_T c5_c);
static real_T *c5_access_pr(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b);
static real_T c5_get_r(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b);
static void c5_set_r(SFc5_EP_IdleRandMergInstanceStruct *chartInstance, uint32_T
                     c5_b, real_T c5_c);
static real_T *c5_access_r(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b);
static real_T c5_get_randAvertGazeChance(SFc5_EP_IdleRandMergInstanceStruct
  *chartInstance, uint32_T c5_b);
static void c5_set_randAvertGazeChance(SFc5_EP_IdleRandMergInstanceStruct
  *chartInstance, uint32_T c5_b, real_T c5_c);
static real_T *c5_access_randAvertGazeChance(SFc5_EP_IdleRandMergInstanceStruct *
  chartInstance, uint32_T c5_b);
static real_T c5_get_randPoseChance(SFc5_EP_IdleRandMergInstanceStruct
  *chartInstance, uint32_T c5_b);
static void c5_set_randPoseChance(SFc5_EP_IdleRandMergInstanceStruct
  *chartInstance, uint32_T c5_b, real_T c5_c);
static real_T *c5_access_randPoseChance(SFc5_EP_IdleRandMergInstanceStruct
  *chartInstance, uint32_T c5_b);
static real_T c5_get_randSmile(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b);
static void c5_set_randSmile(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b, real_T c5_c);
static real_T *c5_access_randSmile(SFc5_EP_IdleRandMergInstanceStruct
  *chartInstance, uint32_T c5_b);
static real_T c5_get_s(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b);
static void c5_set_s(SFc5_EP_IdleRandMergInstanceStruct *chartInstance, uint32_T
                     c5_b, real_T c5_c);
static real_T *c5_access_s(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b);
static real_T c5_get_t(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b);
static void c5_set_t(SFc5_EP_IdleRandMergInstanceStruct *chartInstance, uint32_T
                     c5_b, real_T c5_c);
static real_T *c5_access_t(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b);
static real_T c5_get_temp(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b);
static void c5_set_temp(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b, real_T c5_c);
static real_T *c5_access_temp(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b);
static real_T c5_get_uHand(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b);
static void c5_set_uHand(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b, real_T c5_c);
static real_T *c5_access_uHand(SFc5_EP_IdleRandMergInstanceStruct *chartInstance,
  uint32_T c5_b);
static void init_dsm_address_info(SFc5_EP_IdleRandMergInstanceStruct
  *chartInstance);
  ...
  (SFc5_EP_IdleRandMergInstanceStruct *chartInstance)
{
  ...
  if (chartInstance->c5_is_active_c5_EP_IdleRandMerg == 1U) {
  ...
  (SFc5_EP_IdleRandMergInstanceStruct *chartInstance)
{
  ...
  c5_h_hoistedGlobal = chartInstance->c5_is_active_c5_EP_IdleRandMerg;
  ...
  chartInstance, const mxArray *c5_st)
{
  ...
  *c5_win = c5_d_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c5_u,
  ...
  chartInstance->c5_is_active_c5_EP_IdleRandMerg = c5_j_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c5_u, 9)),
     "is_active_c5_EP_IdleRandMerg");
  ...
  c5_update_debugger_state_c5_EP_IdleRandMerg(chartInstance);
...
static void sf_gateway_c5_EP_IdleRandMerg(SFc5_EP_IdleRandMergInstanceStruct
  *chartInstance)
{
  c5_set_sim_state_side_effects_c5_EP_IdleRandMerg(chartInstance);
}
  ...
  (SFc5_EP_IdleRandMergInstanceStruct *chartInstance)
{
  ...
  chartInstance->c5_is_active_c5_EP_IdleRandMerg = 1U;
  ...
  *chartInstance)
{
  ...
  chartInstance->c5_tp_stateRandomeHand = 0U;
  chartInstance->c5_tp_wait = 0U;
  chartInstance->c5_is_active_c5_EP_IdleRandMerg = 0U;
}
  ...
  *chartInstance)
{
  ...
  c5_initialPoseTablec5_EP_IdleRandMerg(chartInstance, 4.0, &c5_P, c5_BML);
  ...
  c5_insertQueuec5_EP_IdleRandMerg(chartInstance, c5_dv2, c5_dv3, c5_dv4);
  ...
  *chartInstance)
{
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_nargout, 1U, c5_c_sf_marshallOut,
    c5_c_sf_marshallIn);
  c5_initialPoseTablec5_EP_IdleRandMerg(chartInstance, 1.0, &c5_P, c5_BML2);
  c5_set_P(chartInstance, 0, c5_P);
  ssUpdateDataStoreLog(chartInstance->S, 14);
  ...
  c5_insertQueuec5_EP_IdleRandMerg(chartInstance, c5_dv5, c5_dv6, c5_dv7);
  ...
  *chartInstance)
{
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_nargout, 1U, c5_c_sf_marshallOut,
    c5_c_sf_marshallIn);
  c5_initialPoseTablec5_EP_IdleRandMerg(chartInstance, 2.0, &c5_P, c5_BML2);
  c5_set_P(chartInstance, 0, c5_P);
  ssUpdateDataStoreLog(chartInstance->S, 14);
  ...
  c5_insertQueuec5_EP_IdleRandMerg(chartInstance, c5_dv8, c5_dv9, c5_dv10);
  ...
  *chartInstance)
{
  ...
  c5_rockPoseTablec5_EP_IdleRandMerg(chartInstance, c5_get_r(chartInstance, 0),
    &c5_P, c5_BML2);
  c5_set_P(chartInstance, 0, c5_P);
  ssUpdateDataStoreLog(chartInstance->S, 14);
  ...
  c5_insertQueuec5_EP_IdleRandMerg(chartInstance, c5_dv11, c5_dv12, c5_dv13);
  ...
  *chartInstance)
{
  ...
  c5_paperPoseBradTablec5_EP_IdleRandMerg(chartInstance, c5_get_pa(chartInstance,
    0), &c5_P, c5_BML2);
  c5_set_P(chartInstance, 0, c5_P);
  ssUpdateDataStoreLog(chartInstance->S, 14);
  ...
  c5_insertQueuec5_EP_IdleRandMerg(chartInstance, c5_dv14, c5_dv15, c5_dv16);
  ...
  *chartInstance)
{
  ...
  c5_scissorsPoseBradTablec5_EP_IdleRandMerg(chartInstance, c5_get_s
  ...
  c5_insertQueuec5_EP_IdleRandMerg(chartInstance, c5_dv17, c5_dv18, c5_dv19);
  ...
  chartInstance)
{
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_nargout, 1U, c5_c_sf_marshallOut,
    c5_c_sf_marshallIn);
  c5_idlePoseBradTablec5_EP_IdleRandMerg(chartInstance, (*c5_randArray)[15],
    &c5_P, c5_BML);
  c5_set_P(chartInstance, 0, c5_P);
  ssUpdateDataStoreLog(chartInstance->S, 14);
  ...
  c5_insertQueueLowc5_EP_IdleRandMerg(chartInstance, c5_dv20, c5_dv21, c5_dv22);
...
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData)
{
  ...
  const mxArray *c5_y = NULL;
  SFc5_EP_IdleRandMergInstanceStruct *chartInstance;
  chartInstance = (SFc5_EP_IdleRandMergInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c5_EP_IdleRandMerg_get_eml_resolved_functions_info(void)
{
...
void sf_exported_auto_activate_c5_EP_IdleRandMerg_secs(SimStruct *c5_S)
{
  SFc5_EP_IdleRandMergInstanceStruct *chartInstance;
  chartInstance = (SFc5_EP_IdleRandMergInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c5_S))->instanceInfo)->chartInstance;
  c5_activate_secsc5_EP_IdleRandMerg(chartInstance);
}

void sf_exported_auto_incrementTemporalCounter_c5_EP_IdleRandMerg_secs(SimStruct
  *c5_S)
{
  SFc5_EP_IdleRandMergInstanceStruct *chartInstance;
  chartInstance = (SFc5_EP_IdleRandMergInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c5_S))->instanceInfo)->chartInstance;
  c5_increment_counters_secsc5_EP_IdleRandMerg(chartInstance);
}

void sf_exported_auto_resetTemporalCounter_c5_EP_IdleRandMerg_secs(SimStruct
  *c5_S)
{
  SFc5_EP_IdleRandMergInstanceStruct *chartInstance;
  chartInstance = (SFc5_EP_IdleRandMergInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c5_S))->instanceInfo)->chartInstance;
  c5_reset_counters_secsc5_EP_IdleRandMerg(chartInstance);
}

void sf_exported_auto_deactivate_c5_EP_IdleRandMerg_secs(SimStruct *c5_S)
{
  SFc5_EP_IdleRandMergInstanceStruct *chartInstance;
  chartInstance = (SFc5_EP_IdleRandMergInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c5_S))->instanceInfo)->chartInstance;
  c5_deactivate_secsc5_EP_IdleRandMerg(chartInstance);
}

boolean_T sf_exported_auto_isStablec5_EP_IdleRandMerg(SimStruct *c5_S)
{
  SFc5_EP_IdleRandMergInstanceStruct *chartInstance;
  chartInstance = (SFc5_EP_IdleRandMergInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c5_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_duringc5_EP_IdleRandMerg(SimStruct *c5_S)
{
  SFc5_EP_IdleRandMergInstanceStruct *chartInstance;
  chartInstance = (SFc5_EP_IdleRandMergInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c5_S))->instanceInfo)->chartInstance;
  c5_c5_EP_IdleRandMerg(chartInstance);
}

void sf_exported_auto_enterc5_EP_IdleRandMerg(SimStruct *c5_S)
{
  SFc5_EP_IdleRandMergInstanceStruct *chartInstance;
  chartInstance = (SFc5_EP_IdleRandMergInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c5_S))->instanceInfo)->chartInstance;
  ...
  c5_enter_atomic_c5_EP_IdleRandMerg(chartInstance);
  c5_enter_internal_c5_EP_IdleRandMerg(chartInstance);
}

void sf_exported_auto_exitc5_EP_IdleRandMerg(SimStruct *c5_S)
{
  SFc5_EP_IdleRandMergInstanceStruct *chartInstance;
  chartInstance = (SFc5_EP_IdleRandMergInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c5_S))->instanceInfo)->chartInstance;
  _sfTime_ = sf_get_time(chartInstance->S);
  c5_exit_internal_c5_EP_IdleRandMerg(chartInstance);
  c5_b_sendSBM(chartInstance);
}

void sf_exported_auto_gatewayc5_EP_IdleRandMerg(SimStruct *c5_S)
{
  SFc5_EP_IdleRandMergInstanceStruct *chartInstance;
  chartInstance = (SFc5_EP_IdleRandMergInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c5_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_enablec5_EP_IdleRandMerg(SimStruct *c5_S)
{
  SFc5_EP_IdleRandMergInstanceStruct *chartInstance;
  chartInstance = (SFc5_EP_IdleRandMergInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c5_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_disablec5_EP_IdleRandMerg(SimStruct *c5_S)
{
  SFc5_EP_IdleRandMergInstanceStruct *chartInstance;
  chartInstance = (SFc5_EP_IdleRandMergInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c5_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_stepBuffersc5_EP_IdleRandMerg(SimStruct *c5_S)
{
  SFc5_EP_IdleRandMergInstanceStruct *chartInstance;
  chartInstance = (SFc5_EP_IdleRandMergInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c5_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_initBuffersc5_EP_IdleRandMerg(SimStruct *c5_S)
{
  SFc5_EP_IdleRandMergInstanceStruct *chartInstance;
  chartInstance = (SFc5_EP_IdleRandMergInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c5_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_activate_callc5_EP_IdleRandMerg(SimStruct *c5_S)
{
  SFc5_EP_IdleRandMergInstanceStruct *chartInstance;
  chartInstance = (SFc5_EP_IdleRandMergInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c5_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_increment_call_counterc5_EP_IdleRandMerg(SimStruct *c5_S)
{
  SFc5_EP_IdleRandMergInstanceStruct *chartInstance;
  chartInstance = (SFc5_EP_IdleRandMergInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c5_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_reset_call_counterc5_EP_IdleRandMerg(SimStruct *c5_S)
{
  SFc5_EP_IdleRandMergInstanceStruct *chartInstance;
  chartInstance = (SFc5_EP_IdleRandMergInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c5_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_deactivate_callc5_EP_IdleRandMerg(SimStruct *c5_S)
{
  SFc5_EP_IdleRandMergInstanceStruct *chartInstance;
  chartInstance = (SFc5_EP_IdleRandMergInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c5_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_initc5_EP_IdleRandMerg(SimStruct *c5_S)
{
  SFc5_EP_IdleRandMergInstanceStruct *chartInstance;
  chartInstance = (SFc5_EP_IdleRandMergInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c5_S))->instanceInfo)->chartInstance;
  c5_initc5_EP_IdleRandMerg(chartInstance);
}

const mxArray *sf_exported_auto_getSimstatec5_EP_IdleRandMerg(SimStruct *c5_S)
{
  ...
  chartInstance = (SFc5_EP_IdleRandMergInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c5_S))->instanceInfo)->chartInstance;
  c5_out = NULL;
  sf_mex_assign(&c5_out, sf_internal_get_sim_state_c5_EP_IdleRandMerg(c5_S),
                false);
  return c5_out;
}

void sf_exported_auto_setSimstatec5_EP_IdleRandMerg(SimStruct *c5_S, const
  mxArray *c5_in)
{
  SFc5_EP_IdleRandMergInstanceStruct *chartInstance;
  chartInstance = (SFc5_EP_IdleRandMergInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c5_S))->instanceInfo)->chartInstance;
  sf_internal_set_sim_state_c5_EP_IdleRandMerg(c5_S, sf_mex_dup(c5_in));
  sf_mex_destroy(&c5_in);
}

void sf_exported_auto_check_state_inconsistency_c5_EP_IdleRandMerg(SimStruct
  *c5_S)
{
  SFc5_EP_IdleRandMergInstanceStruct *chartInstance;
  chartInstance = (SFc5_EP_IdleRandMergInstanceStruct *)((ChartInfoStruct *)
...
void sf_exported_user_c5_EP_IdleRandMerg_handPoseSBTable(SimStruct *c5_S, real_T
  c5_sbmID, real_T c5_poseSBM[1000])
{
  SFc5_EP_IdleRandMergInstanceStruct *chartInstance;
  chartInstance = (SFc5_EP_IdleRandMergInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c5_S))->instanceInfo)->chartInstance;
  c5_handPoseSBTablec5_EP_IdleRandMerg(chartInstance, c5_sbmID, c5_poseSBM);
}

void sf_exported_user_c5_EP_IdleRandMerg_idlePoseBradTable(SimStruct *c5_S,
  real_T c5_bmlID, real_T *c5_p, real_T c5_poseBML[1000])
{
  ...
  chartInstance = (SFc5_EP_IdleRandMergInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c5_S))->instanceInfo)->chartInstance;
  c5_idlePoseBradTablec5_EP_IdleRandMerg(chartInstance, c5_bmlID, &c5_b_p,
    c5_poseBML);
  *c5_p = c5_b_p;
}

void sf_exported_user_c5_EP_IdleRandMerg_initialPoseTable(SimStruct *c5_S,
  real_T c5_bmlID, real_T *c5_p, real_T c5_poseBML[1000])
{
  real_T c5_b_p;
  SFc5_EP_IdleRandMergInstanceStruct *chartInstance;
  chartInstance = (SFc5_EP_IdleRandMergInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c5_S))->instanceInfo)->chartInstance;
  c5_initialPoseTablec5_EP_IdleRandMerg(chartInstance, c5_bmlID, &c5_b_p,
    c5_poseBML);
  *c5_p = c5_b_p;
}

void sf_exported_user_c5_EP_IdleRandMerg_insertQueue(SimStruct *c5_S, real_T
  c5_bmls[5000], real_T c5_mBML[1000], real_T c5_newBmls[5000])
{
  ...
  c5_insertQueuec5_EP_IdleRandMerg(chartInstance, c5_b_bmls, c5_b_mBML,
    c5_newBmls);
}

void sf_exported_user_c5_EP_IdleRandMerg_insertQueueLow(SimStruct *c5_S, real_T
  c5_bmls[5000], real_T c5_myBML[1000], real_T c5_newBmls[5000])
{
  ...
  c5_insertQueueLowc5_EP_IdleRandMerg(chartInstance, c5_b_bmls, c5_b_myBML,
    c5_newBmls);
}

void sf_exported_user_c5_EP_IdleRandMerg_paperPoseBradTable(SimStruct *c5_S,
  real_T c5_bmlID, real_T *c5_p, real_T c5_poseBML[1000])
{
  real_T c5_b_p;
  SFc5_EP_IdleRandMergInstanceStruct *chartInstance;
  chartInstance = (SFc5_EP_IdleRandMergInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c5_S))->instanceInfo)->chartInstance;
  c5_paperPoseBradTablec5_EP_IdleRandMerg(chartInstance, c5_bmlID, &c5_b_p,
    c5_poseBML);
  *c5_p = c5_b_p;
}

void sf_exported_user_c5_EP_IdleRandMerg_rockPoseTable(SimStruct *c5_S, real_T
  c5_bmlID, real_T *c5_p, real_T c5_poseBML[1000])
{
  ...
  chartInstance = (SFc5_EP_IdleRandMergInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c5_S))->instanceInfo)->chartInstance;
  c5_rockPoseTablec5_EP_IdleRandMerg(chartInstance, c5_bmlID, &c5_b_p,
    c5_poseBML);
  *c5_p = c5_b_p;
}

void sf_exported_user_c5_EP_IdleRandMerg_scissorsPoseBradTable(SimStruct *c5_S,
  real_T c5_bmlID, real_T *c5_p, real_T c5_poseBML[1000])
{
  real_T c5_b_p;
  SFc5_EP_IdleRandMergInstanceStruct *chartInstance;
  chartInstance = (SFc5_EP_IdleRandMergInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c5_S))->instanceInfo)->chartInstance;
  c5_scissorsPoseBradTablec5_EP_IdleRandMerg(chartInstance, c5_bmlID, &c5_b_p,
    c5_poseBML);
  *c5_p = c5_b_p;
}

void sf_exported_user_c5_EP_IdleRandMerg_sendSBM(SimStruct *c5_S, real_T c5_arg
  [256])
{
  int32_T c5_i365;
  real_T c5_b_arg[256];
  ...
  c5_sendSBMc5_EP_IdleRandMerg(chartInstance, c5_b_arg);
}
  ...
  uint32_T c5_b)
{
  ...
  if (chartInstance->c5_BML_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'BML\' (#478) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c5_b)
{
  ...
  if (chartInstance->c5_BML2_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'BML2\' (#482) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c5_b)
{
  ...
  if (chartInstance->c5_BORED_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'BORED\' (#473) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c5_b)
{
  ...
  if (chartInstance->c5_BOREDOM_THRESHOLD_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'BOREDOM_THRESHOLD\' (#450) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c5_b)
{
  ...
  if (chartInstance->c5_CONTEMPT_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'CONTEMPT\' (#472) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c5_b)
{
  ...
  if (chartInstance->c5_EXCITE_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'EXCITE\' (#477) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c5_b)
{
  ...
  if (chartInstance->c5_FEAR_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'FEAR\' (#475) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c5_b)
{
  ...
  if (chartInstance->c5_FRUST_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'FRUST\' (#474) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c5_b)
{
  ...
  if (chartInstance->c5_GAZE_GUI_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'GAZE_GUI\' (#458) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c5_b)
{
  ...
  if (chartInstance->c5_GAZE_SOFTEYE_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'GAZE_SOFTEYE\' (#459) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c5_b)
{
  ...
  if (chartInstance->c5_GAZE_USER_HAND_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'GAZE_USER_HAND\' (#460) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c5_b)
{
  ...
  if (chartInstance->c5_GAZE_WIN_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'GAZE_WIN\' (#466) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c5_b)
{
  ...
  if (chartInstance->c5_HAPPY_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'HAPPY\' (#470) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c5_b)
{
  ...
  if (chartInstance->c5_IDLE_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'IDLE\' (#476) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c5_b)
{
  ...
  if (chartInstance->c5_P_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'P\' (#456) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c5_b)
{
  ...
  if (chartInstance->c5_SAD_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'SAD\' (#471) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c5_b)
{
  ...
  if (chartInstance->c5_STATE_BEFORE_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'STATE_BEFORE\' (#467) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c5_b)
{
  ...
  if (chartInstance->c5_STATE_HAND_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'STATE_HAND\' (#463) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c5_b)
{
  ...
  if (chartInstance->c5_STATE_OVER_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'STATE_OVER\' (#464) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c5_b)
{
  ...
  if (chartInstance->c5_STATE_READY_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'STATE_READY\' (#461) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c5_b)
{
  ...
  if (chartInstance->c5_STATE_RESULT_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'STATE_RESULT\' (#468) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c5_b)
{
  ...
  if (chartInstance->c5_STATE_WAIT_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'STATE_WAIT\' (#469) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c5_b)
{
  ...
  if (chartInstance->c5_avert_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'avert\' (#457) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c5_b)
{
  ...
  if (chartInstance->c5_avertH_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'avertH\' (#491) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c5_b)
{
  ...
  if (chartInstance->c5_bHand_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'bHand\' (#445) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c5_b)
{
  ...
  if (chartInstance->c5_bmlsH_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'bmlsH\' (#484) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c5_b)
{
  ...
  if (chartInstance->c5_bmlsL_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'bmlsL\' (#487) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c5_b)
{
  ...
  if (chartInstance->c5_boredom_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'boredom\' (#449) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c5_b)
{
  ...
  if (chartInstance->c5_diff_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'diff\' (#443) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c5_b)
{
  ...
  if (chartInstance->c5_fileID_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'fileID\' (#481) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c5_b)
{
  ...
  if (chartInstance->c5_gazing_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'gazing\' (#465) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c5_b)
{
  ...
  if (chartInstance->c5_n_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'n\' (#486) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c5_b)
{
  ...
  if (chartInstance->c5_pa_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'pa\' (#454) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c5_b)
{
  ...
  if (chartInstance->c5_pr_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'pr\' (#479) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c5_b)
{
  ...
  if (chartInstance->c5_r_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'r\' (#453) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c5_b)
{
  ...
  if (chartInstance->c5_randAvertGazeChance_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'randAvertGazeChance\' (#451) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c5_b)
{
  ...
  if (chartInstance->c5_randPoseChance_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'randPoseChance\' (#452) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c5_b)
{
  ...
  if (chartInstance->c5_randSmile_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'randSmile\' (#448) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c5_b)
{
  ...
  if (chartInstance->c5_s_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'s\' (#455) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c5_b)
{
  ...
  if (chartInstance->c5_t_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'t\' (#483) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c5_b)
{
  ...
  if (chartInstance->c5_temp_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'temp\' (#442) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c5_b)
{
  ...
  if (chartInstance->c5_uHand_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'uHand\' (#444) in the initialization routine of the chart.\n");
  }
...
void sf_c5_EP_IdleRandMerg_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c5_EP_IdleRandMerg_get_autoinheritance_info(void)
{
...
mxArray *sf_c5_EP_IdleRandMerg_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c5_EP_IdleRandMerg_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c5_EP_IdleRandMerg(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x10'type','srcId','name','auxInfo'{{M[1],M[114],T\"bWinT\",},{M[1],M[107],T\"bradHand\",},{M[1],M[105],T\"gameState\",},{M[1],M[148],T\"round\",},{M[1],M[115],T\"uWinT\",},{M[1],M[108],T\"userHand\",},{M[1],M[109],T\"win\",},{M[3],M[177],T\"newBmlsH\",},{M[3],M[180],T\"newBmlsL\",},{M[8],M[0],T\"is_active_c5_EP_IdleRandMerg\",}}",
  ...
  sf_c5_EP_IdleRandMerg_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc5_EP_IdleRandMergInstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_FCN(3,0,"insertQueuec5_EP_IdleRandMerg",0,-1,590);
        ...
        _SFD_CV_INIT_EML_FCN(4,0,"insertQueueLowc5_EP_IdleRandMerg",0,-1,597);
        ...
        _SFD_CV_INIT_EML_FCN(6,0,"rockPoseTablec5_EP_IdleRandMerg",0,-1,562);
        ...
        _SFD_CV_INIT_EML_FCN(5,0,"paperPoseBradTablec5_EP_IdleRandMerg",0,-1,571);
        ...
        _SFD_CV_INIT_EML_FCN(7,0,"scissorsPoseBradTablec5_EP_IdleRandMerg",0,-1,
                             583);
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"handPoseSBTablec5_EP_IdleRandMerg",0,-1,759);
        ...
        _SFD_CV_INIT_EML_FCN(1,0,"idlePoseBradTablec5_EP_IdleRandMerg",0,-1,2816);
        ...
        _SFD_CV_INIT_EML_FCN(2,0,"initialPoseTablec5_EP_IdleRandMerg",0,-1,690);
...
static void sf_opaque_initialize_c5_EP_IdleRandMerg(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc5_EP_IdleRandMergInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c5_EP_IdleRandMerg((SFc5_EP_IdleRandMergInstanceStruct*)
    chartInstanceVar);
  initialize_c5_EP_IdleRandMerg((SFc5_EP_IdleRandMergInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c5_EP_IdleRandMerg(void *chartInstanceVar)
{
  enable_c5_EP_IdleRandMerg((SFc5_EP_IdleRandMergInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c5_EP_IdleRandMerg(void *chartInstanceVar)
{
  disable_c5_EP_IdleRandMerg((SFc5_EP_IdleRandMergInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c5_EP_IdleRandMerg(void *chartInstanceVar)
{
  sf_gateway_c5_EP_IdleRandMerg((SFc5_EP_IdleRandMergInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c5_EP_IdleRandMerg(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c5_EP_IdleRandMerg
    ((SFc5_EP_IdleRandMergInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c5_EP_IdleRandMerg();/* state var info */
...
extern void sf_internal_set_sim_state_c5_EP_IdleRandMerg(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c5_EP_IdleRandMerg();/* state var info */
  ...
  set_sim_state_c5_EP_IdleRandMerg((SFc5_EP_IdleRandMergInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c5_EP_IdleRandMerg(SimStruct* S)
{
  return NULL;
}

static void sf_opaque_set_sim_state_c5_EP_IdleRandMerg(SimStruct* S, const
  mxArray *st)
{
}

static void sf_opaque_terminate_c5_EP_IdleRandMerg(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc5_EP_IdleRandMergInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c5_EP_IdleRandMerg((SFc5_EP_IdleRandMergInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc5_EP_IdleRandMerg((SFc5_EP_IdleRandMergInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c5_EP_IdleRandMerg(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c5_EP_IdleRandMerg(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(2032144503U));
  ssSetChecksum1(S,(2163674221U));
  ssSetChecksum2(S,(350143751U));
  ssSetChecksum3(S,(3232850114U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c5_EP_IdleRandMerg(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c5_EP_IdleRandMerg(SimStruct *S)
{
  SFc5_EP_IdleRandMergInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc5_EP_IdleRandMergInstanceStruct *)utMalloc(sizeof
    (SFc5_EP_IdleRandMergInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc5_EP_IdleRandMergInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c5_EP_IdleRandMerg;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c5_EP_IdleRandMerg;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c5_EP_IdleRandMerg;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c5_EP_IdleRandMerg;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c5_EP_IdleRandMerg;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c5_EP_IdleRandMerg;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c5_EP_IdleRandMerg;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c5_EP_IdleRandMerg;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c5_EP_IdleRandMerg;
  chartInstance->chartInfo.mdlStart = mdlStart_c5_EP_IdleRandMerg;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c5_EP_IdleRandMerg;
...
void c5_EP_IdleRandMerg_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c5_EP_IdleRandMerg(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c5_EP_IdleRandMerg(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c5_EP_IdleRandMerg(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c5_EP_IdleRandMerg_method_dispatcher.\n"
