...
static const char * c13_debug_family_names[10] = { "randTrigger", "nargin",
  "nargout", "randv", "smile", "wave", "win", "invade", "valenceTrig", "v_trigW"
};

/* Function Declarations */
static void initialize_c13_EP_IdleRandMerg(SFc13_EP_IdleRandMergInstanceStruct
  *chartInstance);
static void initialize_params_c13_EP_IdleRandMerg
  (SFc13_EP_IdleRandMergInstanceStruct *chartInstance);
static void enable_c13_EP_IdleRandMerg(SFc13_EP_IdleRandMergInstanceStruct
  *chartInstance);
static void disable_c13_EP_IdleRandMerg(SFc13_EP_IdleRandMergInstanceStruct
  *chartInstance);
static void c13_update_debugger_state_c13_EP_IdleRandMerg
  (SFc13_EP_IdleRandMergInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c13_EP_IdleRandMerg
  (SFc13_EP_IdleRandMergInstanceStruct *chartInstance);
static void set_sim_state_c13_EP_IdleRandMerg
  (SFc13_EP_IdleRandMergInstanceStruct *chartInstance, const mxArray *c13_st);
static void finalize_c13_EP_IdleRandMerg(SFc13_EP_IdleRandMergInstanceStruct
  *chartInstance);
static void sf_gateway_c13_EP_IdleRandMerg(SFc13_EP_IdleRandMergInstanceStruct
  *chartInstance);
static void initSimStructsc13_EP_IdleRandMerg
  (SFc13_EP_IdleRandMergInstanceStruct *chartInstance);
...
static const mxArray *c13_sf_marshallOut(void *chartInstanceVoid, void
  *c13_inData);
static real_T c13_emlrt_marshallIn(SFc13_EP_IdleRandMergInstanceStruct
  *chartInstance, const mxArray *c13_v_trigW, const char_T *c13_identifier);
static real_T c13_b_emlrt_marshallIn(SFc13_EP_IdleRandMergInstanceStruct
...
static const mxArray *c13_b_sf_marshallOut(void *chartInstanceVoid, void
  *c13_inData);
static int32_T c13_c_emlrt_marshallIn(SFc13_EP_IdleRandMergInstanceStruct
  *chartInstance, const mxArray *c13_u, const emlrtMsgIdentifier *c13_parentId);
static void c13_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c13_mxArrayInData, const char_T *c13_varName, void *c13_outData);
static uint8_T c13_d_emlrt_marshallIn(SFc13_EP_IdleRandMergInstanceStruct
  *chartInstance, const mxArray *c13_b_is_active_c13_EP_IdleRandMerg, const
  char_T *c13_identifier);
static uint8_T c13_e_emlrt_marshallIn(SFc13_EP_IdleRandMergInstanceStruct
  *chartInstance, const mxArray *c13_u, const emlrtMsgIdentifier *c13_parentId);
static void init_dsm_address_info(SFc13_EP_IdleRandMergInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c13_is_active_c13_EP_IdleRandMerg = 0U;
}
  ...
  (SFc13_EP_IdleRandMergInstanceStruct *chartInstance, const mxArray *c13_st)
{
  ...
  *c13_v_trigW = c13_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c13_u, 0)), "v_trigW");
  *c13_valenceTrig = c13_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c13_u, 1)), "valenceTrig");
  chartInstance->c13_is_active_c13_EP_IdleRandMerg = c13_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c13_u, 2)),
     "is_active_c13_EP_IdleRandMerg");
  sf_mex_destroy(&c13_u);
  c13_update_debugger_state_c13_EP_IdleRandMerg(chartInstance);
  ...
  *chartInstance)
{
  ...
  real_T *c13_b_win;
  real_T *c13_b_invade;
  real_T *c13_b_valenceTrig;
  real_T *c13_b_v_trigW;
  boolean_T guard1 = false;
  boolean_T guard2 = false;
  c13_b_v_trigW = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
  c13_b_valenceTrig = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c13_valenceTrig, 8U, c13_sf_marshallOut,
    c13_sf_marshallIn);
  ...
  if (CV_EML_IF(0, 1, 2, c13_win == 2.0)) {
    ...
    if (CV_EML_IF(0, 1, 3, c13_win == 1.0)) {
  ...
  if (CV_EML_IF(0, 1, 4, c13_smile == 1.0)) {
  ...
  if (CV_EML_IF(0, 1, 5, c13_wave == 1.0)) {
  ...
  if (CV_EML_IF(0, 1, 6, c13_invade == 1.0)) {
  ...
  *c13_b_valenceTrig = c13_valenceTrig;
  *c13_b_v_trigW = c13_v_trigW;
  ...
  _SFD_DATA_RANGE_CHECK(*c13_b_valenceTrig, 5U);
  ...
  *c13_inData)
{
  ...
  const mxArray *c13_y = NULL;
  SFc13_EP_IdleRandMergInstanceStruct *chartInstance;
  chartInstance = (SFc13_EP_IdleRandMergInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c13_EP_IdleRandMerg_get_eml_resolved_functions_info(void)
{
  const mxArray *c13_nameCaptureInfo = NULL;
  c13_nameCaptureInfo = NULL;
  sf_mex_assign(&c13_nameCaptureInfo, sf_mex_createstruct("structure", 2, 3, 1),
                false);
  ...
  char_T *c13_identifier)
{
  ...
  c13_y = c13_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c13_b_is_active_c13_EP_IdleRandMerg), &c13_thisId);
  sf_mex_destroy(&c13_b_is_active_c13_EP_IdleRandMerg);
  return c13_y;
}
...
void sf_c13_EP_IdleRandMerg_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1277339141U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1876373274U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(6977322U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3324855817U);
}

mxArray *sf_c13_EP_IdleRandMerg_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("TsggD4ImQouqmANQNMdalE");
...
mxArray *sf_c13_EP_IdleRandMerg_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c13_EP_IdleRandMerg_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c13_EP_IdleRandMerg(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[11],T\"v_trigW\",},{M[1],M[5],T\"valenceTrig\",},{M[8],M[0],T\"is_active_c13_EP_IdleRandMerg\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c13_EP_IdleRandMerg_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc13_EP_IdleRandMergInstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          _SFD_SET_DATA_PROPS(5,2,0,1,"valenceTrig");
        ...
        _SFD_CV_INIT_EML_IF(0,1,0,271,306,-1,349);
        _SFD_CV_INIT_EML_IF(0,1,1,354,390,-1,434);
        _SFD_CV_INIT_EML_IF(0,1,2,444,454,526,540);
        _SFD_CV_INIT_EML_IF(0,1,3,526,540,-1,540);
        _SFD_CV_INIT_EML_IF(0,1,4,627,639,-1,682);
        _SFD_CV_INIT_EML_IF(0,1,5,688,699,-1,742);
        _SFD_CV_INIT_EML_IF(0,1,6,748,761,-1,805);

        {
          static int condStart[] = { 274, 291 };

          static int condEnd[] = { 287, 305 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,0,273,306,2,0,&(condStart[0]),&(condEnd[0]),
                                3,&(pfixExpr[0]));
        }

        {
          static int condStart[] = { 357, 375 };

          static int condEnd[] = { 371, 389 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,1,356,390,2,2,&(condStart[0]),&(condEnd[0]),
                                3,&(pfixExpr[0]));
        }
...

        {
          ...
          _SFD_SET_DATA_VALUE_PTR(5U, c13_valenceTrig);
...
{
  return "G1wshu4n2GJ9JOVqNyVD0F";
}

static void sf_opaque_initialize_c13_EP_IdleRandMerg(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc13_EP_IdleRandMergInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c13_EP_IdleRandMerg((SFc13_EP_IdleRandMergInstanceStruct*)
    chartInstanceVar);
  initialize_c13_EP_IdleRandMerg((SFc13_EP_IdleRandMergInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c13_EP_IdleRandMerg(void *chartInstanceVar)
{
  enable_c13_EP_IdleRandMerg((SFc13_EP_IdleRandMergInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c13_EP_IdleRandMerg(void *chartInstanceVar)
{
  disable_c13_EP_IdleRandMerg((SFc13_EP_IdleRandMergInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c13_EP_IdleRandMerg(void *chartInstanceVar)
{
  sf_gateway_c13_EP_IdleRandMerg((SFc13_EP_IdleRandMergInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c13_EP_IdleRandMerg(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c13_EP_IdleRandMerg
    ((SFc13_EP_IdleRandMergInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c13_EP_IdleRandMerg();/* state var info */
...
extern void sf_internal_set_sim_state_c13_EP_IdleRandMerg(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c13_EP_IdleRandMerg();/* state var info */
  ...
  set_sim_state_c13_EP_IdleRandMerg((SFc13_EP_IdleRandMergInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c13_EP_IdleRandMerg(SimStruct* S)
{
  return sf_internal_get_sim_state_c13_EP_IdleRandMerg(S);
}

static void sf_opaque_set_sim_state_c13_EP_IdleRandMerg(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c13_EP_IdleRandMerg(S, st);
}

static void sf_opaque_terminate_c13_EP_IdleRandMerg(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc13_EP_IdleRandMergInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c13_EP_IdleRandMerg((SFc13_EP_IdleRandMergInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc13_EP_IdleRandMerg((SFc13_EP_IdleRandMergInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c13_EP_IdleRandMerg(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c13_EP_IdleRandMerg(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(1071629676U));
  ssSetChecksum1(S,(3085367973U));
  ssSetChecksum2(S,(315352503U));
  ssSetChecksum3(S,(3310661797U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c13_EP_IdleRandMerg(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c13_EP_IdleRandMerg(SimStruct *S)
{
  SFc13_EP_IdleRandMergInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc13_EP_IdleRandMergInstanceStruct *)utMalloc(sizeof
    (SFc13_EP_IdleRandMergInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc13_EP_IdleRandMergInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c13_EP_IdleRandMerg;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c13_EP_IdleRandMerg;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c13_EP_IdleRandMerg;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c13_EP_IdleRandMerg;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c13_EP_IdleRandMerg;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c13_EP_IdleRandMerg;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c13_EP_IdleRandMerg;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c13_EP_IdleRandMerg;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c13_EP_IdleRandMerg;
  chartInstance->chartInfo.mdlStart = mdlStart_c13_EP_IdleRandMerg;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c13_EP_IdleRandMerg;
...
void c13_EP_IdleRandMerg_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c13_EP_IdleRandMerg(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c13_EP_IdleRandMerg(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c13_EP_IdleRandMerg(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c13_EP_IdleRandMerg_method_dispatcher.\n"
