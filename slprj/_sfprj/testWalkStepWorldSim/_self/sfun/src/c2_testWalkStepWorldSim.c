...
static void initialize_c2_testWalkStepWorldSim
  (SFc2_testWalkStepWorldSimInstanceStruct *chartInstance);
static void initialize_params_c2_testWalkStepWorldSim
  (SFc2_testWalkStepWorldSimInstanceStruct *chartInstance);
static void enable_c2_testWalkStepWorldSim
  (SFc2_testWalkStepWorldSimInstanceStruct *chartInstance);
static void disable_c2_testWalkStepWorldSim
  (SFc2_testWalkStepWorldSimInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_testWalkStepWorldSim
  (SFc2_testWalkStepWorldSimInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_testWalkStepWorldSim
  (SFc2_testWalkStepWorldSimInstanceStruct *chartInstance);
static void set_sim_state_c2_testWalkStepWorldSim
  (SFc2_testWalkStepWorldSimInstanceStruct *chartInstance, const mxArray *c2_st);
static void finalize_c2_testWalkStepWorldSim
  (SFc2_testWalkStepWorldSimInstanceStruct *chartInstance);
static void sf_gateway_c2_testWalkStepWorldSim
  (SFc2_testWalkStepWorldSimInstanceStruct *chartInstance);
static void initSimStructsc2_testWalkStepWorldSim
  (SFc2_testWalkStepWorldSimInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber, uint32_T c2_instanceNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static real_T c2_emlrt_marshallIn(SFc2_testWalkStepWorldSimInstanceStruct
...
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_b_emlrt_marshallIn(SFc2_testWalkStepWorldSimInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_c_emlrt_marshallIn(SFc2_testWalkStepWorldSimInstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_testWalkStepWorldSim, const
  char_T *c2_identifier);
static uint8_T c2_d_emlrt_marshallIn(SFc2_testWalkStepWorldSimInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void init_dsm_address_info(SFc2_testWalkStepWorldSimInstanceStruct
  *chartInstance);
  ...
  (SFc2_testWalkStepWorldSimInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_testWalkStepWorldSim = 0U;
}
  ...
  (SFc2_testWalkStepWorldSimInstanceStruct *chartInstance)
{
  ...
  c2_hoistedGlobal = chartInstance->c2_is_active_c2_testWalkStepWorldSim;
  ...
  (SFc2_testWalkStepWorldSimInstanceStruct *chartInstance, const mxArray *c2_st)
{
  ...
  chartInstance->c2_is_active_c2_testWalkStepWorldSim = c2_c_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 0)),
     "is_active_c2_testWalkStepWorldSim");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_testWalkStepWorldSim(chartInstance);
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_testWalkStepWorldSimInstanceStruct *chartInstance;
  chartInstance = (SFc2_testWalkStepWorldSimInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c2_testWalkStepWorldSim_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c2_identifier)
{
  ...
  c2_y = c2_d_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_testWalkStepWorldSim), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_testWalkStepWorldSim);
  return c2_y;
}
...
void sf_c2_testWalkStepWorldSim_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c2_testWalkStepWorldSim_get_autoinheritance_info(void)
{
...
mxArray *sf_c2_testWalkStepWorldSim_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_testWalkStepWorldSim_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c2_testWalkStepWorldSim(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S'type','srcId','name','auxInfo'{{M[8],M[0],T\"is_active_c2_testWalkStepWorldSim\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 1, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_testWalkStepWorldSim_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc2_testWalkStepWorldSimInstanceStruct *)
...
static void sf_opaque_initialize_c2_testWalkStepWorldSim(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_testWalkStepWorldSimInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_testWalkStepWorldSim
    ((SFc2_testWalkStepWorldSimInstanceStruct*) chartInstanceVar);
  initialize_c2_testWalkStepWorldSim((SFc2_testWalkStepWorldSimInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c2_testWalkStepWorldSim(void *chartInstanceVar)
{
  enable_c2_testWalkStepWorldSim((SFc2_testWalkStepWorldSimInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c2_testWalkStepWorldSim(void *chartInstanceVar)
{
  disable_c2_testWalkStepWorldSim((SFc2_testWalkStepWorldSimInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c2_testWalkStepWorldSim(void *chartInstanceVar)
{
  sf_gateway_c2_testWalkStepWorldSim((SFc2_testWalkStepWorldSimInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_testWalkStepWorldSim
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_testWalkStepWorldSim
    ((SFc2_testWalkStepWorldSimInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_testWalkStepWorldSim();/* state var info */
...
extern void sf_internal_set_sim_state_c2_testWalkStepWorldSim(SimStruct* S,
  const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c2_testWalkStepWorldSim();/* state var info */
  ...
  set_sim_state_c2_testWalkStepWorldSim((SFc2_testWalkStepWorldSimInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c2_testWalkStepWorldSim(SimStruct*
  S)
{
  return sf_internal_get_sim_state_c2_testWalkStepWorldSim(S);
}

static void sf_opaque_set_sim_state_c2_testWalkStepWorldSim(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c2_testWalkStepWorldSim(S, st);
}

static void sf_opaque_terminate_c2_testWalkStepWorldSim(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_testWalkStepWorldSimInstanceStruct*) chartInstanceVar
      )->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c2_testWalkStepWorldSim((SFc2_testWalkStepWorldSimInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc2_testWalkStepWorldSim((SFc2_testWalkStepWorldSimInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_testWalkStepWorldSim(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ...
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c2_testWalkStepWorldSim
      ((SFc2_testWalkStepWorldSimInstanceStruct*)(chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c2_testWalkStepWorldSim(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c2_testWalkStepWorldSim(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_testWalkStepWorldSim(SimStruct *S)
{
  SFc2_testWalkStepWorldSimInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc2_testWalkStepWorldSimInstanceStruct *)utMalloc(sizeof
    (SFc2_testWalkStepWorldSimInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_testWalkStepWorldSimInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_testWalkStepWorldSim;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_testWalkStepWorldSim;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_testWalkStepWorldSim;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c2_testWalkStepWorldSim;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c2_testWalkStepWorldSim;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_testWalkStepWorldSim;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_testWalkStepWorldSim;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_testWalkStepWorldSim;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_testWalkStepWorldSim;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_testWalkStepWorldSim;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_testWalkStepWorldSim;
...
void c2_testWalkStepWorldSim_method_dispatcher(SimStruct *S, int_T method, void *
  data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_testWalkStepWorldSim(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_testWalkStepWorldSim(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_testWalkStepWorldSim(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_testWalkStepWorldSim_method_dispatcher.\n"
