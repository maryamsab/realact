...
static const char * c17_debug_family_names[19] = { "nargin", "nargout", "r1",
  "r2", "r3", "r4", "r5", "r6", "r7", "r8", "r9", "r10", "r11", "r12", "r13",
  "r14", "r15", "r16", "y" };

/* Function Declarations */
static void initialize_c17_testWalkStepWorldSim
  (SFc17_testWalkStepWorldSimInstanceStruct *chartInstance);
static void initialize_params_c17_testWalkStepWorldSim
  (SFc17_testWalkStepWorldSimInstanceStruct *chartInstance);
static void enable_c17_testWalkStepWorldSim
  (SFc17_testWalkStepWorldSimInstanceStruct *chartInstance);
static void disable_c17_testWalkStepWorldSim
  (SFc17_testWalkStepWorldSimInstanceStruct *chartInstance);
static void c17_update_debugger_state_c17_testWalkStepWorldSim
  (SFc17_testWalkStepWorldSimInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c17_testWalkStepWorldSim
  (SFc17_testWalkStepWorldSimInstanceStruct *chartInstance);
static void set_sim_state_c17_testWalkStepWorldSim
  (SFc17_testWalkStepWorldSimInstanceStruct *chartInstance, const mxArray
   *c17_st);
static void finalize_c17_testWalkStepWorldSim
  (SFc17_testWalkStepWorldSimInstanceStruct *chartInstance);
static void sf_gateway_c17_testWalkStepWorldSim
  (SFc17_testWalkStepWorldSimInstanceStruct *chartInstance);
static void initSimStructsc17_testWalkStepWorldSim
  (SFc17_testWalkStepWorldSimInstanceStruct *chartInstance);
...
static const mxArray *c17_sf_marshallOut(void *chartInstanceVoid, void
  *c17_inData);
static void c17_emlrt_marshallIn(SFc17_testWalkStepWorldSimInstanceStruct
  *chartInstance, const mxArray *c17_y, const char_T *c17_identifier, real_T
  c17_b_y[16]);
static void c17_b_emlrt_marshallIn(SFc17_testWalkStepWorldSimInstanceStruct
...
static const mxArray *c17_b_sf_marshallOut(void *chartInstanceVoid, void
  *c17_inData);
static real_T c17_c_emlrt_marshallIn(SFc17_testWalkStepWorldSimInstanceStruct
  *chartInstance, const mxArray *c17_u, const emlrtMsgIdentifier *c17_parentId);
...
static const mxArray *c17_c_sf_marshallOut(void *chartInstanceVoid, void
  *c17_inData);
static int32_T c17_d_emlrt_marshallIn(SFc17_testWalkStepWorldSimInstanceStruct
  *chartInstance, const mxArray *c17_u, const emlrtMsgIdentifier *c17_parentId);
static void c17_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c17_mxArrayInData, const char_T *c17_varName, void *c17_outData);
static uint8_T c17_e_emlrt_marshallIn(SFc17_testWalkStepWorldSimInstanceStruct
  *chartInstance, const mxArray *c17_b_is_active_c17_testWalkStepWorldSim, const
  char_T *c17_identifier);
static uint8_T c17_f_emlrt_marshallIn(SFc17_testWalkStepWorldSimInstanceStruct
  *chartInstance, const mxArray *c17_u, const emlrtMsgIdentifier *c17_parentId);
static void init_dsm_address_info(SFc17_testWalkStepWorldSimInstanceStruct
  *chartInstance);
  ...
  (SFc17_testWalkStepWorldSimInstanceStruct *chartInstance)
{
  ...
  chartInstance->c17_is_active_c17_testWalkStepWorldSim = 0U;
}
  ...
  (SFc17_testWalkStepWorldSimInstanceStruct *chartInstance)
{
  ...
  real_T (*c17_d_y)[16];
  c17_d_y = (real_T (*)[16])ssGetOutputPortSignal(chartInstance->S, 1);
  c17_st = NULL;
  c17_st = NULL;
  c17_y = NULL;
  ...
  c17_hoistedGlobal = chartInstance->c17_is_active_c17_testWalkStepWorldSim;
   ...
   *c17_st)
{
  ...
  int32_T c17_i1;
  real_T (*c17_y)[16];
  c17_y = (real_T (*)[16])ssGetOutputPortSignal(chartInstance->S, 1);
  ...
  chartInstance->c17_is_active_c17_testWalkStepWorldSim = c17_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c17_u, 1)),
     "is_active_c17_testWalkStepWorldSim");
  sf_mex_destroy(&c17_u);
  c17_update_debugger_state_c17_testWalkStepWorldSim(chartInstance);
  ...
  (SFc17_testWalkStepWorldSimInstanceStruct *chartInstance)
{
  ...
  real_T c17_r15;
  real_T c17_r16;
  uint32_T c17_debug_family_var_map[19];
  real_T c17_nargin = 16.0;
  ...
  c17_b_y = (real_T (*)[16])ssGetOutputPortSignal(chartInstance->S, 1);
  ...
  _SFD_DATA_RANGE_CHECK(*c17_b_r1, 0U);
  chartInstance->c17_sfEvent = CALL_EVENT;
  ...
  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 19U, 19U, c17_debug_family_names,
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c17_y, 18U, c17_sf_marshallOut,
    c17_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  for (c17_i3 = 0; c17_i3 < 16; c17_i3++) {
    (*c17_b_y)[c17_i3] = c17_y[c17_i3];
  }
  ...
  for (c17_i4 = 0; c17_i4 < 16; c17_i4++) {
    _SFD_DATA_RANGE_CHECK((*c17_b_y)[c17_i4], 1U);
  }

  _SFD_DATA_RANGE_CHECK(*c17_b_r2, 2U);
  _SFD_DATA_RANGE_CHECK(*c17_b_r3, 3U);
  _SFD_DATA_RANGE_CHECK(*c17_b_r4, 4U);
  _SFD_DATA_RANGE_CHECK(*c17_b_r5, 5U);
  _SFD_DATA_RANGE_CHECK(*c17_b_r6, 6U);
  _SFD_DATA_RANGE_CHECK(*c17_b_r7, 7U);
  _SFD_DATA_RANGE_CHECK(*c17_b_r8, 8U);
  _SFD_DATA_RANGE_CHECK(*c17_b_r9, 9U);
  _SFD_DATA_RANGE_CHECK(*c17_b_r10, 10U);
  _SFD_DATA_RANGE_CHECK(*c17_b_r11, 11U);
  _SFD_DATA_RANGE_CHECK(*c17_b_r12, 12U);
  _SFD_DATA_RANGE_CHECK(*c17_b_r13, 13U);
  _SFD_DATA_RANGE_CHECK(*c17_b_r14, 14U);
  _SFD_DATA_RANGE_CHECK(*c17_b_r15, 15U);
  _SFD_DATA_RANGE_CHECK(*c17_b_r16, 16U);
}
  ...
  *c17_inData)
{
  ...
  const mxArray *c17_y = NULL;
  SFc17_testWalkStepWorldSimInstanceStruct *chartInstance;
  chartInstance = (SFc17_testWalkStepWorldSimInstanceStruct *)chartInstanceVoid;
  c17_mxArrayOutData = NULL;
  for (c17_i5 = 0; c17_i5 < 16; c17_i5++) {
    c17_b_inData[c17_i5] = (*(real_T (*)[16])c17_inData)[c17_i5];
  }
  ...
  c17_y = NULL;
  sf_mex_assign(&c17_y, sf_mex_create("y", c17_u, 0, 0U, 1U, 0U, 2, 1, 16),
                false);
  ...
  *c17_mxArrayInData, const char_T *c17_varName, void *c17_outData)
{
  ...
  for (c17_i8 = 0; c17_i8 < 16; c17_i8++) {
    (*(real_T (*)[16])c17_outData)[c17_i8] = c17_b_y[c17_i8];
  }
...
const mxArray *sf_c17_testWalkStepWorldSim_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c17_identifier)
{
  ...
  c17_y = c17_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c17_b_is_active_c17_testWalkStepWorldSim), &c17_thisId);
  sf_mex_destroy(&c17_b_is_active_c17_testWalkStepWorldSim);
  return c17_y;
}
...
void sf_c17_testWalkStepWorldSim_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1568981467U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3956912064U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3229870273U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3740617148U);
}

mxArray *sf_c17_testWalkStepWorldSim_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("NXVeltQjg4PvjVsETVb4WE");
...
mxArray *sf_c17_testWalkStepWorldSim_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c17_testWalkStepWorldSim_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c17_testWalkStepWorldSim(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c17_testWalkStepWorldSim\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c17_testWalkStepWorldSim_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc17_testWalkStepWorldSimInstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,454);
...
{
  return "CX0smq9DsvPN01F4gVOgo";
}

static void sf_opaque_initialize_c17_testWalkStepWorldSim(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc17_testWalkStepWorldSimInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c17_testWalkStepWorldSim
    ((SFc17_testWalkStepWorldSimInstanceStruct*) chartInstanceVar);
  initialize_c17_testWalkStepWorldSim((SFc17_testWalkStepWorldSimInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c17_testWalkStepWorldSim(void *chartInstanceVar)
{
  enable_c17_testWalkStepWorldSim((SFc17_testWalkStepWorldSimInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c17_testWalkStepWorldSim(void *chartInstanceVar)
{
  disable_c17_testWalkStepWorldSim((SFc17_testWalkStepWorldSimInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c17_testWalkStepWorldSim(void *chartInstanceVar)
{
  sf_gateway_c17_testWalkStepWorldSim((SFc17_testWalkStepWorldSimInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c17_testWalkStepWorldSim
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c17_testWalkStepWorldSim
    ((SFc17_testWalkStepWorldSimInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c17_testWalkStepWorldSim();/* state var info */
...
extern void sf_internal_set_sim_state_c17_testWalkStepWorldSim(SimStruct* S,
  const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c17_testWalkStepWorldSim();/* state var info */
  ...
  set_sim_state_c17_testWalkStepWorldSim
    ((SFc17_testWalkStepWorldSimInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c17_testWalkStepWorldSim(SimStruct*
  S)
{
  return sf_internal_get_sim_state_c17_testWalkStepWorldSim(S);
}

static void sf_opaque_set_sim_state_c17_testWalkStepWorldSim(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c17_testWalkStepWorldSim(S, st);
}

static void sf_opaque_terminate_c17_testWalkStepWorldSim(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc17_testWalkStepWorldSimInstanceStruct*) chartInstanceVar)
      ->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c17_testWalkStepWorldSim((SFc17_testWalkStepWorldSimInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc17_testWalkStepWorldSim
    ((SFc17_testWalkStepWorldSimInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c17_testWalkStepWorldSim(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c17_testWalkStepWorldSim(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(3511240392U));
  ssSetChecksum1(S,(1281176494U));
  ssSetChecksum2(S,(674365841U));
  ssSetChecksum3(S,(2959066837U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c17_testWalkStepWorldSim(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c17_testWalkStepWorldSim(SimStruct *S)
{
  SFc17_testWalkStepWorldSimInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc17_testWalkStepWorldSimInstanceStruct *)utMalloc(sizeof
    (SFc17_testWalkStepWorldSimInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc17_testWalkStepWorldSimInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c17_testWalkStepWorldSim;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c17_testWalkStepWorldSim;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c17_testWalkStepWorldSim;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c17_testWalkStepWorldSim;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c17_testWalkStepWorldSim;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c17_testWalkStepWorldSim;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c17_testWalkStepWorldSim;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c17_testWalkStepWorldSim;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c17_testWalkStepWorldSim;
  chartInstance->chartInfo.mdlStart = mdlStart_c17_testWalkStepWorldSim;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c17_testWalkStepWorldSim;
...
void c17_testWalkStepWorldSim_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c17_testWalkStepWorldSim(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c17_testWalkStepWorldSim(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c17_testWalkStepWorldSim(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c17_testWalkStepWorldSim_method_dispatcher.\n"
