#ifndef __c42_Demo_Shore_h__
#define __c42_Demo_Shore_h__
...
/* Type Definitions */
#ifndef typedef_SFc42_Demo_ShoreInstanceStruct
#define typedef_SFc42_Demo_ShoreInstanceStruct
...
typedef struct {
  ...
  uint8_T c42_is_active_c42_Demo_Shore;
  uint8_T c42_is_c42_Demo_Shore;
...
#endif                                 /*typedef_SFc42_Demo_ShoreInstanceStruct*/
...
extern const mxArray *sf_c42_Demo_Shore_get_eml_resolved_functions_info(void);
extern boolean_T sf_exported_auto_isStablec42_Demo_Shore(SimStruct *c42_S);
extern void sf_exported_auto_duringc42_Demo_Shore(SimStruct *c42_S);
extern void sf_exported_auto_enterc42_Demo_Shore(SimStruct *c42_S);
extern void sf_exported_auto_enablec46_lib_affectiveChar_behavior(SimStruct
  *c42_S);
extern void sf_exported_auto_exitc42_Demo_Shore(SimStruct *c42_S);
extern void sf_exported_auto_disablec46_lib_affectiveChar_behavior(SimStruct
  *c42_S);
extern void sf_exported_auto_gatewayc42_Demo_Shore(SimStruct *c42_S);
extern void sf_exported_auto_gatewayc46_lib_affectiveChar_behavior(SimStruct
  *c42_S);
extern void sf_exported_auto_enablec42_Demo_Shore(SimStruct *c42_S);
extern void sf_exported_auto_enablec46_lib_affectiveChar_behavior(SimStruct
  *c42_S);
extern void sf_exported_auto_disablec42_Demo_Shore(SimStruct *c42_S);
extern void sf_exported_auto_disablec46_lib_affectiveChar_behavior(SimStruct
  *c42_S);
extern void sf_exported_auto_stepBuffersc42_Demo_Shore(SimStruct *c42_S);
extern void sf_exported_auto_stepBuffersc46_lib_affectiveChar_behavior(SimStruct
  *c42_S);
extern void sf_exported_auto_initBuffersc42_Demo_Shore(SimStruct *c42_S);
extern void sf_exported_auto_initBuffersc46_lib_affectiveChar_behavior(SimStruct
  *c42_S);
extern void sf_exported_auto_activate_callc42_Demo_Shore(SimStruct *c42_S);
extern void sf_exported_auto_activate_callc46_lib_affectiveChar_behavior
  (SimStruct *c42_S);
extern void sf_exported_auto_increment_call_counterc42_Demo_Shore(SimStruct
  *c42_S);
extern void
  sf_exported_auto_increment_call_counterc46_lib_affectiveChar_behavior
  (SimStruct *c42_S);
extern void sf_exported_auto_reset_call_counterc42_Demo_Shore(SimStruct *c42_S);
extern void sf_exported_auto_reset_call_counterc46_lib_affectiveChar_behavior
  (SimStruct *c42_S);
extern void sf_exported_auto_deactivate_callc42_Demo_Shore(SimStruct *c42_S);
extern void sf_exported_auto_deactivate_callc46_lib_affectiveChar_behavior
  (SimStruct *c42_S);
extern void sf_exported_auto_initc42_Demo_Shore(SimStruct *c42_S);
extern const mxArray *sf_exported_auto_getSimstatec42_Demo_Shore(SimStruct
  *c42_S);
extern const mxArray *sf_internal_get_sim_state_c42_Demo_Shore(SimStruct *c42_S);
extern void sf_exported_auto_setSimstatec42_Demo_Shore(SimStruct *c42_S, const
  mxArray *c42_in);
extern void sf_internal_set_sim_state_c42_Demo_Shore(SimStruct *c42_S, const
  mxArray *c42_in);
...
extern void c42_Demo_Shore_method_dispatcher(SimStruct *S, int_T method, void
  *data);
