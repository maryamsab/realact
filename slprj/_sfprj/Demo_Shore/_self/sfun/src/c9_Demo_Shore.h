#ifndef __c9_Demo_Shore_h__
#define __c9_Demo_Shore_h__
...
/* Type Definitions */
#ifndef typedef_SFc9_Demo_ShoreInstanceStruct
#define typedef_SFc9_Demo_ShoreInstanceStruct
...
typedef struct {
  ...
  uint8_T c9_is_active_c9_Demo_Shore;
...
#endif                                 /*typedef_SFc9_Demo_ShoreInstanceStruct*/
...
extern const mxArray *sf_c9_Demo_Shore_get_eml_resolved_functions_info(void);
extern void sf_exported_auto_activate_c9_Demo_Shore_secs(SimStruct *c9_S);
...
extern void sf_exported_auto_resetTemporalCounter_c9_Demo_Shore_secs(SimStruct
  *c9_S);
extern void sf_exported_auto_deactivate_c9_Demo_Shore_secs(SimStruct *c9_S);
extern boolean_T sf_exported_auto_isStablec9_Demo_Shore(SimStruct *c9_S);
extern void sf_exported_auto_duringc9_Demo_Shore(SimStruct *c9_S);
extern void sf_exported_auto_enterc9_Demo_Shore(SimStruct *c9_S);
extern void sf_exported_auto_exitc9_Demo_Shore(SimStruct *c9_S);
extern void sf_exported_auto_gatewayc9_Demo_Shore(SimStruct *c9_S);
extern void sf_exported_auto_enablec9_Demo_Shore(SimStruct *c9_S);
extern void sf_exported_auto_disablec9_Demo_Shore(SimStruct *c9_S);
extern void sf_exported_auto_stepBuffersc9_Demo_Shore(SimStruct *c9_S);
extern void sf_exported_auto_initBuffersc9_Demo_Shore(SimStruct *c9_S);
extern void sf_exported_auto_activate_callc9_Demo_Shore(SimStruct *c9_S);
extern void sf_exported_auto_increment_call_counterc9_Demo_Shore(SimStruct *c9_S);
extern void sf_exported_auto_reset_call_counterc9_Demo_Shore(SimStruct *c9_S);
extern void sf_exported_auto_deactivate_callc9_Demo_Shore(SimStruct *c9_S);
extern void sf_exported_auto_initc9_Demo_Shore(SimStruct *c9_S);
extern const mxArray *sf_exported_auto_getSimstatec9_Demo_Shore(SimStruct *c9_S);
extern const mxArray *sf_internal_get_sim_state_c9_Demo_Shore(SimStruct *c9_S);
extern void sf_exported_auto_setSimstatec9_Demo_Shore(SimStruct *c9_S, const
  mxArray *c9_in);
extern void sf_internal_set_sim_state_c9_Demo_Shore(SimStruct *c9_S, const
  mxArray *c9_in);
extern void sf_exported_auto_check_state_inconsistency_c9_Demo_Shore(SimStruct
  *c9_S);
extern void sf_exported_user_c9_Demo_Shore_gazeFollowUserMove(SimStruct *c9_S,
  real_T c9_bmlID, real_T *c9_p, real_T c9_gazeBML[1000]);
extern void sf_exported_user_c9_Demo_Shore_idleFastGazeTable(SimStruct *c9_S,
  real_T c9_bmlID, real_T *c9_p, real_T c9_gazeBML[1000]);
extern void sf_exported_user_c9_Demo_Shore_idleGazeFunction(SimStruct *c9_S,
  real_T c9_dir, real_T c9_mag, real_T c9_dirChance, real_T c9_arrBML[1000]);
extern void sf_exported_user_c9_Demo_Shore_idleGazeInterestedTable(SimStruct
  *c9_S, real_T c9_bmlID, real_T *c9_p, real_T c9_gazeBML[1000]);
extern void sf_exported_user_c9_Demo_Shore_idleGazeOrigFunction(SimStruct *c9_S,
  real_T c9_dir, real_T c9_mag, real_T c9_arrBML[1000]);
extern void sf_exported_user_c9_Demo_Shore_idleGazeTable(SimStruct *c9_S, real_T
  c9_bmlID, real_T *c9_p, real_T c9_gazeBML[1000]);
extern void sf_exported_user_c9_Demo_Shore_idleNormalGazeTable(SimStruct *c9_S,
  real_T c9_bmlID, real_T *c9_p, real_T c9_gazeBML[1000]);
extern void sf_exported_user_c9_Demo_Shore_idleSlowGazeTable(SimStruct *c9_S,
  real_T c9_bmlID, real_T *c9_p, real_T c9_gazeBML[1000]);
extern void sf_exported_user_c9_Demo_Shore_insertQueueLow(SimStruct *c9_S,
  real_T c9_bmls[5000], real_T c9_myBML[1000], real_T c9_newBmls[5000]);
extern void sf_exported_user_c9_Demo_Shore_successTable(SimStruct *c9_S, real_T
  c9_bmlID, real_T *c9_p, real_T c9_poseBML[1000]);

/* Function Definitions */
extern void sf_c9_Demo_Shore_get_check_sum(mxArray *plhs[]);
extern void c9_Demo_Shore_method_dispatcher(SimStruct *S, int_T method, void
  *data);
