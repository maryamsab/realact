...
static void initialize_c14_Demo_Shore(SFc14_Demo_ShoreInstanceStruct
  *chartInstance);
static void initialize_params_c14_Demo_Shore(SFc14_Demo_ShoreInstanceStruct
  *chartInstance);
static void enable_c14_Demo_Shore(SFc14_Demo_ShoreInstanceStruct *chartInstance);
static void disable_c14_Demo_Shore(SFc14_Demo_ShoreInstanceStruct *chartInstance);
static void c14_update_debugger_state_c14_Demo_Shore
  (SFc14_Demo_ShoreInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c14_Demo_Shore
  (SFc14_Demo_ShoreInstanceStruct *chartInstance);
static void set_sim_state_c14_Demo_Shore(SFc14_Demo_ShoreInstanceStruct
  *chartInstance, const mxArray *c14_st);
static void finalize_c14_Demo_Shore(SFc14_Demo_ShoreInstanceStruct
  *chartInstance);
static void sf_gateway_c14_Demo_Shore(SFc14_Demo_ShoreInstanceStruct
  *chartInstance);
static void initSimStructsc14_Demo_Shore(SFc14_Demo_ShoreInstanceStruct
  *chartInstance);
...
static const mxArray *c14_sf_marshallOut(void *chartInstanceVoid, void
  *c14_inData);
static real_T c14_emlrt_marshallIn(SFc14_Demo_ShoreInstanceStruct *chartInstance,
  const mxArray *c14_a_trigW, const char_T *c14_identifier);
static real_T c14_b_emlrt_marshallIn(SFc14_Demo_ShoreInstanceStruct
...
static const mxArray *c14_c_sf_marshallOut(void *chartInstanceVoid, void
  *c14_inData);
static int32_T c14_c_emlrt_marshallIn(SFc14_Demo_ShoreInstanceStruct
  *chartInstance, const mxArray *c14_u, const emlrtMsgIdentifier *c14_parentId);
static void c14_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c14_mxArrayInData, const char_T *c14_varName, void *c14_outData);
static uint8_T c14_d_emlrt_marshallIn(SFc14_Demo_ShoreInstanceStruct
  *chartInstance, const mxArray *c14_b_is_active_c14_Demo_Shore, const char_T
  *c14_identifier);
static uint8_T c14_e_emlrt_marshallIn(SFc14_Demo_ShoreInstanceStruct
  *chartInstance, const mxArray *c14_u, const emlrtMsgIdentifier *c14_parentId);
static void init_dsm_address_info(SFc14_Demo_ShoreInstanceStruct *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c14_is_active_c14_Demo_Shore = 0U;
}
  ...
  (SFc14_Demo_ShoreInstanceStruct *chartInstance)
{
  ...
  c14_c_hoistedGlobal = chartInstance->c14_is_active_c14_Demo_Shore;
  ...
  *chartInstance, const mxArray *c14_st)
{
  ...
  *c14_a_trigW = c14_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c14_u, 1)), "a_trigW");
  chartInstance->c14_is_active_c14_Demo_Shore = c14_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c14_u, 2)),
     "is_active_c14_Demo_Shore");
  sf_mex_destroy(&c14_u);
  c14_update_debugger_state_c14_Demo_Shore(chartInstance);
  ...
  *c14_inData)
{
  ...
  const mxArray *c14_y = NULL;
  SFc14_Demo_ShoreInstanceStruct *chartInstance;
  chartInstance = (SFc14_Demo_ShoreInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c14_Demo_Shore_get_eml_resolved_functions_info(void)
{
  ...
  *c14_identifier)
{
  ...
  c14_y = c14_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c14_b_is_active_c14_Demo_Shore), &c14_thisId);
  sf_mex_destroy(&c14_b_is_active_c14_Demo_Shore);
  return c14_y;
}
...
void sf_c14_Demo_Shore_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c14_Demo_Shore_get_autoinheritance_info(void)
{
...
mxArray *sf_c14_Demo_Shore_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c14_Demo_Shore_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c14_Demo_Shore(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"a_trig\",},{M[1],M[8],T\"a_trigW\",},{M[8],M[0],T\"is_active_c14_Demo_Shore\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c14_Demo_Shore_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc14_Demo_ShoreInstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c14_Demo_Shore(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc14_Demo_ShoreInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c14_Demo_Shore((SFc14_Demo_ShoreInstanceStruct*)
    chartInstanceVar);
  initialize_c14_Demo_Shore((SFc14_Demo_ShoreInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c14_Demo_Shore(void *chartInstanceVar)
{
  enable_c14_Demo_Shore((SFc14_Demo_ShoreInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c14_Demo_Shore(void *chartInstanceVar)
{
  disable_c14_Demo_Shore((SFc14_Demo_ShoreInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c14_Demo_Shore(void *chartInstanceVar)
{
  sf_gateway_c14_Demo_Shore((SFc14_Demo_ShoreInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c14_Demo_Shore(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c14_Demo_Shore
    ((SFc14_Demo_ShoreInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c14_Demo_Shore();/* state var info */
...
extern void sf_internal_set_sim_state_c14_Demo_Shore(SimStruct* S, const mxArray
  *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c14_Demo_Shore();/* state var info */
  ...
  set_sim_state_c14_Demo_Shore((SFc14_Demo_ShoreInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c14_Demo_Shore(SimStruct* S)
{
  return sf_internal_get_sim_state_c14_Demo_Shore(S);
}

static void sf_opaque_set_sim_state_c14_Demo_Shore(SimStruct* S, const mxArray
  *st)
{
  sf_internal_set_sim_state_c14_Demo_Shore(S, st);
}

static void sf_opaque_terminate_c14_Demo_Shore(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc14_Demo_ShoreInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c14_Demo_Shore((SFc14_Demo_ShoreInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc14_Demo_Shore((SFc14_Demo_ShoreInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c14_Demo_Shore(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c14_Demo_Shore(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c14_Demo_Shore(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c14_Demo_Shore(SimStruct *S)
{
  SFc14_Demo_ShoreInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc14_Demo_ShoreInstanceStruct *)utMalloc(sizeof
    (SFc14_Demo_ShoreInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc14_Demo_ShoreInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c14_Demo_Shore;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c14_Demo_Shore;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c14_Demo_Shore;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c14_Demo_Shore;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c14_Demo_Shore;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c14_Demo_Shore;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c14_Demo_Shore;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c14_Demo_Shore;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c14_Demo_Shore;
  chartInstance->chartInfo.mdlStart = mdlStart_c14_Demo_Shore;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c14_Demo_Shore;
...
void c14_Demo_Shore_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c14_Demo_Shore(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c14_Demo_Shore(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c14_Demo_Shore(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c14_Demo_Shore_method_dispatcher.\n"
