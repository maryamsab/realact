...
static void initialize_c8_Demo_Shore(SFc8_Demo_ShoreInstanceStruct
  *chartInstance);
static void initialize_params_c8_Demo_Shore(SFc8_Demo_ShoreInstanceStruct
  *chartInstance);
static void enable_c8_Demo_Shore(SFc8_Demo_ShoreInstanceStruct *chartInstance);
static void disable_c8_Demo_Shore(SFc8_Demo_ShoreInstanceStruct *chartInstance);
static void c8_update_debugger_state_c8_Demo_Shore(SFc8_Demo_ShoreInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c8_Demo_Shore(SFc8_Demo_ShoreInstanceStruct *
  chartInstance);
static void set_sim_state_c8_Demo_Shore(SFc8_Demo_ShoreInstanceStruct
  *chartInstance, const mxArray *c8_st);
static void c8_set_sim_state_side_effects_c8_Demo_Shore
  (SFc8_Demo_ShoreInstanceStruct *chartInstance);
static void finalize_c8_Demo_Shore(SFc8_Demo_ShoreInstanceStruct *chartInstance);
static void sf_gateway_c8_Demo_Shore(SFc8_Demo_ShoreInstanceStruct
  *chartInstance);
static void c8_enter_atomic_c8_Demo_Shore(SFc8_Demo_ShoreInstanceStruct
  *chartInstance);
static void c8_enter_internal_c8_Demo_Shore(SFc8_Demo_ShoreInstanceStruct
  *chartInstance);
static void c8_c8_Demo_Shore(SFc8_Demo_ShoreInstanceStruct *chartInstance);
static void c8_exit_internal_c8_Demo_Shore(SFc8_Demo_ShoreInstanceStruct
  *chartInstance);
static void c8_initc8_Demo_Shore(SFc8_Demo_ShoreInstanceStruct *chartInstance);
static void initSimStructsc8_Demo_Shore(SFc8_Demo_ShoreInstanceStruct
  *chartInstance);
static void c8_enter_atomic_gazeSurprized(SFc8_Demo_ShoreInstanceStruct
  *chartInstance);
static void c8_gazeSurprized(SFc8_Demo_ShoreInstanceStruct *chartInstance);
static void c8_doIt3Times(SFc8_Demo_ShoreInstanceStruct *chartInstance);
static void c8_enter_atomic_headNeuralGazeCamera(SFc8_Demo_ShoreInstanceStruct
  *chartInstance);
static void c8_headNeuralGazeCamera(SFc8_Demo_ShoreInstanceStruct *chartInstance);
static void c8_enter_atomic_stateWalkBack(SFc8_Demo_ShoreInstanceStruct
  *chartInstance);
static void c8_enter_atomic_browUp(SFc8_Demo_ShoreInstanceStruct *chartInstance);
static void c8_browUp(SFc8_Demo_ShoreInstanceStruct *chartInstance);
static void c8_doIt3Times1(SFc8_Demo_ShoreInstanceStruct *chartInstance);
static void c8_checkUserCoord(SFc8_Demo_ShoreInstanceStruct *chartInstance);
static void c8_enter_atomic_idle(SFc8_Demo_ShoreInstanceStruct *chartInstance);
static void c8_idle(SFc8_Demo_ShoreInstanceStruct *chartInstance);
static void c8_enter_atomic_leanFW(SFc8_Demo_ShoreInstanceStruct *chartInstance);
static void c8_leanFW(SFc8_Demo_ShoreInstanceStruct *chartInstance);
static void c8_doIt3Times2(SFc8_Demo_ShoreInstanceStruct *chartInstance);
static void c8_enter_atomic_walkFW(SFc8_Demo_ShoreInstanceStruct *chartInstance);
static void c8_enter_atomic_leanNeutral(SFc8_Demo_ShoreInstanceStruct
  *chartInstance);
static void c8_leanNeutral(SFc8_Demo_ShoreInstanceStruct *chartInstance);
static void c8_encStr2Arr(SFc8_Demo_ShoreInstanceStruct *chartInstance, real_T
  c8_myarr256[1000]);
static void c8_b_encStr2Arr(SFc8_Demo_ShoreInstanceStruct *chartInstance, real_T
  c8_myarr256[1000]);
static void c8_c_encStr2Arr(SFc8_Demo_ShoreInstanceStruct *chartInstance, real_T
  c8_myarr256[1000]);
static void c8_d_encStr2Arr(SFc8_Demo_ShoreInstanceStruct *chartInstance, real_T
  c8_myarr256[1000]);
static void c8_e_encStr2Arr(SFc8_Demo_ShoreInstanceStruct *chartInstance, real_T
  c8_myarr256[1000]);
static void c8_f_encStr2Arr(SFc8_Demo_ShoreInstanceStruct *chartInstance, real_T
  c8_myarr256[1000]);
static void c8_g_encStr2Arr(SFc8_Demo_ShoreInstanceStruct *chartInstance, real_T
  c8_myarr256[1000]);
static void c8_h_encStr2Arr(SFc8_Demo_ShoreInstanceStruct *chartInstance, real_T
  c8_myarr256[1000]);
static void c8_i_encStr2Arr(SFc8_Demo_ShoreInstanceStruct *chartInstance, real_T
  c8_myarr256[1000]);
static void init_script_number_translation(uint32_T c8_machineNumber, uint32_T
  c8_chartNumber, uint32_T c8_instanceNumber);
static const mxArray *c8_sf_marshallOut(void *chartInstanceVoid, void *c8_inData);
static void c8_emlrt_marshallIn(SFc8_Demo_ShoreInstanceStruct *chartInstance,
  const mxArray *c8_newBmls, const char_T *c8_identifier, real_T c8_y[5000]);
static void c8_b_emlrt_marshallIn(SFc8_Demo_ShoreInstanceStruct *chartInstance,
  const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId, real_T c8_y[5000]);
static void c8_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData);
static const mxArray *c8_b_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static void c8_c_emlrt_marshallIn(SFc8_Demo_ShoreInstanceStruct *chartInstance,
  const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId, real_T c8_y[1000]);
static void c8_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData);
static const mxArray *c8_c_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static real_T c8_d_emlrt_marshallIn(SFc8_Demo_ShoreInstanceStruct *chartInstance,
  const mxArray *c8_nargout, const char_T *c8_identifier);
static real_T c8_e_emlrt_marshallIn(SFc8_Demo_ShoreInstanceStruct *chartInstance,
...
static const mxArray *c8_d_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static void c8_f_emlrt_marshallIn(SFc8_Demo_ShoreInstanceStruct *chartInstance,
  const mxArray *c8_myarr256, const char_T *c8_identifier, real_T c8_y[1000]);
static void c8_g_emlrt_marshallIn(SFc8_Demo_ShoreInstanceStruct *chartInstance,
  const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId, real_T c8_y[1000]);
...
static const mxArray *c8_f_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static boolean_T c8_h_emlrt_marshallIn(SFc8_Demo_ShoreInstanceStruct
...
static void c8_activate_secsc8_Demo_Shore(SFc8_Demo_ShoreInstanceStruct
  *chartInstance);
static void c8_deactivate_secsc8_Demo_Shore(SFc8_Demo_ShoreInstanceStruct
  *chartInstance);
static void c8_increment_counters_secsc8_Demo_Shore
  (SFc8_Demo_ShoreInstanceStruct *chartInstance);
static void c8_reset_counters_secsc8_Demo_Shore(SFc8_Demo_ShoreInstanceStruct
  *chartInstance);
static void c8_insertQueueLowc8_Demo_Shore(SFc8_Demo_ShoreInstanceStruct
  *chartInstance, real_T c8_bmls[5000], real_T c8_myBML[1000], real_T
  c8_newBmls[5000]);
static void c8_walkInvadingTablec8_Demo_Shore(SFc8_Demo_ShoreInstanceStruct
  *chartInstance, real_T c8_bmlID, real_T *c8_p, real_T c8_poseBML[1000]);
static void c8_insertQueuec8_Demo_Shore(SFc8_Demo_ShoreInstanceStruct
  *chartInstance, real_T c8_bmls[5000], real_T c8_myBML[1000], real_T
  c8_newBmls[5000]);
static boolean_T c8_isequal(SFc8_Demo_ShoreInstanceStruct *chartInstance, real_T
  c8_varargin_1[1000], real_T c8_varargin_2[1000]);
static const mxArray *c8_u_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static int8_T c8_i_emlrt_marshallIn(SFc8_Demo_ShoreInstanceStruct *chartInstance,
  const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
...
static const mxArray *c8_v_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static int32_T c8_j_emlrt_marshallIn(SFc8_Demo_ShoreInstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
...
static const mxArray *c8_w_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static uint8_T c8_k_emlrt_marshallIn(SFc8_Demo_ShoreInstanceStruct
  *chartInstance, const mxArray *c8_b_tp_stateInit, const char_T *c8_identifier);
static uint8_T c8_l_emlrt_marshallIn(SFc8_Demo_ShoreInstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
...
static const mxArray *c8_x_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static void c8_m_emlrt_marshallIn(SFc8_Demo_ShoreInstanceStruct *chartInstance,
  const mxArray *c8_b_BMLM, const char_T *c8_identifier, creal_T c8_y[1000]);
static void c8_n_emlrt_marshallIn(SFc8_Demo_ShoreInstanceStruct *chartInstance,
...
static void c8_i_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData);
static const mxArray *c8_o_emlrt_marshallIn(SFc8_Demo_ShoreInstanceStruct
  *chartInstance, const mxArray *c8_b_setSimStateSideEffectsInfo, const char_T
  *c8_identifier);
static const mxArray *c8_p_emlrt_marshallIn(SFc8_Demo_ShoreInstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void c8_updateDataWrittenToVector(SFc8_Demo_ShoreInstanceStruct
  *chartInstance, uint32_T c8_vectorIndex);
static void c8_errorIfDataNotWrittenToFcn(SFc8_Demo_ShoreInstanceStruct
  *chartInstance, uint32_T c8_vectorIndex, uint32_T c8_dataNumber);
static real_T c8_get_BML1(SFc8_Demo_ShoreInstanceStruct *chartInstance, uint32_T
  c8_b);
static void c8_set_BML1(SFc8_Demo_ShoreInstanceStruct *chartInstance, uint32_T
  c8_b, real_T c8_c);
static real_T *c8_access_BML1(SFc8_Demo_ShoreInstanceStruct *chartInstance,
  uint32_T c8_b);
static real_T c8_get_P(SFc8_Demo_ShoreInstanceStruct *chartInstance, uint32_T
  c8_b);
static void c8_set_P(SFc8_Demo_ShoreInstanceStruct *chartInstance, uint32_T c8_b,
                     real_T c8_c);
static real_T *c8_access_P(SFc8_Demo_ShoreInstanceStruct *chartInstance,
  uint32_T c8_b);
static real_T c8_get_STATE_BEFORE(SFc8_Demo_ShoreInstanceStruct *chartInstance,
  uint32_T c8_b);
static void c8_set_STATE_BEFORE(SFc8_Demo_ShoreInstanceStruct *chartInstance,
  uint32_T c8_b, real_T c8_c);
static real_T *c8_access_STATE_BEFORE(SFc8_Demo_ShoreInstanceStruct
  *chartInstance, uint32_T c8_b);
static real_T c8_get_STATE_OVER(SFc8_Demo_ShoreInstanceStruct *chartInstance,
  uint32_T c8_b);
static void c8_set_STATE_OVER(SFc8_Demo_ShoreInstanceStruct *chartInstance,
  uint32_T c8_b, real_T c8_c);
static real_T *c8_access_STATE_OVER(SFc8_Demo_ShoreInstanceStruct *chartInstance,
  uint32_T c8_b);
static real_T c8_get_STATE_READY(SFc8_Demo_ShoreInstanceStruct *chartInstance,
  uint32_T c8_b);
static void c8_set_STATE_READY(SFc8_Demo_ShoreInstanceStruct *chartInstance,
  uint32_T c8_b, real_T c8_c);
static real_T *c8_access_STATE_READY(SFc8_Demo_ShoreInstanceStruct
  *chartInstance, uint32_T c8_b);
static real_T c8_get_avert(SFc8_Demo_ShoreInstanceStruct *chartInstance,
  uint32_T c8_b);
static void c8_set_avert(SFc8_Demo_ShoreInstanceStruct *chartInstance, uint32_T
  c8_b, real_T c8_c);
static real_T *c8_access_avert(SFc8_Demo_ShoreInstanceStruct *chartInstance,
  uint32_T c8_b);
static real_T c8_get_bmlsL(SFc8_Demo_ShoreInstanceStruct *chartInstance,
  uint32_T c8_b);
static void c8_set_bmlsL(SFc8_Demo_ShoreInstanceStruct *chartInstance, uint32_T
  c8_b, real_T c8_c);
static real_T *c8_access_bmlsL(SFc8_Demo_ShoreInstanceStruct *chartInstance,
  uint32_T c8_b);
static real_T c8_get_bmlsM(SFc8_Demo_ShoreInstanceStruct *chartInstance,
  uint32_T c8_b);
static void c8_set_bmlsM(SFc8_Demo_ShoreInstanceStruct *chartInstance, uint32_T
  c8_b, real_T c8_c);
static real_T *c8_access_bmlsM(SFc8_Demo_ShoreInstanceStruct *chartInstance,
  uint32_T c8_b);
static real_T c8_get_fileID(SFc8_Demo_ShoreInstanceStruct *chartInstance,
  uint32_T c8_b);
static void c8_set_fileID(SFc8_Demo_ShoreInstanceStruct *chartInstance, uint32_T
  c8_b, real_T c8_c);
static real_T *c8_access_fileID(SFc8_Demo_ShoreInstanceStruct *chartInstance,
  uint32_T c8_b);
static real_T c8_get_pr(SFc8_Demo_ShoreInstanceStruct *chartInstance, uint32_T
  c8_b);
static void c8_set_pr(SFc8_Demo_ShoreInstanceStruct *chartInstance, uint32_T
                      c8_b, real_T c8_c);
static real_T *c8_access_pr(SFc8_Demo_ShoreInstanceStruct *chartInstance,
  uint32_T c8_b);
static void init_dsm_address_info(SFc8_Demo_ShoreInstanceStruct *chartInstance);
  ...
  *chartInstance, const mxArray *c8_st)
{
  ...
  *c8_gameState = c8_d_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
  ...
  chartInstance->c8_is_active_c8_Demo_Shore = c8_k_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c8_u, 13)),
     "is_active_c8_Demo_Shore");
  chartInstance->c8_is_c8_Demo_Shore = c8_k_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c8_u, 14)), "is_c8_Demo_Shore");
  ...
  c8_update_debugger_state_c8_Demo_Shore(chartInstance);
...
static void sf_gateway_c8_Demo_Shore(SFc8_Demo_ShoreInstanceStruct
  *chartInstance)
{
  c8_set_sim_state_side_effects_c8_Demo_Shore(chartInstance);
}
  ...
  *chartInstance)
{
  ...
  chartInstance->c8_is_active_c8_Demo_Shore = 1U;
  ...
  *chartInstance)
{
  ...
  chartInstance->c8_is_c8_Demo_Shore = c8_IN_stateInit;
  _SFD_CS_CALL(STATE_ACTIVE_TAG, 12U, chartInstance->c8_sfEvent);
  chartInstance->c8_tp_stateInit = 1U;
...
static void c8_c8_Demo_Shore(SFc8_Demo_ShoreInstanceStruct *chartInstance)
{
  ...
  switch (chartInstance->c8_is_c8_Demo_Shore) {
   case c8_IN_browUp:
    CV_CHART_EVAL(4, 0, 1);
   ...
   case c8_IN_stateInit:
    ...
    if (c8_out) {
      ...
      _SFD_CS_CALL(STATE_INACTIVE_TAG, 12U, chartInstance->c8_sfEvent);
      chartInstance->c8_isStable = false;
      chartInstance->c8_is_c8_Demo_Shore = c8_IN_headNeuralGazeCamera;
      _SFD_CS_CALL(STATE_ACTIVE_TAG, 6U, chartInstance->c8_sfEvent);
      chartInstance->c8_tp_headNeuralGazeCamera = 1U;
      ...
      _SFD_CS_CALL(STATE_INACTIVE_TAG, 12U, chartInstance->c8_sfEvent);
      chartInstance->c8_isStable = false;
      chartInstance->c8_is_c8_Demo_Shore = c8_IN_checkUserCoord;
      _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, chartInstance->c8_sfEvent);
      chartInstance->c8_temporalCounter_i1 = 0U;
      chartInstance->c8_tp_checkUserCoord = 1U;
    }
   ...
   case c8_IN_stateWalkBack:
    ...
    if (c8_b_out) {
      ...
      _SFD_CS_CALL(STATE_INACTIVE_TAG, 13U, chartInstance->c8_sfEvent);
      chartInstance->c8_isStable = false;
      chartInstance->c8_is_c8_Demo_Shore = c8_IN_doIt3Times;
      _SFD_CS_CALL(STATE_ACTIVE_TAG, 2U, chartInstance->c8_sfEvent);
      chartInstance->c8_temporalCounter_i1 = 0U;
      chartInstance->c8_tp_doIt3Times = 1U;
      ...
      if (c8_c_out) {
        ...
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 13U, chartInstance->c8_sfEvent);
        chartInstance->c8_isStable = false;
        chartInstance->c8_is_c8_Demo_Shore = c8_IN_wait;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 14U, chartInstance->c8_sfEvent);
        chartInstance->c8_tp_wait = 1U;
      } else {
   ...
   case c8_IN_walkFW:
    ...
    if (c8_g_out) {
      ...
      _SFD_CS_CALL(STATE_INACTIVE_TAG, 16U, chartInstance->c8_sfEvent);
      chartInstance->c8_isStable = false;
      chartInstance->c8_is_c8_Demo_Shore = c8_IN_doIt3Times2;
      _SFD_CS_CALL(STATE_ACTIVE_TAG, 4U, chartInstance->c8_sfEvent);
      chartInstance->c8_temporalCounter_i1 = 0U;
      chartInstance->c8_tp_doIt3Times2 = 1U;
   ...
   default:
    CV_CHART_EVAL(4, 0, 0);
    chartInstance->c8_is_c8_Demo_Shore = c8_IN_NO_ACTIVE_CHILD;
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, chartInstance->c8_sfEvent);
    break;
  }
...
static void c8_initc8_Demo_Shore(SFc8_Demo_ShoreInstanceStruct *chartInstance)
{
  ...
  chartInstance->c8_tp_walkFW = 0U;
  chartInstance->c8_temporalCounter_i1 = 0U;
  chartInstance->c8_is_active_c8_Demo_Shore = 0U;
  chartInstance->c8_is_c8_Demo_Shore = c8_IN_NO_ACTIVE_CHILD;
}
  ...
  *chartInstance)
{
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c8_nargout, 1U, c8_c_sf_marshallOut,
    c8_c_sf_marshallIn);
  c8_walkInvadingTablec8_Demo_Shore(chartInstance, 5.0, &c8_P, c8_b_BMLM);
  ...
  c8_insertQueuec8_Demo_Shore(chartInstance, c8_dv4, c8_dv5, c8_dv6);
  ...
  *chartInstance)
{
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c8_nargout, 1U, c8_c_sf_marshallOut,
    c8_c_sf_marshallIn);
  c8_walkInvadingTablec8_Demo_Shore(chartInstance, 4.0, &c8_P, c8_b_BMLM);
  c8_set_P(chartInstance, 0, c8_P);
  ssUpdateDataStoreLog(chartInstance->S, 1);
  ...
  c8_insertQueuec8_Demo_Shore(chartInstance, c8_dv7, c8_dv8, c8_dv9);
  ...
  *chartInstance)
{
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c8_nargout, 1U, c8_c_sf_marshallOut,
    c8_c_sf_marshallIn);
  c8_walkInvadingTablec8_Demo_Shore(chartInstance, 2.0, &c8_P, c8_b_BMLM);
  c8_set_P(chartInstance, 0, c8_P);
  ssUpdateDataStoreLog(chartInstance->S, 1);
  ...
  c8_insertQueuec8_Demo_Shore(chartInstance, c8_dv10, c8_dv11, c8_dv12);
...
static void c8_enter_atomic_browUp(SFc8_Demo_ShoreInstanceStruct *chartInstance)
{
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c8_nargout, 1U, c8_c_sf_marshallOut,
    c8_c_sf_marshallIn);
  c8_walkInvadingTablec8_Demo_Shore(chartInstance, 8.0, &c8_P, c8_b_BMLM);
  c8_set_P(chartInstance, 0, c8_P);
  ssUpdateDataStoreLog(chartInstance->S, 1);
  ...
  c8_insertQueuec8_Demo_Shore(chartInstance, c8_dv13, c8_dv14, c8_dv15);
...
static void c8_checkUserCoord(SFc8_Demo_ShoreInstanceStruct *chartInstance)
{
  ...
  if (c8_out) {
    ...
    if (c8_b_out) {
      ...
      _SFD_CS_CALL(STATE_INACTIVE_TAG, 1U, chartInstance->c8_sfEvent);
      chartInstance->c8_isStable = false;
      chartInstance->c8_is_c8_Demo_Shore = c8_IN_leanNeutral;
      _SFD_CS_CALL(STATE_ACTIVE_TAG, 11U, chartInstance->c8_sfEvent);
      chartInstance->c8_temporalCounter_i1 = 0U;
      chartInstance->c8_tp_leanNeutral = 1U;
      ...
      if (c8_c_out) {
        ...
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 1U, chartInstance->c8_sfEvent);
        chartInstance->c8_isStable = false;
        chartInstance->c8_is_c8_Demo_Shore = c8_IN_leanFW;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 10U, chartInstance->c8_sfEvent);
        chartInstance->c8_tp_leanFW = 1U;
  ...
  if (guard3 == true) {
    ...
    if (c8_d_out) {
      ...
      if (c8_e_out) {
        ...
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 1U, chartInstance->c8_sfEvent);
        chartInstance->c8_isStable = false;
        chartInstance->c8_is_c8_Demo_Shore = c8_IN_browUp;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, chartInstance->c8_sfEvent);
        chartInstance->c8_tp_browUp = 1U;
        ...
        if (c8_f_out) {
          ...
          _SFD_CS_CALL(STATE_INACTIVE_TAG, 1U, chartInstance->c8_sfEvent);
          chartInstance->c8_isStable = false;
          chartInstance->c8_is_c8_Demo_Shore = c8_IN_idle;
          _SFD_CS_CALL(STATE_ACTIVE_TAG, 7U, chartInstance->c8_sfEvent);
          chartInstance->c8_temporalCounter_i1 = 0U;
          chartInstance->c8_tp_idle = 1U;
  ...
  if (guard2 == true) {
    ...
    if (c8_g_out) {
      ...
      if (c8_h_out) {
        ...
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 1U, chartInstance->c8_sfEvent);
        chartInstance->c8_isStable = false;
        chartInstance->c8_is_c8_Demo_Shore = c8_IN_stateWalkBack;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 13U, chartInstance->c8_sfEvent);
        chartInstance->c8_temporalCounter_i1 = 0U;
        chartInstance->c8_tp_stateWalkBack = 1U;
        ...
        if (c8_i_out) {
          ...
          _SFD_CS_CALL(STATE_INACTIVE_TAG, 1U, chartInstance->c8_sfEvent);
          chartInstance->c8_isStable = false;
          chartInstance->c8_is_c8_Demo_Shore = c8_IN_gazeSurprized;
          _SFD_CS_CALL(STATE_ACTIVE_TAG, 5U, chartInstance->c8_sfEvent);
          chartInstance->c8_tp_gazeSurprized = 1U;
  ...
  if (guard1 == true) {
    ...
    if (c8_j_out) {
      ...
      _SFD_CS_CALL(STATE_INACTIVE_TAG, 1U, chartInstance->c8_sfEvent);
      chartInstance->c8_isStable = false;
      chartInstance->c8_is_c8_Demo_Shore = c8_IN_wait2;
      _SFD_CS_CALL(STATE_ACTIVE_TAG, 15U, chartInstance->c8_sfEvent);
      chartInstance->c8_tp_wait2 = 1U;
    } else {
...
static void c8_enter_atomic_idle(SFc8_Demo_ShoreInstanceStruct *chartInstance)
{
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c8_nargout, 1U, c8_c_sf_marshallOut,
    c8_c_sf_marshallIn);
  c8_walkInvadingTablec8_Demo_Shore(chartInstance, 1.0, &c8_P, c8_b_BMLM);
  c8_set_P(chartInstance, 0, c8_P);
  ssUpdateDataStoreLog(chartInstance->S, 1);
  ...
  c8_insertQueuec8_Demo_Shore(chartInstance, c8_dv16, c8_dv17, c8_dv18);
...
static void c8_idle(SFc8_Demo_ShoreInstanceStruct *chartInstance)
{
  ...
  if (c8_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 7U, chartInstance->c8_sfEvent);
    chartInstance->c8_isStable = false;
    chartInstance->c8_is_c8_Demo_Shore = c8_IN_doIt3Times1;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 3U, chartInstance->c8_sfEvent);
    chartInstance->c8_temporalCounter_i1 = 0U;
    chartInstance->c8_tp_doIt3Times1 = 1U;
...
static void c8_enter_atomic_leanFW(SFc8_Demo_ShoreInstanceStruct *chartInstance)
{
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c8_nargout, 1U, c8_c_sf_marshallOut,
    c8_c_sf_marshallIn);
  c8_walkInvadingTablec8_Demo_Shore(chartInstance, 6.0, &c8_P, c8_b_BMLM);
  c8_set_P(chartInstance, 0, c8_P);
  ssUpdateDataStoreLog(chartInstance->S, 1);
  ...
  c8_insertQueuec8_Demo_Shore(chartInstance, c8_dv19, c8_dv20, c8_dv21);
...
static void c8_enter_atomic_walkFW(SFc8_Demo_ShoreInstanceStruct *chartInstance)
{
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c8_nargout, 1U, c8_c_sf_marshallOut,
    c8_c_sf_marshallIn);
  c8_walkInvadingTablec8_Demo_Shore(chartInstance, 3.0, &c8_P, c8_b_BMLM);
  c8_set_P(chartInstance, 0, c8_P);
  ssUpdateDataStoreLog(chartInstance->S, 1);
  ...
  c8_insertQueuec8_Demo_Shore(chartInstance, c8_dv22, c8_dv23, c8_dv24);
  ...
  *chartInstance)
{
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c8_nargout, 1U, c8_c_sf_marshallOut,
    c8_c_sf_marshallIn);
  c8_walkInvadingTablec8_Demo_Shore(chartInstance, 7.0, &c8_P, c8_b_BMLM);
  c8_set_P(chartInstance, 0, c8_P);
  ssUpdateDataStoreLog(chartInstance->S, 1);
  ...
  c8_insertQueuec8_Demo_Shore(chartInstance, c8_dv25, c8_dv26, c8_dv27);
...
static void c8_leanNeutral(SFc8_Demo_ShoreInstanceStruct *chartInstance)
{
  ...
  if (c8_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 11U, chartInstance->c8_sfEvent);
    chartInstance->c8_isStable = false;
    chartInstance->c8_is_c8_Demo_Shore = c8_IN_walkFW;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 16U, chartInstance->c8_sfEvent);
    chartInstance->c8_temporalCounter_i1 = 0U;
    chartInstance->c8_tp_walkFW = 1U;
...
static const mxArray *c8_sf_marshallOut(void *chartInstanceVoid, void *c8_inData)
{
  ...
  const mxArray *c8_y = NULL;
  SFc8_Demo_ShoreInstanceStruct *chartInstance;
  chartInstance = (SFc8_Demo_ShoreInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c8_Demo_Shore_get_eml_resolved_functions_info(void)
{
...
void sf_exported_auto_activate_c8_Demo_Shore_secs(SimStruct *c8_S)
{
  SFc8_Demo_ShoreInstanceStruct *chartInstance;
  chartInstance = (SFc8_Demo_ShoreInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c8_S))->instanceInfo)->chartInstance;
  c8_activate_secsc8_Demo_Shore(chartInstance);
}

void sf_exported_auto_incrementTemporalCounter_c8_Demo_Shore_secs(SimStruct
  *c8_S)
{
  SFc8_Demo_ShoreInstanceStruct *chartInstance;
  chartInstance = (SFc8_Demo_ShoreInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c8_S))->instanceInfo)->chartInstance;
  c8_increment_counters_secsc8_Demo_Shore(chartInstance);
}

void sf_exported_auto_resetTemporalCounter_c8_Demo_Shore_secs(SimStruct *c8_S)
{
  SFc8_Demo_ShoreInstanceStruct *chartInstance;
  chartInstance = (SFc8_Demo_ShoreInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c8_S))->instanceInfo)->chartInstance;
  c8_reset_counters_secsc8_Demo_Shore(chartInstance);
}

void sf_exported_auto_deactivate_c8_Demo_Shore_secs(SimStruct *c8_S)
{
  SFc8_Demo_ShoreInstanceStruct *chartInstance;
  chartInstance = (SFc8_Demo_ShoreInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c8_S))->instanceInfo)->chartInstance;
  c8_deactivate_secsc8_Demo_Shore(chartInstance);
}

boolean_T sf_exported_auto_isStablec8_Demo_Shore(SimStruct *c8_S)
{
  SFc8_Demo_ShoreInstanceStruct *chartInstance;
  chartInstance = (SFc8_Demo_ShoreInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c8_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_duringc8_Demo_Shore(SimStruct *c8_S)
{
  SFc8_Demo_ShoreInstanceStruct *chartInstance;
  chartInstance = (SFc8_Demo_ShoreInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c8_S))->instanceInfo)->chartInstance;
  c8_c8_Demo_Shore(chartInstance);
}

void sf_exported_auto_enterc8_Demo_Shore(SimStruct *c8_S)
{
  SFc8_Demo_ShoreInstanceStruct *chartInstance;
  chartInstance = (SFc8_Demo_ShoreInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c8_S))->instanceInfo)->chartInstance;
  _sfTime_ = sf_get_time(chartInstance->S);
  c8_enter_atomic_c8_Demo_Shore(chartInstance);
  c8_enter_internal_c8_Demo_Shore(chartInstance);
}

void sf_exported_auto_exitc8_Demo_Shore(SimStruct *c8_S)
{
  SFc8_Demo_ShoreInstanceStruct *chartInstance;
  chartInstance = (SFc8_Demo_ShoreInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c8_S))->instanceInfo)->chartInstance;
  _sfTime_ = sf_get_time(chartInstance->S);
  c8_exit_internal_c8_Demo_Shore(chartInstance);
}

void sf_exported_auto_gatewayc8_Demo_Shore(SimStruct *c8_S)
{
  SFc8_Demo_ShoreInstanceStruct *chartInstance;
  chartInstance = (SFc8_Demo_ShoreInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c8_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_enablec8_Demo_Shore(SimStruct *c8_S)
{
  SFc8_Demo_ShoreInstanceStruct *chartInstance;
  chartInstance = (SFc8_Demo_ShoreInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c8_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_disablec8_Demo_Shore(SimStruct *c8_S)
{
  SFc8_Demo_ShoreInstanceStruct *chartInstance;
  chartInstance = (SFc8_Demo_ShoreInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c8_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_stepBuffersc8_Demo_Shore(SimStruct *c8_S)
{
  SFc8_Demo_ShoreInstanceStruct *chartInstance;
  chartInstance = (SFc8_Demo_ShoreInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c8_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_initBuffersc8_Demo_Shore(SimStruct *c8_S)
{
  SFc8_Demo_ShoreInstanceStruct *chartInstance;
  chartInstance = (SFc8_Demo_ShoreInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c8_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_activate_callc8_Demo_Shore(SimStruct *c8_S)
{
  SFc8_Demo_ShoreInstanceStruct *chartInstance;
  chartInstance = (SFc8_Demo_ShoreInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c8_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_increment_call_counterc8_Demo_Shore(SimStruct *c8_S)
{
  SFc8_Demo_ShoreInstanceStruct *chartInstance;
  chartInstance = (SFc8_Demo_ShoreInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c8_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_reset_call_counterc8_Demo_Shore(SimStruct *c8_S)
{
  SFc8_Demo_ShoreInstanceStruct *chartInstance;
  chartInstance = (SFc8_Demo_ShoreInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c8_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_deactivate_callc8_Demo_Shore(SimStruct *c8_S)
{
  SFc8_Demo_ShoreInstanceStruct *chartInstance;
  chartInstance = (SFc8_Demo_ShoreInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c8_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_initc8_Demo_Shore(SimStruct *c8_S)
{
  SFc8_Demo_ShoreInstanceStruct *chartInstance;
  chartInstance = (SFc8_Demo_ShoreInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c8_S))->instanceInfo)->chartInstance;
  c8_initc8_Demo_Shore(chartInstance);
}

const mxArray *sf_exported_auto_getSimstatec8_Demo_Shore(SimStruct *c8_S)
{
  ...
  chartInstance = (SFc8_Demo_ShoreInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c8_S))->instanceInfo)->chartInstance;
  c8_out = NULL;
  sf_mex_assign(&c8_out, sf_internal_get_sim_state_c8_Demo_Shore(c8_S), false);
  return c8_out;
}

void sf_exported_auto_setSimstatec8_Demo_Shore(SimStruct *c8_S, const mxArray
  *c8_in)
{
  SFc8_Demo_ShoreInstanceStruct *chartInstance;
  chartInstance = (SFc8_Demo_ShoreInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c8_S))->instanceInfo)->chartInstance;
  sf_internal_set_sim_state_c8_Demo_Shore(c8_S, sf_mex_dup(c8_in));
  sf_mex_destroy(&c8_in);
}

void sf_exported_auto_check_state_inconsistency_c8_Demo_Shore(SimStruct *c8_S)
{
  SFc8_Demo_ShoreInstanceStruct *chartInstance;
  chartInstance = (SFc8_Demo_ShoreInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c8_S))->instanceInfo)->chartInstance;
...
void sf_exported_user_c8_Demo_Shore_insertQueue(SimStruct *c8_S, real_T c8_bmls
  [5000], real_T c8_myBML[1000], real_T c8_newBmls[5000])
{
  ...
  c8_insertQueuec8_Demo_Shore(chartInstance, c8_b_bmls, c8_b_myBML, c8_newBmls);
}

void sf_exported_user_c8_Demo_Shore_insertQueueLow(SimStruct *c8_S, real_T
  c8_bmls[5000], real_T c8_myBML[1000], real_T c8_newBmls[5000])
{
  ...
  c8_insertQueueLowc8_Demo_Shore(chartInstance, c8_b_bmls, c8_b_myBML,
    c8_newBmls);
}

void sf_exported_user_c8_Demo_Shore_walkInvadingTable(SimStruct *c8_S, real_T
  c8_bmlID, real_T *c8_p, real_T c8_poseBML[1000])
{
  ...
  chartInstance = (SFc8_Demo_ShoreInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c8_S))->instanceInfo)->chartInstance;
  c8_walkInvadingTablec8_Demo_Shore(chartInstance, c8_bmlID, &c8_b_p, c8_poseBML);
  *c8_p = c8_b_p;
}
  ...
  c8_b)
{
  ...
  if (chartInstance->c8_BML1_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'BML1\' (#2192) in the initialization routine of the chart.\n");
  }
  ...
  c8_b)
{
  ...
  if (chartInstance->c8_P_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'P\' (#2193) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c8_b)
{
  ...
  if (chartInstance->c8_STATE_BEFORE_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'STATE_BEFORE\' (#2191) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c8_b)
{
  ...
  if (chartInstance->c8_STATE_OVER_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'STATE_OVER\' (#2189) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c8_b)
{
  ...
  if (chartInstance->c8_STATE_READY_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'STATE_READY\' (#2188) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c8_b)
{
  ...
  if (chartInstance->c8_avert_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'avert\' (#25) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c8_b)
{
  ...
  if (chartInstance->c8_bmlsL_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'bmlsL\' (#31) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c8_b)
{
  ...
  if (chartInstance->c8_bmlsM_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'bmlsM\' (#27) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c8_b)
{
  ...
  if (chartInstance->c8_fileID_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'fileID\' (#2195) in the initialization routine of the chart.\n");
  }
  ...
  c8_b)
{
  ...
  if (chartInstance->c8_pr_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'pr\' (#2194) in the initialization routine of the chart.\n");
  }
...
void sf_c8_Demo_Shore_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c8_Demo_Shore_get_autoinheritance_info(void)
{
...
mxArray *sf_c8_Demo_Shore_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c8_Demo_Shore_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c8_Demo_Shore(void)
{
  ...
  const char *infoEncStr[] = {
    ...
    "100 S1x6'type','srcId','name','auxInfo'{{M[3],M[111],T\"newBmlsL\",},{M[3],M[100],T\"newBmlsM\",},{M[3],M[75],T\"position\",},{M[8],M[0],T\"is_active_c8_Demo_Shore\",},{M[9],M[0],T\"is_c8_Demo_Shore\",},{M[11],M[33],T\"temporalCounter_i1\",S'et','os','ct'{{T\"ev\",M1x8[23 26 24 127 128 124 50 84],M[1]}}}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 16, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c8_Demo_Shore_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc8_Demo_ShoreInstanceStruct *) chartInfo->chartInstance;
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_FCN(9,0,"insertQueueLowc8_Demo_Shore",0,-1,568);
        ...
        _SFD_CV_INIT_EML_FCN(17,0,"walkInvadingTablec8_Demo_Shore",0,-1,1351);
        ...
        _SFD_CV_INIT_EML_FCN(8,0,"insertQueuec8_Demo_Shore",0,-1,565);
...
static void sf_opaque_initialize_c8_Demo_Shore(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc8_Demo_ShoreInstanceStruct*) chartInstanceVar
    )->S,0);
  initialize_params_c8_Demo_Shore((SFc8_Demo_ShoreInstanceStruct*)
    chartInstanceVar);
  initialize_c8_Demo_Shore((SFc8_Demo_ShoreInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c8_Demo_Shore(void *chartInstanceVar)
{
  enable_c8_Demo_Shore((SFc8_Demo_ShoreInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c8_Demo_Shore(void *chartInstanceVar)
{
  disable_c8_Demo_Shore((SFc8_Demo_ShoreInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c8_Demo_Shore(void *chartInstanceVar)
{
  sf_gateway_c8_Demo_Shore((SFc8_Demo_ShoreInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c8_Demo_Shore(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c8_Demo_Shore
    ((SFc8_Demo_ShoreInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c8_Demo_Shore();/* state var info */
...
extern void sf_internal_set_sim_state_c8_Demo_Shore(SimStruct* S, const mxArray *
  st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c8_Demo_Shore();/* state var info */
  ...
  set_sim_state_c8_Demo_Shore((SFc8_Demo_ShoreInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c8_Demo_Shore(SimStruct* S)
{
  return NULL;
}

static void sf_opaque_set_sim_state_c8_Demo_Shore(SimStruct* S, const mxArray
  *st)
{
}

static void sf_opaque_terminate_c8_Demo_Shore(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc8_Demo_ShoreInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c8_Demo_Shore((SFc8_Demo_ShoreInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc8_Demo_Shore((SFc8_Demo_ShoreInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c8_Demo_Shore(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c8_Demo_Shore(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c8_Demo_Shore(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c8_Demo_Shore(SimStruct *S)
{
  SFc8_Demo_ShoreInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc8_Demo_ShoreInstanceStruct *)utMalloc(sizeof
    (SFc8_Demo_ShoreInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc8_Demo_ShoreInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c8_Demo_Shore;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c8_Demo_Shore;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c8_Demo_Shore;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c8_Demo_Shore;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c8_Demo_Shore;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c8_Demo_Shore;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c8_Demo_Shore;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c8_Demo_Shore;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c8_Demo_Shore;
  chartInstance->chartInfo.mdlStart = mdlStart_c8_Demo_Shore;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c8_Demo_Shore;
...
void c8_Demo_Shore_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c8_Demo_Shore(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c8_Demo_Shore(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c8_Demo_Shore(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c8_Demo_Shore_method_dispatcher.\n"
