...
static void sf_gateway_c3_untitled1(SFc3_untitled1InstanceStruct *chartInstance);
static void initSimStructsc3_untitled1(SFc3_untitled1InstanceStruct
  *chartInstance);
...
static real_T c3_b_emlrt_marshallIn(SFc3_untitled1InstanceStruct *chartInstance,
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static const mxArray *c3_b_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static int32_T c3_c_emlrt_marshallIn(SFc3_untitled1InstanceStruct *chartInstance,
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static uint8_T c3_d_emlrt_marshallIn(SFc3_untitled1InstanceStruct *chartInstance,
  const mxArray *c3_b_is_active_c3_untitled1, const char_T *c3_identifier);
static uint8_T c3_e_emlrt_marshallIn(SFc3_untitled1InstanceStruct *chartInstance,
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
...
static void initialize_c3_untitled1(SFc3_untitled1InstanceStruct *chartInstance)
{
  ...
  chartInstance->c3_is_active_c3_untitled1 = 0U;
}
  ...
  *chartInstance)
{
  ...
  c3_b_hoistedGlobal = chartInstance->c3_is_active_c3_untitled1;
  ...
  *chartInstance, const mxArray *c3_st)
{
  ...
  *c3_y = c3_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 0)),
    "y");
  chartInstance->c3_is_active_c3_untitled1 = c3_d_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c3_u, 1)), "is_active_c3_untitled1");
  sf_mex_destroy(&c3_u);
  ...
  const mxArray *c3_b_is_active_c3_untitled1, const char_T *c3_identifier)
{
  ...
  c3_y = c3_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c3_b_is_active_c3_untitled1), &c3_thisId);
  sf_mex_destroy(&c3_b_is_active_c3_untitled1);
  return c3_y;
}
...
mxArray *sf_c3_untitled1_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c3_untitled1_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c3_untitled1(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c3_untitled1\",}}"
  };
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc3_untitled1InstanceStruct *) chartInfo->chartInstance;
...
{
  sf_gateway_c3_untitled1((SFc3_untitled1InstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c3_untitled1(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
...
extern void sf_internal_set_sim_state_c3_untitled1(SimStruct* S, const mxArray
  *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c3_untitled1();/* state var info */
...
static const mxArray* sf_opaque_get_sim_state_c3_untitled1(SimStruct* S)
{
...
{
  initSimStructsc3_untitled1((SFc3_untitled1InstanceStruct*) chartInstanceVar);
}
...
static void mdlStart_c3_untitled1(SimStruct *S)
{
  ...
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc3_untitled1InstanceStruct *)utMalloc(sizeof
