...
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_b_emlrt_marshallIn(SFc2_untitled1InstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
  ...
  *chartInstance)
{
  ...
  c2_hoistedGlobal = chartInstance->c2_is_active_c2_untitled1;
...
static const mxArray *sf_get_sim_state_info_c2_untitled1(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S'type','srcId','name','auxInfo'{{M[8],M[0],T\"is_active_c2_untitled1\",}}"
  };
  ...
  *st)
{
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c2_untitled1();/* state var info */
