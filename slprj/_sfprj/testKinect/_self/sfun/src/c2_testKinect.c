...
static void initialize_c2_testKinect(SFc2_testKinectInstanceStruct
  *chartInstance);
static void initialize_params_c2_testKinect(SFc2_testKinectInstanceStruct
  *chartInstance);
static void enable_c2_testKinect(SFc2_testKinectInstanceStruct *chartInstance);
static void disable_c2_testKinect(SFc2_testKinectInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_testKinect(SFc2_testKinectInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c2_testKinect(SFc2_testKinectInstanceStruct *
  chartInstance);
static void set_sim_state_c2_testKinect(SFc2_testKinectInstanceStruct
  *chartInstance, const mxArray *c2_st);
static void finalize_c2_testKinect(SFc2_testKinectInstanceStruct *chartInstance);
static void sf_gateway_c2_testKinect(SFc2_testKinectInstanceStruct
  *chartInstance);
static void initSimStructsc2_testKinect(SFc2_testKinectInstanceStruct
  *chartInstance);
static void c2_encStr2Arr(SFc2_testKinectInstanceStruct *chartInstance, char_T
  c2_mystr[181], real_T c2_myarr256[256]);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber, uint32_T c2_instanceNumber);
static void c2_emlrt_marshallIn(SFc2_testKinectInstanceStruct *chartInstance,
  const mxArray *c2_sprintf, const char_T *c2_identifier, char_T c2_y[181]);
static void c2_b_emlrt_marshallIn(SFc2_testKinectInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId, char_T c2_y[181]);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static void c2_c_emlrt_marshallIn(SFc2_testKinectInstanceStruct *chartInstance,
  const mxArray *c2_arrBML, const char_T *c2_identifier, real_T c2_y[256]);
static void c2_d_emlrt_marshallIn(SFc2_testKinectInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId, real_T c2_y[256]);
static void c2_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_e_emlrt_marshallIn(SFc2_testKinectInstanceStruct *chartInstance,
...
static const mxArray *c2_d_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_f_emlrt_marshallIn(SFc2_testKinectInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId, real_T c2_y[181]);
...
static const mxArray *c2_f_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_g_emlrt_marshallIn(SFc2_testKinectInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_h_emlrt_marshallIn(SFc2_testKinectInstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_testKinect, const char_T
  *c2_identifier);
static uint8_T c2_i_emlrt_marshallIn(SFc2_testKinectInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void init_dsm_address_info(SFc2_testKinectInstanceStruct *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_testKinect = 0U;
}
  ...
  chartInstance)
{
  ...
  c2_hoistedGlobal = chartInstance->c2_is_active_c2_testKinect;
  ...
  *chartInstance, const mxArray *c2_st)
{
  ...
  chartInstance->c2_is_active_c2_testKinect = c2_h_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 1)),
     "is_active_c2_testKinect");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_testKinect(chartInstance);
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  real_T c2_u[256];
  const mxArray *c2_y = NULL;
  SFc2_testKinectInstanceStruct *chartInstance;
  chartInstance = (SFc2_testKinectInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c2_testKinect_get_eml_resolved_functions_info(void)
{
  ...
  *c2_identifier)
{
  ...
  c2_y = c2_i_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_testKinect), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_testKinect);
  return c2_y;
}
...
void sf_c2_testKinect_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c2_testKinect_get_autoinheritance_info(void)
{
...
mxArray *sf_c2_testKinect_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_testKinect_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c2_testKinect(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[14],T\"arrBML\",},{M[8],M[0],T\"is_active_c2_testKinect\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_testKinect_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc2_testKinectInstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c2_testKinect(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_testKinectInstanceStruct*) chartInstanceVar
    )->S,0);
  initialize_params_c2_testKinect((SFc2_testKinectInstanceStruct*)
    chartInstanceVar);
  initialize_c2_testKinect((SFc2_testKinectInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_testKinect(void *chartInstanceVar)
{
  enable_c2_testKinect((SFc2_testKinectInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_testKinect(void *chartInstanceVar)
{
  disable_c2_testKinect((SFc2_testKinectInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_testKinect(void *chartInstanceVar)
{
  sf_gateway_c2_testKinect((SFc2_testKinectInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_testKinect(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_testKinect
    ((SFc2_testKinectInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_testKinect();/* state var info */
...
extern void sf_internal_set_sim_state_c2_testKinect(SimStruct* S, const mxArray *
  st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c2_testKinect();/* state var info */
  ...
  set_sim_state_c2_testKinect((SFc2_testKinectInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c2_testKinect(SimStruct* S)
{
  return sf_internal_get_sim_state_c2_testKinect(S);
}

static void sf_opaque_set_sim_state_c2_testKinect(SimStruct* S, const mxArray
  *st)
{
  sf_internal_set_sim_state_c2_testKinect(S, st);
}

static void sf_opaque_terminate_c2_testKinect(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_testKinectInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c2_testKinect((SFc2_testKinectInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc2_testKinect((SFc2_testKinectInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_testKinect(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_testKinect(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(1422114519U));
  ssSetChecksum1(S,(467850244U));
  ssSetChecksum2(S,(69870868U));
  ssSetChecksum3(S,(901438909U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c2_testKinect(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_testKinect(SimStruct *S)
{
  SFc2_testKinectInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc2_testKinectInstanceStruct *)utMalloc(sizeof
    (SFc2_testKinectInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_testKinectInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c2_testKinect;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c2_testKinect;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c2_testKinect;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_testKinect;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c2_testKinect;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c2_testKinect;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c2_testKinect;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c2_testKinect;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_testKinect;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_testKinect;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c2_testKinect;
...
void c2_testKinect_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_testKinect(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_testKinect(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_testKinect(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_testKinect_method_dispatcher.\n"
