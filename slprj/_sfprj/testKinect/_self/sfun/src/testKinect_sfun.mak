...
MACHINE     = testKinect
TARGET      = sfun
CHART_SRCS   = c1_testKinect.c c2_testKinect.c
MACHINE_SRC  = testKinect_sfun.c
MACHINE_REG = testKinect_sfun_registry.c
MAKEFILE    = testKinect_sfun.mak
...
MLSLSF_INCLUDES = \
    ...
    /I "C:\Users\Maryam\Documents\maryam-research\code\Matlab-M+M\slprj\_sfprj\testKinect\_self\sfun\src" 
...
OBJLIST_FILE = testKinect_sfun.mol
SFCLIB = 
AUX_LNK_OBJS =     
USER_LIBS = 
LINK_MACHINE_LIBS = 
