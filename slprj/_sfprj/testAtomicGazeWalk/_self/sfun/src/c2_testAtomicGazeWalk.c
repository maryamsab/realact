...
#include "c2_testAtomicGazeWalk.h"
...
static const char * c2_debug_family_names[7] = { "c", "mystr", "nargin",
  "nargout", "x", "y", "arrBML" };
...
static void initialize_c2_testAtomicGazeWalk
  (SFc2_testAtomicGazeWalkInstanceStruct *chartInstance);
static void initialize_params_c2_testAtomicGazeWalk
  (SFc2_testAtomicGazeWalkInstanceStruct *chartInstance);
static void enable_c2_testAtomicGazeWalk(SFc2_testAtomicGazeWalkInstanceStruct
  *chartInstance);
static void disable_c2_testAtomicGazeWalk(SFc2_testAtomicGazeWalkInstanceStruct *
  chartInstance);
static void c2_update_debugger_state_c2_testAtomicGazeWalk
  (SFc2_testAtomicGazeWalkInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_testAtomicGazeWalk
  (SFc2_testAtomicGazeWalkInstanceStruct *chartInstance);
static void set_sim_state_c2_testAtomicGazeWalk
  (SFc2_testAtomicGazeWalkInstanceStruct *chartInstance, const mxArray *c2_st);
static void finalize_c2_testAtomicGazeWalk(SFc2_testAtomicGazeWalkInstanceStruct
  *chartInstance);
static void sf_gateway_c2_testAtomicGazeWalk
  (SFc2_testAtomicGazeWalkInstanceStruct *chartInstance);
static void c2_chartstep_c2_testAtomicGazeWalk
  (SFc2_testAtomicGazeWalkInstanceStruct *chartInstance);
static void initSimStructsc2_testAtomicGazeWalk
  (SFc2_testAtomicGazeWalkInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber, uint32_T c2_instanceNumber);
static void c2_emlrt_marshallIn(SFc2_testAtomicGazeWalkInstanceStruct
  *chartInstance, const mxArray *c2_sprintf, const char_T *c2_identifier, char_T
  c2_y_data[], int32_T c2_y_sizes[2]);
static void c2_b_emlrt_marshallIn(SFc2_testAtomicGazeWalkInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId,
  char_T c2_y_data[], int32_T c2_y_sizes[2]);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static void c2_c_emlrt_marshallIn(SFc2_testAtomicGazeWalkInstanceStruct
  *chartInstance, const mxArray *c2_arrBML, const char_T *c2_identifier, real_T
  c2_y[256]);
static void c2_d_emlrt_marshallIn(SFc2_testAtomicGazeWalkInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId,
  real_T c2_y[256]);
...
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_e_emlrt_marshallIn(SFc2_testAtomicGazeWalkInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
...
static void c2_f_emlrt_marshallIn(SFc2_testAtomicGazeWalkInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId,
  char_T c2_y_data[], int32_T c2_y_sizes[2]);
...
static void c2_g_emlrt_marshallIn(SFc2_testAtomicGazeWalkInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId,
...
static const mxArray *c2_e_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_h_emlrt_marshallIn(SFc2_testAtomicGazeWalkInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_i_emlrt_marshallIn(SFc2_testAtomicGazeWalkInstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_testAtomicGazeWalk, const
  char_T *c2_identifier);
static uint8_T c2_j_emlrt_marshallIn(SFc2_testAtomicGazeWalkInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void init_dsm_address_info(SFc2_testAtomicGazeWalkInstanceStruct
  *chartInstance);
  ...
  (SFc2_testAtomicGazeWalkInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_testAtomicGazeWalk = 0U;
}
  ...
  (SFc2_testAtomicGazeWalkInstanceStruct *chartInstance)
{
  ...
  c2_hoistedGlobal = chartInstance->c2_is_active_c2_testAtomicGazeWalk;
  ...
  (SFc2_testAtomicGazeWalkInstanceStruct *chartInstance, const mxArray *c2_st)
{
  ...
  chartInstance->c2_is_active_c2_testAtomicGazeWalk = c2_i_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 1)),
     "is_active_c2_testAtomicGazeWalk");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_testAtomicGazeWalk(chartInstance);
  ...
  (SFc2_testAtomicGazeWalkInstanceStruct *chartInstance)
{
  ...
  int32_T c2_i3;
  int32_T c2_i4;
  static char_T c2_cv0[64] = { 's', 'c', 'e', 'n', 'e', '.', 'g', 'e', 't', 'P',
  ...
  c2_f_y = (real_T *)ssGetInputPortSignal(chartInstance->S, 1);
  c2_h_x = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 1U, chartInstance->c2_sfEvent);
  c2_hoistedGlobal = *c2_h_x;
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_nargout, 3U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_x, 4U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_y, 5U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c2_arrBML, 6U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  c2_b_y = NULL;
  sf_mex_assign(&c2_b_y, sf_mex_create("y", c2_u, 10, 0U, 1U, 0U, 2, 1, 64),
                false);
  c2_b_u = c2_x;
  c2_c_y = NULL;
  ...
  for (c2_i5 = 0; c2_i5 <= c2_b_loop_ub; c2_i5++) {
    c2_mystr_data[c2_i5] = c2_tmp_data[c2_i5];
  }
  ...
  for (c2_i6 = 0; c2_i6 <= c2_c_loop_ub; c2_i6++) {
    c2_b_mystr_data[c2_i6] = c2_mystr_data[c2_i6];
  }
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_c_nargin, 5U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_c_nargout, 6U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  ...
  for (c2_i7 = 0; c2_i7 <= c2_d_loop_ub; c2_i7++) {
    c2_arr_data[c2_i7] = (real_T)c2_b_mystr_data[c2_b_mystr_sizes[0] * c2_i7];
  }
  ...
  if (c2_b2) {
    ...
    c2_i9 = _SFD_EML_ARRAY_BOUNDS_CHECK("tt", (int32_T)c2_ss, 1, 256, 0, 0);
  }

  c2_b_tmp_sizes = c2_i9;
  c2_e_loop_ub = c2_i9 - 1;
  for (c2_i10 = 0; c2_i10 <= c2_e_loop_ub; c2_i10++) {
    c2_b_tmp_data[c2_i10] = c2_i10;
  }
  ...
  for (c2_i13 = 0; c2_i13 < 256; c2_i13++) {
    (*c2_b_arrBML)[c2_i13] = c2_arrBML[c2_i13];
  }
  ...
  char_T c2_y_data[], int32_T c2_y_sizes[2])
{
  ...
  for (c2_i14 = 0; c2_i14 < 2; c2_i14++) {
    c2_uv0[c2_i14] = 1U + 69U * (uint32_T)c2_i14;
  }
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_testAtomicGazeWalkInstanceStruct *chartInstance;
  chartInstance = (SFc2_testAtomicGazeWalkInstanceStruct *)chartInstanceVoid;
  ...
  char_T c2_y_data[], int32_T c2_y_sizes[2])
{
  ...
  for (c2_i23 = 0; c2_i23 < 2; c2_i23++) {
    c2_uv1[c2_i23] = 1U + 69U * (uint32_T)c2_i23;
  }
...
const mxArray *sf_c2_testAtomicGazeWalk_get_eml_resolved_functions_info(void)
{
...
static void c2_info_helper(const mxArray **c2_info)
{
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("blanks"), "name", "name", 11);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 11);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
  ...
  char_T *c2_identifier)
{
  ...
  c2_y = c2_j_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_testAtomicGazeWalk), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_testAtomicGazeWalk);
  return c2_y;
}
...
void sf_c2_testAtomicGazeWalk_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3832991180U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(4158893317U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1177262035U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1055263797U);
}

mxArray *sf_c2_testAtomicGazeWalk_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("lPjUqcI2i7SOqkJbaEJ5TF");
...
mxArray *sf_c2_testAtomicGazeWalk_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_testAtomicGazeWalk_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c2_testAtomicGazeWalk(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[14],T\"arrBML\",},{M[8],M[0],T\"is_active_c2_testAtomicGazeWalk\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_testAtomicGazeWalk_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc2_testAtomicGazeWalkInstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          ...
          _SFD_SET_DATA_VALUE_PTR(2U, *c2_arrBML);
        }
      }
    } else {
...
{
  return "EhMWUYMhKmRGiSJbpWSDkE";
}

static void sf_opaque_initialize_c2_testAtomicGazeWalk(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_testAtomicGazeWalkInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_testAtomicGazeWalk((SFc2_testAtomicGazeWalkInstanceStruct*)
    chartInstanceVar);
  initialize_c2_testAtomicGazeWalk((SFc2_testAtomicGazeWalkInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c2_testAtomicGazeWalk(void *chartInstanceVar)
{
  enable_c2_testAtomicGazeWalk((SFc2_testAtomicGazeWalkInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c2_testAtomicGazeWalk(void *chartInstanceVar)
{
  disable_c2_testAtomicGazeWalk((SFc2_testAtomicGazeWalkInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c2_testAtomicGazeWalk(void *chartInstanceVar)
{
  sf_gateway_c2_testAtomicGazeWalk((SFc2_testAtomicGazeWalkInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_testAtomicGazeWalk(SimStruct*
  S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_testAtomicGazeWalk
    ((SFc2_testAtomicGazeWalkInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_testAtomicGazeWalk();/* state var info */
...
extern void sf_internal_set_sim_state_c2_testAtomicGazeWalk(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c2_testAtomicGazeWalk();/* state var info */
  ...
  set_sim_state_c2_testAtomicGazeWalk((SFc2_testAtomicGazeWalkInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c2_testAtomicGazeWalk(SimStruct* S)
{
  return sf_internal_get_sim_state_c2_testAtomicGazeWalk(S);
}

static void sf_opaque_set_sim_state_c2_testAtomicGazeWalk(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c2_testAtomicGazeWalk(S, st);
}

static void sf_opaque_terminate_c2_testAtomicGazeWalk(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_testAtomicGazeWalkInstanceStruct*) chartInstanceVar)
      ->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c2_testAtomicGazeWalk((SFc2_testAtomicGazeWalkInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc2_testAtomicGazeWalk((SFc2_testAtomicGazeWalkInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_testAtomicGazeWalk(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c2_testAtomicGazeWalk
      ((SFc2_testAtomicGazeWalkInstanceStruct*)(chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c2_testAtomicGazeWalk(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(2049937655U));
  ssSetChecksum1(S,(2585644182U));
  ssSetChecksum2(S,(1964986932U));
  ssSetChecksum3(S,(837343317U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c2_testAtomicGazeWalk(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_testAtomicGazeWalk(SimStruct *S)
{
  SFc2_testAtomicGazeWalkInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc2_testAtomicGazeWalkInstanceStruct *)utMalloc(sizeof
    (SFc2_testAtomicGazeWalkInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_testAtomicGazeWalkInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_testAtomicGazeWalk;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_testAtomicGazeWalk;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_testAtomicGazeWalk;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_testAtomicGazeWalk;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c2_testAtomicGazeWalk;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_testAtomicGazeWalk;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_testAtomicGazeWalk;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_testAtomicGazeWalk;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_testAtomicGazeWalk;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_testAtomicGazeWalk;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_testAtomicGazeWalk;
...
void c2_testAtomicGazeWalk_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_testAtomicGazeWalk(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_testAtomicGazeWalk(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_testAtomicGazeWalk(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_testAtomicGazeWalk_method_dispatcher.\n"
