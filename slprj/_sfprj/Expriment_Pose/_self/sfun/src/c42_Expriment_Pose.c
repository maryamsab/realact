...
static void initialize_c42_Expriment_Pose(SFc42_Expriment_PoseInstanceStruct
  *chartInstance);
static void initialize_params_c42_Expriment_Pose
  (SFc42_Expriment_PoseInstanceStruct *chartInstance);
static void enable_c42_Expriment_Pose(SFc42_Expriment_PoseInstanceStruct
  *chartInstance);
static void disable_c42_Expriment_Pose(SFc42_Expriment_PoseInstanceStruct
  *chartInstance);
static void c42_update_debugger_state_c42_Expriment_Pose
  (SFc42_Expriment_PoseInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c42_Expriment_Pose
  (SFc42_Expriment_PoseInstanceStruct *chartInstance);
static void set_sim_state_c42_Expriment_Pose(SFc42_Expriment_PoseInstanceStruct *
  chartInstance, const mxArray *c42_st);
static void c42_set_sim_state_side_effects_c42_Expriment_Pose
  (SFc42_Expriment_PoseInstanceStruct *chartInstance);
static void finalize_c42_Expriment_Pose(SFc42_Expriment_PoseInstanceStruct
  *chartInstance);
static void sf_gateway_c42_Expriment_Pose(SFc42_Expriment_PoseInstanceStruct
  *chartInstance);
static void c42_enter_atomic_c42_Expriment_Pose
  (SFc42_Expriment_PoseInstanceStruct *chartInstance);
static void c42_enter_internal_c42_Expriment_Pose
  (SFc42_Expriment_PoseInstanceStruct *chartInstance);
static void c42_c42_Expriment_Pose(SFc42_Expriment_PoseInstanceStruct
  *chartInstance);
static void c42_exit_internal_c42_Expriment_Pose
  (SFc42_Expriment_PoseInstanceStruct *chartInstance);
static void c42_initc42_Expriment_Pose(SFc42_Expriment_PoseInstanceStruct
  *chartInstance);
static void initSimStructsc42_Expriment_Pose(SFc42_Expriment_PoseInstanceStruct *
  chartInstance);
...
static const mxArray *c42_sf_marshallOut(void *chartInstanceVoid, void
  *c42_inData);
static real_T c42_emlrt_marshallIn(SFc42_Expriment_PoseInstanceStruct
...
static const mxArray *c42_b_sf_marshallOut(void *chartInstanceVoid, void
  *c42_inData);
static boolean_T c42_b_emlrt_marshallIn(SFc42_Expriment_PoseInstanceStruct
  *chartInstance, const mxArray *c42_u, const emlrtMsgIdentifier *c42_parentId);
...
static const mxArray *c42_c_sf_marshallOut(void *chartInstanceVoid, void
  *c42_inData);
static int32_T c42_c_emlrt_marshallIn(SFc42_Expriment_PoseInstanceStruct
  *chartInstance, const mxArray *c42_u, const emlrtMsgIdentifier *c42_parentId);
...
static const mxArray *c42_d_sf_marshallOut(void *chartInstanceVoid, void
  *c42_inData);
static uint8_T c42_d_emlrt_marshallIn(SFc42_Expriment_PoseInstanceStruct
  *chartInstance, const mxArray *c42_b_tp_setP, const char_T *c42_identifier);
static uint8_T c42_e_emlrt_marshallIn(SFc42_Expriment_PoseInstanceStruct
  *chartInstance, const mxArray *c42_u, const emlrtMsgIdentifier *c42_parentId);
...
static const mxArray *c42_f_sf_marshallOut(void *chartInstanceVoid, void
  *c42_inData);
static void c42_f_emlrt_marshallIn(SFc42_Expriment_PoseInstanceStruct
  *chartInstance, const mxArray *c42_u, const emlrtMsgIdentifier *c42_parentId,
  real_T c42_y[11]);
...
static const mxArray *c42_g_sf_marshallOut(void *chartInstanceVoid, void
  *c42_inData);
static const mxArray *c42_g_emlrt_marshallIn(SFc42_Expriment_PoseInstanceStruct *
  chartInstance, const mxArray *c42_b_subchartSimStateInfo, const char_T
  *c42_identifier);
static const mxArray *c42_h_emlrt_marshallIn(SFc42_Expriment_PoseInstanceStruct *
  chartInstance, const mxArray *c42_u, const emlrtMsgIdentifier *c42_parentId);
static real_T c42_get_avert_freq_factor(SFc42_Expriment_PoseInstanceStruct
  *chartInstance, uint32_T c42_b);
static void c42_set_avert_freq_factor(SFc42_Expriment_PoseInstanceStruct
  *chartInstance, uint32_T c42_b, real_T c42_c);
static real_T *c42_access_avert_freq_factor(SFc42_Expriment_PoseInstanceStruct
  *chartInstance, uint32_T c42_b);
static real_T c42_get_avert_gaze_dirs_chance(SFc42_Expriment_PoseInstanceStruct *
  chartInstance, uint32_T c42_b);
static void c42_set_avert_gaze_dirs_chance(SFc42_Expriment_PoseInstanceStruct
  *chartInstance, uint32_T c42_b, real_T c42_c);
static real_T *c42_access_avert_gaze_dirs_chance
  (SFc42_Expriment_PoseInstanceStruct *chartInstance, uint32_T c42_b);
static real_T c42_get_avert_gaze_duration_factor
  (SFc42_Expriment_PoseInstanceStruct *chartInstance, uint32_T c42_b);
static void c42_set_avert_gaze_duration_factor
  (SFc42_Expriment_PoseInstanceStruct *chartInstance, uint32_T c42_b, real_T
   c42_c);
...
static real_T *c42_access_avert_head_frequency_factor
  (SFc42_Expriment_PoseInstanceStruct *chartInstance, uint32_T c42_b);
static real_T c42_get_avert_head_speed(SFc42_Expriment_PoseInstanceStruct
  *chartInstance, uint32_T c42_b);
static void c42_set_avert_head_speed(SFc42_Expriment_PoseInstanceStruct
  *chartInstance, uint32_T c42_b, real_T c42_c);
static real_T *c42_access_avert_head_speed(SFc42_Expriment_PoseInstanceStruct
  *chartInstance, uint32_T c42_b);
static real_T c42_get_blink_flag(SFc42_Expriment_PoseInstanceStruct
  *chartInstance, uint32_T c42_b);
static void c42_set_blink_flag(SFc42_Expriment_PoseInstanceStruct *chartInstance,
  uint32_T c42_b, real_T c42_c);
static real_T *c42_access_blink_flag(SFc42_Expriment_PoseInstanceStruct
  *chartInstance, uint32_T c42_b);
static real_T c42_get_blinkperiod_max(SFc42_Expriment_PoseInstanceStruct
  *chartInstance, uint32_T c42_b);
static void c42_set_blinkperiod_max(SFc42_Expriment_PoseInstanceStruct
  *chartInstance, uint32_T c42_b, real_T c42_c);
static real_T *c42_access_blinkperiod_max(SFc42_Expriment_PoseInstanceStruct
  *chartInstance, uint32_T c42_b);
static real_T c42_get_blinkperiod_min(SFc42_Expriment_PoseInstanceStruct
  *chartInstance, uint32_T c42_b);
static void c42_set_blinkperiod_min(SFc42_Expriment_PoseInstanceStruct
  *chartInstance, uint32_T c42_b, real_T c42_c);
static real_T *c42_access_blinkperiod_min(SFc42_Expriment_PoseInstanceStruct
  *chartInstance, uint32_T c42_b);
static real_T c42_get_emotion_amount_factor(SFc42_Expriment_PoseInstanceStruct
  *chartInstance, uint32_T c42_b);
static void c42_set_emotion_amount_factor(SFc42_Expriment_PoseInstanceStruct
  *chartInstance, uint32_T c42_b, real_T c42_c);
static real_T *c42_access_emotion_amount_factor
  (SFc42_Expriment_PoseInstanceStruct *chartInstance, uint32_T c42_b);
static real_T c42_get_mut_freq_factor(SFc42_Expriment_PoseInstanceStruct
  *chartInstance, uint32_T c42_b);
static void c42_set_mut_freq_factor(SFc42_Expriment_PoseInstanceStruct
  *chartInstance, uint32_T c42_b, real_T c42_c);
static real_T *c42_access_mut_freq_factor(SFc42_Expriment_PoseInstanceStruct
  *chartInstance, uint32_T c42_b);
...
static real_T *c42_access_mutual_gaze_duration_factor
  (SFc42_Expriment_PoseInstanceStruct *chartInstance, uint32_T c42_b);
static real_T c42_get_pose_cat_chance(SFc42_Expriment_PoseInstanceStruct
  *chartInstance, uint32_T c42_b);
static void c42_set_pose_cat_chance(SFc42_Expriment_PoseInstanceStruct
  *chartInstance, uint32_T c42_b, real_T c42_c);
static real_T *c42_access_pose_cat_chance(SFc42_Expriment_PoseInstanceStruct
  *chartInstance, uint32_T c42_b);
static real_T c42_get_pose_chanc_factor(SFc42_Expriment_PoseInstanceStruct
  *chartInstance, uint32_T c42_b);
static void c42_set_pose_chanc_factor(SFc42_Expriment_PoseInstanceStruct
  *chartInstance, uint32_T c42_b, real_T c42_c);
static real_T *c42_access_pose_chanc_factor(SFc42_Expriment_PoseInstanceStruct
  *chartInstance, uint32_T c42_b);
static real_T c42_get_pose_change_flag(SFc42_Expriment_PoseInstanceStruct
  *chartInstance, uint32_T c42_b);
static void c42_set_pose_change_flag(SFc42_Expriment_PoseInstanceStruct
  *chartInstance, uint32_T c42_b, real_T c42_c);
static real_T *c42_access_pose_change_flag(SFc42_Expriment_PoseInstanceStruct
  *chartInstance, uint32_T c42_b);
static real_T c42_get_pose_frequency_factor(SFc42_Expriment_PoseInstanceStruct
  *chartInstance, uint32_T c42_b);
static void c42_set_pose_frequency_factor(SFc42_Expriment_PoseInstanceStruct
  *chartInstance, uint32_T c42_b, real_T c42_c);
static real_T *c42_access_pose_frequency_factor
  (SFc42_Expriment_PoseInstanceStruct *chartInstance, uint32_T c42_b);
static real_T c42_get_pose_lean(SFc42_Expriment_PoseInstanceStruct
  *chartInstance, uint32_T c42_b);
static void c42_set_pose_lean(SFc42_Expriment_PoseInstanceStruct *chartInstance,
  uint32_T c42_b, real_T c42_c);
static real_T *c42_access_pose_lean(SFc42_Expriment_PoseInstanceStruct
  *chartInstance, uint32_T c42_b);
static real_T c42_get_pose_lean_flag(SFc42_Expriment_PoseInstanceStruct
  *chartInstance, uint32_T c42_b);
static void c42_set_pose_lean_flag(SFc42_Expriment_PoseInstanceStruct
  *chartInstance, uint32_T c42_b, real_T c42_c);
static real_T *c42_access_pose_lean_flag(SFc42_Expriment_PoseInstanceStruct
  *chartInstance, uint32_T c42_b);
static real_T c42_get_pose_speed(SFc42_Expriment_PoseInstanceStruct
  *chartInstance, uint32_T c42_b);
static void c42_set_pose_speed(SFc42_Expriment_PoseInstanceStruct *chartInstance,
  uint32_T c42_b, real_T c42_c);
static real_T *c42_access_pose_speed(SFc42_Expriment_PoseInstanceStruct
  *chartInstance, uint32_T c42_b);
static real_T c42_get_pose_twitch(SFc42_Expriment_PoseInstanceStruct
  *chartInstance, uint32_T c42_b);
static void c42_set_pose_twitch(SFc42_Expriment_PoseInstanceStruct
  *chartInstance, uint32_T c42_b, real_T c42_c);
static real_T *c42_access_pose_twitch(SFc42_Expriment_PoseInstanceStruct
  *chartInstance, uint32_T c42_b);
static void init_dsm_address_info(SFc42_Expriment_PoseInstanceStruct
  *chartInstance);
  ...
  chartInstance, const mxArray *c42_st)
{
  ...
  chartInstance->c42_is_active_c42_Expriment_Pose = c42_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c42_u, 0)),
     "is_active_c42_Expriment_Pose");
  chartInstance->c42_is_c42_Expriment_Pose = c42_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c42_u, 1)),
     "is_c42_Expriment_Pose");
  ...
  c42_update_debugger_state_c42_Expriment_Pose(chartInstance);
  sf_exported_auto_setSimstatec50_Expriment_Pose
...
static void sf_gateway_c42_Expriment_Pose(SFc42_Expriment_PoseInstanceStruct
  *chartInstance)
{
  c42_set_sim_state_side_effects_c42_Expriment_Pose(chartInstance);
}
  ...
  (SFc42_Expriment_PoseInstanceStruct *chartInstance)
{
  ...
  chartInstance->c42_is_active_c42_Expriment_Pose = 1U;
  ...
  (SFc42_Expriment_PoseInstanceStruct *chartInstance)
{
  ...
  chartInstance->c42_is_c42_Expriment_Pose = c42_IN_init;
  _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, chartInstance->c42_sfEvent);
  chartInstance->c42_tp_init = 1U;
  ...
  *chartInstance)
{
  ...
  switch (chartInstance->c42_is_c42_Expriment_Pose) {
   case c42_IN_init:
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, chartInstance->c42_sfEvent);
    chartInstance->c42_isStable = false;
    chartInstance->c42_is_c42_Expriment_Pose = c42_IN_wait;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 3U, chartInstance->c42_sfEvent);
    chartInstance->c42_tp_wait = 1U;
   ...
   case c42_IN_wait:
    ...
    if (c42_out) {
      ...
      _SFD_CS_CALL(STATE_INACTIVE_TAG, 3U, chartInstance->c42_sfEvent);
      chartInstance->c42_isStable = false;
      chartInstance->c42_is_c42_Expriment_Pose = c42_IN_setP;
      _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, chartInstance->c42_sfEvent);
      chartInstance->c42_tp_setP = 1U;
      ...
      sf_exported_user_c50_Expriment_Pose_setPoseFactors
   ...
   default:
    ...
    chartInstance->c42_is_c42_Expriment_Pose = c42_IN_NO_ACTIVE_CHILD;
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, chartInstance->c42_sfEvent);
    break;
  }
...
static void c42_initc42_Expriment_Pose(SFc42_Expriment_PoseInstanceStruct
  *chartInstance)
{
  sf_exported_auto_initc50_Expriment_Pose(chartInstance->c42_subchartSimstruct);
  ...
  chartInstance->c42_tp_setP = 0U;
  chartInstance->c42_tp_wait = 0U;
  chartInstance->c42_is_active_c42_Expriment_Pose = 0U;
  chartInstance->c42_is_c42_Expriment_Pose = c42_IN_NO_ACTIVE_CHILD;
}
  ...
  *c42_inData)
{
  ...
  const mxArray *c42_y = NULL;
  SFc42_Expriment_PoseInstanceStruct *chartInstance;
  chartInstance = (SFc42_Expriment_PoseInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c42_Expriment_Pose_get_eml_resolved_functions_info(void)
{
...
boolean_T sf_exported_auto_isStablec42_Expriment_Pose(SimStruct *c42_S)
{
  SFc42_Expriment_PoseInstanceStruct *chartInstance;
  chartInstance = (SFc42_Expriment_PoseInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c42_S))->instanceInfo)->chartInstance;
  return chartInstance->c42_isStable;
}

void sf_exported_auto_duringc42_Expriment_Pose(SimStruct *c42_S)
{
  SFc42_Expriment_PoseInstanceStruct *chartInstance;
  chartInstance = (SFc42_Expriment_PoseInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c42_S))->instanceInfo)->chartInstance;
  c42_c42_Expriment_Pose(chartInstance);
}

void sf_exported_auto_enterc42_Expriment_Pose(SimStruct *c42_S)
{
  SFc42_Expriment_PoseInstanceStruct *chartInstance;
  chartInstance = (SFc42_Expriment_PoseInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c42_S))->instanceInfo)->chartInstance;
  _sfTime_ = sf_get_time(chartInstance->S);
  sf_exported_auto_enablec50_Expriment_Pose(chartInstance->c42_subchartSimstruct);
  c42_enter_atomic_c42_Expriment_Pose(chartInstance);
  c42_enter_internal_c42_Expriment_Pose(chartInstance);
}

void sf_exported_auto_exitc42_Expriment_Pose(SimStruct *c42_S)
{
  SFc42_Expriment_PoseInstanceStruct *chartInstance;
  chartInstance = (SFc42_Expriment_PoseInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c42_S))->instanceInfo)->chartInstance;
  _sfTime_ = sf_get_time(chartInstance->S);
  c42_exit_internal_c42_Expriment_Pose(chartInstance);
  sf_exported_auto_disablec50_Expriment_Pose
    (chartInstance->c42_subchartSimstruct);
}

void sf_exported_auto_gatewayc42_Expriment_Pose(SimStruct *c42_S)
{
  SFc42_Expriment_PoseInstanceStruct *chartInstance;
  chartInstance = (SFc42_Expriment_PoseInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c42_S))->instanceInfo)->chartInstance;
  _sfTime_ = sf_get_time(chartInstance->S);
  sf_exported_auto_gatewayc50_Expriment_Pose
    (chartInstance->c42_subchartSimstruct);
}

void sf_exported_auto_enablec42_Expriment_Pose(SimStruct *c42_S)
{
  SFc42_Expriment_PoseInstanceStruct *chartInstance;
  chartInstance = (SFc42_Expriment_PoseInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c42_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_disablec42_Expriment_Pose(SimStruct *c42_S)
{
  SFc42_Expriment_PoseInstanceStruct *chartInstance;
  chartInstance = (SFc42_Expriment_PoseInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c42_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_stepBuffersc42_Expriment_Pose(SimStruct *c42_S)
{
  SFc42_Expriment_PoseInstanceStruct *chartInstance;
  chartInstance = (SFc42_Expriment_PoseInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c42_S))->instanceInfo)->chartInstance;
  sf_exported_auto_stepBuffersc50_Expriment_Pose
    (chartInstance->c42_subchartSimstruct);
}

void sf_exported_auto_initBuffersc42_Expriment_Pose(SimStruct *c42_S)
{
  SFc42_Expriment_PoseInstanceStruct *chartInstance;
  chartInstance = (SFc42_Expriment_PoseInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c42_S))->instanceInfo)->chartInstance;
  sf_exported_auto_initBuffersc50_Expriment_Pose
    (chartInstance->c42_subchartSimstruct);
  sf_exported_auto_initBuffersc50_Expriment_Pose
    (chartInstance->c42_subchartSimstruct);
}

void sf_exported_auto_activate_callc42_Expriment_Pose(SimStruct *c42_S)
{
  SFc42_Expriment_PoseInstanceStruct *chartInstance;
  chartInstance = (SFc42_Expriment_PoseInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c42_S))->instanceInfo)->chartInstance;
  chartInstance->c42_sfEvent = CALL_EVENT;
  sf_exported_auto_activate_callc50_Expriment_Pose
    (chartInstance->c42_subchartSimstruct);
}

void sf_exported_auto_increment_call_counterc42_Expriment_Pose(SimStruct *c42_S)
{
  SFc42_Expriment_PoseInstanceStruct *chartInstance;
  chartInstance = (SFc42_Expriment_PoseInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c42_S))->instanceInfo)->chartInstance;
  sf_exported_auto_increment_call_counterc50_Expriment_Pose
    (chartInstance->c42_subchartSimstruct);
}

void sf_exported_auto_reset_call_counterc42_Expriment_Pose(SimStruct *c42_S)
{
  SFc42_Expriment_PoseInstanceStruct *chartInstance;
  chartInstance = (SFc42_Expriment_PoseInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c42_S))->instanceInfo)->chartInstance;
  sf_exported_auto_reset_call_counterc50_Expriment_Pose
    (chartInstance->c42_subchartSimstruct);
}

void sf_exported_auto_deactivate_callc42_Expriment_Pose(SimStruct *c42_S)
{
  SFc42_Expriment_PoseInstanceStruct *chartInstance;
  chartInstance = (SFc42_Expriment_PoseInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c42_S))->instanceInfo)->chartInstance;
  sf_exported_auto_deactivate_callc50_Expriment_Pose
    (chartInstance->c42_subchartSimstruct);
}

void sf_exported_auto_initc42_Expriment_Pose(SimStruct *c42_S)
{
  SFc42_Expriment_PoseInstanceStruct *chartInstance;
  chartInstance = (SFc42_Expriment_PoseInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c42_S))->instanceInfo)->chartInstance;
  c42_initc42_Expriment_Pose(chartInstance);
}

const mxArray *sf_exported_auto_getSimstatec42_Expriment_Pose(SimStruct *c42_S)
{
  ...
  chartInstance = (SFc42_Expriment_PoseInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c42_S))->instanceInfo)->chartInstance;
  c42_out = NULL;
  sf_mex_assign(&c42_out, sf_internal_get_sim_state_c42_Expriment_Pose(c42_S),
                false);
  return c42_out;
}

void sf_exported_auto_setSimstatec42_Expriment_Pose(SimStruct *c42_S, const
  mxArray *c42_in)
{
  SFc42_Expriment_PoseInstanceStruct *chartInstance;
  chartInstance = (SFc42_Expriment_PoseInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c42_S))->instanceInfo)->chartInstance;
  sf_internal_set_sim_state_c42_Expriment_Pose(c42_S, sf_mex_dup(c42_in));
  sf_mex_destroy(&c42_in);
}

void sf_exported_auto_check_state_inconsistency_c42_Expriment_Pose(SimStruct
  *c42_S)
{
  SFc42_Expriment_PoseInstanceStruct *chartInstance;
  chartInstance = (SFc42_Expriment_PoseInstanceStruct *)((ChartInfoStruct *)
  ...
  *chartInstance, uint32_T c42_b)
{
  ...
  if (chartInstance->c42_avert_freq_factor_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'avert_freq_factor\' (#1046) in the initialization routine of the chart.\n");
  }
  ...
  chartInstance, uint32_T c42_b)
{
  ...
  if (chartInstance->c42_avert_gaze_dirs_chance_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'avert_gaze_dirs_chance\' (#1033) in the initialization routine of the chart.\n");
  }
  ...
  (SFc42_Expriment_PoseInstanceStruct *chartInstance, uint32_T c42_b)
{
  ...
  if (chartInstance->c42_avert_gaze_duration_factor_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'avert_gaze_duration_factor\' (#1031) in the initialization routine of the chart.\n");
  }
  ...
  (SFc42_Expriment_PoseInstanceStruct *chartInstance, uint32_T c42_b)
{
  ...
  if (chartInstance->c42_avert_head_frequency_factor_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'avert_head_frequency_factor\' (#1030) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c42_b)
{
  ...
  if (chartInstance->c42_avert_head_speed_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'avert_head_speed\' (#1032) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c42_b)
{
  ...
  if (chartInstance->c42_blink_flag_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'blink_flag\' (#1049) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c42_b)
{
  ...
  if (chartInstance->c42_blinkperiod_max_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'blinkperiod_max\' (#1050) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c42_b)
{
  ...
  if (chartInstance->c42_blinkperiod_min_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'blinkperiod_min\' (#1048) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c42_b)
{
  ...
  if (chartInstance->c42_emotion_amount_factor_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'emotion_amount_factor\' (#1044) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c42_b)
{
  ...
  if (chartInstance->c42_mut_freq_factor_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'mut_freq_factor\' (#1045) in the initialization routine of the chart.\n");
  }
  ...
  (SFc42_Expriment_PoseInstanceStruct *chartInstance, uint32_T c42_b)
{
  ...
  if (chartInstance->c42_mutual_gaze_duration_factor_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'mutual_gaze_duration_factor\' (#1029) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c42_b)
{
  ...
  if (chartInstance->c42_pose_cat_chance_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'pose_cat_chance\' (#1041) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c42_b)
{
  ...
  if (chartInstance->c42_pose_chanc_factor_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'pose_chanc_factor\' (#1035) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c42_b)
{
  ...
  if (chartInstance->c42_pose_change_flag_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'pose_change_flag\' (#1038) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c42_b)
{
  ...
  if (chartInstance->c42_pose_frequency_factor_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'pose_frequency_factor\' (#1036) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c42_b)
{
  ...
  if (chartInstance->c42_pose_lean_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'pose_lean\' (#1037) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c42_b)
{
  ...
  if (chartInstance->c42_pose_lean_flag_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'pose_lean_flag\' (#1039) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c42_b)
{
  ...
  if (chartInstance->c42_pose_speed_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'pose_speed\' (#1040) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c42_b)
{
  ...
  if (chartInstance->c42_pose_twitch_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'pose_twitch\' (#1047) in the initialization routine of the chart.\n");
  }
...
void sf_c42_Expriment_Pose_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1402422035U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1337609973U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2615848303U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3654461590U);
}

mxArray *sf_c42_Expriment_Pose_get_autoinheritance_info(void)
{
...
mxArray *sf_c42_Expriment_Pose_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c42_Expriment_Pose_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c42_Expriment_Pose(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[8],M[0],T\"is_active_c42_Expriment_Pose\",},{M[9],M[0],T\"is_c42_Expriment_Pose\",},{M[14],M[123],T\"subchartSimStateInfo\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c42_Expriment_Pose_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc42_Expriment_PoseInstanceStruct *)
...
{
  return "9ZuQPV6vWam1fXX1qKZM0C";
}

static void sf_opaque_initialize_c42_Expriment_Pose(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc42_Expriment_PoseInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c42_Expriment_Pose((SFc42_Expriment_PoseInstanceStruct*)
    chartInstanceVar);
  initialize_c42_Expriment_Pose((SFc42_Expriment_PoseInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c42_Expriment_Pose(void *chartInstanceVar)
{
  enable_c42_Expriment_Pose((SFc42_Expriment_PoseInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c42_Expriment_Pose(void *chartInstanceVar)
{
  disable_c42_Expriment_Pose((SFc42_Expriment_PoseInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c42_Expriment_Pose(void *chartInstanceVar)
{
  sf_gateway_c42_Expriment_Pose((SFc42_Expriment_PoseInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c42_Expriment_Pose(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c42_Expriment_Pose
    ((SFc42_Expriment_PoseInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c42_Expriment_Pose();/* state var info */
...
extern void sf_internal_set_sim_state_c42_Expriment_Pose(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c42_Expriment_Pose();/* state var info */
  ...
  set_sim_state_c42_Expriment_Pose((SFc42_Expriment_PoseInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c42_Expriment_Pose(SimStruct* S)
{
  return NULL;
}

static void sf_opaque_set_sim_state_c42_Expriment_Pose(SimStruct* S, const
  mxArray *st)
{
}

static void sf_opaque_terminate_c42_Expriment_Pose(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc42_Expriment_PoseInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c42_Expriment_Pose((SFc42_Expriment_PoseInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc42_Expriment_Pose((SFc42_Expriment_PoseInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c42_Expriment_Pose(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c42_Expriment_Pose(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(2862016595U));
  ssSetChecksum1(S,(1931835533U));
  ssSetChecksum2(S,(2485705181U));
  ssSetChecksum3(S,(649456720U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c42_Expriment_Pose(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c42_Expriment_Pose(SimStruct *S)
{
  SFc42_Expriment_PoseInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc42_Expriment_PoseInstanceStruct *)utMalloc(sizeof
    (SFc42_Expriment_PoseInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc42_Expriment_PoseInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c42_Expriment_Pose;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c42_Expriment_Pose;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c42_Expriment_Pose;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c42_Expriment_Pose;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c42_Expriment_Pose;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c42_Expriment_Pose;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c42_Expriment_Pose;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c42_Expriment_Pose;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c42_Expriment_Pose;
  chartInstance->chartInfo.mdlStart = mdlStart_c42_Expriment_Pose;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c42_Expriment_Pose;
...
void c42_Expriment_Pose_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c42_Expriment_Pose(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c42_Expriment_Pose(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c42_Expriment_Pose(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c42_Expriment_Pose_method_dispatcher.\n"
