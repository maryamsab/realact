#ifndef __c57_Expriment_Pose_h__
#define __c57_Expriment_Pose_h__
...
/* Type Definitions */
#ifndef typedef_SFc57_Expriment_PoseInstanceStruct
#define typedef_SFc57_Expriment_PoseInstanceStruct
...
typedef struct {
  ...
  uint8_T c57_is_active_c57_Expriment_Pose;
...
} SFc57_Expriment_PoseInstanceStruct;

#endif                                 /*typedef_SFc57_Expriment_PoseInstanceStruct*/
...
extern const mxArray *sf_c57_Expriment_Pose_get_eml_resolved_functions_info(void);
extern void sf_exported_auto_activate_c57_Expriment_Pose_secs(SimStruct *c57_S);
...
extern void sf_exported_auto_resetTemporalCounter_c57_Expriment_Pose_secs
  (SimStruct *c57_S);
extern void sf_exported_auto_deactivate_c57_Expriment_Pose_secs(SimStruct *c57_S);
extern boolean_T sf_exported_auto_isStablec57_Expriment_Pose(SimStruct *c57_S);
extern void sf_exported_auto_duringc57_Expriment_Pose(SimStruct *c57_S);
extern void sf_exported_auto_enterc57_Expriment_Pose(SimStruct *c57_S);
extern void sf_exported_auto_exitc57_Expriment_Pose(SimStruct *c57_S);
extern void sf_exported_auto_gatewayc57_Expriment_Pose(SimStruct *c57_S);
extern void sf_exported_auto_enablec57_Expriment_Pose(SimStruct *c57_S);
extern void sf_exported_auto_disablec57_Expriment_Pose(SimStruct *c57_S);
extern void sf_exported_auto_stepBuffersc57_Expriment_Pose(SimStruct *c57_S);
extern void sf_exported_auto_initBuffersc57_Expriment_Pose(SimStruct *c57_S);
extern void sf_exported_auto_activate_callc57_Expriment_Pose(SimStruct *c57_S);
extern void sf_exported_auto_increment_call_counterc57_Expriment_Pose(SimStruct *
  c57_S);
extern void sf_exported_auto_reset_call_counterc57_Expriment_Pose(SimStruct
  *c57_S);
extern void sf_exported_auto_deactivate_callc57_Expriment_Pose(SimStruct *c57_S);
extern void sf_exported_auto_initc57_Expriment_Pose(SimStruct *c57_S);
extern const mxArray *sf_exported_auto_getSimstatec57_Expriment_Pose(SimStruct
  *c57_S);
extern const mxArray *sf_internal_get_sim_state_c57_Expriment_Pose(SimStruct
  *c57_S);
extern void sf_exported_auto_setSimstatec57_Expriment_Pose(SimStruct *c57_S,
  const mxArray *c57_in);
extern void sf_internal_set_sim_state_c57_Expriment_Pose(SimStruct *c57_S, const
  mxArray *c57_in);
extern void sf_exported_auto_check_state_inconsistency_c57_Expriment_Pose
  (SimStruct *c57_S);
extern void sf_exported_user_c57_Expriment_Pose_blinkFunction(SimStruct *c57_S,
  real_T c57_blinkPeriodMin, real_T c57_blinkPeriodMax, real_T c57_arrSBM[1000]);
extern void sf_exported_user_c57_Expriment_Pose_gazeFollowUserMove(SimStruct
  *c57_S, real_T c57_bmlID, real_T *c57_p, real_T c57_gazeBML[1000]);
extern void sf_exported_user_c57_Expriment_Pose_idleFastUpHeadTable(SimStruct
  *c57_S, real_T c57_bmlID, real_T *c57_p, real_T c57_gazeBML[1000]);
extern void sf_exported_user_c57_Expriment_Pose_idleGazeFunction(SimStruct
  *c57_S, real_T c57_dir, real_T c57_mag, real_T c57_dirChance, real_T
  c57_arrBML[1000]);
extern void sf_exported_user_c57_Expriment_Pose_idleGazeInterestedTable
  (SimStruct *c57_S, real_T c57_bmlID, real_T *c57_p, real_T c57_gazeBML[1000]);
extern void sf_exported_user_c57_Expriment_Pose_idleGazeOrigFunction(SimStruct
  *c57_S, real_T c57_dir, real_T c57_mag, real_T c57_arrBML[1000]);
extern void sf_exported_user_c57_Expriment_Pose_idleGazeTable(SimStruct *c57_S,
  real_T c57_bmlID, real_T *c57_p, real_T c57_gazeBML[1000]);
extern void sf_exported_user_c57_Expriment_Pose_idleHeadFunction(SimStruct
  *c57_S, real_T c57_dir, real_T c57_mag, real_T c57_dirChance, real_T
  c57_headSpeed, real_T c57_arrBML[1000]);
extern void sf_exported_user_c57_Expriment_Pose_idleNormalHeadTable(SimStruct
  *c57_S, real_T c57_bmlID, real_T *c57_p, real_T c57_gazeBML[1000]);
extern void sf_exported_user_c57_Expriment_Pose_idleSlowDownHeadTable(SimStruct *
  c57_S, real_T c57_bmlID, real_T *c57_p, real_T c57_gazeBML[1000]);
extern void sf_exported_user_c57_Expriment_Pose_insertQueueLow(SimStruct *c57_S,
  real_T c57_bmls[5000], real_T c57_myBML[1000], real_T c57_newBmls[5000]);
extern void sf_exported_user_c57_Expriment_Pose_sendSBM(SimStruct *c57_S, real_T
  c57_In[1000]);
extern void sf_exported_user_c57_Expriment_Pose_successTable(SimStruct *c57_S,
  real_T c57_bmlID, real_T *c57_p, real_T c57_poseBML[1000]);

/* Function Definitions */
extern void sf_c57_Expriment_Pose_get_check_sum(mxArray *plhs[]);
extern void c57_Expriment_Pose_method_dispatcher(SimStruct *S, int_T method,
  void *data);
