...
static void initialize_c50_Expriment_Pose(SFc50_Expriment_PoseInstanceStruct
  *chartInstance);
static void initialize_params_c50_Expriment_Pose
  (SFc50_Expriment_PoseInstanceStruct *chartInstance);
static void enable_c50_Expriment_Pose(SFc50_Expriment_PoseInstanceStruct
  *chartInstance);
static void disable_c50_Expriment_Pose(SFc50_Expriment_PoseInstanceStruct
  *chartInstance);
static void c50_update_debugger_state_c50_Expriment_Pose
  (SFc50_Expriment_PoseInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c50_Expriment_Pose
  (SFc50_Expriment_PoseInstanceStruct *chartInstance);
static void set_sim_state_c50_Expriment_Pose(SFc50_Expriment_PoseInstanceStruct *
  chartInstance, const mxArray *c50_st);
static void c50_set_sim_state_side_effects_c50_Expriment_Pose
  (SFc50_Expriment_PoseInstanceStruct *chartInstance);
static void finalize_c50_Expriment_Pose(SFc50_Expriment_PoseInstanceStruct
  *chartInstance);
static void sf_gateway_c50_Expriment_Pose(SFc50_Expriment_PoseInstanceStruct
  *chartInstance);
static void c50_enter_atomic_c50_Expriment_Pose
  (SFc50_Expriment_PoseInstanceStruct *chartInstance);
static void c50_enter_internal_c50_Expriment_Pose
  (SFc50_Expriment_PoseInstanceStruct *chartInstance);
static void c50_c50_Expriment_Pose(SFc50_Expriment_PoseInstanceStruct
  *chartInstance);
static void c50_exit_internal_c50_Expriment_Pose
  (SFc50_Expriment_PoseInstanceStruct *chartInstance);
static void c50_initc50_Expriment_Pose(SFc50_Expriment_PoseInstanceStruct
  *chartInstance);
static void initSimStructsc50_Expriment_Pose(SFc50_Expriment_PoseInstanceStruct *
  chartInstance);
...
static const mxArray *c50_sf_marshallOut(void *chartInstanceVoid, void
  *c50_inData);
static real_T c50_emlrt_marshallIn(SFc50_Expriment_PoseInstanceStruct
...
static const mxArray *c50_b_sf_marshallOut(void *chartInstanceVoid, void
  *c50_inData);
static void c50_b_emlrt_marshallIn(SFc50_Expriment_PoseInstanceStruct
  *chartInstance, const mxArray *c50_u, const emlrtMsgIdentifier *c50_parentId,
  real_T c50_y[6]);
...
static const mxArray *c50_c_sf_marshallOut(void *chartInstanceVoid, void
  *c50_inData);
static boolean_T c50_c_emlrt_marshallIn(SFc50_Expriment_PoseInstanceStruct
  *chartInstance, const mxArray *c50_u, const emlrtMsgIdentifier *c50_parentId);
...
static void c50_setGazeFactorsc50_Expriment_Pose
  (SFc50_Expriment_PoseInstanceStruct *chartInstance, real_T c50_v, real_T c50_a,
...
static void c50_setPoseFactorsc50_Expriment_Pose
  (SFc50_Expriment_PoseInstanceStruct *chartInstance, real_T c50_v, real_T
...
static real_T c50_round(SFc50_Expriment_PoseInstanceStruct *chartInstance,
  real_T c50_x);
static const mxArray *c50_d_sf_marshallOut(void *chartInstanceVoid, void
  *c50_inData);
static int32_T c50_d_emlrt_marshallIn(SFc50_Expriment_PoseInstanceStruct
  *chartInstance, const mxArray *c50_u, const emlrtMsgIdentifier *c50_parentId);
static void c50_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c50_mxArrayInData, const char_T *c50_varName, void *c50_outData);
static uint8_T c50_e_emlrt_marshallIn(SFc50_Expriment_PoseInstanceStruct
  *chartInstance, const mxArray *c50_b_is_active_c50_Expriment_Pose, const
  char_T *c50_identifier);
static uint8_T c50_f_emlrt_marshallIn(SFc50_Expriment_PoseInstanceStruct
  *chartInstance, const mxArray *c50_u, const emlrtMsgIdentifier *c50_parentId);
static const mxArray *c50_g_emlrt_marshallIn(SFc50_Expriment_PoseInstanceStruct *
  chartInstance, const mxArray *c50_b_setSimStateSideEffectsInfo, const char_T
  *c50_identifier);
static const mxArray *c50_h_emlrt_marshallIn(SFc50_Expriment_PoseInstanceStruct *
  chartInstance, const mxArray *c50_u, const emlrtMsgIdentifier *c50_parentId);
static void c50_updateDataWrittenToVector(SFc50_Expriment_PoseInstanceStruct
  *chartInstance, uint32_T c50_vectorIndex);
static void c50_errorIfDataNotWrittenToFcn(SFc50_Expriment_PoseInstanceStruct
  *chartInstance, uint32_T c50_vectorIndex, uint32_T c50_dataNumber);
static void c50_b_round(SFc50_Expriment_PoseInstanceStruct *chartInstance,
  real_T *c50_x);
static void init_dsm_address_info(SFc50_Expriment_PoseInstanceStruct
  *chartInstance);
  ...
  (SFc50_Expriment_PoseInstanceStruct *chartInstance)
{
  ...
  c50_hoistedGlobal = chartInstance->c50_is_active_c50_Expriment_Pose;
  ...
  chartInstance, const mxArray *c50_st)
{
  ...
  chartInstance->c50_is_active_c50_Expriment_Pose = c50_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c50_u, 0)),
     "is_active_c50_Expriment_Pose");
  ...
  c50_update_debugger_state_c50_Expriment_Pose(chartInstance);
...
static void sf_gateway_c50_Expriment_Pose(SFc50_Expriment_PoseInstanceStruct
  *chartInstance)
{
  c50_set_sim_state_side_effects_c50_Expriment_Pose(chartInstance);
}
  ...
  (SFc50_Expriment_PoseInstanceStruct *chartInstance)
{
  ...
  chartInstance->c50_is_active_c50_Expriment_Pose = 1U;
  ...
  *chartInstance)
{
  ...
  chartInstance->c50_is_active_c50_Expriment_Pose = 0U;
}
  ...
  *c50_inData)
{
  ...
  const mxArray *c50_y = NULL;
  SFc50_Expriment_PoseInstanceStruct *chartInstance;
  chartInstance = (SFc50_Expriment_PoseInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c50_Expriment_Pose_get_eml_resolved_functions_info(void)
{
...
boolean_T sf_exported_auto_isStablec50_Expriment_Pose(SimStruct *c50_S)
{
  SFc50_Expriment_PoseInstanceStruct *chartInstance;
  chartInstance = (SFc50_Expriment_PoseInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c50_S))->instanceInfo)->chartInstance;
  return true;
}

void sf_exported_auto_duringc50_Expriment_Pose(SimStruct *c50_S)
{
  SFc50_Expriment_PoseInstanceStruct *chartInstance;
  chartInstance = (SFc50_Expriment_PoseInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c50_S))->instanceInfo)->chartInstance;
  c50_c50_Expriment_Pose(chartInstance);
}

void sf_exported_auto_enterc50_Expriment_Pose(SimStruct *c50_S)
{
  SFc50_Expriment_PoseInstanceStruct *chartInstance;
  chartInstance = (SFc50_Expriment_PoseInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c50_S))->instanceInfo)->chartInstance;
  _sfTime_ = sf_get_time(chartInstance->S);
  c50_enter_atomic_c50_Expriment_Pose(chartInstance);
  c50_enter_internal_c50_Expriment_Pose(chartInstance);
}

void sf_exported_auto_exitc50_Expriment_Pose(SimStruct *c50_S)
{
  SFc50_Expriment_PoseInstanceStruct *chartInstance;
  chartInstance = (SFc50_Expriment_PoseInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c50_S))->instanceInfo)->chartInstance;
  _sfTime_ = sf_get_time(chartInstance->S);
  c50_exit_internal_c50_Expriment_Pose(chartInstance);
}

void sf_exported_auto_gatewayc50_Expriment_Pose(SimStruct *c50_S)
{
  SFc50_Expriment_PoseInstanceStruct *chartInstance;
  chartInstance = (SFc50_Expriment_PoseInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c50_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_enablec50_Expriment_Pose(SimStruct *c50_S)
{
  SFc50_Expriment_PoseInstanceStruct *chartInstance;
  chartInstance = (SFc50_Expriment_PoseInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c50_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_disablec50_Expriment_Pose(SimStruct *c50_S)
{
  SFc50_Expriment_PoseInstanceStruct *chartInstance;
  chartInstance = (SFc50_Expriment_PoseInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c50_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_stepBuffersc50_Expriment_Pose(SimStruct *c50_S)
{
  SFc50_Expriment_PoseInstanceStruct *chartInstance;
  chartInstance = (SFc50_Expriment_PoseInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c50_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_initBuffersc50_Expriment_Pose(SimStruct *c50_S)
{
  SFc50_Expriment_PoseInstanceStruct *chartInstance;
  chartInstance = (SFc50_Expriment_PoseInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c50_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_activate_callc50_Expriment_Pose(SimStruct *c50_S)
{
  SFc50_Expriment_PoseInstanceStruct *chartInstance;
  chartInstance = (SFc50_Expriment_PoseInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c50_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_increment_call_counterc50_Expriment_Pose(SimStruct *c50_S)
{
  SFc50_Expriment_PoseInstanceStruct *chartInstance;
  chartInstance = (SFc50_Expriment_PoseInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c50_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_reset_call_counterc50_Expriment_Pose(SimStruct *c50_S)
{
  SFc50_Expriment_PoseInstanceStruct *chartInstance;
  chartInstance = (SFc50_Expriment_PoseInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c50_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_deactivate_callc50_Expriment_Pose(SimStruct *c50_S)
{
  SFc50_Expriment_PoseInstanceStruct *chartInstance;
  chartInstance = (SFc50_Expriment_PoseInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c50_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_initc50_Expriment_Pose(SimStruct *c50_S)
{
  SFc50_Expriment_PoseInstanceStruct *chartInstance;
  chartInstance = (SFc50_Expriment_PoseInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c50_S))->instanceInfo)->chartInstance;
  c50_initc50_Expriment_Pose(chartInstance);
}

const mxArray *sf_exported_auto_getSimstatec50_Expriment_Pose(SimStruct *c50_S)
{
  ...
  chartInstance = (SFc50_Expriment_PoseInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c50_S))->instanceInfo)->chartInstance;
  c50_out = NULL;
  sf_mex_assign(&c50_out, sf_internal_get_sim_state_c50_Expriment_Pose(c50_S),
                false);
  return c50_out;
}

void sf_exported_auto_setSimstatec50_Expriment_Pose(SimStruct *c50_S, const
  mxArray *c50_in)
{
  SFc50_Expriment_PoseInstanceStruct *chartInstance;
  chartInstance = (SFc50_Expriment_PoseInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c50_S))->instanceInfo)->chartInstance;
  sf_internal_set_sim_state_c50_Expriment_Pose(c50_S, sf_mex_dup(c50_in));
  sf_mex_destroy(&c50_in);
}

void sf_exported_auto_check_state_inconsistency_c50_Expriment_Pose(SimStruct
  *c50_S)
{
  SFc50_Expriment_PoseInstanceStruct *chartInstance;
  chartInstance = (SFc50_Expriment_PoseInstanceStruct *)((ChartInfoStruct *)
        ...
        if (CV_EML_COND(0, 1, 4, c50_v > 40.0)) {
          if (CV_EML_COND(0, 1, 5, c50_a < -40.0)) {
            ...
            *c50_avertDurFactor *= 0.75;
            ...
            c50_b_y = c50_r_x / 2.0;
            c50_s_x = c50_b_y;
            *c50_avertHeadFreqFactor = c50_s_x;
            c50_t_x = *c50_avertHeadFreqFactor;
            *c50_avertHeadFreqFactor = c50_t_x;
        ...
        if (guard3 == true) {
          ...
          if (CV_EML_COND(0, 1, 6, c50_v < -40.0)) {
            if (CV_EML_COND(0, 1, 7, c50_a < -40.0)) {
              ...
              c50_errorIfDataNotWrittenToFcn(chartInstance, 0U, 2U);
              c50_u_x = *c50_mutDurFactor * 0.75;
              *c50_mutDurFactor = c50_u_x;
              c50_v_x = *c50_mutDurFactor;
              *c50_mutDurFactor = c50_v_x;
              *c50_mutDurFactor = muDoubleScalarRound(*c50_mutDurFactor);
              c50_updateDataWrittenToVector(chartInstance, 0U);
              _SFD_EML_CALL(0U, chartInstance->c50_sfEvent, 141U);
              c50_errorIfDataNotWrittenToFcn(chartInstance, 1U, 3U);
              c50_w_x = *c50_avertDurFactor * 1.5;
              *c50_avertDurFactor = c50_w_x;
              c50_x_x = *c50_avertDurFactor;
              *c50_avertDurFactor = c50_x_x;
...
void sf_exported_user_c50_Expriment_Pose_setGazeFactors(SimStruct *c50_S, real_T
  ...
  real_T *c50_blinkFlag, real_T *c50_blinkPeriodMin, real_T *c50_blinkPeriodMax)
{
  ...
  c50_setGazeFactorsc50_Expriment_Pose(chartInstance, c50_v, c50_a, c50_p,
...
void sf_exported_user_c50_Expriment_Pose_setPoseFactors(SimStruct *c50_S, real_T
  ...
  *c50_poseLeanFlag)
{
  ...
  c50_setPoseFactorsc50_Expriment_Pose(chartInstance, c50_v, c50_ar, c50_p,
  ...
  char_T *c50_identifier)
{
  ...
  c50_y = c50_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c50_b_is_active_c50_Expriment_Pose), &c50_thisId);
  sf_mex_destroy(&c50_b_is_active_c50_Expriment_Pose);
  return c50_y;
}
...
void sf_c50_Expriment_Pose_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1684382988U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2856053514U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1745836177U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1773624880U);
}

mxArray *sf_c50_Expriment_Pose_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("KRq2LRephOappHkB1touEE");
...
mxArray *sf_c50_Expriment_Pose_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c50_Expriment_Pose_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c50_Expriment_Pose(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S'type','srcId','name','auxInfo'{{M[8],M[0],T\"is_active_c50_Expriment_Pose\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 1, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c50_Expriment_Pose_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc50_Expriment_PoseInstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"setGazeFactorsc50_Expriment_Pose",0,-1,7290);
        ...
        _SFD_CV_INIT_EML_FCN(1,0,"setPoseFactorsc50_Expriment_Pose",0,-1,2621);
...
{
  return "a4qMZRIqLdmT1S9dgaqlWB";
}

static void sf_opaque_initialize_c50_Expriment_Pose(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc50_Expriment_PoseInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c50_Expriment_Pose((SFc50_Expriment_PoseInstanceStruct*)
    chartInstanceVar);
  initialize_c50_Expriment_Pose((SFc50_Expriment_PoseInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c50_Expriment_Pose(void *chartInstanceVar)
{
  enable_c50_Expriment_Pose((SFc50_Expriment_PoseInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c50_Expriment_Pose(void *chartInstanceVar)
{
  disable_c50_Expriment_Pose((SFc50_Expriment_PoseInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c50_Expriment_Pose(void *chartInstanceVar)
{
  sf_gateway_c50_Expriment_Pose((SFc50_Expriment_PoseInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c50_Expriment_Pose(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c50_Expriment_Pose
    ((SFc50_Expriment_PoseInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c50_Expriment_Pose();/* state var info */
...
extern void sf_internal_set_sim_state_c50_Expriment_Pose(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c50_Expriment_Pose();/* state var info */
  ...
  set_sim_state_c50_Expriment_Pose((SFc50_Expriment_PoseInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c50_Expriment_Pose(SimStruct* S)
{
  return NULL;
}

static void sf_opaque_set_sim_state_c50_Expriment_Pose(SimStruct* S, const
  mxArray *st)
{
}

static void sf_opaque_terminate_c50_Expriment_Pose(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc50_Expriment_PoseInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c50_Expriment_Pose((SFc50_Expriment_PoseInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc50_Expriment_Pose((SFc50_Expriment_PoseInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c50_Expriment_Pose(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c50_Expriment_Pose(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(3513823508U));
  ssSetChecksum1(S,(2581676810U));
  ssSetChecksum2(S,(1197217088U));
  ssSetChecksum3(S,(4106793396U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c50_Expriment_Pose(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c50_Expriment_Pose(SimStruct *S)
{
  SFc50_Expriment_PoseInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc50_Expriment_PoseInstanceStruct *)utMalloc(sizeof
    (SFc50_Expriment_PoseInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc50_Expriment_PoseInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c50_Expriment_Pose;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c50_Expriment_Pose;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c50_Expriment_Pose;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c50_Expriment_Pose;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c50_Expriment_Pose;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c50_Expriment_Pose;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c50_Expriment_Pose;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c50_Expriment_Pose;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c50_Expriment_Pose;
  chartInstance->chartInfo.mdlStart = mdlStart_c50_Expriment_Pose;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c50_Expriment_Pose;
...
void c50_Expriment_Pose_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c50_Expriment_Pose(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c50_Expriment_Pose(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c50_Expriment_Pose(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c50_Expriment_Pose_method_dispatcher.\n"
