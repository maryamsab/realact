#ifndef __c4_Expriment_Pose_h__
#define __c4_Expriment_Pose_h__
...
/* Type Definitions */
#ifndef typedef_SFc4_Expriment_PoseInstanceStruct
#define typedef_SFc4_Expriment_PoseInstanceStruct
...
typedef struct {
  ...
  uint8_T c4_is_active_c4_Expriment_Pose;
...
#endif                                 /*typedef_SFc4_Expriment_PoseInstanceStruct*/
...
extern const mxArray *sf_c4_Expriment_Pose_get_eml_resolved_functions_info(void);
extern void sf_exported_auto_activate_c4_Expriment_Pose_secs(SimStruct *c4_S);
...
extern void sf_exported_auto_resetTemporalCounter_c4_Expriment_Pose_secs
  (SimStruct *c4_S);
extern void sf_exported_auto_deactivate_c4_Expriment_Pose_secs(SimStruct *c4_S);
extern boolean_T sf_exported_auto_isStablec4_Expriment_Pose(SimStruct *c4_S);
extern void sf_exported_auto_duringc4_Expriment_Pose(SimStruct *c4_S);
extern void sf_exported_auto_enterc4_Expriment_Pose(SimStruct *c4_S);
extern void sf_exported_auto_exitc4_Expriment_Pose(SimStruct *c4_S);
extern void sf_exported_auto_gatewayc4_Expriment_Pose(SimStruct *c4_S);
extern void sf_exported_auto_enablec4_Expriment_Pose(SimStruct *c4_S);
extern void sf_exported_auto_disablec4_Expriment_Pose(SimStruct *c4_S);
extern void sf_exported_auto_stepBuffersc4_Expriment_Pose(SimStruct *c4_S);
extern void sf_exported_auto_initBuffersc4_Expriment_Pose(SimStruct *c4_S);
extern void sf_exported_auto_activate_callc4_Expriment_Pose(SimStruct *c4_S);
extern void sf_exported_auto_increment_call_counterc4_Expriment_Pose(SimStruct
  *c4_S);
extern void sf_exported_auto_reset_call_counterc4_Expriment_Pose(SimStruct *c4_S);
extern void sf_exported_auto_deactivate_callc4_Expriment_Pose(SimStruct *c4_S);
extern void sf_exported_auto_initc4_Expriment_Pose(SimStruct *c4_S);
extern const mxArray *sf_exported_auto_getSimstatec4_Expriment_Pose(SimStruct
  *c4_S);
extern const mxArray *sf_internal_get_sim_state_c4_Expriment_Pose(SimStruct
  *c4_S);
extern void sf_exported_auto_setSimstatec4_Expriment_Pose(SimStruct *c4_S, const
  mxArray *c4_in);
extern void sf_internal_set_sim_state_c4_Expriment_Pose(SimStruct *c4_S, const
  mxArray *c4_in);
extern void sf_exported_auto_check_state_inconsistency_c4_Expriment_Pose
  (SimStruct *c4_S);
extern void sf_exported_user_c4_Expriment_Pose_insertQueue(SimStruct *c4_S,
  real_T c4_bmls[5000], real_T c4_myBML[1000], real_T c4_newBmls[5000]);
extern void sf_exported_user_c4_Expriment_Pose_insertQueueLow(SimStruct *c4_S,
  real_T c4_bmls[5000], real_T c4_myBML[1000], real_T c4_newBmls[5000]);
extern void sf_exported_user_c4_Expriment_Pose_selfAdaptorTable(SimStruct *c4_S,
  real_T c4_bmlID, real_T *c4_pr, real_T c4_poseBML[1000]);
extern void sf_exported_user_c4_Expriment_Pose_selfAdaptorTableBilly(SimStruct
  *c4_S, real_T c4_bmlID, real_T *c4_pr, real_T c4_poseBML[1000]);
extern real_T sf_exported_user_c4_Expriment_Pose_selfAdaptorTypeTable(SimStruct *
  c4_S, real_T c4_poseSpeed, real_T c4_poseTwitch);
extern real_T sf_exported_user_c4_Expriment_Pose_weightShiftTypeTable(SimStruct *
  c4_S, real_T c4_poseSpeed);
extern void sf_exported_user_c4_Expriment_Pose_weightshiftTable(SimStruct *c4_S,
  real_T c4_bmlID, real_T *c4_pr, real_T c4_poseBML[1000]);

/* Function Definitions */
extern void sf_c4_Expriment_Pose_get_check_sum(mxArray *plhs[]);
extern void c4_Expriment_Pose_method_dispatcher(SimStruct *S, int_T method, void
  *data);
