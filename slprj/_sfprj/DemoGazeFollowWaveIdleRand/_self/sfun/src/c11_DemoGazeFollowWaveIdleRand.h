#ifndef __c11_DemoGazeFollowWaveIdleRand_h__
#define __c11_DemoGazeFollowWaveIdleRand_h__
...
/* Type Definitions */
#ifndef typedef_SFc11_DemoGazeFollowWaveIdleRandInstanceStruct
#define typedef_SFc11_DemoGazeFollowWaveIdleRandInstanceStruct
...
typedef struct {
  ...
  uint8_T c11_is_active_c11_DemoGazeFollowWaveIdleRand;
  uint8_T c11_is_c11_DemoGazeFollowWaveIdleRand;
  real_T c11_smileN;
  real_T c11_fileID;
...
#endif                                 /*typedef_SFc11_DemoGazeFollowWaveIdleRandInstanceStruct*/
...
extern const mxArray
  *sf_c11_DemoGazeFollowWaveIdleRand_get_eml_resolved_functions_info(void);
...
extern void sf_exported_auto_deactivate_c11_DemoGazeFollowWaveIdleRand_secs
  (SimStruct *c11_S);
extern boolean_T sf_exported_auto_isStablec11_DemoGazeFollowWaveIdleRand
  (SimStruct *c11_S);
extern void sf_exported_auto_duringc11_DemoGazeFollowWaveIdleRand(SimStruct
  *c11_S);
extern void sf_exported_auto_enterc11_DemoGazeFollowWaveIdleRand(SimStruct
  *c11_S);
extern void sf_exported_auto_exitc11_DemoGazeFollowWaveIdleRand(SimStruct *c11_S);
...
extern void sf_exported_auto_initBuffersc11_DemoGazeFollowWaveIdleRand(SimStruct
  *c11_S);
extern void sf_exported_auto_activate_callc11_DemoGazeFollowWaveIdleRand
  (SimStruct *c11_S);
extern void
  sf_exported_auto_increment_call_counterc11_DemoGazeFollowWaveIdleRand
  (SimStruct *c11_S);
extern void sf_exported_auto_reset_call_counterc11_DemoGazeFollowWaveIdleRand
  (SimStruct *c11_S);
extern void sf_exported_auto_deactivate_callc11_DemoGazeFollowWaveIdleRand
  (SimStruct *c11_S);
extern void sf_exported_auto_initc11_DemoGazeFollowWaveIdleRand(SimStruct *c11_S);
...
extern void
  ...
  (SimStruct *c11_S);
extern void sf_exported_user_c11_DemoGazeFollowWaveIdleRand_insertQueue
  (SimStruct *c11_S, real_T c11_bmls[1280], real_T c11_myBML[256], real_T
   c11_newBmls[1280]);
extern void sf_exported_user_c11_DemoGazeFollowWaveIdleRand_smileTable(SimStruct
  *c11_S, real_T c11_bmlID, real_T *c11_p, real_T c11_poseBML[256]);

/* Function Definitions */
extern void sf_c11_DemoGazeFollowWaveIdleRand_get_check_sum(mxArray *plhs[]);
extern void c11_DemoGazeFollowWaveIdleRand_method_dispatcher(SimStruct *S, int_T
  method, void *data);
