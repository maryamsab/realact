#ifndef __c9_DemoGazeFollowWaveIdleRand_h__
#define __c9_DemoGazeFollowWaveIdleRand_h__
...
/* Type Definitions */
#ifndef typedef_SFc9_DemoGazeFollowWaveIdleRandInstanceStruct
#define typedef_SFc9_DemoGazeFollowWaveIdleRandInstanceStruct
...
typedef struct {
  ...
  uint8_T c9_is_active_c9_DemoGazeFollowWaveIdleRand;
...
} SFc9_DemoGazeFollowWaveIdleRandInstanceStruct;

#endif                                 /*typedef_SFc9_DemoGazeFollowWaveIdleRandInstanceStruct*/
...
extern void sf_exported_auto_deactivate_c9_DemoGazeFollowWaveIdleRand_secs
  (SimStruct *c9_S);
extern boolean_T sf_exported_auto_isStablec9_DemoGazeFollowWaveIdleRand
  (SimStruct *c9_S);
extern void sf_exported_auto_duringc9_DemoGazeFollowWaveIdleRand(SimStruct *c9_S);
extern void sf_exported_auto_enterc9_DemoGazeFollowWaveIdleRand(SimStruct *c9_S);
extern void sf_exported_auto_exitc9_DemoGazeFollowWaveIdleRand(SimStruct *c9_S);
extern void sf_exported_auto_gatewayc9_DemoGazeFollowWaveIdleRand(SimStruct
  *c9_S);
extern void sf_exported_auto_enablec9_DemoGazeFollowWaveIdleRand(SimStruct *c9_S);
...
extern void sf_exported_auto_initBuffersc9_DemoGazeFollowWaveIdleRand(SimStruct *
  c9_S);
extern void sf_exported_auto_activate_callc9_DemoGazeFollowWaveIdleRand
  (SimStruct *c9_S);
extern void sf_exported_auto_increment_call_counterc9_DemoGazeFollowWaveIdleRand
  (SimStruct *c9_S);
extern void sf_exported_auto_reset_call_counterc9_DemoGazeFollowWaveIdleRand
  (SimStruct *c9_S);
extern void sf_exported_auto_deactivate_callc9_DemoGazeFollowWaveIdleRand
  (SimStruct *c9_S);
extern void sf_exported_auto_initc9_DemoGazeFollowWaveIdleRand(SimStruct *c9_S);
...
extern void sf_internal_set_sim_state_c9_DemoGazeFollowWaveIdleRand(SimStruct
  *c9_S, const mxArray *c9_in);
extern void
  sf_exported_auto_check_state_inconsistency_c9_DemoGazeFollowWaveIdleRand
  (SimStruct *c9_S);
extern void sf_exported_user_c9_DemoGazeFollowWaveIdleRand_gazeFollowUserMove
  (SimStruct *c9_S, real_T c9_bmlID, real_T *c9_p, real_T c9_gazeBML[256]);
extern void sf_exported_user_c9_DemoGazeFollowWaveIdleRand_idleGazeFunction
  (SimStruct *c9_S, real_T c9_dir, real_T c9_mag, real_T c9_arrBML[256]);
extern void
  sf_exported_user_c9_DemoGazeFollowWaveIdleRand_idleGazeInterestedTable
  (SimStruct *c9_S, real_T c9_bmlID, real_T *c9_p, real_T c9_gazeBML[256]);
extern void sf_exported_user_c9_DemoGazeFollowWaveIdleRand_idleGazeTable
  (SimStruct *c9_S, real_T c9_bmlID, real_T *c9_p, real_T c9_gazeBML[256]);
extern void sf_exported_user_c9_DemoGazeFollowWaveIdleRand_insertQueueLow
  (SimStruct *c9_S, real_T c9_bmls[1280], real_T c9_myBML[256], real_T
   c9_newBmls[1280]);
extern void sf_exported_user_c9_DemoGazeFollowWaveIdleRand_successTable
  (SimStruct *c9_S, real_T c9_bmlID, real_T *c9_p, real_T c9_poseBML[256]);

/* Function Definitions */
extern void sf_c9_DemoGazeFollowWaveIdleRand_get_check_sum(mxArray *plhs[]);
extern void c9_DemoGazeFollowWaveIdleRand_method_dispatcher(SimStruct *S, int_T
  method, void *data);
