#ifndef __c4_DemoGazeFollowWaveIdleRand_h__
#define __c4_DemoGazeFollowWaveIdleRand_h__
...
/* Type Definitions */
#ifndef typedef_SFc4_DemoGazeFollowWaveIdleRandInstanceStruct
#define typedef_SFc4_DemoGazeFollowWaveIdleRandInstanceStruct
...
typedef struct {
  ...
  uint8_T c4_is_active_c4_DemoGazeFollowWaveIdleRand;
  uint8_T c4_is_c4_DemoGazeFollowWaveIdleRand;
  real_T c4_BMLl[256];
...
} SFc4_DemoGazeFollowWaveIdleRandInstanceStruct;

#endif                                 /*typedef_SFc4_DemoGazeFollowWaveIdleRandInstanceStruct*/
...
extern void sf_exported_auto_deactivate_c4_DemoGazeFollowWaveIdleRand_secs
  (SimStruct *c4_S);
extern boolean_T sf_exported_auto_isStablec4_DemoGazeFollowWaveIdleRand
  (SimStruct *c4_S);
extern void sf_exported_auto_duringc4_DemoGazeFollowWaveIdleRand(SimStruct *c4_S);
extern void sf_exported_auto_enterc4_DemoGazeFollowWaveIdleRand(SimStruct *c4_S);
extern void sf_exported_auto_exitc4_DemoGazeFollowWaveIdleRand(SimStruct *c4_S);
extern void sf_exported_auto_gatewayc4_DemoGazeFollowWaveIdleRand(SimStruct
  *c4_S);
extern void sf_exported_auto_enablec4_DemoGazeFollowWaveIdleRand(SimStruct *c4_S);
...
extern void sf_exported_auto_initBuffersc4_DemoGazeFollowWaveIdleRand(SimStruct *
  c4_S);
extern void sf_exported_auto_activate_callc4_DemoGazeFollowWaveIdleRand
  (SimStruct *c4_S);
extern void sf_exported_auto_increment_call_counterc4_DemoGazeFollowWaveIdleRand
  (SimStruct *c4_S);
extern void sf_exported_auto_reset_call_counterc4_DemoGazeFollowWaveIdleRand
  (SimStruct *c4_S);
extern void sf_exported_auto_deactivate_callc4_DemoGazeFollowWaveIdleRand
  (SimStruct *c4_S);
extern void sf_exported_auto_initc4_DemoGazeFollowWaveIdleRand(SimStruct *c4_S);
...
extern void sf_internal_set_sim_state_c4_DemoGazeFollowWaveIdleRand(SimStruct
  *c4_S, const mxArray *c4_in);
extern void
  sf_exported_auto_check_state_inconsistency_c4_DemoGazeFollowWaveIdleRand
  (SimStruct *c4_S);
extern void sf_exported_user_c4_DemoGazeFollowWaveIdleRand_idlePoseBradTable
  (SimStruct *c4_S, real_T c4_bmlID, real_T *c4_pr, real_T c4_poseBML[256]);
extern void sf_exported_user_c4_DemoGazeFollowWaveIdleRand_insertQueueLow
  (SimStruct *c4_S, real_T c4_bmls[1280], real_T c4_myBML[256], real_T
   c4_newBmls[1280]);
extern void sf_exported_user_c4_DemoGazeFollowWaveIdleRand_walkInvadingTable
  (SimStruct *c4_S, real_T c4_bmlID, creal_T *c4_p, real_T c4_poseBML[256]);

/* Function Definitions */
extern void sf_c4_DemoGazeFollowWaveIdleRand_get_check_sum(mxArray *plhs[]);
extern void c4_DemoGazeFollowWaveIdleRand_method_dispatcher(SimStruct *S, int_T
  method, void *data);
