#ifndef __c8_DemoGazeFollowWaveIdleRand_h__
#define __c8_DemoGazeFollowWaveIdleRand_h__
...
/* Type Definitions */
#ifndef typedef_SFc8_DemoGazeFollowWaveIdleRandInstanceStruct
#define typedef_SFc8_DemoGazeFollowWaveIdleRandInstanceStruct
...
typedef struct {
  ...
  uint8_T c8_is_active_c8_DemoGazeFollowWaveIdleRand;
  uint8_T c8_is_c8_DemoGazeFollowWaveIdleRand;
  ...
  int32_T c8_pr_index;
} SFc8_DemoGazeFollowWaveIdleRandInstanceStruct;

#endif                                 /*typedef_SFc8_DemoGazeFollowWaveIdleRandInstanceStruct*/
...
extern void sf_exported_auto_deactivate_c8_DemoGazeFollowWaveIdleRand_secs
  (SimStruct *c8_S);
extern boolean_T sf_exported_auto_isStablec8_DemoGazeFollowWaveIdleRand
  (SimStruct *c8_S);
extern void sf_exported_auto_duringc8_DemoGazeFollowWaveIdleRand(SimStruct *c8_S);
extern void sf_exported_auto_enterc8_DemoGazeFollowWaveIdleRand(SimStruct *c8_S);
extern void sf_exported_auto_exitc8_DemoGazeFollowWaveIdleRand(SimStruct *c8_S);
extern void sf_exported_auto_gatewayc8_DemoGazeFollowWaveIdleRand(SimStruct
  *c8_S);
extern void sf_exported_auto_enablec8_DemoGazeFollowWaveIdleRand(SimStruct *c8_S);
...
extern void sf_exported_auto_initBuffersc8_DemoGazeFollowWaveIdleRand(SimStruct *
  c8_S);
extern void sf_exported_auto_activate_callc8_DemoGazeFollowWaveIdleRand
  (SimStruct *c8_S);
extern void sf_exported_auto_increment_call_counterc8_DemoGazeFollowWaveIdleRand
  (SimStruct *c8_S);
extern void sf_exported_auto_reset_call_counterc8_DemoGazeFollowWaveIdleRand
  (SimStruct *c8_S);
extern void sf_exported_auto_deactivate_callc8_DemoGazeFollowWaveIdleRand
  (SimStruct *c8_S);
extern void sf_exported_auto_initc8_DemoGazeFollowWaveIdleRand(SimStruct *c8_S);
...
extern void sf_internal_set_sim_state_c8_DemoGazeFollowWaveIdleRand(SimStruct
  *c8_S, const mxArray *c8_in);
extern void
  sf_exported_auto_check_state_inconsistency_c8_DemoGazeFollowWaveIdleRand
  (SimStruct *c8_S);
extern void sf_exported_user_c8_DemoGazeFollowWaveIdleRand_insertQueue(SimStruct
  *c8_S, real_T c8_bmls[1280], real_T c8_myBML[256], real_T c8_newBmls[1280]);
extern void sf_exported_user_c8_DemoGazeFollowWaveIdleRand_insertQueueLow
  (SimStruct *c8_S, real_T c8_bmls[1280], real_T c8_myBML[256], real_T
   c8_newBmls[1280]);
extern void sf_exported_user_c8_DemoGazeFollowWaveIdleRand_walkInvadingTable
  (SimStruct *c8_S, real_T c8_bmlID, real_T *c8_p, real_T c8_poseBML[256]);

/* Function Definitions */
extern void sf_c8_DemoGazeFollowWaveIdleRand_get_check_sum(mxArray *plhs[]);
extern void c8_DemoGazeFollowWaveIdleRand_method_dispatcher(SimStruct *S, int_T
  method, void *data);
