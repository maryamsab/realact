...
static void initialize_c15_DemoGazeFollowWaveIdleRand
  (SFc15_DemoGazeFollowWaveIdleRandInstanceStruct *chartInstance);
static void initialize_params_c15_DemoGazeFollowWaveIdleRand
  (SFc15_DemoGazeFollowWaveIdleRandInstanceStruct *chartInstance);
static void enable_c15_DemoGazeFollowWaveIdleRand
  (SFc15_DemoGazeFollowWaveIdleRandInstanceStruct *chartInstance);
static void disable_c15_DemoGazeFollowWaveIdleRand
  (SFc15_DemoGazeFollowWaveIdleRandInstanceStruct *chartInstance);
static void c15_update_debugger_state_c15_DemoGazeFollowWaveIdleRand
  (SFc15_DemoGazeFollowWaveIdleRandInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c15_DemoGazeFollowWaveIdleRand
  (SFc15_DemoGazeFollowWaveIdleRandInstanceStruct *chartInstance);
static void set_sim_state_c15_DemoGazeFollowWaveIdleRand
  (SFc15_DemoGazeFollowWaveIdleRandInstanceStruct *chartInstance, const mxArray *
   c15_st);
static void c15_set_sim_state_side_effects_c15_DemoGazeFollowWaveIdleRand
  (SFc15_DemoGazeFollowWaveIdleRandInstanceStruct *chartInstance);
static void finalize_c15_DemoGazeFollowWaveIdleRand
  (SFc15_DemoGazeFollowWaveIdleRandInstanceStruct *chartInstance);
static void sf_gateway_c15_DemoGazeFollowWaveIdleRand
  (SFc15_DemoGazeFollowWaveIdleRandInstanceStruct *chartInstance);
static void initSimStructsc15_DemoGazeFollowWaveIdleRand
  (SFc15_DemoGazeFollowWaveIdleRandInstanceStruct *chartInstance);
static void c15_encStr2Arr(SFc15_DemoGazeFollowWaveIdleRandInstanceStruct
...
static void c15_b_emlrt_marshallIn
  (SFc15_DemoGazeFollowWaveIdleRandInstanceStruct *chartInstance, const mxArray *
   c15_u, const emlrtMsgIdentifier *c15_parentId, real_T c15_y[256]);
...
static const mxArray *c15_i_sf_marshallOut(void *chartInstanceVoid, void
  *c15_inData);
static void c15_f_emlrt_marshallIn
  (SFc15_DemoGazeFollowWaveIdleRandInstanceStruct *chartInstance, const mxArray *
   c15_u, const emlrtMsgIdentifier *c15_parentId, real_T c15_y[256]);
...
static const mxArray *c15_h_emlrt_marshallIn
  (SFc15_DemoGazeFollowWaveIdleRandInstanceStruct *chartInstance, const mxArray *
   c15_u, const emlrtMsgIdentifier *c15_parentId);
static void init_dsm_address_info(SFc15_DemoGazeFollowWaveIdleRandInstanceStruct
  *chartInstance);
  ...
  (SFc15_DemoGazeFollowWaveIdleRandInstanceStruct *chartInstance)
{
  ...
  chartInstance->c15_is_active_c15_DemoGazeFollowWaveIdleRand = 0U;
  chartInstance->c15_is_c15_DemoGazeFollowWaveIdleRand = c15_IN_NO_ACTIVE_CHILD;
}
  ...
  (SFc15_DemoGazeFollowWaveIdleRandInstanceStruct *chartInstance)
{
  ...
  if (chartInstance->c15_is_active_c15_DemoGazeFollowWaveIdleRand == 1U) {
    _SFD_CC_CALL(CHART_ACTIVE_TAG, 9U, chartInstance->c15_sfEvent);
  }

  if (chartInstance->c15_is_c15_DemoGazeFollowWaveIdleRand ==
  ...
  (SFc15_DemoGazeFollowWaveIdleRandInstanceStruct *chartInstance)
{
  ...
  c15_hoistedGlobal =
    chartInstance->c15_is_active_c15_DemoGazeFollowWaveIdleRand;
  c15_u = c15_hoistedGlobal;
  c15_b_y = NULL;
  sf_mex_assign(&c15_b_y, sf_mex_create("y", &c15_u, 3, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c15_y, 0, c15_b_y);
  c15_b_hoistedGlobal = chartInstance->c15_is_c15_DemoGazeFollowWaveIdleRand;
   ...
   c15_st)
{
  ...
  chartInstance->c15_is_active_c15_DemoGazeFollowWaveIdleRand =
    ...
    "is_active_c15_DemoGazeFollowWaveIdleRand");
  chartInstance->c15_is_c15_DemoGazeFollowWaveIdleRand = c15_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c15_u, 1)),
     "is_c15_DemoGazeFollowWaveIdleRand");
  ...
  c15_update_debugger_state_c15_DemoGazeFollowWaveIdleRand(chartInstance);
  ...
  (SFc15_DemoGazeFollowWaveIdleRandInstanceStruct *chartInstance)
{
  ...
  c15_set_sim_state_side_effects_c15_DemoGazeFollowWaveIdleRand(chartInstance);
  ...
  if (chartInstance->c15_is_active_c15_DemoGazeFollowWaveIdleRand == 0U) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 9U, chartInstance->c15_sfEvent);
    chartInstance->c15_is_active_c15_DemoGazeFollowWaveIdleRand = 1U;
    ...
    chartInstance->c15_is_c15_DemoGazeFollowWaveIdleRand =
      c15_IN_stateCreatePawn;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 2U, chartInstance->c15_sfEvent);
    chartInstance->c15_tp_stateCreatePawn = 1U;
  ...
  *c15_inData)
{
  ...
  const mxArray *c15_y = NULL;
  SFc15_DemoGazeFollowWaveIdleRandInstanceStruct *chartInstance;
  chartInstance = (SFc15_DemoGazeFollowWaveIdleRandInstanceStruct *)
    chartInstanceVoid;
...
const mxArray *sf_c15_DemoGazeFollowWaveIdleRand_get_eml_resolved_functions_info
  (void)
{
...
void sf_c15_DemoGazeFollowWaveIdleRand_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c15_DemoGazeFollowWaveIdleRand_get_autoinheritance_info(void)
{
...
mxArray *sf_c15_DemoGazeFollowWaveIdleRand_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c15_DemoGazeFollowWaveIdleRand_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c15_DemoGazeFollowWaveIdleRand(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[8],M[0],T\"is_active_c15_DemoGazeFollowWaveIdleRand\",},{M[9],M[0],T\"is_c15_DemoGazeFollowWaveIdleRand\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c15_DemoGazeFollowWaveIdleRand_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c15_DemoGazeFollowWaveIdleRand(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc15_DemoGazeFollowWaveIdleRandInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c15_DemoGazeFollowWaveIdleRand
    ((SFc15_DemoGazeFollowWaveIdleRandInstanceStruct*) chartInstanceVar);
  initialize_c15_DemoGazeFollowWaveIdleRand
    ((SFc15_DemoGazeFollowWaveIdleRandInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c15_DemoGazeFollowWaveIdleRand(void
  *chartInstanceVar)
{
  enable_c15_DemoGazeFollowWaveIdleRand
    ((SFc15_DemoGazeFollowWaveIdleRandInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c15_DemoGazeFollowWaveIdleRand(void
  *chartInstanceVar)
{
  disable_c15_DemoGazeFollowWaveIdleRand
    ((SFc15_DemoGazeFollowWaveIdleRandInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c15_DemoGazeFollowWaveIdleRand(void
  *chartInstanceVar)
{
  sf_gateway_c15_DemoGazeFollowWaveIdleRand
    ((SFc15_DemoGazeFollowWaveIdleRandInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c15_DemoGazeFollowWaveIdleRand
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c15_DemoGazeFollowWaveIdleRand
    ((SFc15_DemoGazeFollowWaveIdleRandInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c15_DemoGazeFollowWaveIdleRand();/* state var info */
...
extern void sf_internal_set_sim_state_c15_DemoGazeFollowWaveIdleRand(SimStruct*
  S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c15_DemoGazeFollowWaveIdleRand();/* state var info */
  ...
  set_sim_state_c15_DemoGazeFollowWaveIdleRand
    ((SFc15_DemoGazeFollowWaveIdleRandInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c15_DemoGazeFollowWaveIdleRand
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c15_DemoGazeFollowWaveIdleRand(S);
}

static void sf_opaque_set_sim_state_c15_DemoGazeFollowWaveIdleRand(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c15_DemoGazeFollowWaveIdleRand(S, st);
}

static void sf_opaque_terminate_c15_DemoGazeFollowWaveIdleRand(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc15_DemoGazeFollowWaveIdleRandInstanceStruct*)
                    chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c15_DemoGazeFollowWaveIdleRand
      ((SFc15_DemoGazeFollowWaveIdleRandInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc15_DemoGazeFollowWaveIdleRand
    ((SFc15_DemoGazeFollowWaveIdleRandInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c15_DemoGazeFollowWaveIdleRand(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c15_DemoGazeFollowWaveIdleRand(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(3637120358U));
  ssSetChecksum1(S,(1094895571U));
  ssSetChecksum2(S,(3479876506U));
  ssSetChecksum3(S,(2676822000U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c15_DemoGazeFollowWaveIdleRand(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c15_DemoGazeFollowWaveIdleRand(SimStruct *S)
{
  SFc15_DemoGazeFollowWaveIdleRandInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc15_DemoGazeFollowWaveIdleRandInstanceStruct *)utMalloc
    (sizeof(SFc15_DemoGazeFollowWaveIdleRandInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc15_DemoGazeFollowWaveIdleRandInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c15_DemoGazeFollowWaveIdleRand;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c15_DemoGazeFollowWaveIdleRand;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c15_DemoGazeFollowWaveIdleRand;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c15_DemoGazeFollowWaveIdleRand;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c15_DemoGazeFollowWaveIdleRand;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c15_DemoGazeFollowWaveIdleRand;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c15_DemoGazeFollowWaveIdleRand;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c15_DemoGazeFollowWaveIdleRand;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c15_DemoGazeFollowWaveIdleRand;
  chartInstance->chartInfo.mdlStart = mdlStart_c15_DemoGazeFollowWaveIdleRand;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c15_DemoGazeFollowWaveIdleRand;
...
void c15_DemoGazeFollowWaveIdleRand_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c15_DemoGazeFollowWaveIdleRand(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c15_DemoGazeFollowWaveIdleRand(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c15_DemoGazeFollowWaveIdleRand(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c15_DemoGazeFollowWaveIdleRand_method_dispatcher.\n"
