#ifndef __c5_DemoGazeFollowWaveIdleRand_h__
#define __c5_DemoGazeFollowWaveIdleRand_h__
...
/* Type Definitions */
#ifndef typedef_SFc5_DemoGazeFollowWaveIdleRandInstanceStruct
#define typedef_SFc5_DemoGazeFollowWaveIdleRandInstanceStruct
...
typedef struct {
  ...
  uint8_T c5_is_active_c5_DemoGazeFollowWaveIdleRand;
...
} SFc5_DemoGazeFollowWaveIdleRandInstanceStruct;

#endif                                 /*typedef_SFc5_DemoGazeFollowWaveIdleRandInstanceStruct*/
...
extern void sf_exported_auto_deactivate_c5_DemoGazeFollowWaveIdleRand_secs
  (SimStruct *c5_S);
extern boolean_T sf_exported_auto_isStablec5_DemoGazeFollowWaveIdleRand
  (SimStruct *c5_S);
extern void sf_exported_auto_duringc5_DemoGazeFollowWaveIdleRand(SimStruct *c5_S);
extern void sf_exported_auto_enterc5_DemoGazeFollowWaveIdleRand(SimStruct *c5_S);
extern void sf_exported_auto_exitc5_DemoGazeFollowWaveIdleRand(SimStruct *c5_S);
extern void sf_exported_auto_gatewayc5_DemoGazeFollowWaveIdleRand(SimStruct
  *c5_S);
extern void sf_exported_auto_enablec5_DemoGazeFollowWaveIdleRand(SimStruct *c5_S);
...
extern void sf_exported_auto_initBuffersc5_DemoGazeFollowWaveIdleRand(SimStruct *
  c5_S);
extern void sf_exported_auto_activate_callc5_DemoGazeFollowWaveIdleRand
  (SimStruct *c5_S);
extern void sf_exported_auto_increment_call_counterc5_DemoGazeFollowWaveIdleRand
  (SimStruct *c5_S);
extern void sf_exported_auto_reset_call_counterc5_DemoGazeFollowWaveIdleRand
  (SimStruct *c5_S);
extern void sf_exported_auto_deactivate_callc5_DemoGazeFollowWaveIdleRand
  (SimStruct *c5_S);
extern void sf_exported_auto_initc5_DemoGazeFollowWaveIdleRand(SimStruct *c5_S);
...
extern void sf_internal_set_sim_state_c5_DemoGazeFollowWaveIdleRand(SimStruct
  *c5_S, const mxArray *c5_in);
extern void
  sf_exported_auto_check_state_inconsistency_c5_DemoGazeFollowWaveIdleRand
  (SimStruct *c5_S);
extern void sf_exported_user_c5_DemoGazeFollowWaveIdleRand_handPoseSBTable
  (SimStruct *c5_S, real_T c5_sbmID, real_T c5_poseSBM[256]);
extern void sf_exported_user_c5_DemoGazeFollowWaveIdleRand_idlePoseBradTable
  (SimStruct *c5_S, real_T c5_bmlID, real_T *c5_p, real_T c5_poseBML[256]);
extern void sf_exported_user_c5_DemoGazeFollowWaveIdleRand_initialPoseTable
  (SimStruct *c5_S, real_T c5_bmlID, real_T *c5_p, real_T c5_poseBML[256]);
extern void sf_exported_user_c5_DemoGazeFollowWaveIdleRand_insertQueue(SimStruct
  *c5_S, real_T c5_bmls[1280], real_T c5_mBML[256], real_T c5_newBmls[1280]);
extern void sf_exported_user_c5_DemoGazeFollowWaveIdleRand_insertQueueLow
  (SimStruct *c5_S, real_T c5_bmls[1280], real_T c5_myBML[256], real_T
   c5_newBmls[1280]);
extern void sf_exported_user_c5_DemoGazeFollowWaveIdleRand_paperPoseBradTable
  (SimStruct *c5_S, real_T c5_bmlID, real_T *c5_p, real_T c5_poseBML[256]);
extern void sf_exported_user_c5_DemoGazeFollowWaveIdleRand_rockPoseTable
  (SimStruct *c5_S, real_T c5_bmlID, real_T *c5_p, real_T c5_poseBML[256]);
extern void sf_exported_user_c5_DemoGazeFollowWaveIdleRand_scissorsPoseBradTable
  (SimStruct *c5_S, real_T c5_bmlID, real_T *c5_p, real_T c5_poseBML[256]);
extern void sf_exported_user_c5_DemoGazeFollowWaveIdleRand_sendSBM(SimStruct
  *c5_S, real_T c5_arg[256]);

/* Function Definitions */
extern void sf_c5_DemoGazeFollowWaveIdleRand_get_check_sum(mxArray *plhs[]);
extern void c5_DemoGazeFollowWaveIdleRand_method_dispatcher(SimStruct *S, int_T
  method, void *data);
