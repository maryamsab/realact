...
static void initialize_c16_DemoGazeFollow_Idle
  (SFc16_DemoGazeFollow_IdleInstanceStruct *chartInstance);
static void initialize_params_c16_DemoGazeFollow_Idle
  (SFc16_DemoGazeFollow_IdleInstanceStruct *chartInstance);
static void enable_c16_DemoGazeFollow_Idle
  (SFc16_DemoGazeFollow_IdleInstanceStruct *chartInstance);
static void disable_c16_DemoGazeFollow_Idle
  (SFc16_DemoGazeFollow_IdleInstanceStruct *chartInstance);
static void c16_update_debugger_state_c16_DemoGazeFollow_Idle
  (SFc16_DemoGazeFollow_IdleInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c16_DemoGazeFollow_Idle
  (SFc16_DemoGazeFollow_IdleInstanceStruct *chartInstance);
static void set_sim_state_c16_DemoGazeFollow_Idle
  (SFc16_DemoGazeFollow_IdleInstanceStruct *chartInstance, const mxArray *c16_st);
static void finalize_c16_DemoGazeFollow_Idle
  (SFc16_DemoGazeFollow_IdleInstanceStruct *chartInstance);
static void sf_gateway_c16_DemoGazeFollow_Idle
  (SFc16_DemoGazeFollow_IdleInstanceStruct *chartInstance);
static void c16_chartstep_c16_DemoGazeFollow_Idle
  (SFc16_DemoGazeFollow_IdleInstanceStruct *chartInstance);
static void initSimStructsc16_DemoGazeFollow_Idle
  (SFc16_DemoGazeFollow_IdleInstanceStruct *chartInstance);
...
static void c16_emlrt_marshallIn(SFc16_DemoGazeFollow_IdleInstanceStruct
  *chartInstance, const mxArray *c16_sprintf, const char_T *c16_identifier,
  char_T c16_y_data[], int32_T c16_y_sizes[2]);
static void c16_b_emlrt_marshallIn(SFc16_DemoGazeFollow_IdleInstanceStruct
...
static const mxArray *c16_sf_marshallOut(void *chartInstanceVoid, void
  *c16_inData);
static void c16_c_emlrt_marshallIn(SFc16_DemoGazeFollow_IdleInstanceStruct
  *chartInstance, const mxArray *c16_arrBML, const char_T *c16_identifier,
  real_T c16_y[256]);
static void c16_d_emlrt_marshallIn(SFc16_DemoGazeFollow_IdleInstanceStruct
  *chartInstance, const mxArray *c16_u, const emlrtMsgIdentifier *c16_parentId,
  real_T c16_y[256]);
...
static const mxArray *c16_b_sf_marshallOut(void *chartInstanceVoid, void
  *c16_inData);
static real_T c16_e_emlrt_marshallIn(SFc16_DemoGazeFollow_IdleInstanceStruct
  *chartInstance, const mxArray *c16_u, const emlrtMsgIdentifier *c16_parentId);
...
static void c16_f_emlrt_marshallIn(SFc16_DemoGazeFollow_IdleInstanceStruct
  *chartInstance, const mxArray *c16_u, const emlrtMsgIdentifier *c16_parentId,
  char_T c16_y_data[], int32_T c16_y_sizes[2]);
...
static void c16_g_emlrt_marshallIn(SFc16_DemoGazeFollow_IdleInstanceStruct
  *chartInstance, const mxArray *c16_u, const emlrtMsgIdentifier *c16_parentId,
...
static const mxArray *c16_e_sf_marshallOut(void *chartInstanceVoid, void
  *c16_inData);
static int32_T c16_h_emlrt_marshallIn(SFc16_DemoGazeFollow_IdleInstanceStruct
  *chartInstance, const mxArray *c16_u, const emlrtMsgIdentifier *c16_parentId);
static void c16_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c16_mxArrayInData, const char_T *c16_varName, void *c16_outData);
static uint8_T c16_i_emlrt_marshallIn(SFc16_DemoGazeFollow_IdleInstanceStruct
  *chartInstance, const mxArray *c16_b_is_active_c16_DemoGazeFollow_Idle, const
  char_T *c16_identifier);
static uint8_T c16_j_emlrt_marshallIn(SFc16_DemoGazeFollow_IdleInstanceStruct
  *chartInstance, const mxArray *c16_u, const emlrtMsgIdentifier *c16_parentId);
static void init_dsm_address_info(SFc16_DemoGazeFollow_IdleInstanceStruct
  *chartInstance);
  ...
  (SFc16_DemoGazeFollow_IdleInstanceStruct *chartInstance)
{
  ...
  chartInstance->c16_is_active_c16_DemoGazeFollow_Idle = 0U;
}
  ...
  (SFc16_DemoGazeFollow_IdleInstanceStruct *chartInstance)
{
  ...
  c16_hoistedGlobal = chartInstance->c16_is_active_c16_DemoGazeFollow_Idle;
  ...
  (SFc16_DemoGazeFollow_IdleInstanceStruct *chartInstance, const mxArray *c16_st)
{
  ...
  chartInstance->c16_is_active_c16_DemoGazeFollow_Idle = c16_i_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c16_u, 1)),
     "is_active_c16_DemoGazeFollow_Idle");
  sf_mex_destroy(&c16_u);
  c16_update_debugger_state_c16_DemoGazeFollow_Idle(chartInstance);
  ...
  (SFc16_DemoGazeFollow_IdleInstanceStruct *chartInstance)
{
  ...
  chartInstance->c16_sfEvent = CALL_EVENT;
  c16_chartstep_c16_DemoGazeFollow_Idle(chartInstance);
  ...
  *c16_inData)
{
  ...
  const mxArray *c16_y = NULL;
  SFc16_DemoGazeFollow_IdleInstanceStruct *chartInstance;
  chartInstance = (SFc16_DemoGazeFollow_IdleInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c16_DemoGazeFollow_Idle_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c16_identifier)
{
  ...
  c16_y = c16_j_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c16_b_is_active_c16_DemoGazeFollow_Idle), &c16_thisId);
  sf_mex_destroy(&c16_b_is_active_c16_DemoGazeFollow_Idle);
  return c16_y;
}
...
void sf_c16_DemoGazeFollow_Idle_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c16_DemoGazeFollow_Idle_get_autoinheritance_info(void)
{
...
mxArray *sf_c16_DemoGazeFollow_Idle_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c16_DemoGazeFollow_Idle_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c16_DemoGazeFollow_Idle(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[14],T\"arrBML\",},{M[8],M[0],T\"is_active_c16_DemoGazeFollow_Idle\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c16_DemoGazeFollow_Idle_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc16_DemoGazeFollow_IdleInstanceStruct *)
...
static void sf_opaque_initialize_c16_DemoGazeFollow_Idle(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc16_DemoGazeFollow_IdleInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c16_DemoGazeFollow_Idle
    ((SFc16_DemoGazeFollow_IdleInstanceStruct*) chartInstanceVar);
  initialize_c16_DemoGazeFollow_Idle((SFc16_DemoGazeFollow_IdleInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c16_DemoGazeFollow_Idle(void *chartInstanceVar)
{
  enable_c16_DemoGazeFollow_Idle((SFc16_DemoGazeFollow_IdleInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c16_DemoGazeFollow_Idle(void *chartInstanceVar)
{
  disable_c16_DemoGazeFollow_Idle((SFc16_DemoGazeFollow_IdleInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c16_DemoGazeFollow_Idle(void *chartInstanceVar)
{
  sf_gateway_c16_DemoGazeFollow_Idle((SFc16_DemoGazeFollow_IdleInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c16_DemoGazeFollow_Idle
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c16_DemoGazeFollow_Idle
    ((SFc16_DemoGazeFollow_IdleInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c16_DemoGazeFollow_Idle();/* state var info */
...
extern void sf_internal_set_sim_state_c16_DemoGazeFollow_Idle(SimStruct* S,
  const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c16_DemoGazeFollow_Idle();/* state var info */
  ...
  set_sim_state_c16_DemoGazeFollow_Idle((SFc16_DemoGazeFollow_IdleInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c16_DemoGazeFollow_Idle(SimStruct*
  S)
{
  return sf_internal_get_sim_state_c16_DemoGazeFollow_Idle(S);
}

static void sf_opaque_set_sim_state_c16_DemoGazeFollow_Idle(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c16_DemoGazeFollow_Idle(S, st);
}

static void sf_opaque_terminate_c16_DemoGazeFollow_Idle(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc16_DemoGazeFollow_IdleInstanceStruct*) chartInstanceVar
      )->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c16_DemoGazeFollow_Idle((SFc16_DemoGazeFollow_IdleInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc16_DemoGazeFollow_Idle((SFc16_DemoGazeFollow_IdleInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c16_DemoGazeFollow_Idle(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ...
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c16_DemoGazeFollow_Idle
      ((SFc16_DemoGazeFollow_IdleInstanceStruct*)(chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c16_DemoGazeFollow_Idle(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(3499729826U));
  ssSetChecksum1(S,(2687910954U));
  ssSetChecksum2(S,(3613892617U));
  ssSetChecksum3(S,(4174515793U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c16_DemoGazeFollow_Idle(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c16_DemoGazeFollow_Idle(SimStruct *S)
{
  SFc16_DemoGazeFollow_IdleInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc16_DemoGazeFollow_IdleInstanceStruct *)utMalloc(sizeof
    (SFc16_DemoGazeFollow_IdleInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc16_DemoGazeFollow_IdleInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c16_DemoGazeFollow_Idle;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c16_DemoGazeFollow_Idle;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c16_DemoGazeFollow_Idle;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c16_DemoGazeFollow_Idle;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c16_DemoGazeFollow_Idle;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c16_DemoGazeFollow_Idle;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c16_DemoGazeFollow_Idle;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c16_DemoGazeFollow_Idle;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c16_DemoGazeFollow_Idle;
  chartInstance->chartInfo.mdlStart = mdlStart_c16_DemoGazeFollow_Idle;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c16_DemoGazeFollow_Idle;
...
void c16_DemoGazeFollow_Idle_method_dispatcher(SimStruct *S, int_T method, void *
  data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c16_DemoGazeFollow_Idle(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c16_DemoGazeFollow_Idle(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c16_DemoGazeFollow_Idle(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c16_DemoGazeFollow_Idle_method_dispatcher.\n"
