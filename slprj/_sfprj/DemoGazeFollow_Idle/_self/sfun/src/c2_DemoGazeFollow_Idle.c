...
static void initialize_c2_DemoGazeFollow_Idle
  (SFc2_DemoGazeFollow_IdleInstanceStruct *chartInstance);
static void initialize_params_c2_DemoGazeFollow_Idle
  (SFc2_DemoGazeFollow_IdleInstanceStruct *chartInstance);
static void enable_c2_DemoGazeFollow_Idle(SFc2_DemoGazeFollow_IdleInstanceStruct
  *chartInstance);
static void disable_c2_DemoGazeFollow_Idle
  (SFc2_DemoGazeFollow_IdleInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_DemoGazeFollow_Idle
  (SFc2_DemoGazeFollow_IdleInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_DemoGazeFollow_Idle
  (SFc2_DemoGazeFollow_IdleInstanceStruct *chartInstance);
static void set_sim_state_c2_DemoGazeFollow_Idle
  (SFc2_DemoGazeFollow_IdleInstanceStruct *chartInstance, const mxArray *c2_st);
static void finalize_c2_DemoGazeFollow_Idle
  (SFc2_DemoGazeFollow_IdleInstanceStruct *chartInstance);
static void sf_gateway_c2_DemoGazeFollow_Idle
  (SFc2_DemoGazeFollow_IdleInstanceStruct *chartInstance);
static void initSimStructsc2_DemoGazeFollow_Idle
  (SFc2_DemoGazeFollow_IdleInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber, uint32_T c2_instanceNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static real_T c2_emlrt_marshallIn(SFc2_DemoGazeFollow_IdleInstanceStruct
...
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_b_emlrt_marshallIn(SFc2_DemoGazeFollow_IdleInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_c_emlrt_marshallIn(SFc2_DemoGazeFollow_IdleInstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_DemoGazeFollow_Idle, const
  char_T *c2_identifier);
static uint8_T c2_d_emlrt_marshallIn(SFc2_DemoGazeFollow_IdleInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void init_dsm_address_info(SFc2_DemoGazeFollow_IdleInstanceStruct
  *chartInstance);
  ...
  (SFc2_DemoGazeFollow_IdleInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_DemoGazeFollow_Idle = 0U;
}
  ...
  (SFc2_DemoGazeFollow_IdleInstanceStruct *chartInstance)
{
  ...
  c2_hoistedGlobal = chartInstance->c2_is_active_c2_DemoGazeFollow_Idle;
  ...
  (SFc2_DemoGazeFollow_IdleInstanceStruct *chartInstance, const mxArray *c2_st)
{
  ...
  chartInstance->c2_is_active_c2_DemoGazeFollow_Idle = c2_c_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 0)),
     "is_active_c2_DemoGazeFollow_Idle");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_DemoGazeFollow_Idle(chartInstance);
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_DemoGazeFollow_IdleInstanceStruct *chartInstance;
  chartInstance = (SFc2_DemoGazeFollow_IdleInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c2_DemoGazeFollow_Idle_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c2_identifier)
{
  ...
  c2_y = c2_d_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_DemoGazeFollow_Idle), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_DemoGazeFollow_Idle);
  return c2_y;
}
...
void sf_c2_DemoGazeFollow_Idle_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c2_DemoGazeFollow_Idle_get_autoinheritance_info(void)
{
...
mxArray *sf_c2_DemoGazeFollow_Idle_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_DemoGazeFollow_Idle_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c2_DemoGazeFollow_Idle(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S'type','srcId','name','auxInfo'{{M[8],M[0],T\"is_active_c2_DemoGazeFollow_Idle\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 1, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_DemoGazeFollow_Idle_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc2_DemoGazeFollow_IdleInstanceStruct *)
...
static void sf_opaque_initialize_c2_DemoGazeFollow_Idle(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_DemoGazeFollow_IdleInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_DemoGazeFollow_Idle
    ((SFc2_DemoGazeFollow_IdleInstanceStruct*) chartInstanceVar);
  initialize_c2_DemoGazeFollow_Idle((SFc2_DemoGazeFollow_IdleInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c2_DemoGazeFollow_Idle(void *chartInstanceVar)
{
  enable_c2_DemoGazeFollow_Idle((SFc2_DemoGazeFollow_IdleInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c2_DemoGazeFollow_Idle(void *chartInstanceVar)
{
  disable_c2_DemoGazeFollow_Idle((SFc2_DemoGazeFollow_IdleInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c2_DemoGazeFollow_Idle(void *chartInstanceVar)
{
  sf_gateway_c2_DemoGazeFollow_Idle((SFc2_DemoGazeFollow_IdleInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_DemoGazeFollow_Idle(SimStruct*
  S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_DemoGazeFollow_Idle
    ((SFc2_DemoGazeFollow_IdleInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_DemoGazeFollow_Idle();/* state var info */
...
extern void sf_internal_set_sim_state_c2_DemoGazeFollow_Idle(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c2_DemoGazeFollow_Idle();/* state var info */
  ...
  set_sim_state_c2_DemoGazeFollow_Idle((SFc2_DemoGazeFollow_IdleInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c2_DemoGazeFollow_Idle(SimStruct*
  S)
{
  return sf_internal_get_sim_state_c2_DemoGazeFollow_Idle(S);
}

static void sf_opaque_set_sim_state_c2_DemoGazeFollow_Idle(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c2_DemoGazeFollow_Idle(S, st);
}

static void sf_opaque_terminate_c2_DemoGazeFollow_Idle(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_DemoGazeFollow_IdleInstanceStruct*) chartInstanceVar
      )->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c2_DemoGazeFollow_Idle((SFc2_DemoGazeFollow_IdleInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc2_DemoGazeFollow_Idle((SFc2_DemoGazeFollow_IdleInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_DemoGazeFollow_Idle(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ...
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c2_DemoGazeFollow_Idle
      ((SFc2_DemoGazeFollow_IdleInstanceStruct*)(chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c2_DemoGazeFollow_Idle(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c2_DemoGazeFollow_Idle(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_DemoGazeFollow_Idle(SimStruct *S)
{
  SFc2_DemoGazeFollow_IdleInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc2_DemoGazeFollow_IdleInstanceStruct *)utMalloc(sizeof
    (SFc2_DemoGazeFollow_IdleInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_DemoGazeFollow_IdleInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_DemoGazeFollow_Idle;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_DemoGazeFollow_Idle;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_DemoGazeFollow_Idle;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_DemoGazeFollow_Idle;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c2_DemoGazeFollow_Idle;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_DemoGazeFollow_Idle;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_DemoGazeFollow_Idle;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_DemoGazeFollow_Idle;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_DemoGazeFollow_Idle;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_DemoGazeFollow_Idle;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_DemoGazeFollow_Idle;
...
void c2_DemoGazeFollow_Idle_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_DemoGazeFollow_Idle(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_DemoGazeFollow_Idle(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_DemoGazeFollow_Idle(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_DemoGazeFollow_Idle_method_dispatcher.\n"
