...
#include "c35_Expriment_FacialExpr.h"
...
static void initialize_c35_Expriment_FacialExpr
  (SFc35_Expriment_FacialExprInstanceStruct *chartInstance);
static void initialize_params_c35_Expriment_FacialExpr
  (SFc35_Expriment_FacialExprInstanceStruct *chartInstance);
static void enable_c35_Expriment_FacialExpr
  (SFc35_Expriment_FacialExprInstanceStruct *chartInstance);
static void disable_c35_Expriment_FacialExpr
  (SFc35_Expriment_FacialExprInstanceStruct *chartInstance);
static void c35_update_debugger_state_c35_Expriment_FacialExpr
  (SFc35_Expriment_FacialExprInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c35_Expriment_FacialExpr
  (SFc35_Expriment_FacialExprInstanceStruct *chartInstance);
static void set_sim_state_c35_Expriment_FacialExpr
  (SFc35_Expriment_FacialExprInstanceStruct *chartInstance, const mxArray
   *c35_st);
static void c35_set_sim_state_side_effects_c35_Expriment_FacialExpr
  (SFc35_Expriment_FacialExprInstanceStruct *chartInstance);
static void finalize_c35_Expriment_FacialExpr
  (SFc35_Expriment_FacialExprInstanceStruct *chartInstance);
static void sf_gateway_c35_Expriment_FacialExpr
  (SFc35_Expriment_FacialExprInstanceStruct *chartInstance);
static void initSimStructsc35_Expriment_FacialExpr
  (SFc35_Expriment_FacialExprInstanceStruct *chartInstance);
...
static const mxArray *c35_sf_marshallOut(void *chartInstanceVoid, void
  *c35_inData);
static real_T c35_emlrt_marshallIn(SFc35_Expriment_FacialExprInstanceStruct
...
static const mxArray *c35_b_sf_marshallOut(void *chartInstanceVoid, void
  *c35_inData);
static void c35_b_emlrt_marshallIn(SFc35_Expriment_FacialExprInstanceStruct
  *chartInstance, const mxArray *c35_u, const emlrtMsgIdentifier *c35_parentId,
  real_T c35_y[1000]);
...
static void c35_sendSBM(SFc35_Expriment_FacialExprInstanceStruct *chartInstance,
  real_T c35_In2[1000]);
static const mxArray *c35_e_sf_marshallOut(void *chartInstanceVoid, void
  *c35_inData);
static int32_T c35_c_emlrt_marshallIn(SFc35_Expriment_FacialExprInstanceStruct
  *chartInstance, const mxArray *c35_u, const emlrtMsgIdentifier *c35_parentId);
...
static const mxArray *c35_f_sf_marshallOut(void *chartInstanceVoid, void
  *c35_inData);
static uint8_T c35_d_emlrt_marshallIn(SFc35_Expriment_FacialExprInstanceStruct
  *chartInstance, const mxArray *c35_b_tp_stateCreatePawn, const char_T
  *c35_identifier);
static uint8_T c35_e_emlrt_marshallIn(SFc35_Expriment_FacialExprInstanceStruct
  *chartInstance, const mxArray *c35_u, const emlrtMsgIdentifier *c35_parentId);
...
static const mxArray *c35_g_sf_marshallOut(void *chartInstanceVoid, void
  *c35_inData);
static void c35_f_emlrt_marshallIn(SFc35_Expriment_FacialExprInstanceStruct
  *chartInstance, const mxArray *c35_u, const emlrtMsgIdentifier *c35_parentId,
  real_T c35_y[1000]);
...
static const mxArray *c35_h_emlrt_marshallIn
  (SFc35_Expriment_FacialExprInstanceStruct *chartInstance, const mxArray *c35_u,
   const emlrtMsgIdentifier *c35_parentId);
static void init_dsm_address_info(SFc35_Expriment_FacialExprInstanceStruct
  *chartInstance);
  ...
  (SFc35_Expriment_FacialExprInstanceStruct *chartInstance)
{
  ...
  chartInstance->c35_is_active_c35_Expriment_FacialExpr = 0U;
  chartInstance->c35_is_c35_Expriment_FacialExpr = c35_IN_NO_ACTIVE_CHILD;
}
  ...
  (SFc35_Expriment_FacialExprInstanceStruct *chartInstance)
{
  ...
  if (chartInstance->c35_is_active_c35_Expriment_FacialExpr == 1U) {
    _SFD_CC_CALL(CHART_ACTIVE_TAG, 16U, chartInstance->c35_sfEvent);
  }

  if (chartInstance->c35_is_c35_Expriment_FacialExpr == c35_IN_stateCreatePawn)
  {
  ...
  (SFc35_Expriment_FacialExprInstanceStruct *chartInstance)
{
  ...
  c35_hoistedGlobal = chartInstance->c35_is_active_c35_Expriment_FacialExpr;
  c35_u = c35_hoistedGlobal;
  c35_b_y = NULL;
  sf_mex_assign(&c35_b_y, sf_mex_create("y", &c35_u, 3, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c35_y, 0, c35_b_y);
  c35_b_hoistedGlobal = chartInstance->c35_is_c35_Expriment_FacialExpr;
   ...
   *c35_st)
{
  ...
  chartInstance->c35_is_active_c35_Expriment_FacialExpr = c35_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c35_u, 0)),
     "is_active_c35_Expriment_FacialExpr");
  chartInstance->c35_is_c35_Expriment_FacialExpr = c35_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c35_u, 1)),
     "is_c35_Expriment_FacialExpr");
  ...
  c35_update_debugger_state_c35_Expriment_FacialExpr(chartInstance);
...
static void sf_gateway_c35_Expriment_FacialExpr
  (SFc35_Expriment_FacialExprInstanceStruct *chartInstance)
{
  c35_set_sim_state_side_effects_c35_Expriment_FacialExpr(chartInstance);
  ...
  if (chartInstance->c35_is_active_c35_Expriment_FacialExpr == 0U) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 16U, chartInstance->c35_sfEvent);
    chartInstance->c35_is_active_c35_Expriment_FacialExpr = 1U;
    ...
    chartInstance->c35_is_c35_Expriment_FacialExpr = c35_IN_stateCreatePawn;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, chartInstance->c35_sfEvent);
    chartInstance->c35_tp_stateCreatePawn = 1U;
  ...
  *c35_inData)
{
  ...
  const mxArray *c35_y = NULL;
  SFc35_Expriment_FacialExprInstanceStruct *chartInstance;
  chartInstance = (SFc35_Expriment_FacialExprInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c35_Expriment_FacialExpr_get_eml_resolved_functions_info(void)
{
...
void sf_c35_Expriment_FacialExpr_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c35_Expriment_FacialExpr_get_autoinheritance_info(void)
{
...
mxArray *sf_c35_Expriment_FacialExpr_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c35_Expriment_FacialExpr_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c35_Expriment_FacialExpr(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[8],M[0],T\"is_active_c35_Expriment_FacialExpr\",},{M[9],M[0],T\"is_c35_Expriment_FacialExpr\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c35_Expriment_FacialExpr_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc35_Expriment_FacialExprInstanceStruct *)
...
static void sf_opaque_initialize_c35_Expriment_FacialExpr(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc35_Expriment_FacialExprInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c35_Expriment_FacialExpr
    ((SFc35_Expriment_FacialExprInstanceStruct*) chartInstanceVar);
  initialize_c35_Expriment_FacialExpr((SFc35_Expriment_FacialExprInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c35_Expriment_FacialExpr(void *chartInstanceVar)
{
  enable_c35_Expriment_FacialExpr((SFc35_Expriment_FacialExprInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c35_Expriment_FacialExpr(void *chartInstanceVar)
{
  disable_c35_Expriment_FacialExpr((SFc35_Expriment_FacialExprInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c35_Expriment_FacialExpr(void *chartInstanceVar)
{
  sf_gateway_c35_Expriment_FacialExpr((SFc35_Expriment_FacialExprInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c35_Expriment_FacialExpr
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c35_Expriment_FacialExpr
    ((SFc35_Expriment_FacialExprInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c35_Expriment_FacialExpr();/* state var info */
...
extern void sf_internal_set_sim_state_c35_Expriment_FacialExpr(SimStruct* S,
  const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c35_Expriment_FacialExpr();/* state var info */
  ...
  set_sim_state_c35_Expriment_FacialExpr
    ((SFc35_Expriment_FacialExprInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c35_Expriment_FacialExpr(SimStruct*
  S)
{
  return sf_internal_get_sim_state_c35_Expriment_FacialExpr(S);
}

static void sf_opaque_set_sim_state_c35_Expriment_FacialExpr(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c35_Expriment_FacialExpr(S, st);
}

static void sf_opaque_terminate_c35_Expriment_FacialExpr(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc35_Expriment_FacialExprInstanceStruct*) chartInstanceVar)
      ->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c35_Expriment_FacialExpr((SFc35_Expriment_FacialExprInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc35_Expriment_FacialExpr
    ((SFc35_Expriment_FacialExprInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c35_Expriment_FacialExpr(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c35_Expriment_FacialExpr(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(1300229230U));
  ssSetChecksum1(S,(2474749141U));
  ssSetChecksum2(S,(3665080583U));
  ssSetChecksum3(S,(1028267185U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c35_Expriment_FacialExpr(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c35_Expriment_FacialExpr(SimStruct *S)
{
  SFc35_Expriment_FacialExprInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc35_Expriment_FacialExprInstanceStruct *)utMalloc(sizeof
    (SFc35_Expriment_FacialExprInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc35_Expriment_FacialExprInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c35_Expriment_FacialExpr;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c35_Expriment_FacialExpr;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c35_Expriment_FacialExpr;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c35_Expriment_FacialExpr;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c35_Expriment_FacialExpr;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c35_Expriment_FacialExpr;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c35_Expriment_FacialExpr;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c35_Expriment_FacialExpr;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c35_Expriment_FacialExpr;
  chartInstance->chartInfo.mdlStart = mdlStart_c35_Expriment_FacialExpr;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c35_Expriment_FacialExpr;
...
void c35_Expriment_FacialExpr_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c35_Expriment_FacialExpr(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c35_Expriment_FacialExpr(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c35_Expriment_FacialExpr(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c35_Expriment_FacialExpr_method_dispatcher.\n"
