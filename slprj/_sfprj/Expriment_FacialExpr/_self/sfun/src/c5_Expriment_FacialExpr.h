#ifndef __c5_Expriment_FacialExpr_h__
#define __c5_Expriment_FacialExpr_h__
...
/* Type Definitions */
#ifndef typedef_SFc5_Expriment_FacialExprInstanceStruct
#define typedef_SFc5_Expriment_FacialExprInstanceStruct
...
typedef struct {
  ...
  uint8_T c5_is_active_c5_Expriment_FacialExpr;
...
#endif                                 /*typedef_SFc5_Expriment_FacialExprInstanceStruct*/
...
extern const mxArray *sf_c5_Expriment_FacialExpr_get_eml_resolved_functions_info
  (void);
...
extern void sf_exported_auto_deactivate_c5_Expriment_FacialExpr_secs(SimStruct
  *c5_S);
extern boolean_T sf_exported_auto_isStablec5_Expriment_FacialExpr(SimStruct
  *c5_S);
extern void sf_exported_auto_duringc5_Expriment_FacialExpr(SimStruct *c5_S);
extern void sf_exported_auto_enterc5_Expriment_FacialExpr(SimStruct *c5_S);
extern void sf_exported_auto_exitc5_Expriment_FacialExpr(SimStruct *c5_S);
extern void sf_exported_auto_gatewayc5_Expriment_FacialExpr(SimStruct *c5_S);
extern void sf_exported_auto_enablec5_Expriment_FacialExpr(SimStruct *c5_S);
extern void sf_exported_auto_disablec5_Expriment_FacialExpr(SimStruct *c5_S);
extern void sf_exported_auto_stepBuffersc5_Expriment_FacialExpr(SimStruct *c5_S);
extern void sf_exported_auto_initBuffersc5_Expriment_FacialExpr(SimStruct *c5_S);
extern void sf_exported_auto_activate_callc5_Expriment_FacialExpr(SimStruct
  *c5_S);
extern void sf_exported_auto_increment_call_counterc5_Expriment_FacialExpr
  (SimStruct *c5_S);
extern void sf_exported_auto_reset_call_counterc5_Expriment_FacialExpr(SimStruct
  *c5_S);
extern void sf_exported_auto_deactivate_callc5_Expriment_FacialExpr(SimStruct
  *c5_S);
extern void sf_exported_auto_initc5_Expriment_FacialExpr(SimStruct *c5_S);
...
extern const mxArray *sf_internal_get_sim_state_c5_Expriment_FacialExpr
  (SimStruct *c5_S);
extern void sf_exported_auto_setSimstatec5_Expriment_FacialExpr(SimStruct *c5_S,
  const mxArray *c5_in);
extern void sf_internal_set_sim_state_c5_Expriment_FacialExpr(SimStruct *c5_S,
  const mxArray *c5_in);
extern void sf_exported_auto_check_state_inconsistency_c5_Expriment_FacialExpr
  (SimStruct *c5_S);
extern void sf_exported_user_c5_Expriment_FacialExpr_handPoseSBTable(SimStruct
  *c5_S, real_T c5_sbmID, real_T c5_poseSBM[1000]);
extern void sf_exported_user_c5_Expriment_FacialExpr_idlePoseBradTable(SimStruct
  *c5_S, real_T c5_bmlID, real_T *c5_p, real_T c5_poseBML[1000]);
extern void sf_exported_user_c5_Expriment_FacialExpr_initialPoseTable(SimStruct *
  c5_S, real_T c5_bmlID, real_T *c5_p, real_T c5_poseBML[1000]);
extern void sf_exported_user_c5_Expriment_FacialExpr_insertQueue(SimStruct *c5_S,
  real_T c5_bmls[5000], real_T c5_mBML[1000], real_T c5_newBmls[5000]);
extern void sf_exported_user_c5_Expriment_FacialExpr_insertQueueLow(SimStruct
  *c5_S, real_T c5_bmls[5000], real_T c5_myBML[1000], real_T c5_newBmls[5000]);
extern void sf_exported_user_c5_Expriment_FacialExpr_paperPoseBradTable
  (SimStruct *c5_S, real_T c5_bmlID, real_T *c5_p, real_T c5_poseBML[1000]);
extern void sf_exported_user_c5_Expriment_FacialExpr_rockPoseTable(SimStruct
  *c5_S, real_T c5_bmlID, real_T *c5_p, real_T c5_poseBML[1000]);
extern void sf_exported_user_c5_Expriment_FacialExpr_scissorsPoseBradTable
  (SimStruct *c5_S, real_T c5_bmlID, real_T *c5_p, real_T c5_poseBML[1000]);
extern void sf_exported_user_c5_Expriment_FacialExpr_sendSBM(SimStruct *c5_S,
  real_T c5_arg[256]);

/* Function Definitions */
extern void sf_c5_Expriment_FacialExpr_get_check_sum(mxArray *plhs[]);
extern void c5_Expriment_FacialExpr_method_dispatcher(SimStruct *S, int_T method,
  void *data);
