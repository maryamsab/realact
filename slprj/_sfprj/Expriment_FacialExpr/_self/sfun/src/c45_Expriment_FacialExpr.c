...
#include "c45_Expriment_FacialExpr.h"
...
static void initialize_c45_Expriment_FacialExpr
  (SFc45_Expriment_FacialExprInstanceStruct *chartInstance);
static void initialize_params_c45_Expriment_FacialExpr
  (SFc45_Expriment_FacialExprInstanceStruct *chartInstance);
static void enable_c45_Expriment_FacialExpr
  (SFc45_Expriment_FacialExprInstanceStruct *chartInstance);
static void disable_c45_Expriment_FacialExpr
  (SFc45_Expriment_FacialExprInstanceStruct *chartInstance);
static void c45_update_debugger_state_c45_Expriment_FacialExpr
  (SFc45_Expriment_FacialExprInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c45_Expriment_FacialExpr
  (SFc45_Expriment_FacialExprInstanceStruct *chartInstance);
static void set_sim_state_c45_Expriment_FacialExpr
  (SFc45_Expriment_FacialExprInstanceStruct *chartInstance, const mxArray
   *c45_st);
static void finalize_c45_Expriment_FacialExpr
  (SFc45_Expriment_FacialExprInstanceStruct *chartInstance);
static void sf_gateway_c45_Expriment_FacialExpr
  (SFc45_Expriment_FacialExprInstanceStruct *chartInstance);
static void initSimStructsc45_Expriment_FacialExpr
  (SFc45_Expriment_FacialExprInstanceStruct *chartInstance);
...
static const mxArray *c45_sf_marshallOut(void *chartInstanceVoid, void
  *c45_inData);
static void c45_emlrt_marshallIn(SFc45_Expriment_FacialExprInstanceStruct
  *chartInstance, const mxArray *c45_y, const char_T *c45_identifier, real_T
  c45_b_y[6]);
static void c45_b_emlrt_marshallIn(SFc45_Expriment_FacialExprInstanceStruct
...
static const mxArray *c45_b_sf_marshallOut(void *chartInstanceVoid, void
  *c45_inData);
static real_T c45_c_emlrt_marshallIn(SFc45_Expriment_FacialExprInstanceStruct
  *chartInstance, const mxArray *c45_u, const emlrtMsgIdentifier *c45_parentId);
...
static const mxArray *c45_c_sf_marshallOut(void *chartInstanceVoid, void
  *c45_inData);
static int32_T c45_d_emlrt_marshallIn(SFc45_Expriment_FacialExprInstanceStruct
  *chartInstance, const mxArray *c45_u, const emlrtMsgIdentifier *c45_parentId);
static void c45_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c45_mxArrayInData, const char_T *c45_varName, void *c45_outData);
static uint8_T c45_e_emlrt_marshallIn(SFc45_Expriment_FacialExprInstanceStruct
  *chartInstance, const mxArray *c45_b_is_active_c45_Expriment_FacialExpr, const
  char_T *c45_identifier);
static uint8_T c45_f_emlrt_marshallIn(SFc45_Expriment_FacialExprInstanceStruct
  *chartInstance, const mxArray *c45_u, const emlrtMsgIdentifier *c45_parentId);
static void init_dsm_address_info(SFc45_Expriment_FacialExprInstanceStruct
  *chartInstance);
  ...
  (SFc45_Expriment_FacialExprInstanceStruct *chartInstance)
{
  ...
  chartInstance->c45_is_active_c45_Expriment_FacialExpr = 0U;
}
  ...
  (SFc45_Expriment_FacialExprInstanceStruct *chartInstance)
{
  ...
  c45_hoistedGlobal = chartInstance->c45_is_active_c45_Expriment_FacialExpr;
   ...
   *c45_st)
{
  ...
  chartInstance->c45_is_active_c45_Expriment_FacialExpr = c45_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c45_u, 1)),
     "is_active_c45_Expriment_FacialExpr");
  sf_mex_destroy(&c45_u);
  c45_update_debugger_state_c45_Expriment_FacialExpr(chartInstance);
  ...
  *c45_inData)
{
  ...
  const mxArray *c45_y = NULL;
  SFc45_Expriment_FacialExprInstanceStruct *chartInstance;
  chartInstance = (SFc45_Expriment_FacialExprInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c45_Expriment_FacialExpr_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c45_identifier)
{
  ...
  c45_y = c45_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c45_b_is_active_c45_Expriment_FacialExpr), &c45_thisId);
  sf_mex_destroy(&c45_b_is_active_c45_Expriment_FacialExpr);
  return c45_y;
}
...
void sf_c45_Expriment_FacialExpr_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c45_Expriment_FacialExpr_get_autoinheritance_info(void)
{
...
mxArray *sf_c45_Expriment_FacialExpr_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c45_Expriment_FacialExpr_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c45_Expriment_FacialExpr(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c45_Expriment_FacialExpr\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c45_Expriment_FacialExpr_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc45_Expriment_FacialExprInstanceStruct *)
...
static void sf_opaque_initialize_c45_Expriment_FacialExpr(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc45_Expriment_FacialExprInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c45_Expriment_FacialExpr
    ((SFc45_Expriment_FacialExprInstanceStruct*) chartInstanceVar);
  initialize_c45_Expriment_FacialExpr((SFc45_Expriment_FacialExprInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c45_Expriment_FacialExpr(void *chartInstanceVar)
{
  enable_c45_Expriment_FacialExpr((SFc45_Expriment_FacialExprInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c45_Expriment_FacialExpr(void *chartInstanceVar)
{
  disable_c45_Expriment_FacialExpr((SFc45_Expriment_FacialExprInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c45_Expriment_FacialExpr(void *chartInstanceVar)
{
  sf_gateway_c45_Expriment_FacialExpr((SFc45_Expriment_FacialExprInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c45_Expriment_FacialExpr
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c45_Expriment_FacialExpr
    ((SFc45_Expriment_FacialExprInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c45_Expriment_FacialExpr();/* state var info */
...
extern void sf_internal_set_sim_state_c45_Expriment_FacialExpr(SimStruct* S,
  const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c45_Expriment_FacialExpr();/* state var info */
  ...
  set_sim_state_c45_Expriment_FacialExpr
    ((SFc45_Expriment_FacialExprInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c45_Expriment_FacialExpr(SimStruct*
  S)
{
  return sf_internal_get_sim_state_c45_Expriment_FacialExpr(S);
}

static void sf_opaque_set_sim_state_c45_Expriment_FacialExpr(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c45_Expriment_FacialExpr(S, st);
}

static void sf_opaque_terminate_c45_Expriment_FacialExpr(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc45_Expriment_FacialExprInstanceStruct*) chartInstanceVar)
      ->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c45_Expriment_FacialExpr((SFc45_Expriment_FacialExprInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc45_Expriment_FacialExpr
    ((SFc45_Expriment_FacialExprInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c45_Expriment_FacialExpr(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c45_Expriment_FacialExpr(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c45_Expriment_FacialExpr(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c45_Expriment_FacialExpr(SimStruct *S)
{
  SFc45_Expriment_FacialExprInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc45_Expriment_FacialExprInstanceStruct *)utMalloc(sizeof
    (SFc45_Expriment_FacialExprInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc45_Expriment_FacialExprInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c45_Expriment_FacialExpr;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c45_Expriment_FacialExpr;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c45_Expriment_FacialExpr;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c45_Expriment_FacialExpr;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c45_Expriment_FacialExpr;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c45_Expriment_FacialExpr;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c45_Expriment_FacialExpr;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c45_Expriment_FacialExpr;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c45_Expriment_FacialExpr;
  chartInstance->chartInfo.mdlStart = mdlStart_c45_Expriment_FacialExpr;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c45_Expriment_FacialExpr;
...
void c45_Expriment_FacialExpr_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c45_Expriment_FacialExpr(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c45_Expriment_FacialExpr(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c45_Expriment_FacialExpr(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c45_Expriment_FacialExpr_method_dispatcher.\n"
