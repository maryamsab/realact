...
#include "c16_Expriment_FacialExpr.h"
...
static void initialize_c16_Expriment_FacialExpr
  (SFc16_Expriment_FacialExprInstanceStruct *chartInstance);
static void initialize_params_c16_Expriment_FacialExpr
  (SFc16_Expriment_FacialExprInstanceStruct *chartInstance);
static void enable_c16_Expriment_FacialExpr
  (SFc16_Expriment_FacialExprInstanceStruct *chartInstance);
static void disable_c16_Expriment_FacialExpr
  (SFc16_Expriment_FacialExprInstanceStruct *chartInstance);
static void c16_update_debugger_state_c16_Expriment_FacialExpr
  (SFc16_Expriment_FacialExprInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c16_Expriment_FacialExpr
  (SFc16_Expriment_FacialExprInstanceStruct *chartInstance);
static void set_sim_state_c16_Expriment_FacialExpr
  (SFc16_Expriment_FacialExprInstanceStruct *chartInstance, const mxArray
   *c16_st);
static void finalize_c16_Expriment_FacialExpr
  (SFc16_Expriment_FacialExprInstanceStruct *chartInstance);
static void sf_gateway_c16_Expriment_FacialExpr
  (SFc16_Expriment_FacialExprInstanceStruct *chartInstance);
static void initSimStructsc16_Expriment_FacialExpr
  (SFc16_Expriment_FacialExprInstanceStruct *chartInstance);
static void c16_encStr2Arr(SFc16_Expriment_FacialExprInstanceStruct
...
static void c16_emlrt_marshallIn(SFc16_Expriment_FacialExprInstanceStruct
  *chartInstance, const mxArray *c16_sprintf, const char_T *c16_identifier,
  char_T c16_y_data[], int32_T c16_y_sizes[2]);
static void c16_b_emlrt_marshallIn(SFc16_Expriment_FacialExprInstanceStruct
...
static const mxArray *c16_sf_marshallOut(void *chartInstanceVoid, void
  *c16_inData);
static void c16_c_emlrt_marshallIn(SFc16_Expriment_FacialExprInstanceStruct
  *chartInstance, const mxArray *c16_arrBML, const char_T *c16_identifier,
  real_T c16_y[1000]);
static void c16_d_emlrt_marshallIn(SFc16_Expriment_FacialExprInstanceStruct
  *chartInstance, const mxArray *c16_u, const emlrtMsgIdentifier *c16_parentId,
  real_T c16_y[1000]);
...
static const mxArray *c16_b_sf_marshallOut(void *chartInstanceVoid, void
  *c16_inData);
static real_T c16_e_emlrt_marshallIn(SFc16_Expriment_FacialExprInstanceStruct
  *chartInstance, const mxArray *c16_u, const emlrtMsgIdentifier *c16_parentId);
...
static void c16_f_emlrt_marshallIn(SFc16_Expriment_FacialExprInstanceStruct
  *chartInstance, const mxArray *c16_u, const emlrtMsgIdentifier *c16_parentId,
  char_T c16_y_data[], int32_T c16_y_sizes[2]);
...
static void c16_g_emlrt_marshallIn(SFc16_Expriment_FacialExprInstanceStruct
  *chartInstance, const mxArray *c16_u, const emlrtMsgIdentifier *c16_parentId,
...
static const mxArray *c16_e_sf_marshallOut(void *chartInstanceVoid, void
  *c16_inData);
static int32_T c16_h_emlrt_marshallIn(SFc16_Expriment_FacialExprInstanceStruct
  *chartInstance, const mxArray *c16_u, const emlrtMsgIdentifier *c16_parentId);
static void c16_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c16_mxArrayInData, const char_T *c16_varName, void *c16_outData);
static uint8_T c16_i_emlrt_marshallIn(SFc16_Expriment_FacialExprInstanceStruct
  *chartInstance, const mxArray *c16_b_is_active_c16_Expriment_FacialExpr, const
  char_T *c16_identifier);
static uint8_T c16_j_emlrt_marshallIn(SFc16_Expriment_FacialExprInstanceStruct
  *chartInstance, const mxArray *c16_u, const emlrtMsgIdentifier *c16_parentId);
static void init_dsm_address_info(SFc16_Expriment_FacialExprInstanceStruct
  *chartInstance);
  ...
  (SFc16_Expriment_FacialExprInstanceStruct *chartInstance)
{
  ...
  chartInstance->c16_is_active_c16_Expriment_FacialExpr = 0U;
}
  ...
  (SFc16_Expriment_FacialExprInstanceStruct *chartInstance)
{
  ...
  c16_hoistedGlobal = chartInstance->c16_is_active_c16_Expriment_FacialExpr;
   ...
   *c16_st)
{
  ...
  chartInstance->c16_is_active_c16_Expriment_FacialExpr = c16_i_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c16_u, 1)),
     "is_active_c16_Expriment_FacialExpr");
  sf_mex_destroy(&c16_u);
  c16_update_debugger_state_c16_Expriment_FacialExpr(chartInstance);
  ...
  c16_chartNumber, uint32_T c16_instanceNumber)
{
  ...
  _SFD_SCRIPT_TRANSLATION(c16_chartNumber, c16_instanceNumber, 0U,
    ...
    "C:\\Users\\root180\\Documents\\affective-project\\21-12-2015-Matlab\\countDigits.m"));
  ...
  *c16_inData)
{
  ...
  const mxArray *c16_y = NULL;
  SFc16_Expriment_FacialExprInstanceStruct *chartInstance;
  chartInstance = (SFc16_Expriment_FacialExprInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c16_Expriment_FacialExpr_get_eml_resolved_functions_info(void)
{
...
static void c16_info_helper(const mxArray **c16_info)
{
  ...
  sf_mex_addfield(*c16_info, c16_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 7);
  sf_mex_addfield(*c16_info, c16_emlrt_marshallOut(
    "[E]C:/Users/root180/Documents/affective-project/21-12-2015-Matlab/countDigits.m"),
                  "resolved", "resolved", 7);
  ...
  char_T *c16_identifier)
{
  ...
  c16_y = c16_j_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c16_b_is_active_c16_Expriment_FacialExpr), &c16_thisId);
  sf_mex_destroy(&c16_b_is_active_c16_Expriment_FacialExpr);
  return c16_y;
}
...
void sf_c16_Expriment_FacialExpr_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c16_Expriment_FacialExpr_get_autoinheritance_info(void)
{
...
mxArray *sf_c16_Expriment_FacialExpr_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c16_Expriment_FacialExpr_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c16_Expriment_FacialExpr(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[14],T\"arrBML\",},{M[8],M[0],T\"is_active_c16_Expriment_FacialExpr\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c16_Expriment_FacialExpr_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc16_Expriment_FacialExprInstanceStruct *)
...
static void sf_opaque_initialize_c16_Expriment_FacialExpr(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc16_Expriment_FacialExprInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c16_Expriment_FacialExpr
    ((SFc16_Expriment_FacialExprInstanceStruct*) chartInstanceVar);
  initialize_c16_Expriment_FacialExpr((SFc16_Expriment_FacialExprInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c16_Expriment_FacialExpr(void *chartInstanceVar)
{
  enable_c16_Expriment_FacialExpr((SFc16_Expriment_FacialExprInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c16_Expriment_FacialExpr(void *chartInstanceVar)
{
  disable_c16_Expriment_FacialExpr((SFc16_Expriment_FacialExprInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c16_Expriment_FacialExpr(void *chartInstanceVar)
{
  sf_gateway_c16_Expriment_FacialExpr((SFc16_Expriment_FacialExprInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c16_Expriment_FacialExpr
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c16_Expriment_FacialExpr
    ((SFc16_Expriment_FacialExprInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c16_Expriment_FacialExpr();/* state var info */
...
extern void sf_internal_set_sim_state_c16_Expriment_FacialExpr(SimStruct* S,
  const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c16_Expriment_FacialExpr();/* state var info */
  ...
  set_sim_state_c16_Expriment_FacialExpr
    ((SFc16_Expriment_FacialExprInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c16_Expriment_FacialExpr(SimStruct*
  S)
{
  return sf_internal_get_sim_state_c16_Expriment_FacialExpr(S);
}

static void sf_opaque_set_sim_state_c16_Expriment_FacialExpr(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c16_Expriment_FacialExpr(S, st);
}

static void sf_opaque_terminate_c16_Expriment_FacialExpr(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc16_Expriment_FacialExprInstanceStruct*) chartInstanceVar)
      ->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c16_Expriment_FacialExpr((SFc16_Expriment_FacialExprInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc16_Expriment_FacialExpr
    ((SFc16_Expriment_FacialExprInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c16_Expriment_FacialExpr(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c16_Expriment_FacialExpr(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(2208151005U));
  ssSetChecksum1(S,(1305813206U));
  ssSetChecksum2(S,(4227909976U));
  ssSetChecksum3(S,(54006860U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c16_Expriment_FacialExpr(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c16_Expriment_FacialExpr(SimStruct *S)
{
  SFc16_Expriment_FacialExprInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc16_Expriment_FacialExprInstanceStruct *)utMalloc(sizeof
    (SFc16_Expriment_FacialExprInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc16_Expriment_FacialExprInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c16_Expriment_FacialExpr;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c16_Expriment_FacialExpr;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c16_Expriment_FacialExpr;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c16_Expriment_FacialExpr;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c16_Expriment_FacialExpr;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c16_Expriment_FacialExpr;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c16_Expriment_FacialExpr;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c16_Expriment_FacialExpr;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c16_Expriment_FacialExpr;
  chartInstance->chartInfo.mdlStart = mdlStart_c16_Expriment_FacialExpr;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c16_Expriment_FacialExpr;
...
void c16_Expriment_FacialExpr_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c16_Expriment_FacialExpr(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c16_Expriment_FacialExpr(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c16_Expriment_FacialExpr(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c16_Expriment_FacialExpr_method_dispatcher.\n"
