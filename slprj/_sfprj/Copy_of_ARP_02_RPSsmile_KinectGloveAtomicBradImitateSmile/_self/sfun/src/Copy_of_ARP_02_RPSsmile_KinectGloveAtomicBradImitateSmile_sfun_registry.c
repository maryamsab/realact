  ...
  const mxArray * prhs[] )
{
  ...
  if (sf_Copy_of_ARP_02_RPSsmile_KinectGloveAtomicBradImitateSmile_process_check_sum_call
      (nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
  ...
  nrhs, const mxArray * prhs[] )
{
  ...
  if (strcmp(machineName,
             "Copy_of_ARP_02_RPSsmile_KinectGloveAtomicBradImitateSmile") == 0)
  {
...
extern void Copy_of_ARP_02_RPSsmile_KinectGloveAtomicBradImitateSmile_terminator
  (void);
void sf_machine_global_terminator(void)
{
  sfGlobalMdlStartCallCounts--;
  if (sfGlobalMdlStartCallCounts == 0) {
    Copy_of_ARP_02_RPSsmile_KinectGloveAtomicBradImitateSmile_terminator();
...
extern void
  Copy_of_ARP_02_RPSsmile_KinectGloveAtomicBradImitateSmile_initializer(void);
extern void
  Copy_of_ARP_02_RPSsmile_KinectGloveAtomicBradImitateSmile_register_exported_symbols
  (SimStruct* S);
extern void
  Copy_of_ARP_02_RPSsmile_KinectGloveAtomicBradImitateSmile_debug_initialize(
    struct SfDebugInstanceStruct*);
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfGlobalMdlStartCallCounts == 1) {
    ...
    Copy_of_ARP_02_RPSsmile_KinectGloveAtomicBradImitateSmile_initializer();
  }
