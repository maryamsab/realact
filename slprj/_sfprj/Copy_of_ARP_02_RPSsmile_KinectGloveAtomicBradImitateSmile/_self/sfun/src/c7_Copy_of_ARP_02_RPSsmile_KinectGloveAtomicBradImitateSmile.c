...
static void
  initialize_c7_Copy_of_ARP_02_RPSsmile_KinectGloveAtomicBradImitateSmile
  (SFc7_Copy_of_ARP_02_RPSsmile_KinectGloveAtomicBradImitateSmileInstanceStruct *
   chartInstance);
static void
  initialize_params_c7_Copy_of_ARP_02_RPSsmile_KinectGloveAtomicBradImitateSmile
  (SFc7_Copy_of_ARP_02_RPSsmile_KinectGloveAtomicBradImitateSmileInstanceStruct *
   chartInstance);
static void enable_c7_Copy_of_ARP_02_RPSsmile_KinectGloveAtomicBradImitateSmile
  (SFc7_Copy_of_ARP_02_RPSsmile_KinectGloveAtomicBradImitateSmileInstanceStruct *
   chartInstance);
static void disable_c7_Copy_of_ARP_02_RPSsmile_KinectGloveAtomicBradImitateSmile
  (SFc7_Copy_of_ARP_02_RPSsmile_KinectGloveAtomicBradImitateSmileInstanceStruct *
   chartInstance);
static void c7_update_debugger_state_c7_Copy_of_ARP_02_RPSsmile_KinectGloveA
  (SFc7_Copy_of_ARP_02_RPSsmile_KinectGloveAtomicBradImitateSmileInstanceStruct *
   chartInstance);
static const mxArray
  *get_sim_state_c7_Copy_of_ARP_02_RPSsmile_KinectGloveAtomicBradImitateSmile
  (SFc7_Copy_of_ARP_02_RPSsmile_KinectGloveAtomicBradImitateSmileInstanceStruct *
   chartInstance);
static void
  set_sim_state_c7_Copy_of_ARP_02_RPSsmile_KinectGloveAtomicBradImitateSmile
  (SFc7_Copy_of_ARP_02_RPSsmile_KinectGloveAtomicBradImitateSmileInstanceStruct *
   chartInstance, const mxArray *c7_st);
static void
  finalize_c7_Copy_of_ARP_02_RPSsmile_KinectGloveAtomicBradImitateSmile
  (SFc7_Copy_of_ARP_02_RPSsmile_KinectGloveAtomicBradImitateSmileInstanceStruct *
   chartInstance);
static void
  sf_gateway_c7_Copy_of_ARP_02_RPSsmile_KinectGloveAtomicBradImitateSmile
  (SFc7_Copy_of_ARP_02_RPSsmile_KinectGloveAtomicBradImitateSmileInstanceStruct *
   chartInstance);
static void
  initSimStructsc7_Copy_of_ARP_02_RPSsmile_KinectGloveAtomicBradImitateSmile
  (SFc7_Copy_of_ARP_02_RPSsmile_KinectGloveAtomicBradImitateSmileInstanceStruct *
   chartInstance);
...
static uint8_T c7_e_emlrt_marshallIn
   ...
   *c7_b_is_active_c7_Copy_of_ARP_02_RPSsmile_KinectGloveAtomicBradI, const
   ...
   chartInstance)
{
  ...
  chartInstance->c7_is_active_c7_Copy_of_ARP_02_RPSsmile_KinectGloveAtomicBradImi
    = 0U;
}
   ...
   chartInstance, const mxArray *c7_st)
{
  ...
  *c7_y = c7_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c7_u, 0)),
  ...
  chartInstance->c7_is_active_c7_Copy_of_ARP_02_RPSsmile_KinectGloveAtomicBradImi
    ...
    "is_active_c7_Copy_of_ARP_02_RPSsmile_KinectGloveAtomicBradImitateSmile");
  sf_mex_destroy(&c7_u);
  c7_update_debugger_state_c7_Copy_of_ARP_02_RPSsmile_KinectGloveA(chartInstance);
   ...
   char_T *c7_identifier)
{
  ...
  c7_y = c7_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c7_b_is_active_c7_Copy_of_ARP_02_RPSsmile_KinectGloveAtomicBradI),
    &c7_thisId);
  sf_mex_destroy
    (&c7_b_is_active_c7_Copy_of_ARP_02_RPSsmile_KinectGloveAtomicBradI);
  return c7_y;
...
static const mxArray
  *sf_get_sim_state_info_c7_Copy_of_ARP_02_RPSsmile_KinectGloveAtomicBradImitateSmile
  (void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c7_Copy_of_ARP_02_RPSsmile_KinectGloveAtomicBradImitateSmile\",}}"
  };
...
static void
  sf_opaque_initialize_c7_Copy_of_ARP_02_RPSsmile_KinectGloveAtomicBradImitateSmile
...
static void
  sf_opaque_enable_c7_Copy_of_ARP_02_RPSsmile_KinectGloveAtomicBradImitateSmile
  (void *chartInstanceVar)
{
  enable_c7_Copy_of_ARP_02_RPSsmile_KinectGloveAtomicBradImitateSmile
    ((SFc7_Copy_of_ARP_02_RPSsmile_KinectGloveAtomicBradImitateSmileInstanceStruct*)
     chartInstanceVar);
}

static void
  sf_opaque_disable_c7_Copy_of_ARP_02_RPSsmile_KinectGloveAtomicBradImitateSmile
  (void *chartInstanceVar)
{
  disable_c7_Copy_of_ARP_02_RPSsmile_KinectGloveAtomicBradImitateSmile
    ((SFc7_Copy_of_ARP_02_RPSsmile_KinectGloveAtomicBradImitateSmileInstanceStruct*)
     chartInstanceVar);
}

static void
  sf_opaque_gateway_c7_Copy_of_ARP_02_RPSsmile_KinectGloveAtomicBradImitateSmile
  (void *chartInstanceVar)
{
  sf_gateway_c7_Copy_of_ARP_02_RPSsmile_KinectGloveAtomicBradImitateSmile
    ((SFc7_Copy_of_ARP_02_RPSsmile_KinectGloveAtomicBradImitateSmileInstanceStruct*)
...
extern const mxArray*
  sf_internal_get_sim_state_c7_Copy_of_ARP_02_RPSsmile_KinectGloveAtomicBradImitateSmile
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
...
extern void
  sf_internal_set_sim_state_c7_Copy_of_ARP_02_RPSsmile_KinectGloveAtomicBradImitateSmile
...
static const mxArray*
  sf_opaque_get_sim_state_c7_Copy_of_ARP_02_RPSsmile_KinectGloveAtomicBradImitateSmile
  (SimStruct* S)
{
  return
    sf_internal_get_sim_state_c7_Copy_of_ARP_02_RPSsmile_KinectGloveAtomicBradImitateSmile
...
static void
  sf_opaque_set_sim_state_c7_Copy_of_ARP_02_RPSsmile_KinectGloveAtomicBradImitateSmile
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c7_Copy_of_ARP_02_RPSsmile_KinectGloveAtomicBradImitateSmile
    (S, st);
...
static void
  sf_opaque_terminate_c7_Copy_of_ARP_02_RPSsmile_KinectGloveAtomicBradImitateSmile
  (void *chartInstanceVar)
{
...
static void
  mdlProcessParameters_c7_Copy_of_ARP_02_RPSsmile_KinectGloveAtomicBradImitateSmile
  (SimStruct *S)
{
  int i;
...
static void
  mdlSetWorkWidths_c7_Copy_of_ARP_02_RPSsmile_KinectGloveAtomicBradImitateSmile
  (SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
...
static void mdlRTW_c7_Copy_of_ARP_02_RPSsmile_KinectGloveAtomicBradImitateSmile
  (SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void
  mdlStart_c7_Copy_of_ARP_02_RPSsmile_KinectGloveAtomicBradImitateSmile
  (SimStruct *S)
{
  SFc7_Copy_of_ARP_02_RPSsmile_KinectGloveAtomicBradImitateSmileInstanceStruct
    *chartInstance;
  ...
  chartInstance->chartInfo.mdlRTW =
    mdlRTW_c7_Copy_of_ARP_02_RPSsmile_KinectGloveAtomicBradImitateSmile;
  ...
  (SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c7_Copy_of_ARP_02_RPSsmile_KinectGloveAtomicBradImitateSmile(S);
    break;
   ...
   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c7_Copy_of_ARP_02_RPSsmile_KinectGloveAtomicBradImitateSmile_method_dispatcher.\n"
