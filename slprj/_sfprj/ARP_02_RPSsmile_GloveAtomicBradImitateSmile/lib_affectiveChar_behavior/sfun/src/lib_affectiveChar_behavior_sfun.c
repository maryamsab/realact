  ...
  method, void *data)
{
  if (chartFileNumber==11) {
    c11_lib_affectiveChar_behavior_method_dispatcher(simstructPtr, method, data);
    return 1;
  }
  ...
  if (nrhs>2 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"library")) {
      ...
      if (!strcmp(machineName,"lib_affectiveChar_behavior")) {
        if (nrhs==3) {
          ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(6140996U);
          ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2729693703U);
          ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1725410841U);
          ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2316585892U);
        } else if (nrhs==4) {
          ...
          switch (chartFileNumber) {
           case 11:
            {
              extern void sf_c11_lib_affectiveChar_behavior_get_check_sum
                (mxArray *plhs[]);
              sf_c11_lib_affectiveChar_behavior_get_check_sum(plhs);
              break;
            }
  ...
  mxArray * plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 11:
      {
        if (strcmp(aiChksum, "GhgZwV4iSjr0LX0LF8QiIC") == 0) {
          extern mxArray
            *sf_c11_lib_affectiveChar_behavior_get_autoinheritance_info(void);
          plhs[0] = sf_c11_lib_affectiveChar_behavior_get_autoinheritance_info();
          break;
        }
     ...
     case 11:
      {
        extern const mxArray
          *sf_c11_lib_affectiveChar_behavior_get_eml_resolved_functions_info
          (void);
     ...
     case 11:
      {
        if (strcmp(tpChksum, "atiVAuavAdpsJKMZ9UTHZB") == 0) {
          extern mxArray
            *sf_c11_lib_affectiveChar_behavior_third_party_uses_info(void);
          plhs[0] = sf_c11_lib_affectiveChar_behavior_third_party_uses_info();
          break;
        }
      }
     ...
     case 11:
      {
        if (strcmp(tpChksum, "atiVAuavAdpsJKMZ9UTHZB") == 0) {
          extern mxArray
            *sf_c11_lib_affectiveChar_behavior_updateBuildInfo_args_info(void);
          plhs[0] = sf_c11_lib_affectiveChar_behavior_updateBuildInfo_args_info();
          break;
        }
      }
