...
static void initialize_c15_Expriment_Emotion
  (SFc15_Expriment_EmotionInstanceStruct *chartInstance);
static void initialize_params_c15_Expriment_Emotion
  (SFc15_Expriment_EmotionInstanceStruct *chartInstance);
static void enable_c15_Expriment_Emotion(SFc15_Expriment_EmotionInstanceStruct
  *chartInstance);
static void disable_c15_Expriment_Emotion(SFc15_Expriment_EmotionInstanceStruct *
  chartInstance);
static void c15_update_debugger_state_c15_Expriment_Emotion
  (SFc15_Expriment_EmotionInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c15_Expriment_Emotion
  (SFc15_Expriment_EmotionInstanceStruct *chartInstance);
static void set_sim_state_c15_Expriment_Emotion
  (SFc15_Expriment_EmotionInstanceStruct *chartInstance, const mxArray *c15_st);
static void c15_set_sim_state_side_effects_c15_Expriment_Emotion
  (SFc15_Expriment_EmotionInstanceStruct *chartInstance);
static void finalize_c15_Expriment_Emotion(SFc15_Expriment_EmotionInstanceStruct
  *chartInstance);
static void sf_gateway_c15_Expriment_Emotion
  (SFc15_Expriment_EmotionInstanceStruct *chartInstance);
static void initSimStructsc15_Expriment_Emotion
  (SFc15_Expriment_EmotionInstanceStruct *chartInstance);
static void c15_enter_atomic_stateCreatePawn
  (SFc15_Expriment_EmotionInstanceStruct *chartInstance);
static void c15_encStr2Arr(SFc15_Expriment_EmotionInstanceStruct *chartInstance,
...
static const mxArray *c15_sf_marshallOut(void *chartInstanceVoid, void
  *c15_inData);
static real_T c15_emlrt_marshallIn(SFc15_Expriment_EmotionInstanceStruct
...
static const mxArray *c15_b_sf_marshallOut(void *chartInstanceVoid, void
  *c15_inData);
static void c15_b_emlrt_marshallIn(SFc15_Expriment_EmotionInstanceStruct
  *chartInstance, const mxArray *c15_u, const emlrtMsgIdentifier *c15_parentId,
  real_T c15_y[1000]);
...
static void c15_sendBML(SFc15_Expriment_EmotionInstanceStruct *chartInstance,
  real_T c15_In1[1000]);
static void c15_sendSBM(SFc15_Expriment_EmotionInstanceStruct *chartInstance,
  real_T c15_In2[1000]);
static const mxArray *c15_g_sf_marshallOut(void *chartInstanceVoid, void
  *c15_inData);
static int32_T c15_c_emlrt_marshallIn(SFc15_Expriment_EmotionInstanceStruct
  *chartInstance, const mxArray *c15_u, const emlrtMsgIdentifier *c15_parentId);
...
static const mxArray *c15_h_sf_marshallOut(void *chartInstanceVoid, void
  *c15_inData);
static uint8_T c15_d_emlrt_marshallIn(SFc15_Expriment_EmotionInstanceStruct
  *chartInstance, const mxArray *c15_b_tp_stateCreatePawn, const char_T
  *c15_identifier);
static uint8_T c15_e_emlrt_marshallIn(SFc15_Expriment_EmotionInstanceStruct
  *chartInstance, const mxArray *c15_u, const emlrtMsgIdentifier *c15_parentId);
...
static const mxArray *c15_i_sf_marshallOut(void *chartInstanceVoid, void
  *c15_inData);
static void c15_f_emlrt_marshallIn(SFc15_Expriment_EmotionInstanceStruct
  *chartInstance, const mxArray *c15_u, const emlrtMsgIdentifier *c15_parentId,
  real_T c15_y[1000]);
static void c15_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c15_mxArrayInData, const char_T *c15_varName, void *c15_outData);
static const mxArray *c15_g_emlrt_marshallIn
  (SFc15_Expriment_EmotionInstanceStruct *chartInstance, const mxArray
   *c15_b_setSimStateSideEffectsInfo, const char_T *c15_identifier);
static const mxArray *c15_h_emlrt_marshallIn
  (SFc15_Expriment_EmotionInstanceStruct *chartInstance, const mxArray *c15_u,
   const emlrtMsgIdentifier *c15_parentId);
static void init_dsm_address_info(SFc15_Expriment_EmotionInstanceStruct
  *chartInstance);
  ...
  (SFc15_Expriment_EmotionInstanceStruct *chartInstance)
{
  ...
  chartInstance->c15_is_active_c15_Expriment_Emotion = 0U;
  chartInstance->c15_is_c15_Expriment_Emotion = c15_IN_NO_ACTIVE_CHILD;
}
  ...
  (SFc15_Expriment_EmotionInstanceStruct *chartInstance)
{
  ...
  if (chartInstance->c15_is_active_c15_Expriment_Emotion == 1U) {
    _SFD_CC_CALL(CHART_ACTIVE_TAG, 11U, chartInstance->c15_sfEvent);
  }

  if (chartInstance->c15_is_c15_Expriment_Emotion == c15_IN_stateCreatePawn) {
  ...
  (SFc15_Expriment_EmotionInstanceStruct *chartInstance)
{
  ...
  c15_hoistedGlobal = chartInstance->c15_is_active_c15_Expriment_Emotion;
  c15_u = c15_hoistedGlobal;
  c15_b_y = NULL;
  sf_mex_assign(&c15_b_y, sf_mex_create("y", &c15_u, 3, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c15_y, 0, c15_b_y);
  c15_b_hoistedGlobal = chartInstance->c15_is_c15_Expriment_Emotion;
  ...
  (SFc15_Expriment_EmotionInstanceStruct *chartInstance, const mxArray *c15_st)
{
  ...
  chartInstance->c15_is_active_c15_Expriment_Emotion = c15_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c15_u, 0)),
     "is_active_c15_Expriment_Emotion");
  chartInstance->c15_is_c15_Expriment_Emotion = c15_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c15_u, 1)),
     "is_c15_Expriment_Emotion");
  ...
  c15_update_debugger_state_c15_Expriment_Emotion(chartInstance);
...
static void sf_gateway_c15_Expriment_Emotion
  (SFc15_Expriment_EmotionInstanceStruct *chartInstance)
{
  c15_set_sim_state_side_effects_c15_Expriment_Emotion(chartInstance);
  ...
  if (chartInstance->c15_is_active_c15_Expriment_Emotion == 0U) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 11U, chartInstance->c15_sfEvent);
    chartInstance->c15_is_active_c15_Expriment_Emotion = 1U;
    ...
    chartInstance->c15_is_c15_Expriment_Emotion = c15_IN_stateCreatePawn;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 2U, chartInstance->c15_sfEvent);
    chartInstance->c15_tp_stateCreatePawn = 1U;
  ...
  *c15_inData)
{
  ...
  const mxArray *c15_y = NULL;
  SFc15_Expriment_EmotionInstanceStruct *chartInstance;
  chartInstance = (SFc15_Expriment_EmotionInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c15_Expriment_Emotion_get_eml_resolved_functions_info(void)
{
...
void sf_c15_Expriment_Emotion_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c15_Expriment_Emotion_get_autoinheritance_info(void)
{
...
mxArray *sf_c15_Expriment_Emotion_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c15_Expriment_Emotion_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c15_Expriment_Emotion(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[8],M[0],T\"is_active_c15_Expriment_Emotion\",},{M[9],M[0],T\"is_c15_Expriment_Emotion\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c15_Expriment_Emotion_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc15_Expriment_EmotionInstanceStruct *)
...
static void sf_opaque_initialize_c15_Expriment_Emotion(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc15_Expriment_EmotionInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c15_Expriment_Emotion((SFc15_Expriment_EmotionInstanceStruct*)
    chartInstanceVar);
  initialize_c15_Expriment_Emotion((SFc15_Expriment_EmotionInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c15_Expriment_Emotion(void *chartInstanceVar)
{
  enable_c15_Expriment_Emotion((SFc15_Expriment_EmotionInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c15_Expriment_Emotion(void *chartInstanceVar)
{
  disable_c15_Expriment_Emotion((SFc15_Expriment_EmotionInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c15_Expriment_Emotion(void *chartInstanceVar)
{
  sf_gateway_c15_Expriment_Emotion((SFc15_Expriment_EmotionInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c15_Expriment_Emotion(SimStruct*
  S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c15_Expriment_Emotion
    ((SFc15_Expriment_EmotionInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c15_Expriment_Emotion();/* state var info */
...
extern void sf_internal_set_sim_state_c15_Expriment_Emotion(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c15_Expriment_Emotion();/* state var info */
  ...
  set_sim_state_c15_Expriment_Emotion((SFc15_Expriment_EmotionInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c15_Expriment_Emotion(SimStruct* S)
{
  return sf_internal_get_sim_state_c15_Expriment_Emotion(S);
}

static void sf_opaque_set_sim_state_c15_Expriment_Emotion(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c15_Expriment_Emotion(S, st);
}

static void sf_opaque_terminate_c15_Expriment_Emotion(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc15_Expriment_EmotionInstanceStruct*) chartInstanceVar)
      ->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c15_Expriment_Emotion((SFc15_Expriment_EmotionInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc15_Expriment_Emotion((SFc15_Expriment_EmotionInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c15_Expriment_Emotion(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c15_Expriment_Emotion
      ((SFc15_Expriment_EmotionInstanceStruct*)(chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c15_Expriment_Emotion(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(2320059618U));
  ssSetChecksum1(S,(2053439718U));
  ssSetChecksum2(S,(3460954460U));
  ssSetChecksum3(S,(2674359171U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c15_Expriment_Emotion(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c15_Expriment_Emotion(SimStruct *S)
{
  SFc15_Expriment_EmotionInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc15_Expriment_EmotionInstanceStruct *)utMalloc(sizeof
    (SFc15_Expriment_EmotionInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc15_Expriment_EmotionInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c15_Expriment_Emotion;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c15_Expriment_Emotion;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c15_Expriment_Emotion;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c15_Expriment_Emotion;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c15_Expriment_Emotion;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c15_Expriment_Emotion;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c15_Expriment_Emotion;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c15_Expriment_Emotion;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c15_Expriment_Emotion;
  chartInstance->chartInfo.mdlStart = mdlStart_c15_Expriment_Emotion;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c15_Expriment_Emotion;
...
void c15_Expriment_Emotion_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c15_Expriment_Emotion(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c15_Expriment_Emotion(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c15_Expriment_Emotion(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c15_Expriment_Emotion_method_dispatcher.\n"
