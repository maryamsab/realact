...
static const char * c56_b_debug_family_names[17] = { "nargin", "nargout", "v",
  "ar", "p", "pFlag", "vaFlag", "poseArr", "personalityChange", "poseTwitch",
  "poseFreqFactor", "poseChanceFactor", "poseCatChance", "poseLean", "poseSpeed",
  "poseLeanFlag", "poseSpace" };

static boolean_T c56_dataWrittenToVector[15];

/* Function Declarations */
static void initialize_c56_Expriment_Emotion
  (SFc56_Expriment_EmotionInstanceStruct *chartInstance);
static void initialize_params_c56_Expriment_Emotion
  (SFc56_Expriment_EmotionInstanceStruct *chartInstance);
static void enable_c56_Expriment_Emotion(SFc56_Expriment_EmotionInstanceStruct
  *chartInstance);
static void disable_c56_Expriment_Emotion(SFc56_Expriment_EmotionInstanceStruct *
  chartInstance);
static void c56_update_debugger_state_c56_Expriment_Emotion
  (SFc56_Expriment_EmotionInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c56_Expriment_Emotion
  (SFc56_Expriment_EmotionInstanceStruct *chartInstance);
static void set_sim_state_c56_Expriment_Emotion
  (SFc56_Expriment_EmotionInstanceStruct *chartInstance, const mxArray *c56_st);
static void c56_set_sim_state_side_effects_c56_Expriment_Emotion
  (SFc56_Expriment_EmotionInstanceStruct *chartInstance);
static void finalize_c56_Expriment_Emotion(SFc56_Expriment_EmotionInstanceStruct
  *chartInstance);
static void sf_gateway_c56_Expriment_Emotion
  (SFc56_Expriment_EmotionInstanceStruct *chartInstance);
static void c56_enter_atomic_c56_Expriment_Emotion
  (SFc56_Expriment_EmotionInstanceStruct *chartInstance);
static void c56_enter_internal_c56_Expriment_Emotion
  (SFc56_Expriment_EmotionInstanceStruct *chartInstance);
static void c56_c56_Expriment_Emotion(SFc56_Expriment_EmotionInstanceStruct
  *chartInstance);
static void c56_exit_internal_c56_Expriment_Emotion
  (SFc56_Expriment_EmotionInstanceStruct *chartInstance);
static void c56_initc56_Expriment_Emotion(SFc56_Expriment_EmotionInstanceStruct *
  chartInstance);
static void initSimStructsc56_Expriment_Emotion
  (SFc56_Expriment_EmotionInstanceStruct *chartInstance);
...
static const mxArray *c56_sf_marshallOut(void *chartInstanceVoid, void
  *c56_inData);
static real_T c56_emlrt_marshallIn(SFc56_Expriment_EmotionInstanceStruct
...
static const mxArray *c56_b_sf_marshallOut(void *chartInstanceVoid, void
  *c56_inData);
static void c56_b_emlrt_marshallIn(SFc56_Expriment_EmotionInstanceStruct
  *chartInstance, const mxArray *c56_u, const emlrtMsgIdentifier *c56_parentId,
  real_T c56_y[6]);
...
static const mxArray *c56_c_sf_marshallOut(void *chartInstanceVoid, void
  *c56_inData);
static boolean_T c56_c_emlrt_marshallIn(SFc56_Expriment_EmotionInstanceStruct
  *chartInstance, const mxArray *c56_u, const emlrtMsgIdentifier *c56_parentId);
...
static void c56_setGazeFactorsc56_Expriment_Emotion
  (SFc56_Expriment_EmotionInstanceStruct *chartInstance, real_T c56_v, real_T
...
static void c56_setPoseFactorsc56_Expriment_Emotion
  (SFc56_Expriment_EmotionInstanceStruct *chartInstance, real_T c56_v, real_T
   ...
   real_T *c56_poseLean, real_T *c56_poseSpeed, real_T *c56_poseLeanFlag, real_T
   *c56_poseSpace);
static const mxArray *c56_d_sf_marshallOut(void *chartInstanceVoid, void
  *c56_inData);
static int32_T c56_d_emlrt_marshallIn(SFc56_Expriment_EmotionInstanceStruct
  *chartInstance, const mxArray *c56_u, const emlrtMsgIdentifier *c56_parentId);
static void c56_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c56_mxArrayInData, const char_T *c56_varName, void *c56_outData);
static uint8_T c56_e_emlrt_marshallIn(SFc56_Expriment_EmotionInstanceStruct
  *chartInstance, const mxArray *c56_b_is_active_c56_Expriment_Emotion, const
  char_T *c56_identifier);
static uint8_T c56_f_emlrt_marshallIn(SFc56_Expriment_EmotionInstanceStruct
  *chartInstance, const mxArray *c56_u, const emlrtMsgIdentifier *c56_parentId);
static const mxArray *c56_g_emlrt_marshallIn
  (SFc56_Expriment_EmotionInstanceStruct *chartInstance, const mxArray
   *c56_b_setSimStateSideEffectsInfo, const char_T *c56_identifier);
static const mxArray *c56_h_emlrt_marshallIn
  (SFc56_Expriment_EmotionInstanceStruct *chartInstance, const mxArray *c56_u,
   const emlrtMsgIdentifier *c56_parentId);
static void c56_updateDataWrittenToVector(SFc56_Expriment_EmotionInstanceStruct *
  chartInstance, uint32_T c56_vectorIndex);
static void c56_errorIfDataNotWrittenToFcn(SFc56_Expriment_EmotionInstanceStruct
  *chartInstance, uint32_T c56_vectorIndex, uint32_T c56_dataNumber);
static void init_dsm_address_info(SFc56_Expriment_EmotionInstanceStruct
  *chartInstance);
  ...
  (SFc56_Expriment_EmotionInstanceStruct *chartInstance)
{
  ...
  c56_hoistedGlobal = chartInstance->c56_is_active_c56_Expriment_Emotion;
  ...
  (SFc56_Expriment_EmotionInstanceStruct *chartInstance, const mxArray *c56_st)
{
  ...
  chartInstance->c56_is_active_c56_Expriment_Emotion = c56_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c56_u, 0)),
     "is_active_c56_Expriment_Emotion");
  ...
  c56_update_debugger_state_c56_Expriment_Emotion(chartInstance);
...
static void sf_gateway_c56_Expriment_Emotion
  (SFc56_Expriment_EmotionInstanceStruct *chartInstance)
{
  c56_set_sim_state_side_effects_c56_Expriment_Emotion(chartInstance);
}
  ...
  (SFc56_Expriment_EmotionInstanceStruct *chartInstance)
{
  ...
  chartInstance->c56_is_active_c56_Expriment_Emotion = 1U;
  ...
  chartInstance)
{
  ...
  chartInstance->c56_is_active_c56_Expriment_Emotion = 0U;
}
  ...
  *c56_inData)
{
  ...
  const mxArray *c56_y = NULL;
  SFc56_Expriment_EmotionInstanceStruct *chartInstance;
  chartInstance = (SFc56_Expriment_EmotionInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c56_Expriment_Emotion_get_eml_resolved_functions_info(void)
{
...
static void c56_info_helper(const mxArray **c56_info)
{
  ...
  sf_mex_addfield(*c56_info, c56_emlrt_marshallOut("round"), "name", "name", 0);
  ...
  sf_mex_addfield(*c56_info, c56_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/round.m"), "resolved",
                  "resolved", 0);
  sf_mex_addfield(*c56_info, c56_b_emlrt_marshallOut(1363742654U), "fileTimeLo",
                  "fileTimeLo", 0);
  ...
  sf_mex_addfield(*c56_info, c56_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/eml_scalar_round.m"),
                  "resolved", "resolved", 2);
  sf_mex_addfield(*c56_info, c56_b_emlrt_marshallOut(1307683638U), "fileTimeLo",
                  "fileTimeLo", 2);
  sf_mex_addfield(*c56_info, c56_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 2);
  sf_mex_addfield(*c56_info, c56_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c56_info, sf_mex_duplicatearraysafe(&c56_lhs2), "lhs", "lhs",
                  2);
  sf_mex_addfield(*c56_info, c56_emlrt_marshallOut(""), "context", "context", 3);
  ...
  sf_mex_addfield(*c56_info, c56_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.p"), "context",
                  "context", 5);
  sf_mex_addfield(*c56_info, c56_emlrt_marshallOut("rdivide"), "name", "name", 5);
  sf_mex_addfield(*c56_info, c56_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 5);
  sf_mex_addfield(*c56_info, c56_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c56_info, c56_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m"), "context",
                  "context", 8);
  sf_mex_addfield(*c56_info, c56_emlrt_marshallOut("eml_div"), "name", "name", 8);
  sf_mex_addfield(*c56_info, c56_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 8);
  sf_mex_addfield(*c56_info, c56_emlrt_marshallOut(
...
boolean_T sf_exported_auto_isStablec56_Expriment_Emotion(SimStruct *c56_S)
{
  SFc56_Expriment_EmotionInstanceStruct *chartInstance;
  chartInstance = (SFc56_Expriment_EmotionInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c56_S))->instanceInfo)->chartInstance;
  return true;
}

void sf_exported_auto_duringc56_Expriment_Emotion(SimStruct *c56_S)
{
  SFc56_Expriment_EmotionInstanceStruct *chartInstance;
  chartInstance = (SFc56_Expriment_EmotionInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c56_S))->instanceInfo)->chartInstance;
  c56_c56_Expriment_Emotion(chartInstance);
}

void sf_exported_auto_enterc56_Expriment_Emotion(SimStruct *c56_S)
{
  SFc56_Expriment_EmotionInstanceStruct *chartInstance;
  chartInstance = (SFc56_Expriment_EmotionInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c56_S))->instanceInfo)->chartInstance;
  _sfTime_ = sf_get_time(chartInstance->S);
  c56_enter_atomic_c56_Expriment_Emotion(chartInstance);
  c56_enter_internal_c56_Expriment_Emotion(chartInstance);
}

void sf_exported_auto_exitc56_Expriment_Emotion(SimStruct *c56_S)
{
  SFc56_Expriment_EmotionInstanceStruct *chartInstance;
  chartInstance = (SFc56_Expriment_EmotionInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c56_S))->instanceInfo)->chartInstance;
  _sfTime_ = sf_get_time(chartInstance->S);
  c56_exit_internal_c56_Expriment_Emotion(chartInstance);
}

void sf_exported_auto_gatewayc56_Expriment_Emotion(SimStruct *c56_S)
{
  SFc56_Expriment_EmotionInstanceStruct *chartInstance;
  chartInstance = (SFc56_Expriment_EmotionInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c56_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_enablec56_Expriment_Emotion(SimStruct *c56_S)
{
  SFc56_Expriment_EmotionInstanceStruct *chartInstance;
  chartInstance = (SFc56_Expriment_EmotionInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c56_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_disablec56_Expriment_Emotion(SimStruct *c56_S)
{
  SFc56_Expriment_EmotionInstanceStruct *chartInstance;
  chartInstance = (SFc56_Expriment_EmotionInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c56_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_stepBuffersc56_Expriment_Emotion(SimStruct *c56_S)
{
  SFc56_Expriment_EmotionInstanceStruct *chartInstance;
  chartInstance = (SFc56_Expriment_EmotionInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c56_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_initBuffersc56_Expriment_Emotion(SimStruct *c56_S)
{
  SFc56_Expriment_EmotionInstanceStruct *chartInstance;
  chartInstance = (SFc56_Expriment_EmotionInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c56_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_activate_callc56_Expriment_Emotion(SimStruct *c56_S)
{
  SFc56_Expriment_EmotionInstanceStruct *chartInstance;
  chartInstance = (SFc56_Expriment_EmotionInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c56_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_increment_call_counterc56_Expriment_Emotion(SimStruct
  *c56_S)
{
  SFc56_Expriment_EmotionInstanceStruct *chartInstance;
  chartInstance = (SFc56_Expriment_EmotionInstanceStruct *)((ChartInfoStruct *)
...
void sf_exported_auto_reset_call_counterc56_Expriment_Emotion(SimStruct *c56_S)
{
  SFc56_Expriment_EmotionInstanceStruct *chartInstance;
  chartInstance = (SFc56_Expriment_EmotionInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c56_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_deactivate_callc56_Expriment_Emotion(SimStruct *c56_S)
{
  SFc56_Expriment_EmotionInstanceStruct *chartInstance;
  chartInstance = (SFc56_Expriment_EmotionInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c56_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_initc56_Expriment_Emotion(SimStruct *c56_S)
{
  SFc56_Expriment_EmotionInstanceStruct *chartInstance;
  chartInstance = (SFc56_Expriment_EmotionInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c56_S))->instanceInfo)->chartInstance;
  c56_initc56_Expriment_Emotion(chartInstance);
}

const mxArray *sf_exported_auto_getSimstatec56_Expriment_Emotion(SimStruct
  *c56_S)
{
  ...
  chartInstance = (SFc56_Expriment_EmotionInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c56_S))->instanceInfo)->chartInstance;
  c56_out = NULL;
  sf_mex_assign(&c56_out, sf_internal_get_sim_state_c56_Expriment_Emotion(c56_S),
                false);
  return c56_out;
}

void sf_exported_auto_setSimstatec56_Expriment_Emotion(SimStruct *c56_S, const
  mxArray *c56_in)
{
  SFc56_Expriment_EmotionInstanceStruct *chartInstance;
  chartInstance = (SFc56_Expriment_EmotionInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c56_S))->instanceInfo)->chartInstance;
  sf_internal_set_sim_state_c56_Expriment_Emotion(c56_S, sf_mex_dup(c56_in));
  sf_mex_destroy(&c56_in);
}

void sf_exported_auto_check_state_inconsistency_c56_Expriment_Emotion(SimStruct *
  c56_S)
{
  SFc56_Expriment_EmotionInstanceStruct *chartInstance;
  chartInstance = (SFc56_Expriment_EmotionInstanceStruct *)((ChartInfoStruct *)
  ...
  if (CV_EML_COND(0, 1, 0, c56_v > 50.0)) {
    if (CV_EML_COND(0, 1, 1, c56_a > 50.0)) {
      ...
      *c56_avertDurFactor = 0.5;
      c56_x = *c56_avertDurFactor;
      *c56_avertDurFactor = c56_x;
      *c56_avertDurFactor = muDoubleScalarRound(*c56_avertDurFactor);
      c56_updateDataWrittenToVector(chartInstance, 1U);
      _SFD_EML_CALL(0U, chartInstance->c56_sfEvent, 40);
      *c56_avertHeadFreqFactor = 6.666666666666667;
      c56_b_x = *c56_avertHeadFreqFactor;
      *c56_avertHeadFreqFactor = c56_b_x;
      *c56_avertHeadFreqFactor = muDoubleScalarRound(*c56_avertHeadFreqFactor);
      c56_updateDataWrittenToVector(chartInstance, 2U);
    } else {
      guard1 = true;
    }
    ...
    if (CV_EML_COND(0, 1, 2, c56_v < -50.0)) {
      if (CV_EML_COND(0, 1, 3, c56_a > 50.0)) {
        ...
        *c56_mutDurFactor = 0.5;
        c56_c_x = *c56_mutDurFactor;
        *c56_mutDurFactor = c56_c_x;
        *c56_mutDurFactor = muDoubleScalarRound(*c56_mutDurFactor);
        c56_updateDataWrittenToVector(chartInstance, 0U);
      ...
      if (CV_EML_COND(0, 1, 4, c56_v > 50.0)) {
        if (CV_EML_COND(0, 1, 5, c56_a < -50.0)) {
          ...
          *c56_mutDurFactor = 1.5;
          c56_d_x = *c56_mutDurFactor;
          *c56_mutDurFactor = c56_d_x;
          *c56_mutDurFactor = muDoubleScalarRound(*c56_mutDurFactor);
          c56_updateDataWrittenToVector(chartInstance, 0U);
          _SFD_EML_CALL(0U, chartInstance->c56_sfEvent, 51);
          *c56_avertDurFactor = 0.75;
          c56_e_x = *c56_avertDurFactor;
          *c56_avertDurFactor = c56_e_x;
          *c56_avertDurFactor = muDoubleScalarRound(*c56_avertDurFactor);
          c56_updateDataWrittenToVector(chartInstance, 1U);
          _SFD_EML_CALL(0U, chartInstance->c56_sfEvent, 52);
          *c56_avertHeadFreqFactor = 10.0;
          c56_f_x = *c56_avertHeadFreqFactor;
          *c56_avertHeadFreqFactor = c56_f_x;
          *c56_avertHeadFreqFactor = muDoubleScalarRound
            (*c56_avertHeadFreqFactor);
          c56_updateDataWrittenToVector(chartInstance, 2U);
        } else {
          guard3 = true;
        }
        ...
        if (CV_EML_COND(0, 1, 6, c56_v < -50.0)) {
          if (CV_EML_COND(0, 1, 7, c56_a < -50.0)) {
            ...
            *c56_mutDurFactor = 0.75;
            c56_g_x = *c56_mutDurFactor;
            *c56_mutDurFactor = c56_g_x;
            *c56_mutDurFactor = muDoubleScalarRound(*c56_mutDurFactor);
            c56_updateDataWrittenToVector(chartInstance, 0U);
            _SFD_EML_CALL(0U, chartInstance->c56_sfEvent, 57);
            *c56_avertDurFactor = 1.5;
            c56_h_x = *c56_avertDurFactor;
            *c56_avertDurFactor = c56_h_x;
            *c56_avertDurFactor = muDoubleScalarRound(*c56_avertDurFactor);
            c56_updateDataWrittenToVector(chartInstance, 1U);
...
static void c56_setPoseFactorsc56_Expriment_Emotion
   ...
   *c56_poseSpace)
{
  uint32_T c56_debug_family_var_map[17];
  real_T c56_nargin = 7.0;
  real_T c56_nargout = 8.0;
  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 17U, 17U, c56_b_debug_family_names,
    c56_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c56_nargin, 0U, c56_sf_marshallOut,
    c56_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c56_nargout, 1U, c56_sf_marshallOut,
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c56_poseLeanFlag, 15U, c56_sf_marshallOut,
    c56_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c56_poseSpace, 16U, c56_sf_marshallOut,
    c56_sf_marshallIn);
  CV_EML_FCN(1, 0);
  ...
  *c56_poseLeanFlag = 0.0;
  ...
  _SFD_EML_CALL(1U, chartInstance->c56_sfEvent, 9);
  *c56_poseSpace = 0.0;
  c56_updateDataWrittenToVector(chartInstance, 14U);
  ...
  if (CV_EML_IF(1, 1, 0, (real_T)c56_vaFlag == 1.0)) {
    ...
    if (CV_EML_IF(1, 1, 1, c56_ar > 50.0)) {
      ...
      *c56_poseLeanFlag = 1.0;
      c56_updateDataWrittenToVector(chartInstance, 13U);
      _SFD_EML_CALL(1U, chartInstance->c56_sfEvent, 16);
      *c56_poseLean = 13.0;
      c56_updateDataWrittenToVector(chartInstance, 11U);
    }
    ...
    if (CV_EML_IF(1, 1, 2, c56_ar < -50.0)) {
      ...
      *c56_poseSpeed = 3.0;
      c56_updateDataWrittenToVector(chartInstance, 12U);
      _SFD_EML_CALL(1U, chartInstance->c56_sfEvent, 20);
      *c56_poseLeanFlag = 1.0;
      c56_updateDataWrittenToVector(chartInstance, 13U);
      _SFD_EML_CALL(1U, chartInstance->c56_sfEvent, 21);
      *c56_poseLean = 12.0;
      c56_updateDataWrittenToVector(chartInstance, 11U);
    }
  }
...
void sf_exported_user_c56_Expriment_Emotion_setGazeFactors(SimStruct *c56_S,
  ...
  real_T *c56_mutFreqFactor)
{
  ...
  c56_setGazeFactorsc56_Expriment_Emotion(chartInstance, c56_v, c56_a, c56_p,
...
void sf_exported_user_c56_Expriment_Emotion_setPoseFactors(SimStruct *c56_S,
  ...
  *c56_poseLeanFlag, real_T *c56_poseSpace)
{
  int32_T c56_i5;
  real_T c56_b_poseArr[6];
  real_T c56_b_poseSpace;
  ...
  c56_setPoseFactorsc56_Expriment_Emotion(chartInstance, c56_v, c56_ar, c56_p,
  ...
  char_T *c56_identifier)
{
  ...
  c56_y = c56_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c56_b_is_active_c56_Expriment_Emotion), &c56_thisId);
  sf_mex_destroy(&c56_b_is_active_c56_Expriment_Emotion);
  return c56_y;
}
  ...
  *chartInstance, uint32_T c56_vectorIndex, uint32_T c56_dataNumber)
{
  ...
  _SFD_DATA_READ_BEFORE_WRITE_CHECK(c56_dataNumber, c56_dataWrittenToVector
    [(uint32_T)_SFD_EML_ARRAY_BOUNDS_CHECK(0, (int32_T)c56_vectorIndex, 0, 14, 1,
    0)]);
}
...
void sf_c56_Expriment_Emotion_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1734908064U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2472341174U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(656407497U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2939241834U);
}

mxArray *sf_c56_Expriment_Emotion_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("BPxXzqR1RtwJP7mWifK0CD");
...
mxArray *sf_c56_Expriment_Emotion_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c56_Expriment_Emotion_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c56_Expriment_Emotion(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S'type','srcId','name','auxInfo'{{M[8],M[0],T\"is_active_c56_Expriment_Emotion\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 1, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c56_Expriment_Emotion_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc56_Expriment_EmotionInstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"setGazeFactorsc56_Expriment_Emotion",0,-1,3276);
        _SFD_CV_INIT_EML_IF(0,1,0,2159,2175,2441,2462);
        _SFD_CV_INIT_EML_IF(0,1,1,2441,2462,2709,3275);
        _SFD_CV_INIT_EML_IF(0,1,2,2709,2730,2999,3275);
        _SFD_CV_INIT_EML_IF(0,1,3,2999,3021,-1,3021);

        {
          static int condStart[] = { 2162, 2170 };

          static int condEnd[] = { 2166, 2174 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,0,2162,2174,2,0,&(condStart[0]),&(condEnd[0]),
                                3,&(pfixExpr[0]));
        }

        {
          static int condStart[] = { 2448, 2457 };

          static int condEnd[] = { 2453, 2461 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,1,2448,2461,2,2,&(condStart[0]),&(condEnd[0]),
                                3,&(pfixExpr[0]));
        }

        {
          static int condStart[] = { 2716, 2724 };

          static int condEnd[] = { 2720, 2729 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,2,2716,2729,2,4,&(condStart[0]),&(condEnd[0]),
                                3,&(pfixExpr[0]));
        }

        {
          static int condStart[] = { 3006, 3015 };

          static int condEnd[] = { 3011, 3020 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,3,3006,3020,2,6,&(condStart[0]),&(condEnd[0]),
                                3,&(pfixExpr[0]));
        }

        _SFD_CV_INIT_EML(1,1,1,3,0,0,0,0,0,0,0);
        _SFD_CV_INIT_EML_FCN(1,0,"setPoseFactorsc56_Expriment_Emotion",0,-1,756);
        _SFD_CV_INIT_EML_IF(1,1,0,416,429,-1,754);
        _SFD_CV_INIT_EML_IF(1,1,1,438,448,-1,587);
        _SFD_CV_INIT_EML_IF(1,1,2,596,606,-1,746);
...
{
  return "n3s2rhdrCDtXnOm0uEqqVD";
}

static void sf_opaque_initialize_c56_Expriment_Emotion(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc56_Expriment_EmotionInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c56_Expriment_Emotion((SFc56_Expriment_EmotionInstanceStruct*)
    chartInstanceVar);
  initialize_c56_Expriment_Emotion((SFc56_Expriment_EmotionInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c56_Expriment_Emotion(void *chartInstanceVar)
{
  enable_c56_Expriment_Emotion((SFc56_Expriment_EmotionInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c56_Expriment_Emotion(void *chartInstanceVar)
{
  disable_c56_Expriment_Emotion((SFc56_Expriment_EmotionInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c56_Expriment_Emotion(void *chartInstanceVar)
{
  sf_gateway_c56_Expriment_Emotion((SFc56_Expriment_EmotionInstanceStruct*)
    chartInstanceVar);
}
  ...
  S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c56_Expriment_Emotion
    ((SFc56_Expriment_EmotionInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c56_Expriment_Emotion();/* state var info */
...
extern void sf_internal_set_sim_state_c56_Expriment_Emotion(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c56_Expriment_Emotion();/* state var info */
  ...
  set_sim_state_c56_Expriment_Emotion((SFc56_Expriment_EmotionInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c56_Expriment_Emotion(SimStruct* S)
{
  return NULL;
}

static void sf_opaque_set_sim_state_c56_Expriment_Emotion(SimStruct* S, const
  mxArray *st)
{
}

static void sf_opaque_terminate_c56_Expriment_Emotion(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc56_Expriment_EmotionInstanceStruct*) chartInstanceVar)
      ->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c56_Expriment_Emotion((SFc56_Expriment_EmotionInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc56_Expriment_Emotion((SFc56_Expriment_EmotionInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c56_Expriment_Emotion(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c56_Expriment_Emotion
      ((SFc56_Expriment_EmotionInstanceStruct*)(chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c56_Expriment_Emotion(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(4176005716U));
  ssSetChecksum1(S,(3268787373U));
  ssSetChecksum2(S,(967580586U));
  ssSetChecksum3(S,(606427408U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c56_Expriment_Emotion(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c56_Expriment_Emotion(SimStruct *S)
{
  SFc56_Expriment_EmotionInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc56_Expriment_EmotionInstanceStruct *)utMalloc(sizeof
    (SFc56_Expriment_EmotionInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc56_Expriment_EmotionInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c56_Expriment_Emotion;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c56_Expriment_Emotion;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c56_Expriment_Emotion;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c56_Expriment_Emotion;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c56_Expriment_Emotion;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c56_Expriment_Emotion;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c56_Expriment_Emotion;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c56_Expriment_Emotion;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c56_Expriment_Emotion;
  chartInstance->chartInfo.mdlStart = mdlStart_c56_Expriment_Emotion;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c56_Expriment_Emotion;
...
void c56_Expriment_Emotion_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c56_Expriment_Emotion(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c56_Expriment_Emotion(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c56_Expriment_Emotion(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c56_Expriment_Emotion_method_dispatcher.\n"
