...
static void initialize_c45_Expriment_Emotion
  (SFc45_Expriment_EmotionInstanceStruct *chartInstance);
static void initialize_params_c45_Expriment_Emotion
  (SFc45_Expriment_EmotionInstanceStruct *chartInstance);
static void enable_c45_Expriment_Emotion(SFc45_Expriment_EmotionInstanceStruct
  *chartInstance);
static void disable_c45_Expriment_Emotion(SFc45_Expriment_EmotionInstanceStruct *
  chartInstance);
static void c45_update_debugger_state_c45_Expriment_Emotion
  (SFc45_Expriment_EmotionInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c45_Expriment_Emotion
  (SFc45_Expriment_EmotionInstanceStruct *chartInstance);
static void set_sim_state_c45_Expriment_Emotion
  (SFc45_Expriment_EmotionInstanceStruct *chartInstance, const mxArray *c45_st);
static void finalize_c45_Expriment_Emotion(SFc45_Expriment_EmotionInstanceStruct
  *chartInstance);
static void sf_gateway_c45_Expriment_Emotion
  (SFc45_Expriment_EmotionInstanceStruct *chartInstance);
static void initSimStructsc45_Expriment_Emotion
  (SFc45_Expriment_EmotionInstanceStruct *chartInstance);
...
static const mxArray *c45_sf_marshallOut(void *chartInstanceVoid, void
  *c45_inData);
static void c45_emlrt_marshallIn(SFc45_Expriment_EmotionInstanceStruct
  *chartInstance, const mxArray *c45_y, const char_T *c45_identifier, real_T
  c45_b_y[6]);
static void c45_b_emlrt_marshallIn(SFc45_Expriment_EmotionInstanceStruct
...
static const mxArray *c45_b_sf_marshallOut(void *chartInstanceVoid, void
  *c45_inData);
static real_T c45_c_emlrt_marshallIn(SFc45_Expriment_EmotionInstanceStruct
  *chartInstance, const mxArray *c45_u, const emlrtMsgIdentifier *c45_parentId);
...
static const mxArray *c45_c_sf_marshallOut(void *chartInstanceVoid, void
  *c45_inData);
static int32_T c45_d_emlrt_marshallIn(SFc45_Expriment_EmotionInstanceStruct
  *chartInstance, const mxArray *c45_u, const emlrtMsgIdentifier *c45_parentId);
static void c45_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c45_mxArrayInData, const char_T *c45_varName, void *c45_outData);
static uint8_T c45_e_emlrt_marshallIn(SFc45_Expriment_EmotionInstanceStruct
  *chartInstance, const mxArray *c45_b_is_active_c45_Expriment_Emotion, const
  char_T *c45_identifier);
static uint8_T c45_f_emlrt_marshallIn(SFc45_Expriment_EmotionInstanceStruct
  *chartInstance, const mxArray *c45_u, const emlrtMsgIdentifier *c45_parentId);
static void init_dsm_address_info(SFc45_Expriment_EmotionInstanceStruct
  *chartInstance);
  ...
  (SFc45_Expriment_EmotionInstanceStruct *chartInstance)
{
  ...
  chartInstance->c45_is_active_c45_Expriment_Emotion = 0U;
}
  ...
  (SFc45_Expriment_EmotionInstanceStruct *chartInstance)
{
  ...
  c45_hoistedGlobal = chartInstance->c45_is_active_c45_Expriment_Emotion;
  ...
  (SFc45_Expriment_EmotionInstanceStruct *chartInstance, const mxArray *c45_st)
{
  ...
  chartInstance->c45_is_active_c45_Expriment_Emotion = c45_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c45_u, 1)),
     "is_active_c45_Expriment_Emotion");
  sf_mex_destroy(&c45_u);
  c45_update_debugger_state_c45_Expriment_Emotion(chartInstance);
  ...
  *c45_inData)
{
  ...
  const mxArray *c45_y = NULL;
  SFc45_Expriment_EmotionInstanceStruct *chartInstance;
  chartInstance = (SFc45_Expriment_EmotionInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c45_Expriment_Emotion_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c45_identifier)
{
  ...
  c45_y = c45_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c45_b_is_active_c45_Expriment_Emotion), &c45_thisId);
  sf_mex_destroy(&c45_b_is_active_c45_Expriment_Emotion);
  return c45_y;
}
...
void sf_c45_Expriment_Emotion_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c45_Expriment_Emotion_get_autoinheritance_info(void)
{
...
mxArray *sf_c45_Expriment_Emotion_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c45_Expriment_Emotion_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c45_Expriment_Emotion(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c45_Expriment_Emotion\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c45_Expriment_Emotion_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc45_Expriment_EmotionInstanceStruct *)
...
static void sf_opaque_initialize_c45_Expriment_Emotion(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc45_Expriment_EmotionInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c45_Expriment_Emotion((SFc45_Expriment_EmotionInstanceStruct*)
    chartInstanceVar);
  initialize_c45_Expriment_Emotion((SFc45_Expriment_EmotionInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c45_Expriment_Emotion(void *chartInstanceVar)
{
  enable_c45_Expriment_Emotion((SFc45_Expriment_EmotionInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c45_Expriment_Emotion(void *chartInstanceVar)
{
  disable_c45_Expriment_Emotion((SFc45_Expriment_EmotionInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c45_Expriment_Emotion(void *chartInstanceVar)
{
  sf_gateway_c45_Expriment_Emotion((SFc45_Expriment_EmotionInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c45_Expriment_Emotion(SimStruct*
  S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c45_Expriment_Emotion
    ((SFc45_Expriment_EmotionInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c45_Expriment_Emotion();/* state var info */
...
extern void sf_internal_set_sim_state_c45_Expriment_Emotion(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c45_Expriment_Emotion();/* state var info */
  ...
  set_sim_state_c45_Expriment_Emotion((SFc45_Expriment_EmotionInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c45_Expriment_Emotion(SimStruct* S)
{
  return sf_internal_get_sim_state_c45_Expriment_Emotion(S);
}

static void sf_opaque_set_sim_state_c45_Expriment_Emotion(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c45_Expriment_Emotion(S, st);
}

static void sf_opaque_terminate_c45_Expriment_Emotion(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc45_Expriment_EmotionInstanceStruct*) chartInstanceVar)
      ->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c45_Expriment_Emotion((SFc45_Expriment_EmotionInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc45_Expriment_Emotion((SFc45_Expriment_EmotionInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c45_Expriment_Emotion(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c45_Expriment_Emotion
      ((SFc45_Expriment_EmotionInstanceStruct*)(chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c45_Expriment_Emotion(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c45_Expriment_Emotion(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c45_Expriment_Emotion(SimStruct *S)
{
  SFc45_Expriment_EmotionInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc45_Expriment_EmotionInstanceStruct *)utMalloc(sizeof
    (SFc45_Expriment_EmotionInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc45_Expriment_EmotionInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c45_Expriment_Emotion;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c45_Expriment_Emotion;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c45_Expriment_Emotion;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c45_Expriment_Emotion;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c45_Expriment_Emotion;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c45_Expriment_Emotion;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c45_Expriment_Emotion;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c45_Expriment_Emotion;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c45_Expriment_Emotion;
  chartInstance->chartInfo.mdlStart = mdlStart_c45_Expriment_Emotion;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c45_Expriment_Emotion;
...
void c45_Expriment_Emotion_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c45_Expriment_Emotion(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c45_Expriment_Emotion(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c45_Expriment_Emotion(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c45_Expriment_Emotion_method_dispatcher.\n"
