...
static void initialize_c43_Expriment_Emotion
  (SFc43_Expriment_EmotionInstanceStruct *chartInstance);
static void initialize_params_c43_Expriment_Emotion
  (SFc43_Expriment_EmotionInstanceStruct *chartInstance);
static void enable_c43_Expriment_Emotion(SFc43_Expriment_EmotionInstanceStruct
  *chartInstance);
static void disable_c43_Expriment_Emotion(SFc43_Expriment_EmotionInstanceStruct *
  chartInstance);
static void c43_update_debugger_state_c43_Expriment_Emotion
  (SFc43_Expriment_EmotionInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c43_Expriment_Emotion
  (SFc43_Expriment_EmotionInstanceStruct *chartInstance);
static void set_sim_state_c43_Expriment_Emotion
  (SFc43_Expriment_EmotionInstanceStruct *chartInstance, const mxArray *c43_st);
static void finalize_c43_Expriment_Emotion(SFc43_Expriment_EmotionInstanceStruct
  *chartInstance);
static void sf_gateway_c43_Expriment_Emotion
  (SFc43_Expriment_EmotionInstanceStruct *chartInstance);
static void initSimStructsc43_Expriment_Emotion
  (SFc43_Expriment_EmotionInstanceStruct *chartInstance);
...
static const mxArray *c43_sf_marshallOut(void *chartInstanceVoid, void
  *c43_inData);
static real_T c43_emlrt_marshallIn(SFc43_Expriment_EmotionInstanceStruct
  *chartInstance, const mxArray *c43_a2, const char_T *c43_identifier);
static real_T c43_b_emlrt_marshallIn(SFc43_Expriment_EmotionInstanceStruct
...
static const mxArray *c43_b_sf_marshallOut(void *chartInstanceVoid, void
  *c43_inData);
static boolean_T c43_c_emlrt_marshallIn(SFc43_Expriment_EmotionInstanceStruct
  *chartInstance, const mxArray *c43_u, const emlrtMsgIdentifier *c43_parentId);
...
static const mxArray *c43_c_sf_marshallOut(void *chartInstanceVoid, void
  *c43_inData);
static int32_T c43_d_emlrt_marshallIn(SFc43_Expriment_EmotionInstanceStruct
  *chartInstance, const mxArray *c43_u, const emlrtMsgIdentifier *c43_parentId);
static void c43_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c43_mxArrayInData, const char_T *c43_varName, void *c43_outData);
static uint8_T c43_e_emlrt_marshallIn(SFc43_Expriment_EmotionInstanceStruct
  *chartInstance, const mxArray *c43_b_is_active_c43_Expriment_Emotion, const
  char_T *c43_identifier);
static uint8_T c43_f_emlrt_marshallIn(SFc43_Expriment_EmotionInstanceStruct
  *chartInstance, const mxArray *c43_u, const emlrtMsgIdentifier *c43_parentId);
static void init_dsm_address_info(SFc43_Expriment_EmotionInstanceStruct
  *chartInstance);
  ...
  (SFc43_Expriment_EmotionInstanceStruct *chartInstance)
{
  ...
  chartInstance->c43_is_active_c43_Expriment_Emotion = 0U;
}
  ...
  (SFc43_Expriment_EmotionInstanceStruct *chartInstance)
{
  ...
  c43_b_hoistedGlobal = chartInstance->c43_is_active_c43_Expriment_Emotion;
  ...
  (SFc43_Expriment_EmotionInstanceStruct *chartInstance, const mxArray *c43_st)
{
  ...
  *c43_a2 = c43_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c43_u,
    0)), "a2");
  chartInstance->c43_is_active_c43_Expriment_Emotion = c43_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c43_u, 1)),
     "is_active_c43_Expriment_Emotion");
  sf_mex_destroy(&c43_u);
  c43_update_debugger_state_c43_Expriment_Emotion(chartInstance);
  ...
  *c43_inData)
{
  ...
  const mxArray *c43_y = NULL;
  SFc43_Expriment_EmotionInstanceStruct *chartInstance;
  chartInstance = (SFc43_Expriment_EmotionInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c43_Expriment_Emotion_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c43_identifier)
{
  ...
  c43_y = c43_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c43_b_is_active_c43_Expriment_Emotion), &c43_thisId);
  sf_mex_destroy(&c43_b_is_active_c43_Expriment_Emotion);
  return c43_y;
}
...
void sf_c43_Expriment_Emotion_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c43_Expriment_Emotion_get_autoinheritance_info(void)
{
...
mxArray *sf_c43_Expriment_Emotion_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c43_Expriment_Emotion_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c43_Expriment_Emotion(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[4],T\"a2\",},{M[8],M[0],T\"is_active_c43_Expriment_Emotion\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c43_Expriment_Emotion_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc43_Expriment_EmotionInstanceStruct *)
...
static void sf_opaque_initialize_c43_Expriment_Emotion(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc43_Expriment_EmotionInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c43_Expriment_Emotion((SFc43_Expriment_EmotionInstanceStruct*)
    chartInstanceVar);
  initialize_c43_Expriment_Emotion((SFc43_Expriment_EmotionInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c43_Expriment_Emotion(void *chartInstanceVar)
{
  enable_c43_Expriment_Emotion((SFc43_Expriment_EmotionInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c43_Expriment_Emotion(void *chartInstanceVar)
{
  disable_c43_Expriment_Emotion((SFc43_Expriment_EmotionInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c43_Expriment_Emotion(void *chartInstanceVar)
{
  sf_gateway_c43_Expriment_Emotion((SFc43_Expriment_EmotionInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c43_Expriment_Emotion(SimStruct*
  S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c43_Expriment_Emotion
    ((SFc43_Expriment_EmotionInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c43_Expriment_Emotion();/* state var info */
...
extern void sf_internal_set_sim_state_c43_Expriment_Emotion(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c43_Expriment_Emotion();/* state var info */
  ...
  set_sim_state_c43_Expriment_Emotion((SFc43_Expriment_EmotionInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c43_Expriment_Emotion(SimStruct* S)
{
  return sf_internal_get_sim_state_c43_Expriment_Emotion(S);
}

static void sf_opaque_set_sim_state_c43_Expriment_Emotion(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c43_Expriment_Emotion(S, st);
}

static void sf_opaque_terminate_c43_Expriment_Emotion(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc43_Expriment_EmotionInstanceStruct*) chartInstanceVar)
      ->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c43_Expriment_Emotion((SFc43_Expriment_EmotionInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc43_Expriment_Emotion((SFc43_Expriment_EmotionInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c43_Expriment_Emotion(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c43_Expriment_Emotion
      ((SFc43_Expriment_EmotionInstanceStruct*)(chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c43_Expriment_Emotion(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c43_Expriment_Emotion(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c43_Expriment_Emotion(SimStruct *S)
{
  SFc43_Expriment_EmotionInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc43_Expriment_EmotionInstanceStruct *)utMalloc(sizeof
    (SFc43_Expriment_EmotionInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc43_Expriment_EmotionInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c43_Expriment_Emotion;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c43_Expriment_Emotion;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c43_Expriment_Emotion;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c43_Expriment_Emotion;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c43_Expriment_Emotion;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c43_Expriment_Emotion;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c43_Expriment_Emotion;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c43_Expriment_Emotion;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c43_Expriment_Emotion;
  chartInstance->chartInfo.mdlStart = mdlStart_c43_Expriment_Emotion;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c43_Expriment_Emotion;
...
void c43_Expriment_Emotion_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c43_Expriment_Emotion(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c43_Expriment_Emotion(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c43_Expriment_Emotion(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c43_Expriment_Emotion_method_dispatcher.\n"
