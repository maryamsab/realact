...
static void initialize_c2_DemoIdle(SFc2_DemoIdleInstanceStruct *chartInstance);
static void initialize_params_c2_DemoIdle(SFc2_DemoIdleInstanceStruct
  *chartInstance);
static void enable_c2_DemoIdle(SFc2_DemoIdleInstanceStruct *chartInstance);
static void disable_c2_DemoIdle(SFc2_DemoIdleInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_DemoIdle(SFc2_DemoIdleInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c2_DemoIdle(SFc2_DemoIdleInstanceStruct
  *chartInstance);
static void set_sim_state_c2_DemoIdle(SFc2_DemoIdleInstanceStruct *chartInstance,
  const mxArray *c2_st);
static void finalize_c2_DemoIdle(SFc2_DemoIdleInstanceStruct *chartInstance);
static void sf_gateway_c2_DemoIdle(SFc2_DemoIdleInstanceStruct *chartInstance);
static void initSimStructsc2_DemoIdle(SFc2_DemoIdleInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber, uint32_T c2_instanceNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static real_T c2_emlrt_marshallIn(SFc2_DemoIdleInstanceStruct *chartInstance,
...
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_b_emlrt_marshallIn(SFc2_DemoIdleInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
...
static uint8_T c2_d_emlrt_marshallIn(SFc2_DemoIdleInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void init_dsm_address_info(SFc2_DemoIdleInstanceStruct *chartInstance);
...
static void initialize_c2_DemoIdle(SFc2_DemoIdleInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_DemoIdle = 0U;
}
  ...
  *chartInstance)
{
  ...
  c2_hoistedGlobal = chartInstance->c2_is_active_c2_DemoIdle;
  ...
  const mxArray *c2_st)
{
  ...
  chartInstance->c2_is_active_c2_DemoIdle = c2_c_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c2_u, 0)), "is_active_c2_DemoIdle");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_DemoIdle(chartInstance);
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  real_T c2_u;
  const mxArray *c2_y = NULL;
  SFc2_DemoIdleInstanceStruct *chartInstance;
  chartInstance = (SFc2_DemoIdleInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c2_DemoIdle_get_eml_resolved_functions_info(void)
{
...
void sf_c2_DemoIdle_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c2_DemoIdle_get_autoinheritance_info(void)
{
...
mxArray *sf_c2_DemoIdle_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_DemoIdle_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c2_DemoIdle(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S'type','srcId','name','auxInfo'{{M[8],M[0],T\"is_active_c2_DemoIdle\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 1, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_DemoIdle_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc2_DemoIdleInstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c2_DemoIdle(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_DemoIdleInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c2_DemoIdle((SFc2_DemoIdleInstanceStruct*) chartInstanceVar);
  initialize_c2_DemoIdle((SFc2_DemoIdleInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_DemoIdle(void *chartInstanceVar)
{
  enable_c2_DemoIdle((SFc2_DemoIdleInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_DemoIdle(void *chartInstanceVar)
{
  disable_c2_DemoIdle((SFc2_DemoIdleInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_DemoIdle(void *chartInstanceVar)
{
  sf_gateway_c2_DemoIdle((SFc2_DemoIdleInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_DemoIdle(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_DemoIdle((SFc2_DemoIdleInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_DemoIdle();/* state var info */
...
extern void sf_internal_set_sim_state_c2_DemoIdle(SimStruct* S, const mxArray
  *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c2_DemoIdle();/* state var info */
  ...
  set_sim_state_c2_DemoIdle((SFc2_DemoIdleInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c2_DemoIdle(SimStruct* S)
{
  return sf_internal_get_sim_state_c2_DemoIdle(S);
}

static void sf_opaque_set_sim_state_c2_DemoIdle(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c2_DemoIdle(S, st);
}

static void sf_opaque_terminate_c2_DemoIdle(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_DemoIdleInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c2_DemoIdle((SFc2_DemoIdleInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc2_DemoIdle((SFc2_DemoIdleInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_DemoIdle(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c2_DemoIdle((SFc2_DemoIdleInstanceStruct*)
      (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c2_DemoIdle(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c2_DemoIdle(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_DemoIdle(SimStruct *S)
{
  SFc2_DemoIdleInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc2_DemoIdleInstanceStruct *)utMalloc(sizeof
    (SFc2_DemoIdleInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_DemoIdleInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c2_DemoIdle;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c2_DemoIdle;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c2_DemoIdle;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_DemoIdle;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c2_DemoIdle;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c2_DemoIdle;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c2_DemoIdle;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c2_DemoIdle;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_DemoIdle;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_DemoIdle;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c2_DemoIdle;
...
void c2_DemoIdle_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_DemoIdle(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_DemoIdle(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_DemoIdle(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_DemoIdle_method_dispatcher.\n"
