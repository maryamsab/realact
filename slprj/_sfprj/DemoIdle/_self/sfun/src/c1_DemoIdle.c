...
static void initialize_c1_DemoIdle(SFc1_DemoIdleInstanceStruct *chartInstance);
static void initialize_params_c1_DemoIdle(SFc1_DemoIdleInstanceStruct
  *chartInstance);
static void enable_c1_DemoIdle(SFc1_DemoIdleInstanceStruct *chartInstance);
static void disable_c1_DemoIdle(SFc1_DemoIdleInstanceStruct *chartInstance);
static void c1_update_debugger_state_c1_DemoIdle(SFc1_DemoIdleInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c1_DemoIdle(SFc1_DemoIdleInstanceStruct
  *chartInstance);
static void set_sim_state_c1_DemoIdle(SFc1_DemoIdleInstanceStruct *chartInstance,
  const mxArray *c1_st);
static void c1_set_sim_state_side_effects_c1_DemoIdle
  (SFc1_DemoIdleInstanceStruct *chartInstance);
static void finalize_c1_DemoIdle(SFc1_DemoIdleInstanceStruct *chartInstance);
static void sf_gateway_c1_DemoIdle(SFc1_DemoIdleInstanceStruct *chartInstance);
static void initSimStructsc1_DemoIdle(SFc1_DemoIdleInstanceStruct *chartInstance);
static void c1_sendBMLbyPriority(SFc1_DemoIdleInstanceStruct *chartInstance);
static void c1_enter_atomic_sendH(SFc1_DemoIdleInstanceStruct *chartInstance);
static void c1_enter_atomic_sendM(SFc1_DemoIdleInstanceStruct *chartInstance);
static void c1_low(SFc1_DemoIdleInstanceStruct *chartInstance);
static void c1_encStr2Arr(SFc1_DemoIdleInstanceStruct *chartInstance, real_T
  c1_myarr256[256]);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber, uint32_T c1_instanceNumber);
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData);
static real_T c1_emlrt_marshallIn(SFc1_DemoIdleInstanceStruct *chartInstance,
  const mxArray *c1_nargout, const char_T *c1_identifier);
static real_T c1_b_emlrt_marshallIn(SFc1_DemoIdleInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_b_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_c_emlrt_marshallIn(SFc1_DemoIdleInstanceStruct *chartInstance,
...
static const mxArray *c1_d_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_d_emlrt_marshallIn(SFc1_DemoIdleInstanceStruct *chartInstance,
  const mxArray *c1_newBmls, const char_T *c1_identifier, real_T c1_y[1280]);
static void c1_e_emlrt_marshallIn(SFc1_DemoIdleInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId, real_T c1_y[1280]);
static void c1_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_e_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static boolean_T c1_f_emlrt_marshallIn(SFc1_DemoIdleInstanceStruct
...
static void c1_broadcast_secs(SFc1_DemoIdleInstanceStruct *chartInstance);
static void c1_removeQueue(SFc1_DemoIdleInstanceStruct *chartInstance, real_T
  c1_bmls[1280], real_T c1_newBmls[1280]);
static real_T c1_isEmptyQueue(SFc1_DemoIdleInstanceStruct *chartInstance, real_T
  c1_bmls[1280]);
static const mxArray *c1_f_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static int8_T c1_g_emlrt_marshallIn(SFc1_DemoIdleInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_g_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static int32_T c1_h_emlrt_marshallIn(SFc1_DemoIdleInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_f_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_h_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static uint8_T c1_i_emlrt_marshallIn(SFc1_DemoIdleInstanceStruct *chartInstance,
  const mxArray *c1_b_tp_envChangeWait, const char_T *c1_identifier);
static uint8_T c1_j_emlrt_marshallIn(SFc1_DemoIdleInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_g_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_i_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_k_emlrt_marshallIn(SFc1_DemoIdleInstanceStruct *chartInstance,
  const mxArray *c1_BML, const char_T *c1_identifier, real_T c1_y[256]);
static void c1_l_emlrt_marshallIn(SFc1_DemoIdleInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId, real_T c1_y[256]);
static void c1_h_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_m_emlrt_marshallIn(SFc1_DemoIdleInstanceStruct
  *chartInstance, const mxArray *c1_h_subchartSimStateInfo, const char_T
  *c1_identifier);
static const mxArray *c1_n_emlrt_marshallIn(SFc1_DemoIdleInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_updateDataWrittenToVector(SFc1_DemoIdleInstanceStruct
  *chartInstance, uint32_T c1_vectorIndex);
static void c1_errorIfDataNotWrittenToFcn(SFc1_DemoIdleInstanceStruct
  *chartInstance, uint32_T c1_vectorIndex, uint32_T c1_dataNumber);
static real_T c1_get_BML(SFc1_DemoIdleInstanceStruct *chartInstance, uint32_T
  c1_b);
static void c1_set_BML(SFc1_DemoIdleInstanceStruct *chartInstance, uint32_T c1_b,
  real_T c1_c);
static real_T *c1_access_BML(SFc1_DemoIdleInstanceStruct *chartInstance,
  uint32_T c1_b);
static real_T c1_get_BML1(SFc1_DemoIdleInstanceStruct *chartInstance, uint32_T
  c1_b);
static void c1_set_BML1(SFc1_DemoIdleInstanceStruct *chartInstance, uint32_T
  c1_b, real_T c1_c);
static real_T *c1_access_BML1(SFc1_DemoIdleInstanceStruct *chartInstance,
  uint32_T c1_b);
static real_T c1_get_BML2(SFc1_DemoIdleInstanceStruct *chartInstance, uint32_T
  c1_b);
static void c1_set_BML2(SFc1_DemoIdleInstanceStruct *chartInstance, uint32_T
  c1_b, real_T c1_c);
static real_T *c1_access_BML2(SFc1_DemoIdleInstanceStruct *chartInstance,
  uint32_T c1_b);
static real_T c1_get_BORED(SFc1_DemoIdleInstanceStruct *chartInstance, uint32_T
  c1_b);
static void c1_set_BORED(SFc1_DemoIdleInstanceStruct *chartInstance, uint32_T
  c1_b, real_T c1_c);
static real_T *c1_access_BORED(SFc1_DemoIdleInstanceStruct *chartInstance,
  uint32_T c1_b);
static real_T c1_get_BOREDOM_THRESHOLD(SFc1_DemoIdleInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_BOREDOM_THRESHOLD(SFc1_DemoIdleInstanceStruct *chartInstance,
  uint32_T c1_b, real_T c1_c);
static real_T *c1_access_BOREDOM_THRESHOLD(SFc1_DemoIdleInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_CONTEMPT(SFc1_DemoIdleInstanceStruct *chartInstance,
  uint32_T c1_b);
static void c1_set_CONTEMPT(SFc1_DemoIdleInstanceStruct *chartInstance, uint32_T
  c1_b, real_T c1_c);
static real_T *c1_access_CONTEMPT(SFc1_DemoIdleInstanceStruct *chartInstance,
  uint32_T c1_b);
static real_T c1_get_EXCITE(SFc1_DemoIdleInstanceStruct *chartInstance, uint32_T
  c1_b);
static void c1_set_EXCITE(SFc1_DemoIdleInstanceStruct *chartInstance, uint32_T
  c1_b, real_T c1_c);
static real_T *c1_access_EXCITE(SFc1_DemoIdleInstanceStruct *chartInstance,
  uint32_T c1_b);
static real_T c1_get_FEAR(SFc1_DemoIdleInstanceStruct *chartInstance, uint32_T
  c1_b);
static void c1_set_FEAR(SFc1_DemoIdleInstanceStruct *chartInstance, uint32_T
  c1_b, real_T c1_c);
static real_T *c1_access_FEAR(SFc1_DemoIdleInstanceStruct *chartInstance,
  uint32_T c1_b);
static real_T c1_get_FRUST(SFc1_DemoIdleInstanceStruct *chartInstance, uint32_T
  c1_b);
static void c1_set_FRUST(SFc1_DemoIdleInstanceStruct *chartInstance, uint32_T
  c1_b, real_T c1_c);
static real_T *c1_access_FRUST(SFc1_DemoIdleInstanceStruct *chartInstance,
  uint32_T c1_b);
static real_T c1_get_GAZE_GUI(SFc1_DemoIdleInstanceStruct *chartInstance,
  uint32_T c1_b);
static void c1_set_GAZE_GUI(SFc1_DemoIdleInstanceStruct *chartInstance, uint32_T
  c1_b, real_T c1_c);
static real_T *c1_access_GAZE_GUI(SFc1_DemoIdleInstanceStruct *chartInstance,
  uint32_T c1_b);
static real_T c1_get_GAZE_SOFTEYE(SFc1_DemoIdleInstanceStruct *chartInstance,
  uint32_T c1_b);
static void c1_set_GAZE_SOFTEYE(SFc1_DemoIdleInstanceStruct *chartInstance,
  uint32_T c1_b, real_T c1_c);
static real_T *c1_access_GAZE_SOFTEYE(SFc1_DemoIdleInstanceStruct *chartInstance,
  uint32_T c1_b);
static real_T c1_get_GAZE_USER_HAND(SFc1_DemoIdleInstanceStruct *chartInstance,
  uint32_T c1_b);
static void c1_set_GAZE_USER_HAND(SFc1_DemoIdleInstanceStruct *chartInstance,
  uint32_T c1_b, real_T c1_c);
static real_T *c1_access_GAZE_USER_HAND(SFc1_DemoIdleInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_GAZE_WIN(SFc1_DemoIdleInstanceStruct *chartInstance,
  uint32_T c1_b);
static void c1_set_GAZE_WIN(SFc1_DemoIdleInstanceStruct *chartInstance, uint32_T
  c1_b, real_T c1_c);
static real_T *c1_access_GAZE_WIN(SFc1_DemoIdleInstanceStruct *chartInstance,
  uint32_T c1_b);
static real_T c1_get_HAPPY(SFc1_DemoIdleInstanceStruct *chartInstance, uint32_T
  c1_b);
static void c1_set_HAPPY(SFc1_DemoIdleInstanceStruct *chartInstance, uint32_T
  c1_b, real_T c1_c);
static real_T *c1_access_HAPPY(SFc1_DemoIdleInstanceStruct *chartInstance,
  uint32_T c1_b);
static real_T c1_get_IDLE(SFc1_DemoIdleInstanceStruct *chartInstance, uint32_T
  c1_b);
static void c1_set_IDLE(SFc1_DemoIdleInstanceStruct *chartInstance, uint32_T
  c1_b, real_T c1_c);
static real_T *c1_access_IDLE(SFc1_DemoIdleInstanceStruct *chartInstance,
  uint32_T c1_b);
static real_T c1_get_P(SFc1_DemoIdleInstanceStruct *chartInstance, uint32_T c1_b);
static void c1_set_P(SFc1_DemoIdleInstanceStruct *chartInstance, uint32_T c1_b,
                     real_T c1_c);
static real_T *c1_access_P(SFc1_DemoIdleInstanceStruct *chartInstance, uint32_T
  c1_b);
static real_T c1_get_SAD(SFc1_DemoIdleInstanceStruct *chartInstance, uint32_T
  c1_b);
static void c1_set_SAD(SFc1_DemoIdleInstanceStruct *chartInstance, uint32_T c1_b,
  real_T c1_c);
static real_T *c1_access_SAD(SFc1_DemoIdleInstanceStruct *chartInstance,
  uint32_T c1_b);
static real_T c1_get_STATE_BEFORE(SFc1_DemoIdleInstanceStruct *chartInstance,
  uint32_T c1_b);
static void c1_set_STATE_BEFORE(SFc1_DemoIdleInstanceStruct *chartInstance,
  uint32_T c1_b, real_T c1_c);
static real_T *c1_access_STATE_BEFORE(SFc1_DemoIdleInstanceStruct *chartInstance,
  uint32_T c1_b);
static real_T c1_get_STATE_GO(SFc1_DemoIdleInstanceStruct *chartInstance,
  uint32_T c1_b);
static void c1_set_STATE_GO(SFc1_DemoIdleInstanceStruct *chartInstance, uint32_T
  c1_b, real_T c1_c);
static real_T *c1_access_STATE_GO(SFc1_DemoIdleInstanceStruct *chartInstance,
  uint32_T c1_b);
static real_T c1_get_STATE_HAND(SFc1_DemoIdleInstanceStruct *chartInstance,
  uint32_T c1_b);
static void c1_set_STATE_HAND(SFc1_DemoIdleInstanceStruct *chartInstance,
  uint32_T c1_b, real_T c1_c);
static real_T *c1_access_STATE_HAND(SFc1_DemoIdleInstanceStruct *chartInstance,
  uint32_T c1_b);
static real_T c1_get_STATE_OVER(SFc1_DemoIdleInstanceStruct *chartInstance,
  uint32_T c1_b);
static void c1_set_STATE_OVER(SFc1_DemoIdleInstanceStruct *chartInstance,
  uint32_T c1_b, real_T c1_c);
static real_T *c1_access_STATE_OVER(SFc1_DemoIdleInstanceStruct *chartInstance,
  uint32_T c1_b);
static real_T c1_get_STATE_READY(SFc1_DemoIdleInstanceStruct *chartInstance,
  uint32_T c1_b);
static void c1_set_STATE_READY(SFc1_DemoIdleInstanceStruct *chartInstance,
  uint32_T c1_b, real_T c1_c);
static real_T *c1_access_STATE_READY(SFc1_DemoIdleInstanceStruct *chartInstance,
  uint32_T c1_b);
static real_T c1_get_STATE_RESULT(SFc1_DemoIdleInstanceStruct *chartInstance,
  uint32_T c1_b);
static void c1_set_STATE_RESULT(SFc1_DemoIdleInstanceStruct *chartInstance,
  uint32_T c1_b, real_T c1_c);
static real_T *c1_access_STATE_RESULT(SFc1_DemoIdleInstanceStruct *chartInstance,
  uint32_T c1_b);
static real_T c1_get_STATE_WAIT(SFc1_DemoIdleInstanceStruct *chartInstance,
  uint32_T c1_b);
static void c1_set_STATE_WAIT(SFc1_DemoIdleInstanceStruct *chartInstance,
  uint32_T c1_b, real_T c1_c);
static real_T *c1_access_STATE_WAIT(SFc1_DemoIdleInstanceStruct *chartInstance,
  uint32_T c1_b);
static real_T c1_get_avert(SFc1_DemoIdleInstanceStruct *chartInstance, uint32_T
  c1_b);
static void c1_set_avert(SFc1_DemoIdleInstanceStruct *chartInstance, uint32_T
  c1_b, real_T c1_c);
static real_T *c1_access_avert(SFc1_DemoIdleInstanceStruct *chartInstance,
  uint32_T c1_b);
static real_T c1_get_bHand(SFc1_DemoIdleInstanceStruct *chartInstance, uint32_T
  c1_b);
static void c1_set_bHand(SFc1_DemoIdleInstanceStruct *chartInstance, uint32_T
  c1_b, real_T c1_c);
static real_T *c1_access_bHand(SFc1_DemoIdleInstanceStruct *chartInstance,
  uint32_T c1_b);
static real_T c1_get_bmlsH(SFc1_DemoIdleInstanceStruct *chartInstance, uint32_T
  c1_b);
static void c1_set_bmlsH(SFc1_DemoIdleInstanceStruct *chartInstance, uint32_T
  c1_b, real_T c1_c);
static real_T *c1_access_bmlsH(SFc1_DemoIdleInstanceStruct *chartInstance,
  uint32_T c1_b);
static real_T c1_get_bmlsL(SFc1_DemoIdleInstanceStruct *chartInstance, uint32_T
  c1_b);
static void c1_set_bmlsL(SFc1_DemoIdleInstanceStruct *chartInstance, uint32_T
  c1_b, real_T c1_c);
static real_T *c1_access_bmlsL(SFc1_DemoIdleInstanceStruct *chartInstance,
  uint32_T c1_b);
static real_T c1_get_bmlsM(SFc1_DemoIdleInstanceStruct *chartInstance, uint32_T
  c1_b);
static void c1_set_bmlsM(SFc1_DemoIdleInstanceStruct *chartInstance, uint32_T
  c1_b, real_T c1_c);
static real_T *c1_access_bmlsM(SFc1_DemoIdleInstanceStruct *chartInstance,
  uint32_T c1_b);
static real_T c1_get_boredom(SFc1_DemoIdleInstanceStruct *chartInstance,
  uint32_T c1_b);
static void c1_set_boredom(SFc1_DemoIdleInstanceStruct *chartInstance, uint32_T
  c1_b, real_T c1_c);
static real_T *c1_access_boredom(SFc1_DemoIdleInstanceStruct *chartInstance,
  uint32_T c1_b);
static real_T c1_get_changeFlag(SFc1_DemoIdleInstanceStruct *chartInstance,
  uint32_T c1_b);
static void c1_set_changeFlag(SFc1_DemoIdleInstanceStruct *chartInstance,
  uint32_T c1_b, real_T c1_c);
static real_T *c1_access_changeFlag(SFc1_DemoIdleInstanceStruct *chartInstance,
  uint32_T c1_b);
static real_T c1_get_diff(SFc1_DemoIdleInstanceStruct *chartInstance, uint32_T
  c1_b);
static void c1_set_diff(SFc1_DemoIdleInstanceStruct *chartInstance, uint32_T
  c1_b, real_T c1_c);
static real_T *c1_access_diff(SFc1_DemoIdleInstanceStruct *chartInstance,
  uint32_T c1_b);
static real_T c1_get_fileID(SFc1_DemoIdleInstanceStruct *chartInstance, uint32_T
  c1_b);
static void c1_set_fileID(SFc1_DemoIdleInstanceStruct *chartInstance, uint32_T
  c1_b, real_T c1_c);
static real_T *c1_access_fileID(SFc1_DemoIdleInstanceStruct *chartInstance,
  uint32_T c1_b);
static real_T c1_get_gazing(SFc1_DemoIdleInstanceStruct *chartInstance, uint32_T
  c1_b);
static void c1_set_gazing(SFc1_DemoIdleInstanceStruct *chartInstance, uint32_T
  c1_b, real_T c1_c);
static real_T *c1_access_gazing(SFc1_DemoIdleInstanceStruct *chartInstance,
  uint32_T c1_b);
static real_T c1_get_interest(SFc1_DemoIdleInstanceStruct *chartInstance,
  uint32_T c1_b);
static void c1_set_interest(SFc1_DemoIdleInstanceStruct *chartInstance, uint32_T
  c1_b, real_T c1_c);
static real_T *c1_access_interest(SFc1_DemoIdleInstanceStruct *chartInstance,
  uint32_T c1_b);
static real_T c1_get_n(SFc1_DemoIdleInstanceStruct *chartInstance, uint32_T c1_b);
static void c1_set_n(SFc1_DemoIdleInstanceStruct *chartInstance, uint32_T c1_b,
                     real_T c1_c);
static real_T *c1_access_n(SFc1_DemoIdleInstanceStruct *chartInstance, uint32_T
  c1_b);
static real_T c1_get_pa(SFc1_DemoIdleInstanceStruct *chartInstance, uint32_T
  c1_b);
static void c1_set_pa(SFc1_DemoIdleInstanceStruct *chartInstance, uint32_T c1_b,
                      real_T c1_c);
static real_T *c1_access_pa(SFc1_DemoIdleInstanceStruct *chartInstance, uint32_T
  c1_b);
static real_T c1_get_pr(SFc1_DemoIdleInstanceStruct *chartInstance, uint32_T
  c1_b);
static void c1_set_pr(SFc1_DemoIdleInstanceStruct *chartInstance, uint32_T c1_b,
                      real_T c1_c);
static real_T *c1_access_pr(SFc1_DemoIdleInstanceStruct *chartInstance, uint32_T
  c1_b);
static real_T c1_get_r(SFc1_DemoIdleInstanceStruct *chartInstance, uint32_T c1_b);
static void c1_set_r(SFc1_DemoIdleInstanceStruct *chartInstance, uint32_T c1_b,
                     real_T c1_c);
static real_T *c1_access_r(SFc1_DemoIdleInstanceStruct *chartInstance, uint32_T
  c1_b);
static real_T c1_get_randAvertGazeChance(SFc1_DemoIdleInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_randAvertGazeChance(SFc1_DemoIdleInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_randAvertGazeChance(SFc1_DemoIdleInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_randGazeDur(SFc1_DemoIdleInstanceStruct *chartInstance,
  uint32_T c1_b);
static void c1_set_randGazeDur(SFc1_DemoIdleInstanceStruct *chartInstance,
  uint32_T c1_b, real_T c1_c);
static real_T *c1_access_randGazeDur(SFc1_DemoIdleInstanceStruct *chartInstance,
  uint32_T c1_b);
static real_T c1_get_randPoseChance(SFc1_DemoIdleInstanceStruct *chartInstance,
  uint32_T c1_b);
static void c1_set_randPoseChance(SFc1_DemoIdleInstanceStruct *chartInstance,
  uint32_T c1_b, real_T c1_c);
static real_T *c1_access_randPoseChance(SFc1_DemoIdleInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_randSlowPose(SFc1_DemoIdleInstanceStruct *chartInstance,
  uint32_T c1_b);
static void c1_set_randSlowPose(SFc1_DemoIdleInstanceStruct *chartInstance,
  uint32_T c1_b, real_T c1_c);
static real_T *c1_access_randSlowPose(SFc1_DemoIdleInstanceStruct *chartInstance,
  uint32_T c1_b);
static real_T c1_get_randSmile(SFc1_DemoIdleInstanceStruct *chartInstance,
  uint32_T c1_b);
static void c1_set_randSmile(SFc1_DemoIdleInstanceStruct *chartInstance,
  uint32_T c1_b, real_T c1_c);
static real_T *c1_access_randSmile(SFc1_DemoIdleInstanceStruct *chartInstance,
  uint32_T c1_b);
static real_T c1_get_s(SFc1_DemoIdleInstanceStruct *chartInstance, uint32_T c1_b);
static void c1_set_s(SFc1_DemoIdleInstanceStruct *chartInstance, uint32_T c1_b,
                     real_T c1_c);
static real_T *c1_access_s(SFc1_DemoIdleInstanceStruct *chartInstance, uint32_T
  c1_b);
static real_T c1_get_t(SFc1_DemoIdleInstanceStruct *chartInstance, uint32_T c1_b);
static void c1_set_t(SFc1_DemoIdleInstanceStruct *chartInstance, uint32_T c1_b,
                     real_T c1_c);
static real_T *c1_access_t(SFc1_DemoIdleInstanceStruct *chartInstance, uint32_T
  c1_b);
static real_T c1_get_temp(SFc1_DemoIdleInstanceStruct *chartInstance, uint32_T
  c1_b);
static void c1_set_temp(SFc1_DemoIdleInstanceStruct *chartInstance, uint32_T
  c1_b, real_T c1_c);
static real_T *c1_access_temp(SFc1_DemoIdleInstanceStruct *chartInstance,
  uint32_T c1_b);
static real_T c1_get_uHand(SFc1_DemoIdleInstanceStruct *chartInstance, uint32_T
  c1_b);
static void c1_set_uHand(SFc1_DemoIdleInstanceStruct *chartInstance, uint32_T
  c1_b, real_T c1_c);
static real_T *c1_access_uHand(SFc1_DemoIdleInstanceStruct *chartInstance,
  uint32_T c1_b);
static void init_dsm_address_info(SFc1_DemoIdleInstanceStruct *chartInstance);
...
static void initialize_c1_DemoIdle(SFc1_DemoIdleInstanceStruct *chartInstance)
{
  ...
  sf_exported_auto_initc10_DemoIdle(chartInstance->c1_subchartSimstruct);
  sf_exported_auto_initc5_DemoIdle(chartInstance->c1_b_subchartSimstruct);
  sf_exported_auto_initc8_DemoIdle(chartInstance->c1_c_subchartSimstruct);
  sf_exported_auto_initc20_DemoIdle(chartInstance->c1_d_subchartSimstruct);
  sf_exported_auto_initc11_DemoIdle(chartInstance->c1_e_subchartSimstruct);
  sf_exported_auto_initc9_DemoIdle(chartInstance->c1_f_subchartSimstruct);
  sf_exported_auto_initc4_DemoIdle(chartInstance->c1_g_subchartSimstruct);
  ...
  chartInstance->c1_is_active_c1_DemoIdle = 0U;
...
static void enable_c1_DemoIdle(SFc1_DemoIdleInstanceStruct *chartInstance)
{
  ...
  if (chartInstance->c1_is_active_envChangeWait == 1U) {
    sf_exported_auto_enablec10_DemoIdle(chartInstance->c1_subchartSimstruct);
  }

  if (chartInstance->c1_is_active_RPSGameImitateSmileBrad == 1U) {
    sf_exported_auto_enablec5_DemoIdle(chartInstance->c1_b_subchartSimstruct);
  }

  if (chartInstance->c1_is_active_setDistanceIfUserMoves == 1U) {
    sf_exported_auto_enablec8_DemoIdle(chartInstance->c1_c_subchartSimstruct);
  }

  if (chartInstance->c1_is_active_waveBack == 1U) {
    sf_exported_auto_enablec20_DemoIdle(chartInstance->c1_d_subchartSimstruct);
  }

  if (chartInstance->c1_is_active_smile == 1U) {
    sf_exported_auto_enablec11_DemoIdle(chartInstance->c1_e_subchartSimstruct);
  }

  if (chartInstance->c1_is_active_Gaze == 1U) {
    sf_exported_auto_enablec9_DemoIdle(chartInstance->c1_f_subchartSimstruct);
  }

  if (chartInstance->c1_is_active_idlePoseBrad == 1U) {
    sf_exported_auto_enablec4_DemoIdle(chartInstance->c1_g_subchartSimstruct);
  }
}
...
static void disable_c1_DemoIdle(SFc1_DemoIdleInstanceStruct *chartInstance)
{
  ...
  if (chartInstance->c1_is_active_envChangeWait == 1U) {
    sf_exported_auto_disablec10_DemoIdle(chartInstance->c1_subchartSimstruct);
  }

  if (chartInstance->c1_is_active_RPSGameImitateSmileBrad == 1U) {
    sf_exported_auto_disablec5_DemoIdle(chartInstance->c1_b_subchartSimstruct);
  }

  if (chartInstance->c1_is_active_setDistanceIfUserMoves == 1U) {
    sf_exported_auto_disablec8_DemoIdle(chartInstance->c1_c_subchartSimstruct);
  }

  if (chartInstance->c1_is_active_waveBack == 1U) {
    sf_exported_auto_disablec20_DemoIdle(chartInstance->c1_d_subchartSimstruct);
  }

  if (chartInstance->c1_is_active_smile == 1U) {
    sf_exported_auto_disablec11_DemoIdle(chartInstance->c1_e_subchartSimstruct);
  }

  if (chartInstance->c1_is_active_Gaze == 1U) {
    sf_exported_auto_disablec9_DemoIdle(chartInstance->c1_f_subchartSimstruct);
  }

  if (chartInstance->c1_is_active_idlePoseBrad == 1U) {
    sf_exported_auto_disablec4_DemoIdle(chartInstance->c1_g_subchartSimstruct);
  }
}
  ...
  *chartInstance)
{
  ...
  if (chartInstance->c1_is_active_c1_DemoIdle == 1U) {
  ...
  *chartInstance)
{
  ...
  c1_fc_hoistedGlobal = chartInstance->c1_is_active_c1_DemoIdle;
  ...
  const mxArray *c1_st)
{
  ...
  *c1_win = c1_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 6)),
  ...
  chartInstance->c1_is_active_c1_DemoIdle = c1_i_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c1_u, 65)), "is_active_c1_DemoIdle");
  ...
  c1_update_debugger_state_c1_DemoIdle(chartInstance);
  sf_exported_auto_setSimstatec10_DemoIdle(chartInstance->c1_subchartSimstruct,
    sf_mex_dup(c1_subchartSimStateInfo));
  sf_exported_auto_setSimstatec5_DemoIdle(chartInstance->c1_b_subchartSimstruct,
    sf_mex_dup(c1_b_subchartSimStateInfo));
  sf_exported_auto_setSimstatec8_DemoIdle(chartInstance->c1_c_subchartSimstruct,
    sf_mex_dup(c1_c_subchartSimStateInfo));
  sf_exported_auto_setSimstatec20_DemoIdle(chartInstance->c1_d_subchartSimstruct,
    sf_mex_dup(c1_d_subchartSimStateInfo));
  sf_exported_auto_setSimstatec11_DemoIdle(chartInstance->c1_e_subchartSimstruct,
    sf_mex_dup(c1_e_subchartSimStateInfo));
  sf_exported_auto_setSimstatec9_DemoIdle(chartInstance->c1_f_subchartSimstruct,
    sf_mex_dup(c1_f_subchartSimStateInfo));
  sf_exported_auto_setSimstatec4_DemoIdle(chartInstance->c1_g_subchartSimstruct,
    sf_mex_dup(c1_g_subchartSimStateInfo));
...
static void sf_gateway_c1_DemoIdle(SFc1_DemoIdleInstanceStruct *chartInstance)
{
  ...
  c1_gameState = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c1_set_sim_state_side_effects_c1_DemoIdle(chartInstance);
  _SFD_SYMBOL_SCOPE_PUSH(0U, 0U);
  _sfTime_ = sf_get_time(chartInstance->S);
  sf_exported_auto_gatewayc10_DemoIdle(chartInstance->c1_subchartSimstruct);
  sf_exported_auto_gatewayc5_DemoIdle(chartInstance->c1_b_subchartSimstruct);
  sf_exported_auto_gatewayc8_DemoIdle(chartInstance->c1_c_subchartSimstruct);
  sf_exported_auto_gatewayc20_DemoIdle(chartInstance->c1_d_subchartSimstruct);
  sf_exported_auto_gatewayc11_DemoIdle(chartInstance->c1_e_subchartSimstruct);
  sf_exported_auto_gatewayc9_DemoIdle(chartInstance->c1_f_subchartSimstruct);
  sf_exported_auto_gatewayc4_DemoIdle(chartInstance->c1_g_subchartSimstruct);
  ...
  sf_exported_auto_activate_c10_DemoIdle_secs
    (chartInstance->c1_subchartSimstruct);
  sf_exported_auto_activate_c5_DemoIdle_secs
    (chartInstance->c1_b_subchartSimstruct);
  sf_exported_auto_activate_c8_DemoIdle_secs
    (chartInstance->c1_c_subchartSimstruct);
  sf_exported_auto_activate_c20_DemoIdle_secs
    (chartInstance->c1_d_subchartSimstruct);
  sf_exported_auto_activate_c11_DemoIdle_secs
    (chartInstance->c1_e_subchartSimstruct);
  sf_exported_auto_activate_c9_DemoIdle_secs
    (chartInstance->c1_f_subchartSimstruct);
  sf_exported_auto_activate_c4_DemoIdle_secs
    (chartInstance->c1_g_subchartSimstruct);
  sf_exported_auto_incrementTemporalCounter_c10_DemoIdle_secs
    (chartInstance->c1_subchartSimstruct);
  sf_exported_auto_incrementTemporalCounter_c5_DemoIdle_secs
    (chartInstance->c1_b_subchartSimstruct);
  sf_exported_auto_incrementTemporalCounter_c8_DemoIdle_secs
    (chartInstance->c1_c_subchartSimstruct);
  sf_exported_auto_incrementTemporalCounter_c20_DemoIdle_secs
    (chartInstance->c1_d_subchartSimstruct);
  sf_exported_auto_incrementTemporalCounter_c11_DemoIdle_secs
    (chartInstance->c1_e_subchartSimstruct);
  sf_exported_auto_incrementTemporalCounter_c9_DemoIdle_secs
    (chartInstance->c1_f_subchartSimstruct);
  sf_exported_auto_incrementTemporalCounter_c4_DemoIdle_secs
    (chartInstance->c1_g_subchartSimstruct);
  c1_broadcast_secs(chartInstance);
  sf_exported_auto_resetTemporalCounter_c10_DemoIdle_secs
    (chartInstance->c1_subchartSimstruct);
  sf_exported_auto_resetTemporalCounter_c5_DemoIdle_secs
    (chartInstance->c1_b_subchartSimstruct);
  sf_exported_auto_resetTemporalCounter_c8_DemoIdle_secs
    (chartInstance->c1_c_subchartSimstruct);
  sf_exported_auto_resetTemporalCounter_c20_DemoIdle_secs
    (chartInstance->c1_d_subchartSimstruct);
  sf_exported_auto_resetTemporalCounter_c11_DemoIdle_secs
    (chartInstance->c1_e_subchartSimstruct);
  sf_exported_auto_resetTemporalCounter_c9_DemoIdle_secs
    (chartInstance->c1_f_subchartSimstruct);
  sf_exported_auto_resetTemporalCounter_c4_DemoIdle_secs
    (chartInstance->c1_g_subchartSimstruct);
  sf_exported_auto_deactivate_c10_DemoIdle_secs
    (chartInstance->c1_subchartSimstruct);
  sf_exported_auto_deactivate_c5_DemoIdle_secs
    (chartInstance->c1_b_subchartSimstruct);
  sf_exported_auto_deactivate_c8_DemoIdle_secs
    (chartInstance->c1_c_subchartSimstruct);
  sf_exported_auto_deactivate_c20_DemoIdle_secs
    (chartInstance->c1_d_subchartSimstruct);
  sf_exported_auto_deactivate_c11_DemoIdle_secs
    (chartInstance->c1_e_subchartSimstruct);
  sf_exported_auto_deactivate_c9_DemoIdle_secs
    (chartInstance->c1_f_subchartSimstruct);
  sf_exported_auto_deactivate_c4_DemoIdle_secs
    (chartInstance->c1_g_subchartSimstruct);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_DemoIdleMachineNumber_,
    chartInstance->chartNumber, chartInstance->instanceNumber);
  if (chartInstance->c1_is_active_envChangeWait == 1U) {
    sf_exported_auto_check_state_inconsistency_c10_DemoIdle
      (chartInstance->c1_subchartSimstruct);
  }

  if (chartInstance->c1_is_active_RPSGameImitateSmileBrad == 1U) {
    sf_exported_auto_check_state_inconsistency_c5_DemoIdle
      (chartInstance->c1_b_subchartSimstruct);
  }

  if (chartInstance->c1_is_active_setDistanceIfUserMoves == 1U) {
    sf_exported_auto_check_state_inconsistency_c8_DemoIdle
      (chartInstance->c1_c_subchartSimstruct);
  }

  if (chartInstance->c1_is_active_waveBack == 1U) {
    sf_exported_auto_check_state_inconsistency_c20_DemoIdle
      (chartInstance->c1_d_subchartSimstruct);
  }

  if (chartInstance->c1_is_active_smile == 1U) {
    sf_exported_auto_check_state_inconsistency_c11_DemoIdle
      (chartInstance->c1_e_subchartSimstruct);
  }

  if (chartInstance->c1_is_active_Gaze == 1U) {
    sf_exported_auto_check_state_inconsistency_c9_DemoIdle
      (chartInstance->c1_f_subchartSimstruct);
  }

  if (chartInstance->c1_is_active_idlePoseBrad == 1U) {
    sf_exported_auto_check_state_inconsistency_c4_DemoIdle
      (chartInstance->c1_g_subchartSimstruct);
  }
}
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  const mxArray *c1_y = NULL;
  SFc1_DemoIdleInstanceStruct *chartInstance;
  chartInstance = (SFc1_DemoIdleInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c1_DemoIdle_get_eml_resolved_functions_info(void)
{
...
static void c1_broadcast_secs(SFc1_DemoIdleInstanceStruct *chartInstance)
{
  ...
  _SFD_CE_CALL(EVENT_BEFORE_BROADCAST_TAG, c1_event_secs,
               chartInstance->c1_sfEvent);
  sf_exported_auto_stepBuffersc10_DemoIdle(chartInstance->c1_subchartSimstruct);
  sf_exported_auto_stepBuffersc5_DemoIdle(chartInstance->c1_b_subchartSimstruct);
  sf_exported_auto_stepBuffersc8_DemoIdle(chartInstance->c1_c_subchartSimstruct);
  sf_exported_auto_stepBuffersc20_DemoIdle(chartInstance->c1_d_subchartSimstruct);
  sf_exported_auto_stepBuffersc11_DemoIdle(chartInstance->c1_e_subchartSimstruct);
  sf_exported_auto_stepBuffersc9_DemoIdle(chartInstance->c1_f_subchartSimstruct);
  sf_exported_auto_stepBuffersc4_DemoIdle(chartInstance->c1_g_subchartSimstruct);
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 0U, chartInstance->c1_sfEvent);
  if (chartInstance->c1_is_active_c1_DemoIdle == 0U) {
    sf_exported_auto_initBuffersc10_DemoIdle(chartInstance->c1_subchartSimstruct);
    sf_exported_auto_initBuffersc5_DemoIdle
      (chartInstance->c1_b_subchartSimstruct);
    sf_exported_auto_initBuffersc8_DemoIdle
      (chartInstance->c1_c_subchartSimstruct);
    sf_exported_auto_initBuffersc20_DemoIdle
      (chartInstance->c1_d_subchartSimstruct);
    sf_exported_auto_initBuffersc11_DemoIdle
      (chartInstance->c1_e_subchartSimstruct);
    sf_exported_auto_initBuffersc9_DemoIdle
      (chartInstance->c1_f_subchartSimstruct);
    sf_exported_auto_initBuffersc4_DemoIdle
      (chartInstance->c1_g_subchartSimstruct);
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 0U, chartInstance->c1_sfEvent);
    chartInstance->c1_is_active_c1_DemoIdle = 1U;
    _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 0U, chartInstance->c1_sfEvent);
    chartInstance->c1_is_active_RPSGameImitateSmileBrad = 1U;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, chartInstance->c1_sfEvent);
    chartInstance->c1_tp_RPSGameImitateSmileBrad = 1U;
    sf_exported_auto_enterc5_DemoIdle(chartInstance->c1_b_subchartSimstruct);
    chartInstance->c1_is_active_Gaze = 1U;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, chartInstance->c1_sfEvent);
    chartInstance->c1_tp_Gaze = 1U;
    sf_exported_auto_enterc9_DemoIdle(chartInstance->c1_f_subchartSimstruct);
    chartInstance->c1_is_active_idlePoseBrad = 1U;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 3U, chartInstance->c1_sfEvent);
    chartInstance->c1_tp_idlePoseBrad = 1U;
    sf_exported_auto_enterc4_DemoIdle(chartInstance->c1_g_subchartSimstruct);
    chartInstance->c1_is_active_smile = 1U;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 16U, chartInstance->c1_sfEvent);
    chartInstance->c1_tp_smile = 1U;
    sf_exported_auto_enterc11_DemoIdle(chartInstance->c1_e_subchartSimstruct);
    chartInstance->c1_is_active_setDistanceIfUserMoves = 1U;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 15U, chartInstance->c1_sfEvent);
    chartInstance->c1_tp_setDistanceIfUserMoves = 1U;
    sf_exported_auto_enterc8_DemoIdle(chartInstance->c1_c_subchartSimstruct);
    ...
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 17U, chartInstance->c1_sfEvent);
    chartInstance->c1_tp_waveBack = 1U;
    sf_exported_auto_enterc20_DemoIdle(chartInstance->c1_d_subchartSimstruct);
    chartInstance->c1_is_active_envChangeWait = 1U;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 2U, chartInstance->c1_sfEvent);
    chartInstance->c1_tp_envChangeWait = 1U;
    sf_exported_auto_enterc10_DemoIdle(chartInstance->c1_subchartSimstruct);
  } else {
    _SFD_CS_CALL(STATE_ENTER_DURING_FUNCTION_TAG, 1U, chartInstance->c1_sfEvent);
    sf_exported_auto_duringc5_DemoIdle(chartInstance->c1_b_subchartSimstruct);
    _SFD_CS_CALL(EXIT_OUT_OF_FUNCTION_TAG, 1U, chartInstance->c1_sfEvent);
    _SFD_CS_CALL(STATE_ENTER_DURING_FUNCTION_TAG, 0U, chartInstance->c1_sfEvent);
    sf_exported_auto_duringc9_DemoIdle(chartInstance->c1_f_subchartSimstruct);
    _SFD_CS_CALL(EXIT_OUT_OF_FUNCTION_TAG, 0U, chartInstance->c1_sfEvent);
    _SFD_CS_CALL(STATE_ENTER_DURING_FUNCTION_TAG, 3U, chartInstance->c1_sfEvent);
    sf_exported_auto_duringc4_DemoIdle(chartInstance->c1_g_subchartSimstruct);
    ...
    sf_exported_auto_duringc11_DemoIdle(chartInstance->c1_e_subchartSimstruct);
    ...
    sf_exported_auto_duringc8_DemoIdle(chartInstance->c1_c_subchartSimstruct);
    ...
    sf_exported_auto_duringc20_DemoIdle(chartInstance->c1_d_subchartSimstruct);
    ...
    sf_exported_auto_duringc10_DemoIdle(chartInstance->c1_subchartSimstruct);
  ...
  c1_b)
{
  ...
  if (chartInstance->c1_BML_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'BML\' (#1848) in the initialization routine of the chart.\n");
  }
  ...
  c1_b)
{
  ...
  if (chartInstance->c1_BML1_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'BML1\' (#1864) in the initialization routine of the chart.\n");
  }
  ...
  c1_b)
{
  ...
  if (chartInstance->c1_BML2_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'BML2\' (#1863) in the initialization routine of the chart.\n");
  }
  ...
  c1_b)
{
  ...
  if (chartInstance->c1_BORED_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'BORED\' (#1843) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_BOREDOM_THRESHOLD_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'BOREDOM_THRESHOLD\' (#1814) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c1_b)
{
  ...
  if (chartInstance->c1_CONTEMPT_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'CONTEMPT\' (#1842) in the initialization routine of the chart.\n");
  }
  ...
  c1_b)
{
  ...
  if (chartInstance->c1_EXCITE_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'EXCITE\' (#1847) in the initialization routine of the chart.\n");
  }
  ...
  c1_b)
{
  ...
  if (chartInstance->c1_FEAR_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'FEAR\' (#1845) in the initialization routine of the chart.\n");
  }
  ...
  c1_b)
{
  ...
  if (chartInstance->c1_FRUST_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'FRUST\' (#1844) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c1_b)
{
  ...
  if (chartInstance->c1_GAZE_GUI_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'GAZE_GUI\' (#1827) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c1_b)
{
  ...
  if (chartInstance->c1_GAZE_SOFTEYE_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'GAZE_SOFTEYE\' (#1828) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c1_b)
{
  ...
  if (chartInstance->c1_GAZE_USER_HAND_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'GAZE_USER_HAND\' (#1829) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c1_b)
{
  ...
  if (chartInstance->c1_GAZE_WIN_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'GAZE_WIN\' (#1835) in the initialization routine of the chart.\n");
  }
  ...
  c1_b)
{
  ...
  if (chartInstance->c1_HAPPY_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'HAPPY\' (#1840) in the initialization routine of the chart.\n");
  }
  ...
  c1_b)
{
  ...
  if (chartInstance->c1_IDLE_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'IDLE\' (#1846) in the initialization routine of the chart.\n");
  }
...
static real_T c1_get_P(SFc1_DemoIdleInstanceStruct *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_P_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'P\' (#1822) in the initialization routine of the chart.\n");
  }
  ...
  c1_b)
{
  ...
  if (chartInstance->c1_SAD_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'SAD\' (#1841) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c1_b)
{
  ...
  if (chartInstance->c1_STATE_BEFORE_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'STATE_BEFORE\' (#1837) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c1_b)
{
  ...
  if (chartInstance->c1_STATE_GO_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'STATE_GO\' (#1831) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c1_b)
{
  ...
  if (chartInstance->c1_STATE_HAND_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'STATE_HAND\' (#1832) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c1_b)
{
  ...
  if (chartInstance->c1_STATE_OVER_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'STATE_OVER\' (#1833) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c1_b)
{
  ...
  if (chartInstance->c1_STATE_READY_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'STATE_READY\' (#1830) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c1_b)
{
  ...
  if (chartInstance->c1_STATE_RESULT_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'STATE_RESULT\' (#1838) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c1_b)
{
  ...
  if (chartInstance->c1_STATE_WAIT_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'STATE_WAIT\' (#1839) in the initialization routine of the chart.\n");
  }
  ...
  c1_b)
{
  ...
  if (chartInstance->c1_avert_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'avert\' (#1826) in the initialization routine of the chart.\n");
  }
  ...
  c1_b)
{
  ...
  if (chartInstance->c1_bHand_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'bHand\' (#1809) in the initialization routine of the chart.\n");
  }
  ...
  c1_b)
{
  ...
  if (chartInstance->c1_bmlsH_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'bmlsH\' (#1870) in the initialization routine of the chart.\n");
  }
  ...
  c1_b)
{
  ...
  if (chartInstance->c1_bmlsL_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'bmlsL\' (#1868) in the initialization routine of the chart.\n");
  }
  ...
  c1_b)
{
  ...
  if (chartInstance->c1_bmlsM_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'bmlsM\' (#1875) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c1_b)
{
  ...
  if (chartInstance->c1_boredom_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'boredom\' (#1813) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c1_b)
{
  ...
  if (chartInstance->c1_changeFlag_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'changeFlag\' (#1866) in the initialization routine of the chart.\n");
  }
  ...
  c1_b)
{
  ...
  if (chartInstance->c1_diff_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'diff\' (#1807) in the initialization routine of the chart.\n");
  }
  ...
  c1_b)
{
  ...
  if (chartInstance->c1_fileID_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'fileID\' (#1854) in the initialization routine of the chart.\n");
  }
  ...
  c1_b)
{
  ...
  if (chartInstance->c1_gazing_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'gazing\' (#1834) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c1_b)
{
  ...
  if (chartInstance->c1_interest_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'interest\' (#1817) in the initialization routine of the chart.\n");
  }
...
static real_T c1_get_n(SFc1_DemoIdleInstanceStruct *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_n_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'n\' (#1867) in the initialization routine of the chart.\n");
  }
  ...
  c1_b)
{
  ...
  if (chartInstance->c1_pa_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'pa\' (#1819) in the initialization routine of the chart.\n");
  }
  ...
  c1_b)
{
  ...
  if (chartInstance->c1_pr_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'pr\' (#1849) in the initialization routine of the chart.\n");
  }
...
static real_T c1_get_r(SFc1_DemoIdleInstanceStruct *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_r_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'r\' (#1818) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_randAvertGazeChance_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'randAvertGazeChance\' (#1815) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c1_b)
{
  ...
  if (chartInstance->c1_randGazeDur_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'randGazeDur\' (#1821) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c1_b)
{
  ...
  if (chartInstance->c1_randPoseChance_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'randPoseChance\' (#1816) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c1_b)
{
  ...
  if (chartInstance->c1_randSlowPose_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'randSlowPose\' (#1836) in the initialization routine of the chart.\n");
  }
  ...
  uint32_T c1_b)
{
  ...
  if (chartInstance->c1_randSmile_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'randSmile\' (#1812) in the initialization routine of the chart.\n");
  }
...
static real_T c1_get_s(SFc1_DemoIdleInstanceStruct *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_s_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'s\' (#1820) in the initialization routine of the chart.\n");
  }
...
static real_T c1_get_t(SFc1_DemoIdleInstanceStruct *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_t_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'t\' (#1865) in the initialization routine of the chart.\n");
  }
  ...
  c1_b)
{
  ...
  if (chartInstance->c1_temp_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'temp\' (#1806) in the initialization routine of the chart.\n");
  }
  ...
  c1_b)
{
  ...
  if (chartInstance->c1_uHand_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'uHand\' (#1808) in the initialization routine of the chart.\n");
  }
...
void sf_c1_DemoIdle_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c1_DemoIdle_get_autoinheritance_info(void)
{
...
mxArray *sf_c1_DemoIdle_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c1_DemoIdle_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c1_DemoIdle(void)
{
  ...
  const char *infoEncStr[] = {
    ...
    "100 S1x10'type','srcId','name','auxInfo'{{M[3],M[1262],T\"t\",},{M[3],M[1109],T\"t1\",},{M[3],M[1110],T\"t2\",},{M[3],M[460],T\"temp\",},{M[3],M[467],T\"uHand\",},{M[8],M[0],T\"is_active_c1_DemoIdle\",},{M[8],M[831],T\"is_active_Gaze\",},{M[8],M[832],T\"is_active_idlePoseBrad\",},{M[8],M[835],T\"is_active_smile\",},{M[8],M[879],T\"is_active_setDistanceIfUserMoves\",}}",
  ...
  sf_c1_DemoIdle_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc1_DemoIdleInstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c1_DemoIdle(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_DemoIdleInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c1_DemoIdle((SFc1_DemoIdleInstanceStruct*) chartInstanceVar);
  initialize_c1_DemoIdle((SFc1_DemoIdleInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c1_DemoIdle(void *chartInstanceVar)
{
  enable_c1_DemoIdle((SFc1_DemoIdleInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c1_DemoIdle(void *chartInstanceVar)
{
  disable_c1_DemoIdle((SFc1_DemoIdleInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c1_DemoIdle(void *chartInstanceVar)
{
  sf_gateway_c1_DemoIdle((SFc1_DemoIdleInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c1_DemoIdle(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_DemoIdle((SFc1_DemoIdleInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_DemoIdle();/* state var info */
...
extern void sf_internal_set_sim_state_c1_DemoIdle(SimStruct* S, const mxArray
  *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c1_DemoIdle();/* state var info */
  ...
  set_sim_state_c1_DemoIdle((SFc1_DemoIdleInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c1_DemoIdle(SimStruct* S)
{
  return sf_internal_get_sim_state_c1_DemoIdle(S);
}

static void sf_opaque_set_sim_state_c1_DemoIdle(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c1_DemoIdle(S, st);
}

static void sf_opaque_terminate_c1_DemoIdle(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_DemoIdleInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c1_DemoIdle((SFc1_DemoIdleInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc1_DemoIdle((SFc1_DemoIdleInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_DemoIdle(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c1_DemoIdle((SFc1_DemoIdleInstanceStruct*)
      (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c1_DemoIdle(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(4248217914U));
  ssSetChecksum1(S,(947257303U));
  ssSetChecksum2(S,(761354515U));
  ssSetChecksum3(S,(664105792U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c1_DemoIdle(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_DemoIdle(SimStruct *S)
{
  SFc1_DemoIdleInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc1_DemoIdleInstanceStruct *)utMalloc(sizeof
    (SFc1_DemoIdleInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc1_DemoIdleInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c1_DemoIdle;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c1_DemoIdle;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c1_DemoIdle;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c1_DemoIdle;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c1_DemoIdle;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c1_DemoIdle;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c1_DemoIdle;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c1_DemoIdle;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_DemoIdle;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_DemoIdle;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c1_DemoIdle;
...
void c1_DemoIdle_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_DemoIdle(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_DemoIdle(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_DemoIdle(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_DemoIdle_method_dispatcher.\n"
