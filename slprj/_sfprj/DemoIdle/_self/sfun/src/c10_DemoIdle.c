...
static void initialize_c10_DemoIdle(SFc10_DemoIdleInstanceStruct *chartInstance);
static void initialize_params_c10_DemoIdle(SFc10_DemoIdleInstanceStruct
  *chartInstance);
static void enable_c10_DemoIdle(SFc10_DemoIdleInstanceStruct *chartInstance);
static void disable_c10_DemoIdle(SFc10_DemoIdleInstanceStruct *chartInstance);
static void c10_update_debugger_state_c10_DemoIdle(SFc10_DemoIdleInstanceStruct *
  chartInstance);
static const mxArray *get_sim_state_c10_DemoIdle(SFc10_DemoIdleInstanceStruct
  *chartInstance);
static void set_sim_state_c10_DemoIdle(SFc10_DemoIdleInstanceStruct
  *chartInstance, const mxArray *c10_st);
static void c10_set_sim_state_side_effects_c10_DemoIdle
  (SFc10_DemoIdleInstanceStruct *chartInstance);
static void finalize_c10_DemoIdle(SFc10_DemoIdleInstanceStruct *chartInstance);
static void sf_gateway_c10_DemoIdle(SFc10_DemoIdleInstanceStruct *chartInstance);
static void c10_enter_atomic_c10_DemoIdle(SFc10_DemoIdleInstanceStruct
  *chartInstance);
static void c10_enter_internal_c10_DemoIdle(SFc10_DemoIdleInstanceStruct
  *chartInstance);
static void c10_c10_DemoIdle(SFc10_DemoIdleInstanceStruct *chartInstance);
static void c10_exit_internal_c10_DemoIdle(SFc10_DemoIdleInstanceStruct
  *chartInstance);
static void c10_initc10_DemoIdle(SFc10_DemoIdleInstanceStruct *chartInstance);
static void initSimStructsc10_DemoIdle(SFc10_DemoIdleInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c10_machineNumber, uint32_T
  c10_chartNumber, uint32_T c10_instanceNumber);
static const mxArray *c10_sf_marshallOut(void *chartInstanceVoid, void
  *c10_inData);
static real_T c10_emlrt_marshallIn(SFc10_DemoIdleInstanceStruct *chartInstance,
  const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId);
static void c10_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c10_mxArrayInData, const char_T *c10_varName, void *c10_outData);
static const mxArray *c10_b_sf_marshallOut(void *chartInstanceVoid, void
  *c10_inData);
static boolean_T c10_b_emlrt_marshallIn(SFc10_DemoIdleInstanceStruct
  *chartInstance, const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId);
static void c10_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c10_mxArrayInData, const char_T *c10_varName, void *c10_outData);
static void c10_activate_secsc10_DemoIdle(SFc10_DemoIdleInstanceStruct
  *chartInstance);
static void c10_deactivate_secsc10_DemoIdle(SFc10_DemoIdleInstanceStruct
  *chartInstance);
static void c10_increment_counters_secsc10_DemoIdle(SFc10_DemoIdleInstanceStruct
  *chartInstance);
static void c10_reset_counters_secsc10_DemoIdle(SFc10_DemoIdleInstanceStruct
  *chartInstance);
static const mxArray *c10_c_sf_marshallOut(void *chartInstanceVoid, void
  *c10_inData);
static int8_T c10_c_emlrt_marshallIn(SFc10_DemoIdleInstanceStruct *chartInstance,
  const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId);
...
static const mxArray *c10_d_sf_marshallOut(void *chartInstanceVoid, void
  *c10_inData);
static int32_T c10_d_emlrt_marshallIn(SFc10_DemoIdleInstanceStruct
  *chartInstance, const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId);
...
static const mxArray *c10_e_sf_marshallOut(void *chartInstanceVoid, void
  *c10_inData);
static uint8_T c10_e_emlrt_marshallIn(SFc10_DemoIdleInstanceStruct
  *chartInstance, const mxArray *c10_b_tp_flagOne, const char_T *c10_identifier);
static uint8_T c10_f_emlrt_marshallIn(SFc10_DemoIdleInstanceStruct
  *chartInstance, const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId);
static void c10_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c10_mxArrayInData, const char_T *c10_varName, void *c10_outData);
static const mxArray *c10_g_emlrt_marshallIn(SFc10_DemoIdleInstanceStruct
  *chartInstance, const mxArray *c10_b_setSimStateSideEffectsInfo, const char_T *
  c10_identifier);
static const mxArray *c10_h_emlrt_marshallIn(SFc10_DemoIdleInstanceStruct
  *chartInstance, const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId);
static real_T c10_get_changeFlag(SFc10_DemoIdleInstanceStruct *chartInstance,
  uint32_T c10_b);
static void c10_set_changeFlag(SFc10_DemoIdleInstanceStruct *chartInstance,
  uint32_T c10_b, real_T c10_c);
static real_T *c10_access_changeFlag(SFc10_DemoIdleInstanceStruct *chartInstance,
  uint32_T c10_b);
static void init_dsm_address_info(SFc10_DemoIdleInstanceStruct *chartInstance);
  ...
  *chartInstance)
{
  ...
  c10_hoistedGlobal = chartInstance->c10_is_active_c10_DemoIdle;
  c10_u = c10_hoistedGlobal;
  c10_b_y = NULL;
  sf_mex_assign(&c10_b_y, sf_mex_create("y", &c10_u, 3, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c10_y, 0, c10_b_y);
  c10_b_hoistedGlobal = chartInstance->c10_is_c10_DemoIdle;
  ...
  *chartInstance, const mxArray *c10_st)
{
  ...
  chartInstance->c10_is_active_c10_DemoIdle = c10_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c10_u, 0)),
     "is_active_c10_DemoIdle");
  chartInstance->c10_is_c10_DemoIdle = c10_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c10_u, 1)), "is_c10_DemoIdle");
  ...
  c10_update_debugger_state_c10_DemoIdle(chartInstance);
...
static void sf_gateway_c10_DemoIdle(SFc10_DemoIdleInstanceStruct *chartInstance)
{
  c10_set_sim_state_side_effects_c10_DemoIdle(chartInstance);
}
  ...
  *chartInstance)
{
  ...
  chartInstance->c10_is_active_c10_DemoIdle = 1U;
  ...
  *chartInstance)
{
  ...
  chartInstance->c10_is_c10_DemoIdle = c10_IN_init;
  _SFD_CS_CALL(STATE_ACTIVE_TAG, 2U, chartInstance->c10_sfEvent);
  chartInstance->c10_tp_init = 1U;
}
...
static void c10_c10_DemoIdle(SFc10_DemoIdleInstanceStruct *chartInstance)
{
  ...
  switch (chartInstance->c10_is_c10_DemoIdle) {
   case c10_IN_flagOne:
    CV_CHART_EVAL(6, 0, 1);
   ...
   case c10_IN_init:
    ...
    if (c10_b_out) {
      ...
      _SFD_CS_CALL(STATE_INACTIVE_TAG, 2U, chartInstance->c10_sfEvent);
      chartInstance->c10_isStable = false;
      chartInstance->c10_is_c10_DemoIdle = c10_IN_flagOne;
      _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, chartInstance->c10_sfEvent);
      chartInstance->c10_temporalCounter_i1 = 0U;
      chartInstance->c10_tp_flagOne = 1U;
      ...
      if (c10_c_out) {
        ...
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 2U, chartInstance->c10_sfEvent);
        chartInstance->c10_isStable = false;
        chartInstance->c10_is_c10_DemoIdle = c10_IN_flagZero;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, chartInstance->c10_sfEvent);
        chartInstance->c10_tp_flagZero = 1U;
   ...
   default:
    CV_CHART_EVAL(6, 0, 0);
    chartInstance->c10_is_c10_DemoIdle = c10_IN_NO_ACTIVE_CHILD;
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, chartInstance->c10_sfEvent);
    break;
  }
...
static void c10_initc10_DemoIdle(SFc10_DemoIdleInstanceStruct *chartInstance)
{
  ...
  chartInstance->c10_tp_flagZero = 0U;
  chartInstance->c10_tp_init = 0U;
  chartInstance->c10_is_active_c10_DemoIdle = 0U;
  chartInstance->c10_is_c10_DemoIdle = c10_IN_NO_ACTIVE_CHILD;
}
  ...
  *c10_inData)
{
  ...
  const mxArray *c10_y = NULL;
  SFc10_DemoIdleInstanceStruct *chartInstance;
  chartInstance = (SFc10_DemoIdleInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c10_DemoIdle_get_eml_resolved_functions_info(void)
{
...
void sf_exported_auto_activate_c10_DemoIdle_secs(SimStruct *c10_S)
{
  SFc10_DemoIdleInstanceStruct *chartInstance;
  chartInstance = (SFc10_DemoIdleInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c10_S))->instanceInfo)->chartInstance;
  c10_activate_secsc10_DemoIdle(chartInstance);
}

void sf_exported_auto_incrementTemporalCounter_c10_DemoIdle_secs(SimStruct
  *c10_S)
{
  SFc10_DemoIdleInstanceStruct *chartInstance;
  chartInstance = (SFc10_DemoIdleInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c10_S))->instanceInfo)->chartInstance;
  c10_increment_counters_secsc10_DemoIdle(chartInstance);
}

void sf_exported_auto_resetTemporalCounter_c10_DemoIdle_secs(SimStruct *c10_S)
{
  SFc10_DemoIdleInstanceStruct *chartInstance;
  chartInstance = (SFc10_DemoIdleInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c10_S))->instanceInfo)->chartInstance;
  c10_reset_counters_secsc10_DemoIdle(chartInstance);
}

void sf_exported_auto_deactivate_c10_DemoIdle_secs(SimStruct *c10_S)
{
  SFc10_DemoIdleInstanceStruct *chartInstance;
  chartInstance = (SFc10_DemoIdleInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c10_S))->instanceInfo)->chartInstance;
  c10_deactivate_secsc10_DemoIdle(chartInstance);
}

boolean_T sf_exported_auto_isStablec10_DemoIdle(SimStruct *c10_S)
{
  SFc10_DemoIdleInstanceStruct *chartInstance;
  chartInstance = (SFc10_DemoIdleInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c10_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_duringc10_DemoIdle(SimStruct *c10_S)
{
  SFc10_DemoIdleInstanceStruct *chartInstance;
  chartInstance = (SFc10_DemoIdleInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c10_S))->instanceInfo)->chartInstance;
  c10_c10_DemoIdle(chartInstance);
}

void sf_exported_auto_enterc10_DemoIdle(SimStruct *c10_S)
{
  SFc10_DemoIdleInstanceStruct *chartInstance;
  chartInstance = (SFc10_DemoIdleInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c10_S))->instanceInfo)->chartInstance;
  _sfTime_ = sf_get_time(chartInstance->S);
  c10_enter_atomic_c10_DemoIdle(chartInstance);
  c10_enter_internal_c10_DemoIdle(chartInstance);
}

void sf_exported_auto_exitc10_DemoIdle(SimStruct *c10_S)
{
  SFc10_DemoIdleInstanceStruct *chartInstance;
  chartInstance = (SFc10_DemoIdleInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c10_S))->instanceInfo)->chartInstance;
  _sfTime_ = sf_get_time(chartInstance->S);
  c10_exit_internal_c10_DemoIdle(chartInstance);
}

void sf_exported_auto_gatewayc10_DemoIdle(SimStruct *c10_S)
{
  SFc10_DemoIdleInstanceStruct *chartInstance;
  chartInstance = (SFc10_DemoIdleInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c10_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_enablec10_DemoIdle(SimStruct *c10_S)
{
  SFc10_DemoIdleInstanceStruct *chartInstance;
  chartInstance = (SFc10_DemoIdleInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c10_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_disablec10_DemoIdle(SimStruct *c10_S)
{
  SFc10_DemoIdleInstanceStruct *chartInstance;
  chartInstance = (SFc10_DemoIdleInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c10_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_stepBuffersc10_DemoIdle(SimStruct *c10_S)
{
  SFc10_DemoIdleInstanceStruct *chartInstance;
  chartInstance = (SFc10_DemoIdleInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c10_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_initBuffersc10_DemoIdle(SimStruct *c10_S)
{
  SFc10_DemoIdleInstanceStruct *chartInstance;
  chartInstance = (SFc10_DemoIdleInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c10_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_activate_callc10_DemoIdle(SimStruct *c10_S)
{
  SFc10_DemoIdleInstanceStruct *chartInstance;
  chartInstance = (SFc10_DemoIdleInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c10_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_increment_call_counterc10_DemoIdle(SimStruct *c10_S)
{
  SFc10_DemoIdleInstanceStruct *chartInstance;
  chartInstance = (SFc10_DemoIdleInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c10_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_reset_call_counterc10_DemoIdle(SimStruct *c10_S)
{
  SFc10_DemoIdleInstanceStruct *chartInstance;
  chartInstance = (SFc10_DemoIdleInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c10_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_deactivate_callc10_DemoIdle(SimStruct *c10_S)
{
  SFc10_DemoIdleInstanceStruct *chartInstance;
  chartInstance = (SFc10_DemoIdleInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c10_S))->instanceInfo)->chartInstance;
...
void sf_exported_auto_initc10_DemoIdle(SimStruct *c10_S)
{
  SFc10_DemoIdleInstanceStruct *chartInstance;
  chartInstance = (SFc10_DemoIdleInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c10_S))->instanceInfo)->chartInstance;
  c10_initc10_DemoIdle(chartInstance);
}

const mxArray *sf_exported_auto_getSimstatec10_DemoIdle(SimStruct *c10_S)
{
  ...
  chartInstance = (SFc10_DemoIdleInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c10_S))->instanceInfo)->chartInstance;
  c10_out = NULL;
  sf_mex_assign(&c10_out, sf_internal_get_sim_state_c10_DemoIdle(c10_S), false);
  return c10_out;
}

void sf_exported_auto_setSimstatec10_DemoIdle(SimStruct *c10_S, const mxArray
  *c10_in)
{
  SFc10_DemoIdleInstanceStruct *chartInstance;
  chartInstance = (SFc10_DemoIdleInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c10_S))->instanceInfo)->chartInstance;
  sf_internal_set_sim_state_c10_DemoIdle(c10_S, sf_mex_dup(c10_in));
  sf_mex_destroy(&c10_in);
}

void sf_exported_auto_check_state_inconsistency_c10_DemoIdle(SimStruct *c10_S)
{
  SFc10_DemoIdleInstanceStruct *chartInstance;
  chartInstance = (SFc10_DemoIdleInstanceStruct *)((ChartInfoStruct *)
    ((ChartRunTimeInfo *)ssGetUserData(c10_S))->instanceInfo)->chartInstance;
  ...
  uint32_T c10_b)
{
  ...
  if (chartInstance->c10_changeFlag_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'changeFlag\' (#643) in the initialization routine of the chart.\n");
  }
...
void sf_c10_DemoIdle_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c10_DemoIdle_get_autoinheritance_info(void)
{
...
mxArray *sf_c10_DemoIdle_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c10_DemoIdle_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c10_DemoIdle(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[8],M[0],T\"is_active_c10_DemoIdle\",},{M[9],M[0],T\"is_c10_DemoIdle\",},{M[11],M[11],T\"temporalCounter_i1\",S'et','os','ct'{{T\"ev\",M[7],M[1]}}}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c10_DemoIdle_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc10_DemoIdleInstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c10_DemoIdle(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc10_DemoIdleInstanceStruct*) chartInstanceVar
    )->S,0);
  initialize_params_c10_DemoIdle((SFc10_DemoIdleInstanceStruct*)
    chartInstanceVar);
  initialize_c10_DemoIdle((SFc10_DemoIdleInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c10_DemoIdle(void *chartInstanceVar)
{
  enable_c10_DemoIdle((SFc10_DemoIdleInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c10_DemoIdle(void *chartInstanceVar)
{
  disable_c10_DemoIdle((SFc10_DemoIdleInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c10_DemoIdle(void *chartInstanceVar)
{
  sf_gateway_c10_DemoIdle((SFc10_DemoIdleInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c10_DemoIdle(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c10_DemoIdle((SFc10_DemoIdleInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c10_DemoIdle();/* state var info */
...
extern void sf_internal_set_sim_state_c10_DemoIdle(SimStruct* S, const mxArray
  *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c10_DemoIdle();/* state var info */
  ...
  set_sim_state_c10_DemoIdle((SFc10_DemoIdleInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c10_DemoIdle(SimStruct* S)
{
  return NULL;
}

static void sf_opaque_set_sim_state_c10_DemoIdle(SimStruct* S, const mxArray *st)
{
}

static void sf_opaque_terminate_c10_DemoIdle(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc10_DemoIdleInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c10_DemoIdle((SFc10_DemoIdleInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc10_DemoIdle((SFc10_DemoIdleInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c10_DemoIdle(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c10_DemoIdle(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c10_DemoIdle(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c10_DemoIdle(SimStruct *S)
{
  SFc10_DemoIdleInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc10_DemoIdleInstanceStruct *)utMalloc(sizeof
    (SFc10_DemoIdleInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc10_DemoIdleInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c10_DemoIdle;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c10_DemoIdle;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c10_DemoIdle;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c10_DemoIdle;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c10_DemoIdle;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c10_DemoIdle;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c10_DemoIdle;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c10_DemoIdle;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c10_DemoIdle;
  chartInstance->chartInfo.mdlStart = mdlStart_c10_DemoIdle;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c10_DemoIdle;
...
void c10_DemoIdle_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c10_DemoIdle(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c10_DemoIdle(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c10_DemoIdle(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c10_DemoIdle_method_dispatcher.\n"
