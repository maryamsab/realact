  ...
  method, void *data)
{
  if (chartFileNumber==50) {
    c50_lib_affectiveChar_behavior_method_dispatcher(simstructPtr, method, data);
    return 1;
  }
  ...
  if (nrhs>2 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"library")) {
      ...
      if (!strcmp(machineName,"lib_affectiveChar_behavior")) {
        if (nrhs==3) {
          ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(626015761U);
          ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1093458112U);
          ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2537546054U);
          ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(907292075U);
        } else if (nrhs==4) {
          ...
          switch (chartFileNumber) {
           case 50:
            {
              extern void sf_c50_lib_affectiveChar_behavior_get_check_sum
                (mxArray *plhs[]);
              sf_c50_lib_affectiveChar_behavior_get_check_sum(plhs);
              break;
            }
  ...
  mxArray * plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 50:
      {
        if (strcmp(aiChksum, "VMWkzs0Xndb5ltBqosEAID") == 0) {
          extern mxArray
            *sf_c50_lib_affectiveChar_behavior_get_autoinheritance_info(void);
          plhs[0] = sf_c50_lib_affectiveChar_behavior_get_autoinheritance_info();
          break;
        }
     ...
     case 50:
      {
        extern const mxArray
          *sf_c50_lib_affectiveChar_behavior_get_eml_resolved_functions_info
          (void);
  ...
  mxArray * plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 50:
      {
        if (strcmp(tpChksum, "7NeWQyO6jlCCtwsfqhUmdB") == 0) {
          extern mxArray
            *sf_c50_lib_affectiveChar_behavior_third_party_uses_info(void);
          plhs[0] = sf_c50_lib_affectiveChar_behavior_third_party_uses_info();
          break;
        }
      }
     ...
     case 50:
      {
        if (strcmp(tpChksum, "7NeWQyO6jlCCtwsfqhUmdB") == 0) {
          extern mxArray
            *sf_c50_lib_affectiveChar_behavior_updateBuildInfo_args_info(void);
          plhs[0] = sf_c50_lib_affectiveChar_behavior_updateBuildInfo_args_info();
          break;
        }
      }
...
mxArray* load_lib_affectiveChar_behavior_optimization_info(void)
{
  if (sRtwOptimizationInfoStruct==NULL) {
    sRtwOptimizationInfoStruct = sf_load_rtw_optimization_info(
      "lib_affectiveChar_behavior", "Demo_EP_IdleRandMerg");
