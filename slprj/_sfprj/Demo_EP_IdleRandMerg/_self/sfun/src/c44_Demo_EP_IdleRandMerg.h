#ifndef __c44_Demo_EP_IdleRandMerg_h__
#define __c44_Demo_EP_IdleRandMerg_h__
...
/* Type Definitions */
#ifndef typedef_SFc44_Demo_EP_IdleRandMergInstanceStruct
#define typedef_SFc44_Demo_EP_IdleRandMergInstanceStruct
...
typedef struct {
  ...
  uint8_T c44_is_active_c44_Demo_EP_IdleRandMerg;
  uint8_T c44_is_c44_Demo_EP_IdleRandMerg;
...
#endif                                 /*typedef_SFc44_Demo_EP_IdleRandMergInstanceStruct*/
...
extern boolean_T sf_exported_auto_isStablec44_Demo_EP_IdleRandMerg(SimStruct
  *c44_S);
extern void sf_exported_auto_duringc44_Demo_EP_IdleRandMerg(SimStruct *c44_S);
extern void sf_exported_auto_enterc44_Demo_EP_IdleRandMerg(SimStruct *c44_S);
extern void sf_exported_auto_enablec50_lib_affectiveChar_behavior(SimStruct
  *c44_S);
extern void sf_exported_auto_exitc44_Demo_EP_IdleRandMerg(SimStruct *c44_S);
extern void sf_exported_auto_disablec50_lib_affectiveChar_behavior(SimStruct
  *c44_S);
extern void sf_exported_auto_gatewayc44_Demo_EP_IdleRandMerg(SimStruct *c44_S);
extern void sf_exported_auto_gatewayc50_lib_affectiveChar_behavior(SimStruct
  *c44_S);
extern void sf_exported_auto_enablec44_Demo_EP_IdleRandMerg(SimStruct *c44_S);
extern void sf_exported_auto_enablec50_lib_affectiveChar_behavior(SimStruct
  *c44_S);
extern void sf_exported_auto_disablec44_Demo_EP_IdleRandMerg(SimStruct *c44_S);
extern void sf_exported_auto_disablec50_lib_affectiveChar_behavior(SimStruct
  *c44_S);
extern void sf_exported_auto_stepBuffersc44_Demo_EP_IdleRandMerg(SimStruct
  *c44_S);
extern void sf_exported_auto_stepBuffersc50_lib_affectiveChar_behavior(SimStruct
  *c44_S);
extern void sf_exported_auto_initBuffersc44_Demo_EP_IdleRandMerg(SimStruct
  *c44_S);
...
extern void sf_exported_auto_activate_callc50_lib_affectiveChar_behavior
  (SimStruct *c44_S);
extern void sf_exported_auto_increment_call_counterc44_Demo_EP_IdleRandMerg
  (SimStruct *c44_S);
extern void
  sf_exported_auto_increment_call_counterc50_lib_affectiveChar_behavior
  (SimStruct *c44_S);
extern void sf_exported_auto_reset_call_counterc44_Demo_EP_IdleRandMerg
  (SimStruct *c44_S);
...
extern void sf_exported_auto_deactivate_callc50_lib_affectiveChar_behavior
  (SimStruct *c44_S);
extern void sf_exported_auto_initc44_Demo_EP_IdleRandMerg(SimStruct *c44_S);
...
extern const mxArray *sf_internal_get_sim_state_c44_Demo_EP_IdleRandMerg
  (SimStruct *c44_S);
extern void sf_exported_auto_setSimstatec44_Demo_EP_IdleRandMerg(SimStruct
  *c44_S, const mxArray *c44_in);
extern void sf_internal_set_sim_state_c44_Demo_EP_IdleRandMerg(SimStruct *c44_S,
...
extern void c44_Demo_EP_IdleRandMerg_method_dispatcher(SimStruct *S, int_T
  method, void *data);
