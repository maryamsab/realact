...
static void initialize_c12_Demo_EP_IdleRandMerg
  (SFc12_Demo_EP_IdleRandMergInstanceStruct *chartInstance);
static void initialize_params_c12_Demo_EP_IdleRandMerg
  (SFc12_Demo_EP_IdleRandMergInstanceStruct *chartInstance);
static void enable_c12_Demo_EP_IdleRandMerg
  (SFc12_Demo_EP_IdleRandMergInstanceStruct *chartInstance);
static void disable_c12_Demo_EP_IdleRandMerg
  (SFc12_Demo_EP_IdleRandMergInstanceStruct *chartInstance);
static void c12_update_debugger_state_c12_Demo_EP_IdleRandMerg
  (SFc12_Demo_EP_IdleRandMergInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c12_Demo_EP_IdleRandMerg
  (SFc12_Demo_EP_IdleRandMergInstanceStruct *chartInstance);
static void set_sim_state_c12_Demo_EP_IdleRandMerg
  (SFc12_Demo_EP_IdleRandMergInstanceStruct *chartInstance, const mxArray
   *c12_st);
static void finalize_c12_Demo_EP_IdleRandMerg
  (SFc12_Demo_EP_IdleRandMergInstanceStruct *chartInstance);
static void sf_gateway_c12_Demo_EP_IdleRandMerg
  (SFc12_Demo_EP_IdleRandMergInstanceStruct *chartInstance);
static void c12_chartstep_c12_Demo_EP_IdleRandMerg
  (SFc12_Demo_EP_IdleRandMergInstanceStruct *chartInstance);
static void initSimStructsc12_Demo_EP_IdleRandMerg
  (SFc12_Demo_EP_IdleRandMergInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c12_machineNumber, uint32_T
  c12_chartNumber, uint32_T c12_instanceNumber);
static const mxArray *c12_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static real_T c12_emlrt_marshallIn(SFc12_Demo_EP_IdleRandMergInstanceStruct
  *chartInstance, const mxArray *c12_e, const char_T *c12_identifier);
static real_T c12_b_emlrt_marshallIn(SFc12_Demo_EP_IdleRandMergInstanceStruct
...
static const mxArray *c12_c_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static int32_T c12_d_emlrt_marshallIn(SFc12_Demo_EP_IdleRandMergInstanceStruct
  *chartInstance, const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId);
static void c12_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c12_mxArrayInData, const char_T *c12_varName, void *c12_outData);
static uint8_T c12_e_emlrt_marshallIn(SFc12_Demo_EP_IdleRandMergInstanceStruct
  *chartInstance, const mxArray *c12_b_is_active_c12_Demo_EP_IdleRandMerg, const
  char_T *c12_identifier);
static uint8_T c12_f_emlrt_marshallIn(SFc12_Demo_EP_IdleRandMergInstanceStruct
  *chartInstance, const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId);
static void init_dsm_address_info(SFc12_Demo_EP_IdleRandMergInstanceStruct
  *chartInstance);
  ...
  (SFc12_Demo_EP_IdleRandMergInstanceStruct *chartInstance)
{
  ...
  chartInstance->c12_is_active_c12_Demo_EP_IdleRandMerg = 0U;
}
  ...
  (SFc12_Demo_EP_IdleRandMergInstanceStruct *chartInstance)
{
  ...
  c12_b_hoistedGlobal = chartInstance->c12_is_active_c12_Demo_EP_IdleRandMerg;
   ...
   *c12_st)
{
  ...
  *c12_e = c12_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c12_u,
    0)), "e");
  chartInstance->c12_is_active_c12_Demo_EP_IdleRandMerg = c12_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c12_u, 1)),
     "is_active_c12_Demo_EP_IdleRandMerg");
  sf_mex_destroy(&c12_u);
  c12_update_debugger_state_c12_Demo_EP_IdleRandMerg(chartInstance);
  ...
  *c12_inData)
{
  ...
  const mxArray *c12_y = NULL;
  SFc12_Demo_EP_IdleRandMergInstanceStruct *chartInstance;
  chartInstance = (SFc12_Demo_EP_IdleRandMergInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c12_Demo_EP_IdleRandMerg_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c12_identifier)
{
  ...
  c12_y = c12_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c12_b_is_active_c12_Demo_EP_IdleRandMerg), &c12_thisId);
  sf_mex_destroy(&c12_b_is_active_c12_Demo_EP_IdleRandMerg);
  return c12_y;
}
...
void sf_c12_Demo_EP_IdleRandMerg_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c12_Demo_EP_IdleRandMerg_get_autoinheritance_info(void)
{
...
mxArray *sf_c12_Demo_EP_IdleRandMerg_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c12_Demo_EP_IdleRandMerg_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c12_Demo_EP_IdleRandMerg(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"e\",},{M[8],M[0],T\"is_active_c12_Demo_EP_IdleRandMerg\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c12_Demo_EP_IdleRandMerg_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc12_Demo_EP_IdleRandMergInstanceStruct *)
...
static void sf_opaque_initialize_c12_Demo_EP_IdleRandMerg(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc12_Demo_EP_IdleRandMergInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c12_Demo_EP_IdleRandMerg
    ((SFc12_Demo_EP_IdleRandMergInstanceStruct*) chartInstanceVar);
  initialize_c12_Demo_EP_IdleRandMerg((SFc12_Demo_EP_IdleRandMergInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c12_Demo_EP_IdleRandMerg(void *chartInstanceVar)
{
  enable_c12_Demo_EP_IdleRandMerg((SFc12_Demo_EP_IdleRandMergInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c12_Demo_EP_IdleRandMerg(void *chartInstanceVar)
{
  disable_c12_Demo_EP_IdleRandMerg((SFc12_Demo_EP_IdleRandMergInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c12_Demo_EP_IdleRandMerg(void *chartInstanceVar)
{
  sf_gateway_c12_Demo_EP_IdleRandMerg((SFc12_Demo_EP_IdleRandMergInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c12_Demo_EP_IdleRandMerg
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c12_Demo_EP_IdleRandMerg
    ((SFc12_Demo_EP_IdleRandMergInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c12_Demo_EP_IdleRandMerg();/* state var info */
...
extern void sf_internal_set_sim_state_c12_Demo_EP_IdleRandMerg(SimStruct* S,
  const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c12_Demo_EP_IdleRandMerg();/* state var info */
  ...
  set_sim_state_c12_Demo_EP_IdleRandMerg
    ((SFc12_Demo_EP_IdleRandMergInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c12_Demo_EP_IdleRandMerg(SimStruct*
  S)
{
  return sf_internal_get_sim_state_c12_Demo_EP_IdleRandMerg(S);
}

static void sf_opaque_set_sim_state_c12_Demo_EP_IdleRandMerg(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c12_Demo_EP_IdleRandMerg(S, st);
}

static void sf_opaque_terminate_c12_Demo_EP_IdleRandMerg(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc12_Demo_EP_IdleRandMergInstanceStruct*) chartInstanceVar)
      ->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c12_Demo_EP_IdleRandMerg((SFc12_Demo_EP_IdleRandMergInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc12_Demo_EP_IdleRandMerg
    ((SFc12_Demo_EP_IdleRandMergInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c12_Demo_EP_IdleRandMerg(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c12_Demo_EP_IdleRandMerg(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c12_Demo_EP_IdleRandMerg(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c12_Demo_EP_IdleRandMerg(SimStruct *S)
{
  SFc12_Demo_EP_IdleRandMergInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc12_Demo_EP_IdleRandMergInstanceStruct *)utMalloc(sizeof
    (SFc12_Demo_EP_IdleRandMergInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc12_Demo_EP_IdleRandMergInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c12_Demo_EP_IdleRandMerg;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c12_Demo_EP_IdleRandMerg;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c12_Demo_EP_IdleRandMerg;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c12_Demo_EP_IdleRandMerg;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c12_Demo_EP_IdleRandMerg;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c12_Demo_EP_IdleRandMerg;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c12_Demo_EP_IdleRandMerg;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c12_Demo_EP_IdleRandMerg;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c12_Demo_EP_IdleRandMerg;
  chartInstance->chartInfo.mdlStart = mdlStart_c12_Demo_EP_IdleRandMerg;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c12_Demo_EP_IdleRandMerg;
...
void c12_Demo_EP_IdleRandMerg_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c12_Demo_EP_IdleRandMerg(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c12_Demo_EP_IdleRandMerg(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c12_Demo_EP_IdleRandMerg(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c12_Demo_EP_IdleRandMerg_method_dispatcher.\n"
