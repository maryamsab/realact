...
static void initialize_c14_Demo_EP_IdleRandMerg
  (SFc14_Demo_EP_IdleRandMergInstanceStruct *chartInstance);
static void initialize_params_c14_Demo_EP_IdleRandMerg
  (SFc14_Demo_EP_IdleRandMergInstanceStruct *chartInstance);
static void enable_c14_Demo_EP_IdleRandMerg
  (SFc14_Demo_EP_IdleRandMergInstanceStruct *chartInstance);
static void disable_c14_Demo_EP_IdleRandMerg
  (SFc14_Demo_EP_IdleRandMergInstanceStruct *chartInstance);
static void c14_update_debugger_state_c14_Demo_EP_IdleRandMerg
  (SFc14_Demo_EP_IdleRandMergInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c14_Demo_EP_IdleRandMerg
  (SFc14_Demo_EP_IdleRandMergInstanceStruct *chartInstance);
static void set_sim_state_c14_Demo_EP_IdleRandMerg
  (SFc14_Demo_EP_IdleRandMergInstanceStruct *chartInstance, const mxArray
   *c14_st);
static void finalize_c14_Demo_EP_IdleRandMerg
  (SFc14_Demo_EP_IdleRandMergInstanceStruct *chartInstance);
static void sf_gateway_c14_Demo_EP_IdleRandMerg
  (SFc14_Demo_EP_IdleRandMergInstanceStruct *chartInstance);
static void initSimStructsc14_Demo_EP_IdleRandMerg
  (SFc14_Demo_EP_IdleRandMergInstanceStruct *chartInstance);
...
static const mxArray *c14_sf_marshallOut(void *chartInstanceVoid, void
  *c14_inData);
static real_T c14_emlrt_marshallIn(SFc14_Demo_EP_IdleRandMergInstanceStruct
  *chartInstance, const mxArray *c14_a_trigW, const char_T *c14_identifier);
static real_T c14_b_emlrt_marshallIn(SFc14_Demo_EP_IdleRandMergInstanceStruct
...
static const mxArray *c14_c_sf_marshallOut(void *chartInstanceVoid, void
  *c14_inData);
static int32_T c14_c_emlrt_marshallIn(SFc14_Demo_EP_IdleRandMergInstanceStruct
  *chartInstance, const mxArray *c14_u, const emlrtMsgIdentifier *c14_parentId);
static void c14_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c14_mxArrayInData, const char_T *c14_varName, void *c14_outData);
static uint8_T c14_d_emlrt_marshallIn(SFc14_Demo_EP_IdleRandMergInstanceStruct
  *chartInstance, const mxArray *c14_b_is_active_c14_Demo_EP_IdleRandMerg, const
  char_T *c14_identifier);
static uint8_T c14_e_emlrt_marshallIn(SFc14_Demo_EP_IdleRandMergInstanceStruct
  *chartInstance, const mxArray *c14_u, const emlrtMsgIdentifier *c14_parentId);
static void init_dsm_address_info(SFc14_Demo_EP_IdleRandMergInstanceStruct
  *chartInstance);
  ...
  (SFc14_Demo_EP_IdleRandMergInstanceStruct *chartInstance)
{
  ...
  chartInstance->c14_is_active_c14_Demo_EP_IdleRandMerg = 0U;
}
  ...
  (SFc14_Demo_EP_IdleRandMergInstanceStruct *chartInstance)
{
  ...
  c14_c_hoistedGlobal = chartInstance->c14_is_active_c14_Demo_EP_IdleRandMerg;
   ...
   *c14_st)
{
  ...
  *c14_a_trigW = c14_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c14_u, 1)), "a_trigW");
  chartInstance->c14_is_active_c14_Demo_EP_IdleRandMerg = c14_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c14_u, 2)),
     "is_active_c14_Demo_EP_IdleRandMerg");
  sf_mex_destroy(&c14_u);
  c14_update_debugger_state_c14_Demo_EP_IdleRandMerg(chartInstance);
  ...
  *c14_inData)
{
  ...
  const mxArray *c14_y = NULL;
  SFc14_Demo_EP_IdleRandMergInstanceStruct *chartInstance;
  chartInstance = (SFc14_Demo_EP_IdleRandMergInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c14_Demo_EP_IdleRandMerg_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c14_identifier)
{
  ...
  c14_y = c14_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c14_b_is_active_c14_Demo_EP_IdleRandMerg), &c14_thisId);
  sf_mex_destroy(&c14_b_is_active_c14_Demo_EP_IdleRandMerg);
  return c14_y;
}
...
void sf_c14_Demo_EP_IdleRandMerg_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(52794385U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(4173699323U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1400160962U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3704488784U);
}

mxArray *sf_c14_Demo_EP_IdleRandMerg_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("4OXrhqwzt1bWB91QDOEPEC");
...
mxArray *sf_c14_Demo_EP_IdleRandMerg_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c14_Demo_EP_IdleRandMerg_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c14_Demo_EP_IdleRandMerg(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"a_trig\",},{M[1],M[8],T\"a_trigW\",},{M[8],M[0],T\"is_active_c14_Demo_EP_IdleRandMerg\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c14_Demo_EP_IdleRandMerg_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc14_Demo_EP_IdleRandMergInstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,1593);
        _SFD_CV_INIT_EML_IF(0,1,0,418,431,1420,1451);
        _SFD_CV_INIT_EML_IF(0,1,1,636,671,-1,717);
        _SFD_CV_INIT_EML_IF(0,1,2,726,762,-1,810);
        _SFD_CV_INIT_EML_IF(0,1,3,820,843,-1,915);
        _SFD_CV_INIT_EML_IF(0,1,4,924,947,-1,1019);
        _SFD_CV_INIT_EML_IF(0,1,5,1028,1051,-1,1125);
        _SFD_CV_INIT_EML_IF(0,1,6,1134,1157,-1,1227);
        _SFD_CV_INIT_EML_IF(0,1,7,1353,1370,-1,1415);
        _SFD_CV_INIT_EML_IF(0,1,8,1456,1469,1492,1593);
        _SFD_CV_INIT_EML_IF(0,1,9,1492,1509,1563,1593);

        {
          static int condStart[] = { 639, 656 };

          static int condEnd[] = { 652, 670 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,0,638,671,2,0,&(condStart[0]),&(condEnd[0]),
                                3,&(pfixExpr[0]));
        }

        {
          static int condStart[] = { 729, 747 };

          static int condEnd[] = { 743, 761 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,1,728,762,2,2,&(condStart[0]),&(condEnd[0]),
                                3,&(pfixExpr[0]));
        }
...
{
  return "mKaAFfUa9d6xgRXf4uQHPH";
}

static void sf_opaque_initialize_c14_Demo_EP_IdleRandMerg(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc14_Demo_EP_IdleRandMergInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c14_Demo_EP_IdleRandMerg
    ((SFc14_Demo_EP_IdleRandMergInstanceStruct*) chartInstanceVar);
  initialize_c14_Demo_EP_IdleRandMerg((SFc14_Demo_EP_IdleRandMergInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c14_Demo_EP_IdleRandMerg(void *chartInstanceVar)
{
  enable_c14_Demo_EP_IdleRandMerg((SFc14_Demo_EP_IdleRandMergInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c14_Demo_EP_IdleRandMerg(void *chartInstanceVar)
{
  disable_c14_Demo_EP_IdleRandMerg((SFc14_Demo_EP_IdleRandMergInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c14_Demo_EP_IdleRandMerg(void *chartInstanceVar)
{
  sf_gateway_c14_Demo_EP_IdleRandMerg((SFc14_Demo_EP_IdleRandMergInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c14_Demo_EP_IdleRandMerg
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c14_Demo_EP_IdleRandMerg
    ((SFc14_Demo_EP_IdleRandMergInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c14_Demo_EP_IdleRandMerg();/* state var info */
...
extern void sf_internal_set_sim_state_c14_Demo_EP_IdleRandMerg(SimStruct* S,
  const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c14_Demo_EP_IdleRandMerg();/* state var info */
  ...
  set_sim_state_c14_Demo_EP_IdleRandMerg
    ((SFc14_Demo_EP_IdleRandMergInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c14_Demo_EP_IdleRandMerg(SimStruct*
  S)
{
  return sf_internal_get_sim_state_c14_Demo_EP_IdleRandMerg(S);
}

static void sf_opaque_set_sim_state_c14_Demo_EP_IdleRandMerg(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c14_Demo_EP_IdleRandMerg(S, st);
}

static void sf_opaque_terminate_c14_Demo_EP_IdleRandMerg(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc14_Demo_EP_IdleRandMergInstanceStruct*) chartInstanceVar)
      ->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c14_Demo_EP_IdleRandMerg((SFc14_Demo_EP_IdleRandMergInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc14_Demo_EP_IdleRandMerg
    ((SFc14_Demo_EP_IdleRandMergInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c14_Demo_EP_IdleRandMerg(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c14_Demo_EP_IdleRandMerg(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(4141492158U));
  ssSetChecksum1(S,(2470395418U));
  ssSetChecksum2(S,(3342390706U));
  ssSetChecksum3(S,(1014394108U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c14_Demo_EP_IdleRandMerg(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c14_Demo_EP_IdleRandMerg(SimStruct *S)
{
  SFc14_Demo_EP_IdleRandMergInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc14_Demo_EP_IdleRandMergInstanceStruct *)utMalloc(sizeof
    (SFc14_Demo_EP_IdleRandMergInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc14_Demo_EP_IdleRandMergInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c14_Demo_EP_IdleRandMerg;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c14_Demo_EP_IdleRandMerg;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c14_Demo_EP_IdleRandMerg;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c14_Demo_EP_IdleRandMerg;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c14_Demo_EP_IdleRandMerg;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c14_Demo_EP_IdleRandMerg;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c14_Demo_EP_IdleRandMerg;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c14_Demo_EP_IdleRandMerg;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c14_Demo_EP_IdleRandMerg;
  chartInstance->chartInfo.mdlStart = mdlStart_c14_Demo_EP_IdleRandMerg;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c14_Demo_EP_IdleRandMerg;
...
void c14_Demo_EP_IdleRandMerg_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c14_Demo_EP_IdleRandMerg(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c14_Demo_EP_IdleRandMerg(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c14_Demo_EP_IdleRandMerg(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c14_Demo_EP_IdleRandMerg_method_dispatcher.\n"
