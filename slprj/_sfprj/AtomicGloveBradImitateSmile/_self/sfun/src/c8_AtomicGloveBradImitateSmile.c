...
static void initialize_c8_AtomicGloveBradImitateSmile
  (SFc8_AtomicGloveBradImitateSmileInstanceStruct *chartInstance);
static void initialize_params_c8_AtomicGloveBradImitateSmile
  (SFc8_AtomicGloveBradImitateSmileInstanceStruct *chartInstance);
static void enable_c8_AtomicGloveBradImitateSmile
  (SFc8_AtomicGloveBradImitateSmileInstanceStruct *chartInstance);
static void disable_c8_AtomicGloveBradImitateSmile
  (SFc8_AtomicGloveBradImitateSmileInstanceStruct *chartInstance);
static void c8_update_debugger_state_c8_AtomicGloveBradImitateSmile
  (SFc8_AtomicGloveBradImitateSmileInstanceStruct *chartInstance);
...
static void set_sim_state_c8_AtomicGloveBradImitateSmile
  (SFc8_AtomicGloveBradImitateSmileInstanceStruct *chartInstance, const mxArray *
   c8_st);
static void finalize_c8_AtomicGloveBradImitateSmile
  (SFc8_AtomicGloveBradImitateSmileInstanceStruct *chartInstance);
static void sf_gateway_c8_AtomicGloveBradImitateSmile
  (SFc8_AtomicGloveBradImitateSmileInstanceStruct *chartInstance);
static void initSimStructsc8_AtomicGloveBradImitateSmile
  (SFc8_AtomicGloveBradImitateSmileInstanceStruct *chartInstance);
...
static uint8_T c8_d_emlrt_marshallIn
  (SFc8_AtomicGloveBradImitateSmileInstanceStruct *chartInstance, const mxArray *
   c8_b_is_active_c8_AtomicGloveBradImitateSmile, const char_T *c8_identifier);
static uint8_T c8_e_emlrt_marshallIn
  (SFc8_AtomicGloveBradImitateSmileInstanceStruct *chartInstance, const mxArray *
   c8_u, const emlrtMsgIdentifier *c8_parentId);
static void init_dsm_address_info(SFc8_AtomicGloveBradImitateSmileInstanceStruct
  *chartInstance);
  ...
  (SFc8_AtomicGloveBradImitateSmileInstanceStruct *chartInstance)
{
  ...
  chartInstance->c8_is_active_c8_AtomicGloveBradImitateSmile = 0U;
}
   ...
   c8_b_is_active_c8_AtomicGloveBradImitateSmile, const char_T *c8_identifier)
{
  ...
  c8_y = c8_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c8_b_is_active_c8_AtomicGloveBradImitateSmile), &c8_thisId);
  sf_mex_destroy(&c8_b_is_active_c8_AtomicGloveBradImitateSmile);
  return c8_y;
}
...
void sf_c8_AtomicGloveBradImitateSmile_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c8_AtomicGloveBradImitateSmile_get_autoinheritance_info(void)
{
...
mxArray *sf_c8_AtomicGloveBradImitateSmile_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c8_AtomicGloveBradImitateSmile_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c8_AtomicGloveBradImitateSmile(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c8_AtomicGloveBradImitateSmile\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c8_AtomicGloveBradImitateSmile_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c8_AtomicGloveBradImitateSmile(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc8_AtomicGloveBradImitateSmileInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c8_AtomicGloveBradImitateSmile
    ((SFc8_AtomicGloveBradImitateSmileInstanceStruct*) chartInstanceVar);
  initialize_c8_AtomicGloveBradImitateSmile
    ((SFc8_AtomicGloveBradImitateSmileInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c8_AtomicGloveBradImitateSmile(void
  *chartInstanceVar)
{
  enable_c8_AtomicGloveBradImitateSmile
    ((SFc8_AtomicGloveBradImitateSmileInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c8_AtomicGloveBradImitateSmile(void
  *chartInstanceVar)
{
  disable_c8_AtomicGloveBradImitateSmile
    ((SFc8_AtomicGloveBradImitateSmileInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c8_AtomicGloveBradImitateSmile(void
  *chartInstanceVar)
{
  sf_gateway_c8_AtomicGloveBradImitateSmile
    ((SFc8_AtomicGloveBradImitateSmileInstanceStruct*) chartInstanceVar);
}
  ...
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c8_AtomicGloveBradImitateSmile
    ((SFc8_AtomicGloveBradImitateSmileInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c8_AtomicGloveBradImitateSmile();/* state var info */
...
extern void sf_internal_set_sim_state_c8_AtomicGloveBradImitateSmile(SimStruct*
  S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c8_AtomicGloveBradImitateSmile();/* state var info */
  ...
  set_sim_state_c8_AtomicGloveBradImitateSmile
    ((SFc8_AtomicGloveBradImitateSmileInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c8_AtomicGloveBradImitateSmile
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c8_AtomicGloveBradImitateSmile(S);
}

static void sf_opaque_set_sim_state_c8_AtomicGloveBradImitateSmile(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c8_AtomicGloveBradImitateSmile(S, st);
}

static void sf_opaque_terminate_c8_AtomicGloveBradImitateSmile(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc8_AtomicGloveBradImitateSmileInstanceStruct*)
                    chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c8_AtomicGloveBradImitateSmile
      ((SFc8_AtomicGloveBradImitateSmileInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc8_AtomicGloveBradImitateSmile
    ((SFc8_AtomicGloveBradImitateSmileInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c8_AtomicGloveBradImitateSmile(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c8_AtomicGloveBradImitateSmile(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c8_AtomicGloveBradImitateSmile(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c8_AtomicGloveBradImitateSmile(SimStruct *S)
{
  SFc8_AtomicGloveBradImitateSmileInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc8_AtomicGloveBradImitateSmileInstanceStruct *)utMalloc
    (sizeof(SFc8_AtomicGloveBradImitateSmileInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc8_AtomicGloveBradImitateSmileInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c8_AtomicGloveBradImitateSmile;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c8_AtomicGloveBradImitateSmile;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c8_AtomicGloveBradImitateSmile;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c8_AtomicGloveBradImitateSmile;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c8_AtomicGloveBradImitateSmile;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c8_AtomicGloveBradImitateSmile;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c8_AtomicGloveBradImitateSmile;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c8_AtomicGloveBradImitateSmile;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c8_AtomicGloveBradImitateSmile;
  chartInstance->chartInfo.mdlStart = mdlStart_c8_AtomicGloveBradImitateSmile;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c8_AtomicGloveBradImitateSmile;
...
void c8_AtomicGloveBradImitateSmile_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c8_AtomicGloveBradImitateSmile(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c8_AtomicGloveBradImitateSmile(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c8_AtomicGloveBradImitateSmile(S);
    break;
