...
#include "c1_AtomicGloveBradImitateSmile.h"
...
static void initialize_c1_AtomicGloveBradImitateSmile
  (SFc1_AtomicGloveBradImitateSmileInstanceStruct *chartInstance);
static void initialize_params_c1_AtomicGloveBradImitateSmile
  (SFc1_AtomicGloveBradImitateSmileInstanceStruct *chartInstance);
static void enable_c1_AtomicGloveBradImitateSmile
  (SFc1_AtomicGloveBradImitateSmileInstanceStruct *chartInstance);
static void disable_c1_AtomicGloveBradImitateSmile
  (SFc1_AtomicGloveBradImitateSmileInstanceStruct *chartInstance);
static void c1_update_debugger_state_c1_AtomicGloveBradImitateSmile
  (SFc1_AtomicGloveBradImitateSmileInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c1_AtomicGloveBradImitateSmile
  (SFc1_AtomicGloveBradImitateSmileInstanceStruct *chartInstance);
static void set_sim_state_c1_AtomicGloveBradImitateSmile
  (SFc1_AtomicGloveBradImitateSmileInstanceStruct *chartInstance, const mxArray *
   c1_st);
static void c1_set_sim_state_side_effects_c1_AtomicGloveBradImitateSmile
  (SFc1_AtomicGloveBradImitateSmileInstanceStruct *chartInstance);
static void finalize_c1_AtomicGloveBradImitateSmile
  (SFc1_AtomicGloveBradImitateSmileInstanceStruct *chartInstance);
static void sf_gateway_c1_AtomicGloveBradImitateSmile
  (SFc1_AtomicGloveBradImitateSmileInstanceStruct *chartInstance);
static void initSimStructsc1_AtomicGloveBradImitateSmile
  (SFc1_AtomicGloveBradImitateSmileInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber, uint32_T c1_instanceNumber);
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData);
static int8_T c1_emlrt_marshallIn(SFc1_AtomicGloveBradImitateSmileInstanceStruct
...
static uint8_T c1_c_emlrt_marshallIn
  (SFc1_AtomicGloveBradImitateSmileInstanceStruct *chartInstance, const mxArray *
   c1_b_tp_RPSGameImitateSmileBrad, const char_T *c1_identifier);
...
static const mxArray *c1_e_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_g_emlrt_marshallIn(SFc1_AtomicGloveBradImitateSmileInstanceStruct
  *chartInstance, const mxArray *c1_b_randomH, const char_T *c1_identifier,
  real_T c1_y[2]);
static void c1_h_emlrt_marshallIn(SFc1_AtomicGloveBradImitateSmileInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId,
  real_T c1_y[2]);
...
static const mxArray *c1_j_emlrt_marshallIn
  (SFc1_AtomicGloveBradImitateSmileInstanceStruct *chartInstance, const mxArray *
   c1_u, const emlrtMsgIdentifier *c1_parentId);
static real_T c1_get_BOREDOMT(SFc1_AtomicGloveBradImitateSmileInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_BOREDOMT(SFc1_AtomicGloveBradImitateSmileInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_BOREDOMT(SFc1_AtomicGloveBradImitateSmileInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_avert(SFc1_AtomicGloveBradImitateSmileInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_avert(SFc1_AtomicGloveBradImitateSmileInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_avert(SFc1_AtomicGloveBradImitateSmileInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_b(SFc1_AtomicGloveBradImitateSmileInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_b(SFc1_AtomicGloveBradImitateSmileInstanceStruct
                     *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_b(SFc1_AtomicGloveBradImitateSmileInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_bHand(SFc1_AtomicGloveBradImitateSmileInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_bHand(SFc1_AtomicGloveBradImitateSmileInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_bHand(SFc1_AtomicGloveBradImitateSmileInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_bored(SFc1_AtomicGloveBradImitateSmileInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_bored(SFc1_AtomicGloveBradImitateSmileInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_bored(SFc1_AtomicGloveBradImitateSmileInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_diff(SFc1_AtomicGloveBradImitateSmileInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_diff(SFc1_AtomicGloveBradImitateSmileInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_diff(SFc1_AtomicGloveBradImitateSmileInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_p(SFc1_AtomicGloveBradImitateSmileInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_p(SFc1_AtomicGloveBradImitateSmileInstanceStruct
                     *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_p(SFc1_AtomicGloveBradImitateSmileInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_pose(SFc1_AtomicGloveBradImitateSmileInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_pose(SFc1_AtomicGloveBradImitateSmileInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_pose(SFc1_AtomicGloveBradImitateSmileInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_r(SFc1_AtomicGloveBradImitateSmileInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_r(SFc1_AtomicGloveBradImitateSmileInstanceStruct
                     *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_r(SFc1_AtomicGloveBradImitateSmileInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_randomD(SFc1_AtomicGloveBradImitateSmileInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_randomD(SFc1_AtomicGloveBradImitateSmileInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_randomD(SFc1_AtomicGloveBradImitateSmileInstanceStruct *
  chartInstance, uint32_T c1_b);
static real_T c1_get_randomG(SFc1_AtomicGloveBradImitateSmileInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_randomG(SFc1_AtomicGloveBradImitateSmileInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_randomG(SFc1_AtomicGloveBradImitateSmileInstanceStruct *
  chartInstance, uint32_T c1_b);
static real_T c1_get_randomP(SFc1_AtomicGloveBradImitateSmileInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_randomP(SFc1_AtomicGloveBradImitateSmileInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_randomP(SFc1_AtomicGloveBradImitateSmileInstanceStruct *
  chartInstance, uint32_T c1_b);
static real_T c1_get_s(SFc1_AtomicGloveBradImitateSmileInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_s(SFc1_AtomicGloveBradImitateSmileInstanceStruct
                     *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_s(SFc1_AtomicGloveBradImitateSmileInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_smileN(SFc1_AtomicGloveBradImitateSmileInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_smileN(SFc1_AtomicGloveBradImitateSmileInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_smileN(SFc1_AtomicGloveBradImitateSmileInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_smileYN(SFc1_AtomicGloveBradImitateSmileInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_smileYN(SFc1_AtomicGloveBradImitateSmileInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_smileYN(SFc1_AtomicGloveBradImitateSmileInstanceStruct *
  chartInstance, uint32_T c1_b);
static real_T c1_get_temp(SFc1_AtomicGloveBradImitateSmileInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_temp(SFc1_AtomicGloveBradImitateSmileInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_temp(SFc1_AtomicGloveBradImitateSmileInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_uHand(SFc1_AtomicGloveBradImitateSmileInstanceStruct
  *chartInstance, uint32_T c1_b);
static void c1_set_uHand(SFc1_AtomicGloveBradImitateSmileInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_uHand(SFc1_AtomicGloveBradImitateSmileInstanceStruct
  *chartInstance, uint32_T c1_b);
static real_T c1_get_wristRotate(SFc1_AtomicGloveBradImitateSmileInstanceStruct *
  chartInstance, uint32_T c1_b);
static void c1_set_wristRotate(SFc1_AtomicGloveBradImitateSmileInstanceStruct
  *chartInstance, uint32_T c1_b, real_T c1_c);
static real_T *c1_access_wristRotate
  (SFc1_AtomicGloveBradImitateSmileInstanceStruct *chartInstance, uint32_T c1_b);
static void init_dsm_address_info(SFc1_AtomicGloveBradImitateSmileInstanceStruct
  *chartInstance);
  ...
  (SFc1_AtomicGloveBradImitateSmileInstanceStruct *chartInstance)
{
  ...
  sf_exported_auto_initc7_AtomicGloveBradImitateSmile
    (chartInstance->c1_subchartSimstruct);
  sf_exported_auto_initc6_AtomicGloveBradImitateSmile
    (chartInstance->c1_b_subchartSimstruct);
  sf_exported_auto_initc5_AtomicGloveBradImitateSmile
    (chartInstance->c1_c_subchartSimstruct);
  sf_exported_auto_initc4_AtomicGloveBradImitateSmile
  ...
  chartInstance->c1_is_active_c1_AtomicGloveBradImitateSmile = 0U;
  ...
  (SFc1_AtomicGloveBradImitateSmileInstanceStruct *chartInstance)
{
  ...
  if (chartInstance->c1_is_active_RPSGameImitateSmileBrad == 1U) {
    sf_exported_auto_enablec7_AtomicGloveBradImitateSmile
      (chartInstance->c1_subchartSimstruct);
  }

  if (chartInstance->c1_is_active_idleGaze == 1U) {
    sf_exported_auto_enablec6_AtomicGloveBradImitateSmile
      (chartInstance->c1_b_subchartSimstruct);
  }

  if (chartInstance->c1_is_active_idlePoseBrad == 1U) {
    sf_exported_auto_enablec5_AtomicGloveBradImitateSmile
      (chartInstance->c1_c_subchartSimstruct);
  }

  if (chartInstance->c1_is_active_smile == 1U) {
    sf_exported_auto_enablec4_AtomicGloveBradImitateSmile
      (chartInstance->c1_d_subchartSimstruct);
  }
}
  ...
  (SFc1_AtomicGloveBradImitateSmileInstanceStruct *chartInstance)
{
  _sfTime_ = sf_get_time(chartInstance->S);
  if (chartInstance->c1_is_active_RPSGameImitateSmileBrad == 1U) {
    sf_exported_auto_disablec7_AtomicGloveBradImitateSmile
      (chartInstance->c1_subchartSimstruct);
  }

  if (chartInstance->c1_is_active_idleGaze == 1U) {
    sf_exported_auto_disablec6_AtomicGloveBradImitateSmile
      (chartInstance->c1_b_subchartSimstruct);
  }

  if (chartInstance->c1_is_active_idlePoseBrad == 1U) {
    sf_exported_auto_disablec5_AtomicGloveBradImitateSmile
      (chartInstance->c1_c_subchartSimstruct);
  }

  if (chartInstance->c1_is_active_smile == 1U) {
    sf_exported_auto_disablec4_AtomicGloveBradImitateSmile
      (chartInstance->c1_d_subchartSimstruct);
  }
}
  ...
  (SFc1_AtomicGloveBradImitateSmileInstanceStruct *chartInstance)
{
  ...
  if (chartInstance->c1_is_active_c1_AtomicGloveBradImitateSmile == 1U) {
  ...
  (SFc1_AtomicGloveBradImitateSmileInstanceStruct *chartInstance)
{
  ...
  for (c1_i0 = 0; c1_i0 < 2; c1_i0++) {
    c1_s_u[c1_i0] = chartInstance->c1_randomH[c1_i0];
  }

  c1_t_y = NULL;
  sf_mex_assign(&c1_t_y, sf_mex_create("y", c1_s_u, 0, 0U, 1U, 0U, 1, 2), false);
  ...
  c1_bb_hoistedGlobal = chartInstance->c1_is_active_smile;
  ...
  c1_cb_hoistedGlobal = chartInstance->c1_is_active_idlePoseBrad;
  ...
  c1_db_hoistedGlobal = chartInstance->c1_is_active_idleGaze;
  ...
  c1_eb_hoistedGlobal = chartInstance->c1_is_active_RPSGameImitateSmileBrad;
  ...
  c1_gb_u = sf_mex_dup(c1_d_subchartSimStateInfo);
  c1_hb_y = NULL;
  sf_mex_assign(&c1_hb_y, sf_mex_duplicatearraysafe(&c1_gb_u), false);
  sf_mex_destroy(&c1_gb_u);
  sf_mex_setcell(c1_y, 31, c1_hb_y);
  c1_hb_u = sf_mex_dup(c1_c_subchartSimStateInfo);
  c1_ib_y = NULL;
  sf_mex_assign(&c1_ib_y, sf_mex_duplicatearraysafe(&c1_hb_u), false);
  sf_mex_destroy(&c1_hb_u);
  sf_mex_setcell(c1_y, 32, c1_ib_y);
  c1_ib_u = sf_mex_dup(c1_b_subchartSimStateInfo);
  c1_jb_y = NULL;
  sf_mex_assign(&c1_jb_y, sf_mex_duplicatearraysafe(&c1_ib_u), false);
  sf_mex_destroy(&c1_ib_u);
  sf_mex_setcell(c1_y, 33, c1_jb_y);
  c1_jb_u = sf_mex_dup(c1_subchartSimStateInfo);
  c1_kb_y = NULL;
   ...
   c1_st)
{
  ...
  *c1_win = c1_e_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u,
  ...
  c1_set_randomD(chartInstance, 0, c1_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c1_u, 16)), "randomD"));
  c1_set_randomG(chartInstance, 0, c1_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c1_u, 17)), "randomG"));
  ...
  c1_set_randomP(chartInstance, 0, c1_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c1_u, 19)), "randomP"));
  ...
  c1_set_smileN(chartInstance, 0, c1_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c1_u, 21)), "smileN"));
  c1_set_smileYN(chartInstance, 0, c1_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c1_u, 22)), "smileYN"));
  ...
  chartInstance->c1_is_active_c1_AtomicGloveBradImitateSmile =
    c1_c_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 26)),
    "is_active_c1_AtomicGloveBradImitateSmile");
  chartInstance->c1_is_active_smile = c1_c_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c1_u, 27)), "is_active_smile");
  chartInstance->c1_is_active_idlePoseBrad = c1_c_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c1_u, 28)), "is_active_idlePoseBrad");
  chartInstance->c1_is_active_idleGaze = c1_c_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c1_u, 29)), "is_active_idleGaze");
  ...
  sf_mex_assign(&c1_d_subchartSimStateInfo, c1_i_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c1_u, 31)), "subchartSimStateInfo"), true);
  ...
  c1_update_debugger_state_c1_AtomicGloveBradImitateSmile(chartInstance);
  sf_exported_auto_setSimstatec7_AtomicGloveBradImitateSmile
    (chartInstance->c1_subchartSimstruct, sf_mex_dup(c1_subchartSimStateInfo));
  sf_exported_auto_setSimstatec6_AtomicGloveBradImitateSmile
    (chartInstance->c1_b_subchartSimstruct, sf_mex_dup(c1_b_subchartSimStateInfo));
  sf_exported_auto_setSimstatec5_AtomicGloveBradImitateSmile
    (chartInstance->c1_c_subchartSimstruct, sf_mex_dup(c1_c_subchartSimStateInfo));
  sf_exported_auto_setSimstatec4_AtomicGloveBradImitateSmile
  ...
  (SFc1_AtomicGloveBradImitateSmileInstanceStruct *chartInstance)
{
  ...
  c1_gameState = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c1_set_sim_state_side_effects_c1_AtomicGloveBradImitateSmile(chartInstance);
  _SFD_SYMBOL_SCOPE_PUSH(0U, 0U);
  _sfTime_ = sf_get_time(chartInstance->S);
  sf_exported_auto_gatewayc7_AtomicGloveBradImitateSmile
    (chartInstance->c1_subchartSimstruct);
  sf_exported_auto_gatewayc6_AtomicGloveBradImitateSmile
    (chartInstance->c1_b_subchartSimstruct);
  sf_exported_auto_gatewayc5_AtomicGloveBradImitateSmile
    (chartInstance->c1_c_subchartSimstruct);
  sf_exported_auto_gatewayc4_AtomicGloveBradImitateSmile
    (chartInstance->c1_d_subchartSimstruct);
  ...
  _SFD_DATA_RANGE_CHECK(*c1_pSmile, 26U);
  _SFD_DATA_RANGE_CHECK(c1_get_avert(chartInstance, 0), 27U);
  sf_exported_auto_activate_c7_AtomicGloveBradImitateSmile_secs
    (chartInstance->c1_subchartSimstruct);
  sf_exported_auto_activate_c6_AtomicGloveBradImitateSmile_secs
    (chartInstance->c1_b_subchartSimstruct);
  sf_exported_auto_activate_c5_AtomicGloveBradImitateSmile_secs
    (chartInstance->c1_c_subchartSimstruct);
  sf_exported_auto_activate_callc4_AtomicGloveBradImitateSmile
    (chartInstance->c1_d_subchartSimstruct);
  ...
  sf_exported_auto_stepBuffersc7_AtomicGloveBradImitateSmile
    (chartInstance->c1_subchartSimstruct);
  sf_exported_auto_stepBuffersc6_AtomicGloveBradImitateSmile
    (chartInstance->c1_b_subchartSimstruct);
  sf_exported_auto_stepBuffersc5_AtomicGloveBradImitateSmile
    (chartInstance->c1_c_subchartSimstruct);
  sf_exported_auto_stepBuffersc4_AtomicGloveBradImitateSmile
    (chartInstance->c1_d_subchartSimstruct);
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 0U, chartInstance->c1_sfEvent);
  if (chartInstance->c1_is_active_c1_AtomicGloveBradImitateSmile == 0U) {
    sf_exported_auto_initBuffersc7_AtomicGloveBradImitateSmile
      (chartInstance->c1_subchartSimstruct);
    sf_exported_auto_initBuffersc6_AtomicGloveBradImitateSmile
      (chartInstance->c1_b_subchartSimstruct);
    sf_exported_auto_initBuffersc5_AtomicGloveBradImitateSmile
      (chartInstance->c1_c_subchartSimstruct);
    sf_exported_auto_initBuffersc4_AtomicGloveBradImitateSmile
      (chartInstance->c1_d_subchartSimstruct);
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 0U, chartInstance->c1_sfEvent);
    chartInstance->c1_is_active_c1_AtomicGloveBradImitateSmile = 1U;
    _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 0U, chartInstance->c1_sfEvent);
    chartInstance->c1_is_active_RPSGameImitateSmileBrad = 1U;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, chartInstance->c1_sfEvent);
    chartInstance->c1_tp_RPSGameImitateSmileBrad = 1U;
    sf_exported_auto_enterc7_AtomicGloveBradImitateSmile
      (chartInstance->c1_subchartSimstruct);
    chartInstance->c1_is_active_idleGaze = 1U;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, chartInstance->c1_sfEvent);
    chartInstance->c1_tp_idleGaze = 1U;
    sf_exported_auto_enterc6_AtomicGloveBradImitateSmile
      (chartInstance->c1_b_subchartSimstruct);
    chartInstance->c1_is_active_idlePoseBrad = 1U;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 2U, chartInstance->c1_sfEvent);
    chartInstance->c1_tp_idlePoseBrad = 1U;
    sf_exported_auto_enterc5_AtomicGloveBradImitateSmile
      (chartInstance->c1_c_subchartSimstruct);
    chartInstance->c1_is_active_smile = 1U;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 3U, chartInstance->c1_sfEvent);
    chartInstance->c1_tp_smile = 1U;
    sf_exported_auto_enterc4_AtomicGloveBradImitateSmile
      (chartInstance->c1_d_subchartSimstruct);
  } else {
    _SFD_CS_CALL(STATE_ENTER_DURING_FUNCTION_TAG, 0U, chartInstance->c1_sfEvent);
    sf_exported_auto_duringc7_AtomicGloveBradImitateSmile
      (chartInstance->c1_subchartSimstruct);
    _SFD_CS_CALL(EXIT_OUT_OF_FUNCTION_TAG, 0U, chartInstance->c1_sfEvent);
    _SFD_CS_CALL(STATE_ENTER_DURING_FUNCTION_TAG, 1U, chartInstance->c1_sfEvent);
    sf_exported_auto_duringc6_AtomicGloveBradImitateSmile
      (chartInstance->c1_b_subchartSimstruct);
    _SFD_CS_CALL(EXIT_OUT_OF_FUNCTION_TAG, 1U, chartInstance->c1_sfEvent);
    _SFD_CS_CALL(STATE_ENTER_DURING_FUNCTION_TAG, 2U, chartInstance->c1_sfEvent);
    sf_exported_auto_duringc5_AtomicGloveBradImitateSmile
      (chartInstance->c1_c_subchartSimstruct);
    _SFD_CS_CALL(EXIT_OUT_OF_FUNCTION_TAG, 2U, chartInstance->c1_sfEvent);
    _SFD_CS_CALL(STATE_ENTER_DURING_FUNCTION_TAG, 3U, chartInstance->c1_sfEvent);
    sf_exported_auto_duringc4_AtomicGloveBradImitateSmile
      (chartInstance->c1_d_subchartSimstruct);
  ...
  sf_exported_auto_resetTemporalCounter_c5_AtomicGloveBradImitateSmile_secs
    (chartInstance->c1_c_subchartSimstruct);
  sf_exported_auto_deactivate_c7_AtomicGloveBradImitateSmile_secs
    (chartInstance->c1_subchartSimstruct);
  sf_exported_auto_deactivate_c6_AtomicGloveBradImitateSmile_secs
    (chartInstance->c1_b_subchartSimstruct);
  sf_exported_auto_deactivate_c5_AtomicGloveBradImitateSmile_secs
    (chartInstance->c1_c_subchartSimstruct);
  sf_exported_auto_deactivate_callc4_AtomicGloveBradImitateSmile
    (chartInstance->c1_d_subchartSimstruct);
...
const mxArray *sf_c1_AtomicGloveBradImitateSmile_get_eml_resolved_functions_info
  (void)
{
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  const mxArray *c1_y = NULL;
  SFc1_AtomicGloveBradImitateSmileInstanceStruct *chartInstance;
  chartInstance = (SFc1_AtomicGloveBradImitateSmileInstanceStruct *)
    chartInstanceVoid;
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_BOREDOMT_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'BOREDOMT\' (#250) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_avert_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'avert\' (#264) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_b_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'b\' (#254) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_bHand_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'bHand\' (#245) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_bored_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'bored\' (#249) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_diff_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'diff\' (#243) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_p_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'p\' (#256) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_pose_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'pose\' (#253) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_r_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'r\' (#255) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_randomD_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'randomD\' (#258) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_randomG_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'randomG\' (#251) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_randomP_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'randomP\' (#252) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_s_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'s\' (#257) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_smileN_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'smileN\' (#262) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_smileYN_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'smileYN\' (#248) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_temp_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'temp\' (#242) in the initialization routine of the chart.\n");
  }
  ...
  *chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_uHand_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'uHand\' (#244) in the initialization routine of the chart.\n");
  }
  ...
  chartInstance, uint32_T c1_b)
{
  ...
  if (chartInstance->c1_wristRotate_address == 0) {
    sf_mex_error_message("Invalid access to Data Store Memory data \'wristRotate\' (#259) in the initialization routine of the chart.\n");
  }
...
void sf_c1_AtomicGloveBradImitateSmile_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(753125014U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2180859931U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2083336603U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3449330875U);
}

mxArray *sf_c1_AtomicGloveBradImitateSmile_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("IqIvJIC0VDeXPHEf3UedaH");
...
mxArray *sf_c1_AtomicGloveBradImitateSmile_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c1_AtomicGloveBradImitateSmile_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c1_AtomicGloveBradImitateSmile(void)
{
  ...
  const char *infoEncStr[] = {
    ...
    "100 S1x10'type','srcId','name','auxInfo'{{M[3],M[661],T\"s\",},{M[3],M[754],T\"smileN\",},{M[3],M[566],T\"smileYN\",},{M[3],M[460],T\"temp\",},{M[3],M[467],T\"uHand\",},{M[3],M[689],T\"wristRotate\",},{M[8],M[0],T\"is_active_c1_AtomicGloveBradImitateSmile\",},{M[8],M[750],T\"is_active_smile\",},{M[8],M[751],T\"is_active_idlePoseBrad\",},{M[8],M[752],T\"is_active_idleGaze\",}}",
    "100 S1x5'type','srcId','name','auxInfo'{{M[8],M[753],T\"is_active_RPSGameImitateSmileBrad\",},{M[14],M[750],T\"subchartSimStateInfo\",},{M[14],M[751],T\"subchartSimStateInfo\",},{M[14],M[752],T\"subchartSimStateInfo\",},{M[14],M[753],T\"subchartSimStateInfo\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 35, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_AtomicGloveBradImitateSmile_get_check_sum(&mxChecksum);
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          _SFD_SET_DATA_PROPS(26,1,1,0,"pSmile");
...

        {
          ...
          _SFD_SET_DATA_VALUE_PTR(26U, c1_pSmile);
...
{
  return "vixzFaKzYCvBHZ2MGEBqdH";
}

static void sf_opaque_initialize_c1_AtomicGloveBradImitateSmile(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_AtomicGloveBradImitateSmileInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c1_AtomicGloveBradImitateSmile
    ((SFc1_AtomicGloveBradImitateSmileInstanceStruct*) chartInstanceVar);
  initialize_c1_AtomicGloveBradImitateSmile
    ((SFc1_AtomicGloveBradImitateSmileInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c1_AtomicGloveBradImitateSmile(void
  *chartInstanceVar)
{
  enable_c1_AtomicGloveBradImitateSmile
    ((SFc1_AtomicGloveBradImitateSmileInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c1_AtomicGloveBradImitateSmile(void
  *chartInstanceVar)
{
  disable_c1_AtomicGloveBradImitateSmile
    ((SFc1_AtomicGloveBradImitateSmileInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c1_AtomicGloveBradImitateSmile(void
  *chartInstanceVar)
{
  sf_gateway_c1_AtomicGloveBradImitateSmile
    ((SFc1_AtomicGloveBradImitateSmileInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c1_AtomicGloveBradImitateSmile
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_AtomicGloveBradImitateSmile
    ((SFc1_AtomicGloveBradImitateSmileInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_AtomicGloveBradImitateSmile();/* state var info */
...
extern void sf_internal_set_sim_state_c1_AtomicGloveBradImitateSmile(SimStruct*
  S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c1_AtomicGloveBradImitateSmile();/* state var info */
  ...
  set_sim_state_c1_AtomicGloveBradImitateSmile
    ((SFc1_AtomicGloveBradImitateSmileInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c1_AtomicGloveBradImitateSmile
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c1_AtomicGloveBradImitateSmile(S);
}

static void sf_opaque_set_sim_state_c1_AtomicGloveBradImitateSmile(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c1_AtomicGloveBradImitateSmile(S, st);
}

static void sf_opaque_terminate_c1_AtomicGloveBradImitateSmile(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_AtomicGloveBradImitateSmileInstanceStruct*)
                    chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c1_AtomicGloveBradImitateSmile
      ((SFc1_AtomicGloveBradImitateSmileInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc1_AtomicGloveBradImitateSmile
    ((SFc1_AtomicGloveBradImitateSmileInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_AtomicGloveBradImitateSmile(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c1_AtomicGloveBradImitateSmile(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(1987580451U));
  ssSetChecksum1(S,(820165393U));
  ssSetChecksum2(S,(3401608408U));
  ssSetChecksum3(S,(2254792784U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c1_AtomicGloveBradImitateSmile(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_AtomicGloveBradImitateSmile(SimStruct *S)
{
  SFc1_AtomicGloveBradImitateSmileInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc1_AtomicGloveBradImitateSmileInstanceStruct *)utMalloc
    (sizeof(SFc1_AtomicGloveBradImitateSmileInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc1_AtomicGloveBradImitateSmileInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c1_AtomicGloveBradImitateSmile;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c1_AtomicGloveBradImitateSmile;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c1_AtomicGloveBradImitateSmile;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c1_AtomicGloveBradImitateSmile;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c1_AtomicGloveBradImitateSmile;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c1_AtomicGloveBradImitateSmile;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c1_AtomicGloveBradImitateSmile;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_AtomicGloveBradImitateSmile;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_AtomicGloveBradImitateSmile;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_AtomicGloveBradImitateSmile;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c1_AtomicGloveBradImitateSmile;
...
void c1_AtomicGloveBradImitateSmile_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_AtomicGloveBradImitateSmile(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_AtomicGloveBradImitateSmile(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_AtomicGloveBradImitateSmile(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_AtomicGloveBradImitateSmile_method_dispatcher.\n"
