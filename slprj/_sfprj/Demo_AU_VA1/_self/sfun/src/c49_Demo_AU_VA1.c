...
static void initialize_c49_Demo_AU_VA1(SFc49_Demo_AU_VA1InstanceStruct
  *chartInstance);
static void initialize_params_c49_Demo_AU_VA1(SFc49_Demo_AU_VA1InstanceStruct
  *chartInstance);
static void enable_c49_Demo_AU_VA1(SFc49_Demo_AU_VA1InstanceStruct
  *chartInstance);
static void disable_c49_Demo_AU_VA1(SFc49_Demo_AU_VA1InstanceStruct
  *chartInstance);
static void c49_update_debugger_state_c49_Demo_AU_VA1
  (SFc49_Demo_AU_VA1InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c49_Demo_AU_VA1
  (SFc49_Demo_AU_VA1InstanceStruct *chartInstance);
static void set_sim_state_c49_Demo_AU_VA1(SFc49_Demo_AU_VA1InstanceStruct
  *chartInstance, const mxArray *c49_st);
static void finalize_c49_Demo_AU_VA1(SFc49_Demo_AU_VA1InstanceStruct
  *chartInstance);
static void sf_gateway_c49_Demo_AU_VA1(SFc49_Demo_AU_VA1InstanceStruct
  *chartInstance);
static void initSimStructsc49_Demo_AU_VA1(SFc49_Demo_AU_VA1InstanceStruct
  *chartInstance);
...
static real_T c49_fopen(SFc49_Demo_AU_VA1InstanceStruct *chartInstance);
static real_T c49_fileManager(SFc49_Demo_AU_VA1InstanceStruct *chartInstance);
static void c49_fclose(SFc49_Demo_AU_VA1InstanceStruct *chartInstance, real_T
  c49_fileID);
static int32_T c49_b_fileManager(SFc49_Demo_AU_VA1InstanceStruct *chartInstance,
  real_T c49_varargin_1);
static real_T c49_emlrt_marshallIn(SFc49_Demo_AU_VA1InstanceStruct
  *chartInstance, const mxArray *c49_feval, const char_T *c49_identifier);
static real_T c49_b_emlrt_marshallIn(SFc49_Demo_AU_VA1InstanceStruct
  *chartInstance, const mxArray *c49_u, const emlrtMsgIdentifier *c49_parentId);
static boolean_T c49_c_emlrt_marshallIn(SFc49_Demo_AU_VA1InstanceStruct
  *chartInstance, const mxArray *c49_failp, const char_T *c49_identifier);
static boolean_T c49_d_emlrt_marshallIn(SFc49_Demo_AU_VA1InstanceStruct
  *chartInstance, const mxArray *c49_u, const emlrtMsgIdentifier *c49_parentId);
static const mxArray *c49_c_sf_marshallOut(void *chartInstanceVoid, void
  *c49_inData);
static int32_T c49_e_emlrt_marshallIn(SFc49_Demo_AU_VA1InstanceStruct
  *chartInstance, const mxArray *c49_u, const emlrtMsgIdentifier *c49_parentId);
static void c49_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c49_mxArrayInData, const char_T *c49_varName, void *c49_outData);
static uint8_T c49_f_emlrt_marshallIn(SFc49_Demo_AU_VA1InstanceStruct
  *chartInstance, const mxArray *c49_b_is_active_c49_Demo_AU_VA1, const char_T
  *c49_identifier);
static uint8_T c49_g_emlrt_marshallIn(SFc49_Demo_AU_VA1InstanceStruct
  *chartInstance, const mxArray *c49_u, const emlrtMsgIdentifier *c49_parentId);
static void init_dsm_address_info(SFc49_Demo_AU_VA1InstanceStruct *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c49_is_active_c49_Demo_AU_VA1 = 0U;
}
  ...
  (SFc49_Demo_AU_VA1InstanceStruct *chartInstance)
{
  ...
  c49_hoistedGlobal = chartInstance->c49_is_active_c49_Demo_AU_VA1;
  ...
  *chartInstance, const mxArray *c49_st)
{
  ...
  chartInstance->c49_is_active_c49_Demo_AU_VA1 = c49_f_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c49_u, 0)),
     "is_active_c49_Demo_AU_VA1");
  sf_mex_destroy(&c49_u);
  c49_update_debugger_state_c49_Demo_AU_VA1(chartInstance);
  ...
  *chartInstance)
{
  ...
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 10U, chartInstance->c49_sfEvent);
  _SFD_DATA_RANGE_CHECK(*c49_b_v, 0U);
  _SFD_DATA_RANGE_CHECK(*c49_b_a, 1U);
  chartInstance->c49_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 10U, chartInstance->c49_sfEvent);
  ...
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 10U, chartInstance->c49_sfEvent);
  _SFD_SYMBOL_SCOPE_POP();
  ...
  *c49_inData)
{
  ...
  const mxArray *c49_y = NULL;
  SFc49_Demo_AU_VA1InstanceStruct *chartInstance;
  chartInstance = (SFc49_Demo_AU_VA1InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c49_Demo_AU_VA1_get_eml_resolved_functions_info(void)
{
  ...
  *c49_identifier)
{
  ...
  c49_y = c49_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c49_b_is_active_c49_Demo_AU_VA1), &c49_thisId);
  sf_mex_destroy(&c49_b_is_active_c49_Demo_AU_VA1);
  return c49_y;
}
...
void sf_c49_Demo_AU_VA1_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c49_Demo_AU_VA1_get_autoinheritance_info(void)
{
...
mxArray *sf_c49_Demo_AU_VA1_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c49_Demo_AU_VA1_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c49_Demo_AU_VA1(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S'type','srcId','name','auxInfo'{{M[8],M[0],T\"is_active_c49_Demo_AU_VA1\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 1, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c49_Demo_AU_VA1_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc49_Demo_AU_VA1InstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c49_Demo_AU_VA1(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc49_Demo_AU_VA1InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c49_Demo_AU_VA1((SFc49_Demo_AU_VA1InstanceStruct*)
    chartInstanceVar);
  initialize_c49_Demo_AU_VA1((SFc49_Demo_AU_VA1InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c49_Demo_AU_VA1(void *chartInstanceVar)
{
  enable_c49_Demo_AU_VA1((SFc49_Demo_AU_VA1InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c49_Demo_AU_VA1(void *chartInstanceVar)
{
  disable_c49_Demo_AU_VA1((SFc49_Demo_AU_VA1InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c49_Demo_AU_VA1(void *chartInstanceVar)
{
  sf_gateway_c49_Demo_AU_VA1((SFc49_Demo_AU_VA1InstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c49_Demo_AU_VA1(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c49_Demo_AU_VA1
    ((SFc49_Demo_AU_VA1InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c49_Demo_AU_VA1();/* state var info */
...
extern void sf_internal_set_sim_state_c49_Demo_AU_VA1(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c49_Demo_AU_VA1();/* state var info */
  ...
  set_sim_state_c49_Demo_AU_VA1((SFc49_Demo_AU_VA1InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c49_Demo_AU_VA1(SimStruct* S)
{
  return sf_internal_get_sim_state_c49_Demo_AU_VA1(S);
}

static void sf_opaque_set_sim_state_c49_Demo_AU_VA1(SimStruct* S, const mxArray *
  st)
{
  sf_internal_set_sim_state_c49_Demo_AU_VA1(S, st);
}

static void sf_opaque_terminate_c49_Demo_AU_VA1(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc49_Demo_AU_VA1InstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c49_Demo_AU_VA1((SFc49_Demo_AU_VA1InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc49_Demo_AU_VA1((SFc49_Demo_AU_VA1InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c49_Demo_AU_VA1(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c49_Demo_AU_VA1(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c49_Demo_AU_VA1(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c49_Demo_AU_VA1(SimStruct *S)
{
  SFc49_Demo_AU_VA1InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc49_Demo_AU_VA1InstanceStruct *)utMalloc(sizeof
    (SFc49_Demo_AU_VA1InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc49_Demo_AU_VA1InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c49_Demo_AU_VA1;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c49_Demo_AU_VA1;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c49_Demo_AU_VA1;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c49_Demo_AU_VA1;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c49_Demo_AU_VA1;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c49_Demo_AU_VA1;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c49_Demo_AU_VA1;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c49_Demo_AU_VA1;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c49_Demo_AU_VA1;
  chartInstance->chartInfo.mdlStart = mdlStart_c49_Demo_AU_VA1;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c49_Demo_AU_VA1;
...
void c49_Demo_AU_VA1_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c49_Demo_AU_VA1(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c49_Demo_AU_VA1(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c49_Demo_AU_VA1(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c49_Demo_AU_VA1_method_dispatcher.\n"
