...
static void initialize_c14_Demo_AU_VA1(SFc14_Demo_AU_VA1InstanceStruct
  *chartInstance);
static void initialize_params_c14_Demo_AU_VA1(SFc14_Demo_AU_VA1InstanceStruct
  *chartInstance);
static void enable_c14_Demo_AU_VA1(SFc14_Demo_AU_VA1InstanceStruct
  *chartInstance);
static void disable_c14_Demo_AU_VA1(SFc14_Demo_AU_VA1InstanceStruct
  *chartInstance);
static void c14_update_debugger_state_c14_Demo_AU_VA1
  (SFc14_Demo_AU_VA1InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c14_Demo_AU_VA1
  (SFc14_Demo_AU_VA1InstanceStruct *chartInstance);
static void set_sim_state_c14_Demo_AU_VA1(SFc14_Demo_AU_VA1InstanceStruct
  *chartInstance, const mxArray *c14_st);
static void finalize_c14_Demo_AU_VA1(SFc14_Demo_AU_VA1InstanceStruct
  *chartInstance);
static void sf_gateway_c14_Demo_AU_VA1(SFc14_Demo_AU_VA1InstanceStruct
  *chartInstance);
static void initSimStructsc14_Demo_AU_VA1(SFc14_Demo_AU_VA1InstanceStruct
  *chartInstance);
...
static const mxArray *c14_sf_marshallOut(void *chartInstanceVoid, void
  *c14_inData);
static real_T c14_emlrt_marshallIn(SFc14_Demo_AU_VA1InstanceStruct
  *chartInstance, const mxArray *c14_a_trigW, const char_T *c14_identifier);
static real_T c14_b_emlrt_marshallIn(SFc14_Demo_AU_VA1InstanceStruct
...
static const mxArray *c14_b_sf_marshallOut(void *chartInstanceVoid, void
  *c14_inData);
static int32_T c14_c_emlrt_marshallIn(SFc14_Demo_AU_VA1InstanceStruct
  *chartInstance, const mxArray *c14_u, const emlrtMsgIdentifier *c14_parentId);
static void c14_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c14_mxArrayInData, const char_T *c14_varName, void *c14_outData);
static uint8_T c14_d_emlrt_marshallIn(SFc14_Demo_AU_VA1InstanceStruct
  *chartInstance, const mxArray *c14_b_is_active_c14_Demo_AU_VA1, const char_T
  *c14_identifier);
static uint8_T c14_e_emlrt_marshallIn(SFc14_Demo_AU_VA1InstanceStruct
  *chartInstance, const mxArray *c14_u, const emlrtMsgIdentifier *c14_parentId);
static void init_dsm_address_info(SFc14_Demo_AU_VA1InstanceStruct *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c14_is_active_c14_Demo_AU_VA1 = 0U;
}
  ...
  (SFc14_Demo_AU_VA1InstanceStruct *chartInstance)
{
  ...
  c14_c_hoistedGlobal = chartInstance->c14_is_active_c14_Demo_AU_VA1;
  ...
  *chartInstance, const mxArray *c14_st)
{
  ...
  *c14_a_trigW = c14_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c14_u, 1)), "a_trigW");
  chartInstance->c14_is_active_c14_Demo_AU_VA1 = c14_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c14_u, 2)),
     "is_active_c14_Demo_AU_VA1");
  sf_mex_destroy(&c14_u);
  c14_update_debugger_state_c14_Demo_AU_VA1(chartInstance);
  ...
  *chartInstance)
{
  ...
  c14_b_vaFlag = (real_T *)ssGetInputPortSignal(chartInstance->S, 2);
  ...
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 2U, chartInstance->c14_sfEvent);
  _SFD_DATA_RANGE_CHECK(*c14_b_userInvade, 0U);
  _SFD_DATA_RANGE_CHECK(*c14_b_interactionState, 1U);
  chartInstance->c14_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 2U, chartInstance->c14_sfEvent);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML(&c14_vaFlag, 5U, c14_sf_marshallOut);
  ...
  if (CV_EML_IF(0, 1, 0, c14_vaFlag == 1.0)) {
  ...
  *c14_b_a_trigW = c14_a_trigW;
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 2U, chartInstance->c14_sfEvent);
  _SFD_SYMBOL_SCOPE_POP();
  ...
  _SFD_DATA_RANGE_CHECK(*c14_b_vaFlag, 4U);
  ...
  *c14_inData)
{
  ...
  const mxArray *c14_y = NULL;
  SFc14_Demo_AU_VA1InstanceStruct *chartInstance;
  chartInstance = (SFc14_Demo_AU_VA1InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c14_Demo_AU_VA1_get_eml_resolved_functions_info(void)
{
  ...
  *c14_identifier)
{
  ...
  c14_y = c14_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c14_b_is_active_c14_Demo_AU_VA1), &c14_thisId);
  sf_mex_destroy(&c14_b_is_active_c14_Demo_AU_VA1);
  return c14_y;
}
...
void sf_c14_Demo_AU_VA1_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(936552107U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3620580529U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(370625665U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(308577804U);
}

mxArray *sf_c14_Demo_AU_VA1_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("lr20EASllmb4Q87kOa9KrF");
...
mxArray *sf_c14_Demo_AU_VA1_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c14_Demo_AU_VA1_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c14_Demo_AU_VA1(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"a_trig\",},{M[1],M[8],T\"a_trigW\",},{M[8],M[0],T\"is_active_c14_Demo_AU_VA1\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c14_Demo_AU_VA1_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc14_Demo_AU_VA1InstanceStruct *) chartInfo->chartInstance;
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_IF(0,1,1,630,665,-1,711);
        _SFD_CV_INIT_EML_IF(0,1,2,720,756,-1,804);
        ...
        {
          static int condStart[] = { 723, 741 };

          static int condEnd[] = { 737, 755 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,1,722,756,2,2,&(condStart[0]),&(condEnd[0]),
                                3,&(pfixExpr[0]));
        }
...

        {
          ...
          c14_vaFlag = (real_T *)ssGetInputPortSignal(chartInstance->S, 2);
          c14_a_trigW = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
          c14_a_trig = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
...
{
  return "wk2G9XovJ5HNRP5OWLrQZC";
}

static void sf_opaque_initialize_c14_Demo_AU_VA1(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc14_Demo_AU_VA1InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c14_Demo_AU_VA1((SFc14_Demo_AU_VA1InstanceStruct*)
    chartInstanceVar);
  initialize_c14_Demo_AU_VA1((SFc14_Demo_AU_VA1InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c14_Demo_AU_VA1(void *chartInstanceVar)
{
  enable_c14_Demo_AU_VA1((SFc14_Demo_AU_VA1InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c14_Demo_AU_VA1(void *chartInstanceVar)
{
  disable_c14_Demo_AU_VA1((SFc14_Demo_AU_VA1InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c14_Demo_AU_VA1(void *chartInstanceVar)
{
  sf_gateway_c14_Demo_AU_VA1((SFc14_Demo_AU_VA1InstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c14_Demo_AU_VA1(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c14_Demo_AU_VA1
    ((SFc14_Demo_AU_VA1InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c14_Demo_AU_VA1();/* state var info */
...
extern void sf_internal_set_sim_state_c14_Demo_AU_VA1(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c14_Demo_AU_VA1();/* state var info */
  ...
  set_sim_state_c14_Demo_AU_VA1((SFc14_Demo_AU_VA1InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c14_Demo_AU_VA1(SimStruct* S)
{
  return sf_internal_get_sim_state_c14_Demo_AU_VA1(S);
}

static void sf_opaque_set_sim_state_c14_Demo_AU_VA1(SimStruct* S, const mxArray *
  st)
{
  sf_internal_set_sim_state_c14_Demo_AU_VA1(S, st);
}

static void sf_opaque_terminate_c14_Demo_AU_VA1(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc14_Demo_AU_VA1InstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c14_Demo_AU_VA1((SFc14_Demo_AU_VA1InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc14_Demo_AU_VA1((SFc14_Demo_AU_VA1InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c14_Demo_AU_VA1(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c14_Demo_AU_VA1(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(3572356140U));
  ssSetChecksum1(S,(507518228U));
  ssSetChecksum2(S,(4010204239U));
  ssSetChecksum3(S,(3436185974U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c14_Demo_AU_VA1(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c14_Demo_AU_VA1(SimStruct *S)
{
  SFc14_Demo_AU_VA1InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc14_Demo_AU_VA1InstanceStruct *)utMalloc(sizeof
    (SFc14_Demo_AU_VA1InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc14_Demo_AU_VA1InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c14_Demo_AU_VA1;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c14_Demo_AU_VA1;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c14_Demo_AU_VA1;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c14_Demo_AU_VA1;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c14_Demo_AU_VA1;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c14_Demo_AU_VA1;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c14_Demo_AU_VA1;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c14_Demo_AU_VA1;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c14_Demo_AU_VA1;
  chartInstance->chartInfo.mdlStart = mdlStart_c14_Demo_AU_VA1;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c14_Demo_AU_VA1;
...
void c14_Demo_AU_VA1_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c14_Demo_AU_VA1(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c14_Demo_AU_VA1(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c14_Demo_AU_VA1(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c14_Demo_AU_VA1_method_dispatcher.\n"
