...
static void initialize_c13_Demo_AU_VA1(SFc13_Demo_AU_VA1InstanceStruct
  *chartInstance);
static void initialize_params_c13_Demo_AU_VA1(SFc13_Demo_AU_VA1InstanceStruct
  *chartInstance);
static void enable_c13_Demo_AU_VA1(SFc13_Demo_AU_VA1InstanceStruct
  *chartInstance);
static void disable_c13_Demo_AU_VA1(SFc13_Demo_AU_VA1InstanceStruct
  *chartInstance);
static void c13_update_debugger_state_c13_Demo_AU_VA1
  (SFc13_Demo_AU_VA1InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c13_Demo_AU_VA1
  (SFc13_Demo_AU_VA1InstanceStruct *chartInstance);
static void set_sim_state_c13_Demo_AU_VA1(SFc13_Demo_AU_VA1InstanceStruct
  *chartInstance, const mxArray *c13_st);
static void finalize_c13_Demo_AU_VA1(SFc13_Demo_AU_VA1InstanceStruct
  *chartInstance);
static void sf_gateway_c13_Demo_AU_VA1(SFc13_Demo_AU_VA1InstanceStruct
  *chartInstance);
static void initSimStructsc13_Demo_AU_VA1(SFc13_Demo_AU_VA1InstanceStruct
  *chartInstance);
...
static const mxArray *c13_sf_marshallOut(void *chartInstanceVoid, void
  *c13_inData);
static real_T c13_emlrt_marshallIn(SFc13_Demo_AU_VA1InstanceStruct
  *chartInstance, const mxArray *c13_v_trig, const char_T *c13_identifier);
static real_T c13_b_emlrt_marshallIn(SFc13_Demo_AU_VA1InstanceStruct
...
static const mxArray *c13_b_sf_marshallOut(void *chartInstanceVoid, void
  *c13_inData);
static int32_T c13_c_emlrt_marshallIn(SFc13_Demo_AU_VA1InstanceStruct
  *chartInstance, const mxArray *c13_u, const emlrtMsgIdentifier *c13_parentId);
static void c13_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c13_mxArrayInData, const char_T *c13_varName, void *c13_outData);
static uint8_T c13_d_emlrt_marshallIn(SFc13_Demo_AU_VA1InstanceStruct
  *chartInstance, const mxArray *c13_b_is_active_c13_Demo_AU_VA1, const char_T
  *c13_identifier);
static uint8_T c13_e_emlrt_marshallIn(SFc13_Demo_AU_VA1InstanceStruct
  *chartInstance, const mxArray *c13_u, const emlrtMsgIdentifier *c13_parentId);
static void init_dsm_address_info(SFc13_Demo_AU_VA1InstanceStruct *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c13_is_active_c13_Demo_AU_VA1 = 0U;
}
  ...
  (SFc13_Demo_AU_VA1InstanceStruct *chartInstance)
{
  ...
  c13_c_hoistedGlobal = chartInstance->c13_is_active_c13_Demo_AU_VA1;
  ...
  *chartInstance, const mxArray *c13_st)
{
  ...
  *c13_v_trigW = c13_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c13_u, 1)), "v_trigW");
  chartInstance->c13_is_active_c13_Demo_AU_VA1 = c13_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c13_u, 2)),
     "is_active_c13_Demo_AU_VA1");
  sf_mex_destroy(&c13_u);
  c13_update_debugger_state_c13_Demo_AU_VA1(chartInstance);
  ...
  *chartInstance)
{
  ...
  c13_b_vaFlag = (real_T *)ssGetInputPortSignal(chartInstance->S, 5);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML(&c13_vaFlag, 8U, c13_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c13_v_trigW, 9U, c13_sf_marshallOut,
    c13_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c13_v_trig, 10U, c13_sf_marshallOut,
    c13_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, chartInstance->c13_sfEvent, 8);
  if (CV_EML_IF(0, 1, 0, c13_vaFlag == 1.0)) {
  ...
  *c13_b_v_trig = c13_v_trig;
  ...
  _SFD_DATA_RANGE_CHECK(*c13_b_v_trigW, 5U);
  _SFD_DATA_RANGE_CHECK(*c13_b_vaFlag, 6U);
  ...
  *c13_inData)
{
  ...
  const mxArray *c13_y = NULL;
  SFc13_Demo_AU_VA1InstanceStruct *chartInstance;
  chartInstance = (SFc13_Demo_AU_VA1InstanceStruct *)chartInstanceVoid;
  ...
  *chartInstance, const mxArray *c13_v_trig, const char_T *c13_identifier)
{
  ...
  c13_y = c13_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c13_v_trig),
    &c13_thisId);
  sf_mex_destroy(&c13_v_trig);
  return c13_y;
}
...
static void c13_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c13_mxArrayInData, const char_T *c13_varName, void *c13_outData)
{
  const mxArray *c13_v_trig;
  const char_T *c13_identifier;
  emlrtMsgIdentifier c13_thisId;
  real_T c13_y;
  SFc13_Demo_AU_VA1InstanceStruct *chartInstance;
  chartInstance = (SFc13_Demo_AU_VA1InstanceStruct *)chartInstanceVoid;
  c13_v_trig = sf_mex_dup(c13_mxArrayInData);
...
const mxArray *sf_c13_Demo_AU_VA1_get_eml_resolved_functions_info(void)
{
  ...
  *c13_identifier)
{
  ...
  c13_y = c13_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c13_b_is_active_c13_Demo_AU_VA1), &c13_thisId);
  sf_mex_destroy(&c13_b_is_active_c13_Demo_AU_VA1);
  return c13_y;
}
...
void sf_c13_Demo_AU_VA1_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(290339985U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(635241540U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2751808945U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2245277787U);
}

mxArray *sf_c13_Demo_AU_VA1_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("Pcd8wF5D5qLUwD1USXeu4G");
...
mxArray *sf_c13_Demo_AU_VA1_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c13_Demo_AU_VA1_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c13_Demo_AU_VA1(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[14],T\"v_trig\",},{M[1],M[11],T\"v_trigW\",},{M[8],M[0],T\"is_active_c13_Demo_AU_VA1\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c13_Demo_AU_VA1_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc13_Demo_AU_VA1InstanceStruct *) chartInfo->chartInstance;
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,1324);
        _SFD_CV_INIT_EML_IF(0,1,0,346,359,1149,1181);
        _SFD_CV_INIT_EML_IF(0,1,1,562,597,-1,647);
        _SFD_CV_INIT_EML_IF(0,1,2,656,692,-1,742);
        _SFD_CV_INIT_EML_IF(0,1,3,752,762,840,854);
        _SFD_CV_INIT_EML_IF(0,1,4,840,854,-1,854);
        _SFD_CV_INIT_EML_IF(0,1,5,950,962,-1,1008);
        _SFD_CV_INIT_EML_IF(0,1,6,1018,1029,-1,1075);
        _SFD_CV_INIT_EML_IF(0,1,7,1085,1098,-1,1144);
        _SFD_CV_INIT_EML_IF(0,1,8,1186,1199,1222,1323);
        _SFD_CV_INIT_EML_IF(0,1,9,1222,1239,1293,1323);
...

        {
          ...
          real_T *c13_v_trig;
          c13_v_trig = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
          c13_vaFlag = (real_T *)ssGetInputPortSignal(chartInstance->S, 5);
          c13_v_trigW = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
          ...
          _SFD_SET_DATA_VALUE_PTR(5U, c13_v_trigW);
          _SFD_SET_DATA_VALUE_PTR(6U, c13_vaFlag);
...
{
  return "vngNPoUiFoa1nWSxbop15";
}

static void sf_opaque_initialize_c13_Demo_AU_VA1(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc13_Demo_AU_VA1InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c13_Demo_AU_VA1((SFc13_Demo_AU_VA1InstanceStruct*)
    chartInstanceVar);
  initialize_c13_Demo_AU_VA1((SFc13_Demo_AU_VA1InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c13_Demo_AU_VA1(void *chartInstanceVar)
{
  enable_c13_Demo_AU_VA1((SFc13_Demo_AU_VA1InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c13_Demo_AU_VA1(void *chartInstanceVar)
{
  disable_c13_Demo_AU_VA1((SFc13_Demo_AU_VA1InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c13_Demo_AU_VA1(void *chartInstanceVar)
{
  sf_gateway_c13_Demo_AU_VA1((SFc13_Demo_AU_VA1InstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c13_Demo_AU_VA1(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c13_Demo_AU_VA1
    ((SFc13_Demo_AU_VA1InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c13_Demo_AU_VA1();/* state var info */
...
extern void sf_internal_set_sim_state_c13_Demo_AU_VA1(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c13_Demo_AU_VA1();/* state var info */
  ...
  set_sim_state_c13_Demo_AU_VA1((SFc13_Demo_AU_VA1InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c13_Demo_AU_VA1(SimStruct* S)
{
  return sf_internal_get_sim_state_c13_Demo_AU_VA1(S);
}

static void sf_opaque_set_sim_state_c13_Demo_AU_VA1(SimStruct* S, const mxArray *
  st)
{
  sf_internal_set_sim_state_c13_Demo_AU_VA1(S, st);
}

static void sf_opaque_terminate_c13_Demo_AU_VA1(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc13_Demo_AU_VA1InstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c13_Demo_AU_VA1((SFc13_Demo_AU_VA1InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc13_Demo_AU_VA1((SFc13_Demo_AU_VA1InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c13_Demo_AU_VA1(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c13_Demo_AU_VA1(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(699868745U));
  ssSetChecksum1(S,(2441716029U));
  ssSetChecksum2(S,(463917427U));
  ssSetChecksum3(S,(1685224500U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c13_Demo_AU_VA1(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c13_Demo_AU_VA1(SimStruct *S)
{
  SFc13_Demo_AU_VA1InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc13_Demo_AU_VA1InstanceStruct *)utMalloc(sizeof
    (SFc13_Demo_AU_VA1InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc13_Demo_AU_VA1InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c13_Demo_AU_VA1;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c13_Demo_AU_VA1;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c13_Demo_AU_VA1;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c13_Demo_AU_VA1;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c13_Demo_AU_VA1;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c13_Demo_AU_VA1;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c13_Demo_AU_VA1;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c13_Demo_AU_VA1;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c13_Demo_AU_VA1;
  chartInstance->chartInfo.mdlStart = mdlStart_c13_Demo_AU_VA1;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c13_Demo_AU_VA1;
...
void c13_Demo_AU_VA1_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c13_Demo_AU_VA1(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c13_Demo_AU_VA1(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c13_Demo_AU_VA1(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c13_Demo_AU_VA1_method_dispatcher.\n"
