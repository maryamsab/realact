function calculateVA_Stable2_sfun(block)
...
disp('InitializeConditions')
  ...
  block.OutputPort(2).Data = -1; %A=s-/i-s/d-f
...
function Update(block)
    ...
    sTime=round(rto);
    LowNdecayRate=1; %LowN goes faster to steady-state than others 
    
    MAX_V=20;%Valence curve cieling
    MAX_A=20;%Arousal curve cieling
    
    satisfied = block.InputPort(1).Data;
    aroused = block.InputPort(2).Data; 
