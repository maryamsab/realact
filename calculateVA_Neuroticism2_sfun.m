function calculateVA_Neuroticism2_sfun(block)
...
function InitializeConditions(block)
    ...
    block.OutputPort(1).Data = -1; %V=s-/i-s/d-f, A=s+/i-f/d-s
...
function Update(block)
    ...
    sTime=round(rto); 
    HighNdecayRate=1; %this is for HighE and HighN (LowN goes faster to steady-state than others)
